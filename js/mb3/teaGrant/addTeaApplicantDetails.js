    ...
    var addApplicantModal = document.getElementById("addTeaApplicantDetails");

    function openTeaApplicant(){
    ...
    function addTeaApplicant(){

        var case_no = $('#case_no').val();
        
        var add_applicant_name_ass = $('#add_applicant_name_ass').val();
        var add_applicant_name_eng = $('#add_applicant_name_eng').val();
        var add_guardian_name_ass = $('#add_guardian_name_ass').val();
        var add_guardian_name_eng = $('#add_guardian_name_eng').val();
        var add_relation = $('#add_relation').val();
        var add_gender = $('#add_gender').val();
        var add_dob = $('#add_dob').val();
        var add_marital_status = $('#add_marital_status').val();
        var add_mobile = $('#add_mobile').val();
        var add_per_address = $('#add_per_address').val();
        var add_pre_address = $('#add_pre_address').val();
        ...
        $.ajax({
            url: baseurl+'TeaGrantController/addApplicantDetails',
            type: "POST",
            data: postData,
                ...
                if(arr.responseType == 0){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            '<tr><th>Present address</th><td><input type="text" readonly="" name="pdar_add2'+arr.appnData.id+'" id="pdar_add2'+arr.appnData.id+'" value='+arr.appnData.pdar_add2+' class="form-control input-sm"></td></tr>'+
                            '<tr><td>'+
...
function confirmDeleteApplicant(id)
{
  ...
  if(confirm("Are you sure you want to delete this Record?")){
    $.ajax({
      type: "POST",
      url: baseurl+'TeaGrantController/delApplicantDetails',
      async: false,
      // dataType: 'json',
