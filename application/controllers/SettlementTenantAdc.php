...
class SettlementTenantAdc extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('SettlementMb/SettlementTenantAdcModel');
...
//********************** START TENANT **********************************
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTenantAdcModel->getAllHearingPendingCasesForAdc($dist_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Adc/Tenant/first_proceeding_case_dc_tenant';
        $this->load->view('layouts/main', $data);
    ...
    public function SettlementApFirstLandDc()
    {
        ...
        $hearingAdcCount = $this->SettlementTenantAdcModel->hearingAdcCount($dist_code);
        ...
        $data['_view'] = 'settlementView/Adc/Tenant/first_landing_page_dc_tenant';
        $this->load->view('layouts/main', $data);
