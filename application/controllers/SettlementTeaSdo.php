...
class SettlementTeaSdo extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('SettlementModel/SettlementTeaModel');
...
//********************** COMMON **********************************
    ...
    function randomFileName()
    {
        ...
        if($this->SettlementTeaSdoModel->checkDuplicateFileNameInProposal($new_case_no) != 0)
        {
            $this->randomFileName();
        }
        else
    ...
    public function applicationRevertFromDCToCO()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementTeaSdoModel->countSettlementApplicationDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            ...
            else
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementTeaSdoModel->updateSettlementBasicData($case_no,$dist_code,$subDiv_code,$updateData)== 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
    ...
    public function applicationRejectedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementTeaSdoModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code,$subDiv_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $mmnn = $this->SettlementTeaSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function applicationApprovedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount       = $this->SettlementTeaSdoModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code,$subDiv_code);
            $caseCountInPro  = $this->SettlementTeaSdoModel->countSettlementAppDetailsByCaseNoUnderProposal($case_no);
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->SettlementTeaSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function viewPaymentReceivedAppDetailsByDc()
    {
        ...
        $subDiv_code = $this->session->userdata('subdiv_code');
        $this->utilityclass->checkUserAuthForCaseForSdo($case_no);
        $caseCount = $this->SettlementTeaSdoModel->countSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
        if($caseCount == 0)
        {
            $this->getErrorPage();
        }
        ...
        {
            $caseDetails = $this->SettlementTeaSdoModel->getSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            $proceedings = $this->SettlementTeaSdoModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;

            $data['_view'] = 'settlementView/Sdo/Tea/payment_received_app_details_tea';
    ...
    public function updateProposalHearingDateTea()
    {
        ...
        else
        {
            ...
            $allCases      = $this->SettlementTeaSdoModel->getAllAppInReportSendByDcToSdlacTea($proposalNo);
    ...
    public function updateHearingDateGenerateNoticeTea()
    {
        ...
        else
        {
            ...
            $proposalDetails = $this->SettlementTeaSdoModel->getProposalDetailsById($proposalNo,$dist_code,$subDiv_code);
            if($proposalDetails == '')
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->db->trans_begin();
                    if($this->SettlementTeaSdoModel->updateProposalListById($proposalNo,$dist_code,$subDiv_code,$updateProposalData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
...
//********************** COMMON **********************************
    ...
    public function SettlementTeaLandDc()
    {
        ...
        // todo
        $firstProceedingCount = $this->SettlementTeaSdoModel->countAllPendingSettlementTea($dist_code,$subDiv_code);
        $SDLACCommitteeCount  = $this->SettlementCommonDcModel->countAllSDLACCommitteeMember($dist_code,$user_code,$user_desig_code);
        $SDLACNoticeCount     = $this->SettlementTeaSdoModel->countMarkAsSDLACSettlementTea($dist_code,$subDiv_code);
        $SDLACReportCount     = $this->SettlementTeaSdoModel->countAllProposalSendByDcToSdlacTea($dist_code,$subDiv_code);
        $caseStatusCount      = 0;
        $sdlacMemberApproval  = $this->SettlementTeaSdoModel->countSdlacStatusList($dist_code,$subDiv_code);
        $SDLACConsideration   = $this->SettlementTeaSdoModel->countAllUnderConsiderationAppTea($dist_code,$subDiv_code);

        // $reReportByCOCount    = $this->SettlementTeaSdoModel->countReRevertedByCoApplicationTea($dist_code,$subDiv_code);
        // $approvedListCount    = $this->SettlementTeaSdoModel->countAllApproveAppBySdlacTea($dist_code,$subDiv_code);
        // $rejectedListCount    = $this->SettlementTeaSdoModel->countAllRejectAppByDcTea($dist_code,$subDiv_code);
        // $finalVerifyCaseCount = $this->SettlementTeaSdoModel->countAllCasesForFinalVerifyAppTea($dist_code,$subDiv_code);
        // $revertedByDepartmentCount = $this->SettlementTeaSdoModel->countRevertedByDeptApplicationTea($dist_code,$subDiv_code);
        // $chithaUpdateOrderCount    = $this->SettlementTeaSdoModel->countAllOrderChithaUpdateAppTea($dist_code,$subDiv_code);
        ...
        $coRejectedListCount = $this->SettlementCommonDcModel->countCoRejectedCaseForSDO($dist_code,$subDiv_code,SETTLEMENT_SPECIAL_CULTIVATORS_ID);

        $coModificationListCount = $this->SettlementPullModel->countCoModificationRequestCaseForSDO($dist_code,$subDiv_code,SETTLEMENT_SPECIAL_CULTIVATORS_ID);

        $rejctedListCount = $this->SettlementCommonDcModel->rejectedCaseListSDO($dist_code,$subDiv_code, SETTLEMENT_SPECIAL_CULTIVATORS_ID, MB_SUB_DIV_COMM);
        $revivalListCount = $this->SettlementCommonDcModel->revivalListCountSDO($dist_code, $subDiv_code, SETTLEMENT_SPECIAL_CULTIVATORS_ID, MB_SUB_DIV_COMM);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/first_landing_page_dc_tea';
        $this->load->view('layouts/main', $data);

    }


    // view all first Proceeding case list Tea SDO
    public function viewAllTeaFirstProceedingDCCaseList()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllPendingSettlementTea($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/first_proceeding_case_dc_tea';
        $this->load->view('layouts/main', $data);

    }


    //  settlement application details Tea SDO
    public function getSettlementTeaApplicationDetails()
    {
        ...
        $basic= $this->SettlementTeaModel->getSettlementBasic($application_no);
        $applicants_buyers = $this->SettlementTeaModel->getAllApplicantBuyers($application_no);
        $applicants_owners = $this->SettlementTeaModel->getAllApplicantOwners($application_no);
        $applicants_encroacher = $this->SettlementTeaModel->getAllApplicantEncroacher($application_no);
        $applicants_riotee_nok = $this->SettlementTeaModel->getAllApplicantRioteeNok($application_no);

        $dags = $this->SettlementTeaModel->getSettlementDag($application_no);
        $lmnotes = $this->SettlementTeaModel->getSettlementTenantLmNote($application_no);
        $proceedings = $this->SettlementTeaModel->getSettlementProceeding($application_no);
        $dhardocuments = $this->SettlementTeaModel->getDocuments($application_no);
        $nominee = $this->SettlementTeaModel->getAllNomineeDetail($application_no);
        ...
        // var_dump($data['premium_data']); die;
        ...
        else
        {
            ...
            $caseDetails = $this->SettlementTeaSdoModel->getSettlementApplicationDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            $proceedings = $this->SettlementTeaSdoModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
            ...
            $data['additional_property'] = $this->SettlementTeaModel->getAdditionalProperty($application_no);
            ...
            $data['_view'] = 'settlementView/Sdo/Tea/settlement_app_details_tea';
            $this->load->view('layouts/main', $data);
        }
    }


    // view all mark as SDLAC Tea SDO
    public function viewAllMarkAsSDLACListForDCTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getMarkAsSDLACSettlementTea($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/mark_as_sdlac_case_dc_tea';
        $this->load->view('layouts/main', $data);

    }


    // get all proposal list for Tea SDO
    public function getAllProposalListSdlacTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllProposalSendByDcToSdlacTea($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/proposal_list_send_to_sdlac_tea';
        $this->load->view('layouts/main', $data);
    }


    // get all SDLAC Under consideration Tea SDO
    public function getAllUnderConSdlacTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllUnderConSettlementTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/under_consideration_case_dc_tea';
        $this->load->view('layouts/main', $data);
    }


    // get all application send by SDO to sdlac for report Tea
    public function getAllApplicationInReportSendByDcToSdlacTea()
    {
        ...
        $subDiv_code = $this->session->userdata('subdiv_code');
        $user_code   = $this->session->userdata('user_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllAppInReportSendByDcToSdlacTea($proposal_no);
        $proposalDetails = $this->SettlementTeaSdoModel->getProposalDetailsById($proposal_no,$dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/send_to_sdlac_case_dc_tea';
        $this->load->view('layouts/main', $data);

    }


    // generate proposal notice Tea SDO
    public function generateNoticeSendAllMarkAppToSDLACByDcTea()
    {
        ...
        else
        {
            ...
            if(!empty($allSelectedList))
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementTeaSdoModel->saveProposalSDLACTea($dataProSave) == 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
                ...
                else
                {
                    ...
                    foreach ($allSelectedMem as $member)
                    {
                        ...
                        if($ins != 1 || $ins != true ){
                            $this->db->trans_rollback();
                            log_message('error', '#ERMRCODE2168: Insertion failed in sdlac_present_member for 
                        proposal no : '.$proposal_id. ' and query is '. $this->db->last_query());
                            $json = [
                                'response' => 1,
                                'message'  => '#ERMRCODE2168: SDLAC/CDLAC Member not added. Kindly contact system administrator',
                            ];
                    ...
                    foreach ($allSelectedList as $row)
                    {
                        ...
                        if($this->SettlementTeaSdoModel->saveProposalCaseListSDLACTea($saveCaseList) == 0)
                        {
                            //$this->SettlementTeaSdoModel->deleteProposalSDLAC($proposalId);
    ...
    // get all  approved list Tea
    public function getAllApprovedBySDLACListTea()
    {
        $subDiv_code = $this->session->userdata('subdiv_code');
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllApproveAppBySdlacTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/approve_list_by_sdlac_tea';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function viewApprovedAppDetailsTea()
    {
        ...
        $caseCount = $this->SettlementTeaSdoModel->countSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code,$subDiv_code);
        if($caseCount == 0)
        {
            $this->SettlementTeaLandDc();
        }
        else
        {
            ...
            $caseDetails = $this->SettlementTeaSdoModel->getSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code,$subDiv_code);
            $proceedings = $this->SettlementTeaSdoModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
            ...
            $data['_view'] = 'settlementView/Sdo/Tea/settlement_app_details_only_view_tea';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    public function getAllRejectByDcListTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllRejectAppByDcTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/rejected_list_by_dc_tea';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function viewRejectedAppDetailsTea()
    {
        ...
        else
        {
            ...
            $data['_view'] = 'settlementView/Sdo/Tea/settlement_app_details_rejected_only_view_tea';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    public function getAllOrderChithaUpdateForDcAppTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getAllOrderChithaUpdateAppTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/order_chitha_update_list_by_dc_tea';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllReReportAppByCOForDcAppTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getReRevertedByCoApplicationTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/re_revert_by_co_list_tea';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllRevertedAppByDeptForDcAppTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getRevertedByDeptApplicationTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/revert_by_dept_list_tea';
        $this->load->view('layouts/main', $data);
    }


    // Application Order for payment generate Dc
    public function applicationPaymentGenerateDcTea()
    {
        $_POST = json_decode(file_get_contents("php://input"), true);
        $this->load->library('form_validation');
        $this->form_validation->set_rules('caseNo', 'Case Number', 'trim|required');
        ...
        else
        {
            ...
            $remarks   = $this->input->post('remarks');
            $user_code = $this->session->userdata('user_code');
            $caseCount = $this->SettlementTeaSdoModel->caseForDcApprovalTea($case_no,$dist_code,$subDiv_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
    ...
    public function getAllCasesForFinalVerifyByDcTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $allCase = $this->SettlementTeaSdoModel->getAllCasesForFinalVerifyAppTea($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $allCase->result();
        $data['pendingCaseCount'] = $allCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/final_verify_list_by_dc_tea';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function proposalForwardToDcForFinalVerifyTea()
    {
        ...
        else
        {
            ...
            $dist_code   = $this->session->userdata('dist_code');
            $pendingCase = $this->SettlementTeaSdoModel->getAllAppInReportSendByDcToSdlacTea($proposal_no,$subDiv_code);
            ...
            foreach ($cases as $case)
            {
                ...
                if($case->case_status == 1 || $case->case_status == 0)
                {
                    ...
                    if($this->SettlementTeaSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updateCase)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                    ...
                    if($this->SettlementTeaSdoModel->updateSettlementBasicData($caseNo,$dist_code,$subDiv_code,$updateBasicData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                ...
                if($case->case_status == 2)
                {
                    ...
                    else
                    {
                        ...
                        $mmnn = $this->SettlementTeaSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updatePro);
            ...
            if($this->SettlementTeaSdoModel->updateProposalListById($proposal_no,$dist_code,$subDiv_code,$dataUpdate)== 0)
            {
                $this->db->trans_rollback();
                echo json_encode(array(
                    'responseType' => 1,
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementTeaSdo/getSettlementTeaApplicationDetails/?case='.$rows->case_no.'">Process</a>',
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementTeaSdo/getSettlementTeaApplicationDetails/?case='.$rows->case_no.'">View Application</a>'
                );
        ...
        if($query->num_rows() > 0)
        {
            ...
            foreach($result as $rows)
            {
                $json[] = array (
                  ...
                  <a class="btn btn-sm btn-success" href="'.base_url().'index.php/SettlementTeaSdo/getAllApplicationInReportSendByDcToSdlacTea/?case='.$rows->id.'">
    ...
    // get all forth proceeding SDLAC Report Tea page
    public function getAllSdlacMemberApprovalProposalListTea()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subdiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTeaSdoModel->getSdlacApprovalProposalListTea($dist_code,$subdiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Tea/sdlac_approval_proposal_list_tea';
        $this->load->view('layouts/main', $data);

    }


    // get all forth proceeding SDLAC Report Tea with data
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                <div class="text-green" id="list_of_cases_'.$rows->id.'"></div>',
                    ...
                    <a class="rezaButt btn-success" href="'.base_url().'index.php/SettlementTeaSdo/getSdlacMemberApproveProposalViewIndividualTea/?case='.$rows->id.'">
                    '.'Process'.'</a>'
    ...
    public function getSdlacMemberApproveProposalViewIndividualTea()
    {
        ...
        $suv_div     = $this->session->userdata('subdiv_code');
        $proposal_no = $this->input->get('case');
        $proposalDetails  = $this->SettlementTeaSdoModel->getSdlacApprovalProposalIndividualTea($proposal_no,$dist_code,$suv_div);
        $reportDetails    = $this->SettlementTeaSdoModel->getSdlacMemberReportDetailsTea($proposal_no,$dist_code,$suv_div);
        $getMembersStatus = $this->SettlementTeaSdoModel->getSdlacMemberStatus($dist_code, $proposal_no);
        ...
        $data['_view'] = 'settlementView/Sdo/Tea/sdlac_committee_report_details_tea';
        $this->load->view('layouts/main', $data);
    }
