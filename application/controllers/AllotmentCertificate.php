...
class AllotmentCertificate extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['villages'] = $this->AllotmentCertificateModel->getAllVillages($dist_code, null);
        $data['circles']  = $this->AllotmentCertificateModel->getAllCircles($dist_code, null);

        // print_r($data['villages']);
        // exit();

        if (ALLOTMENT_AND_SETTLEMENT == 1) {
            $data['certificate'] = $this->AllotmentCertificateModel->getAllotmentCertificates($dist_code);
            $data['_view']       = 'allotment_certificate/landing_page';
        } else {
            $data['_view'] = 'allotment_certificate/closed';
        }
    ...
    public function getAllAllotmentCertificateDetails()
    {
        ...
        $cases_list = $this->AllotmentCertificateModel->getAllCasesAllocatedCertificate($start, $length, $order);
    ...
    public function bulkApproveCasesOfAllotmentCertificateWithoutDigitalSignWithoutPdf()
    {
        ...
        foreach ($dhar_case_no_list as $key => $dhar_case_no) {
            ...
            // $passed_cases = array();
            $data['application_no'] = $application_no = $this->AllotmentCertificateModel->getApplidFromCaseNo($dhar_case_no);
            $data['rtps_no']        = $rtps_no        = $this->AllotmentCertificateModel->getRtpsRefNo($application_no);
            // $data['patta_info']     = $patta_info     = $this->AllotmentCertificateModel->getPattaInfo($application_no);
            $check_partial = $this->AllotmentCertificateModel->checkPartialPayment($dhar_case_no);
            if ($check_partial != 'Y') {
                ...
                //     exit; 
                // }
                $insert_all_data = $this->AllotmentCertificateModel->insertAllAllocatedCertificateDataWithoutPdf($application_no, $rtps_no, isset($patta_info) ? $patta_info : null, $dhar_case_no);
            }
    ...
    // {
    //     $data['application_no'] = $application_no = $this->AllotmentCertificateModel->getApplidFromCaseNo($dhar_case_no);
    //     $data['rtps_ref_no']    = $rtps_no    = $this->AllotmentCertificateModel->getRtpsRefNo($application_no);

    //     $data['institution_details'] = $institute_details = $this->AllotmentCertificateModel->getInstitutionDetails($dhar_case_no);
    //     $data['location_details']    = $this->AllotmentCertificateModel->getLocationDetails($dhar_case_no);
    //     // $data['location_details'] = $location_details;
    //     $data['dag_details'] = $dag_details = $this->AllotmentCertificateModel->getDagDetails($dhar_case_no);
    ...
    //         $north_boundary_district    = $this->AllotmentCertificateModel->getLocationName($north['dist_code']);
    //         $north_boundary_subdivision = $this->AllotmentCertificateModel->getLocationName($north['dist_code'], $north['subdiv_code']);
    //         $north_boundary_circle      = $this->AllotmentCertificateModel->getLocationName($north['dist_code'], $north['subdiv_code'], $north['cir_code']);
    //         $north_boundary_mouza       = $this->AllotmentCertificateModel->getLocationName($north['dist_code'], $north['subdiv_code'], $north['cir_code'], $north['mouza_pargona_code']);
    //         $north_boundary_lot         = $this->AllotmentCertificateModel->getLocationName($north['dist_code'], $north['subdiv_code'], $north['cir_code'], $north['mouza_pargona_code'], $north['lot_no']);
    //         $north_boundary_village     = $this->AllotmentCertificateModel->getLocationName($north['dist_code'], $north['subdiv_code'], $north['cir_code'], $north['mouza_pargona_code'], $north['lot_no'], $north['vill_townprt_code']);
    ...
    //         $south_boundary_district    = $this->AllotmentCertificateModel->getLocationName($south['dist_code']);
    //         $south_boundary_subdivision = $this->AllotmentCertificateModel->getLocationName($south['dist_code'], $south['subdiv_code']);
    //         $south_boundary_circle      = $this->AllotmentCertificateModel->getLocationName($south['dist_code'], $south['subdiv_code'], $south['cir_code']);
    //         $south_boundary_mouza       = $this->AllotmentCertificateModel->getLocationName($south['dist_code'], $south['subdiv_code'], $south['cir_code'], $south['mouza_pargona_code']);
    //         $south_boundary_lot         = $this->AllotmentCertificateModel->getLocationName($south['dist_code'], $south['subdiv_code'], $south['cir_code'], $south['mouza_pargona_code'], $south['lot_no']);
    //         $south_boundary_village     = $this->AllotmentCertificateModel->getLocationName($south['dist_code'], $south['subdiv_code'], $south['cir_code'], $south['mouza_pargona_code'], $south['lot_no'], $south['vill_townprt_code']);
    ...
    //         $east_boundary_district    = $this->AllotmentCertificateModel->getLocationName($east['dist_code']);
    //         $east_boundary_subdivision = $this->AllotmentCertificateModel->getLocationName($east['dist_code'], $east['subdiv_code']);
    //         $east_boundary_circle      = $this->AllotmentCertificateModel->getLocationName($east['dist_code'], $east['subdiv_code'], $east['cir_code']);
    //         $east_boundary_mouza       = $this->AllotmentCertificateModel->getLocationName($east['dist_code'], $east['subdiv_code'], $east['cir_code'], $east['mouza_pargona_code']);
    //         $east_boundary_lot         = $this->AllotmentCertificateModel->getLocationName($east['dist_code'], $east['subdiv_code'], $east['cir_code'], $east['mouza_pargona_code'], $east['lot_no']);
    //         $east_boundary_village     = $this->AllotmentCertificateModel->getLocationName($east['dist_code'], $east['subdiv_code'], $east['cir_code'], $east['mouza_pargona_code'], $east['lot_no'], $east['vill_townprt_code']);
    ...
    //         $west_boundary_district    = $this->AllotmentCertificateModel->getLocationName($west['dist_code']);
    //         $west_boundary_subdivision = $this->AllotmentCertificateModel->getLocationName($west['dist_code'], $west['subdiv_code']);
    //         $west_boundary_circle      = $this->AllotmentCertificateModel->getLocationName($west['dist_code'], $west['subdiv_code'], $west['cir_code']);
    //         $west_boundary_mouza       = $this->AllotmentCertificateModel->getLocationName($west['dist_code'], $west['subdiv_code'], $west['cir_code'], $west['mouza_pargona_code']);
    //         $west_boundary_lot         = $this->AllotmentCertificateModel->getLocationName($west['dist_code'], $west['subdiv_code'], $west['cir_code'], $west['mouza_pargona_code'], $west['lot_no']);
    //         $west_boundary_village     = $this->AllotmentCertificateModel->getLocationName($west['dist_code'], $west['subdiv_code'], $west['cir_code'], $west['mouza_pargona_code'], $west['lot_no'], $west['vill_townprt_code']);
    ...
    //     $certificate_no = $this->AllotmentCertificateModel->generateCertificateNumber();

    //     $landclass = $this->utilityclass->getLandClassCode($dag_details->new_land_class_code);

    //     $get_meeting_no = $this->AllotmentCertificateModel->getMeetingNo($dhar_case_no);

    //     $otherDetails = $this->AllotmentCertificateModel->getOtherDetails($dhar_case_no);
    ...
    //     $getVillageUUID = $this->AllotmentCertificateModel->getVillageUUID($dist_code, $sub, $cir, $mou, $lot, $vill);
    //     // make the array for insertion into the database

    //     $dag_nos = $this->AllotmentCertificateModel->getChithaDagNos($dhar_case_no);

    //     $getArea = $this->AllotmentCertificateModel->getDagAreaBYCase($dhar_case_no);
    ...
    //     $insert_data = $this->AllotmentCertificateModel->insertOrUpdateCertificateData($certificate_data);
    //     // print($insert_data);
    //     return $insert_data;
    // }
    ...
    //     $certificate_no = $this->AllotmentCertificateModel->getCertificateData($dhar_case_no);
    ...
    //             $dag_nos   = $this->AllotmentCertificateModel->getChithaDagNosByOldDag($dhar_case_no, $value->dag_no);
    ...
    //             $pattaDetails = $this->AllotmentCertificateModel->getPattaDetails($dist_code, $sub, $cir, $mou, $lot, $vill, $dag_no_old, $dag_no_new);
    ...
    //         $getDataFromApLmNote = $this->AllotmentCertificateModel->getDataFromApLmNotes($dhar_case_no);
    //         $isSettlement        = $this->AllotmentCertificateModel->isSettlementorAllotment($institute_details->ins_cat_type_co, $getDataFromApLmNote); // or use: $this->AllotmentCertificateModel->isSettlement($case_no);
    ...
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate_state_govt', $data, true);
    //             } else if ($checkType == 9) {
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate_state_govt_undertaking', $data, true);
    //             } else if ($checkType == 10) {
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate_central_govt', $data, true);
    //             } else if ($checkType == 11) {
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate_central_govt_undertaking', $data, true);
    //             } else if ($checkType == 12) {
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate_non_govt', $data, true);
    //             } else {
    //                 $html = $this->load->view('allotment_certificate/actual_certificate/allotment_certificate', $data, true);
    //             }
    ...
    //             $file_name = "allotment_certificate_state_govt_" . $dhar_case_name . ".txt"; // save as text file
    ...
    //             $data['base_64_file'] = base_url() . "uploads/allotment_certificate/actual_certificate/" . $file_name;
    //         }
    ...
    public function generateCertificate($dist_code = '07', $dhar_case_no, $type)
    {
            ...
            foreach ($dag_details as $key => $value) {
                ...
                $reservation = $this->AllotmentCertificateModel->getReservationArea($dhar_case_no, $value->dag_no);
                // print_r($reservation);
                // die;
            ...
            $isSettlement        = $this->AllotmentCertificateModel->isSettlementorAllotment($institute_details->ins_cat_type_co, $getDataFromApLmNote); // or use: $this->AllotmentCertificateModel->isSettlement($case_no);
             ...
             if($institute_details->ins_cat_type_co == 12){
                $purpose =  null;
                $allDataFromPurpose = $this->AllotmentCertificateModel->getPruposeBycaseNo($dhar_case_no);
            ...
            if ($type == "generate") {
                ...
                if ($checkType == 8) { // State Government
                    ...
                    if($purpose_land_allot_co == 'religious-socio-culture'){
                        $html = $this->load->view('allotment_certificate/actual_certificate/religious_socio_culture', $data, true);
                    }
                    else if($purpose_land_allot_co == 'eductaion-govt-aidded'){
                        $html = $this->load->view('allotment_certificate/actual_certificate/eductaion_govt_aidded', $data, true);
                    }
                    else if($purpose_land_allot_co == 'eductaion-unrecognized-venture'){
                        $html = $this->load->view('allotment_certificate/actual_certificate/eductaion_unrecognized_venture', $data, true);
                    }
                    else if($purpose_land_allot_co == 'eductaion-non-venture'){
                        $html = $this->load->view('allotment_certificate/actual_certificate/eductaion_non_venture', $data, true);
                    }
    ...
    public function getAllotmentCertificate()
    {
        ...
        if ($insert_data['result'] == 'ERROR') {
            $string = $this->load->view('allotment_certificate/no-certificate', $insert_data, true);
            echo json_encode($string);
        } else {

            $getCertifacteData        = $this->AllotmentCertificateModel->getCertificateData($dhar_case_no);
            $data['certificate_data'] = $getCertifacteData;
            // $data['patta_info'] = $this->AllotmentCertificateModel->getPattaInfo($dhar_case_no);
            $data['district_name_eng'] = $this->AllotmentCertificateModel->getDistrictNameEng($dist_code);
            // if(!$data['patta_info']['result']){
            ...
            $checkType = (int) $this->AllotmentCertificateModel->checkType($dhar_case_no)->ins_cat_type_co;

            if ($checkType == 8) { //State Government
                $string = $this->load->view('allotment_certificate/allotment_certificate_state_govt', $data, true);
            } else if ($checkType == 9) { //State Government Under Taking
                $string = $this->load->view('allotment_certificate/allotment_certificate_state_govt_undertaking', $data, true);
            } else if ($checkType == 10) { //Central Government
                $string = $this->load->view('allotment_certificate/allotment_certificate_central_govt', $data, true);
            } else if ($checkType == 11) { //Central Government UnderTaking
                $string = $this->load->view('allotment_certificate/allotment_certificate_central_govt_undertaking', $data, true);
            } else if ($checkType == 12) { //Non Goverment
                $string = $this->load->view('allotment_certificate/allotment_certificate_non_govt', $data, true);
            } else {
                ...
                $string = $this->load->view('allotment_certificate/allotment_certificate', $data, true);
            }
            echo json_encode($string);
        }
    }
...
//         $case_no = 'DIB/DIBW/2024-25/65815/SLIJE';
    //     }
    //     $this->db->trans_begin();
    //     echo $response = $this->AllotmentCertificateModel->genArrayForCithaUpdate($case_no);
...
//         $this->db->trans_rollback();
    ...
    public function getAllDigitalPattaDetails()
    {
        ...
        // print_r($_POST);
        // die;
        $cases_list = $this->AllotmentCertificateModel->getAllCasesAllocatedCertificate($start, $length, $order, $selectService, $selectVillage, $selectCircle);
    ...
    public function getAllDigitalPattaDetailsIssuedv2()
    {
        ...
        $selectCertificate = $this->input->post('selectCertificate');


        // print_r($_POST);
        // die;
        $cases_list = $this->AllotmentCertificateModel->getAllCasesAllocatedCertificateIssuedv2($start, $length, $order, $selectService, $selectVillage, $selectCircle, $selectStatus, $selectCertificate);


        // $cases_list = $this->AllotmentCertificateModel->getAllCasesAllocatedCertificateIssuedv2($start, $length, $order);
        ...
        if (! empty($cases_list)) {
            ...
            if ($cases_list['total_records'] > 0) {
                ...
                foreach ($data_rows as $row) {
                  ...
                  $status  = '<div class="text-center" style="font-size: 0.6rem;">'; // smaller font
$status .= '<span class="badge bg-info text-dark p-1 mb-1">Issued Id: ' . $row->issued_id . '</span><br>';
$status .= $row->printing_status == '1'
    ? '<span class="badge bg-success p-1" style="font-size: 0.75rem;"><i class="fa fa-print"></i> Printed</span>'
    : '<span class="badge bg-danger p-1" style="font-size: 0.75rem;"><i class="fa fa-print"></i> Not Printed</span>';
$status .= '</div>';

                    $alot_cert = $row->certificate_no;
    ...
    //         //     array_push($passed_cases,$patta_info);
    //         // }
    //         $insert_all_data = $this->AllotmentCertificateModel->insertAllAllocatedCertificateDataWithoutPdf($application_no, $rtps_no, $patta_info, $dhar_case_no);
        ...
        foreach ($dhar_case_no_list as $key => $dhar_case_no) {
            ...
            try {
                ...
                if ($status != true) {
                    ...
                    $updateStatus = $this->AllotmentCertificateModel->updateSettlementBasicTable($dhar_case_no);
    ...
    public function issued()
    {
        ...
        if (ALLOTMENT_AND_SETTLEMENT == 1) {
            $data['certificate'] = $this->AllotmentCertificateModel->getAllotmentCertificatesIssued($dist_code);
            $data['_view']       = 'allotment_certificate/issued_landing_page';
        } else {
            $data['_view'] = 'allotment_certificate/closed';
        }
        $this->load->view('layouts/main', $data);
    ...
    public function getVillagesByCircle(){
        ...
        $villages = $this->AllotmentCertificateModel->getAllVillages($dist_code, $circle_id);
        echo json_encode($villages);
    }

        public function generateCertificateTest($dist_code = '07', $dhar_case_no="KAM/PAL/2024-25/76754/SLIJE", $type="generate")
    {
  ...
  public function print_certificates_without_sign()
{
    ...
    foreach ($dhar_case_no_list as $dhar_case_no) {
        $certificate_data = $this->AllotmentCertificateModel->getCertificateData($dhar_case_no);
        $this->AllotmentCertificateModel->updatePrintStatus($dhar_case_no);
