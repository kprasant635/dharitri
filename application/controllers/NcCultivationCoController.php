<?php
class NcCultivationCoController extends CI_Controller {
    ...
    public function __construct() {
        ...
        if($user_desig_code != MB_CIRCLE_OFFICER){
    ...
    public function settlementTeaCo()
    {
        ...
        $url = API_LINK_NC."serviceResponseBasu?application_no=" . $basundhara->basundhara ;
        $ch = curl_init();
        ...
        $rejected_data = $this->NcCommonModel->getRejectModal(SETTLEMENT_SPECIAL_CULTIVATORS_ID);
        if($rejected_data == 'n')
        {
        ...
        $lmdata['_view'] = 'NcVillageService/NcCultivation/SettlementTeaCoView';
    ...
    public function generateNoticeCo(){
        ...
        if(isset($_POST['generate_notice'])){
            ...
            $this->load->view('NcVillageService/NcCultivation/SettlementNotice',$data);
        ...
        if(isset($_POST['print_notice'])){
            ...
            $data['_view'] = 'NcVillageService/NcCultivation/PrintNotice';
    ...
    public function saveNotice(){
        ...
        if($this->db->trans_status()==FALSE){
            ...
            redirect(base_url() . 'index.php/NcCultivationCoController/settlementTea?case='.$case_no);
        }
    }
    ...
    public function generatePaymentNoticeCo(){
        ...
        //     //$get_dag_details = $this->NcServiceModel->getSettlementDagDetails($case_no);
        //     $get_settlement_applicant = $this->NcServiceModel->getAllApplicant($case_no);
        //     $get_owners = $this->NcServiceModel->getOwners($case_no);
        //     $get_buyers = $this->NcServiceModel->getBuyers($case_no);
        //     $get_dag_details = $this->NcServiceModel->getDags($case_no);
        //     $data = [
        ...
        //     $this->load->view('NcVillageService/NcCultivation/paymentNotice',$data);
        // }else{
        ...
        // $this->db->trans_begin();
        // $settlement_premium_insertion = $this->NcCommonModel->premiumReCalculationTea($case_no);
        ...
        $data['_view'] = 'NcVillageService/NcCultivation/generateNoticeView';
        $this->load->view('layouts/main', $data);
        // }
    }
    ...
    public function generatePaymentNoticeCoSave(){
        ...
        if(isset($basic))
        {
            ...
            }elseif($basic['service_code'] == NC_CULTIVATOR_ID){
        ...
        curl_setopt($curl_handle, CURLOPT_URL, API_LINK_NC."getApplicationDate");
        ...
        $this->load->view('NcVillageService/NcCultivation/cultivation_notice', $data);
    }
    ...
    public function savePaymentNotice(){
        ...
        if($this->db->trans_status()==FALSE){
            ...
            // //   $user_status_api = $this->NcApiModel->postApiBasundharaSec($case,$rmk,$status,$task,$pen);
            // if(trim($status) != 'y'){
            //     $this->db->trans_rollback();
            //     $data=array(
            ...
            if(trim($result) != 'y'){
                ...
                redirect(base_url() . 'index.php/NcCultivationCoController/generatePaymentNoticeCo?case='.$case_no);
            }
        }
    }
