<?php
class SettlementCultivator extends CI_Controller {
    ...
    public function secondProceeding()
    {
        ...
        if($this->utilityclass->checkUserAuthForCaseForLm($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"],$basic["lot_no"]) == false){
        ...
        $applid_doc = $this->utilityclass->getApplidFromCaseNo($case_no);
        ...
        // $url = API_LINK_MB2."serviceResponse?case_no=" . $application_no ;
        ...
        if($_SERVER['REQUEST_METHOD'] != 'POST'){
            $lmdata['_view'] = 'SettlementView/Lm/Tea/SettlementTeaView';
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if($distCode == NULL)
            {
                redirect(base_url(). 'index.php/home/SettlementSpecialCulLm?service='.SETTLEMENT_SPECIAL_CULTIVATORS_ID);
            }
            if($case_no == NULL)
            {
                redirect(base_url(). 'index.php/home/SettlementSpecialCulLm?service='.SETTLEMENT_SPECIAL_CULTIVATORS_ID);
            ...
            if($_POST['lm_note'] == '2')
            {
                ...
                { 
                    ...
                    $validation_bypass_array = $this->getValidationBypass(SETTLEMENT_SPECIAL_CULTIVATORS_ID);
            ...
            if($validation_bypass == 0)
            {
                ...
                if(in_array($distCode, json_decode(BARAK_VALLEY)))
                {
                    foreach ($dags as $dag)
                    {
                        ...
                        //******NCBTAD check  */
                        $ncBtadCheck = $this->SettlementCommonModel->ncBtadCheck($dag->dist_code, $dag->subdiv_code, $dag->cir_code, $dag->mouza_pargona_code, $dag->lot_no, $dag->vill_townprt_code, $dag->dag_no);
                        ...
                        $bighaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_b'.$dag->dag_no), 0);
                        $kathaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_k'.$dag->dag_no), 0);
                        $lessaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_lc'.$dag->dag_no), 0);
                        $gandaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_g'.$dag->dag_no), 0);
    
                        $bighaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_b'.$dag->dag_no), 0);
                        $kathaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_k'.$dag->dag_no), 0);
                        $lessaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_lc'.$dag->dag_no), 0);
                        $gandaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_g'.$dag->dag_no), 0);
    
                        $bighaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_b'.$dag->dag_no), 0);
                        $kathaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_k'.$dag->dag_no), 0);
                        $lessaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_lc'.$dag->dag_no), 0);
                        $gandaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_g'.$dag->dag_no), 0);
                        ...
                        if (trim($roadside_comment_check)=='YES') {
                            ...
                            $bighaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_bigha'.$dag->dag_no), 0);
                            $kathaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_katha'.$dag->dag_no), 0);
                            $lessaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_lessa'.$dag->dag_no), 0);
                            $gandaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_ganda'.$dag->dag_no), 0);
                        ...
                        if ($family_comment_check=='YES') {
                            ...
                            $bighaValidationFamily = $this->UtilsModel->defaultValue($this->input->post('reserved_bigha_family'.$dag->dag_no), 0);
                            $kathaValidationFamily = $this->UtilsModel->defaultValue($this->input->post('reserved_katha_family'.$dag->dag_no), 0);
                            $lessaValidationFamily = $this->UtilsModel->defaultValue($this->input->post('reserved_lessa_family'.$dag->dag_no), 0);
                            $gandaValidationFamily = $this->UtilsModel->defaultValue($this->input->post('reserved_ganda_family'.$dag->dag_no), 0);
                ...
                else
                {
                    ...
                    {
                        //******NCBTAD check  */
                        $ncBtadCheck = $this->SettlementCommonModel->ncBtadCheck($dagV->dist_code, $dagV->subdiv_code, $dagV->cir_code, $dagV->mouza_pargona_code, $dagV->lot_no, $dagV->vill_townprt_code, $dagV->dag_no);
                        ...
                        $bighaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_b'.$dagV->dag_no), 0);
                        $kathaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_k'.$dagV->dag_no), 0);
                        $lessaValidation = $this->UtilsModel->defaultValue($this->input->post('dag_area_lc'.$dagV->dag_no), 0);
    
                        $bighaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_b'.$dagV->dag_no), 0);
                        $kathaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_k'.$dagV->dag_no), 0);
                        $lessaValidationHome = $this->UtilsModel->defaultValue($this->input->post('home_lc'.$dagV->dag_no), 0);
    
                        $bighaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_b'.$dagV->dag_no), 0);
                        $kathaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_k'.$dagV->dag_no), 0);
                        $lessaValidationAgr = $this->UtilsModel->defaultValue($this->input->post('agri_lc'.$dagV->dag_no), 0);
                        ...
                        if (trim($roadside_comment_check)=='YES') {
                            ...
                            $bighaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_bigha'.$dagV->dag_no), 0);
                            $kathaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_katha'.$dagV->dag_no), 0);
                            $lessaValidationRoadside = $this->UtilsModel->defaultValue($this->input->post('reserved_lessa'.$dagV->dag_no), 0);
            ...
            if ($this->form_validation->run() == FALSE)
            {
                ...
                redirect(base_url(). 'index.php/SettlementCultivator/secondProceeding?case='.$this->utilityclass->encryptJwtCase($case_no));
            ...
            else
            {
                ...
                if($validation_bypass == 0)
                {
                        ...
                        for($i = 0; $i < $fileCount; $i++)
                        {
                            ...
                            if ($this->upload->do_upload('file'))
                            {
                                $document= array(
                                    ...
                                    'mut_type'   => SETTLEMENT_SPECIAL_CULTIVATORS_ID,
                                );
                    ...
                    if(NRC_FILE_UPLOAD_ENABLED ==1)
                    {
                        ...
                        $service_code = SETTLEMENT_SPECIAL_CULTIVATORS;
                    ...
                    $responseMasterObj = $this->SettlementCommonModel->lmRejectedValidationBypassFalse(SETTLEMENT_SPECIAL_CULTIVATORS_ID); 
                    ...
                    if($is_prem_update=='YES'){
                        ...
                        foreach ($dags as $premdags) {
                            ...
                            if (in_array($premdags->dist_code, json_decode(BARAK_VALLEY))){
                                $area_in_bigha=6400;
                                $max_area_concession=192000;
                            }else{
                                $area_in_bigha=100;
                                $max_area_concession=3000;
                            }
                            if($board_for_prem=="TEA"){

                                if ($total_settlement_area_prem < $max_area_concession){
                                ...
                                if ($total_settlement_area_prem < $max_area_concession){
                                    ...
                                    // $amount =ceil($premium * $percentage / 100);
                                    // $sumMbAmount += $amount;
                                    $per_lessa_rate = 5000/$area_in_bigha;
                                    $amount = ceil($totlessa * $per_lessa_rate);
                                    $sumMbAmount += $amount;
                                }else{
                                    $is_full_pay=$this->input->post('paymode');
                ...
                if($validation_bypass == 1)
                {
                   ...
                   $this->SettlementCommonModel->secondProceedingValidationBypassTrue(
                        SETTLEMENT_SPECIAL_CULTIVATORS_ID, 
                        $case_no, 
                        $application_no, 
    ...
    public function settlementApplication($review_flag = false)
    {
        $this->db=$this->load->database('db2', TRUE);
        $lmdata['district_all'] = $this->db->query("Select * from district_details")->result();
        ...
        try{
            ...
            $lmdata['document']=$output->documents;
            $lmdata['query']=$output->query;
            $lmdata['property']    = $this->SettlementKhasModel->getAdditionalProperty($case_no);
            $lmdata['aadhar']    = $this->SettlementKhasModel->getMainApplicant($case_no);
            foreach($output->selfDeclaration as $selfDec){
                $lmdata['selfDeclarationDetails']=json_decode($selfDec->dec_details);
            }
        ...
        if($_SERVER['REQUEST_METHOD'] != 'POST'){
            $lmdata['_view'] = 'SettlementView/SettlementCultivatorsView';
            $this->load->view('layouts/main',$lmdata);
        }
