...
class SettlementApSdo extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('SettlementMb/SettlementApSdoModel');
...
//********************** COMMON **********************************
    ...
    function randomFileName()
    {
        ...
        if($this->SettlementApSdoModel->checkDuplicateFileNameInProposal($new_case_no) != 0)
        {
            $this->randomFileName();
        }
        else
    ...
    public function applicationRevertFromDCToCO()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementApSdoModel->countSettlementApplicationDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            ...
            else
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementApSdoModel->updateSettlementBasicData($case_no,$dist_code,$subDiv_code,$updateData)== 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
    ...
    public function applicationRejectedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementApSdoModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code,$subDiv_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $mmnn = $this->SettlementApSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
                    ...
                    foreach($applicants_encroacher as $applicant_enc){
                        ...
                        if($enc_check->num_rows() > 0){
                            ...
                            if($sql_land_bank->num_rows() > 0){
                                ...
                                $lb_approval_rmk = "Approved by SDO";

                                $insertVLBquery = $this->SettlementApSdoModel->lbdetailsApproveSettlementCases($lb_details_id,$elb_enc_id,$uuid,$dag_no,$application_no,$lb_approval_rmk);
    ...
    public function applicationApprovedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount      = $this->SettlementApSdoModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code,$subDiv_code);
            $caseCountInPro = $this->SettlementApSdoModel->countSettlementAppDetailsByCaseNoUnderProposal($case_no);
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->SettlementApSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function viewPaymentReceivedAppDetailsByDc()
    {
        ...
        $subDiv_code = $this->session->userdata('subdiv_code');
        $this->utilityclass->checkUserAuthForCaseForSdo($case_no);
        $caseCount = $this->SettlementApSdoModel->countSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
        ...
        {
            $caseDetails = $this->SettlementApSdoModel->getSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            $proceedings = $this->SettlementApSdoModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;

            $data['_view'] = 'settlementView/Sdo/Ap/payment_received_app_details_ap';
...
//********************** COMMON **********************************
    ...
    // view all first Proceeding case list AP SDO
    public function viewAllApFirstProceedingDCCaseList()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getAllPendingSettlementAp($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/first_proceeding_case_dc_ap';

        $this->load->view('layouts/main', $data);

    }

    // settlement application details AP SDO
    public function getSettlementApApplicationDetails()
    {
        ...
        else
        {
            ...
            $caseDetails = $this->SettlementApSdoModel->getSettlementApplicationDetailsByCaseNo($case_no,$dist_code,$subDiv_code);
            $proceedings = $this->SettlementApSdoModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
            ...
            $data['_view'] = 'settlementView/Sdo/Ap/settlement_app_details_ap';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    public function SettlementApLandDc()
    {
        ...
        // todo
        $firstProceedingCount = $this->SettlementApSdoModel->countAllPendingSettlementAp($dist_code,$subDiv_code);
        $SDLACCommitteeCount  = $this->SettlementCommonDcModel->countAllSDLACCommitteeMember($dist_code,$user_code,$user_desig_code);
        $SDLACNoticeCount     = $this->SettlementApSdoModel->countMarkAsSDLACSettlementAp($dist_code,$subDiv_code);
        $SDLACReportCount     = $this->SettlementApSdoModel->countAllProposalSendByDcToSdlacAp($dist_code,$subDiv_code);
        $caseStatusCount      = 0;
        $sdlacMemberApproval  = $this->SettlementApSdoModel->countSdlacStatusList($dist_code,$subDiv_code);
        $SDLACConsideration   = $this->SettlementApSdoModel->countAllUnderConsiderationAppAp($dist_code,$subDiv_code);

//        $reReportByCOCount    = $this->SettlementApSdoModel->countReRevertedByCoApplicationAp($dist_code,$subDiv_code);
//        $approvedListCount    = $this->SettlementApSdoModel->countAllApproveAppBySdlacAp($dist_code,$subDiv_code);
//        $rejectedListCount    = $this->SettlementApSdoModel->countAllRejectAppByDcAp($dist_code,$subDiv_code);
//        $finalVerifyCaseCount = $this->SettlementApSdoModel->countAllCasesForFinalVerifyAppAp($dist_code,$subDiv_code);
//        $revertedByDepartmentCount = $this->SettlementApSdoModel->countRevertedByDeptApplicationAp($dist_code,$subDiv_code);
//        $chithaUpdateOrderCount    = $this->SettlementApSdoModel->countAllOrderChithaUpdateAppAp($dist_code,$subDiv_code);
        ...
        $coRejectedListCount = $this->SettlementCommonDcModel->countCoRejectedCaseForSDO($dist_code,$subDiv_code,SETTLEMENT_AP_TRANSFER_ID);

        $coModificationListCount = $this->SettlementPullModel->countCoModificationRequestCaseForSDO($dist_code,$subDiv_code,SETTLEMENT_AP_TRANSFER_ID);

        $rejctedListCount = $this->SettlementCommonDcModel->rejectedCaseListSDO($dist_code,$subDiv_code, SETTLEMENT_AP_TRANSFER_ID, MB_SUB_DIV_COMM);
        $revivalListCount = $this->SettlementCommonDcModel->revivalListCountSDO($dist_code, $subDiv_code, SETTLEMENT_AP_TRANSFER_ID, MB_SUB_DIV_COMM);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/first_landing_page_dc_ap';
        $this->load->view('layouts/main', $data);

    }

    // view all mark as SDLAC AP SDO
    public function viewAllMarkAsSDLACListForDCAp()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getMarkAsSDLACSettlementAp($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/mark_as_sdlac_case_dc_ap';
        $this->load->view('layouts/main', $data);
    ...
    public function generateNoticeSendAllMarkAppToSDLACByDcAp()
    {
        ...
        else
        {
            ...
            if(!empty($allSelectedList))
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementApSdoModel->saveProposalSDLACAp($dataProSave) == 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
                ...
                else
                {
                    ...
                    foreach ($allSelectedList as $row)
                    {
                        ...
                        if($this->SettlementApSdoModel->saveProposalCaseListSDLACAp($saveCaseList) == 0)
                        {
                            //$this->SettlementApSdoModel->deleteProposalSDLAC($proposalId);
                            $this->db->trans_rollback();
                            echo json_encode(array(
                                'responseType' => 1,
                            ));
    ...
    public function getAllUnderConSdlacAp()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getAllUnderConSettlementAp($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Ap/under_consideration_case_dc_ap';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllProposalListSdlacAp()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getAllProposalSendByDcToSdlacAp($dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/proposal_list_send_to_sdlac_ap';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllApplicationInReportSendByDcToSdlacAp()
    {
        ...
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getAllAppInReportSendByDcToSdlacAp($proposal_no);
        $proposalDetails = $this->SettlementApSdoModel->getProposalDetailsById($proposal_no,$dist_code,$subDiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/send_to_sdlac_case_dc_ap';
        $this->load->view('layouts/main', $data);
    ...
    public function checkForSdlacStatus() {
        ...
        $processStatus = $this->db->query("SELECT * FROM settlement_proposal_list
                                    WHERE sdlac_prceed_status ".PROPOSAL_SEND_TO_SDLAC." AND dist_code = ? 
                                      AND id = ? AND subdiv_code = ? AND created_by = ? ",
    ...
    public function updateProposalHearingDateAp()
    {
        ...
        else
        {
            ...
            $allCases      = $this->SettlementApSdoModel->getAllAppInReportSendByDcToSdlacAp($proposalNo);
    ...
    public function getAllReReportAppByCOForDcAppAp()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subDiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getReRevertedByCoApplicationAp($dist_code,$subDiv_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Sdo/Ap/re_revert_by_co_list_ap';
        $this->load->view('layouts/main', $data);
    }
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementApSdo/getSettlementApApplicationDetails/?case='.$rows->case_no.'">
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementApSdo/getSettlementApApplicationDetails/?case='.$rows->case_no.'">View Application</a>'
                );
                ...
                $json[] = array (
                  ...
                  <div class="text-green" id="list_of_cases_'.$rows->id.'"></div>',
                    ...
                    '<a class="btn btn-sm btn-primary" target= "SDLACProposalNotice" href="'.base_url().'index.php/SettlementCommonDc/getProposalNotice/?case='.$rows->id.'">Print Notice</a>
                     ...
                     <a class="btn btn-sm btn-success" href="'.base_url().'index.php/SettlementApSdo/getAllApplicationInReportSendByDcToSdlacAp/?case='.$rows->id.'">
                      '.$this->lang->line('process').'</a>'
    ...
    // get all forth proceeding SDLAC Report ap page
    public function getAllSdlacMemberApprovalProposalListAp()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subdiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementApSdoModel->getSdlacApprovalProposalListAp($dist_code,$subdiv_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/sdlac_approval_proposal_list_ap';
        $this->load->view('layouts/main', $data);
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                <div class="text-green" id="list_of_cases_'.$rows->id.'"></div>',
                    ...
                    <a class="rezaButt btn-success" href="'.base_url().'index.php/SettlementApSdo/getSdlacMemberApproveProposalViewIndividualAp/?case='.$rows->id.'">
                    '.'Process'.'</a>'
    ...
    public function getSdlacMemberApproveProposalViewIndividualAp()
    {
        ...
        $suv_div     = $this->session->userdata('subdiv_code');
        $proposal_no = $this->input->get('case');
        $proposalDetails = $this->SettlementApSdoModel->getSdlacApprovalProposalIndividualAp($proposal_no,$dist_code,$suv_div);
        // SDLAC/CDLAC Member report details
        $reportDetails   = $this->SettlementApSdoModel->getSdlacMemberReportDetailsAp($proposal_no,$dist_code,$suv_div);

        $getMembersStatus = $this->SettlementApSdoModel->getSdlacMemberStatus($dist_code, $proposal_no);
        ...
        $data['_view'] = 'settlementView/Sdo/Ap/sdlac_committee_report_details_ap';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function proposalForwardToDcForFinalVerifyAp()
    {
        ...
        else
        {
            ...
            $dist_code   = $this->session->userdata('dist_code');
            $pendingCase = $this->SettlementApSdoModel->getAllAppInReportSendByDcToSdlacAp($proposal_no,$subDiv_code);
            ...
            foreach ($cases as $case)
            {
                ...
                if($case->case_status == 1 || $case->case_status == 0)
                {
                    ...
                    if($this->SettlementApSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updateCase)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                    ...
                    if($this->SettlementApSdoModel->updateSettlementBasicData($caseNo,$dist_code,$subDiv_code,$updateBasicData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                ...
                if($case->case_status == 2)
                {
                    ...
                    else
                    {
                        ...
                        $mmnn = $this->SettlementApSdoModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updatePro);
                        if($mmnn == 0)
                        {
                            $this->db->trans_rollback();
                            echo json_encode(array(
            ...
            if($this->SettlementApSdoModel->updateProposalListById($proposal_no,$dist_code,$subDiv_code,$dataUpdate)== 0)
            {
                $this->db->trans_rollback();
                echo json_encode(array(
                    'responseType' => 1,
