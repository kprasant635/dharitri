...
class BhoodanControllerAdc extends CI_Controller
{
...
//********************** COMMON **********************************
    ...
    function randomFileName()
    {
        ...
        if($this->BhoodanAdcModel->checkDuplicateFileNameInProposal($new_case_no) != 0)
        {
            $this->randomFileName();
        }
        else
    ...
    public function applicationRejectedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount = $this->BhoodanAdcModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                $this->db->trans_begin();
                if($this->BhoodanAdcModel->updateSettlementBasicData($case_no,$dist_code,$updateData)== 0)
                {
                    $this->db->trans_rollback();
                ...
                else
                {
                    ...
                    $mmnn = $this->BhoodanAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function applicationApprovedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount      = $this->BhoodanAdcModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            $caseCountInPro = $this->BhoodanAdcModel->countSettlementAppDetailsByCaseNoUnderProposal($case_no);
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->BhoodanAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function viewPaymentReceivedAppDetailsByDc()
    {
        ...
        $dist_code = $this->session->userdata('dist_code');
        $this->utilityclass->checkUserAuthForCaseForAdc($case_no);
        $caseCount = $this->BhoodanAdcModel->countSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
        ...
        {
            $caseDetails = $this->BhoodanAdcModel->getSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
            $proceedings = $this->BhoodanAdcModel->getSettlementProceeding($case_no);
    ...
    public function updateProposalHearingDateBhoodan()
    {
        ...
        else
        {
            ...
            $allCases      = $this->BhoodanAdcModel->getAllAppInReportSendByDcToSdlacKhas($proposalNo);
    ...
    public function updateHearingDateGenerateNoticeBhoodan()
    {
        ...
        else
        {
            ...
            $proposalDetails = $this->BhoodanAdcModel->getProposalDetailsById($proposalNo,$dist_code);
            if($proposalDetails == '')
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->db->trans_begin();
                    if($this->BhoodanAdcModel->updateProposalListById($proposalNo,$updateProposalData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
...
//********************** COMMON **********************************
    ...
    public function bhoodanLandAdc()
    {
        ...
        $firstProceedingCount    = $this->BhoodanAdcModel->countAllPendingBhoodanLand($dist_code);
        $SDLACCommitteeCount     = $this->SettlementCommonDcModel->countAllSDLACCommitteeMember($dist_code,$user_code,$user_desig_code);
        $SDLACNoticeCount        = $this->BhoodanAdcModel->countMarkAsSdlacBhoodanLand($dist_code);
        $SDLACReportCount        = $this->BhoodanAdcModel->countAllProposalSendByDcToSdlacBhoodan($dist_code);
        $caseStatusCount         = 0;
        $sdlacMemberApproval     = $this->BhoodanAdcModel->countSdlacStatusList($dist_code);
        $SDLACConsideration      = $this->BhoodanAdcModel->countAllUnderConsiderationAppBhoodan($dist_code);
        $coRejectedListCount     = $this->SettlementCommonDcModel->countCoRejectedCaseForADC($dist_code,BHODDAN_SERVICE_CODE);
        $rejctedListCount        = $this->SettlementCommonDcModel->rejectedCaseList($dist_code,BHODDAN_SERVICE_CODE, MB_ADD_DEPUTY_COMM);

//        $revivalListCount        = $this->SettlementCommonDcModel->revivalListCount($dist_code,BHODDAN_SERVICE_CODE, MB_ADD_DEPUTY_COMM);
//        $coModificationListCount = $this->SettlementPullModel->countCoModificationRequestCaseForADC($dist_code,BHODDAN_SERVICE_CODE);
        ...
        $data['_view'] = 'Bhoodan/ADC/first_landing_page_adc';
        $this->load->view('layouts/main', $data);
    }
    ...
    {
        $dist_code                = $this->session->userdata('dist_code');
        $pendingCase              = $this->BhoodanAdcModel->getAllPendingBhoodanLand($dist_code);
        $data['dist_code']        = $dist_code;
        ...
        $data['_view']    = 'Bhoodan/ADC/first_proceeding_case_list';
        $this->load->view('layouts/main', $data);
    }
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/BhoodanControllerAdc/getBhoodanLandApplicationDetails/?case='.$rows->case_no.'">
    ...
    public function getBhoodanLandApplicationDetails()
    {
        ...
        $caseCount = $this->BhoodanAdcModel->countSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
        if($caseCount == 0)
        {
            $this->bhoodanLandAdc();
        }
        else
        {
            ...
            $caseDetails           = $this->BhoodanAdcModel->getSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
            $proceedings           = $this->BhoodanAdcModel->getSettlementProceeding($case_no);
            $data['caseCount']     = $caseCount;
            $data['caseDetails']   = $caseDetails;
            $data['proceedings']   = $proceedings;
            ...
            $data['_view']            = 'Bhoodan/ADC/first_proceeding_app_details';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getMarkAsSdlacSettlementBhoodan($dist_code);
        ...
        $data['location'] = $circleList;
        $data['_view']    = 'Bhoodan/ADC/mark_as_sdlac_case_dc_bhoodan';
        $this->load->view('layouts/main', $data);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllUnderConSettlementKhas($dist_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'Bhoodan/ADC/under_consideration_case_dc_khas';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function generateNoticeSendAllMarkAppToSdlacByDcBhoodan()
    {
        ...
        else
        {
            ...
            if(!empty($allSelectedList))
            {
                ...
                $this->db->trans_begin();
                if($this->BhoodanAdcModel->saveProposalSdlacBhoodan($dataProSave) == 0)
                {
                    // echo $this->db->last_query();
                    $this->db->trans_rollback();
                ...
                else
                {
                    ...
                    foreach ($allSelectedList as $row)
                    {
                        ...
                        if($this->BhoodanAdcModel->saveProposalCaseListSdlacBhoodan($saveCaseList) == 0)
                        {
                            // echo $this->db->last_query(); die;
//                            $this->BhoodanAdcModel->deleteProposalSDLAC($proposalId);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllProposalSendByDcToSdlacBhoodan($dist_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'Bhoodan/ADC/proposal_list_send_to_sdlac';
        $this->load->view('layouts/main', $data);
    }
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array (
                    ...
                    <a class="btn btn-sm btn-success" href="'.base_url().'index.php/BhoodanControllerAdc/getAllApplicationInReportSendByDcToSdlacBhoodan/?case='.$rows->id.'">
                      '.$this->lang->line('process').'</a>'
    ...
    public function getAllApplicationInReportSendByDcToSdlacBhoodan()
    {
        ...
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllAppInReportSendByDcToSdlacBhoodan($proposal_no);
        $proposalDetails = $this->BhoodanAdcModel->getProposalDetailsById($proposal_no,$dist_code);
        ...
        $data['_view'] = 'Bhoodan/ADC/send_to_sdlac_case_dc';
        $this->load->view('layouts/main', $data);
    ...
    public function checkForSdlacStatus()
    {
        ...
        $processStatus = $this->db->query("SELECT * FROM settlement_proposal_list
            ...
            array($dist_code, $proposal_id, MB_ADD_DEPUTY_COMM, 3));
    ...
    public function getCasesAgainstProposalNo()
    {
        ...
        AND B.created_by=? AND B.mb_status=?",
            array($proposal_id, $dist_code, $service_code, MB_ADD_DEPUTY_COMM,3));
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllApproveAppBySdlacKhas($dist_code);
    ...
    public function viewApprovedAppDetailsBhoodan()
    {
        ...
        $caseCount = $this->BhoodanAdcModel->countSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
        if($caseCount == 0)
        {
            $this->bhoodanLandAdc();
        }
        else
        {
            ...
            $caseDetails = $this->BhoodanAdcModel->getSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
            $proceedings = $this->BhoodanAdcModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllRejectAppByDcKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getAllOrderChithaUpdateAppKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getReRevertedByCoApplicationKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->BhoodanAdcModel->getRevertedByDeptApplicationKhas($dist_code);
    ...
    public function applicationPaymentGenerateDcBhoodan()
    {
        ...
        else
        {
            ...
            $caseCount = $this->BhoodanAdcModel->caseForDcApprovalKhas($case_no,$dist_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $allCase = $this->BhoodanAdcModel->getAllCasesForFinalVerifyAppKhas($dist_code);
    ...
    public function proposalForwardToDcForFinalVerifyBhoodan()
    {
        ...
        else
        {
            ...
            $dist_code   = $this->session->userdata('dist_code');
            $pendingCase = $this->BhoodanAdcModel->getAllAppInReportSendByDcToSdlacKhas($proposal_no);
            ...
            foreach ($cases as $case)
            {
                ...
                if($case->case_status == 1)
                {
                    ...
                    if($this->BhoodanAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updateCase)== 0)
                    {
                        $this->db->trans_rollback();
                    ...
                    if($this->BhoodanAdcModel->updateSettlementBasicData($caseNo,$dist_code,$updateBasicData)== 0)
                    {
                        $this->db->trans_rollback();
                ...
                if($case->case_status == 2)
                {
                    ...
                    else
                    {
                        ...
                        $mmnn = $this->BhoodanAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updatePro);
            ...
            if($this->BhoodanAdcModel->updateProposalListById($proposal_no,$dataUpdate)== 0)
            {
                $this->db->trans_rollback();
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success btn-sm" href="'.base_url().'index.php/BhoodanControllerAdc/getBhoodanLandApplicationDetails/?case='.$rows->case_no.'">View Application</a>'
                );
    ...
    public function getAllSdlacMemberApprovalProposalListBhoodan()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subdiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->BhoodanAdcModel->getSdlacApprovalProposalListKhas($dist_code);
    ...
    public function getSdlacMemberApproveProposalViewIndividualBhoodan()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $proposal_no = $this->input->get('case');
        $proposalDetails  = $this->BhoodanAdcModel->getSdlacApprovalProposalIndividualKhas($proposal_no,$dist_code);
        $reportDetails    = $this->BhoodanAdcModel->getSdlacMemberReportDetailsKhas($proposal_no,$dist_code);
        $getMembersStatus = $this->BhoodanAdcModel->getSdlacMemberStatus($dist_code, $proposal_no);
