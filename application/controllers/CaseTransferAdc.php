<?php
class CaseTransferAdc extends CI_Controller {
	...
	function index(){
      ...
      $q="SElect use_name,user_code,dist_code from loginuser_table where dist_code='$dist_code' and dis_enb_option='E' and user_code like 'ADC%' and priv='adm' ";
      $district['adclist']=$this->db->query($q)->result();
      //var_dump($district);
      // $this->load->view('../views/header');
      // $this->load->view('../views/transfer/index',$district);
      // $this->load->view('../views/footer');
      $district['_view'] = 'transfer/adc_transfer';
	...
	function Update(){
      ...
      $this->db->query("Update petition_basic set co_user_code='$adc_usercode' , add_off_name='$adc_name->username' where dist_code='$dist_code' and (status='P' or status is null) and co_user_code like 'ADC%' and mut_type='01' and year_no >='2017' ");
      ...
      $this->session->set_flashdata('message', "ADC updated!!!");
