...
class SettlementInsSDO extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('SettlementMb/SettlementMbSDOInsModel');
...
//********************** COMMON **********************************
    ...
    function randomFileName()
    {
        ...
        if($this->SettlementMbSDOInsModel->checkDuplicateFileNameInProposal($new_case_no) != 0)
        {
            $this->randomFileName();
        }
        else
    ...
    public function applicationRevertFromDCToCO()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementMbSDOInsModel->countSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
            ...
            else
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementMbSDOInsModel->updateSettlementBasicData($case_no,$dist_code,$updateData)== 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
    ...
    public function applicationRejectedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementMbSDOInsModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $mmnn = $this->SettlementMbSDOInsModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
        ...
        else
        {
            ...
            if(SELECTED_CASES_APPROVED_BY_DEPT_DC == 1)
            {
                foreach ($allSelectedList as $case_no)
                {
                    ...
                    $this->load->model('SettlementModel/SettlementInsModel');
                    $insData   = $this->SettlementInsModel->getInstitutionDetails($case_no);
                    ...
                    $mm = 0;
                    $nn = 0;
                    if(strtoupper($dag->is_urban) == 'Y')
                    {
                        $mm = 1;
                    }
                    if($dag->is_urban == 'N' && ($insData->ins_cat_type_co == 12 || $insData->ins_cat_type_co == 9 || $insData->ins_cat_type_co == 11))
                    {
                        $nn = 1;
                    }
                }
    ...
    public function applicationApprovedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount      = $this->SettlementMbSDOInsModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            $caseCountInPro = $this->SettlementMbSDOInsModel->countSettlementAppDetailsByCaseNoUnderProposal($case_no);
            $dag = $this->SettlementCommonDcModel->getSettlementDagCommon($case_no);
            $urbanByLm = $this->SettlementCommonDcModel->getLandFallsUnderUrban($case_no);
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->SettlementMbSDOInsModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function viewPaymentReceivedAppDetailsByDc()
    {
        ...
        $dist_code = $this->session->userdata('dist_code');
        $this->utilityclass->checkUserAuthForCaseForSdo($case_no);
        $caseCount = $this->SettlementMbSDOInsModel->countSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
        ...
        {
            $caseDetails = $this->SettlementMbSDOInsModel->getSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
            $proceedings = $this->SettlementMbSDOInsModel->getSettlementProceeding($case_no);
    ...
    public function updateProposalHearingDateKhas()
    {
        ...
        else
        {
            ...
            $allCases      = $this->SettlementMbSDOInsModel->getAllAppInReportSendByDcToSdlacKhas($proposalNo);
    ...
    public function updateHearingDateGenerateNoticeKhas()
    {
        ...
        else
        {
            ...
            $proposalDetails = $this->SettlementMbSDOInsModel->getProposalDetailsById($proposalNo,$dist_code);
            if($proposalDetails == '')
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->db->trans_begin();
                    if($this->SettlementMbSDOInsModel->updateProposalListById($proposalNo,$updateProposalData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
...
//********************** COMMON **********************************
    ...
    public function SettlementInsLandDc()
    {
        ...
        $firstProceedingCount = $this->SettlementMbSDOInsModel->countAllPendingSettlementKhas($dist_code);
        $SDLACCommitteeCount  = $this->SettlementCommonDcModel->countAllSDLACCommitteeMember($dist_code,$user_code,$user_desig_code);
        $SDLACNoticeCount     = $this->SettlementMbSDOInsModel->countMarkAsSDLACSettlementKhas($dist_code);
        $SDLACReportCount     = $this->SettlementMbSDOInsModel->countAllProposalSendByDcToSdlacKhas($dist_code);
        $caseStatusCount      = 0;
        $sdlacMemberApproval  = $this->SettlementMbSDOInsModel->countSdlacStatusList($dist_code);
        $coRejectedListCount  = $this->SettlementCommonDcModel->countCoRejectedCaseForSDO($dist_code,$subdiv_code,SLIJE_ID);
        $rejctedListCount     = $this->SettlementCommonDcModel->rejectedCaseListSDO($dist_code,$subdiv_code,SLIJE_ID, MB_SUB_DIV_COMM);

//        $SDLACConsideration      = $this->SettlementMbSDOInsModel->countAllUnderConsiderationAppKhas($dist_code);
//        $coModificationListCount = $this->SettlementPullModel->countCoModificationRequestCaseForADC($dist_code,SLIJE_ID);
//        $revivalListCount        = $this->SettlementCommonDcModel->revivalListCount($dist_code,SLIJE_ID, MB_SUB_DIV_COMM);
...
//        $data['_view'] = 'settlementView/Sdo/Ins/first_landing_page_dc_khas_ins';
        $this->load->view('layouts/main', $data);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllPendingSettlementKhas($dist_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ins/first_proceeding_case_dc_khas_ins';
        $this->load->view('layouts/main', $data);
    ...
    public function getSettlementInsApplicationDetails()
    {
        ...
        else
        {
            ...
            $caseDetails = $this->SettlementMbSDOInsModel->getSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
            $proceedings = $this->SettlementMbSDOInsModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
            ...
            $data['_view'] = 'settlementView/Sdo/Ins/settlement_app_details_khas_ins';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getMarkAsSDLACSettlementKhas($dist_code);
...
//         dd($commMembers);
        ...
        $data['location'] = $circleList;
        $data['_view']    = 'settlementView/Sdo/Ins/mark_as_sdlac_case_dc_khas_ins';
        $this->load->view('layouts/main', $data);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllProposalSendByDcToSdlacKhas($dist_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ins/proposal_list_send_to_sdlac_khas_ins';
        $this->load->view('layouts/main', $data);
    }
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllUnderConSettlementKhas($dist_code);
    ...
    public function getAllApplicationInReportSendByDcToSdlacKhas()
    {
        ...
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllAppInReportSendByDcToSdlacKhas($proposal_no);
        $proposalDetails = $this->SettlementMbSDOInsModel->getProposalDetailsById($proposal_no,$dist_code);
        ...
        $data['_view'] = 'settlementView/Sdo/Ins/send_to_sdlac_case_dc_khas_ins';
        $this->load->view('layouts/main', $data);
    ...
    public function generateNoticeSendAllMarkAppToSDLACByDcKhas()
    {
        ...
        else
        {
            ...
            if(!empty($allSelectedList))
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementMbSDOInsModel->saveProposalSDLACKhas($dataProSave) == 0)
                {
                    $this->db->trans_rollback();
                ...
                else
                {
                    ...
                    foreach ($allSelectedList as $row)
                    {
                        ...
                        if($this->SettlementMbSDOInsModel->saveProposalCaseListSDLACKhas($saveCaseList) == 0)
                        {
//                            $this->SettlementMbSDOInsModel->deleteProposalSDLAC($proposalId);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllApproveAppBySdlacKhas($dist_code);
    ...
    public function viewApprovedAppDetailsKhas()
    {
        ...
        $caseCount = $this->SettlementMbSDOInsModel->countSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
        if($caseCount == 0)
        {
            $this->SettlementInsLandDc();
        }
        else
        {
            ...
            $caseDetails = $this->SettlementMbSDOInsModel->getSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
            $proceedings = $this->SettlementMbSDOInsModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllRejectAppByDcKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getAllOrderChithaUpdateAppKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getReRevertedByCoApplicationKhas($dist_code);
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getRevertedByDeptApplicationKhas($dist_code);
    ...
    public function applicationPaymentGenerateDcKhas()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementMbSDOInsModel->caseForDcApprovalKhas($case_no,$dist_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
    ...
    {
        $dist_code   = $this->session->userdata('dist_code');
        $allCase = $this->SettlementMbSDOInsModel->getAllCasesForFinalVerifyAppKhas($dist_code);
        ...
        else
        {
            ...
            foreach ($cases as $case)
            {
                ...
                if($case->case_status == 1)
                {
                    ...
                    if($this->SettlementMbSDOInsModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updateCase)== 0)
                    {
                        $this->db->trans_rollback();
                    ...
                    if($this->SettlementMbSDOInsModel->updateSettlementBasicData($caseNo,$dist_code,$updateBasicData)== 0)
                    {
                        $this->db->trans_rollback();
                ...
                if($case->case_status == 2)
                {
                    ...
                    else
                    {
                        ...
                        $mmnn = $this->SettlementMbSDOInsModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updatePro);
            ...
            if($this->SettlementMbSDOInsModel->updateProposalListById($proposal_no,$dataUpdate)== 0)
            {
                $this->db->trans_rollback();
    ...
    public function InsfirstProceedingPaginationAPI()
    {
        ...
        $this->db->where('settlement_basic.subdiv_code', $this->session->userdata('subdiv_code'));
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementInsSDO/getSettlementInsApplicationDetails/?case='.$rows->case_no.'">
    ...
    public function secondProceedingSdlacRecommendedMarked()
    {
        ...
        if(!empty($approvedBy))
        {
            if ($approvedBy == 1) // department
            {
                $this->db->where("(trim(settlement_basic.approve_by)='GOVT' or
                            (trim(settlement_basic.approve_by) is null and (t.is_urban='Y'))" );
            }
            if($approvedBy == 2) // DC
            {
                $this->db->where("(trim(settlement_basic.approve_by)='DC' or
                            (trim(settlement_basic.approve_by) is null)" );
            }
        }
        $this->db->limit($length, $start);
        $query = $this->db->get();
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                // else
                // {
                // if(strtoupper($rows->is_urban) == 'N' && ($rows->ins_cat_type_co == 9 || $rows->ins_cat_type_co == 11)
                // {
                //     $approved_by = "<span style='color:green'>DC</span>";
                // }
                // else
                // {
                //     $approved_by = "<span style='color:red'>DEPARTMENT</span>";
                ...
                if(strtoupper($rows->is_urban) == 'N')
                {
                    if($rows->ins_cat_type_co == 9 && $rows->state_warehousing_corporation == 'Y' && $rows->already_alloted == 'N')
                    {
                        $approved_by = "<span style='color:green'>DC</span>";
                    }
                    else if(($rows->ins_cat_type_co == 10 || $rows->ins_cat_type_co == 11) && ($rows->central_health_education_skill_sector ==  'Y' || $rows->central_cwc_sector ==  'Y'))
                    {
                        $approved_by = "<span style='color:green'>DC</span>";
                    }
                    else
                    {
                        $approved_by = "<span style='color:purple'>DEPARTMENT(R)</span>";
                    }
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success btn-sm" href="'.base_url().'index.php/SettlementInsSDO/getSettlementInsApplicationDetails/?case='.$rows->case_no.'">View Application</a>'
                );
    ...
    public function thirdProceedingSdlacReport()
    {
        ...
        if(!empty($by_case_no)) { //join table settlement_proposal_cases            
            ...
            $this->db->where('settlement_proposal_list.subdiv_code', $this->session->userdata('subdiv_code'));
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array (
                    ...
                    <a class="btn btn-sm btn-success" href="'.base_url().'index.php/SettlementInsSDO/getAllApplicationInReportSendByDcToSdlacKhas/?case='.$rows->id.'">
                      '.$this->lang->line('process').'</a>'
    ...
    public function checkForSdlacStatus() {
        ...
        $processStatus = $this->db->query("SELECT * FROM settlement_proposal_list
            ...
            array($dist_code, $proposal_id, MB_SUB_DIV_COMM));
    ...
    public function getAllSdlacMemberApprovalProposalListKhas()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $subdiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementMbSDOInsModel->getSdlacApprovalProposalListKhas($dist_code);
    ...
    public function getSdlacMemberApproveProposalViewIndividualKhas()
    {
        $dist_code   = $this->session->userdata('dist_code');
        $proposal_no = $this->input->get('case');
        $proposalDetails  = $this->SettlementMbSDOInsModel->getSdlacApprovalProposalIndividualKhas($proposal_no,$dist_code);
        $reportDetails    = $this->SettlementMbSDOInsModel->getSdlacMemberReportDetailsKhas($proposal_no,$dist_code);
        $getMembersStatus = $this->SettlementMbSDOInsModel->getSdlacMemberStatus($dist_code, $proposal_no);
    ...
    public function getCasesAgainstProposalNo(){
        ...
        AND B.created_by=?",
            array($proposal_id, $dist_code, $service_code, MB_SUB_DIV_COMM));
