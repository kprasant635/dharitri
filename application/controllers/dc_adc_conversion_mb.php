...
class dc_adc_conversion_mb extends CI_Controller {
...
//        $this->load->view('../views/footer');
    ...
    public function TestFinalForm() {
        ...
        var_dump("ERRSESSION004: Please Contact Administartor"); die;
        //$patta_no = trim($this->session->userdata('patta_no'));
...
//                    $saperating_bigha = $remaining_lessa-($b*100);
    ...
    //    die();
       ...
       $patta_no = trim($this->session->userdata('patta_no'));
       $dag = $this->session->userdata('dag_no');
       var_dump("ERRSESSION005: Please Contact Administartor"); die;
       $patta_type = $this->session->userdata('patta_type');
    ...
    public function FinalSaveTest() {
        ...
        $patta_no = trim($this->session->userdata('patta_no'));
        $dag = $this->session->userdata('dag_no');
        var_dump("ERRSESSION006: Please Contact Administartor"); die;
        $patta_type = $this->session->userdata('patta_type');
            ...
            foreach ($pattdars as $p) {
                ...
                if ($chitha_basic_update == FALSE) {
                    ...
                    $where = [
                        ...
                        'vill_townprt_code'  => $ord->vill_townprt_code,
                        'dag_no'             => $ord->dag_no,
                        'patta_no'           => trim($ord->patta_no),  // Replicating TRIM(patta_no)=trim(...)
                ...
                $where = [
                    ...
                    'pdar_id'            => $ord->pdar_id,
                    'patta_type_code'    => $ord->patta_type_code,
                    'patta_no'           => trim($ord->patta_no), // trim applied in PHP
                ];
            ...
            foreach ($pattdars as $p) {
                ...
                if ($chitha_basic_update == FALSE) {
                    ...
                    $where = [
                        ...
                        'vill_townprt_code'  => $ord->vill_townprt_code,
                        'dag_no'             => $ord->dag_no,
                        'patta_no'           => trim($ord->patta_no),  // PHP trim to mimic SQL TRIM()
                        'patta_type_code'    => $ord->patta_type_code,
                    ];
