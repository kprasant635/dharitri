...
class SettlementProposalControllerInsSdo extends CI_Controller
{
    ...
    public function commonProposalListView()
    {
        ...
        $pendingCase              = $this->SettlementCommonDcModel->getPendingProposalsOfSdoMbTin($dist_code,$createdBy);
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();
        $data['countPendingCase'] = $this->SettlementCommonDcModel->getPendingProposalsReadyForMeetingSdoMbTin($dist_code,MB_SUB_DIV_COMM);
        ...
        $data['_view'] = 'SettlementView/Sdo/common_proposal_list_forward_to_dc_ins';
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                <div class="text-green" id="list_of_cases_'.$rows->id.'"></div>',
                    ...
                    <a class="btn btn-xs btn-success" style=" padding: 7px!important; margin-bottom: 5px!important" target= "SDLACProposalNotice" href="'.base_url().'index.php/SettlementProposalControllerInsSdo/proposalEditOnSdlacMinutesAdc/?case='.$rows->id.'">
    ...
    B.id=A.proposal_id WHERE A.proposal_id=? AND B.dist_code=? AND B.subdiv_code=?", array($proposal_id, $dist_code,$subDiv_code));
    ...
    public function checkAllSdlacPresentMember()
    {
        ...
        else
        {
            ...
            $proSql = $this->db->query("SELECT service_code FROM settlement_proposal_list
                                          WHERE id IN ($allProposals) AND dist_code=? AND subdiv_code=? AND mb_status=?",
                array($dist_code,$subDiv_code,3));
    ...
    public function sendProposalsToDcMinute()
    {
        ...
        $proposalDetails = $this->SettlementCommonDcModel->getAllProposalDetailsByProIdSdoMbTin($proposals);
    ...
    public function sendProposalsToDc()
    {
        ...
        // check for PGR/VGR not allowed in other proposals
        $proSql = $this->db->query("SELECT service_code FROM settlement_proposal_list
                                          WHERE id IN ($allProposalId) AND dist_code=? AND subdiv_code=? AND mb_status=?",
            array($dist_code,$subdiv_code,3));
    ...
    public function getPendingMeetingDetailsBySdoAdc()
    {
        ...
        $pendingMeeting      = $this->SettlementCommonDcModel->checkMeetingExistOrNotWithMeetingIdSdo($meetingId,$dist_code);
        ...
        if($pendingMeetingCount == 0)
        {
            ...
            redirect(base_url() . "index.php/SettlementProposalControllerInsSdo/pendingProposalList");
            $this->pendingProposalList();
        }
        else
        {
            //list of proposals against meeting id
            $proposalDetail = $this->SettlementMeetingDcInsModel->getProposalDetailAgainstMeetingIdSdoMBTin($dist_code,
                $meetingId)->result();
    ...
    public function forwardOnlineMeetingToDcForFinalVerification()
    {
        ...
        $meeting = $this->SettlementCommonDcModel->checkMeetingExistOrNotWithMeetingIdSdo($meetingId,$dist_code);
        ...
        //list of proposals against meeting id
        $getProposal = $this->SettlementMeetingDcInsModel->getProposalDetailAgainstMeetingIdSdoMBTin($dist_code,$meetingId);
    ...
    public function revertMeetingListForAdc()
    {
        ...
        $pendingCase              = $this->SettlementCommonDcModel->getRevertedMeetingListSDOMbTin($dist_code,$subDiv_code,$createdBy);
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'SettlementView/Sdo/reverted_meeting_list_adc_ins';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getProposalUnderRevertedMeetingForAdc()
    {
        ...
        $pendingMeeting      = $this->SettlementCommonDcModel->checkRevertedMeetingExistOrNotWithMeetingIdMbTin($meetingId,$dist_code,$subdiv_code);
        $pendingMeetingCount = $pendingMeeting->num_rows();

        if($pendingMeetingCount == 0)
        {
            $this->session->set_flashdata('error', "Reverted Meeting by DC Not Found !");
            redirect(base_url() . "index.php/SettlementProposalControllerInsSdo/revertMeetingListForAdc");
            $this->pendingProposalList();
        }
        else
        {
            ...
            $proposalDetail = $this->SettlementCommonDcModel->getRevertedProposalDetailAgainstMeetingIdSdoMbTin($dist_code,$meetingId);
            $commMembers    = $this->SettlementMbDcModel->getMembersFromUsersWithUserType($dist_code);
            ...
            $data['_view'] = 'SettlementView/Sdo/reverted_proposal_by_dc_list_ins';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    public function caseListUnderRevertedMeetingForAdc()
    {
        ...
        $proposalDetails = $this->SettlementCommonDcModel->getRevertedProposalDetailsByIdSdoMbTin($proposal_no,$dist_code);
        ...
        $data['_view'] = 'SettlementView/Sdo/reverted_application_by_proposal_ins';
        $this->load->view('layouts/main', $data);
    ...
    public function verifyCasesUnderRevertedMeetingByDc()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                $getProposalsList = $this->SettlementMeetingDcInsModel->getProposalDetailAgainstMeetingIdSdoMBTin($dist_code,$meetingId)->result();
    ...
    public function forwardedMeetingListForAdc()
    {
        ...
        $data['_view'] = 'SettlementView/Sdo/forwarded_meeting_list_adc_ins';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getForwardedMeetingDetailsByIdAdc()
    {
        ...
        {
            $this->session->set_flashdata('error', "Meeting Not Found !");
            redirect(base_url() . "index.php/SettlementProposalControllerInsSdo/forwardedMeetingListForAdc");
        }
        ...
        $data['_view'] = 'SettlementView/Sdo/forwarded_proposals_against_meeting_id_adc_ins';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function proposalEditOnSdlacMinutesAdc()
    {
        ...
        if($proposalDetails->meeting_create_status != 1)
        {
            ...
            redirect(base_url() . "index.php/SettlementProposalControllerInsSdo/commonProposalListView");
        }
        ...
        $data['_view'] = 'SettlementView/Sdo/edit_proposal_from_sdlac_minutes_adc_ins';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getVgrPgrRevertedCaseList()
    {
        ...
        $data['_view'] = 'SettlementView/Sdo/vgr_pgr_reverted_adc';
        $this->load->view('layouts/main', $data);
    ...
    public function getVgrPgrRevertedCaseDetails()
    {
        ...
        if($caseId == '' || $caseId == NULL)
        {
            ...
            redirect(base_url() . "index.php/SettlementProposalControllerInsSdo/getVgrPgrRevertedCaseList");
        }
        ...
        $data['_view'] = 'SettlementView/Sdo/vgr_pgr_reverted_details_adc';
        $this->load->view('layouts/main', $data);
