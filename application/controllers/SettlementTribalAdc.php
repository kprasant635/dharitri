...
class SettlementTribalAdc extends CI_Controller
{
...
//********************** COMMON **********************************
    ...
    function randomFileName()
    {
        ...
        if($this->SettlementTribalAdcModel->checkDuplicateFileNameInProposal($new_case_no) != 0)
        {
            $this->randomFileName();
        }
        else
    ...
    public function applicationRevertFromDCToCO()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementTribalAdcModel->countSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
            ...
            else
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementTribalAdcModel->updateSettlementBasicData($case_no,$dist_code,$updateData)== 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
    ...
    public function applicationRejectedBySdlac()
    {
        ...
        else
        {
            ...
            $caseCount = $this->SettlementTribalAdcModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            if($caseCount == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $mmmmm = $this->SettlementTribalAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
    ...
    public function applicationApprovedBySdlac()
    {
        ...
        else
        {
            ...
            $proposal_id = $this->input->post('proposalId');
            $caseCount   = $this->SettlementTribalAdcModel->countSettlementApplicationDetailsByCaseNoForSDLAC($case_no,$dist_code);
            $caseCountInPro = $this->SettlementTribalAdcModel->countSettlementAppDetailsByCaseNoUnderProposal($case_no);
            $dag = $this->SettlementCommonDcModel->getSettlementDagCommon($case_no);
            $urbanByLm = $this->SettlementCommonDcModel->getLandFallsUnderUrban($case_no);
            ...
            else
            {
                ...
                if($dag->is_urban == 'Y' || ($dag->is_urban == 'N' && $urbanByLm->falls_und_gmc == YES))
                {
                    ...
                    else
                    {
                        ...
                        $mmmm = $this->SettlementTribalAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($case_no,$updatePro);
                        if($mmmm == 0)
                        {
                            $this->db->trans_rollback();
                            echo json_encode(array(
    ...
    public function viewPaymentReceivedAppDetailsByDc()
    {
        ...
        $dist_code = $this->session->userdata('dist_code');
        $this->utilityclass->checkUserAuthForCaseForAdc($case_no);
        $caseCount = $this->SettlementTribalAdcModel->countSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
        ...
        {
            $this->checkingLoginUserAccessSingleUser();
            $caseDetails = $this->SettlementTribalAdcModel->getSettlementPaymentReceivedAppDetailsByCaseNo($case_no,$dist_code);
            $proceedings = $this->SettlementTribalAdcModel->getSettlementProceeding($case_no);
    ...
    public function updateProposalHearingDateTribal()
    {
        ...
        else
        {
            ...
            $allCases      = $this->SettlementTribalAdcModel->getAllAppInReportSendByDcToSdlacTribal($proposalNo);
    ...
    public function updateHearingDateGenerateNoticeTribal()
    {
        ...
        else
        {
            ...
            $proposalDetails = $this->SettlementTribalAdcModel->getProposalDetailsById($proposalNo,$dist_code);
            if($proposalDetails == '')
            {
                echo json_encode(array(
                    'responseType' => 3,
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->db->trans_begin();
                    if($this->SettlementTribalAdcModel->updateProposalListById($proposalNo,$updateProposalData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
...
//********************** COMMON **********************************
    ...
    public function SettlementTribalLandAdc()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code = $this->session->userdata('dist_code');
        $user_code = $this->session->userdata('user_code');
        ...
        $firstProceedingCount = $this->SettlementTribalAdcModel->countAllPendingSettlementTribal($dist_code);
        $SDLACCommitteeCount  = $this->SettlementCommonDcModel->countAllSDLACCommitteeMember($dist_code,$user_code,$user_desig_code);
        $SDLACNoticeCount     = $this->SettlementTribalAdcModel->countMarkAsSDLACSettlementTribal($dist_code);
        $SDLACReportCount     = $this->SettlementTribalAdcModel->countAllProposalSendByDcToSdlacTribal($dist_code);;
        $caseStatusCount      = 0;
        $sdlacMemberApproval  = $this->SettlementTribalAdcModel->countSdlacStatusList($dist_code);
        $SDLACConsideration   = $this->SettlementTribalAdcModel->countAllUnderConsiderationAppTribal($dist_code);
        $coRejectedListCount  = $this->SettlementCommonDcModel->countCoRejectedCaseForADC($dist_code,SETTLEMENT_TRIBAL_COMMUNITY_ID);
        $rejctedListCount     = $this->SettlementCommonDcModel->rejectedCaseList($dist_code,SETTLEMENT_TRIBAL_COMMUNITY_ID, MB_ADD_DEPUTY_COMM);
        $revivalListCount     = $this->SettlementCommonDcModel->revivalListCount($dist_code,SETTLEMENT_TRIBAL_COMMUNITY_ID, MB_ADD_DEPUTY_COMM);
        $coModificationListCount = $this->SettlementPullModel->countCoModificationRequestCaseForADC($dist_code,SETTLEMENT_TRIBAL_COMMUNITY_ID);
        ...
        $data['_view'] = 'settlementView/Adc/Tribal/first_landing_page_adc_tribal';
        $this->load->view('layouts/main', $data);
    ...
    public function viewAllTribalFirstProceedingADCCaseList()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllPendingSettlementTribal($dist_code);
        ...
        $data['_view'] = 'settlementView/Adc/Tribal/first_proceeding_case_adc_tribal';
        $this->load->view('layouts/main', $data);
    ...
    public function getSettlementTribalApplicationDetails()
    {
        ...
        else
        {
            ...
            $caseDetails = $this->SettlementTribalAdcModel->getSettlementApplicationDetailsByCaseNo($case_no,$dist_code);
            $proceedings = $this->SettlementTribalAdcModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
            ...
            $data['_view'] = 'settlementView/Adc/Tribal/settlement_app_details_tribal';
            $this->load->view('layouts/main', $data);
        }
    }
    ...
    public function viewAllMarkAsSDLACListForADCTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getMarkAsSDLACSettlementTribal($dist_code);
        $locationNew = array();
        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();
        ...
        $data['location'] = $circleList;
        $data['_view'] = 'settlementView/Adc/Tribal/mark_as_sdlac_case_adc_tribal';
        $this->load->view('layouts/main', $data);
    ...
    public function getAllProposalListSdlacTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllProposalSendByDcToSdlacTribal($dist_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Adc/Tribal/proposal_list_send_to_sdlac_tribal';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllUnderConSdlacTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllUnderConSettlementTribal($dist_code);

        $data['dist_code']        = $dist_code;
        $data['cases']            = $pendingCase->result();
        $data['pendingCaseCount'] = $pendingCase->num_rows();

        $data['_view'] = 'settlementView/Adc/Tribal/under_consideration_case_dc_tribal';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function getAllApplicationInReportSendByDcToSdlacTribal()
    {
        ...
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllAppInReportSendByDcToSdlacTribal($proposal_no);
        $proposalDetails = $this->SettlementTribalAdcModel->getProposalDetailsById($proposal_no,$dist_code);
        ...
        $data['_view'] = 'settlementView/Adc/Tribal/send_to_sdlac_case_dc_tribal';
        $this->load->view('layouts/main', $data);
    ...
    public function generateNoticeSendAllMarkAppToSDLACByDcTribal()
    {
        ...
        else
        {
            ...
            if(!empty($allSelectedList))
            {
                ...
                $this->db->trans_begin();
                if($this->SettlementTribalAdcModel->saveProposalSDLACTribal($dataProSave) == 0)
                {
                    $this->db->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
                ...
                else
                {
                    ...
                    foreach ($allSelectedList as $row)
                    {
                        ...
                        if($this->SettlementTribalAdcModel->saveProposalCaseListSDLACTribal($saveCaseList) == 0)
                        {
                            $this->db->trans_rollback();
//                            $this->SettlementTribalAdcModel->deleteProposalSDLAC($proposalId);
                            echo json_encode(array(
                                'responseType' => 1,
                            ));
                            return;
    ...
    public function getAllApprovedBySDLACListTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllApproveAppBySdlacTribal($dist_code);
    ...
    public function viewApprovedAppDetailsTribal()
    {
        ...
        $caseCount = $this->SettlementTribalAdcModel->countSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
        ...
        {
            $caseDetails = $this->SettlementTribalAdcModel->getSettlementAppDetailsByCaseNoOnlyView($case_no,$dist_code);
            $proceedings = $this->SettlementTribalAdcModel->getSettlementProceeding($case_no);
            $data['caseCount']   = $caseCount;
            $data['caseDetails'] = $caseDetails;
            $data['proceedings'] = $proceedings;
    ...
    public function getAllRejectByDcListTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllRejectAppByDcTribal($dist_code);
    ...
    public function getAllOrderChithaUpdateForDcAppTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getAllOrderChithaUpdateAppTribal($dist_code);
    ...
    public function getAllReReportAppByCOForDcAppTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getReRevertedByCoApplicationTribal($dist_code);
    ...
    public function getAllRevertedAppByDeptForDcAppTribal()
    {
        $this->checkingLoginUserAccessSingleUser();
        $dist_code   = $this->session->userdata('dist_code');
        $pendingCase = $this->SettlementTribalAdcModel->getRevertedByDeptApplicationTribal($dist_code);
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementTribalAdc/getSettlementTribalApplicationDetails/?case='.$rows->case_no.'">
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                $json[] = array(
                    ...
                    '<a class="btn btn-success" href="'.base_url().'index.php/SettlementTribalAdc/getSettlementTribalApplicationDetails/?case='.$rows->case_no.'">View Application</a>'
                );
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows) {
                ...
                $json[] = array (
                  ...
                  <a class="btn btn-sm btn-success" href="'.base_url().'index.php/SettlementTribalAdc/getAllApplicationInReportSendByDcToSdlacTribal/?case='.$rows->id.'">
                      '.$this->lang->line('process').'</a>'
    ...
    public function getAllSdlacMemberApprovalProposalListTribal()
    {
        ...
        $dist_code   = $this->session->userdata('dist_code');
        $subdiv_code = $this->session->userdata('subdiv_code');
        $pendingCase = $this->SettlementTribalAdcModel->getSdlacApprovalProposalListTribal($dist_code);
        ...
        $data['_view'] = 'settlementView/Adc/Tribal/sdlac_approval_proposal_list_tribal';
        $this->load->view('layouts/main', $data);
        ...
        if($query->num_rows() > 0) {
            ...
            foreach($result as $rows)
            {
                ...
                <div class="text-green" id="list_of_cases_'.$rows->id.'"></div>',
                    ...
                    <a class="rezaButt btn-success" href="'.base_url().'index.php/SettlementTribalAdc/getSdlacMemberApproveProposalViewIndividualTribal/?case='.$rows->id.'">
                    '.'Process'.'</a>'
    ...
    public function getSdlacMemberApproveProposalViewIndividualTribal()
    {
        ...
        // $suv_div     = $this->session->userdata('subdiv_code');
        $proposal_no = $this->input->get('case');
        $proposalDetails = $this->SettlementTribalAdcModel->getSdlacApprovalProposalIndividualTribal($proposal_no,$dist_code);
        // SDLAC/CDLAC Member report details
        $reportDetails   = $this->SettlementTribalAdcModel->getSdlacMemberReportDetailsTribal($proposal_no,$dist_code);

        $getMembersStatus = $this->SettlementTribalAdcModel->getSdlacMemberStatus($dist_code, $proposal_no);
        ...
        $data['_view'] = 'settlementView/Adc/Tribal/sdlac_committee_report_details_tribal';
        $this->load->view('layouts/main', $data);
    }
        ...
        else
        {
            ...
            foreach ($cases as $case)
            {
                ...
                if($case->case_status == 1 || $case->case_status == 0)
                {
                    ...
                    if($this->SettlementTribalAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updateCase)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                    ...
                    if($this->SettlementTribalAdcModel->updateSettlementBasicData($caseNo,$dist_code,$updateBasicData)== 0)
                    {
                        $this->db->trans_rollback();
                        echo json_encode(array(
                            'responseType' => 1,
                ...
                if($case->case_status == 2)
                {
                    ...
                    else
                    {
                        ...
                        $mmnn = $this->SettlementTribalAdcModel->updateSettlementAppDetailsByCaseNoUnderProposal($caseNo,$updatePro);
            ...
            if($this->SettlementTribalAdcModel->updateProposalListById($proposal_no,$dataUpdate)== 0)
            {
                $this->db->trans_rollback();
                echo json_encode(array(
                    'responseType' => 1,
