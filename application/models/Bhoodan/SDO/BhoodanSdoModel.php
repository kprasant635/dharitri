<?php
class BhoodanSdoModel extends CI_Model
{
    ...
    // get all pending settlement  cases BHOODAN
    public function getAllPendingBhoodanLand($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', BHODDAN_SERVICE_CODE);
        $this->db->where('pending_officer', MB_SUB_DIV_COMM);
    ...
    // count  all pending settlement  cases BHOODAN
    public function countAllPendingBhoodanLand($dist_code)
    {
        return $this->db->select()
    ...
    // count all Mark list for SDLAC BHOODAN
    public function countMarkAsSdlacBhoodanLand($dist_code)
    {
        return $this->db->select()
            ->where('service_code', BHODDAN_SERVICE_CODE)
            ->where('pending_officer', MB_SUB_DIV_COMM)
    ...
    // get all pending settlement  cases BHOODAN
    public function getMarkAsSdlacSettlementBhoodan($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', BHODDAN_SERVICE_CODE);
    ...
    // get all under consideration  cases BHOODAN
    ...
    // count all under consideration  cases BHOODAN
    public function countAllUnderConsiderationAppBhoodan($dist_code)
    {
        return $this->db->select()
            ->where('service_code', BHODDAN_SERVICE_CODE)
            ->where('pending_officer', MB_SUB_DIV_COMM)
    ...
    // count all report in send by DC to SDLAC BHOODAN
    ...
    // get all case under selected proposal in send by DC to SDLAC BHOODAN
    public function getAllAppInReportSendByDcToSdlacBhoodan($proposal_no)
    {
    ...
    // get all proposal list in send by DC to SDLAC BHOODAN
    public function getAllProposalSendByDcToSdlacBhoodan($dist_code)
    {
        $this->db->select('*');
    ...
    // count all proposal list in send by ADC to SDLAC BHOODAN
    public function countAllProposalSendByDcToSdlacBhoodan($dist_code)
    {
        return $this->db->select()
            ->where('service_code', BHODDAN_SERVICE_CODE)
    ...
    public function saveProposalSdlacBhoodan($data)
    {
        $this->db->set('created_at', 'NOW()', FALSE);
        $this->db->set('updated_at', 'NOW()', FALSE);
        $this->db->set('service_code',BHODDAN_SERVICE_CODE );
    ...
    public function saveProposalCaseListSdlacBhoodan($data)
    {
        $this->db->set('created_at', 'NOW()', FALSE);
        $this->db->set('updated_at', 'NOW()', FALSE);
    ...
    // count all approve list BHOODAN
    ...
    // count all rejected list by Dc BHOODAN
    ...
    // Count all chitha update application BHOODAN
    ...
    // get all chitha update application BHOODAN
    ...
    // count all Reverted By DEPARTMENT case for DC BHOODAN
    ...
    // get all Reverted By DEPARTMENT case for DC BHOODAN
    ...
    // count all Re-Reverted By CO case for DC BHOODAN
    ...
    // get all Re-Reverted By CO case for DC BHOODAN
    ...
    // Count all final verify by dc application list BHOODAN
    ...
    // get all final verify by dc application list BHOODAN
    ...
    // Count all Sdlac Status List BHOODAN
    ...
    // get single proposal list in send by DC to SDLAC BHOODAN
    ...
    public function getSdlacMemberReportDetailsKhas($proposal_no,$dist_code)
    {
        ...
        $this->db->where('settlement_sdlac_member_report.service_code', BHODDAN_SERVICE_CODE);
        $data = $this->db->get();
        return $data;

    }

    // get SDLAC/CDLAC Member Status List BHOODAN
