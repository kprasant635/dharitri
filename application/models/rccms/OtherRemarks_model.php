...
class OtherRemarks_model extends CI_Model {

    protected $table = 'rccms_land_other_remarks';
    ...
    public function insert($data){
        ...
        if ($tstatus != 1) {
            ...
            log_message(
                "error",
                "#ERRRCCMS002_Other_Remark, Error inserting into {$this->table}. Query: "
                . json_encode($this->db->last_query())
            );

            return [
                'result' => 'SERVER-ERROR',
                'msg' => 'Some error occurred, Error-Code : #ERRRCCMS002_Other_Remark'
            ];
        }
