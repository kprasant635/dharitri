<?php
class SettlementTenantSdoModel extends CI_Model
{
    ...
    public function countAllPendingSettlementTenant($dist_code,$suv_div)
    {
        return $this->db->select()
    ...
    public function countAllApproveAppBySdlacTenant($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
    ...
    public function countAllRejectAppByDcTenant($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
            ->where('from_office', MB_DEPUTY_COMM)
    ...
    public function paymentConfirmNoticeCount($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
            ->where('from_office', MB_DEPUTY_COMM)
    ...
    public function paymentReceivedCount($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
            ->where('from_office', MB_DEPUTY_COMM)
    ...
    public function countRevertedByDeptApplicationTenant($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
    ...
    public function countReRevertedByCoApplicationTenant($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_TENANT_ID)
            ->where('from_office', MB_CIRCLE_OFFICER)
    ...
    public function lotCount($dist_code,$suv_div)
    {
    ...
    public function exlReportGenCount($dist_code,$suv_div)
    {
        ...
        $this->db->where('settlement_basic.subdiv_code', $suv_div);
