<?php
class SettlementTeaDcModel extends CI_Model
{
    ...
    public function getAllPendingSettlementTea($dist_code)
    {
        $this->db->select('*');
    ...
    // count all report in send by DC to SDLAC TEA
    public function countAllAppInReportSendByDcToSdlacTea($dist_code)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('pending_officer', MB_DEPUTY_COMM)
    ...
    // get all case under selected proposal in send by DC to SDLAC TEA
    ...
    public function getAllApproveAppBySdlacTea($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function getAllRejectAppByDcTea($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function getAllOrderChithaUpdateAppTea($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // get all Reverted By DEPARTMENT case for DC TEA
    public function getRevertedByDeptApplicationTea($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // get all Re-Reverted By CO case for DC TEA
    public function getReRevertedByCoApplicationTea($dist_code)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function countAllCasesForFinalVerifyAppTea($dist_code)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('dist_code', $dist_code)
    ...
    // get all Sdlac Status List KHAS
