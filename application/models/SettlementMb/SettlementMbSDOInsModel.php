<?php
class SettlementMbSDOInsModel extends CI_Model
{
    ...
    public function getAllAppInReportSendByDcToSdlacKhas($proposal_no)
    {
        ...
        settlement_basic.dist_code,settlement_basic.subdiv_code,settlement_basic.cir_code,settlement_institution_details.ins_cat_type_co');
