<?php
class SettlementTeaSdoModel extends CI_Model
{
    ...
    public function getAllPendingSettlementTea($dist_code,$suv_div)
    {
        $this->db->select('*');
    ...
    public function countAllPendingSettlementTea($dist_code,$suv_div)
    {
        return $this->db->select()
    ...
    public function countMarkAsSDLACSettlementTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('pending_officer', MB_SUB_DIV_COMM)
    ...
    // get all pending settlement  cases Tea
    public function getMarkAsSDLACSettlementTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function getAllUnderConSettlementTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function countAllUnderConsiderationAppTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('pending_officer', MB_SUB_DIV_COMM)
    ...
    // count all report in send by SDO to SDLAC Tea
    public function countAllAppInReportSendByDcToSdlacTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('pending_officer', MB_SUB_DIV_COMM)
    ...
    // get all proposal list in send by SDO to SDLAC Tea
    public function getAllProposalSendByDcToSdlacTea($dist_code,$suv_div)
    {
        $this->db->select('*');
    ...
    // get all proposal list in send by DC to SDLAC Tea
    public function getSdlacApprovalProposalListTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_proposal_list');
    ...
    // count all proposal list in send by SDO to SDLAC Tea
    public function countAllProposalSendByDcToSdlacTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('status', 1)
    ...
    public function getSdlacMemberReportDetailsTea($proposal_no,$dist_code)
    {
    ...
    // get single proposal list in send by DC to SDLAC Tea
    public function getSdlacApprovalProposalIndividualTea($proposal_no,$dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_proposal_list');
    ...
    public function saveProposalCaseListSDLACTea($data)
    {
        $this->db->set('created_at', 'NOW()', FALSE);
        $this->db->set('updated_at', 'NOW()', FALSE);
    ...
    public function countAllApproveAppBySdlacTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
    ...
    // get all approve list Tea
    public function getAllApproveAppBySdlacTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // count all rejected list by SDO Tea
    public function countAllRejectAppByDcTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('from_office', MB_SUB_DIV_COMM)
    ...
    // get all rejected list Tea
    public function getAllRejectAppByDcTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    public function countAllOrderChithaUpdateAppTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('from_office', MB_CIRCLE_OFFICER)
    ...
    // get all chitha update application Tea
    public function getAllOrderChithaUpdateAppTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // count all Reverted By DEPARTMENT case for SDO Tea
    public function countRevertedByDeptApplicationTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
    ...
    // get all Reverted By DEPARTMENT case for SDO Tea
    public function getRevertedByDeptApplicationTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // count all Re-Reverted By CO case for SDO Tea
    public function countReRevertedByCoApplicationTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('from_office', MB_CIRCLE_OFFICER)
    ...
    // get all Re-Reverted By CO case for SDO Tea
    public function getReRevertedByCoApplicationTea($dist_code,$suv_div)
    {
        $this->db->select('*');
        $this->db->from('settlement_basic');
        $this->db->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID);
    ...
    // count application id by case no for SDO
    public function caseForDcApprovalTea($caseNo,$dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('case_no', $caseNo)
            ->where('dist_code', $dist_code)
    ...
    // Count all final verify by SDO application list Tea
    public function countAllCasesForFinalVerifyAppTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('from_office', MB_SUB_DIV_COMM)
    ...
    // get all final verify by dc application list Tea
    public function getAllCasesForFinalVerifyAppTea($dist_code,$suv_div)
    {
        return $this->db->select()
            ->where('service_code', SETTLEMENT_SPECIAL_CULTIVATORS_ID)
            ->where('from_office', MB_SUB_DIV_COMM)
    ...
    // Count all Sdlac Status List Tea
    ...
    // get SDLAC/CDLAC Member Status List Tea
