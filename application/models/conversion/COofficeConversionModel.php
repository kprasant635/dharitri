...
//$db=  $this->session->userdata('db');
    public function getPendingConversionFreshCases($dsg,$start=0,$limit=null,$key=null) 
    {
        ...
        if ($limit==0 || $limit ||$key!=null)
        {
            ...
            $q = "Select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree  where fmb.not_fresh is null and fmb.lm_note_yn is null and fmb.mut_type='01' and fmb.co_user_code = '$dsg' and fmb.date_entry >= '$define_date' "
                . "and fmb.dist_code='$dist_code' and fmb.subdiv_code='$subdiv_code' and fmb.cir_code='$cir_code' and (fmb.status is null or fmb.status = 'P')
                    and (case_no like '%$key%' or ba.basundhara like '%$key%') and fmb.is_mb3!=1
                ...
                $q = "Select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree  where fmb.not_fresh is null and fmb.lm_note_yn is null and fmb.mut_type='01' and fmb.co_user_code = '$dsg' and fmb.date_entry >= '$define_date' "
                . "and fmb.dist_code='$dist_code' and fmb.subdiv_code='$subdiv_code' and fmb.cir_code='$cir_code' and (fmb.status is null or fmb.status = 'P') and fmb.is_mb3!=1
        ...
        {
            $q = "Select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree  where fmb.not_fresh is null and fmb.lm_note_yn is null and fmb.mut_type='01' and fmb.co_user_code = '$dsg' and fmb.date_entry >= '$define_date' "
                . "and fmb.dist_code='$dist_code' and fmb.subdiv_code='$subdiv_code' and fmb.cir_code='$cir_code' and (fmb.status is null or fmb.status = 'P') and fmb.is_mb3!=1 order by fmb.petition_no ASC";
        }
    ...
    public function countPendingConversionFreshCases($dsg) {
        ...
        return $this->db->query("select count(*) as c from   petition_basic where not_fresh is null and lm_note_yn is null and mut_type='01' and co_user_code = '$dsg' and "
                        . "date_entry >= '$define_date' and dist_code='$dist_code' and subdiv_code='$subdiv_code' and cir_code='$cir_code' and (status is null or status = 'P') and is_mb3!=1")->row()->c;
    }
            ...
            $q = "Select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree where fmb.not_fresh = 'Y' and fmb.status = 'P' and fmb.mut_type='01' and fmb.co_user_code = '$dsg'  and fmb.date_entry >= '$define_date'"
                    ...
                    and (case_no like '%$key%' or ba.basundhara like '%$key%') and fmb.is_mb3!=1
                     order by fmb.case_no ASC";
                        ...
                        $q = "Select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree where fmb.not_fresh = 'Y' and fmb.status = 'P' and fmb.mut_type='01' and fmb.co_user_code = '$dsg'  and fmb.date_entry >= '$define_date'"
                                . " and fmb.dist_code='$dist_code' and fmb.subdiv_code='$subdiv_code' and fmb.cir_code='$cir_code' and fmb.is_mb3!=1
    ...
    public function countPendingConversionSecondCases($dsg) {
        ...
        return $this->db->query("select count(*) as c from   petition_basic where not_fresh = 'Y' and status = 'P' and mut_type='01' and co_user_code = '$dsg' and "
                        . "date_entry >= '$define_date' and dist_code='$dist_code' and subdiv_code='$subdiv_code' and cir_code='$cir_code' and is_mb3!=1")->row()->c;
    }
...
//            }
    ...
    $db=  $this->session->userdata('db');
        ...
        $q = "select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree where is_mb3!=1 and not_fresh = 'Y' and status = 'P' and mut_type='01' and co_user_code = '$dsg'  and date_entry >= '$define_date'"
                . " and dist_code='$dist_code' and bo_note_yn is not null and dept_note_yn is null order by petition_no ASC";
        $cases = $this->db->query($q);
        return $cases;
    }
    ...
    public function getPendingConversionFirstCases_dc($dsg) {
        ...
        $year_no = year_no;
        $define_date = define_date;
        $q = "select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree  where is_mb3!=1 and bo_note_yn is null and bo_notice_gen is null and mut_type='01' and co_user_code = '$dsg' and add_off_desig = '$user_desig_code' and "
                . "date_entry >= '$define_date' and dist_code='$dist_code' and status!='D'  order by petition_no ASC";
    ...
    public function countPendingConversionFirstCases_dc($dsg) {
        ...
        $year_no = year_no;
        $define_date = define_date;
        return $this->db->query("select count(*) as c from   petition_basic where is_mb3!=1 and bo_note_yn is null and bo_notice_gen is null and mut_type='01' and co_user_code = '$dsg' and "
    ...
    public function getPendingConversionFirstCases_adc($dsg) {
        ...
        $year_no = year_no;
        $define_date = define_date;
        $q = "select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree  where is_mb3!=1 and bo_note_yn is null and bo_notice_gen is null and mut_type='01' and co_user_code = '$dsg' and add_off_desig = '$user_desig_code' and status!='D'"
    ...
    public function countPendingConversionFirstCases_adc($dsg) {
        ...
        return $this->db->query("select count(*) as c from   petition_basic where is_mb3!=1 and status!='D' and bo_note_yn is null and bo_notice_gen is null and mut_type='01' and co_user_code = '$dsg' and "
    ...
    public function countAppConversionSecondCases_adc_dpt($dsg) {
        ...
        return $this->db->query("select count(*) as c from  petition_basic where is_mb3!=1 and dept_note_yn='Y' and not_fresh = 'Y' and status = 'P' and mut_type='01' and co_user_code = '$dsg' and "
                        . "date_entry >= '$define_date' and dist_code='$dist_code' and bo_note_yn is not null $circle_bifurcate")->row()->c;
    }
    ...
    public function getAppConversionSecondCases_adc_dpt($dsg) {
            ...
            // $q = "select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree where (dept_note_yn='Y' or add_off_desig='DPT') and not_fresh = 'Y' and (status = 'P' or status = 'W') and mut_type='01' and co_user_code = '$dsg'  and date_entry >= '$define_date'"
            //         . " and dist_code='$dist_code' and bo_note_yn is not null order by petition_no ASC";
            $q = "select *,ba.basundhara from petition_basic fmb left join basundhar_application ba on fmb.case_no=ba.dharitree where is_mb3!=1 and dept_note_yn='Y' and not_fresh = 'Y' and status = 'P' and mut_type='01' and co_user_code = '$dsg'  and date_entry >= '$define_date' and add_off_desig = '$user_desig_code'"
                    . " and dist_code='$dist_code' and bo_note_yn is not null $circle_bifurcate order by petition_no ASC";
            $cases = $this->db->query($q);
            return $cases;
    }
    ...
    public function getRevertCasesFromDpt($user_code) {
        ...
        $q = "SELECT * FROM petition_basic WHERE is_mb3!=1 AND dept_note_yn IS NULL AND not_fresh = 'Y' AND status = 'R' AND add_off_desig='DC' AND mut_type='01' AND co_user_code = '$user_code' AND user_code LIKE '%DPT%' AND "
        . "date_entry >= '$define_date' AND dist_code='$dist_code' AND bo_note_yn IS NOT NULL $circle_bifurcate ORDER BY petition_no ASC";
        $cases = $this->db->query($q);
        return $cases;
    }
    //
