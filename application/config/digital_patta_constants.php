...
define('DIGITAL_SIGN_SERVER_TIME_URL','https://basundhara.assam.gov.in/dscapi/getServerTime');
...
define('SIKRITI_PATRA_GET_SKETCH_URL', 'http://10.177.0.35/dharitreeSVN/index.php/dharitreeApi/traceMapAttachment');
define('BASUNDHARA_LIVE_URL', 'https://basundhara.assam.gov.in/rtpsmb');
define('BASUNDHARA_URL', 'https://basundhara.assam.gov.in/rtpsmb2demo');
