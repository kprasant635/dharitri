<?php
define('STORAGE_IP','/mnt/Data/');
defined('UPLOAD_DIR') OR define('UPLOAD_DIR', STORAGE_IP.'dharitree/dev/uploads/mb2/');
defined('UPLOAD_BASE') OR define('UPLOAD_BASE', STORAGE_IP.'dharitree/dev/uploads/');
defined('BACKUP_DIR') OR define('BACKUP_DIR', STORAGE_IP.'uploads_back_feb224/');
defined('BACKUP_DIR_34') OR define('BACKUP_DIR_34', STORAGE_IP.'dharitree_gitlab/34_archieve/');
defined('BACKUP_DIR_35') OR define('BACKUP_DIR_35', STORAGE_IP.'dharitree_gitlab/35_archieve/');
