         ...
         <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-info">
               ...
               <div class="panel-body">
                  ...
                  <hr style="border-bottom: 2px solid #000;">
                  <?php $action = base_url() . "index.php/coofficemutation/proceeding2Multidag"; ?>
                  <form class='form-horizontal' action="<?php echo $action; ?>" method="post">
                     ...
                     <?php } ?>
                     <?php
                        if(isset($sro) and isset($basuCase) and ($petition_basic->mut_type=='03') and ($petition_basic->trans_code=='03') and count($apps)){
