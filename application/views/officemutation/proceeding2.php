            ...
            <div class="panel panel-info">
               ...
               <div class="panel-body">
                  ...
                  <form class='form-horizontal' action="<?php echo $action; ?>" method="post">
                     ...
                     <?php
                        if(isset($sro) and isset($basuCase) and ($petition_basic->mut_type=='03') and ($petition_basic->trans_code=='03')){
                          ?>
                     <h2><a href="<?php echo base_url()."index.php/coofficemutation/pushSroNgdrsOfc?app=$basuCase&case_no=$_GET[case_no]" ?>" class="green" onclick="if (!confirm('Are you sure want to continue ?')) { return false; }"><i class='fa fa-asterisk'></i>&nbsp;Push to SRO (Click to send SRO Office)</a></h2>
                     <?php
                        } ?>
                     <hr>
                     <?php  if($sro){
                  ...
                  <div class='form-group' style="text-align: center;">
                     ...
                     if(($petitioner[0]->dist_code==$this->session->userdata('dist_code')) && ($petitioner[0]->subdiv_code==$this->session->userdata('subdiv_code')) && ($petitioner[0]->cir_code==$this->session->userdata('cir_code'))){
                        ?>
