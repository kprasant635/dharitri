            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <form method='post' id="finalOrderOfcMutationPassCOMultiDeed" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            ////// BARAK VALLEY CODE START ////////////
                                ...
                                if(in_array($dist_code,json_decode(BARAK_VALLEY))){
                                    ...
                                    foreach ($dag as $dagss) {
                                            $area_message .= "$dag->patta_no নং পট্টাৰ "
                                                . "$dagss->dag_no নং দাগৰ অংশ " . $dagss->m_dag_area_b . " (বিঘা) " . $dagss->m_dag_area_k . " (কঠা) " . $dagss->m_dag_area_lc . " (ছটাক)".$dagss->m_dag_area_g . " (গণ্ডা),";

                                            $area_dag_msg_karim .= "$dagss->patta_no নং পট্টাৰ "
                                                . "$dagss->dag_no ,";
                                        }
                                    //var_dump($coname);
                                    if ($trans_code == 03) {
                                        ...
                                        $message = " আবেদনকারী একটি আবেদন করেছেন এবং মামলাটি উপস্থাপন করা হয়েছে। | "
                                                . "আবেদনকারী " . " $appname " . "মধ্যে " . $this->utilityclass->getMouzaName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code) . " মৌজার অধীনে " . $this->utilityclass->getVillageName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code, $petitioner[0]->lot_no, $petitioner[0]->vill_townprt_code) . " এর খে: ম্যাদী $dagPattaNoList->patta_no নং পাট্টার "
                                                .  "উত্তরসূরি সূত্রে মৃত পাট্টাদার $sellername স্থানে $dagPattaNoList->dag_no জন্য একটি নাম চাওয়া হয়েছে । "
                                                . " তারিখ অনুযায়ী বিজ্ঞপ্তি জারি করা হয় এবং নোটিশের সময়সীমার মধ্যে কোনও আপত্তি আসেনি।  ।  আবেদনকারীর দ্বারা জমা দেওয়া ডেথ সার্টিফিকেট , গ্রামের বৃদ্ধের সার্টিফিকেট, শপথ ও সংশ্লিস্ট লা:ম: এর প্রতিবেদন দেখা হয়েছে ।  "
                                                . $this->utilityclass->getMouzaName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code) . " মৌজার অধীনে " . $this->utilityclass->getVillageName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code, $petitioner[0]->lot_no, $petitioner[0]->vill_townprt_code) . " এর খে: ম্যাদী $dagPattaNoList->patta_no নং পাট্টার পাট্টাদার  $appname $app_relation $appname_father"
                                                . " এর ইতিমধ্যে মৃত এবং আবেদনকারী মৃত পাট্টাদারের প্রকৃত উত্তরাধিকারী । "
                                                . "তাই " . $this->utilityclass->getMouzaName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code) . " অধীনে " . $this->utilityclass->getVillageName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code, $petitioner[0]->lot_no, $petitioner[0]->vill_townprt_code) . " এর খে: ম্যাদী $dagPattaNoList->patta_no নং পাট্টার $dagPattaNoList->dag_no নং দাগের মৃত পাট্টাদারের স্থানে আবেদনকারী: দখল সূত্র "
                                ...
                                else //other than barak valley
                                {
                                    ...
                                    $area_message = null;
                                    $area_dag_msg = null;
                                    foreach ($dag as $dagsa) {
                                        $area_message .= "$dagsa->patta_no নং পট্টাৰ "
                                                . "$dagsa->dag_no নং দাগৰ অংশ " . $dagsa->m_dag_area_b . " (বিঘা) " . $dagsa->m_dag_area_k . " (কঠা) " . $dagsa->m_dag_area_lc . " (লেছা), ";

                                        $area_dag_msg .= "$dagsa->patta_no নং পট্টাৰ "
                                                . "$dagsa->dag_no ,";
                                    }
                                    if ($trans_code == 03) {
                                        $message = "আবেদনকাৰীয়ে হাজিৰ দাখিল কৰিছে আৰু গোচৰ উপস্থাপিত হৈছে |"
                                                ...
                                                " মাটিত খ:দ: সূত্ৰে নামজাৰী বিচাৰিছে | "
                                                ...
                                                .$area_message.
                                                 ...
                                                 "মাটি পট্টাদাৰ $sellername পৰা খৰিদ কৰে | লা:ম: ৰ প্রতিবেদন মতে খৰিদা জমিত আবেদনকাৰীৰ দখল-আবাদ আছে | "
                                        ...
                                        $message = " আবেদনকাৰীয়ে হাজিৰ দাখিল কৰিছে আৰু গোচৰ উপস্থাপিত হৈছে | "
                                                ...
                                                মৃত পট্টাদাৰ   $sellername    স্থলত উত্তৰাধিকাৰী সূত্ৰে নামজাৰী বিচাৰিছে  | "
                                                . " জাননী ৰীতিমতে জাৰি হয় আৰু জাননী জাৰিৰ ম্যাদৰ ভিতৰত কোনো আপত্তি আদি অহা নাই|আবেদনকাৰীয়ে দাখিল কৰা মৃত্যুৰ প্রমাণ পত্ৰ , গাওঁ বুঢ়াৰ প্রমাণ পত্ৰ ,শপত নামা আৰু সংশ্লিস্ট লা:ম: ৰ প্রতিবেদন চোৱা হ’ল |  "
                                                . $this->utilityclass->getMouzaName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code) . " মৌজাৰ অন্তৰ্গত " . $this->utilityclass->getVillageName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code, $petitioner[0]->lot_no, $petitioner[0]->vill_townprt_code) . " ৰ খে: ম্যাদী "

                                                .$area_dag_msg.
                                                " পট্টাদাৰ  $appname $app_relation $appname_father"
                                                . " ৰ ইতিমধ্যে মৃত্যু হৈছে আৰু আবেদনকাৰীজন মৃত পট্টাদাৰৰ প্রকৃত উওৰাধিকাৰী হয় | "
                                                . "সেয়েহে " . $this->utilityclass->getMouzaName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code) . " অন্তৰ্গত " . $this->utilityclass->getVillageName($petitioner[0]->dist_code, $petitioner[0]->subdiv_code, $petitioner[0]->cir_code, $petitioner[0]->mouza_pargona_code, $petitioner[0]->lot_no, $petitioner[0]->vill_townprt_code) . " ৰ খে: ম্যাদী " 
                                                .$area_dag_msg.

                                                " দাগৰ মৃত পট্টাদাৰ স্থলত উ:দ: দখল সূত্ৰে আবেদনকাৰী "
                            ...
                            ?>
                                ...
                                <table class="table table-striped table-bordered text-bold">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Patta No:</td>
                                            <td><span class="text-danger"><?=$dagPattaNoList->patta_no;?></span></td>       
                                        </tr>
                                        <tr>
                                            <td>Dag No:</td>
                                            <td>
                                                <span class="text-danger">
                                                    <?=$dagPattaNoList->dag_no;?>
                                                </span>
                                            </td>
                                            <td>Case No:</td>
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <th style="background-color: #136a6f; color: #fff" colspan="7">Modify Mutated Land Details</th>
                                    </thead>
                                    <thead style="white-space:nowrap; width:100%">
                                        <tr class="text-bold table-success">
                                            ...
                                            <th>K (ক :)</th>
                                            <th>L (লে :)</th>
                                            <th style="display: <?= $show_barrack_block; ?>">G (গ :)</th>
                                            <th style="display: <?= $show_barrack_block; ?>">Kr (ক্ৰা :)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                    foreach ($dag as $key => $dag_val) { ?>
                                
                                    
                                        <tr>
                                            <td><?=$this->lang->line('total_land_area')?></td>
                                            <td rowspan="2" class="text-center pt-5"><?= $dag_val->dag_no ?></td>
                                            <td>
                                                <span class="text-bold"><?=$dag_val->dag_area_b?></span>
                                                <input type='hidden' id="b" 
                                                value="<?=$dag_val->dag_area_b?>"/>
                                            </td>
                                            <td>
                                                <span class="text-bold"><?=$dag_val->dag_area_k?></span>
                                                <input type='hidden' maxlength="2" id="k"
                                                value="<?=$dag_val->dag_area_k?>"/>
                                            </td>
                                            <td>
                                                <span class="text-bold"><?=$dag_val->dag_area_lc?></span>
                                                <input type='hidden' maxlength="5" id="lc" 
                                                value="<?=$dag_val->dag_area_lc?>"/>
                                            </td>
                                            <td style="display: <?= $show_barrack_block; ?>">
                                                <span class="text-bold"><?=$dag_val->dag_area_g?></span>
                                                <input type='hidden' maxlength="2" id="g" 
                                                value="<?=$dag_val->dag_area_g=null?0:$dag_val->dag_area_g?>"/>
                                            </td>
                                            <td style="display: <?= $show_barrack_block; ?>">
                                                <span class="text-bold"><?=$dag_val->dag_area_kr?></span>
                                                <input type='hidden' maxlength="2" id="kr"
                                                value="<?=$dag_val->dag_area_kr?>"/>
                                            </td>
                                        </tr>
                                         <?php
                                            ////// BARAK VALLEY CODE START ////////////
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type='number' maxlength="6" name="mut_b[]" id="mut_b_kr" value="<?=$dag_val->m_dag_area_b?>" />
                                                <div id="err_lm_report_mut_b"></div>
                                            </td>
                                            <td>
                                                <input type='number' maxlength="2" name="mut_k[]" id="mut_k_kr" value="<?=$dag_val->m_dag_area_k?>"/>
                                                <div id="err_lm_report_mut_k"></div>
                                            </td>
                                            <td>
                                                <input type='number' maxlength="5" name="mut_lc[]" id="mut_lc_kr" value="<?=$dag_val->m_dag_area_lc?>" />
                                                <div id="err_lm_report_mut_lc"></div>
                                            </td>
                                            <td style="display: <?= $show_barrack_block; ?>">
                                                <input type='number' maxlength="2" name="mut_g[]" id="mut_g_kr" value="<?=$dag_val->m_dag_area_g==null?0:$dag_val->m_dag_area_g?>" />
                                        ...
                                        <?php }else{?>
                                            ...
                                            <td class="text-red text-bold"><?=$this->lang->line('mutated_land_area')?></td>
                                            <td>
                                                <input type='number' maxlength="6" name="mut_b[]" id="mut_b" value="<?=$dag_val->m_dag_area_b?>" />
                                                <div id="err_lm_report_mut_b"></div>
                                            </td>
                                            <td>
                                                <input type='number' maxlength="2" name="mut_k[]" id="mut_k" value="<?=$dag_val->m_dag_area_k?>"/>
                                                <div id="err_lm_report_mut_k"></div>
                                            </td>
                                            <td>
                                                <input type='number' maxlength="5" name="mut_lc[]" id="mut_lc" value="<?=$dag_val->m_dag_area_lc?>" />
                                                <div id="err_lm_report_mut_lc"></div>
                                            </td>
                                            <td style="display: <?= $show_barrack_block; ?>">
                                                <input type='number' maxlength="2" name="mut_g[]" id="mut_g" value="<?=$dag_val->m_dag_area_g==null?0:$dag_val->m_dag_area_g?>" />
                                                <div id="err_lm_report_mut_g"></div>
                                            </td>
                                            <td style="display: <?= $show_barrack_block; ?>">
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <th style="background-color: #136a6f; color: #fff" colspan="10">Applicant Details</th>
                                    </thead>
                                    <thead style="white-space:nowrap; width:100%">
                                        <tr class="text-bold table-success">
                                            <th>#</th>
                                    ...
                                    <tbody id="applicant_list">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$address?></td>
                                                <td>
                                                    <?= $this->utilityclass->getMaritalStatusName($appl->marital_status); ?>
                                                </td>
                                                <td>
                                                    <?= $appl->applicant_occupation; ?>
                                                </td>
                                                <td>
                                                    <?php 
                                                        echo $this->utilityclass->getCasteCategoryName($appl->caste_category); 
                                                        if($appl->tribe_category){
                                                            echo "<br> (". $this->utilityclass->getTribeCategoryName($appl->tribe_category) .")";
                                                        }
                                                    ?>
                                                </td>
                                                <td>
                                ...
                                <div class="col-lg-12">
                                    <center>
                                        ...
                                        <?php foreach ($dag as $key => $dag_value) { ?>
                                            <input type="hidden" id="patta_no" name="patta_no[]" value="<?=$dag_value->patta_no?>"/>
                                            <!-- <input type="hidden" id="patta_type_code_lm" value="<?=$dag_value->patta_type_code?>"/> -->
                                            
                                            <input type='hidden' name='dag_no[]' value='<?=$dag_value->dag_no?>'/>
                                        <?php } ?> 
                ...
                <div class="row mdl_frm_wrap">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control" name="marital_status" id='marital_status'>
                            ...
                            <?php foreach (json_decode(MARITAL_STATUS) as $marital_status): ?>
                            <option value="<?=$marital_status->CODE?>"><?=$marital_status->NAME?></option>
                            <?php endforeach; ?>
                        </select>
                        <div id="alert_marital_status"></div>
                    </div>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control" name="occupation" id='occupation'>
                            ...
                            <?php foreach (json_decode(OCCUPATION_NEW_APPL) as $occupation): ?>
                            <option value="<?=$occupation->CODE?>" ><?=$occupation->NAME?></option>
                            <?php endforeach; ?>
                        </select>
                        <div id="alert_occupation"></div>
                    </div>
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">&nbsp;</div>
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                        <span class="text-bold">Caste</span>
                        <span class="text-danger text-bold">&nbsp;*</span>
                        <select class="form-control edit_applicant_caste" name="pet_caste" id='pet_caste'>
                            <option disabled selected value="">-- Select Caste --</option>
                            <?php foreach (json_decode(CASTE) as $caste): ?>
                            <option value="<?=$caste->CODE?>" ><?=$caste->NAME?></option>
                            <?php endforeach; ?>
                        </select>
                        <div id="alert_pet_caste"></div>
                    </div>

                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                        <span class="text-bold">Protected Class</span>
                        <span class="text-danger text-bold">&nbsp;*</span>
                        <select class="form-control edit_applicant_protected_class" name="pet_protected_class" id='pet_protected_class'>
                            <?php foreach (json_decode(PROTECTED_CLASS) as $protected_class): ?>
                            <option value="<?= ($protected_class->CODE == '-1' ? '' : $protected_class->CODE) ?>" <?= ($protected_class->CODE == '-1' ? 'disabled selected' : ''); ?>><?=$protected_class->NAME?></option>
                            <?php endforeach; ?>
                        </select>
                        <div id="alert_pet_protected_class"></div>
                    </div>
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">&nbsp;</div>
                    ...
                    <input type="hidden" id="appl_rw_id" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;<hr></div>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            {   
                ...
                $('#appl_rw_id').val(data.petitioners.id);
                $('#marital_status').val(data.petitioners.marital_status);
                $('#occupation').val(data.petitioners.applicant_occupation);
                $('#pet_caste').val(data.petitioners.caste_category);
                $('#pet_protected_class').val(data.petitioners.tribe_category);

                $('.edit_applicant_protected_class', closestForm).attr('disabled', false);
            }
        }
    });
});

$(document).on('change', '.edit_applicant_caste', function(){
    const closestForm = $(this).closest('.mdl_frm_wrap');
    if($(this).val() == '6'){
        $('.edit_applicant_protected_class', closestForm).val('').attr('disabled', true);
    }else{
        $('.edit_applicant_protected_class', closestForm).attr('disabled', false);
    }
});
...
$(document).on('click', '.btnUpdateApplicantCOO', function(){
    ...
    pet_caste = $('#pet_caste').val();
    pet_protected_class = $('#pet_protected_class').val();
    $.ajax({
        url: baseurl + "coofficemutation/updateFinalOrderApplicantOmutCOMultiDagGen",
        type:'POST',
        data:{
                id : id, 
                pet_id : pet_id, 
                ...
                pet_caste : pet_caste,
                pet_protected_class : pet_protected_class,
            },
        dataType:'json',
        success: function (data) {
            console.log(data);
...
$('#finalOrderOfcMutationPassCOMultiDeed').submit(function(e){
    e.preventDefault();
    var form = $('#finalOrderOfcMutationPassCOMultiDeed')[0];
    ...
    $.ajax({
        url: baseurl + "coofficemutation/finalOrderOfcMutationPassCOMultiDag",
        type:'POST',
