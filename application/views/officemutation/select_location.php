        ...
        <div class="col-lg-10 col-lg-offset-3">
            ...
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method='post' action="<?php echo base_url() . "index.php/coofficemutation/updatechitha"; ?>">
                        ...
                        <div class="form-group">
                            <label for="select" class="col-lg-3 uni_text control-label"><?php $this->lang->line('applicant_id')?>/<?php echo $this->lang->line('dag')?></label>
                            <div class="col-lg-9">
