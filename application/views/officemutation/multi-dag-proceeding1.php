                              ...
                              if(in_array($dist_code, json_decode(BARAK_VALLEY))){?>
                                <tr>
                                    <td style='font-size:16px;line-height:1.4em;'><?php
                                        ...
                                        . "লাট মণ্ডল এবং সু:কে: এটি দখল এবং বিরোধের বিষয়ে একটি বিস্তারিত প্রতিবেদন জমা দেবে  |";
                                        ?>
                                        <?php echo $message; ?>
                                ...
                                <?php }else{?>
                                    ...
                                    <td style='font-size:16px;line-height:1.4em;'><?php
                                        ...
                                        . "লাট মণ্ডল আৰু চু:কা: ই চৰজমিন  কৰি  দখল আৰু বিবাদ সম্পৰ্কে বিতং প্রতিবেদন দাখিল কৰিব  |";
                                        ?>
                                        <?php echo $message; ?>
                                        <input type="hidden" class='form-control' name='co_order' value="<?php echo $message; ?>"/>
                                    </td>                                         
