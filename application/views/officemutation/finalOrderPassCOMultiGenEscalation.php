            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <form method='post' id="finalOrderOfcMutationPassCOMultiGeneration" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                if(in_array($this->session->userdata('dist_code'),json_decode(BARAK_VALLEY))){
                                    ...
                                    if ($trans_code == 03) {
                                        ...
                                        $message = "আবেদনকারীর নামের আবেদন টি দেখা হয় । আবেদনকারী " .
                                                ...
                                                . "লাট মণ্ডল এবং চু:কা: ই সরজমিন পরিমাপ করে চিঠা ও জমাবন্দীর এক কপি প্রো-লেটার দখল ও বিরোধ সম্বন্ধে বিস্তারিত প্রতিবেদন দাখিল করেছেন | তারিখ অনুযায়ী বিজ্ঞপ্তি জারি করা হয় এবং নোটিশের সময়সীমার মধ্যে কোনও আপত্তি আসেনি । নামজাৰী মঞ্জুর সম্পন্ন হয়েছে | ";
                                    }
...
$('#finalOrderOfcMutationPassCOMultiGeneration').submit(function(e){
    e.preventDefault();
    var form = $('#finalOrderOfcMutationPassCOMultiGeneration')[0];
    ...
    $.ajax({
        url: baseurl + "coofficemutation/finalOrderOfcMutationPassCOMultiGenEscalation",
        type:'POST',
