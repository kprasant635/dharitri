                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        ...
                        <form method='post' id="finalOrderOfcMutationPassCOMultiGeneration" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                ?>
                                  <!-- /////////ESCALATION REMARK///////////// -->
                                  <?php if (ESCALATION_ENABLE == 1 && ESCALATION_REMARK_ENABLE ==1 && isset($escRemarkData) && !empty($escRemarkData) && $escRemarkData->remark_status == null && $fmb['es_flag'] == 1) { ?>
                                    <div class="col-lg-12">
...
$('#finalOrderOfcMutationPassCOMultiGeneration').submit(function(e){
    ...
    $.ajax({
        url: baseurl + "coofficemutation/finalOrderOfcMutationPassCOMultiGen",
        type:'POST',
