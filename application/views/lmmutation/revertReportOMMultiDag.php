    ...
    <div class="modal-dialog" style="max-width: 70%;">
        <div class="modal-content">
            <form id="first_applicant_edit_<?=$appl->pet_id?>" method="post">
                <input type="hidden" name="pet_id" value="<?=$appl->pet_id?>">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            ...
                            <span class="text-danger text-bold">&nbsp;*</span>
                            <select class="form-control" name="marital_status" id='marital_status_<?=$appl->pet_id?>'>
                                <option disabled selected value="">-- Select Marital Status --</option>
                                <?php foreach (json_decode(MARITAL_STATUS) as $marital_status): ?>
                                <option value="<?=$marital_status->CODE?>"  <?=(($appl->marital_status==$marital_status->CODE)?'selected':'')?>><?=$marital_status->NAME?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            ...
                            <span class="text-danger text-bold">&nbsp;*</span>
                            <select class="form-control" name="occupation" id='occupation_<?=$appl->pet_id?>'>
                                <option disabled selected value="">-- Select Occupation --</option>
                                <?php foreach (json_decode(OCCUPATION_NEW_APPL) as $occupation): ?>
                                <option value="<?=$occupation->CODE?>"  <?=(($appl->applicant_occupation == $occupation->CODE)?'selected':'')?>><?=$occupation->NAME?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            ...
                            <span class="text-danger text-bold">&nbsp;*</span>
                            <select class="form-control edit_applicant_caste" name="pet_caste" id='pet_caste_<?=$appl->pet_id?>'>
                                <option disabled selected value="">-- Select Caste --</option>
                                <?php foreach (json_decode(CASTE) as $caste): ?>
                                <option value="<?=$caste->CODE?>"  <?=(($appl->caste_category==$caste->CODE)?'selected':'')?>><?=$caste->NAME?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                            ...
                            <span class="text-danger text-bold">&nbsp;*</span>
                            <select class="form-control edit_applicant_protected_class" name="pet_protected_class" id='pet_protected_class_<?=$appl->pet_id?>'>
                                <?php foreach (json_decode(PROTECTED_CLASS) as $protected_class): ?>
                                <option value="<?= ($protected_class->CODE == '-1' ? '' : $protected_class->CODE) ?>" <?= ($protected_class->CODE == '-1' ? 'disabled selected' : ''); ?> <?=(($appl->tribe_category==$protected_class->CODE)?'selected':'')?>><?=$protected_class->NAME?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" value="<?=$this->input->get('case_no')?>" name="case_no" id="case_no">
                    <input type="hidden" value="<?=$appl->petition_no?>" name="pet_no" id="petition_no">

                    <button class="btn btn-sm btn-info btnOMutUpdateApplicantCONewMulti" 
                    id="<?=$appl->pet_id?>" type="button">Update Applicant</button>
