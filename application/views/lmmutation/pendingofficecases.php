            ...
            <div class="col-lg-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        Pending Office Mutation Cases
                    </h2>
                </div>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <a href="<?=base_url().'index.php/home/MutationLmOM'?>">
                                    ...
                                    <td>
                                        ...
                                        if ($case->mut_type == '03'):
                                            if ($case->mode_of_registration == 'citizen') {
                                                ?>
                                                <a class="btn btn-sm btn-block btn-primary" href="<?php echo base_url(); ?>index.php/serviceplus/writeOfficeReport?case_no=<?=enc_param('case_no', $case->case_no, 600)?>"><i class="fa fa-pencil"></i>&nbsp;Write Report</a>
                                                <?php
                                            } else {
                                                ...
                                                {
                                                ?>
                                                    <a class="btn btn-sm btn-block btn-primary" href="<?php echo base_url(); ?>index.php/lmmutation/writeOfficeReport?case_no=<?=enc_param('case_no', $case->case_no, 600)?>"><i class="fa fa-pencil"></i>&nbsp;Write Report</a>
                                                <?php } ?>
    ...
    $(document).ready( function () {
        ...
        function load_data(zone_status)
        {
            ...
            var table = $('#cases').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/EscalationController/searchByEscalationZoneForLm',
                    type:'POST',
