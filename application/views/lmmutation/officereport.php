            ...
            <div class='panel panel-info'>
                ...
                <div class='panel-body'>
                    <div class='row'>
                        ...
                        <div class='col-lg-12'>
                            <?php
                            $link = base_url() . "index.php/lmmutation/writeofficereportNew";
                            ?>
                                ...
                                <table class='table table-bordered'>
                                    <tr>
                                        <td colspan="11" style="text-align: center">
                                            ...
                                            <a class="btn btn-info uni_text lmreportmut"  href="<?php echo base_url() . "index.php/officemutation/lmreport?case_no=" . $case_no . "&dist_code=" . $dags->dist_code . "&subdiv_code=" . $dags->subdiv_code . "&cir_code=" . $dags->cir_code . "&mouza_pargona_code=" . $dags->mouza_pargona_code . "&lot_no=" . $dags->lot_no . "&vill_townprt_code=" . $dags->vill_townprt_code; ?>"><i class='fa fa-list-alt'></i>&nbsp; View LM Report (if Exists)</a>
                        ...
                        <?php } echo "</table>"; } ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(($petition->dist_code==$this->session->userdata('dist_code')) && ($petition->subdiv_code==$this->session->userdata('subdiv_code')) && ($petition->cir_code==$this->session->userdata('cir_code')) && ($petition->mouza_pargona_code==$this->session->userdata('mouza_pargona_code')) && ($petition->lot_no==$this->session->userdata('lot_no'))){?>
                                        <td colspan="11" style="text-align: center">
