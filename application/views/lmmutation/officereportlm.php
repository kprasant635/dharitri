            ...
            <div class='panel panel-info'>
                ...
                <div class='panel-body'>
                    <div class='row'>
                        ...
                        <div class='col-lg-12'>
                            <?php
                            $link = base_url() . "index.php/lmmutation/writeofficereportMultiGen";
                            ?>
                            <form method="post" id="omForm" action="<?php echo $link; ?>" accept-charset="UTF-8">
                                ...
                                <table class='table table-bordered'>
                                    ...
                                    <tr>
                                        <td colspan="11" style="text-align: center">
                                          <span style="font-size:16px;font-weight: bold;"> Dag No : <?=$dags->dag_no;?> </span><a target="__blank" href='<?php echo base_url(); ?>index.php/chithareport/generateChitha?case_no=<?php echo $case_no; ?>&dag_no=<?= $dags->dag_no; ?>' class="btn btn-danger"><?php echo $this->lang->line('view_chitha'); ?></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type='number' maxlength="5" readonly id="lc" 
                                                   value="<?php echo number_format($dags->dag_area_lc); ?>"/>
                                        </td>
                                        <td>
                                        ...
                                        <td colspan="6">
                                           <!--  <div class="form-group " style="display: none;">
                                            ...
                                            foreach ($pattadars as $key => $value) { ?>
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" readonly class="form-control" value="<?=$value->dag_no;?>" >
                                                </div>
                                                <div class="col-sm-2">
                                ...
                                <?php if($petition->is_multigeneration == 'S'): ?>
                                <table class="table">
                                    <thead>
                                        <tr class="bg-primary">
                                            <th>Sl No: </th>
                                            ...
                                            <th>Occupation: </th>
                                            <th>Caste: </th>
                                            <th>Action <button class="btn btn-warning btn-sm" type="button" data-toggle="modal" data-target="#addApplicantModal">+ Add NOK</button></th>
                                        </tr>
                                    </thead>
								...
								ভূমিলেখ্য সহায়ক -----</textarea>
                                                <!-- /////////ESCALATION REMARK///////////// -->
                                              <?php if (ESCALATION_ENABLE == 1 && ESCALATION_REMARK_ENABLE ==1 && isset($escRemarkData) && !empty($escRemarkData) && $escRemarkData->remark_status == null && $petition->es_flag == 1) { ?>
                                                <div class="col-lg-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="javascript:void(0)" id="addApplicantForm">
                ...
                <input type="hidden" name="case_id" id="case_id" value="<?= $petition->case_no ?>">
                <input type="hidden" name="dist_code" value="<?= $petition->dist_code ?>">
                <div class="row mx-3">
