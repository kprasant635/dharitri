    ...
    <p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <b>Justification for area change</b>
                <textarea name="justification_area_change" class="form-control" id="justification_area_change"></textarea>
            </div>
            <div class="col-4"></div>
        </div>
        
        <div class="row justify-content-center mt-3">
            <button type="button" onclick="updateJuridicalArea();" class="btn btn-sm btn-danger col-3">UPDATE</button>
        </div>
    </p>
  </div>
