        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">Pending Cases Of Correction Of NH Affacted Lands (Land Acquisition)</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                            <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($land_acquisition as $case): ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a  id='co-order' href='<?php echo base_url() . "index.php/LandAcquisition/FinalOOrder?case_no=" . $case->case_no . "&dist_code=" . $case->dist_code . "&subdiv_code=" . $case->subdiv_code . "&cir_code=" . $case->cir_code . "&mouza_pargona_code=" . $case->mouza_pargona_code . "&lot_no=" . $case->lot_no . "&vill_townprt_code=" . $case->vill_townprt_code; ?>' class="btn btn-sm btn-success"><?php echo $this->lang->line('pass_order');?></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                        </table>
