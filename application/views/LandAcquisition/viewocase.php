					...
					<div class='row'>
						...
						<div class='col-lg-10 col-lg-offset-1'>
							...
							<table class='table uni_text table_black'>
								...
								<tr>
									<td rowspan='2'>Old Dag No. :  <?=$col8->dag_no;?>
									<br>
									Old Patta No : <?=$col8occ[0]->patta_no;?>
									<br>
									...
									<td>
									Total Land Area : <?=$col8->m_dag_area_b?> B-<?=$col8->m_dag_area_k?> K-<?=$col8->m_dag_area_lc?> L <br>
									Applied Land Area : <kbd><?=$col8->area_left_b?> B-<?=$col8->area_left_k?> K-<?=$col8->area_left_lc?> L </kbd>
									</td>
								</tr>	
							</table>
							...
							<table class='table uni_text table_black'>
								...
								<thead>
									...
									<td>Gurdian Name <i class='fa fa-user-plus'>: <?=$fp->infavor_of_guardian?></td>
									<td colspan=2>Relation <i class='fa fa-retweet'>: <?=$this->utilityclass->get_relation($fp->infav_of_guar_relation)?></td>
								</thead>
