                            ...
                            <div class="reza-body">
                                ...
                                <input type="hidden" id="caseNo" name="case_no" value="<?=$_GET['case']?>">
                                    ...
                                    <h5  class="reza-title" style="margin-top: 50px">
                                        <i class="fa fa-check-square-o" aria-hidden="true"></i> AST Report
                                    </h5>
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        ?>
                                        <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url()?>index.php/SettlementAst/generateNotice">
                                                ...
                                                <div class="row justify-content-center mb-5">
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php if (($pending_officer != 'LM' && $from_office != 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) {?>
                                                            <button onclick="return revertSubAlert()" type="button" class="btn btn-warning btn-sm" name="">Disagree and Revert to LM</button>
