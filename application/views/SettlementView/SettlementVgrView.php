...
<script>
    $(document).ready(function () {
        ...
        $(".next-step").click(function (e) {
            if ($('.ename').val() == -1) {
                alert('Please select encroacher name before proceed!');
                // return false;
            }
            if ($('.possesiondate').val().length == 0) {
                alert('Please select possesion date!!');
                return false;
            }
    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url()?>index.php/SettlementVgr/applicationVgrRegistration/<?=$review_flag?>?app=<?=$_GET['app']?>" 
                    ...
                    <div class="tab-content">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tr style="border-bottom:1px solid #227576">
                                                <td colspan="2">
                                                    ...
                                                    <div id="dageligiblemsg<?=$all_dags->id?>" style="padding: 10px; margin-top:5px; background-color: #f44336; color: white; font-weight:bold; display:none"></div>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                                ...
                                <div class="reza-body">
                                    ...
                                    <div class="tableCard ">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                                <span>
                                                    <strong><?=$sl_count++?>.</strong> Applied Scheme?
                                                </span>
                                                <?=form_error('applied_scheme')?>
                                            </div>
                                            <div class="col-md-6">
                                                <select name="applied_scheme" id="applied_scheme" class="form-control
                                                <?php if(form_error('applied_scheme')){echo 'lm_invalid';}?>">
                                                        <option value="">Select...</option>
                                                    <?php foreach(json_decode(APPLIED_SCHEME) as $class): ?>
                                                        <option value="<?php echo $class->CODE ?>"
                                                            <?php if(set_value('applied_scheme') == $class->CODE){ echo "selected";} ?>>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                foreach($dags as $dags_trace){
                                                    ...
                                                    <input
                                                            ...
                                                            id="trace_map_copy"
                                                            class="form-control <?php if(form_error('trace_map_copy'.$dags_trace->dag_no)){echo 'lm_invalid';}?>"
                                                    /><br>
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        if(isset($geo_tag_doc)){
                                                            foreach($geo_tag_doc as $d):
                                                                ...
                                                                <input
                                                                        type="hidden"
                                                                        name="geo_tag_photo<?=$d->dag_no?>"
                                                                        class="form-control <?php if(form_error('geo_tag_photo'.$d->dag_no)){echo 'lm_invalid';}?>"
                                                                        value="<?=$d->file_name;?>"
                                                                        id="geo_tag_photo"
                                                                />
                                                            <?php endforeach;}?>
                                    ...
                                    <div class="row p-2">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="rezaButt buttPrimary <?php if(form_error('totaldue')){echo 'lm_invalid';}?> <?php if(form_error('validationcheck')){echo 'lm_invalid';}?>"
                            ...
                            <ul class="list-inline pull-right" style="margin-top: 20px">
                                ...
                                <?php if(ENABLE_BUTTON_LM_SUBMIT_VGR != 0){?>
                                <li>
...
<script>
   ...
   }else if(classExistsLm)
   {
       ...
       nextTab($active);
       $('html, body').animate({
           scrollTop: ($('.lm_invalid').offset().top - 200),
       }, 200);
   };
