...
<script>
    $(document).ready(function ()
    {
        $(document).on('change', '#category, #mouza_cat, #lot_cat, #r_head_filter', function(){
            ...
            load_data(category, mouza_cat, lot_cat, r_head_filter);

        });

        load_data();

        function load_data(is_category = null, mouza_cat=null, lot_cat=null, r_head_filter =null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementCommonDc/revivalListDcPagination',
                    type:'POST',
                    data: {
