...
<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        <h4 style="text-align: center;">
            All Modification Requested Cases
        </h4>
    </div>
...
<div class="row px-2">
    <table id="datatable" class="datatable table table-stripped">
        ...
        <tr>
            ...
            <th>Case Pending <br>With</th>
            <th>Modification <br>Request Status</th>
            <th>Modification <br>Request Pending With</th>
            <th>Action</th>
        </tr>
        </thead>
        <tbody>
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementModification/paginationForModificationRequestedByCo',
                    type:'POST',
                    data: {
