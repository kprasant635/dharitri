    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                ...
                <hr>
                <span>Modification Requested Application Details</span>
                <hr>
            </div>
                ...
                <div class="tableCard">
                    ...
                    <table class="table table-bordered" >
                        ...
                        <tr>
                            ...
                            <td class="text-warning" style="width: 30%">
                                <strong class="alert-warning">
                                    <?php $requestBy = $this->utilityclass->getSelectedCOName(
...
<script>
    ...
    $(document).on('click','#rejectedRequestModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementModification/modificationRequestReject",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#forwardRequestModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementModification/modificationRequestForwardToDC",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#acceptedRequestModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementModification/modificationRequestAcceptByAdcSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
