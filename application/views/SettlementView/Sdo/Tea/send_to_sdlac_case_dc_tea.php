...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB /
            <a href="<?= base_url()?>index.php/SettlementTeaSdo/SettlementTeaLandDc">Special Cultivators</a> /
            <a href="<?= base_url()?>index.php/SettlementTeaSdo/getAllProposalListSdlacTea">SDLAC/CDLAC Reports</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementTeaSdo/getAllProposalListSdlacTea">
            ...
            <div class="reza-title">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php echo $this->lang->line('sendingToSDLACByDc') ?>
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementTeaSdo/viewApprovedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementTeaSdo/viewRejectedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementTeaSdo/viewRejectedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaSdo/updateProposalHearingDateTea",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaSdo/updateHearingDateGenerateNoticeTea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaSdo/proposalForwardToDcForFinalVerifyTea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalSubmit',function() {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementTeaSdo/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/SettlementTeaSdo/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementTeaSdo/getAllProposalListSdlacTea";
                }
                })
                }
                else
