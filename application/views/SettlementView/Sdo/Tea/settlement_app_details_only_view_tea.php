        ...
        <section>
            ...
            <div class="wizard">
                ...
                <div class="tab-content">
                    <?php
                    include(APPPATH."views/SettlementView/include/applicationKhasDcView.php");
                    ?>
                ...
                <div class="tab-pane" role="tabpanel" id="step5">
                    ...
                    <div class="reza-card">
                        <div class="reza-body">
                            <h5 class="reza-title" style="margin-top: 15px">Approved Remarks Details </h5>
                            <?php if($proceedings){ ?>
                                <div class="tableCard">
                ...
                <div class="tab-pane" role="tabpanel" id="proceedings">
                    ...
                    <div class="reza-card ">
                        <div class="reza-body">
                            <h5 class="reza-title" style="margin-top: 15px">Remarks Details  </h5>
                            <?php if($proceedings){ ?>
                                <div class="tableCard" style="margin-top: 15px">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th style="width: 200px">Remark Date</th>
                                            <th style="width: 200px">Remark Time</th>
