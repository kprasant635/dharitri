...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementTeaSdo/getAllSdlacMemberApprovalProposalListTea">SDLAC/CDLAC Member Status List</a>
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementTeaSdo/getAllSdlacMemberApprovalProposalListDataTea',
                type : 'POST',
                data : {
