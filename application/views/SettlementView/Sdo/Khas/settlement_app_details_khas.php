...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            Process /
            Settlement MB /
            <a href="<?= base_url()?>index.php/SettlementMbSdo/SettlementKhasLandDc">Khas Land</a> /
            <a href="<?= base_url()?>index.php/SettlementMbSdo/viewAllKhasFirstProceedingDCCaseList">First Proceeding</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                                            ...
                                            {
                                                ?>
                                                <button class="rezaButt buttDanger" onclick="showNewDirectRejectModalMb2('<?php echo $_GET['case']?>','<?= SETTLEMENT_KHAS_LAND_ID ?>')">
            ...
            <div class="modal-body" align="left">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <textarea name="consideration_note" class="form-control" id="consideration_remark" cols="30" rows="3" >
                        </textarea>
                    </div>
                </div>
                <br>
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMbSdo/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMbSdo/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationRejectedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationApprovedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $('#approveByDcModal').modal('hide');
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationPaymentGenerateDcKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#revertFromSDLACToCoModalYes',function ()
    {
        ...
        if(remarks != '' && status != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbSdo/applicationRevertFromSDLACToCOKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
