...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 3.0 /  Forwarded Meeting List / Meeting Information
            <br>
            <br>
            <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementProposalControllerInsSdo/forwardedMeetingListForAdc'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
        </div>
