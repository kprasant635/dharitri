    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                ...
                <hr>
                <span><?php echo $this->lang->line('approveAppListForDc') ?></span>
            </div>
                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/viewApprovedAppDetailsTribal/?case=<?php echo $case->case_no; ?>">
