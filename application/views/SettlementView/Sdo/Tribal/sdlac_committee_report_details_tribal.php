...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            /
             <a href="<?= base_url()?>index.php/SettlementTribalSdo/getAllSdlacMemberApprovalProposalListTribal">Proposal List</a>
            <a href="<?= base_url()?>index.php/SettlementTribalSdo/getAllSdlacMemberApprovalProposalListTribal">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span><?php echo $this->lang->line('settlementTribalCommunityTitle') ?> SDLAC/CDLAC Member Status Details</span>
                <hr>
            </div>
...
<script>
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTribalSdo/proposalForwardToDcForFinalVerifyTribal",
                type: "post",
                dataType: "json",
