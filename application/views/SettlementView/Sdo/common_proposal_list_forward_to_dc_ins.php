...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementProposalControllerInsSdo/listOfProposalsAllServices',
                type : 'POST',
                data : {
                    circle       : circle,
                    subdiv       : subdiv,
    ...
    {
        $.ajax({
            url: BASE_URL + "/SettlementProposalControllerInsSdo/getCasesAgainstProposalNo",
            dataType: "JSON",
            data: {id : id},
            type: "POST",
            success: function(data) {
    ...
    $("#openModalForFinalSubmit").click(function(){
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerInsSdo/checkAllSdlacPresentMember",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        {
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerInsSdo/sendProposalsToDcMinute",
                type: "post",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            {
                $.ajax({
                    url: BASE_URL + "/SettlementProposalControllerInsSdo/sendProposalsToDc",
                    type: "post",
                    enctype: 'multipart/form-data',
                    contentType: false,
                    cache: false,
