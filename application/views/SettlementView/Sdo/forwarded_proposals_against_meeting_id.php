...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementProposalSdoController/forwardedMeetingListForSdo'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
            ...
            <div class="reza-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?php if($meeting->digital_sign_status == 1): ?>
                                <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->id; ?>"
                    ...
                    <?php if($meeting->file_minute_path != '' && $meeting->file_minute_path != NULL): ?>
                        ...
                        <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/viewSdlacUploadedMinute/?meetingId=<?php echo $meeting->id; ?>"
...
<script type="text/javascript">
    ...
    function btnCaseView(propId)
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalSdoController/viewCasesAgainstProposalNo",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalSdoController/postAdditionalFileUnderMeetingSdo",
                type: "post",
