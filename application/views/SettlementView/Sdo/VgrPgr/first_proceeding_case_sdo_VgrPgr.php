        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="printableArea">
                ...
                <div class="container bg-white shadow pb-3" id="print_direct">
                    ...
                    <div class="row mt-5 justify-content-end mb-5" style="margin-top: 120px!important;">
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/generateGeneralNotice",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrSdo/saveGeneralNoticeVgrPgr",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
...
$('#datatable').DataTable();
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementVgrPgrSdo/firstProceedingPaginationAPI',
                type:'POST',
                data: {
