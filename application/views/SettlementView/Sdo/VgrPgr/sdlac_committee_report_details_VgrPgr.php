...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            /
             <a href="<?= base_url()?>index.php/SettlementVgrPgrSdo/getAllSdlacMemberApprovalProposalListVgrPgr">Proposal List</a>
            <a href="<?= base_url()?>index.php/SettlementVgrPgrSdo/getAllSdlacMemberApprovalProposalListVgrPgr">
...
<script>
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/proposalForwardToDcForFinalVerifyVgrPgr",
                type: "post",
                dataType: "json",
