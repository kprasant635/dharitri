...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementVgrPgrSdo/getAllProposalListSdlacVgrPgr">SDLAC/CDLAC Report</a>

            <a href="<?= base_url()?>index.php/SettlementVgrPgrSdo/getAllProposalListSdlacVgrPgr">
            ...
            <div class="reza-title">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="hidden" id="service_code" value="<?=SETTLEMENT_PGR_VGR_LAND_ID?>">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div>
                                        <a target="_blank" href="<?php echo base_url()?>index.php/SettlementVgrPgrADC/printNotice?case_no=<?=$case->case_no?>" class="btn btn-info btn-sm m-1"><i class="fa fa-check-square-o" aria-hidden="true"></i>Print De-Reservation Notice</a>

                                        <button type="button" onclick="generateNotice('<?=$case->case_no?>')" id="generateNotice" class="m-1 btn btn-sm btn-danger">Re-Generate De-Reservation Notice</button>

                                        <a target="_blank" href="<?php echo base_url()?>index.php/SettlementVgrPgrADC/printNoticeReservation?case_no=<?=$case->case_no?>" class="btn btn-info btn-sm m-1">
                                            <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                            Print Reservation Notice
                                        </a>

                                        <button class="btn btn-danger btn-sm m-1" onclick="generateNoticeReservation('<?=$case->case_no?>')" id="generateNoticeReservation">
                                            <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                ...
                                <?php if($case->status == PRO_CASE_STATUS_PENDING) : ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if($proposalDetails->meeting_create_status == 0): ?>
                                            ...
                                            <?php if(ADC_SDO_REVERT_SEND_MINUTES_BUTTON_VGR == 1): ?>
                                                <br>
...
<script>
    ...
    $(document).on('click','.closeFinalModal',function (){
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/updateProposalHearingDateVgrPgr",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/updateHearingDateGenerateNoticeVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function report_no(id, case_no) {
        ...
        showNewRejectModalMb2(case_no, '<?= SETTLEMENT_PGR_VGR_LAND_ID ?>')
    }
    ...
    $(document).on('click','#finalSubmit',function() {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrSdo/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrADC/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementVgrPgrSdo/getAllProposalListSdlacVgrPgr";
                }
                })
                }
                else
