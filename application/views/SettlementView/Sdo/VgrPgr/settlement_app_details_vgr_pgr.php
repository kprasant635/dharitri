...
<style>
    ...
    .close-enc-modal-co:hover,
    .close-enc-modal-co:focus {
        color: #000;
        text-decoration: none;
        cursor: pointer;
    }
                      ...
                      <strong>Lot Mondal</strong>
                        ...
                        <li role="presentation">
                            <a href="#step5" data-toggle="tab" aria-controls="step5" role="tab" title="step 5">
                                <span class="round-tab"><strong>SDO</strong></span>
                            </a>
                        </li>
                        <li role="presentation">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        ...
                        <div class="reza-card ">
                            <div class="reza-body">
                                ...
                                <input type="hidden" id="case_no" value="<?php echo $caseDetails->case_no ?>">
                                            ...
                                            if(trim($lmnote->vgr_dag_availability) != 'y'):
                                                ...
                                                <div class="tableCard pb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check form-check-inline">
                                                                <input
                                                                        ...
                                                                        id="reservation_vgr"
                                                                        onclick="getCirclesInSubdiv('<?=$basic['dist_code']?>','<?=$basic['subdiv_code']?>');"
                                                                        value="RESERVATION"
                                                    ...
                                                    <div class="row justify-content-center mt-2">
                                                        <?php
                                                        if(SEND_TO_OTHER_CO_VGR != 0){
                                                            ?>
                                                            <button type="button" onclick="sendToOtherCo('<?=$_GET['case']?>')" class="btn m-1 col-3 btn-warning btn-sm">Send to other CO for Reservation</button>
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        <?php if(VGR_PGR_REJECT_ONLY == 0) { ?>
                                            <button class="rezaButt buttDanger" onclick="showNewDirectRejectModalMb2('<?php echo $_GET['case']?>','<?= SETTLEMENT_PGR_VGR_LAND_ID ?>')">
                                        ...
                                        else
                                        {
                                            if($basic['status'] == 'AF')
                                            {
                                                if(DC_ADC_SDO_PRO_BUTTON_VGR != 0){
                                                    ?>
                                                    <button class="rezaButt buttInfo" onclick="forwardToExistingCluster('<?=$basic['case_no']?>')" id="circleCluster">
                                            ...
                                            else
                                            {
                                                if($basic['status'] == 'W')
                                                {
                                                    ...
                                                    if($basic['notice_generated_yn'] != 'y' || $basic['notice_reservation_yn'] != 'y')
                                                    {

                                                        if($basic['notice_generated_yn'] != 'y')
                                                        {
                                                            ?>
                                                            <button class="rezaButt buttSuccsess" onclick="generateNotice('<?=$basic['case_no']?>')" id="generateNotice">
                                                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                Generate De-reservation Notice
                                                            </button>
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <a target="_blank" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrADC/printNotice?case_no=<?php echo $_GET['case']?>" class="rezaButt buttCust m-1">
                                                                <i class="fa fa-print" aria-hidden="true"></i>
                                                                Print De-Reservation Notice
                                                            </a>

                                                            <?php
                                                        }

                                                        if($basic['notice_reservation_yn'] != 'y')
                                                        {
                                                            ?>

                                                            <button class="rezaButt buttSuccsess" onclick="generateNoticeReservation('<?=$basic['case_no']?>')" id="generateNoticeReservation">
                                                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                Generate Reservation Notice
                                                            </button>
                                                        ...
                                                        {
                                                            ?>
                                                            <a target="_blank" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrADC/printNoticeReservation?case_no=<?php echo $_GET['case']?>" class="rezaButt buttCust m-1">
                                                                <i class="fa fa-print" aria-hidden="true"></i>
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        <button class="rezaButt buttSuccsess" onclick="generateNotice('<?=$basic['case_no']?>')" id="generateNotice">
                                                            ...
                                                            Re-Generate De-Reservation Notice
                                                        </button>
                                                        ...
                                                        if($caseDetails->status == MB_PENDING OR $caseDetails->status == MB_RE_REPORT OR $caseDetails->status == MB_REVERT)
                                                        {
                                                            if(DC_ADC_SDO_PRO_BUTTON_VGR != 0){
                                                                ?>
                                                                <button class="rezaButt buttInfo" onclick="circleCluster('<?=$basic['case_no']?>')" id="circleCluster">
                                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                                    Put in circle cluster
                                                                </button>
                                                            <?php }?>
                                                            <button class="rezaButt buttPrimary" id="revertFromDcToCo">
                                                                <i class="fa fa-level-down" aria-hidden="true"></i>
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrSdo/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrSdo/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/applicationRejectedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/applicationApprovedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#revertFromSDLACToCoModalYes',function ()
    {
        ...
        if(remarks != '' && status != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrSdo/applicationRevertFromSDLACToCOVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<div id="otherCoModal" class="modal-co">

    <!-- Modal content -->
    <div class="modal-content-co">
        <div class="row text-right">
            <span class="close-enc-modal-co px-4">&times;</span>
        </div>
        <h5 id="head_label_co"></h5>

        <div class="container px-5" id="other_cos" style="border: 1px solid #CED4DA;">
        </div>
    </div>
...
<script>
    ...
    var modal_co = document.getElementById("otherCoModal");
    // Get the button that opens the modal_vgr
    var btn = document.getElementById("myBtn");
    // Get the <span> element that closes the modal_vgr
    var span_co = document.getElementsByClassName("close-enc-modal-co")[0];

    span_co.onclick = function() {
        // checkIfRserveDataInserted();
        modal_co.style.display = "none";
        // table.destroy();
    }

    // When the user clicks anywhere outside of the modal_vgr, close it
    window.onclick = function(event) {
        if (event.target == modal_co) {
            // checkIfRserveDataInserted();
            modal_co.style.display = "none";
            // table.destroy();
        }
    ...
    function sendToOtherCo(case_no)
    {
        var postData = {
            'case_no': case_no
        }
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrSdo/otherCoList',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
                ...
                {
                    //show modal with others Co in circle here
                    modal_co.style.display = "block";

                    $('#head_label_co').html('<h5 class="pl-5"><u>Co list in District/Sub-div</u></h5>');

                    var options = '<option value="">Select co...</option>';

                    for(i=0; i<arr.content.length; i++)
                    {
                        options += "<option value='"+arr.content[i].user_code+"_"+arr.content[i].dist_code+"_"+arr.content[i].subdiv_code+"_"+arr.content[i].cir_code+"'>"+arr.content[i].username+" ("+arr.content[i].loc_name+")</option>";
                    }

                    $('#other_cos').html("<div class='row justify-content-center mt-3'>"+
                        "<div class='col-md-11'><select class='form-control' id='coSelected'>"+options+"</select></div>"+
                        "</div>"+
                        "<div class='row justify-content-center mt-3'>"+
                        "<div class='col-md-11'><textarea class='form-control p-2' rows='5' id='remark_other_co' placeholder='Please enter remark...'></textarea></div>"+
                        "</div>"+

                        "<div class='row justify-content-center mt-4 mb-5'>"+
                        "<button type='button' onclick=\"sendToCoSub(\'"+case_no+"\')\" class='btn btn-primary btn-sm col-5'>send</button>"+
                        "</div>");
    ...
    function sendToCoSub(case_no)
    {
        var co_data = $('#coSelected').val();
        var splited_data = co_data.split('_');

        var co_code = splited_data[0];
        var dist_code = splited_data[1];
        var subdiv_code = splited_data[2];
        var cir_code = splited_data[3];

        var remark_other_co = $('#remark_other_co').val();
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrSdo/sendToOtherCo',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
                ...
                else
                {
                    ...
                    window.location.href = baseurl+"SettlementVgrPgrSdo/viewAllVgrPgrFirstProceedingSdoCaseList";
                }
                })
                }
            }
    ...
    function circleCluster(case_no)
    {
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
                confirmButton: 'btn btn-success ml-2',
        ...
        swalWithBootstrapButtons.fire({
            title: 'This will forward the case to circle cluster...',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Ok',
            reverseButtons: true
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrSdo/putInCircleCluster',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
...
<script>
    function forwardToExistingCluster(case_no)
    {
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
                confirmButton: 'btn btn-success ml-2',
        ...
        swalWithBootstrapButtons.fire({
            title: 'This case was reverted from cluster. This will forward the case to existing cluster...',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Ok',
            reverseButtons: true
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrSdo/forwardToExistingCluster',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
