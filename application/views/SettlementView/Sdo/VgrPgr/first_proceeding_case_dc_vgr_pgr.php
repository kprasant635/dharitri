                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <?php if($case->general_notice_dc == 'y'): ?>
                                        <a class="rezaButt buttPrimary" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/getSettlementVgrPgrApplicationDetails/?case=<?php echo $case->case_no; ?>">
                                            <i class="fa fa-cog" aria-hidden="true"></i>
                                            <?php echo $this->lang->line('process'); ?>
                                        </a>
                                        <a target="_blank" class="rezaButt buttInfo" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/viewGeneralNoticeVgrPgr/?case=<?php echo $case->case_no; ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button  class="rezaButt case_no" id="case_no" onclick="generalNotice" value="<?=$case->case_no?>">
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/generateGeneralNotice",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrDc/saveGeneralNoticeVgrPgr",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
