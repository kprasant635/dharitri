...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-left: 25px">
        Process /
        Settlement MB /
        <a href="<?= base_url()?>index.php/SettlementProposalSdoController/revertMeetingListForSdo">Reverted Meeting </a> /
        Proposals

        <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalSdoController/revertMeetingListForSdo'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
                        ...
                        <?php $i=1; foreach ($proposals as $proposal): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="rezaButt buttSuccess"  target= "SDLACProposalNotice" href="<?php echo base_url(); ?>index.php/SettlementProposalSdoController/caseListUnderRevertedMeetingForSdo/?proposal=<?php echo $proposal->id ?>">
...
<script>
    ...
    $("#verifyCases").click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalSdoController/verifyCasesUnderRevertedMeetingByDc",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data)
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalSdoController/sendRevertedProposalsToDcMinute",
            type: "post",
            enctype: 'multipart/form-data',
            contentType: false,
            cache: false,
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalSdoController/sendRevertedProposalsToDc",
                type: "post",
                enctype: 'multipart/form-data',
                contentType: false,
                cache: false,
