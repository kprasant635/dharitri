...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 3.0 / <a href="<?= base_url()?>index.php/SettlementInsSDO/SettlementInsLandDc">Juridical Entities</a>


            <a href="<?= base_url()?>index.php/SettlementInsSDO/SettlementInsLandDc">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON_INS == 0 OR DC_ADC_SDO_PRO_BUTTON_INS == 1) { ?>
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsSDO/viewAllInsFirstProceedingDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsSDO/viewAllMarkAsSDLACListForDCKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON_INS == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsSDO/getAllProposalListSdlacKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
...
<!--                    </tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDc/getAllRejectedApplicationByCoForSdo?service='.SLIJE_ID .'&s='.MB_DISMISS; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
...
<!--                    </tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDC/rejectedList?service='.SLIJE_ID.'&s=D&office='.MB_SUB_DIV_COMM; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
