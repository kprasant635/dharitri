                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="step5">
                        ...
                        <h5 class="bg-info p-2 text-white shadow">
                            Registration of <?php echo $this->lang->line('khasLand')?> (
                    ...
                    <div class="tab-pane" role="tabpanel" id="proceedings">
                        ...
                        <br>
                        <h5 class="bg-info p-2 text-white shadow">
                            Proceeding of <?php echo $this->lang->line('khasLand')?> (
...
<script>
    ...
    $(document).on('click','#orderForChithaUpdateModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbADC/orderToCoByDcForChithaUpdating",
                type: "post",
                dataType: "json",
