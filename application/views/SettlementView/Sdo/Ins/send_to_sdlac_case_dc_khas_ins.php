...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementInsSDO/getAllProposalListSdlacKhas">SDLAC/CDLAC Report</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementInsSDO/getAllProposalListSdlacKhas">
                ...
                <?php else : ?>
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode'   width="100%">
                        ...
                        <tr>
                            ...
                            <th width="25%"><label class="control-label">Category</label></th>
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementInsSDO/viewApprovedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementInsSDO/viewRejectedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementInsSDO/viewRejectedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsSDO/updateProposalHearingDateKhas",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsSDO/updateHearingDateGenerateNoticeKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsSDO/proposalForwardToDcForFinalVerifyKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalSubmit',function() {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementInsSDO/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/SettlementInsSDO/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementInsSDO/getAllProposalListSdlacKhas";
                }
                })
                }
                else
