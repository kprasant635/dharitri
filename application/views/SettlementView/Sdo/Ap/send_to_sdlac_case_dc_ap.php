...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB /
            <a href="<?= base_url()?>index.php/SettlementApSdo/SettlementApLandDc">AP Transfer</a> /
            <a href="<?= base_url()?>index.php/SettlementApSdo/getAllProposalListSdlacAp">SDLAC Proposal</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementApSdo/getAllProposalListSdlacAp">
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApSdo/updateProposalHearingDateAp",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApSdo/proposalForwardToDcForFinalVerifyAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function report_no(id, case_no) {
        ...
        showNewRejectModalMb2(case_no, '<?= SETTLEMENT_AP_TRANSFER_ID ?>')
    }

    $(document).on('click','#finalSubmit',function() {
        prop_id = $('#proposalIdForward').val();
        $.ajax({
            url: BASE_URL + "/SettlementApSdo/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/SettlementApSdo/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementApSdo/getAllProposalListSdlacAp";
                }
                })
                }
                else
