...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementApSdo/viewAllMarkAsSDLACListForDCAp">SDLAC/CDLAC Recommended (Marked)</a>
...
<script>
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApSdo/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApSdo/generateNoticeSendAllMarkAppToSDLACByDcAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    $('#cir_id').change(function()
    {
        ...
        $.ajax({
            url: base_url+'index.php/SettlementCommon/getVillName',
            dataType: "JSON",
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementApSdo/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
