...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementApSdo/getAllSdlacMemberApprovalProposalListAp">SDLAC/CDLAC Member Status </a> / Details

            <a href="<?= base_url()?>index.php/SettlementApSdo/getAllSdlacMemberApprovalProposalListAp">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span><?php echo $this->lang->line('settlementAP') ?> SDLAC/CDLAC Member Status Details</span>
                <hr>
            </div>
