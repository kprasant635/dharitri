                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        <?php if($caseDetails->status == MB_PENDING OR $caseDetails->status == MB_RE_REPORT OR $caseDetails->status == MB_REVERT) :?>
                                            ...
                                            <?php if($areaCheck == 0): ?>
                                                <a id="generatePay" class="rezaButt buttInfo" href="<?php echo base_url(); ?>index.php/SettlementTenantDc/generatePaymentNotice?case=<?=$_GET['case']?>">
...
<script>
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTenantDc/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
