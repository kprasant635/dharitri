                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td class="rezaText">
                            ...
                            Payment confirmation status and chitha update
                    ...
                    <tr>
                        <td class="rezaText"> <?php echo $slNo += 1; ?>.</td>
                        <td class="rezaText"><?php echo $this->lang->line('beneficiary') ?></td>
                        <td>
                            <?php
                            if ($beneficiaryCount != '0')
                            {
                                echo  "<span class=\"badge badge-danger\">$beneficiaryCount</span>";
                            }
                            else
                            {
                                echo  "<span class=\"badge badge-success\">$beneficiaryCount</span>";
                            }
                            ?>
                        </td>
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantDc/getAllBeneficiaryForDcAppTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
