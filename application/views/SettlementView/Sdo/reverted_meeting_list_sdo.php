                    ...
                    <?php $i=1; foreach($cases as $row) { ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <?php else: ?>
                                    <a class="rezaButt rezaInfo" href="<?php echo base_url(); ?>index.php/SettlementProposalSdoController/getProposalUnderRevertedMeetingForSdo/?meetingId=<?php echo $row->id; ?>">
