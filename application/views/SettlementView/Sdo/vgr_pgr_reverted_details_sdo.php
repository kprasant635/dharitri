...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
        ...
        <a href="<?= base_url()?>index.php/SettlementProposalSdoController/getVgrPgrRevertedCaseListSdo">
...
<script>
    ...
    $(document).on('click','#forwardedToDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalSdoController/revertedVgrCaseForwardToDcSdo",
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    else if(data.responseType == 2)
                    {
                        ...
                        window.location = BASE_URL + "/SettlementProposalSdoController/getVgrPgrRevertedCaseListSdo";
                    }
                    })
                    }
                    else
    ...
    $(document).on('click','#revertToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalSdoController/revertedVgrCaseRevertToCoSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
