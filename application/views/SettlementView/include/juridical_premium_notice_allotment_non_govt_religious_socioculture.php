...
<html class="no-js">
   ...
   <body style="background: none !important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementInstitutionCo/savePaymentNotice" method="post" enctype='multipart/form-data'>
        ...
        <input type="hidden" name="land_revenue_amount" value="<?=$final_land_revenue_amount;?>">
            ...
            border: 1px solid #191919;
              ...
              <div class="row mt-4">
                 ...
                 <?php } ?>
                    ...
                    <br>
                     ...
                     খ) চৰকাৰী অধিসূচনা  E-430577/2024I/489202/2024 dated 6 March,2024 মৰ্মে বন্দোবস্তীৰ বাবে বাকী থকা প্ৰিমিয়ামৰ ধনৰাশি অন্তিম বন্দোবস্তীৰ পূৰ্বে, (৩ বছৰৰ ভিতৰত) আবেদন ও আদায় সাপেক্ষে প্ৰদান  কৰা হ’ব । ( চৰ্ত্ত  থাকে যে ইয়াৰ বাবে মাটিখিনি উল্লেখ কৰা নিৰ্দিষ্ট কাৰণত ব্যৱহাৰ কৰা হ’ব লাগিব )
                     <br>
              ...
              <div class="col-12 text-justify pl-5 pr-5">
               <b><u>চৰকাৰী অধিসূচনা</u></b> <br>
                  ...
                  ৩) eCF No.565802/I/776018/2024 Dated 19-10-2024, No.ECF. 647652/2025/4 dated 10-06-2025.
