<h5 class="reza-title" style="margin-top: 45px">
    ...
    &nbsp; &nbsp;
    <button type="button" class="rezaButt viewVillageAreaDetails" id="viewVillageAreaDetails" style="background-color: #F44336; ">
        <i class="fa fa-spinner fa-spin"></i> Verify Area
    </button>
...
<div class="tableCard" id="applicationArea">
    <div class="tree" >
        <table class="table table-bordered" style="font-weight: bold">
            ...
            <tr>
                <td>Total area in pending application (LRA report submitted)</td>
            ...
            <tr>
                <td>Total area in pending application (LRA report not submitted)</td>
...
<script>
    ...
    $(document).on('click','.viewVillageAreaDetails',function ()
    {
        ...
        $.ajax({
            url: baseurl + "SettlementCommonDc/getChithaApproveAppliedAppAreaCalculation",
            type: "post",
            dataType: "json",
            ...
            success: function (data) {
                ...
                else if (data.responseType == 2)
                {
                    ...
                    if (data.process == 1)
                    {
                        ...
                        $('#verifiedVillageAreaDetails').show();
