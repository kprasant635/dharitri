            ...
            <div class="modal-header">
                <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        PREMIUM CALCULATION TENANT URBAN
                    </h5>
                </div>
                ...
                ?>
                    ...
                    <script>
                        ...
                        $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                            ...
                            var appbigha=parseFloat($("#s_dag_area_b").val());
                            var appkatha=parseFloat($("#s_dag_area_k").val());
                            var applessa=parseFloat($("#s_dag_area_lc").val());
                            var appganda=parseFloat($("#s_dag_area_g").val());
                            ...
                            var final_amount = (total_ganda * dag_per_ganda_revenue);
                            var total_due= Math.ceil(final_amount * 50);
                            $('#total_s_lessa').val(total_ganda);
                            ...
                            if (selectedValue == "YES") {
                                ...
                                var finalmbamount=total_due + amount;

                                $('#amount_<?=$dagsprem->dag_no?>').val(finalmbamount);
                                $('#total_lessa<?=$dagsprem->dag_no?>').val(total_s_area);
                                $('#validationcheck').val(1);
                                $('#total_due_amount').val(finalmbamount);
                                $("#total_due_row").show();
                        ...
                        $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                            ...
                            var final_amount = (total_lessa * dag_per_lessa_revenue);
                            var total_due= Math.ceil(final_amount * 50);
                            $('#total_s_lessa').val(total_lessa);
