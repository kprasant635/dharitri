...
<div class="tab-pane active" role="tabpanel" id="step1">
    ...
    <div class="reza-card">
        ...
        <h5 class="reza-title" style="margin-top: 15px">
            ...
            <?php $i = 1;foreach ($applicant_marital_status as $main_applicant): ?>
                <div class="tableCard">
                    <table class="table table-bordered">
                        <tr >
                            <th rowspan="6" style="vertical-align : middle;text-align:center; min-width: 4%!important; max-width: 4%!important; width: 4%">
                        ...
                        <tr>
                            ...
                            <td>
                                <strong class="alert-warning">
                                    <?php
                                    if ($main_applicant->gender == "1") {
                                        echo "Male";
                                    }
                                    if ($main_applicant->gender == "2") {
                                        echo "Female";
                                    }
                                    if ($main_applicant->gender == "3") {
                                        echo "Others";
                                    }
                                    ?>
                                </strong>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                    foreach(json_decode(MARITAL_STATUS) as $marital_stat){
                                        if($marital_stat->CODE == $main_applicant->marital_status){
                                        ?>
                                            <?=$marital_stat->NAME?>
                                        <?php
                                    } }
    ...
    <div class="reza-body"> -->
        ...
        <input type="hidden" id="caseNo" name="case_no" value="<?=$_GET['case']?>">
            ...
            <div class="tableCard ">
                ...
                ?>
                <form method="post" id="lm_form_sub" name="lm_form_sub" action="<?php echo base_url() ?>index.php/SettlementApplicantLm/lmReportSubmit">
                    ...
                    <div class="mt-4 row px-5">
                        ...
                        <div class="col-md-9">
                            ...
                            <select name="remark_lm_type" id="remark_co" onchange="autoRemark();" class="form-control">
                            ...
                            <textarea placeholder="Remarks  ..." name="remark_lm" id="remark_co_text" class="form-control p-2" cols="30" rows="10"></textarea>
                    ...
                    <input type="submit" name="forward_to_dc" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" value="Forward">
                    </div>
