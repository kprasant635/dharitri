<div class="modal" role="dialog" id="premiumModalAdc" style="padding-top: 25px!important;" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        PREMIUM CALCULATION TEA GRANT
                    </h5>
                </div>
                ...
                ?>
                    ...
                    <script>
                        ...
                        $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                            ...
                            var appbigha=parseFloat($("#enc_home_b<?=$dagsprem->dag_no?>").val());
                            var appkatha=parseFloat($("#enc_home_k<?=$dagsprem->dag_no?>").val());
                            var applessa=parseFloat($("#enc_home_lc<?=$dagsprem->dag_no?>").val());
                            var appganda=parseFloat($("#enc_home_g<?=$dagsprem->dag_no?>").val());
