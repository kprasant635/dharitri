            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <?php if(ENABLE_BUTTON_CHANGE_ENCROACHER_INSTITUTE != 0){?>
                ...
                include(APPPATH."views/SettlementView/include/encroacherNotEligibleViewIns.php");
                ?>
            </table>
        </div>
    <?php 
