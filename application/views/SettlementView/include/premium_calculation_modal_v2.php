                ...
                <div class="modal-body" align="">
                    <?php  $areacount=1;  foreach($dags as $dagsprem){ ?>
                        ...
                        <script>
                            ...
                            if (area_id == 19)
                            {
                              area_id =23; // assigned 23 bcz as per new notification Revenue Towns showing urbanization and industrial growth (Town Area) rate changed
                            }
                            ...
                            $( "select[name='rate_type<?=$dagsprem->dag_no?>']" ).change(function () {
                                ...
                                // ajax for getting land list starts here
                                $.ajax({
                                    url: baseurl + "SettlementPremium/getRateV2/" + typeID,
                                    success: function(data) {
                                        // loading.out();
                            ...
                            $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                                ...
                                if (selectedValue == "YES") {
                                    ...
                                    if(rate_type=='P'){
                                        ...
                                        // }
                                        if (total_s_area > mb_land) {
                                            // concession factor (e.g. 25% → 0.75)
                                            var concessionFactor = (100 - getPrice) / 100;

                                            // --- Part 1: mb_land area ---
                                            var basePremium1 = (mb_land * zonal) / 6400;
                                            var amount1 = Math.ceil(basePremium1 * (rate / 100) * concessionFactor);

                                            // --- Part 2: excess area (flat 150% rate, no prem_rate) ---
                                            var access_area = total_s_area - mb_land;
                                            var basePremium2 = (access_area * (zonal * 1.5)) / 6400;
                                            var amount2 = Math.ceil(basePremium2 * concessionFactor);
                                            ...
                                            var basePremium = (total_s_area * zonal) / 6400;
                                            var amount = Math.ceil(basePremium * (rate / 100) * concessionFactor);
                                    ...
                                    if (selectedValue == "NO") {
                                        ...
                                        if(rate_type =='P'){
                                            if (total_s_area > mb_land) {
                                                ...
                                                var premium1 = (mb_land * zonal) / 6400;
                                                var amount1  = Math.ceil(premium1 * rate / 100);

                                                // --- Part 2: excess area at flat 150% zonal (no rate applied) ---
                                                var access_area = total_s_area - mb_land;
                                                var premium2    = (access_area * (zonal * 1.5)) / 6400;
                                                var amount2     = Math.ceil(premium2);
                                                ...
                                                // --- When total area is within mb_land ---
                                                var premium = (total_s_area * zonal) / 6400;
                            ...
                            $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                                ...
                                if (selectedValue == "YES") {
                                    ...
                                    if(rate_type=='P'){
                                        if (total_s_area > mb_land) {
                                            var concessionFactor = (100 - getPrice) / 100; // e.g. 25% → 0.75

                                            // --- Part 1: within mb_land ---
                                            var basePremium1 = (mb_land * zonal) / 100;
                                            var amount1 = Math.ceil(basePremium1 * (rate / 100) * concessionFactor);

                                            // --- Part 2: excess area at flat 150% zonal ---
                                            var access_area = total_s_area - mb_land;
                                            var basePremium2 = (access_area * (zonal * 1.5)) / 100;
                                            var amount2 = Math.ceil(basePremium2 * concessionFactor);
                                            ...
                                            var basePremium = (total_s_area * zonal) / 100;
                                            var amount = Math.ceil(basePremium * (rate / 100) * concessionFactor);
                                    ...
                                    if (selectedValue == "NO") {
                                        ...
                                        if(rate_type =='P'){
                                            ...
                                            if (total_s_area > mb_land) {
                                                // --- Part 1: within mb_land ---
                                                var premium1 = (mb_land * zonal) / 100;
                                                var amount1  = Math.ceil(premium1 * rate / 100);
