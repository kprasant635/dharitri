...
<div class="tab-pane active" role="tabpanel" id="step1">
    ...
    <div class="reza-card">
        <div class="reza-body">
            <!-- =========Settlement Institution Details Start======= -->
            <h5 class="reza-title">
                        ...
                        <table class="table table-bordered">
                            ...
                            foreach($ins_data as $ins){
                                ...
                                <tr class="<?=$hideNs?>">
                                    ...
                                    <td><?=$ins->director_of?></td>
                                </tr>
                                <tr class="<?=$hideNs?>">
                                    <th>Undertaking Board</th>
                                    <td><?=$ins->undertaking_board?></td>
                                </tr>
                                <tr class="<?=$hideNs?>">
                                    <th>Under taking board address</th>
                                    <td><?=$ins->undertaking_board_address?></td>
                                </tr>
                                ...
                                <!-- <tr class="<?=$hideNs?>">
                                    <th>Is the Institute Under Center Undertaking</th>
                                    <td><?=$ins->is_under_central_undertaking?></td>
                                </tr> -->
                                <tr>
            ...
            <!-- =========Settlement Institution Details End======= -->
                            ...
                            foreach ($applicants_buyers as $identity):
                                if($identity->is_applicant == 1){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong class="alert-warning">
                                                <?=$identity->eng_pdar_name;?>
                                            </strong>
                                        </td>
                                        <th>Guardian Name (English)</th>
                                        <td>
                                            <strong class="alert-warning">
                                                <?=$identity->eng_pdar_guardian;?>
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <?php if ($applicants_encroacher == true) { ?>
                <h5 class="reza-title" style="margin-top: 50px">
                    <i class="fa fa-user-secret"></i> Occupier's Details (Non individual Juridical Entity)
                </h5>
                <div class="tableCard">
                    <table class="table table-bordered">
                        <?php $enc_count = 1; foreach ($applicants_encroacher as $riotee) { ?>
                            <tr >
                                ...
                                <th style="max-width: 18%!important; min-width: 18%!important; width: 18%"> Entity Name</th>
                                <td style="max-width: 30%!important; min-width: 30%!important; width: 30%!important;">
                                    <strong class="alert-warning">
                                        <?=$riotee->pdar_name;?>
                                    </strong>
                                </td>
                                <th style="max-width: 18%!important; min-width: 18%!important; width: 18%">Office bearer's Name</th>
                                <td style="max-width: 30%!important; min-width: 30%!important; width: 30%!important;">
                                    <strong class="alert-warning">
                        ...
                        <?php }
                           ...
                           include(APPPATH."views/SettlementView/include/encroacherNotEligibleCoViewIns.php");
                       ...
                       <!--  <tr class="bg-white">
                        ...
                        <tr class="bg-white">
                            <td colspan="6" style="margin-top:2px; border-bottom:1px solid #227576;" class="text-center">
                                <a type="button" target="_blank" class="btn-sm  buttInfo" href="<?php echo base_url(); ?>index.php/SettlementMB3Common/apiDagWiseApplication?app=<?=$basic["applid"];?>&dag=<?=$all_dags->dag_no;?>">
                        ...
                        <?php
                                ...
                                include(APPPATH."views/SettlementView/include/dagNotEligibleCoViewIns.php");
                        ?>
                ...
                <?php $sl_count =1; $i = 1;foreach ($lmnotes as $lmnote): 
                    ...
                    <?php if($validation_bypass == 0): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control"  name="co_operative_registered" value="<?=$lmnote->co_operative_registered=='Y' ? "YES" : "NO"?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control"  name="registration_no" value="<?=$lmnote->registration_no?>" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 ">
                            ...
                            <div class="form-group col-md-6">
                                <?php 
                                if($lmnote->registration_date == '1970-01-01')
                                {
                                    $registration_date = null;
                                }
                                else
                                {
                                    $registration_date = $lmnote->registration_date;
                                }
                                ?>
                        ...
                        <?php if(PREMIUM_FOR_SETTLEMENT == 1){   ?>
                            <div class="row">
                                <div class="form-group col-md-6 ">
                                    <strong><?=$sl_count++?>.</strong> <span class="alert-warning"><strong>Is the land applied for already alloted in the name of institution</strong></span>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control"  name="already_alloted" value="<?=$lmnote->already_alloted=='Y' ? "YES" : "NO"?>" readonly>
                                    
                                </div>
                            </div>
                            <?php if($lmnote->already_alloted == 'Y'){ ?>
                                <div class="row">
                                    <div class="form-group col-md-6 ">
                                        a) Date of allotment
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control"  name="date_of_allotment" value="<?=$lmnote->date_of_allotment?>" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control"  name="actual_purpose_use" value="<?=$lmnote->actual_purpose_use=='YES' ? "YES" : "NO"?>" readonly>
                    ...
                    <?php if($lmnote->lm_rejected_remarks != 'null'){ ?>
                        <div class="row p-5 m-2" style="background:#FFF3CD;">
                        <div class="col-md-12">

                        <?php 
                            include(APPPATH."views/SettlementView/include/coRejectedRemarksIns.php");
                        ?>
                        </div>
                    </div>
                    <?php           } ?>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(arr.responseType == 0){
                        ...
                        if(arr.selfDeclarationDetails.length > 0)
                        {
