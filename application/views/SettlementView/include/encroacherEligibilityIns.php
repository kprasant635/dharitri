<?php if($validation_bypass == 0):?>
            <h5 class="bg-warning p-2" style="margin-top: 10px">
            ...
            <div class="reza-card">
                <div class="reza-body">
                    <?php
                        foreach($applicants_encroacher as $encroacher_eligibility)
                        {
                            ?>
                            <h5 class="mt-2">
                                ...
                                <span class="alert-warning">
                                    *Note [DAG NO: <?=$encroacher_eligibility->dag_no?>]- Encroacher  
                                    <?php 
                                        foreach(json_decode(ENC_VARIFICATION_LIST) as $enc_exist_list)
                                        {
