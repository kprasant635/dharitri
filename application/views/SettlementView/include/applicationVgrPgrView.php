                        ...
                        if($settlement->is_applicant == 1){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="caste_name" readonly name="" value="<?php
                        ...
                        if($settlement->is_applicant == 1){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" readonly name="" value="<?php
            ...
            <div class="tableCard" id='applicantrow_<?=$i?>'>
                <table class="table table-bordered" >
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="pdar_name<?=$settlement->id?>" value="<?php if(isset($err_return)){ echo set_value('pdar_name'.$settlement->id);}else{ echo $settlement->name_ass;}?>" class="form-control input-sm <?php if(form_error('pdar_name'.$settlement->id)){echo 'is-invalid';}?>">
                            <?=form_error('pdar_name' . $settlement->id)?>
                        </td>
                        <th>Guardian name</th>
                        <td colspan="2">
                            <input type="text" name="pdar_guardian<?=$settlement->id?>" value="<?php if(isset($err_return)){ echo set_value('pdar_guardian'.$settlement->id);}else{ echo $settlement->gurdian_name_ass;}?>" class="form-control input-sm <?php if (form_error('pdar_guardian' . $settlement->id)) {echo 'is-invalid';}?>">
                    ...
                    <tr>
                        ...
                        <th>Relation</th>
                        <td>
                            <select name="pdar_rel_guar<?=$settlement->id?>" id="pdar_rel_guar<?=$settlement->id?>" class="form-control <?php if (form_error('pdar_rel_guar' . $settlement->id)) {echo 'is-invalid';}?>" required>
                        ...
                        <td>
                            <select name="pdar_gender<?=$settlement->id?>" id="pdar_gender<?=$settlement->id?>"
                                    class="form-control <?php if (form_error('pdar_gender' . $settlement->id)) {echo 'is-invalid';}?>">
                        ...
                        <th>Mobile</th>
                        <td>
                            <input type="text" name="pdar_mobile<?=$settlement->id?>" value="<?php if(isset($err_return)) { echo set_value('pdar_mobile' . $settlement->id);} else { echo $settlement->mobile;}?>" class="form-control input-sm <?php if (form_error('pdar_mobile' . $settlement->id)) {echo 'is-invalid';}?>" >
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="pdar_add1<?=$settlement->id?>" value="<?php if(isset($err_return)) { echo set_value('pdar_add1' . $settlement->id);} else { echo $settlement->per_add;}?>" class="form-control input-sm <?php if (form_error('pdar_add1' . $settlement->id)) {echo 'is-invalid';}?>">
                            <?=form_error('pdar_add1' . $settlement->id)?>
                        </td>

                        <th>Present address</th>
                        <td colspan="2">
                            <input type="text" name="pdar_add2<?=$settlement->id?>" value="<?php if(isset($err_return)) { echo set_value('pdar_add2' . $settlement->id);} else { echo $settlement->pre_add;}?>" class="form-control input-sm <?php if (form_error('pdar_add2' . $settlement->id)) {echo 'is-invalid';}?>" >
            ...
            <div class="card-text alternate-table-color">
                ...
                <table class="table table-bordered">
                    ...
                    <tr class="bg-info">
                        ...
                        <td>
                            <strong class="alert-warning">
                                <input type="text" id="dag_no<?=$dags->id?>" name="dag_no<?=$dags->id?>" value='<?=$dags->dag_no?>' class="form-control input-sm" readonly>
                            </strong>
                        </td>
                        ...
                        <td>
                            <strong class="alert-warning">
                                <input type="text" id="patta_no<?=$dags->id?>" name="patta_no<?=$dags->id?>" class="form-control input-sm" value='<?=$dags->patta_no;?>' readonly>
                            </strong>
                        </td>
                        <th>Patta type:</th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <strong>
                                <input type="text" id="dag_area_b<?=$dags->id?>" style="text-align: center;" name="dag_area_b<?=$dags->id?>" class="form-control input-sm" value="<?=$dags->applied_bigha?>" readonly>
                            </strong>
                        </td>
                        <td>
                            <span class="input-group-addon">Katha</span>
                            <input type="text" id="dag_area_k<?=$dags->id?>" style="text-align: center;" name="dag_area_k<?=$dags->id?>" value="<?=$dags->applied_katha?>" class="form-control input-sm" readonly>
                        </td>
                        <td>
                            <span class="input-group-addon">Lessa</span>
                            <input type="text" id="dag_area_lc<?=$dags->id?>" style="text-align: center;" name="dag_area_lc<?=$dags->id?>" class="form-control input-sm" value="<?=$dags->applied_lessa?>" readonly>
                        </td>
                        <?php if((in_array($app->dist_code, json_decode(BARAK_VALLEY)))): ?>
                            <td>
                                <span class="input-group-addon">Ganda</span>
                                <input type="text" id="dag_area_g<?=$dags->id?>" style="text-align: center;" value="<?=$dags->applied_ganda?>" class="form-control input-sm" name="dag_area_g<?=$dags->id?>" readonly>
                            </td>
                            <td>
                                <span class="input-group-addon">Kranti</span>
                                <input type="text" id="dag_area_kr<?=$dags->id?>" style="text-align: center;" value="<?=$dags->applied_kranti?>" class="form-control input-sm" name="dag_area_kr<?=$dags->id?>" readonly>
                            </td>
                        <?php endif ; ?>
                    </tr>
                    <tr>
                        <th class="text-primary">
                            Applied area (Homestead)
                            <span class="<?php if(form_error('vgrMaxHomestead')){echo 'is-invalid';}?>"></span>
                            <?=form_error('vgrMaxHomestead');?>
                        </th>
                        <td>
                            <span class="input-group-addon">Bigha</span>
                    ...
                    <tr class="hide">
                        ...
                        <td>
                            <span class="input-group-addon">Bigha</span>
                            <input type="text" style="text-align: center;" required name="agri_bigha<?=$dags->id?>" class="form-control input-sm agri_bigha" value="<?=$dags->agri_bigha?>" onkeyup="agriArea()" id="agri_bigha<?=$total_area_agri_bigha++?>">
                        </td>
                        <td>
                            <span class="input-group-addon">Katha</span>
                            <input type="text" style="text-align: center;" required name="agri_katha<?=$dags->id?>" value="<?=$dags->agri_katha?>" class="form-control input-sm agri_katha" onkeyup="agriArea()" id="agri_katha<?=$total_area_agri_katha++?>">
                        </td>
                        <td>
                            <span class="input-group-addon">Lessa</span>
                            <input type="text" style="text-align: center;" required name="agri_lessa<?=$dags->id?>" class="form-control input-sm agri_lessa" value="<?=$dags->agri_lessa?>" onkeyup="agriArea()" id="agri_lessa<?=$total_area_agri_lessa++?>">
                        </td>
                        <?php if((in_array($app->dist_code, json_decode(BARAK_VALLEY)))): ?>
                            <td>
                                <span class="input-group-addon">Ganda</span>
                                <input type="text" style="text-align: center;"  value="<?=$dags->agri_ganda?>" class="form-control input-sm agri_ganda" name="agri_ganda<?=$dags->id?>" onkeyup="agriArea()" id="agri_ganda<?=$total_area_agri_ganda++?>">
                            </td>
                            <td>
                                <span class="input-group-addon">Kranti</span>
                                <input type="text" style="text-align: center;"  value="<?=$dags->agri_kranti?>" class="form-control input-sm agri_kranti" name="agri_kranti<?=$dags->id?>" onkeyup="agriArea()" id="agri_kranti<?=$total_area_agri_kranti++?>">
                            </td>
                        <?php endif ; ?>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" style="vertical-align : middle;text-align:center;">
                            <button type="button" onclick="editArea(<?=$dags->id?>);" class="btn btn-sm btn-warning">Edit Area</button>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th class="text-danger">
                            ...
                            <span class="<?php if(form_error('appAreaMoreThanDagA') || form_error('totalAppliedAreaZeroCheck')){echo 'is-invalid';}?>"></span>
                    ...
                    <tr class="hide">
                        ...
                        <td>
                            <span class="input-group-addon">Bigha</span>
                            <input type="text" style="text-align: center;" name="ag_dag_area_b" class="form-control input-sm ag_dag_area_b" value="<?=$total_agri_bigha?>" id="total_applied_agri_bigha">
                        </td>
                        <td>
                            <span class="input-group-addon">Katha</span>
                            <input type="text" style="text-align: center;" name="ag_dag_area_k" value="<?=$total_agri_katha?>" class="form-control input-sm ag_dag_area_k" id="total_applied_agri_katha">
                        </td>
                        <td>
                            <span class="input-group-addon">Lessa</span>
                            <input type="text" style="text-align: center;" name="ag_dag_area_lc" class="form-control input-sm ag_dag_area_lc" value="<?=$total_agri_lessa?>" id="total_applied_agri_lessa">
                        </td>
                        <?php if((in_array($app->dist_code, json_decode(BARAK_VALLEY)))): ?>
                            <td>
                                <span class="input-group-addon">Ganda</span>
                                <input type="text" style="text-align: center;" value="<?=$total_agri_ganda?>" class="form-control input-sm ag_dag_area_g" name="ag_dag_area_g" id="total_applied_agri_ganda">
                            </td>
                            <td>
                                <span class="input-group-addon">Kranti</span>
                                <input type="text" style="text-align: center;" value="<?=$total_agri_kranti?>" class="form-control input-sm ag_dag_area_kr" name="ag_dag_area_kr" id="total_applied_agri_kranti">
                            </td>
                        <?php endif ; ?>
                    </tr>
