    ...
    <div class="modal-body">
      <div class="row">
        <div id="additional_property" >
          <input type="hidden" name="application_no" id="application_no" value="<?php if($basic['service_code'] == '14'){ echo $_GET['app']; }else{ echo $this->utilityclass->decryptJwtCase($_GET['app']); }?>">
          <div id="message"></div>
          <div class="row">
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
