...
<html class="no-js">
   ...
   <body style="background: none !important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementCommon/savePaymentNotice" method="post" enctype='multipart/form-data'>
        ...
        <input type="hidden" name="amount_1" value="<?=$net_premium_payable_1;?>">
        <input type="hidden" name="amount_2" value="<?=$net_premium_payable_2;?>">
            ...
            border: 1px solid #191919;
              ...
              <div class="row mt-4">
                 <div class="col-12 text-justify p-5">
                    ...
                    <br>
                    <br>
                    ইয়াৰ দ্বাৰা আপোনাক জনোৱা হয় যে মিছন বসুন্ধৰাৰ অধীনত <b><?=$service_name?></b> সেৱাৰ বাবে আপুনি নিম্নোক্ত তপচিলভুক্ত ভূমিৰ বাবে <b><?=$date_of_application?></b> তাৰিখে আবেদন নং  <b><?=$application_no?></b> যোগে দাখিল কৰিছে।
                    ...
                    আৱেদন পৰীক্ষাৰ অন্তত <b><?=$date_of_sldc?></b> তাৰিখৰ ভূমি উপদেষ্টা সমিতিৰ বৈঠকৰ সিদ্ধান্ত অনুসৰি আৰু ৰাজহ আৰু দুৰ্যোগ ব্যৱস্থাপনা বিভাগ, অসম চৰকাৰৰ অধিসূচনা No. <?=$dept_order_no?> dtd <?=$dept_order_date?> অনুযায়ী চৰকাৰী মাটিৰ পট্টনৰ বাবে আবেদন প্ৰস্তাৱত অনুমোদন জনোৱা হৈছে। সেয়েহে অসম ভূমি ও ৰাজহ অধিনিয়ম ১৮৮৬ অন্তর্গত ৩২(১) ধাৰা অনুসৰি ওপৰত উল্লেখ কৰা দাগত আপোনাৰ দখলত থকা ভূমিৰ পট্টনৰ বাবে এই জাননীযোগে জনোৱা হ'ল আৰু আপুনি উক্ত পট্টন গ্ৰহন কৰিবলৈ সন্মত হলে তলত উল্লেখিত ধৰনে প্ৰিমিয়াম আদায় দিবলৈ জনোৱা হল ।
                    <br><br>
                    সেই অনুসৰি উক্ত ভূমিৰ প্ৰিমিয়াম আদায় ক্ৰমে আপোনাৰ নামত পট্টনৰ বাবে কতৃপক্ষই বিবেচনা কৰিছে। 
                    <br><br>
                    আপুনি আদায় দিবলগীয়া প্ৰিমিয়ামৰ মূল্য তলত দিয়া ধৰণৰ -

                    <br><br>

                    <b><u>চৰ্তযুক্ত বন্দৱস্তীৰ বাবে প্ৰিমিয়ামৰ হাৰ </u></b>
                    ...
                    <table class="mt-4 mb-4">
                        <thead>
                            <tr>
                                ...
                                <th>মাণ্ডলিক মূল্য (প্ৰতি বিঘা)</th>
                                <th>দাগ নং</th>
                                <th class="text-center">কালি</th>
                                <th class="text-center">মুঠ প্রিমিয়াম</th>
                            </tr>
                        </thead>
                        <tbody>
                           <?php echo $tbody; ?>
                    ...
                    <b><u>সম্পূৰ্ণ বন্দৱস্তীৰ বাবে প্ৰিমিয়ামৰ হাৰ </u></b>
                    ...
                    <table class="mt-4 mb-4">
                        <thead>
                            <tr>
                                <th class="text-center">ক্ৰমিক নং</th>
                                <th class="text-center">বৰ্ণনা</th>
                                <th>মাণ্ডলিক মূল্য (প্ৰতি বিঘা)/ বিশেষ শ্ৰেণী</th>
                                <th>দাগ নং</th>
                                <th class="text-center">কালি</th>
                                <th class="text-center">মুঠ প্রিমিয়াম</th>
                            </tr>
                    ...
                    সেইমৰ্মে আপুনি সৰ্বমুঠ <b>₹ <?=$net_premium_payable_1?></b> প্ৰিমিয়াম চৰ্তযুক্ত বন্দৱস্তী পাবলৈ অথবা সৰ্বমুঠ <b>₹ <?=$net_premium_payable_2?></b> প্ৰিমিয়াম সম্পূৰ্ণ বন্দৱস্তী পাবলৈ অহা ইং <?=$due_date?> তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জনোৱা হ'ল।
                    <br>
                    <br>
                    ...
                    <br>
                     ...
                     <b>(ক)</b> ওপৰত উল্লেখ কৰা ধৰণে মুঠ প্ৰিমিয়াম আদায় কৰাৰ পাছতহে আৱেদনকাৰীক চৰ্তযুক্ত  ভূমি পট্টা অথবা সম্পূৰ্ণ ভূমি পট্টা প্ৰদান কৰা হব।

                     <br>

                     <b>(খ)</b> আৰচিচি ঘৰ অৱস্থিত ভূমিত বৰ্তমানৰ মাণ্ডলিক মূল্যৰ ১০% প্ৰিমিয়াম আদায় দিয়াৰ পিছত চৰ্তযুক্ত পট্টা প্ৰদান কৰা হ’ব কিন্তু বিক্ৰী,লীজ বা উপহাৰ আদিৰ দ্বাৰা এনে নিষ্পত্তি কৰা ভূমিৰ হস্তান্তৰৰ বাবে জিলা প্ৰশাসনৰ দ্বাৰা আপত্তিহীন প্ৰমাণপত্ৰ প্ৰদানৰ সময়ত বকেয়া প্ৰিমিয়াম হিচাপে তেতিয়াৰ প্ৰচলিত মাণ্ডলিক মূল্যৰ ৪০ শতাংশ আদায় দিব লাগিব। অৱশ্যে এনে চৰ্তযুক্ত পট্টা ভূমি, বিত্তীয় প্ৰতিষ্ঠানসমূহক বন্ধকত দিব পৰা হ’ব যাতে বন্দোবস্তধাৰীয়ে অৰ্থনৈতিক কাৰ্যকলাপ কৰিব পাৰে।

                     <br>

                     <b>(গ)</b> অন্য প্ৰকাৰৰ ঘৰ অৱস্থিত ভূমিত বৰ্তমানৰ মাণ্ডলিক মূল্যৰ ৩% প্ৰিমিয়াম আদায় দিয়াৰ পিছত চৰ্তযুক্ত পট্টা প্ৰদান কৰা হ’ব কিন্তু বিক্ৰী,লীজ বা উপহাৰ আদিৰ দ্বাৰা এনে নিষ্পত্তি কৰা ভূমিৰ হস্তান্তৰৰ বাবে জিলা প্ৰশাসনৰ দ্বাৰা আপত্তিহীন প্ৰমাণপত্ৰ প্ৰদানৰ সময়ত বকেয়া প্ৰিমিয়াম হিচাপে তেতিয়াৰ প্ৰচলিত মাণ্ডলিক মূল্যৰ 27 শতাংশ আদায় দিব লাগিব। অৱশ্যে এনে চৰ্তযুক্ত পট্টা ভূমিবিত্তীয় প্ৰতিষ্ঠানসমূহক বন্ধকত দিব পৰা হ’ব যাতে বন্দোবস্তধাৰীয়ে অৰ্থনৈতিক কাৰ্যকলাপ কৰিব পাৰে।

                     <br>

                     <b>(ঘ)</b> চৰ্তযুক্ত পট্টা ব্যৱস্থাটো ঐচ্ছিক হ'ব আৰু আবেদনকাৰীয়ে প্ৰযোজ্য সম্পূৰ্ণ প্ৰিমিয়াম দি মাটিৰ নিঃচৰ্ত নিষ্পত্তি/বন্দৱস্তী লাভ কৰিব পাৰিব।
              ...
              <div class="col-12 text-justify pl-5 pr-5">
               <b><u>চৰকাৰী অধিসূচনা</u></b> <br>
                  ১)  No. RDM-12011(17)/5/2022-LR-REV-R&DM/94 dtd 11-Nov-2022(e-File No.232314)<br>
                  ২) No. RDM-12011(17)/15/2022-LR-REV-R&DM/14 dtd 21-Aug-2023(e-File No.262568)<br>
                  ৩) No E-540451/I/874570/2024 dtd 27-Dec-2024<br>
                  8) eCF No. 565802/ I/772761/2024 dated Dispur, 15-10-2024 & eCFNo.565802/I/772778/2024 dated Dispur,the 15-10-2024<br>
              ...
              ওপৰত উল্লেখ কৰা প্রিমিয়াম আপোনাৰ স্ব- ঘোষণাৰ লগতে সংশ্লিষ্ট চক্ৰ বিষয়াই কৰা (সম্ভাব্য) মূল্যায়নৰ ওপৰত নিৰ্ধাৰণ কৰি আপোনাৰ দখল/অধীনত থকা মাটিৰ ওপৰত নিৰ্ণয় কৰা হৈছে। আধুনিক পদ্ধতিৰে জৰীপৰ পাছত দখল/অধীনত থকা প্ৰকৃত মাটিৰ পৰিমাণ সাল-সলনি হ’লে বিধি অনুযায়ী ব্যৱস্থা লোৱা হব ।
               <br><br>
