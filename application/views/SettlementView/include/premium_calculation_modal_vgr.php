            ...
            <div class="modal-content">
                ...
                <div class="modal-body" align="">
                    <?php 
                        ...
                        foreach($applicants_encroacher as $dagspremnew) {
                    ...
                    ?>
                        ...
                        <div class="tableCard " style="padding: 25px!important;">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" readonly onkeyup="zonalValueChange<?=$dagspremnew->dag_no?>()" name="zonal_valuation_prem<?=$dagspremnew->dag_no?>" id="zonal_valuation_prem<?=$dagspremnew->dag_no?>"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <select readonly class="form-control"  name='area<?=$dagspremnew->dag_no?>' id='area<?=$dagspremnew->dag_no?>' >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    <select name="land_type<?=$dagspremnew->dag_no?>" id="landtypes<?=$dagspremnew->dag_no?>" class="form-control" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    <select name="rate_type<?=$dagspremnew->dag_no?>" id="ratetypes<?=$dagspremnew->dag_no?>" class="form-control">
                                        <option value="">Select Premium </option>
                                    </select>

                                </div>
                            </div>
                            <div class="row" id="percentage<?=$dagspremnew->dag_no?>">
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 ">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="radio" id="concession1" name="concession<?=$dagspremnew->dag_no?>" class="concession<?=$dagspremnew->dag_no?>" value="YES">
                                    <label for="html">YES</label>
                                    <input type="radio" id="concession2" name="concession<?=$dagspremnew->dag_no?>" class="concession<?=$dagspremnew->dag_no?>" value="NO">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input id="finalper<?=$dagspremnew->dag_no?>" type="hidden" class="finalper<?=$dagspremnew->dag_no?>" value="" name="finalper<?=$dagspremnew->dag_no?>" />
                                    <input id="total_lessa<?=$dagspremnew->dag_no?>" type="hidden" class="total_lessa<?=$dagspremnew->dag_no?> dag_total_lessa" value="" name="total_lessa<?=$dagspremnew->dag_no?>" />
                                    <input id="amount_<?=$dagspremnew->dag_no?>" type="number"
                        ...
                        <script>
                            ...
                            var area_id = $("#area_new<?=$dagspremnew->dag_no?>").val();
                            var area_category = $("#area_cat_new<?=$dagspremnew->dag_no?>").val();
                            var land_area_name_new =
                                                ...
                                                area_category +
                                                "</option>";
                            $("#area<?=$dagspremnew->dag_no?>").html(land_area_name_new);
                            // alert(area_id);
                            // alert(area_category);
                            $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        $("#landtypes<?=$dagspremnew->dag_no?>").html(template);
                            ...
                            //////// for premium
                            function zonalValueChange<?=$dagspremnew->dag_no?>(){
                                $("#area<?=$dagspremnew->dag_no?>").val('');
                                $("#landtypes<?=$dagspremnew->dag_no?>").val('');
                                $("#rate_type<?=$dagspremnew->dag_no?>").val('');
                                $("#ratetypes<?=$dagspremnew->dag_no?>").val('');
                                $('#amount_<?=$dagspremnew->dag_no?>').val('');
                                $('#rate<?=$dagspremnew->dag_no?>').val('');
                                $(".premhide").hide();
                                $("#finalsubmit").show();
                                $("#finalsave").hide();
                                $('#totaldue').val('');
                                $('#finalamount').val('');
                                $(".concession<?=$dagspremnew->dag_no?>").prop( "checked", false );
                            ...
                            $( "select[name='area_cat<?=$dagspremnew->dag_no?>']" ).change(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        $("#area_subcat<?=$dagspremnew->dag_no?>").html(land_under);
                                        clear();
                            ...
                            $( "select[name='area_subcat<?=$dagspremnew->dag_no?>']" ).change(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        $("#area<?=$dagspremnew->dag_no?>").html(land_area_name);
                            ...
                            $( "select[name='area<?=$dagspremnew->dag_no?>']" ).change(function () {
                                var areaID = $(this).val();
                                var areaType = $("#area<?=$dagspremnew->dag_no?> option:selected").text();
                            ...
                            $( "select[name='land_type<?=$dagspremnew->dag_no?>']" ).change(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        //console.log(template);
                                        $("#ratetypes<?=$dagspremnew->dag_no?>").html(template);
                                        clear();
                                    },
                                    error: function(error) {
                                        // loading.out();
                            ...
                            $( "select[name='rate_type<?=$dagspremnew->dag_no?>']" ).change(function () {
                                var typeID = $(this).val();
                                // alert(typeID); return;
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        for (var i = 0; i < landpercentage.length; i++) {
                                            if(landpercentage[i].rate_type=='P'){var ratetype='%'} else if (landpercentage[i].rate_type=='R'){var ratetype='Rs -@500/bigha'}
                                            var template =
                                                "<div class='form-group col-md-6'><label> Rate ('"+ratetype+"')</label></div>";
                                            template +=
                                                "<div class='form-group col-md-6'><input type='text' readonly id='rate<?=$dagspremnew->dag_no?>' class='form-control' name='rate<?=$dagspremnew->dag_no?>' value='" +
                                                landpercentage[i].rate +
                                                "'><input type='hidden' readonly id='amount_type<?=$dagspremnew->dag_no?>' class='form-group' name='amount_type<?=$dagspremnew->dag_no?>' value='" +
                                                landpercentage[i].rate_type +
                                                "'><input type='hidden' readonly id='mb_land<?=$dagspremnew->dag_no?>' class='form-group' name='mb_land<?=$dagspremnew->dag_no?>' value='" +
                                                landpercentage[i].mb_land +
                                                "'><input type='hidden' readonly id='max_land<?=$dagspremnew->dag_no?>' class='form-group' name='max_land<?=$dagspremnew->dag_no?>' value='" +
                                                landpercentage[i].max_land +
                                                "'><input type='hidden' readonly id='approval<?=$dagspremnew->dag_no?>' class='form-group' name='approval<?=$dagspremnew->dag_no?>' value='" +
                                                landpercentage[i].approval +
                                                "'></div>";
                                        }
                                        //console.log(template);
                                        $("#percentage<?=$dagspremnew->dag_no?>").html(template);
                                        $('#amount_<?=$dagspremnew->dag_no?>').val('');
                                        $('#totaldue').val('');
                                        $('#finalamount').val('');
                                        $(".premhide").hide();
                            ...
                            $('.concession<?=$dagspremnew->dag_no?>').click(function() {
                            ...
                            // $("input[name=concession<?=$dagspremnew->dag_no?>]").on("click", function () {
                                ...
                                var zonal = parseFloat($("#zonal_valuation_prem<?=$dagspremnew->dag_no?>").val());
                                var selectedValue = $("input[name=concession<?=$dagspremnew->dag_no?>]:checked").val();
                                var agribigha=0;
                                var agrikatha=0;
                                var agrilessa=0;
                                var agriganda=0;

                                var mbigha=parseFloat($("#home_b<?=$dagspremnew->dag_no?>").val());
                                var mkatha=parseFloat($("#home_k<?=$dagspremnew->dag_no?>").val());
                                var mlessa=parseFloat($("#home_lc<?=$dagspremnew->dag_no?>").val());
                                var mganda=parseFloat($("#home_g<?=$dagspremnew->dag_no?>").val());
                                ...
                                if (family_reserved_yn == "YES") {
                                    var family_bigha=parseFloat($("#reserved_bigha_family<?=$dagspremnew->dag_no?>").val());
                                    var family_katha=parseFloat($("#reserved_katha_family<?=$dagspremnew->dag_no?>").val());
                                    var family_lessa=parseFloat($("#reserved_lessa_family<?=$dagspremnew->dag_no?>").val());
                                    var family_ganda=parseFloat($("#reserved_ganda_family<?=$dagspremnew->dag_no?>").val());
                                ...
                                var rate_type = $("#amount_type<?=$dagspremnew->dag_no?>").val();
                                var mb_land = 0;
                                mb_land = $("#mb_land<?=$dagspremnew->dag_no?>").val();
                                if(mb_land==25){
                                    mb_land =1600;
                                } else if(mb_land==30){
                                    mb_land =1920;
                                ...
                                if (selectedValue == "YES") {
                                    ...
                                    var rate = parseFloat($("#rate<?=$dagspremnew->dag_no?>").val());
                                    var getPrice = 25;
                                    if(rate_type=='P'){
                                        ...
                                        // var amount = Math.ceil(premium * discount / 100);
                                        var premium = total_s_area * rate / 6400;
                                        var discount = Math.ceil(premium * (getPrice/100));
                                        var amount = Math.ceil(premium - discount);
                                        $(".downpay").hide();
                                    }

                                    $('#finalper<?=$dagspremnew->dag_no?>').val(discount);
                                    $('#amount_<?=$dagspremnew->dag_no?>').val(amount);
                                    $('#total_lessa<?=$dagspremnew->dag_no?>').val(total_s_area);
                                    ...
                                    if (selectedValue == "NO") {
                                        ...
                                        if(rate_type =='P'){
                                            ...
                                            // var premium = total_s_area * rate / 6400;
                                            // var amount = Math.ceil(premium * rate / 100);
                                            var amount = Math.ceil(total_s_area * rate / 6400);
                                            $(".downpay").hide();
                                        }

                                        $('#finalper<?=$dagspremnew->dag_no?>').val(rate);
                                        $('#amount_<?=$dagspremnew->dag_no?>').val(amount);
                                        $('#total_lessa<?=$dagspremnew->dag_no?>').val(total_s_area);
                                        $('#validationcheck').val(1);
                                    }
                                ...
                                if (selectedValue == "YES") {
                                    ...
                                    if (selectedValue == "NO") {
                                        ...
                                        if(rate_type =='P'){
                                            ...
                                            var amount = Math.ceil(total_s_area * rate / 100);
                                            $(".downpay").hide();
