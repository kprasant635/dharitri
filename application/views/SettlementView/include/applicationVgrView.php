                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if (isset($basic["tribal_belt"])) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <strong class="alert-warning">
                                            <?php if($basic['tribal_belt'] == '1') { ?>
                                                <input type="text" readonly value="Yes" 
                                                    class="form-control">
                                            <?php } else { ?>
                ...
                <table class="table">
                    <thead class="thead-warning">
                        <tr>
                            ...
                            <th class="text-center">Lessa / Chatak</th>
            ...
            <div class="tableCard">
                <?php  $sl_count = 1;  $i=1; foreach($lmnotes as $lmnote):
                    ...
                    <div class="row p-2" >
                        <div class="col-md-6">
                            <span
                            ><strong><?=$sl_count++?>.</strong> VLB Verified?</span
                            >
                        </div>
                        <div class="col-md-2">
                            <div class="form-check form-check-inline">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-6 form-group">
                            <select name="applied_scheme" id="applied_scheme" class="form-control" disabled>
                                <?php foreach(json_decode(APPLIED_SCHEME) as $class): ?>
                                    <option value="<?php echo $class->CODE ?>" <?php if($lmnote->applied_scheme == $class->CODE){echo "selected";} ?>>
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-6 form-group">
                            <select name="protected_class_lm" id="protected_class_lm" class="form-control" disabled>
                                <?php foreach(json_decode(PROTECTED_CLASS) as $class): ?>
                                    <option value="<?php echo $class->CODE ?>" <?php if($lmnote->protected_class_lm == $class->CODE){echo "selected";} ?>>
                                        <?php echo $class->NAME ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <div class="row p-2" >
                        <div class="col-md-6">
                            <span
                            ><strong><?=$sl_count++?>.</strong> Whether proposed land is under litigation?</span>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check form-check-inline">
                                <input
                    ...
                    <div class="row p-2" >
                        <div class="col-md-6">
                            <span
                            ><strong><?=$sl_count++?>.</strong> Is Area Under cover landslide prone ? </span>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check form-check-inline">
                                <input
                    ...
                    <div class="row p-2" >
                        <div class="col-md-6">
                            <span
                            ><strong><?=$sl_count++?>.</strong> Whether the land falls under erosion?</span>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check form-check-inline">
                                <input
                    ...
                    <div class="row p-2" >
                        <div class="col-md-6">
                            <span
                            ><strong><?=$sl_count++?>.</strong> Nature of possession </span>
                        </div>
                        <div class="form-group col-md-6">
                            <select
                    ...
                    <div class="row p-2">
                        <div class="col-md-6 text-justify">
                            <span
                            ><strong><?=$sl_count++?>.</strong> Category of the proposed land?</span>
                        </div>
                        <div class="col-md-6 form-group">
                            <select name="land_falls" id="land_falls" class="form-control" disabled>
                                <?php foreach(json_decode(LAND_FALLS) as $landCode): ?>
                                    <option value="<?php echo $landCode->CODE ?>" <?php if($lmnote->land_falls == $landCode->CODE){echo "selected";}?>>
                    ...
                    <?php if ($reservation == true) {?>
                        <div class="row p-2" >
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input disabled type="radio" onclick="roadSideReservYes();" class="form-check-input roadside_comment_check1 <?php if(form_error('roadside_comment_check')) {
                                        echo 'lm_invalid';
                                    }?>" name="roadside_comment_check" id="roadside_comment_check1" value="YES" <?php 
                                    //if($reservation != null) {
                                        foreach ($reservation as $reserv_road) 
                                        {
                                ...
                                <div class="form-check form-check-inline">
                                    <input disabled type="radio"  onclick="roadSideReservNo();" class="form-check-input roadside_comment_check2 <?php if(form_error('roadside_comment_check')) {
                                        echo 'lm_invalid';
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <textarea readonly name="lm_remark_text" placeholder="Enter remark..." class="form-control p-2" id="lm_remark_text" cols="30" rows="12"><?=$lmnote->lm_remark_text?></textarea>

                        </div>
                    </div>

                    <hr>
                    <?php if($vgrReservation == true){
                        ?>

                        <div class="row p-2">
                            <div class="col-md-12">
                                <h5  class="reza-title">
                                    <i class="fa fa-pie-chart" aria-hidden="true"></i> Reservation / De Reservation Proposal 
                                </h5>
                                <table class="table table-bordered">
                                    <tr>
                                        <th>District Name:</th>
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$this->utilityclass->getDistrictName($vgrReservation->dist_code)?>
                                            </strong>
                                        </td>
                                        <th>Subdivision Name:</th>
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$this->utilityclass->getSubDivName($vgrReservation->dist_code,$vgrReservation->subdiv_code)?>
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$this->utilityclass->getCircleName($vgrReservation->dist_code,$vgrReservation->subdiv_code,$vgrReservation->cir_code)?>
                                            </strong>
                                        </td>
                                        <th>Mouza Name: </th>
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$this->utilityclass->getMouzaName($vgrReservation->dist_code,$vgrReservation->subdiv_code,$vgrReservation->cir_code,$vgrReservation->mouza_pargona_code)?>
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$this->utilityclass->getVillageName($vgrReservation->dist_code,$vgrReservation->subdiv_code,$vgrReservation->cir_code,$vgrReservation->mouza_pargona_code,$vgrReservation->lot_no,$vgrReservation->vill_townprt_code)?>
                                            </strong>
                                        </td>
                                        <th>Dag No: </th>
                                        <td class="text-warning">
                                            <strong class="alert-warning">
                                                <?=$vgrReservation->dag_no ?>
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <span class="input-group-addon">Bigha</span>
                                            <input readonly type="text" style="text-align: center;" name="bigha" class="form-control input-sm bigha" value="<?=$vgrReservation->dag_area_b?>" >
                                        </td>
                                        <td>
                                            <span class="input-group-addon">Katha</span>
                                            <input readonly type="text" style="text-align: center;" name="katha" value="<?=$vgrReservation->dag_area_k?>" class="form-control input-sm katha" >
                                        </td>
                                        <td>
                                            <span class="input-group-addon">Lessa</span>
                                            <input readonly type="text" style="text-align: center;" name="lessa" class="form-control input-sm lessa" value="<?=$vgrReservation->dag_area_lc?>" >
                                        </td>
                                        <?php if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))): ?>
                                            <td>
                                                <span class="input-group-addon">Ganda</span>
                                                <input readonly type="text" style="text-align: center;" value="<?=$vgrReservation->dag_area_g?>" class="form-control input-sm ganda" name="ganda" >
                                            </td>
                                            <td>
                                                <span class="input-group-addon">Kranti</span>
                                                <input readonly type="text" style="text-align: center;" value="0" class="form-control input-sm kranti" name="kranti" >
                                            </td>
                                        <?php endif ; ?>
                                    </tr>
                    ...
                    <?php
                        if($lmnote->vgr_dag_availability == 'n'){
                            ?>
                            <div class="row bg-danger text-center">
                                <span class="text-white"><h5>Dag not available to reserve/de-reserve area !</h5></span>
                            </div>
                        <?php
                        }
