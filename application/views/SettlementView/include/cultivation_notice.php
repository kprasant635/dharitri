...
<html class="no-js">
   ...
   <body style="background: none !important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementTeaCo/savePaymentNotice" method="post" enctype='multipart/form-data'>
            ...
            border: 1px solid #191919;
              ...
              <div class="row mt-4">
                 <div class="col-12 text-justify p-5">
                          ...
                          //  echo $condition;
                           if($condition == 1)
                           {
                              ?>
                                <tr>
                                    ...
                                    <td><b>প্ৰিমিয়ামৰ মূল্য (ৰবৰ/কফি বিশেষ খেতি- প্ৰতি বিঘাত ৫০০০ টকাকৈ)</b></td>
                           ...
                           elseif($condition == 2)
                           {
                              ?>
                                 <tr>
                                    ...
                                    <td><b>প্ৰিমিয়ামৰ মূল্য (চাহ বিশেষ খেতি-প্ৰতি বিঘাত ১০০০ টকাকৈ ৩০ বিঘাৰ লৈকে )</b></td>
                                    <td><?=$premium_per_bigha?></td>
                                    <td><?=$dag_no?></td>
                                    <td><?=$area?></td>
                           ...
                           elseif($condition == 3)
                           {
                              ...
                              <tr>
                                 ...
                                 <td><b>প্ৰিমিয়ামৰ মূল্য (চাহ বিশেষ খেতি - ৩০ বিঘাৰ উৰ্দ্ধত আৰু ৭৫ বিঘাৰ লৈকে -মাণ্ডলিক মূল্যৰ ১০০%)</b></td>
                                 <td><?=$premium_per_bigha?></td>
                                 <td><?=$dag_no?></td>
                                 <td><?=$area?></td>
                                 <td><?=$premium_payable_without_concession?></td>
                    ...
                    সেইমৰ্মে আপোনাক সৰ্বমুঠ <b><?=$net_premium_payable?></b> টকাৰ প্ৰিমিয়াম অহা ইং <?=$due_date?> তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জনোৱা হ'ল।
                    <br>
                    <br>
                    <u>চৰ্তাৱলী</u>
                    <br>
              ...
              <div class="col-12 text-justify p-5 fw-bold">
               ...
               ২) No. RDM-15014/21/2017-LS-REV/9, dtd. 26-March-2018 (ECF No. 31465) <br>
               ৩) No.RSS.327/2020/1 dtd 4-Nov-2020 <br>
               ৪) No. RDM-12011(17)/5/2022-LR-REV-R&DM/94 dtd 11-Nov-2022(e-File No.234314) <br>
               ৫) eCF No.565802/I/772730/2024 dtd Dispur,the 15-10-2024, eCF No. 565802/ I/772761/2024 dtd Dispur, 15-10-2024 and eCFNo.565802/I/772778/2024 dtd Dispur,the 15-10-2024. -->
              ...
              <!-- <b>ওপৰত উল্লেখ কৰা প্রিমিয়াম আপোনাৰ স্ব- ঘোষণাৰ লগতে সংশ্লিষ্ট চক্ৰ বিষয়াই কৰা (সম্ভাব্য) মূল্যায়নৰ ওপৰত নিৰ্ধাৰণ কৰি আপোনাৰ দখল/অধীনত থকা মাটিৰ ওপৰত নিৰ্ণয় কৰা হৈছে। আধুনিক পদ্ধতিৰে জৰীপৰ পাছত দখল/অধীনত থকা প্ৰকৃত মাটিৰ পৰিমাণ সাল-সলনি হ’লে আদায় দিবলগীয়া ভূমিৰ প্ৰিমিয়াম সংশোধন কৰা হ’ব পাৰে। </b> -->
               ...
               <br>
               আপোনাৰ প্রিমিয়াম Sewa Setu (https://sewasetu.assam.gov.in/) পৰ্টেলৰ পৰা পৰিশোধ কৰিব পাৰিব।
              </div>
              </div>
