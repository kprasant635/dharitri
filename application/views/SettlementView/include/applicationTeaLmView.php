...
function wrong_poss_forward_lra_to_co() {
    ...
    $.ajax({
        url: baseurl + "index.php/SettlementPossesionFrom/formSubmitFromLra",
        type: 'POST',
            ...
            if (response.result === 'SUCCESS') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = baseurl + "index.php/SettlementPossesionFrom/index";
                    }
                });
            } else {
                Swal.fire({
...
function wrong_poss_co_update() {
    ...
    $.ajax({
        url: baseurl + "index.php/SettlementPossesionFrom/formSubmitFromCo",
        type: 'POST',
        enctype: 'multipart/form-data',
        data: formdata,
        contentType: false,
        ...
        success: function (response) {
            ...
            if (response.result === 'SUCCESS') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = baseurl + "index.php/SettlementPossesionFrom/coLanding";
                    }
                });
            } else {
                Swal.fire({
