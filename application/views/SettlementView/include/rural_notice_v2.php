...
<html class="no-js">
   ...
   <body style="background: none !important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementCommon/savePaymentNotice" method="post" enctype='multipart/form-data'>
         <input type="hidden" name="version" value="<?=RURAL_PAYMENT_V2?>">
            ...
            border: 1px solid #191919;
              ...
              <div class="row mt-4">
                 <div class="col-12 text-justify p-5">
                    ...
                    <br>
                    <br>
                    ইয়াৰ দ্বাৰা আপোনাক জনোৱা হয় যে মিছন বসুন্ধৰাৰ অধীনত <b><?=$service_name?></b> সেৱাৰ বাবে আপুনি নিম্নোক্ত তপচিলভূক্ত ভূমিৰ বাবে <b><?=$date_of_application?></b> তাৰিখে আৱেদন নং  <b><?=$application_no?></b>. দাখিল কৰিছিল |
                    ...
                    আৱেদন পৰীক্ষাৰ অন্তত  <b><?=$date_of_sldc?></b> তাৰিখৰ ভূমি উপদেষ্টা সমিতিৰ বৈঠকৰ সিদ্ধান্ত অনুসৰি চৰকাৰী মাটিৰ পট্টনৰ বাবে দাখিল কৰা আৱেদন প্ৰস্তাৱত অনুমোদন জনোৱা হৈছিল। সেয়েহে অসম ভূমি আৰু ৰাজহ অধিনিয়ম, ১৮৮৬ৰ ধাৰা ৩২(১) অনুসৰি ওপৰত উল্লেখিত দাগত আপোনাৰ দখলত থকা ভূমিৰ পট্টনৰ বাবে <?=$payment_notice_date?>
                    তাৰিখৰ জাননীৰ যোগে আৰু চৰকাৰী অধিসূচনা Ecf No441422/1 Dated Dispur31-01-2024 মৰ্মে প্ৰিমিয়াম ১৫ ফেব্ৰুৱাৰী, ২০২৪ তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জাননী দিয়া হৈছিল | পুনৰ এই জাননীযোগে জনোৱা হ'য় যে, আপুনি যদি উক্ত পট্টন গ্ৰহণ কৰিবলৈ সন্মত হয়, তেন্তে তলত উল্লেখিত ধৰনে প্ৰিমিয়াম ৩১ ডিচেম্বৰ, ২০২৫ তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জনোৱা হ'ল।
                    ...
                    সেইমৰ্মে আপোনাক সৰ্বমুঠ <b><?=$net_premium_payable?></b> টকাৰ  প্ৰিমিয়াম অহা ইং 31/12/2025 তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জনোৱা হ’ল।
                    <br>
                    <br>
                    <u>চৰ্তাৱলী</u>
                    <br>
                    ...
                    গ) ওপৰত উল্লেখিত বর্ধিত সময়সীমাৰ ভিতৰত আবেদনকাৰীৰ পৰা প্ৰিমিয়াম কোষাগাৰত নিম্নলিখিত ধৰণে জমা নহ’লে, চৰকাৰী অধিসূচনা No. ECF. 675554/2025/47 dated 28-10-2025 মৰ্মে  উক্ত বন্দোবস্তীৰ প্ৰস্তাৱ ০১/০১/২০২৬ তাৰিখৰ পৰা বাতিল হিচাপে গণ্য হ’ব।
                    <br>
