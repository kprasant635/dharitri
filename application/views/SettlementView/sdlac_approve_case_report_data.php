...
<div class="row" style='padding: 40px 0px 40px 20px'>
    ...
    <div class="row" style='padding: 5px 5px 5px 0px' id="print_direct">
                                    ...
                                    <tr>
                                        <?php foreach ($locations as $location): ?>
                                            <td style="align-content: center; text-align: center">
                                                ...
                                                ($meeting->id,$this->session->userdata('dist_code'),$location['subdiv_code'],$location['cir_code'],1);
