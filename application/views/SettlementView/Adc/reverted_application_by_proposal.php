...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?=base_url().'index.php/SettlementProposalController/getProposalUnderRevertedMeetingForAdc/?meetingId='. $proposalDetails->proposal_meeting_id ?>"> Proposals</a> /
            SDLAC/CDLAC Report
            <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalController/getProposalUnderRevertedMeetingForAdc/?meetingId='. $proposalDetails->proposal_meeting_id ?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
