...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB /
            <a href="<?= base_url()?>index.php/SettlementTeaAdc/SettlementTeaLandAdc">Special Cultivators</a> /
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var service_code = <?= SETTLEMENT_SPECIAL_CULTIVATORS_ID ?>;
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementTeaAdc/thirdProceedingSdlacReport',
                type : 'POST',
                data : {
    ...
    function openTab(id){
        ...
        $.ajax({
            url  : base_url+'index.php/SettlementTeaAdc/getCasesAgainstProposalNo',
            dataType: "JSON",
