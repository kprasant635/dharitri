...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementTeaADC/viewAllMarkAsSDLACListForDCTea">SDLAC/CDLAC Recommended (Marked)</a>
...
<script>
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaAdc/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaAdc/generateNoticeSendAllMarkAppToSDLACByDcTea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementTeaAdc/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
