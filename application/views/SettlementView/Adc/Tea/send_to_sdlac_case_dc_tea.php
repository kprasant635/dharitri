...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB /
            <a href="<?= base_url()?>index.php/SettlementTeaAdc/SettlementTeaLandDc">Special Cultivators</a> /
            <a href="<?= base_url()?>index.php/SettlementTeaAdc/getAllProposalListSdlacTea">SDLAC/CDLAC Reports</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementTeaAdc/getAllProposalListSdlacTea">
            ...
            <div class="reza-title">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="hidden" id="service_code" value="<?=SETTLEMENT_SPECIAL_CULTIVATORS_ID?>">
                    ...
                    <!--                        --><?php //if($proposalDetails->sdlac_prceed_status == 2) { ?>
                    <!--                            <span style="color: #EF5350; font-weight: bold; font-size: 18px">-->
                    <!--                                --><?php //echo $this->lang->line('finalApprovalPending'); ?>
                    <!--                            </span>-->
                    <!--                        --><?php //} ?>
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementTeaAdc/viewApprovedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementTeaAdc/viewRejectedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementTeaAdc/viewRejectedAppDetailsTea/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaAdc/updateProposalHearingDateTea",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaAdc/updateHearingDateGenerateNoticeTea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTeaAdc/proposalForwardToDcForFinalVerifyTea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function report_no(id, case_no) {
        ...
        showNewRejectModalMb2(case_no, '<?= SETTLEMENT_SPECIAL_CULTIVATORS_ID ?>')
    }

    $(document).on('click','#finalSubmit',function() {
        prop_id = $('#proposalIdForward').val();
        $.ajax({
            url: BASE_URL + "/SettlementTeaAdc/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/SettlementTeaAdc/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementTeaAdc/getAllProposalListSdlacTea";
                }
                })
                }
                else
