...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB / <a href="<?= base_url()?>index.php/SettlementTeaADC/SettlementTeaLandAdc">Special Cultivators</a>

            <a href="<?= base_url()?>index.php/SettlementTeaADC/SettlementTeaLandAdc">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Settlement of Special Cultivators</span>
            ...
            <div class="reza-body">
                <table class="table table-striped table-hover">
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        ...
                        <!--                            </td>-->
                        <!--                            <td>-->
                        <!--                                <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaAdc/getAllSdlacMemberApprovalProposalListTea'; ?><!--" style="float:right">-->
                        <!--                                    <i class="fa fa-eye"></i>&nbsp;view-->
                        <!--                                </a>-->
                        <!--                            </td>-->
                        <!--                        </tr>-->
                    ...
                    <!--                            </td>-->
                    <!--                            <td>-->
                    <!--                                <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaADC/getAllReReportAppByCOForDcAppKhas'; ?><!--" style="float:right">-->
                    <!--                                    <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                                </a>-->
                    <!--                            </td>-->
                    <!--                        </tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDc/getAllRejectedApplicationByCoForAdc?service='.SETTLEMENT_SPECIAL_CULTIVATORS_ID .'&s='.MB_DISMISS; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementModification/getAllModificationRequestApplicationByCoForAdc?service='.SETTLEMENT_SPECIAL_CULTIVATORS_ID; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDC/rejectedList?service='.SETTLEMENT_SPECIAL_CULTIVATORS_ID.'&s=D&office='.MB_ADD_DEPUTY_COMM; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
