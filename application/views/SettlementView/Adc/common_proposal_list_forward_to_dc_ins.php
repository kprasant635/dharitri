...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 3.0 / SDLAC/CDLAC Minute
        </div>
        ...
        <div class="reza-card">
            <div class="row" style="padding: 15px">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right">
                    <a class="rezaButt rezaPrint pull-right" href="<?=base_url().'index.php/SettlementCommonDc/addEditCopyToIns'?>">
            ...
            <div class="reza-body">
                    ...
                    <tr>
                        ...
                        <th>Service Name
                            <select class="form-control" name="by_service" id="by_service" data-column-index="0">
                                ...
                                <option value="<?=SLIJE_ID?>">Juridical Entities</option>
                            </select>
                        </th>
                ...
                <?php if($countPendingCase != 0){ ?>
                    <div class="row">
                        <?php if(SEND_PROPOSAL_TO_SDLAC_MEM_BUTTON_INSTITUTE == 1) { ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="datetime-local" class="form-control"
                                       name="meeting_date" id="meeting_date" required max="<?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_INPUT_INSTITUTE ?>">
                            </div>
            ...
            <div class="modal-body" id="print_direct">
                ...
                <div class="container bg-white divCard pb-3 " style="page-break-before:always;">
                    ...
                    <div class="row">
                        ...
                        <div style="padding-left: 85px">
                            <table>
                                <tbody class="meetingRemarksShow">
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementProposalControllerIns/listOfProposalsAllServices',
                type : 'POST',
                data : {
                    circle       : circle,
                    subdiv       : subdiv,
    ...
    {
        $.ajax({
            url: BASE_URL + "/SettlementProposalControllerIns/getCasesAgainstProposalNo",
            dataType: "JSON",
            data: {id : id},
            type: "POST",
            success: function(data) {
    ...
    $("#openModalForFinalSubmit").click(function(){
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerIns/checkAllSdlacPresentMember",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        {
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerIns/sendProposalsToDcMinute",
                type: "post",
                ...
                success: function (data)
                {
                    ...
                    if (data.response == 1)
                    {
                        ...
                        $('.meetingRemarksShow').html(data.meeting_remarks_show);
    ...
    function displayRecommendCases(data)
    {
        ...
        var fixed_header = '<tr>' +
            ...
            '<td style="background-color: white!important;  border: 1px solid black;  color: black!important; font-size: 12px;">Name of Proposed holder</td>' +
            '<td style="background-color: white!important;  border: 1px solid black;  color: black!important; font-size: 12px;">Under Department/Ministry</td>' +
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            {
                $.ajax({
                    url: BASE_URL + "/SettlementProposalControllerIns/sendProposalsToDc",
                    type: "post",
                    enctype: 'multipart/form-data',
                    contentType: false,
                    cache: false,
