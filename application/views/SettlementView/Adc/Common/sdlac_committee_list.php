                ...
                <?php else : ?>
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <tr>
                            ...
                            <th><label class="control-label">Mobile No.</label></th>
                            <th><label class="control-label">Email</label></th>
                            <th class="center">View</label></th>

                        </tr>
                        </thead>
                        <tbody>
                        <?php $i = 0; foreach ($committeeList as $member):  $i++ ?>
                            <tr>
                                <td><?php echo $i ?> </td>
                                ...
                                <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementCommonDc/getSdlacMemberIndividual/?member=<?php echo $member->id; ?>">
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"  id="addMoreSdlacCommMemberNo">NO</button>
                        <button type="button" class="btn btn-primary"   id="addMoreSdlacCommMemberYes">ADD</button>
                    </div>
                </div>
            </div>
        </div>
