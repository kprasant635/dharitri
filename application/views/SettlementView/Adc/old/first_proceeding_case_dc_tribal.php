                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                <td><?php echo $i ?> </td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/LMconversionPartha?case_no=<?php echo $case->case_no; ?>"><?php echo $case->case_no; ?></a>
                                    <br>
                                ...
                                <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementMbADC/getSettlementTribalApplicationDetails/?case=<?php echo $case->case_no; ?>">
