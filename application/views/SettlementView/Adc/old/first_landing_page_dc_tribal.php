            ...
            <div class="reza-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbADC/viewAllTribalFirstProceedingDCCaseList'; ?>" style="float:right">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbCo/FirstProceeding'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
