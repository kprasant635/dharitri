...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <br>
            <br>
            <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementProposalControllerIns/forwardedMeetingListForAdc'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
        </div>
            ...
            <div class="reza-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <a href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewSdlacAttendance/?meetingId=<?php echo $meeting->id; ?>"
