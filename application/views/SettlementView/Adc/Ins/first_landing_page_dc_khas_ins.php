...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 3.0 / <a href="<?= base_url()?>index.php/SettlementInsADC/SettlementInsLandDc">Juridical Entities</a>


            <a href="<?= base_url()?>index.php/SettlementInsADC/SettlementInsLandDc">
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <?php if(DC_ADC_SDO_PRO_BUTTON_INS == 0 OR DC_ADC_SDO_PRO_BUTTON_INS == 1) { ?>
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsADC/viewAllInsFirstProceedingDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsADC/viewAllMarkAsSDLACListForDCKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
                    <?php if(DC_ADC_SDO_PRO_BUTTON_INS == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsADC/getAllProposalListSdlacKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementInsADC/getAllUnderConSdlacKhas'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDc/getAllRejectedApplicationByCoForAdc?service='.SLIJE_ID .'&s='.MB_DISMISS; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementModification/getAllModificationRequestApplicationByCoForAdc?service='.SLIJE_ID; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonIns/rejectedListIns?service='.SLIJE_ID.'&s=D&office='.MB_ADD_DEPUTY_COMM; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="rezaText"> <?php echo $slNo += 1; ?>. </td>
                        <td class="rezaText"> -- </td>
                        <td class="rezaText">Download All cases </td>
                        <td>
                            <span class="badge badge-danger"></span>
                        </td>
                        <td>
                            <a class="rezaButt" style=" float:right" target= "SDLACProposalNotice" href="<?php echo base_url() . 'index.php/SettlementCommonIns/downloadCasesWithPendingOfficerAdcForAdcOnly' ?> ">
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbCo/coRevivalCases?service='.SLIJE_ID.'&s=D'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <input type="hidden" id="serviceType" value="><?php echo SLIJE_ID ?>">
