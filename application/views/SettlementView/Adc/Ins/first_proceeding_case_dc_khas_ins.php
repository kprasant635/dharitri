...
<div class="row" style='padding: 15px 10px 0px 0px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / 
            Settlement MB / 
            <a href="<?= base_url()?>index.php/SettlementInsADC/SettlementInsLandDc">Juridical Entitites</a> / 
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementInsADC/InsfirstProceedingPaginationAPI',
                type:'POST',
                data: {
