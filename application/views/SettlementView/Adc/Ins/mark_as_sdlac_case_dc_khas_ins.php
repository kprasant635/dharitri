...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementInsADC/viewAllMarkAsSDLACListForDCKhas">SDLAC/CDLAC Recommended (Marked)</a>
            ...
            <div class="reza-body">
                    ...
                    <table class="datatable table table-stripped table-responsive" id='datatable' width="100%">
                        ...
                        <tr>
                            ...
                            <th class="center">Category
                                ...
                                <select class="form-control" data-column-index="3" id="ins_cat"
                                        name="ins_cat">
                            ...
                            <th class="center">Already allotted

                                <select class="form-control" data-column-index="4" id="already_alloted"
                                        name="already_alloted">
                                    <option value="">Select Category</option>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="left">
                        <?php if(ENABLE_BUTTON_SEND_TO_SDLAC_INSTITUTE !=0): ?>
                            ...
                            <?php if (in_array(trim($this->session->userdata('dist_code')), INS_DIST_CODE_ALLOW_FOR_PROPOSAL_MAKING) ) :?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Hearing Date <span style="color: red; font-weight: bold">*</span>
                                <?php if(MEETING_PROPOSAL_SDLAC_NOTICE_HOLD_INSTITUTE == 1): ?>
                                    <span style="color: #EF5350; font-weight: bold">
                                        ( Maximum Date of processing <?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_SHOW_INSTITUTE ?> )
                                    </span>
                                <?php endif; ?>
                            </label>
                            <input type="datetime-local" class="form-control" name="w3date" id="date" required  max="<?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_INPUT_INSTITUTE ?>"> </input>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control" id="select_nominee_<?=$row->user_code?>">
                                        ...
                                        <?php if($row->user_type == 'MLA' && in_array($this->session->userdata("dist_code").'_'.$row->user_code, SDLAC_MEM_MLA_NOMINEE_ALLOW)) :?>
                                            ...
                                            foreach($nominee as $nom)
                                            {
                                                ...
                                                $checkedStatus = $this->utilityclass->getSelectedNomineeOfSdlac($proposal_no, $nom->id, SLIJE_ID); ?>
...
<script>
    ...
    $('#insertNominee').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalControllerIns/insertNomineeDetailOfSdlacMember",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsADC/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsADC/generateNoticeSendAllMarkAppToSDLACByDcKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementInsADC/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
                    ...
                    ins_cat    : ins_cat,
                    already_alloted:already_alloted
                },
                deferLoading: 57,
            },
