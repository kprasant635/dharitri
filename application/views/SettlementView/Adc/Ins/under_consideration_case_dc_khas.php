...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementInsADC/getAllUnderConSdlacKhas">Under Consideration</a>
                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementInsADC/getSettlementInsApplicationDetails/?case=<?php echo $case->case_no; ?>">
