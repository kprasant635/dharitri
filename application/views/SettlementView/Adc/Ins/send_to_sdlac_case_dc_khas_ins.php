...
<div class="row" style='padding: 15px 10px 1px 1px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB 3.0 /
            <a href="<?= base_url()?>index.php/SettlementInsADC/SettlementInsLandDc">Juridical Entities</a> /
            <a href="<?= base_url()?>index.php/SettlementInsADC/getAllProposalListSdlacKhas">SDLAC/CDLAC Report</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementInsADC/getAllProposalListSdlacKhas">
                <button type="button" class="btn btn-sm btn-danger pull-right">
                    <i class="fa fa-backward"></i>&nbsp;Go one step Back
                </button>
            </a>
        </div>
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span><?php echo NJS_TAGLINE; ?></span>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="reza-body">
                ...
                <?php else : ?>
                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode'   width="100%">
                        ...
                        <tr>
                            ...
                            <th width="15%"><label class="control-label">Category</label></th>
                            <th width="10%" class="center"><label class="control-label">Circle Name <br><?php echo $this->lang->line('submission_date'); ?></label></th>
                            <th width="10%" class="center"><label class="control-label">Status</label></th>
                            <th width="25%" class="center"><label class="control-label"><?php echo $this->lang->line('write_report'); ?></label></th>
                            <th width="18%" class="center">
                                <label class="control-label">
                                    Institution falls under category of NGOs, Trusts, Local Bodies, Associations, Societies ?
                                </label>
                            </th>
                            <th width="18%" class="center">
                                <label class="control-label">
                                    Is the Educational Institution a Non Provincialised Venture School ?
                                </label>
                            </th>
                            <th width="15%" class="center"><label class="control-label">Remarks (If No) </label></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                <td><?php echo $i ?> </td>
                                <td>
                                    <a href="<?php echo base_url('index.php/SettlementInsADC/getSettlementInsApplicationDetails/?case=').$case->case_no ?>" class="">
                                ...
                                <td class="center">
                                    <?php echo $this->utilityclass->ins_cat_name_full($case->dist_code, $case->ins_cat_type_co); ?>
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementInsADC/viewApprovedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementInsADC/viewRejectedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementInsADC/viewRejectedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
                                <td>
                                    <input type="hidden" value="<?=$case->ins_cat_type_co?>"  name="ins_cat_type_co"    id="ins_cat_type_co<?=$case->id?>" >
                                    <input type="hidden" value="<?=$case->ins_cat_type_co?>"  name="ins_cat_type_co_id" id="ins_cat_type_co_id<?=$case->id?>" >
                                    <input type="hidden" value="<?=$case->purpose_land_allot_co?>"  name="purpose_land_allot_co"    id="purpose_land_allot_co<?=$case->id?>" >
                                    <input type="hidden" value="<?=$case->purpose_land_allot_co?>"  name="purpose_land_allot_co_id" id="purpose_land_allot_co_id<?=$case->id?>" >

                                    <?php if($case->ins_cat_type_co == 12): ?>
                                        <?php if($case->under_ngo_trust_localbodies == '' || $case->under_ngo_trust_localbodies == NULL) : ?>
                                            <input type="radio" name="institution_falls_<?=$case->id?>" value="YES" id="institution_falls_yes<?=$case->id?>">&nbsp;Yes
                                            <br>
                                            <input type="radio" name="institution_falls_<?=$case->id?>" value="NO" id="institution_falls_no<?=$case->id?>"> &nbsp;No
                                        <?php else: ?>
                                            <?php if($case->under_ngo_trust_localbodies == 'YES' || $case->under_ngo_trust_localbodies == 'yes' || $case->under_ngo_trust_localbodies == 'Yes') : ?>
                                                <input type="radio" name="institution_falls_<?=$case->id?>" value="YES" id="institution_falls_yes<?=$case->id?>" checked>&nbsp;YES
                                                <br>
                                                <input type="radio" name="institution_falls_<?=$case->id?>" value="NO" id="institution_falls_no<?=$case->id?>"> &nbsp;NO
                                            <?php endif; ?>
                                            <?php if($case->under_ngo_trust_localbodies == 'NO' || $case->under_ngo_trust_localbodies == 'no' || $case->under_ngo_trust_localbodies == 'No') : ?>
                                                <input type="radio" name="institution_falls_<?=$case->id?>" value="YES" id="institution_falls_yes<?=$case->id?>">&nbsp;YES
                                                <br>
                                                <input type="radio" name="institution_falls_<?=$case->id?>" value="NO" id="institution_falls_no<?=$case->id?>" checked> &nbsp;NO
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        NA
                                ...
                                <td>
                                    <?php if($case->ins_cat_type_co == 12 && $case->purpose_land_allot_co == 'Educational'): ?>
                                        <?php if($case->under_venture_school == '' || $case->under_venture_school == NULL): ?>
                                            <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="YES" id="institution_falls_venture_yes<?=$case->id?>">&nbsp;Yes
                                            <br>
                                            <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="NO" id="institution_falls_venture_no<?=$case->id?>"> &nbsp;No
                                        <?php else: ?>
                                            <?php if($case->under_venture_school == 'YES' || $case->under_venture_school == 'yes' || $case->under_venture_school == 'Yes') : ?>
                                                <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="YES" id="institution_falls_venture_yes<?=$case->id?>" checked>&nbsp;YES
                                                <br>
                                                <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="NO" id="institution_falls_venture_no<?=$case->id?>"> &nbsp;NO
                                            <?php endif; ?>
                                            <?php if($case->under_venture_school == 'NO' || $case->under_venture_school == 'no' || $case->under_venture_school == 'No') : ?>
                                                <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="YES" id="institution_falls_venture_yes<?=$case->id?>">&nbsp;YES
                                                <br>
                                                <input type="radio" name="institution_falls_venture_<?=$case->id?>" value="NO" id="institution_falls_venture_no<?=$case->id?>" checked> &nbsp;NO
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        NA
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                        <?php if(FORWARD_PROPOSAL_TO_SDLAC_MEM_BUTTON_INSTITUTE == 1) { ?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsADC/updateProposalHearingDateKhas",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsADC/updateHearingDateGenerateNoticeKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementInsADC/proposalForwardToDcForFinalVerifyKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function report_yes(id, case_no) {
        ...
        {
            $.ajax({
                url: BASE_URL + "/RejectMb3NewController/deleteRejectRemarkOnConfirm",
                dataType: "JSON",
    ...
    $(document).on('click','#finalSubmit',function()
    {
        ...
        var ins_cat_type_co_id         = $("#ins_cat_type_co_id<?php echo $case->id?>").val();
        var purpose_land_allot_co_id   = $("#purpose_land_allot_co_id<?php echo $case->id?>").val();
        var institution_venture_school = $('input:radio[name=institution_falls_venture_'+<?=$case->id?>+']:checked').val();
        var institution_falls_ngo      = $('input:radio[name=institution_falls_'+<?=$case->id?>+']:checked').val();
        var case_no = $('#case_no_<?php echo $case->id?>').val();

        allInsData = {institution_venture_school,institution_falls_ngo,ins_cat_type_co_id,case_no,purpose_land_allot_co_id};

        dataIns.push(allInsData);
        ...
        $.ajax({
            url: BASE_URL + "/SettlementInsADC/checkForSdlacStatus",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
        ...
        //     url: BASE_URL + "/SettlementInsADC/checkForSdlacStatus",
        //     dataType: "JSON",
        //     data: {prop_id : prop_id, allData : allData},
        //     type: "POST",
        //     success: function (data) {
        //         if (data.response == 1) {
        //             showWarningMessage(data.message);
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        var ins_cat_type_co            = $("#ins_cat_type_co<?php echo $case->id?>").val();
        var purpose_land_allot_co      = $("#purpose_land_allot_co<?php echo $case->id?>").val();
        ...
        allData = {id,report_status,remarks,case_no,institution_venture_school,institution_falls_ngo,ins_cat_type_co,purpose_land_allot_co};
        data.push(allData);
        <?php } ?>
        ...
        $.ajax({
            url: BASE_URL + "/SettlementInsADC/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementInsADC/getAllProposalListSdlacKhas";
                }
                })
                }
                else
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementCommonIns/applicationRemoveFromProposal",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
