    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="font-size: 20px;">
                <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalController/pendingProposalList'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).on('click','#meetingFrowardToDcYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalController/forwardOnlineMeetingToDcForFinalVerification",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data)
                    ...
                    else if (data.response == 2)
                    {
                        Swal.fire({
                            ...
                            if(result.isConfirmed){
                                window.location = BASE_URL + "/SettlementProposalController/pendingProposalList";
                            }
                        });
                    }
                    else
