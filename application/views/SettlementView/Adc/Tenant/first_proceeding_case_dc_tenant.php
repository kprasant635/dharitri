                            ...
                            <tr >
                                ...
                                <td class="center">
                                    <?php if($case->general_notice_dc == 'y'){ ?>
                                        ...
                                        <a target="_blank" class="rezaButt buttInfo mt-2" href="<?php echo base_url(); ?>index.php/SettlementTenantDc/viewGeneralNoticeTenant/?case=<?php echo $case->case_no; ?>">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                            View Notice
                                        </a>
...
<script>
    ...
    $(document).on('click','#hearingRemarkModalNo',function ()
    {
        $('#caseHRemark').val('');
        $('#hearing_remark').val('');
        $('#hearingRemarkModal').modal('hide');
    ...
    $(document).on('click','#hearingRemarkModalYes',function ()
    {
       ...
       $.ajax({
            url: baseurl+'SettlementTenantAdc/forwardToDCAfterHearing',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
