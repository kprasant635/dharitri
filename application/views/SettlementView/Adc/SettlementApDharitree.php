    ...
    <div class="row">
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url()?>index.php/SettlementAp/settlementApUpdate" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <input type="text" name="pdar_name" value="<?=$settlement->pdar_name;?>" class="form-control input-sm">
                                                </td>
                                                <th>Gurdian name</th>
                                                <td colspan="2">
                                                    <input type="text" name="pdar_guardian" value="<?=$settlement->pdar_guardian;?>" class="form-control input-sm" >
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <th>Relation</th>
                                                <td>
                                                    <input type="text" value="<?=$settlement->pdar_rel_guar;?>" name="pdar_rel_guar" class="form-control input-sm">
                                                </td>
                                                <th>Gender</th>
                                                <td>
                                                    <input type="text" name="pdar_gender" class="form-control input-sm" value="<?=$settlement->pdar_gender;?>">
                                                </td>
                                                <th>Mobile</th>
                                                <td>
                                                    <input type="text" name="pdar_mobile" value="<?=$settlement->pdar_mobile?>" class="form-control input-sm" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td colspan="2">
                                                    <input type="text" name="pdar_add1" value="<?=$settlement->pdar_add1?>" class="form-control input-sm">
                                                </td>

                                                <th>Presend address</th>
                                                <td colspan="2">
                                                    <input type="text" name="pdar_add2" value="<?=$settlement->pdar_add2?>" class="form-control input-sm" >
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <strong><input type="text" style="text-align: center;" value="<?=$settlement->i_area_b?>" name="i_area_b" class="form-control input-sm">
                                                    </strong>
                                                </td>
                                                <td>
                                                    <span class="input-group-addon">Katha</span>
                                                    <strong><input type="text" style="text-align: center;" value="<?=$settlement->i_area_k?>" name="i_area_k" class="form-control input-sm" >
                                                    </strong>
                                                </td>
                                                <td>
                                                    <span class="input-group-addon">Lessa</span>
                                                    <strong><input type="text" style="text-align: center;" name="i_area_lc" value="<?=$settlement->i_area_lc?>" class="form-control input-sm" >
                                                    </strong>
                                                </td>
                                                <td>
                                                    <span class="input-group-addon">Ganda</span>
                                                    <strong><input type="text" style="text-align: center;" name="i_area_g" value="<?php if((in_array($this->session->userdata('dist_code'), BARAK_VALLEY))){ echo $settlement->i_area_g;} else {echo '0';} ?>" class="form-control input-sm" >
                                                    </strong>
                                                </td>
                                                <td>
                                                    <span class="input-group-addon">Kranti</span>
                                                    <strong><input type="text" style="text-align: center;" value="<?php if((in_array($this->session->userdata('dist_code'), BARAK_VALLEY))){ echo $settlement->i_area_kr;} else {echo '0';} ?>" name="i_area_kr" class="form-control input-sm" >
                                                    </strong>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="row p-2 px-5" >
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <?php $i=1; foreach($proceedings as $pro): ?>
                                                <tr>
                                                <td><?=date('Y-m-d h:i:s', strtotime($pro->date_entry));?></td>                                                    <td><?=$pro->office_from;?></td>
