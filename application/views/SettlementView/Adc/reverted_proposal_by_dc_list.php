...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-left: 25px">
        Process /
        Settlement MB /
        <a href="<?= base_url()?>index.php/SettlementProposalController/revertMeetingListForAdc">Reverted Meeting </a> /
        Proposals

        <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalController/revertMeetingListForAdc'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
                        ...
                        <?php $i=1; foreach ($proposals as $proposal): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="rezaButt buttCust"    target= "Download" href="<?php echo base_url(); ?>index.php/SettlementCommonDc/downloadCasesWithProposalId/?case=<?php echo $proposal->id ?>">
                                        <i class="fa fa-download"></i> Download
                                    </a>
                                    <a class="rezaButt buttSuccess"  target= "SDLACProposalNotice" href="<?php echo base_url(); ?>index.php/SettlementProposalController/caseListUnderRevertedMeetingForAdc/?proposal=<?php echo $proposal->id ?>">
...
<script>
    ...
    $("#verifyCases").click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalController/verifyCasesUnderRevertedMeetingByDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalController/sendRevertedProposalsToDcAdc",
                type: "post",
                enctype: 'multipart/form-data',
                contentType: false,
                cache: false,
