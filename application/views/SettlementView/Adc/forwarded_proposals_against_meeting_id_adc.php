...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 2.0 /  Forwarded Meeting List / Meeting Information
            <br>
            <br>
            <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementProposalController/forwardedMeetingListForAdc'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
        </div>
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?php if($meeting->digital_sign_status == 1): ?>
                                <a href="<?php echo base_url(); ?>index.php/SettlementCommonDc/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->id; ?>"
                    ...
                    <?php if($meeting->file_minute_path != '' && $meeting->file_minute_path != NULL): ?>
                        ...
                        <td colspan="3">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewSdlacUploadedMinute/?meetingId=<?php echo $meeting->id; ?>"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/viewSdlacAttendance/?meetingId=<?php echo $meeting->id; ?>"
                ...
                <table class="table table-bordered">
                    <thead><h5 style="color:black;margin-top: 45px">SDLAC/CDLAC members who attended meeting</h5></thead>
                    <thead>
                    <tr style="background-color:#1b4f4d; color: white;">
...
<script type="text/javascript">
    ...
    function btnCaseView(propId)
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalController/viewCasesAgainstProposalNo",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalController/postAdditionalFileUnderMeetingAdc",
                type: "post",
