                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        <h5 class="bg-info p-2 text-white shadow" style="margin-top: 10px">
                            <?php echo $this->lang->line('pgrVgrTitle')?> (
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrADC/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrADC/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/applicationRejectedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/applicationApprovedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#revertFromSDLACToCoModalYes',function ()
    {
        ...
        if(remarks != '' && status != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/applicationRevertFromSDLACToCOVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script>
    ...
    function sendToOtherCo(case_no)
    {
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrADC/otherCoList',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
    ...
    function sendToCoSub(case_no)
    {
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrADC/sendToOtherCo',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
                ...
                else
                {
                    ...
                    window.location.href = baseurl+"SettlementVgrPgrADC/viewAllVgrPgrFirstProceedingDCCaseList";
                }
                })
    ...
    function circleCluster(case_no)
    {
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrADC/putInCircleCluster',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
...
<script>
    function forwardToExistingCluster(case_no)
    {
        ...
        $.ajax({
            url: baseurl+'SettlementVgrPgrADC/forwardToExistingCluster',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
