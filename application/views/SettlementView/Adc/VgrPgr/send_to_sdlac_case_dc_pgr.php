...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementVgrPgrADC/getAllProposalListSdlacVgrPgr">SDLAC/CDLAC Report</a>
            / Process

            <a href="<?= base_url()?>index.php/SettlementVgrPgrADC/getAllProposalListSdlacVgrPgr">
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/updateProposalHearingDateVgrPgr",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/updateHearingDateGenerateNoticeVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/proposalForwardToDcForFinalVerifyVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalSubmit',function() {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementVgrPgrADC/checkForSdlacStatus",
            dataType: "JSON",
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/SettlementVgrPgrADC/getAllProposalListSdlacVgrPgr";
                }
                })
                }
                else
