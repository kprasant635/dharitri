...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementVgrPgrADC/getAllSdlacMemberApprovalProposalListVgrPgr">SDLAC/CDLAC Member Status List</a>
            ...
            <div class="reza-title">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <span><?php echo $this->lang->line('pgrVgrTitle') ?> <?php echo $this->lang->line('proposalList') ?></span>
                        <hr>
                    </div>
                </div>
            </div>
            ...
            <div class="reza-body">
                ...
                <?php else : ?>
                    ...
                    <table class="datatable table table-stripped" id='datatable' width="100%">
                        ...
                        <tr>
                            <th width='2%'>#</th>
                            <th width='22%'> Proposal No <input type="text" id="by_proposal_no" name="by_proposal_no" data-column-index="1" class="form-control" placeholder="Search by Proposal No"></th>
                            ...
                            <th width="42%" class="center">Action<button type="button" class="search_button btn btn-sm btn-primary form-control"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;&nbsp;Search</button></th>
                        </tr>
                        </thead>
                        <tbody>
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementVgrPgrADC/getAllSdlacMemberApprovalProposalListDataVgrPgr',
                type : 'POST',
                data : {
