...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB / <a href="<?= base_url()?>index.php/SettlementVgrPgrADC/SettlementVgrPgrLandDc">PGR VGR</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrADC/viewAllVgrPgrFirstProceedingDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrADC/viewAllMarkAsSDLACListForDCVgrPgr'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrADC/getAllProposalListSdlacVgrPgr'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <!--     </td>-->
                        <!--     <td>-->
                        <!--         <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrADC/getAllSdlacMemberApprovalProposalListVgrPgr'; ?><!--" style="float:right">-->
                        <!--             <i class="fa fa-eye"></i>&nbsp;view-->
                        <!--         </a>-->
                        <!--     </td>-->
                        <!-- </tr>-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementProposalController/getVgrPgrRevertedCaseList'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDc/getAllRejectedApplicationByCoForAdc?service='.SETTLEMENT_PGR_VGR_LAND_ID .'&s='.MB_DISMISS; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDC/rejectedList?service='.SETTLEMENT_PGR_VGR_LAND_ID.'&s=D&office='.MB_ADD_DEPUTY_COMM; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementModification/getAllModificationRequestApplicationByCoForAdc?service='.SETTLEMENT_PGR_VGR_LAND_ID; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
