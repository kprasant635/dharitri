...
<script>
    ...
    function sendToSDLACModalYes(cluster_id)
    {
        ...
        if (cluster_id)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (cluster_id)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrADC/generateNoticeSendAllMarkAppToSDLACByDcVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementVgrPgrADC/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
