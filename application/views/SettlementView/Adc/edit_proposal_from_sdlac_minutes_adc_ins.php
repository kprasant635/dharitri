...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-left: 25px">
            ...
            <a href="<?= base_url()?>index.php/SettlementProposalControllerIns/commonProposalListView"> SDLAC/CDLAC Minute </a>
            / Edit Proposal

            <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalControllerIns/commonProposalListView'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode'  width="100%">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                <td><?php echo $i ?> </td>
                                <td>
                                    <a target="_blank" href="<?php echo base_url('index.php/SettlementCommonDc/viewApplicationDetailsOnly/?case=').$case->case_no ?>" class="">
...
<script>
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementCommonIns/applicationRevertToCoFromProposalUnderMinutes",
                type: "post",
                dataType: "json",
