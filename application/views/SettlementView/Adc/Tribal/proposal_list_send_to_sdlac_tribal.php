...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / 
            Settlement MB / 
            <a href="<?= base_url()?>index.php/SettlementTribalAdc/SettlementTribalLandAdc">Tribal Land</a> / 
            <a href="<?= base_url()?>index.php/SettlementTribalAdc/getAllProposalListSdlacTribal">Proposal Send to SDLAC</a>
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
              url  : base_url+'index.php/SettlementTribalAdc/thirdProceedingSdlacReport',
              type : 'POST',
              data : {
    ...
    function openTab(id){
        ...
        $.ajax({
          url  : base_url+'index.php/SettlementTribalAdc/getCasesAgainstProposalNo',
          dataType: "JSON",
