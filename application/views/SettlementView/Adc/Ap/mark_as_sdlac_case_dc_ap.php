...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementApADC/viewAllMarkAsSDLACListForDCAp">SDLAC/CDLAC Recommended (Marked)</a>
                ...
                <!-- <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                    ...
                    <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                        <tr id="caseNoData">
                            ...
                            <td class="center">
                                <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementApADC/getSettlementApApplicationDetails/?case=<?php echo $case->case_no; ?>">
...
<script>
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApADC/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApADC/generateNoticeSendAllMarkAppToSDLACByDcAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementApADC/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
