        ...
        <section>
            <div class="wizard">
                ...
                <form
                        ...
                        class="lmForm"
                        method="post"
                        action="<?php echo base_url()?>index.php/SettlementTenant/settlementTenantRegistration/<?=$review_flag?>?app=<?=$_GET['app']?>"
                ...
                >
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                      ...
                      <?php include(APPPATH."views/SettlementView/include/applicationTenantView.php"); ?>
                          ...
                          <div class="reza-card">
                            <div class="reza-body">
                              ...
                              <div class="tableCard">
                                ...
                                <div class="row p-2" >
                                  <div class="col-md-6">
                                    <span><strong><?=$sl_count++?>.</strong> RK verified?</span>
                                ...
                                <div class="row p-2" >
                                    <div class="col-md-6">
                                        <span><strong><?=$sl_count++?>.</strong> Purpose of the land used by the occupants(if any other than pt.12)</span>
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" class="rezaButt buttPrimary <?php if(form_error('total_due_amount')){echo 'lm_invalid';}?>" onclick="premiumModal();">
                                            Calculate Premium
                                        </button><span><b>&nbsp; <br>(50 Times of Dag Revenue Value / Bigha)</b></span>
                            ...
                            <ul class="list-inline pull-right" style="margin-top: 20px">
                              ...
                              <?php if(ENABLE_BUTTON_LM_SUBMIT_TENANT != 0){?>
                                <li>
