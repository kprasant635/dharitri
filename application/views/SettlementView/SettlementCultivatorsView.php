    ...
    <div class="row">
        ...
        <section>
            ...
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url()?>index.php/SettlementCultivator/settlementApplication/<?=$review_flag?>?app=<?=$_GET['app']?>" enctype="multipart/form-data">
                    <?php 
