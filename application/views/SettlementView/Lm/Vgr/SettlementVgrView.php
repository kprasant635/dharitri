    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url()?>index.php/SettlementVgr/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">

                    <?php
                        $case_no = $this->utilityclass->decryptJwtCase($_GET['case']);
                    ?>

                    <input type="hidden" name="service_code" id="service_code" value="<?=$basic["service_code"]?>">
                    <input type="hidden" name="lot_no" value="<?=$basic["lot_no"]?>">
                    <input type="hidden" id ='application_no' name="application_no" value="<?=$application_no?>">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-10">
                                            <table class="table table-bordered">
                                                ...
                                                <td>
                                                    <input type="text" name="aadhar_verified" value="<?php if ($identity->identity_type) {echo 'Yes';}?>" class="form-control" disabled>
                                                </td>
                                                </tr>
                                                <?php }
                                                endforeach;
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                        foreach(json_decode(PROTECTED_CLASS) as $class12){
                                                            ...
                                                            {
                                                            ?>
                                                                <input type="text" readonly class="form-control" value="<?=$class12->NAME?>">
                                                            <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <?php
                                                if($basic['applied_scheme'] != null):
                                                ?>
                                                <tr>
                                                <th>Applied Scheme under ?</th>
                                                <td>
                                                    <input type="hidden" name="protected_class" value="<?=$basic['applied_scheme']?>" class="form-control">
                                                    <strong class="alert-warning">
                                                    <?php
                                                        foreach(json_decode(APPLIED_SCHEME) as $class12){
                                                            if($class12->CODE == $basic['applied_scheme'])
                                                            {
                                                            ?>
                                                                <input type="text" readonly class="form-control" value="<?=$class12->NAME?>">
                                                            <?php
                                ...
                                if ($applicants_riotee_nok == true) {
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tr style="border-bottom:1px solid #227576">
                                                ...
                                                <a type="button" target="_blank" class="btn-sm rezaButt buttInfo" href="<?php echo base_url(); ?>index.php/SettlementCommon/apiDagWiseApplication?app=<?=$basic["applid"];?>&dag=<?=$all_dags->dag_no;?>">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 text-justify">
                                                <span><strong><?=$sl_count++?>.</strong> Applied under scheme?</span>
                                                <?=form_error('applied_scheme')?>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <select name="applied_scheme" id="applied_scheme" class="form-control <?php if(form_error('applied_scheme')){ echo 'lm_invalid';}?>">
                                                    <?php foreach(json_decode(APPLIED_SCHEME) as $class): ?>
                                                        <option value="<?php echo $class->CODE ?>" <?php 
                                                            if(isset($err_return)){
                                                                if(set_value('applied_scheme') == $class->CODE){
                                                                    echo "selected";
                                                                }
                                                            }else{
                                                                if($lmnote->applied_scheme == $class->CODE){echo "selected";}
                                                            }?>>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 text-justify">
                                                    <span><strong><?=$sl_count++?>.</strong>
                                                        Does applicant falls under protected category?
                                                        <?=form_error('protected_class_lm')?>
                                                    </span>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <select name="protected_class_lm" id="protected_class_lm" class="form-control <?php if(form_error('protected_class_lm')){ echo 'lm_invalid';}?>">
                                        ...
                                        <div class="row p-2" >
                                            <div class="col-md-6">
                                                    <span><strong><?=$sl_count++?>.</strong>
                                                        Whether the proposed land falls under
                                        ...
                                        <?php 
                                        if ($reservation == true) {
                                            foreach($reservation as $checkType){
                                                if(trim($checkType->type) == 'R')
                                                {
                                                    ?>
                                                    <div class="row p-2" >
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                    ...
                                                                    if(isset($err_return)){
                                                                        ...
                                                                        $road_reservation = 0;
                                                                        foreach($reservation as $reserv_r)
                                                                        {
                                                                            if(trim($reserv_r->type) == 'R')
                                                                            {
                                                                                echo "checked";
                                                                                $road_reservation = 1;
                                                                                break;
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        if(isset($err_return)){
                                                            ...
                                                            if($road_reservation == true) 
                                                            {
                                                                foreach($road_reservation as $reserv_r)
                                                                {
                                                                    if(trim($reserv_r->type) == 'R')
                                                                        echo "checked";
                                                                }
                                                    ...
                                                    <div id="road_side_reservation_hide" style="display:none;" class="road_side_reservation_hide">
                                                        <?php foreach($dags as $dags_roadside) { ?>
                                                        <div class="form-group row mt-2">
                                                        <input type="hidden" value="<?=$dags_roadside->dag_no?>" class="form-control input-sm" name="reserved_dag_road<?=$dags_roadside->dag_no?>" id="reserved_dag_road">
                                                        <input type="hidden" value="<?=$dags_roadside->patta_no?>" class="form-control input-sm" name="reserved_patta_road<?=$dags_roadside->dag_no?>" id="reserved_patta_road">
                                            ...
                                            <div class="col-md-6">
                                                <select name="lm_note" id="lm_remark" class="form-control <?php if(form_error('lm_note')){echo 'lm_invalid';}?>">
                                                    ...
                                                    foreach(json_decode(LM_NOTE) as $lm_remark_cat){
                                                        if(VGR_RECOMEND_OPTION == 0)
                                                        {
                                                            if($lm_remark_cat->CODE == 1)
                                                            {
                                                                continue;
                                                            }
                                                        }
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6 bg-danger text-white">
                                                ...
                                                <?=form_error('area_mismatch')?>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            class="form-check-input <?php if(form_error('re_dereservation')){echo 'lm_invalid';}?> <?php if(form_error('area_mismatch')){echo 'lm_invalid';}?>"
                                                            type="radio"
                                                            name="re_dereservation"
                                                            id="reservation_vgr"
                                                            onclick="vgrReservation('<?=$basic['dist_code']?>','<?=$basic['subdiv_code']?>','<?=$basic['cir_code']?>','<?=$basic['mouza_pargona_code']?>','<?=$basic['lot_no']?>','<?=$basic['vill_townprt_code']?>')"
                                                            value="RESERVATION"
                                        ...
                                        <table class="table">
                                            <?php foreach ($dhardocuments as $docs): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file" name="DOCMAIN<?=$docs->dag_no?>_<?=$docs->id?>" style="font-size: 1em!important;">
                                                    </td>
                                                </tr>
                                            <?php endforeach;
...
<?php include(APPPATH."views/SettlementView/include/premium_calculation_modal_vgr.php"); ?>
...
<?php
                    ...
                    <script>
                        function totalAppliedArea(){
                            ...
                            <?php foreach($encroachers as $dags_lmtemplate3){ ?>
...
<script>
    ...
    // var get_vgr_reservation_check = $("input[name='re_dereservation']:checked").val();
    // if(get_vgr_reservation_check == 'RESERVATION'){
    //     var x = document.getElementById("area_details_div");
    //     if (x.style.display === "none") {
    //         x.style.display = "block";
    //     }
    // }
    ...
    $(document).ready(function() {
        ...
        var all_villages = $("#select_village").val();
            ...
            if(all_villages){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#dag_detail").html(template);
                    },
                });
            }
        <?php } ?>

        $("#select_village").change(function(e) {
            if ($(this).val() == null) {
                return;
            }
        ...
        if($reservation == true){
            foreach($reservation as $reserv){
                if ($reserv->type == "V") {
                    ...
                    var service_code = $("#service_code").val();
                    var vill_code = $("#select_village").val();
                    var dag = <?=$reserv->dag_no?>
                        //const loading = new Loading();
                        $.ajax({
                            url: baseurl +
                            "SettlementVgr/getArea/" +
                            district +
                            "/" +
                            subdiv_code +
                            "/" +
                            ...
                            success: function(data) {
                                ...
                                $("#bigha_dropdown").val(area.bigha);
                                $("#katha_dropdown").val(area.katha);
                                $("#lessa_dropdown").val(area.lessa);
                                $("#ganda_dropdown").val(area.ganda);
                                $("#kranti_dropdown").val(area.kranti);
                                $("#patta_no_dropdown").val(area.patta_no);
                                $("#patta_type_dropdown").val(area.patta_type);
                                $("#patta_code_dropdown").val(area.patta_code);
                            },
...
if(selectedRemark==1){
    ...
    $('#lm_remark_text').text('');
    <?php if((in_array($basic['dist_code'], json_decode(BARAK_VALLEY)))): ?>
    $('#lm_remark_text').text("আবেদনকাৰী শ্ৰী <?php echo $app_name?> য়ে <?php echo $this->utilityclass->getCircleName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'])?> ৰাজহ চক্ৰৰ  <?php echo $this->utilityclass->getMouzaName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'])?> মৌজাৰ <?php echo $this->utilityclass->getLotName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'],$basic['lot_no'])?>ৰ <?php echo $this->utilityclass->getVillageName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'],$basic['lot_no'],$basic['vill_townprt_code'])?> ৰাজহ গাওঁৰ গাৱলীয়া চৰণীয়া পথাৰ / বৃত্তি গতচৰণীয়া পথাৰৰ ভূমিতপট্টন ৰ বাবে আবেদন কৰিছে।");
    $('#lm_remark_text').append("চৰজমিন তদন্তৰ সময়ত দেখা যায় যে উক্তচৰণীয়া পথাৰৰ দাগ নং <?php echo $all_dags?> ৰ "+$('#sbigha').val()+" বি "+$('#skatha').val()+" ক "+$('#slessa').val()+" চ "+$('#sganda').val()+" গ ভূমিত  আবেদনকাৰীয়ে স্থায়ী ভাবে ঘৰবস্তী কৰি দখলত ৰখা দেখা যায়।");
    $('#lm_remark_text').append("\n \n আবেদনকাৰীক..............তাৰিখৰ .............. নং হুকুম মতে /এমএনপি আচনিত .... চনত বহী নং.............. ক্ৰমিকনং………………………………… মৰ্মে ২০১১ চনৰ আগতে আবণ্টন দিয়া হৈছিল ।");
    $('#lm_remark_text').append("\n \n আবেদনকাৰী "+$('#caste_name').val()+" জাতিৰ/ শ্ৰেণীৰ এজন খিলঞ্জীয়া লোক।");
    <?php else : ?>
    $('#lm_remark_text').text("আবেদনকাৰী শ্ৰী <?php echo $app_name?> য়ে <?php echo $this->utilityclass->getCircleName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'])?> ৰাজহ চক্ৰৰ  <?php echo $this->utilityclass->getMouzaName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'])?> মৌজাৰ <?php echo $this->utilityclass->getLotName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'],$basic['lot_no'])?>ৰ <?php echo $this->utilityclass->getVillageName($basic['dist_code'],$basic['subdiv_code'],$basic['cir_code'],$basic['mouza_pargona_code'],$basic['lot_no'],$basic['vill_townprt_code'])?> ৰাজহ গাওঁৰ গাৱলীয়া চৰণীয়া পথাৰ / বৃত্তি গতচৰণীয়া পথাৰৰ ভূমিতপট্টন ৰ বাবে আবেদন কৰিছে।");
    $('#lm_remark_text').append("চৰজমিন তদন্তৰ সময়ত দেখা যায় যে উক্তচৰণীয়া পথাৰৰ দাগ নং <?php echo $all_dags?> ত "+$('#sbigha').val()+" বি "+$('#skatha').val()+" ক "+$('#slessa').val()+" লে ভূমিত  আবেদনকাৰীয়ে স্থায়ী ভাবে ঘৰবস্তী কৰি দখলত ৰখা দেখা যায়।");
    $('#lm_remark_text').append("\n \n আবেদনকাৰীক..............তাৰিখৰ .............. নং হুকুম মতে /এমএনপি আচনিত .... চনত বহী নং.............. ক্ৰমিকনং………………………………… মৰ্মে ২০১১ চনৰ আগতে আবণ্টন দিয়া হৈছিল ।");
    $('#lm_remark_text').append("\n \n আবেদনকাৰী "+$('#caste_name').val()+" জাতিৰ/ শ্ৰেণীৰ এজন খিলঞ্জীয়া লোক।");
    <?php endif ;?>
...
<?php include(APPPATH."views/SettlementView/include/editAreaDetails.php"); ?>
<script src="<?php echo base_url();?>js/mb2/editAreaDetails.js"></script>
...
<!-- <script>
    function getDagInfo(dag_no, b, k, l, g)
    {
        ...
        var uuid = $("#select_village_uuid").val();
        var postData = {
                'uuid' : uuid,
                'dag_no' : dag_no
            };
