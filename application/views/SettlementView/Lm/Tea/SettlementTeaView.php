    ...
    <div class="row">
        ...
        <section>
            ...
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url()?>index.php/SettlementCultivator/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
...
<script>
    $(document).on('change', '#cult_board', function(){
        ...
        {
            $('#messageDiv').html('<span><b>&nbsp; <br>(@Rs 5000/ per Bigha for special cultivation of Coffee and Rubber up to 30 bighas of land. If above 30 bighas then 100% of the Zonal valuation.)</b></span>');
        }
    })
