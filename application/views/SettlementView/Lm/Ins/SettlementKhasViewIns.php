    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url() ?>index.php/SettlementInstitutionLm/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <div class="reza-card">
                                ...
                                <div class="reza-body">
                                    ...
                                    <?php 
                                        $basuCase= $this->utilityclass->decryptJwtCase($_GET['case']);
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            foreach ($dags as $all_dags) {
                                                ...
                                                <tr style="border-bottom:1px solid #227576">
                                                    <td colspan="2">
                                                        <?php if(ENABLE_AREA_BUTTON_INSTITUTE_LM == 1){?>
                                                            <button type="button" onclick="editArea(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-warning">Edit Area</button>
                                                        <?php } if(ENABLE_DAG_ELIGIBLE_BUTTON_LM_REVERT_INSTITUTE != 0){ ?>
                                                            <?php 
                                                            if($dag_count>1){?>
                                                            <button type="button" id="deldag<?=$all_dags->id?>" onclick="deleteDagRevertIns(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-danger"><i class="fa fa-remove" style="color:white"></i> Dag Not Eligible</button>
                                                        <?php } ?>
                                                            <?php ?>
                                                            <button type="button" id="insdag<?=$all_dags->id?>" onclick="insertDagRevertIns(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-success" style="display:none" >Eligible</button>
                                                        <?php  }?>
                                                    </td>
                                    ...
                                    <?php if(ENABLE_DAG_CHANGE_BUTTON_INSTITUTE == 1) { ?>
                                      ...
                                      <script src="<?php echo base_url();?>js/mb3/newDagEntryIns.js"></script>
                                    <?php } ?>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                            ...
                            <div class="reza-card">
                                ...
                                <?php if($instituteDetails->ins_cat_type_co == 12 && $instituteDetails->purpose_land_allot_co=='education')
                                    { ?>
                                    <div class="row p-2" style="color:#ff681d">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col-md-6">
                                            <b><?php 
                                            if($instituteDetails->venture_type == 'govt_aided_venture')
                                            {
                                                echo "Govt aided venture (Allotment Only)";
                                            } 
                                            else if($instituteDetails->venture_type == 'unrecognised_venture')
                                            {
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col-md-6">
                                            <b><?php 
                                            if($instituteDetails->under_charter_activities == 'YES')
                                            {
                                                echo "YES";
                                            } 
                                            else if($instituteDetails->venture_type == 'NO')
                                            {
                                                echo "NO";
                                            }
                                            else
                                ...
                                <?php if(isset($instituteDetails->commercial_purpose_non_govt) && $instituteDetails->ins_cat_type_co == 12 && ($instituteDetails->commercial_purpose_non_govt =='N' || $instituteDetails->commercial_purpose_non_govt == 'Y')){ ?>
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        <?php $i = 1;foreach ($lmnotes as $lmnote): ?>
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" autocomplete="off" class="form-control <?php if(form_error('lm_possession_entry')){echo 'lm_invalid';}?>" id="lm_possession_entry" placeholder="dd-mm-yyyy" name="lm_possession_entry" value="<?php echo $lmnote->period_possession;?>" required="" style="margin-left: 20px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            <?php
                                                            if(isset($err_return)){
                                                                if(set_value('wetland_area') == YES){
                                                                    echo "checked";
                                                                }
                                                            }else{
                                                                if (trim($lmnote->wetland_area) == YES) {echo "checked";}
                                                            }
                                                            ?>
                                                        />
                                                        <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            <?php
                                                            if(isset($err_return)){
                                                                if(set_value('wetland_area') == NO){
                                                                    echo "checked";
                                                                }
                                                            }else{
                                                                if (trim($lmnote->wetland_area) == NO) {echo "checked";}
                                                            }
                                                            ?>
                                                        />
                                                        <label class="form-check-label" for="inlineRadio2">No</label>
                                    ...
                                    <?php endforeach; }?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <select name="co_operative_registered" id="co_operative_registered" class="form-select <?php if(form_error('co_operative_registered')) { echo 'lm_invalid';}?>">
                                                   <?php 
                                                    if(trim($lmnote->co_operative_registered) == 'N')
                                                    {
                                        ...
                                        <div class="row registration_no_details">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" autocomplete="off" class="form-control <?php if(form_error('registration_no')){echo 'lm_invalid';}?>" id="registration_no" placeholder="" name="registration_no" value="<?php if(isset($err_return)){ echo set_value('registration_no');}else{ echo $lmnote->registration_no;}?>" required="" style="margin-left: 20px;">
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" autocomplete="off" class="form-control <?php if(form_error('registration_date')){echo 'lm_invalid';}?>" id="registration_date" placeholder="" name="registration_date" value="<?php if(isset($err_return)){ echo set_value('registration_date');}else{ echo $lmnote->registration_date;}?>" required="" style="margin-left: 20px;">
                                            </div>
                                        </div>
                                        <?php } ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="already_alloted" id="already_alloted" class="form-select <?php if(form_error('already_alloted')) { echo 'lm_invalid';}?>">
                                                        <option value="N" <?php if ($lmnote->already_alloted == 'N') {echo "selected";}?> >NO</option>
                                                        <option value="Y" <?php if ($lmnote->already_alloted == 'Y') {echo "selected";}?>>YES</option>

                                                    </select>
                                                </div>
                                            </div>
                                          
                                                <div class="row already_premium_paid_div" >
                                                    <div class="form-group col-md-6 ">
                                                        a) Date of allotment
                                                    </div>
                                                    <div class="form-group col-md-6">

                                                        <input type="text" autocomplete="off" class="form-control <?php if(form_error('date_of_allotment')){echo 'lm_invalid';}?>" id="date_of_allotment" placeholder="dd-mm-yyyy" name="date_of_allotment" value="<?php if(isset($err_return)){ echo set_value('date_of_allotment');} else {echo trim($lmnote->date_of_allotment);}?>" required="" style="margin-left: 20px;">
                                                    </div>
                                                </div>
                                                <div class="row already_premium_paid_div">
                                                    <div class="form-group col-md-6 ">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input <?php if(form_error('actual_purpose_use')){echo 'lm_invalid';}?>"
                                                                    type="radio"
                                                                    name="actual_purpose_use"
                                                                    id="actual_purpose_use1"
                                                                    value="YES" <?php
                                                            if(isset($err_return)){
                                                                if(set_value('actual_purpose_use') == "YES"){
                                                                    echo "checked";
                                                                }
                                                            }else{
                                                                if (trim($lmnote->actual_purpose_use) == "YES"){
                                                                    echo "checked";
                                                                }
                                                            }?>
                                                            />
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input <?php if(form_error('actual_purpose_use')){echo 'lm_invalid';}?>"
                                                                    ...
                                                                    value="NO" <?php
                                                            if(isset($err_return)){
                                                                if(set_value('actual_purpose_use') == "NO"){
                                                                    echo "checked";
                                                                }
                                                            }else{
                                                                if (trim($lmnote->actual_purpose_use) == "NO"){
                                                                    echo "checked";
                                                                }
                                                            }?>
                                                            />
...
<script>
    ...
    $("#lm_remark").change(function (event) {
        ...
        if(selectedRemark==1){
            ...
            $('#lm_remark_text').append("\n \n গতিকে ভূমি নীতি ও চৰকাৰ ৰ সেহতীয়া নিৰ্দেশ মতে পট্টনৰ যোগ্য বুলি বিবেচনা কৰিব পাৰি আৰু সংৰক্ষন কৰিব লগা ভূমি বাদ দি "+$('#alloted_bigha').val()+" বি "+$('#alloted_katha').val()+" ক "+$('#alloted_lessa').val()+" চ "+$('#alloted_ganda').val()+" গ পট্টন দিব পৰা যায়।");
            <?php else : ?>
            ...
            $('#lm_remark_text').append("\n \n গতিকে ভূমি নীতি ও চৰকাৰ ৰ সেহতীয়া নিৰ্দেশ মতে পট্টনৰ যোগ্য বুলি বিবেচনা কৰিব পাৰি আৰু সংৰক্ষন কৰিব লগা ভূমি বাদ দি "+$('#alloted_bigha').val()+" বি "+$('#alloted_katha').val()+" ক "+$('#alloted_lessa').val()+" লে পট্টন দিব পৰা যায়।");
            <?php endif ;?>
            ...
            $('#lm_remark_text').append("\n \n গতিকে ভূমি নীতি ও চৰকাৰ ৰ সেহতীয়া নিৰ্দেশ মতে পট্টনৰ যোগ্য বুলি বিবেচনা কৰিব পাৰি আৰু সংৰক্ষন কৰিব লগা ভূমি বাদ দি "+$('#alloted_bigha').val()+" বি "+$('#alloted_katha').val()+" ক "+$('#alloted_lessa').val()+" চ "+$('#alloted_ganda').val()+" গ পট্টন দিব পৰা নাযায়।");
            <?php else : ?>
            $('#lm_remark_text').text("আবেদনকাৰী  <?php echo $instituteDetails->ins_name_assamese; ?> য়ে <?php echo $this->utilityclass->getCircleName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"])?> ৰাজহ চক্ৰৰ  <?php echo $this->utilityclass->getMouzaName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"])?> মৌজাৰ <?php echo $this->utilityclass->getLotName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"],$basic["lot_no"])?>ৰ <?php echo $this->utilityclass->getVillageName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"],$basic["lot_no"],$basic["vill_townprt_code"])?> <?php echo $lmtown?> ৰাজহ গাওঁৰ চৰকাৰী দাগ নং <?php echo $all_dags?> ত "+$('#sbigha').val()+" বি "+$('#skatha').val()+" ক "+$('#slessa').val()+" লে  ত ভূমি পট্টনৰ বাবে আবেদন কৰিছে।");
            $('#lm_remark_text').append("\n \n "+$('#lm_verification_date').val()+" তাৰিখে চৰজমিন তদন্তৰ উক্ত মাটি "+$('#lm_possession_entry').val()+"  ৰ সময়ত আবেদনকাৰীয়ে দখলকৰি থকা দেখা গল।");
            <?php foreach($dags as $lmnote_dag): ?>
            ...
            $('#lm_remark_text').append("\n \n গতিকে ভূমি নীতি ও চৰকাৰ ৰ সেহতীয়া নিৰ্দেশ মতে পট্টনৰ যোগ্য বুলি বিবেচনা কৰিব পাৰি আৰু সংৰক্ষন কৰিব লগা ভূমি বাদ দি "+$('#alloted_bigha').val()+" বি "+$('#alloted_katha').val()+" ক "+$('#alloted_lessa').val()+" লে পট্টন দিব পৰা নাযায়।");
            <?php endif ;?>
        }else{
            $('#lm_remark_text').text('');
...
<script>
    ...
    function premiumModal(){
        ...
        if(ins_cat_type_co_val == 12)
        {
            ...
            {
                // alert('#ERR 3771 : Something went wrong...');
                // return false;
        ...
        else
        {
            ...
            {
                // alert('#ERR 3772 : Something went wrong...');
                // return false;
