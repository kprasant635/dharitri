    ...
    <section>
      <div class="wizard">
        ...
        <form role="form" method="post" action="<?php echo base_url()?>index.php/basundhara/settlementApPost" enctype="multipart/form-data">
          ...
          <input type="hidden" name="is_urban" value=" <?=$settlementsOne->is_urban; ?>">
          ...
          <div class="tab-content">
            <div class="tab-pane active" role="tabpanel" id="step1">
              <h5 class="bg-info p-2 text-white shadow">
                Registration of SETTLEMENT TEA (
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <?php $i=1; foreach($settlements as $settlement): ?>
                      <input type="hidden" name="pdar_id<?=$i?>" value="<?=$settlement->appl_pdar_id;?>">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td colspan="2">
                          <input type="text" name="pdar_add1<?=$i?>" value="<?=$settlement->address?>" class="form-control input-sm">
                        </td>
                
                        <th>Presend address</th>
                        <td colspan="2">
                          <input type="text" name="pdar_add2<?=$i?>" value="<?=$settlement->address_2?>" class="form-control input-sm" >
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <strong><input type="text" style="text-align: center;" value="<?=$settlement->ind_b?>" name="i_area_b<?=$i?>" class="form-control input-sm">
                          </strong>
                          </td>
                          <td>
                          <span class="input-group-addon">Katha</span>
                          <strong><input type="text" style="text-align: center;" value="<?=$settlement->ind_k?>" name="i_area_k<?=$i?>" class="form-control input-sm" >
                          </strong> 
                        </td>
                        <td>
                          <span class="input-group-addon">Lessa</span>
                          <strong><input type="text" style="text-align: center;" name="i_area_lc<?=$i?>" value="<?=$settlement->ind_l?>" class="form-control input-sm" >
                          </strong> 
                        </td>
                        <td>
                          <span class="input-group-addon">Ganda</span>
                          <strong><input type="text" style="text-align: center;" name="i_area_g<?=$i?>" value="<?php if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))){ echo $settlement->ind_g;} else {echo '0';} ?>" class="form-control input-sm" >
                          </strong> 
                        </td>
                        <td>
                          <span class="input-group-addon">Kranti</span>
                          <strong><input type="text" style="text-align: center;" value="<?php if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))){ echo $settlement->ind_kr;} else {echo '0';} ?>" name="i_area_kr<?=$i?>" class="form-control input-sm" >
                          </strong>
                        </td>
                      </tr>
                    </table>
                  ...
                  <p class="card-text">
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="input-group-addon">Bigha</span>
                          <input type="text" style="text-align: center;" name="s_dag_area_b" class="form-control input-sm s_dag_area_b" value="<?=$settlement->app_bigha?>" >
                        </td>
                        <td>
                          <span class="input-group-addon">Katha</span>
                          <input type="text" style="text-align: center;" name="s_dag_area_k" value="<?=$settlement->app_katha?>" class="form-control input-sm s_dag_area_k" >
                        </td>
                        <td>
                          <span class="input-group-addon">Lessa</span>
                          <input type="text" style="text-align: center;" name="s_dag_area_lc" class="form-control input-sm s_dag_area_lc" value="<?=$settlement->app_lessa?>" >
                        </td>
                        <?php if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))): ?>
                        <td>
                          <span class="input-group-addon">Ganda</span>
                          <input type="text" style="text-align: center;" value="<?=$settlement->app_ganda?>" class="form-control input-sm s_dag_area_g" name="s_dag_area_g" >
                        </td>
                        <td>
                          <span class="input-group-addon">Kranti</span>
                          <input type="text" style="text-align: center;" value="<?=$settlement->app_kranti?>" class="form-control input-sm s_dag_area_kr" name="s_dag_area_kr" >
                        </td>
                        <?php endif ; ?>
                      </tr>
                      <?php $i++?>
