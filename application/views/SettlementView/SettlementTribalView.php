    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form class="lmForm" role="form" method="post" action="<?php echo base_url()?>index.php/SettlementTribal/TribalApplicationRegistration/<?=$review_flag?>?app=<?=$_GET['app']?>" enctype="multipart/form-data">
