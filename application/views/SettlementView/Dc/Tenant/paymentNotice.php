...
<html class="no-js">
   ...
   <body style="background:none!important">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementTenantDc/savePaymentNotice" method="post" enctype='multipart/form-data'>
            ...
            <div class="container bg-white shadow" id="print_direct">
               ...
               <div class="row mt-4">
                  <div class="col-12 text-justify p-5">
                     ...
                     ইয়াৰ দ্বাৰা আপোনাক জনোৱা হয় যে মিছন বসুন্ধৰাৰ অধীনত  <b>SETTLEMENT OF OCCUPANCY TENANT</b> সেৱাৰ বাবে আপুনি নিম্নোক্ত তপচিলভুক্ত ভূমিৰ বাবে <b><?=$date_of_application?></b> তাৰিখে আবেদন নং <b><?=$get_settlement_basic->applid?> (<?=$case_no?>)</b> যোগে দাখিল কৰিছে।
                     <br>
                     <br>
                     ...
                     <br>
                     অসম (অস্থায়ী বন্দৱস্তী এলেকা) ৰায়তী আইন ১৯৭১  অনুসৰি আবেদন পৰীক্ষা ও  শুনানি লোৱাৰ অন্তত ২৩ আৰু ২৪/২৫ ধাৰাৰ অধীনত আপোনাৰ বাবে মালিকীস্বত্বৰ অধিগ্ৰহণৰ বাবে মূল্যায়ন  আৰু প্ৰদান কৰা মুঠ ক্ষতিপূৰণৰ পৰিমাণ হিচাপে <b><?=$premium_data[0]->due_amount?></b> টকাৰ ৰাশি জমা দিবলৈ জনোৱা হ'ল I
                     ...
                     <br>
                     ১) No. RDM-12011(17)/5/2022-LR-REV-R&DM/94 dtd 11-Nov-2022

                     <br> -->
                     <br>
                     ওপৰত উল্লেখ কৰা ক্ষতিপূৰণৰ মূল্য আপোনাৰ স্ব- ঘোষণাৰ লগতে সংশ্লিষ্ট চক্ৰ বিষয়াই কৰা (সম্ভাব্য) মূল্যায়নৰ ওপৰত নিৰ্ধাৰণ কৰি আপোনাৰ দখল/অধীনত থকা মাটিৰ ওপৰত নিৰ্ণয় কৰা হৈছে। আধুনিক পদ্ধতিৰে জৰীপৰ পাছত দখল/অধীনত থকা প্ৰকৃত মাটিৰ পৰিমাণ সাল-সলনি হ’লে আদায় দিবলগীয়া ভূমিৰ ক্ষতিপূৰণৰ মূল্য  সংশোধন কৰা হ’ব পাৰে।

                     <br>
                     <br>
                     *পৰিৱৰ্তিত ক্ষতিপূৰণৰ মূল্য দখল অনুসৰি সংশোধনযোগ্য হ’ব।
