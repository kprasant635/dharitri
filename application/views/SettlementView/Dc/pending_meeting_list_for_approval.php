            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 25px">
                        ...
                        <?php if(MB2_DIGITAL_SIGN_LIVE == 1): ?>
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : BASE_URL + '/SettlementMeetingControllerDc/listOfPendingMeetingIds',
                type : 'POST',
                data : {
                    // circle       : circle,
                    // subdiv       : subdiv,
    ...
    $('#datatable').on('click', '.showMinutesGenerateModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/generateDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/verifyArea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCasesPendingMeeting(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/deleteProposalWithZeroCasesForPendingMeetingByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        // });
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/digitalSignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $('#datatable').on('click', '.revertBackMeetingModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/getRevertBackMeetingDetails",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
                ...
                {
                    window.location.href = baseurl+"SettlementMeetingControllerDc/getVgrPgrCasesForRevertDc/"+data.meetingId;
                }
                else
                {
                    showErrorMessage("SOMETHING WENT WRONG");
    ...
    $('#revertBackMeetingModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/revertBackMeetingToAdcSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "SettlementMeetingControllerDc/signedAndFinalApproveByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
