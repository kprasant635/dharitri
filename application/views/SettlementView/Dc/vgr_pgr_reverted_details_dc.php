                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" align="right">
                        <?php if(PROCESS_REVERTED_VGR_PGR_CASE_ADC_SDO == 1): ?>
                            <button class="rezaButt buttPrim" id="forwardedToDc">
                                <i class="fa fa-share"></i> Forward To Department
                            </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Case Forward to Department </h5>
            </div>
...
<script>
    ...
    $(document).on('click','#forwardedToDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/revertedVgrCaseForwardToDeptByDc",
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    else if(data.responseType == 2)
                    {
                        ...
                        window.location = BASE_URL + "/SettlementMeetingControllerDc/getAllVgrPgrRevertedCaseByDept";
                    }
                    })
                    }
                    else
    ...
    $(document).on('click','#revertToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/revertedVgrCaseRevertToCoByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
