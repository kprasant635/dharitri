...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB3 /
            <a href="<?= base_url()?>index.php/home/ConversionDcMb">
               AP to PP Conversion /
            </a>
            Cases For Pull Back
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Pending Cases with Department for Pullback – AP to PP Conversion (MB3.0) </span>
                <hr>
            </div>
...
<script>
    ...
    $('#datatable').on('click', '.pullBackCasesModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/dc_conversion_mb/getPullBackCaseDetailsApToPp",
            type: "post",
            dataType: "json",
    ...
    $('#pullBackCasesModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/dc_conversion_mb/finalPullBackRevertToCoSubmitApToPp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/dc_conversion_mb/pullBackCasesWithDeptPaginationAPIApToPp',
                type:'POST',
                data: {
                    circle     : circle,
                    subdiv     : subdiv,
