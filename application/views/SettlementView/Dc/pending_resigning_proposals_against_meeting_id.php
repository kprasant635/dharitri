...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementMeetingControllerDc/getAllPendingMeetingForDigitalResigning'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
