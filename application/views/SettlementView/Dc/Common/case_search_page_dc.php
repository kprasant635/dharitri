                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-select" aria-label="Default select example" name="serviceType" id="serviceType">
                                    ...
                                    <option value="<?= SLIJE_ID ?>">
                                        Non individual juridical entities
                                    </option>
                                    <option value="<?= BHODDAN_SERVICE_CODE ?>">
                                        Settlement of unsettled erstwhile Bhoodan/Gramdan Lands
                                    </option>
                                    <option value="<?= NC_KHAS_LAND_ID ?>">
                                        <?= $this->lang->line('ncKhasLink') ?>
                                    </option>
                                    <option value="<?= NC_CULTIVATOR_ID ?>">
                                        <?= $this->lang->line('ncCultivatorTitle') ?>
                                    </option>
                                    <option value="<?= NC_TRIBAL_ID ?>">
                                        <?= $this->lang->line('ncTribalTitle') ?>
                                    </option>
                                    <option value="<?= RECLASS_ID ?>">
                                        Offering Reclassification Suite
                                    </option>
                                    <option value="<?= SETTLEMENT_TENANT_URBAN_ID ?>">
                                        Settlement of Occupancy Tenant (Urban)
                                    </option>
                                    <option value="<?= TEA_SERVICE_CODE ?>">
                                        Limited Conversion of Tea Grant to Periodic Patta
                                    </option>
                                </select>
                            </div>
                        </div>
