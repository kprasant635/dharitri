                    ...
                    <div class="modal-body" align="">
                        <form action="<?php echo base_url() . 'index.php/SettlementCommonDc/editSdlacMemberDetails'; ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label for="w3review" style="font-weight: bold">Position Order </label>
                                    <input class="form-control" name="position_order" value="<?php echo trim($member->position_order) ?>" required minlength="1">
                                </div>
                            </div>
