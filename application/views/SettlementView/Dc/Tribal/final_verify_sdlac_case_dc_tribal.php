        ...
        <div class="reza-card">
            <div class="reza-title">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" align="right">
                        <?php if($proposalDetails->final_verify_status == 1): ?>
                            <?php if(DC_FINAL_APPROVED == 1): ?>
                                <button  class="rezaButt buttPrimary" id="approveDCFinal" >
                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                    <?php echo $this->lang->line('approvedButt'); ?>
                                </button>
                            <?php endif; ?>
                ...
                <?php else : ?>
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <tr>
                            ...
                            <th class="center"><label class="control-label">SDLAC Status</label></th>
                            <th class="center"><label class="control-label">DC Status</label></th>
                            ...
                            <tr id="caseNoData">
                                ...
                                <td>
                                    ...
                                    <span class='small font-italic red'><?php if ($case->case_no) {
                                            ...
                                            if($case->rejected_flag == 1)
                                            {
                                                echo "<br> <b>This case has been rejected.</b> &nbsp; <a style=\"cursor:pointer; text-decoration:underline; color:blue\" onclick=\"rejectedModal('$case->case_no')\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i> Rejected Reasons</a>";
                                ...
                                <?php if($case->status == PRO_CASE_STATUS_PENDING) : ?>
                                    ...
                                    <td class="center">
                                        <span style="color: #37474F">
                                            <i class="fa fa-<?=($case->rejected_flag == 1)?'close':'Spinner fa-pulse'?>" aria-hidden="true"></i> &nbsp;<?=($case->rejected_flag == 1)?'Rejected':'Pending'?>
                                        </span>
                                    </td>

                                    <td class="center">
                                        <?php if($proposalDetails->final_verify_status != 2): ?>
                                            <span style="color: #37474F">
                                            <i class="fa fa-spinner fa-pulse " aria-hidden="true"></i> &nbsp;Pending
                                        </span>
                                        <?php else : ?>
                                            <span style="color: #2E7D32">
                                            <i class="fa fa-check-square" aria-hidden="true"></i> &nbsp;Processed
                                        </span>
                                        <?php endif;?>
                                    </td>
                                    <td class="center">
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/getSettlementTribalApplicationDetails/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <span style="color: #37474F">
                                            <i class="fa fa-<?=($case->rejected_flag == 1)?'close':'Spinner fa-pulse'?>" aria-hidden="true"></i> &nbsp;<?=($case->rejected_flag == 1)?'Rejected':'Approved'?>
                                        </span>
                                    </td>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/viewApprovedAppDetailsTribal/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <span style="color: #37474F">
                                            <i class="fa fa-<?=($case->rejected_flag == 1)?'close':'Spinner fa-pulse'?>" aria-hidden="true"></i> &nbsp;<?=($case->rejected_flag == 1)?'Rejected':'Rejected'?>
                                        </span>
                                    </td>
                                    <td class="center">
                                        <?php if($proposalDetails->final_verify_status != 2): ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/viewRejectedAppDetailsTribal/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <span style="color: #37474F">
                                            <i class="fa fa-<?=($case->rejected_flag == 1)?'close':'Spinner fa-pulse'?>" aria-hidden="true"></i> &nbsp;<?=($case->rejected_flag == 1)?'Rejected':'Reverted'?>
                                        </span>
                                    </td>
                                    <td class="center">
                                        <?php if($proposalDetails->final_verify_status != 2): ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/viewRejectedAppDetailsTribal/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                <h3>Are You Sure !</h3>
                <br>
                <h5>You want to Approve this Proposal !</h5>
            </div>
            <div class="modal-footer">
...
<!-- Modal Mark as SDLAC -->
<div class="modal" role="dialog" id="viewRejectedModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
            ...
            <div class="modal-body" >
                ...
                <div class="row">
                    <table>
                        <tbody id="rejected_list_id"></tbody>
                    </table>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"  id="rejectedReasonClose">CLOSE</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click','#approveDCFinal',function ()
    {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTribalDc/finalApproveTheProposalByDcTribal",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    {
                        showErrorMessage("There might be some approved case(s) under this Proposal !");
                    }
                    ...
                    else if (data.responseType == 7)
                    {
                        showErrorMessage("This Proposal already approved !");
                        window.location = window.location;
                    }
...
<script>
    function rejectedModal(case_no)
    {
        $('#viewRejectedModal').modal('show');
        ...
        $.ajax({
            url: baseurl+'SettlementCommon/getRejectedReasons',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
                ...
                if(arr.responseType == 0){
                    ...
                    for(i=0; i<arr.data.length; i++)
                    {
                        tableRej +=
                            '<tr>'+
                            '<td class="pl-3 pr-3"><i class="fa fa-check" aria-hidden="true"></i> <strong>' + arr.data[i].remark + '</strong></td>' +
                            '</tr>'
                    }
                    $('#rejected_list_id').html(tableRej);
                }
            }
        });
    }

    $(document).on('click','#rejectedReasonClose',function ()
    {
        $('#viewRejectedModal').modal('hide');
    });
