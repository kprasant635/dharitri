...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementTribalSdo/getAllProposalListSdlacKhas">SDLAC/CDLAC Report</a>
                            ...
                            <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementTribalDc/getAllApplicationInReportSendByDcToSdlacTribal/?case=<?php echo $case->id; ?>">
