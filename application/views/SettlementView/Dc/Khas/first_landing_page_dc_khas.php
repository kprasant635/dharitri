...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB / <a href="<?= base_url()?>index.php/SettlementMbDc/SettlementKhasLandDc">Khas Land</a>

            <?php include(APPPATH."views/SettlementView/include/buttonMenuDc.php"); ?>
        </div>
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                <table class="table table-striped table-hover">
                    ...
                    <?php if(FIRST_PAGE_ONLY_DC == 1) { ?>
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbDc/viewAllKhasFirstProceedingDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbDc/viewAllMarkAsSDLACListForDCKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbDc/getAllProposalListSdlacKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <!--                            </td>-->
                        <!--                            <td>-->
                        <!--                                <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllSdlacMemberApprovalProposalListKhas'; ?><!--" style="float:right">-->
                        <!--                                    <i class="fa fa-eye"></i>&nbsp;view-->
                        <!--                                </a>-->
                        <!--                            </td>-->
                        <!--                        </tr>-->
                    ...
                    <?php } ?>
                    <?php if(FIRST_PAGE_ONLY_DC == 0 OR FIRST_PAGE_ONLY_DC == 1) { ?>
                        <tr>
                            <td class="rezaText"><?php echo $slNo += 1; ?>.</td>
                            <td class="rezaText">Step 1</td>
                            <td class="rezaText"><?php echo $this->lang->line('finalCaseList') ?></td>
                            <td>
                                <?php
                                if ($finalVerifyCaseCount != '0')
                                {
                                    echo  "<span class=\"badge badge-danger\">$finalVerifyCaseCount</span>";
                                }
                                else
                                {
                                    echo  "<span class=\"badge badge-success\">$finalVerifyCaseCount</span>";
                                }
                                ?>
                            </td>
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbDc/getAllProposalForFinalVerification'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <!-- <tr>
                        ...
                        <td class="rezaText">Cases rejected by SDO/ADC</td>
                        <td>
                            <?php
                    if ($rejectedCasesSdoAdc != '0')
                    {
                        echo  "<span class=\"badge badge-danger\">$rejectedCasesSdoAdc</span>";
                    }
                    else
                    {
                        echo  "<span class=\"badge badge-success\">$rejectedCasesSdoAdc</span>";
                    }
                    ?>
                        </td>
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbDc/getAllRejectedCasesByAdcSdo'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php ////echo base_url() . 'index.php/SettlementMbDc/getAllUnderConSdlacKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllReReportAppByCOForDcAppKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllRevertedAppByDeptForDcAppKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllApprovedBySDLACListKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllRejectByDcListKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbDc/getAllOrderChithaUpdateForDcAppKhas'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
