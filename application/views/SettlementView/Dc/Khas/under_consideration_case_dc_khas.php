...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementMbDc/getAllUnderConSdlacKhas">Under Consideration</a>
                            ...
                            <tr>
                                ...
                                <th>Circle Name
                                    <select class="form-control input_search" name="cir_id" id="cir_id" data-column-index="0">
                                        ...
                                        <?php
                                            if(isset($locations)){ foreach($locations as $cir){
                                            ?>
                                            <option value="<?=$cir->cir_code?>,<?=$cir->subdiv_code?>,<?=$cir->mouza_pargona_code?>,<?=$cir->lot_no?>"><?=$this->utilityclass->getCircleName($cir->dist_code, $cir->subdiv_code, $cir->cir_code)?></option>
                                        <?php }}?>
                                    </select>
                                </th>
...
<script type="text/javascript">
    ...
    $('#cir_id').change(function()
    {
        ...
        $.ajax({
            url: base_url+'index.php/SettlementMbDc/getVillName',
            dataType: "JSON",
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementMbDc/thirdProceedingUnderConsideration',
                type:'POST',
                data: {
