...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementMbDc/getAllSdlacMemberApprovalProposalListKhas">SDLAC/CDLAC Member Status </a> / Details

            <a href="<?= base_url()?>index.php/SettlementMbDc/getAllSdlacMemberApprovalProposalListKhas"><button type="button" class="btn btn-sm btn-danger pull-right">
                    <i class="fa fa-backward"></i>&nbsp;Go Back One Step</button></a>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($report->status == SDLAC_MEMBER_REPORT_STATUS_AGREE) : ?>
                                        <i class="fa fa-check-square" aria-hidden="true"></i> &nbsp;Agreed
                                    <?php elseif ($report->status == SDLAC_MEMBER_REPORT_STATUS_DISAGREE) : ?>
                                        <i class="fa fa-times-circle" aria-hidden="true"></i> &nbsp;Disagreed
                                    <?php endif ;?>
                                </td>
