                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr id="caseNoData">
                                ...
                                <?php
                                if($case->status == PRO_CASE_STATUS_PENDING) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementMbDc/getSettlementKhasApplicationDetails/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementMbDc/viewApprovedAppDetailsKhas/?case=<?php echo $case->case_no; ?>">
...
<script>
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/finalApproveTheProposalByDcKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
