...
<div class="container">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        <a href="<?= base_url()?>index.php/SettlementMbDc/viewAllKhasFirstProceedingDCCaseList">First Proceeding</a> / View
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMbDc/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMbDc/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationRejectedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    {
                        $('.rezaButt').hide();
                        showSuccessMessage("Application Rejected & Forwarded to DC for Final Verification  ");
                        // showSuccessMessage("Application Successfully Rejected");
                    }
                    else if (data.responseType == 3)
                    {
    ...
    $(document).on('click','#approveBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationApprovedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $('#approveByDcModal').modal('hide');
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationPaymentGenerateDcKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#revertFromSDLACToCoModalYes',function ()
    {
        ...
        if(remarks != '' && status != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMbDc/applicationRevertFromSDLACToCOKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
