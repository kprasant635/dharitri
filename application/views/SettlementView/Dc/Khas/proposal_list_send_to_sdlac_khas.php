            ...
            <div class="reza-title">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <span><?php echo $this->lang->line('khasLand') ?> <?php echo $this->lang->line('proposalList') ?></span>
                        <hr>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementMbDc/thirdProceedingSdlacReport',
                type : 'POST',
                data : {
    ...
    function openTab(id){
        ...
        $.ajax({
            url  : base_url+'index.php/SettlementMbDc/getCasesAgainstProposalNo',
            dataType: "JSON",
