...
<!--                <a class="btn btn-sm btn-info pull-right" href="--><?//=base_url().'index.php/SettlementProposalControllerIns/commonProposalListView'?><!--"><i class="fa fa-backward"></i>&nbsp;Go Back</a>-->
<!--            --><?php //} else if($this->session->userdata('user_desig_code') == MB_SUB_DIV_COMM) { ?>
<!--                <a class="btn btn-sm btn-info pull-right" href="--><?//=base_url().'index.php/SettlementProposalControllerInsSdo/commonProposalListView'?><!--"><i class="fa fa-backward"></i>&nbsp;Go Back</a>-->
<!--            --><?php //} ?>
