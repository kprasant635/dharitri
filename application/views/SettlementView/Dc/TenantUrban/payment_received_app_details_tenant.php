                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="step5">
                        ...
                        <h5 class="bg-info p-2 text-white shadow">
                            Registration of <?php echo $this->lang->line('settlementOccupancyTenant')?> (
                    ...
                    <div class="tab-pane" role="tabpanel" id="proceedings">
                        ...
                        <br>
                        <h5 class="bg-info p-2 text-white shadow">
                            Proceeding of <?php echo $this->lang->line('settlementOccupancyTenant')?> (
...
<script>
    ...
    $(document).on('click','#orderForChithaUpdateModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTenantDc/orderToCoByDcForChithaUpdating",
                type: "post",
                dataType: "json",
