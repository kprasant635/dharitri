                            ...
                            <tr >
                                ...
                                <td class="center">
                                    <?php //if($case->general_notice_dc == 'y'){ ?>
                                        <a class="rezaButt buttPrimary" href="<?php echo base_url(); ?>index.php/SettlementTenantUrbanDc/getSettlementApApplicationDetails/?case=<?php echo $case->case_no; ?>">
                                            <i class="fa fa-cog" aria-hidden="true"></i>
                                            <?php echo $this->lang->line('process'); ?>
                                        </a>
                                        <!-- <a target="_blank" class="rezaButt buttInfo" href="<?php //echo base_url(); ?>index.php/SettlementTenantUrbanDc/viewGeneralNoticeTenant/?case=<?php //echo $case->case_no; ?>">
