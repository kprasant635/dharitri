...
<form action="<?php echo base_url()?>index.php/SettlementTenantUrbanDc/confirmPaymentApplicant" method="post">
...
<!--            </button>-->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    type="text" placeholder="PAYMENT-DATE" readonly />
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-lg-4" style="text-align: right;">
            ...
            <script>
                ...
                function manualPaymentDetailsSubmitHandle(){
                    ...
                    $.ajax({
                        url: baseurl + "SettlementTenantUrbanDc/manualPaymentDetailsSubmitHandleDc",
                        type: 'POST',
