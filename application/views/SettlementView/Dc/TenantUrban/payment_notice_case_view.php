                            ...
                            <div class="reza-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if ($caseDetails->status == MB_PENDING or $caseDetails->pending_officer == MB_DEPUTY_COMM) : ?>

                                            <?php if ($caseDetails->general_notice_dc == 'y') { ?>

                                                <a target="_blank" class="btn btn-warning" href="<?php echo base_url(); ?>index.php/SettlementTenantUrbanDc/viewGeneralNoticeTenant/?case=<?php echo $caseDetails->case_no; ?>">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>View General Notice
                                                </a>

                                                <!-- <button  class="btn btn-warning" onclick="generalNotice('<?php echo $caseDetails->case_no ?>')" value="<?php echo $caseDetails->case_no ?>">
                                                ...
                                                <?php if ($areaCheck == 0):
                                                    if ($validation_bypass != 1) {
                                                        if (strtolower(trim($basic['dept_approval'])) == 'y') {
                                                            ?>
                                                            <a id="generatePay" class="rezaButt buttInfo" href="<?php echo base_url(); ?>index.php/SettlementTenantUrbanDc/generatePaymentNotice?case=<?php echo $_GET['case'] ?>">
                                                                <i class="fa fa-money" aria-hidden="true"></i> Generate Payment Notice
                                                            </a>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <!--                                                            <a id="forwardToDept" class="rezaButt buttInfo" href="--><?php //echo base_url(); ?><!--index.php/SettlementTenantUrbanDc/forwardToDept?case=--><?php //echo $_GET['case'] ?><!--">-->
                                                            <!--                                                                <i class="fa fa-money" aria-hidden="true"></i> Forward to Department-->
                                                            <!--                                                            </a>-->
                                                ...
                                                <button class="rezaButt buttDanger" id="rejectByDc" onclick="showNewDirectRejectModalMb3('<?php echo $_GET['case'] ?>','<?= SETTLEMENT_TENANT_URBAN_ID ?>')">
                ...
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <textarea class="form-control" name="w3review" id="revertToCoRemarks" rows="4" required minlength="3"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
