...
<div class="col-lg-12"  style='padding: 40px 50px 40px 20px'>
    <div class="reza-card ">
        <div class="reza-title">
            ...
            <hr>
            <span>Available cases to generate Excel sheet</span>
        </div>
            ...
            <table class="datatable table table-stripped" id='datatable'>
                ...
                <tr>
                    ...
                    <th class="center">Action
                        <button type="button" class="search_button btn btn-sm btn-primary form-control"><i class="fa fa-search" aria-hidden="true"></i>Search</button>
                    </th>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="left">
                    <?php if(ENABLE_BUTTON_SEND_TO_SDLAC !=0): ?>
                        <button class="rezaButt buttInfo" id="generateExcel">
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementTenantDc/getPaymentReceivedCases',
                type:'POST',
                data: {
    ...
    $('#generateExcel').click(function ()
    {
        ...
        //    $.ajax({
        //        url: baseurl+'SettlementTenantDc/excelDataInsertion',
        //        type: "POST",
        //        data: postData,
        //        success: function(data) {
        //            arr = JSON.parse(data);
        ...
        //                .then((result) => {
        //                    if (result.isConfirmed) {
        //                         //*******load the datatable again for fresh data */
        //                         load_data();
        //                         // window.location = baseurl+'SettlementTenantDc/generateExcel'+arr.beneData;
        //                    }
        //                })
        //            }
        //        }
