...
<style>
    ...
    <blade media|%20screen%20and%20(max-width%3A%20600px)%20%7B%0D>.timeline {
                                                                     gap: 15px;
                                                                     padding: 10px;
                                                                 }
                ...
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs shadow" id="myTab" role="tablist">
                        <li role="presentation" class="active">
                            <a class="test" href="#step1" data-toggle="tab" aria-controls="step1" role="tab"
                               title="Step 1">
                            ...
                            <div class="reza-body">
                                            ...
                                            foreach ($proceedings as $pro): if ($i == 1) {?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?php echo date("d-M-Y", strtotime($pro->date_entry)) ?>
                                                    </td>
                                                    <td style="text-transform: uppercase">
                                                        <i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;
                                                        <?php echo date("h:i a", strtotime($pro->date_entry)) ?>
                                                    </td>
                                                    <td>
                                                        <i class="fa fa-user" aria-hidden="true"></i>&nbsp;
                                                        <?php echo $pro->office_from; ?>
                                                    </td>
                                                    <td><?php echo $pro->note_on_order; ?></span></td>
                                                </tr>
                                            <?php }
                                                $i++;endforeach; ?>
                                        </table>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" style="margin-bottom: 40px">
                                                    ...
                                                    <ul style="margin-bottom: 50px">
                                                        ...
                                                        <span>
                                                            ...
                                                            <ul style="padding-bottom: 20px!important;">
                                                                ...
                                                                <span class="badge badge-reza2"
                                                                    ...
                                                                    <?php foreach ($reservedArea as $reza): ?>
                                                                        ...
                                                                        <span class="rezaCaseSpan">
                                                                            <a target="_blank"
                                                                               href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewApplicationDetailsOnly/?case=<?php echo $singleReservedArea->case_no; ?>"
                                                                               style="text-decoration: none">
                                                                                <b><?php echo $singleReservedArea->case_no ?>
                                                                                </b>
                                                                            </a>
                                                                        </span>
                                                                    ...
                                                                    <?php if ((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))): ?>
                                                                        ...
                                                                        <span class="rezaCaseSpanTotal"
                                                                              style="font-weight: bold; align-content: center!important;">
                                                                ...
                                                                <li style="padding-top: 10px; padding-bottom: 15px">
                                                                <span class="badge "
                                                                      style="padding: 5px; font-size: 14px; background-color: #6f42c1">
                                                                    <i class="fa fa-spinner"></i>
                                                                    &nbsp; LM Processed Area In this Dag (LM Report
                                                                    Submitted)
                                                                </span>
                                                                ...
                                                                <span class="badge "
                                                                      style="padding: 5px; font-size: 14px; background-color: #6f42c1">
                                                                    <i class="fa fa-spinner"></i>
                                                                    &nbsp; Applied Area In this Dag (LM Report Not
                                                                    Submitted)
                                                                </span>
                                                                    <?php foreach ($lmProcessArea as $single): ?>
                                                                        <?php foreach ($single as $singleReservedArea): ?>
                                                                ...
                                                                <?php if (! empty($reservation)): ?>
                                                                    <li>
                                                                <span class="badge badge-reza3"
                                                                      style="padding: 5px; font-size: 14px; background-color: #FF9800">
                                        ...
                                        <?php if ($areaCheck == 1): ?>
                                            <h5
                                                style="color: red; font-weight: bold; padding-top: 15px; padding-bottom: 15px; text-align: center">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if ($caseDetails->status == MB_REVERT): ?>


                                            <a target="_blank" class="btn btn-warning"
                                               href="<?php echo base_url(); ?>index.php/SettlementTenantUrbanDc/viewGeneralNoticeTenant/?case=<?php echo $caseDetails->case_no; ?>">
                                            ...
                                            <button id="forwardToDept" class="rezaButt buttInfo" >
                                                <i class="fa fa-share" aria-hidden="true"></i> Forward to Department
                                            </button>
                                            <button class="rezaButt buttDanger" id="rejectByDc"
                                                    onclick="showNewDirectRejectModalMb3('<?php echo $_GET['case'] ?>','<?php echo SETTLEMENT_TENANT_URBAN_ID ?>')">
                                    ...
                                    <div class="timeline" style="margin-bottom: 15px">
                                        ...
                                        <?php foreach ($proceedings as $pro): ?>
                                            ...
                                            <span class="content_tag"
                                                  style="margin-top: 15px; background-color: white; color: #4CAF50">
                                                Application Approved
                                            </span>
                                                    <span class="content_date" style="color: white; margin-top: 7px">
                                                <?php echo date("F j, Y", strtotime($pro->date_entry)) ?>
                                                        <br>
                                                By                                                                                                                                                       <?php echo $pro->office_from; ?>
                                            </span>
                                                </div>
                                            ...
                                            <span class="content_tag"
                                                  style="margin-top: 15px; background-color: white; color: #EF5350">
                                            ...
                                            <span class="content_tag" style="background-color: #AB47BC; color: white">
                                                ...
                                                On                                                                                                                                                       <?php echo date("F j, Y", strtotime($pro->date_entry)) ?>
                                            </span>
                        ...
                        <div class="tab-pane" role="tabpanel" id="premium">
                            ...
                            <h5 class="bg-info p-2 text-white shadow" style="margin-top: 10px">
                                ...
                                <span class="bg-warning"
                                      style="padding-left: 5px; padding-right: 5px"><?php echo $_GET['case'] ?></span> )
                            </h5>
                            <div class="reza-card ">
                                <div class="reza-body">
                                    ...
                                    <div class="tableCard " style="padding: 25px!important;">
                                        ...
                                        <?php foreach ($premium_data as $dagsprem) {?>
                                            ...
                                            <?php if (! empty($dagsprem->zonal_valuation)) {?>
                                                <div class="row">
                                                    <div class="form-group col-md-6 ">
                                                        <label>Zonal Value for dag no <strong><span
                                                                    id="dag_prem"><?php echo $dagsprem->dag_no ?></span></strong></label>

                                                    </div>
                                                    <div class="form-group col-md-6">

                                                        <input type="number" name="zonal_valuation_prem<?php echo $dagsprem->dag_no ?>"
                                                               id="zonal_valuation_prem<?php echo $dagsprem->dag_no ?>" class="form-control"
                                                               value="<?php echo $dagsprem->zonal_valuation ?>" readonly />
                                                    </div>
                                                </div>
                                            <?php }?>
                                            ...
                                            <?php if (! empty($dagsprem->amount_dag)) {?>
                                                <div class="row">
                                                    <div class="form-group col-md-6 ">
                                                        <label for="title">Total amount for dag no <strong><span
                                                                    id="dag_prem"><?php echo $dagsprem->dag_no ?></span></strong></label>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <input id="finalper<?php echo $dagsprem->dag_no ?>" type="hidden"
                                                               class="finalper<?php echo $dagsprem->dag_no ?>" value=""
                                                               name="finalper<?php echo $dagsprem->dag_no ?>" />
                                                        <input id="total_lessa<?php echo $dagsprem->dag_no ?>" type="hidden"
                                                               class="total_lessa<?php echo $dagsprem->dag_no ?>" value=""
                                                               name="total_lessa<?php echo $dagsprem->dag_no ?>" />
                                                        <input type="text" class="totalamount form-control"
                                                               value="<?php echo $dagsprem->amount_dag ?>" name="amount<?php echo $dagsprem->dag_no ?>"
                                                               readonly />
                                                    </div>
                                                </div>
                                            <?php }}?>
                                        ...
                                        <div class="tableCard" style="padding: 25px!important;">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control" name="finalamount"
                                                           id="finalamount" value="<?php echo $dagsprem->final_amount ?>" readonly>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control " name="totaldue" id="totaldue"
                                                           value="<?php echo $dagsprem->due_amount ?>" readonly>
                                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="alert alert-warning mt-3" role="alert" style="font-size: 14px;">
                <strong>Note:</strong> Once you revert this application to the CO, you will have to re-generate the notice.
            </div>
...
<!-- Modal Forward to department-->
<div class="modal" role="dialog" id="forwardToDeptModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Application Recommended & Forward To Department</h5>
            </div>
            <div class="modal-body" align="">
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Enter Your Remarks (If Any)</label>
                            <textarea class="form-control" name="w3review" id="forwardToDeptRemarks" rows="4"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="forwardToDeptModalNo">CLOSE</button>
                <button type="button" class="btn btn-primary" id="forwardToDeptModalYes">RECOMMENDED & FORWARDED TO DEPT</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '#revertFromDcToCoModalYes', function () {
        ...
        if (remarks != '') {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTenantUrbanDc/deptRevertedApplicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
    ...
    // ------------------------------------------------------
    // Forward Application From DC TO Dept
    $(document).on('click', '#forwardToDept', function() {
        $('#forwardToDeptModal').modal('show');
    });

    $(document).on('click', '#forwardToDeptModalNo', function() {
        $('#forwardToDeptModal').modal('hide');
    });

    $(document).on('click', '#forwardToDeptModalYes', function() {
        var remarks = $("#forwardToDeptRemarks").val();
        if (remarks != '') {
            const applicant = {
                caseNo: $("#caseNo").val(),
                remarks: remarks
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTenantUrbanDc/applicationForwardToDept",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function(data) {
