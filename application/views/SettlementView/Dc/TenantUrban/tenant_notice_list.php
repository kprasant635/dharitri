...
<script>
    ...
    function load_data() {
        var base_url = "<?php echo base_url(); ?>"; // Base URL from PHP
        var service_code = <?php echo SETTLEMENT_TENANT_URBAN_ID; ?>; // Ensure PHP value is echoed correctly
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax': {
                url: base_url + 'index.php/SettlementTenantUrbanDc/getPaymentReceivedCasesNoticeByVillage',
                type: 'POST',
                data: {
    ...
    $('#generateExcel').click(function ()
    {
        ...
        .then((result) => {
            if (result.isConfirmed) {
                $('<form action="'+baseurl+'SettlementTenantUrbanDc/excelDataInsertion" method="POST"/>')
...
<script>
    ...
    $(document).on('click','#generateNotice', function(){
        ...
        $.ajax({
            url: baseurl+'SettlementTenantUrbanDc/generateVillNotice',
            type: "POST",
            data: postData,
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        $.ajax({
            url: baseurl+'SettlementTenantUrbanDc/genVIllNotice',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
                ...
                if(arr.responseType != 2){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = baseurl+'SettlementTenantUrbanDc/AllApplicantPaymentConfirmedCasesForNotice';
                        }
                        else
                        {
                            window.location.href = baseurl+'SettlementTenantUrbanDc/AllApplicantPaymentConfirmedCasesForNotice';
    ...
    //     $.ajax({
    //         url: baseurl+'SettlementTenantUrbanDc/printNotice',
    //         type: "POST",
    //         data: postData,
    //         success: function(data) {
    //             $.unblockUI();
