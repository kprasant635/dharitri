                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td style="width: 200px" >
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/viewAllApFirstProceedingDCCaseList'; ?>" style="float:right">
                    ...
                    <tr>
                        ...
                        <td style="width: 200px" >
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/noticeGeneratedAdcHearingCases'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="rezaText"><?php echo $slNo += 1; ?>.</td>
                        <td class="rezaText">ADC forwarded cases/Forward to Department</td>
                        <td>
                            <?php
                            if ($getCasesforwardedByAdcAfterHearing != '0') {
                                echo "<span class=\"badge badge-danger\">$getCasesforwardedByAdcAfterHearing</span>";
                            } else {
                                echo "<span class=\"badge badge-success\">$getCasesforwardedByAdcAfterHearing</span>";
                            }
                            ?>
                        </td>
                        <td style="width: 200px" >
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/paymentNoticeCasesBeforeList'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 200px" >
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/paymentNoticeCases'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    ?>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/getAllReReportAppByCOForDcAppTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTenantUrbanDc/getAllRevertedAppByDeptForDcAppTenant'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    ?>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/getAllApprovedBySDLACListTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    ...
                    ?>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/getAllRejectByDcListTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/getAllOrderChithaUpdateForDcAppTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/AllApplicantPaymentConfirmedCasesForNotice'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/AllApplicantPaymentConfirmedCases'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a> -->
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/excelGeneratedCases'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a> -->
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/pullBackCasesFromDepartmentForDCTenant'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="rezaText"><?php echo $slNo += 1; ?>.</td>
                        <td class="rezaText">Department Reverted Cases</td>
                        <td>
                            <?php
                            if ($deptRevertedCases != '0') {
                                echo "<span class=\"badge badge-danger\">$deptRevertedCases</span>";
                            } else {
                                echo "<span class=\"badge badge-success\">$deptRevertedCases</span>";
                            }
                            ?>
                        </td>
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTenantUrbanDc/departmentRevertedCaseToDC'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
