                ...
                <div class="container bg-white divCard pb-3 " id="html1" style="page-break-before:always;">
                    ...
                    <div class="row">
                        ...
                        <div style="margin-bottom: 20px; padding-left: 85px">
                            ...
                            <br>
                            4.	The Commissioner, Lower Assam Division, Guwahati-1 for kind information.
                            <br>
                    ...
                    <div class="col-lg-12" style="margin-top: 25px">
                        ...
                        <?php if(MB2_DIGITAL_SIGN_LIVE == 1): ?>
                            <button type="submit" id="minutesGenerateModalYes" class="rezaButt rezaDag">
                                <i class="fa fa-forward" aria-hidden="true"></i>&nbsp;&nbsp; Sign & Approve
                            </button>
                        <?php else : ?>
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : BASE_URL + '/SettlementMeetingControllerDc/listOfPendingMeetingIdsHardCode',
                type : 'POST',
                data : {
                    // circle       : circle,
                    // subdiv       : subdiv,
    ...
    $('#datatable').on('click', '.showMinutesGenerateModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/generateDigitalMinutesDcHardCode",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/digitalSignAndSavePdfHardCode",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document)
        .ready(function(){
            ...
            function saveDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "SettlementMeetingControllerDc/signedAndFinalApproveByDCHardCode",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
