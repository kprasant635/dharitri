                    ...
                    <table class="datatable table table-stripped table-bordered" id='datatable_reverted'>
                        ...
                        foreach ($meetings as $meeting):  $i++  ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo 'DEPT'; ?> </td>
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->meeting_id; ?>"
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/getRevertedProposalsAgainstMeetingId/?meetingId=<?php echo $meeting->meeting_id; ?>"
                                       class="rezaButt btn btn-sm " style="background-color :#4CAF50" >
                                        <i class="fa fa-eye" aria-hidden="true"></i> &nbsp;Meeting Details
                                    </a>
                                    <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/getRevertedCasesDeptAgainstMeetingId/?meetingId=<?php echo $meeting->meeting_id; ?>"
