                            ...
                            <div class="reza-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) { ?>                                            <?php if($caseDetails->status == MB_PENDING OR $caseDetails->status == MB_RE_REPORT OR $caseDetails->status == MB_REVERT OR $caseDetails->status == MB_UNDER_CONSIDERATION) :?>
                                        ...
                                        <?php if(DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                                            ...
                                            <?php if($caseDetails->status == MB_RE_REPORT OR $caseDetails->status == MB_REVERT): ?>
...
<script>
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    {
                        showErrorMessage("#MRPULL000659: There is modification request for this case by CO");
                    }
    ...
    $(document).on('click','#rejectedByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationRejectedByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#approveNrModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $('#approveNrModal').modal('hide');
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationApprovedByDcNr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    else if (data.responseType == 2)
                    {
                        $('.rezaButt').hide();
                        Swal.fire({
                            text: 'Application Forwarded To CO For NR case Settlement Process',
                            icon: 'success',
                        ...
                        window.location.href = baseurl+"SettlementApDc/viewAllApFirstProceedingDCCaseList";
                    }})
                    }
                    else if (data.responseType == 3)
                    {
                    ...
                    {
                        showErrorMessage("Applied area can't exceed total chitha area !");
                    }
                    else if (data.responseType == 101)
                    {
                        showErrorMessage(data.message);
                    }
                    else if (data.responseType == 99)
                    {
                        showErrorMessage(data.message);
                    }
                    else
    ...
    $(document).on('click','#approveByDcModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $('#approveByDcModal').modal('hide');
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationApprovedByDcAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#forwardedToDeptModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $('#forwardedToDeptModal').modal('hide');
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationForwardedToDeptAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementApDc/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementApDc/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#approveBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationApprovedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#rejectedBySdlacModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationRejectedBySdlac",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#revertFromSDLACToCoModalYes',function ()
    {
        ...
        if(remarks != '' && status != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/applicationRevertFromSDLACToCOAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
