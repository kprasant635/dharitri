                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr id="caseNoData">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementApDc/viewApprovedAppDetailsAp/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementApDc/viewRejectedAppDetailsAp/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementApDc/viewRejectedAppDetailsAp/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/updateProposalHearingDateAp",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/updateHearingDateGenerateNoticeAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementApDc/finalApproveTheProposalByDcAp",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    if (data.responseType == 1)
                    {
                        showErrorMessage(data.errCode + " There is some problem, Please try again");
                    }
                    else if (data.responseType == 2)
                    {
                        showErrorMessage("Data not found !");
