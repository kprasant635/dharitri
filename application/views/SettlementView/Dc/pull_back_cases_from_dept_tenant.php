...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB3 /
            <a href="<?= base_url()?>index.php/SettlementTenantUrbanDc/pullBackCasesFromDepartmentForDCTenant">
                Cases For Pull Back (Occupancy Tenant)
            </a>
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Pending Cases with Department for Pullback – Settlement of Occupancy Tenant </span>
                <hr>
            </div>
    ...
    <div class="modal-dialog custom-modal-width" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <br>
                <h5>
                    You want to Pull back the Case Number -
                    <br>
                    <br>
                    <b><span id="caseNumber"></span></b>
                    <br>
                    <br>
                ...
                <div class="row">
                    <div style="font-size: 17px; color: #EF5350; font-weight: bold; margin-top: 10px; margin-bottom: 10px">
                        <b>Note</b>:
                        Once you pull back the case, it can't be undone. !!
                    </div>
                </div>
            </div>
...
<script>
    ...
    $('#datatable').on('click', '.pullBackCasesModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementTenantUrbanDc/getPullBackCaseDetailsTenant",
            type: "post",
            dataType: "json",
    ...
    $('#pullBackCasesModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementTenantUrbanDc/finalPullBackRevertToCoSubmitTenant",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/SettlementTenantUrbanDc/pullBackCasesWithDeptPaginationAPITenant',
                type:'POST',
                data: {
