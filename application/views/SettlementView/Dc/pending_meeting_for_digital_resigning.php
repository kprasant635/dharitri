                        ...
                        <?php $i = 0;  foreach ($meetings as $meeting):  $i++  ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDc/getResigningProposalsAgainstMeetingId/?meetingId=<?php echo $meeting->id; ?>"
...
<script type="text/javascript">
    ...
    $('.showMinutesGenerateModal').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/generateResignDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/verifyAreaForResignMinutes",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCases(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDc/deleteProposalWithZeroCasesByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDc/digitalResignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "SettlementMeetingControllerDc/resignedFinalUpdatedMeetingByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
