                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if(FIRST_PAGE_ONLY_DC == 1) { ?>
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTeaDc/viewAllTeaFirstProceedingDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTeaDc/viewAllMarkAsSDLACListForDCTea'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTeaDc/getAllProposalListSdlacTea'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTeaDc/getAllSdlacMemberApprovalProposalListKhas'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <?php if(FIRST_PAGE_ONLY_DC == 0 OR FIRST_PAGE_ONLY_DC == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementTeaDc/getAllProposalForFinalVerification'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllUnderConSdlacTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllReReportAppByCOForDcAppTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllRevertedAppByDeptForDcAppTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllApprovedBySDLACListTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllRejectByDcListTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
                    ...
                    <!--                        </td>-->
                    <!--                        <td>-->
                    <!--                            <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementTeaDc/getAllOrderChithaUpdateForDcAppTea'; ?><!--" style="float:right">-->
                    <!--                                <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                            </a>-->
                    <!--                        </td>-->
                    <!--                    </tr>-->
