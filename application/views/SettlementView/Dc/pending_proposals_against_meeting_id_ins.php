...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB 3.0 /
            <a href="<?=base_url().'index.php/SettlementMeetingControllerDcIns/meetingLandPage'?>">Pending Meeting List </a>
            / Meeting Information
            <br>
            <br>
            <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/SettlementMeetingControllerDcIns/meetingLandPage'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
        </div>
...
<script type="text/javascript">
    ...
    function btnCaseView(propId)
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/viewCasesAgainstProposalNo",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/postAdditionalFileUnderMeetingDc",
                type: "post",
    ...
    {
        var redirect_url = BASE_URL + "/SettlementMeetingControllerDcIns/meetingLandPage";
        Swal.fire({
            backdrop:true,
            allowOutsideClick: false,
            icon: 'warning',
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/finalApproveOfMeetingDetail",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
