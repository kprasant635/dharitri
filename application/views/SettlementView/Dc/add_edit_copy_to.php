...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="font-size: 20px;">
            ...
            <!--                <a class="btn btn-sm btn-info pull-right" href="--><?//=base_url().'index.php/SettlementProposalController/commonProposalListView'?><!--"><i class="fa fa-backward"></i>&nbsp;Go Back</a>-->
            <!--            --><?php //} else if($this->session->userdata('user_desig_code') == MB_SUB_DIV_COMM) { ?>
            <!--                <a class="btn btn-sm btn-info pull-right" href="--><?//=base_url().'index.php/SettlementProposalSdoController/commonProposalListView'?><!--"><i class="fa fa-backward"></i>&nbsp;Go Back</a>-->
            <!--            --><?php //} ?>
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                ...
                <form method="post" action="<?=base_url().'index.php/SettlementCommonDc/saveCcData'?>">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-check mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php $hpcCount = 0; ?>
                                                        <?php if($isInserted == true): ?>
                                                            <?php foreach($inserted_data as $dtt): ?>
                                                                <?php if((trim($dtt->user_code) == trim($mp->user_code)) && ($dtt->user_level == '1')): ?>
                                                                    <?php $hpcCount = 1; ?>
                                                                    <?php if(trim($dtt->hpc_type) == 'HPC') : ?>
                                                                        <select name="hpcType<?=$j?>" id="" class="form-control">
                                                                            <option value="HPC" selected>HPC</option>
                                                                            <option value="Rajya Sabha">Rajya Sabha</option>
                                                                        </select>
                                                                    <?php elseif(trim($dtt->hpc_type) == 'Rajya Sabha') : ?>
                                                                        <select name="hpcType<?=$j?>" id="" class="form-control">
                                                                            <option value="HPC">HPC</option>
                                                                            <option value="Rajya Sabha" selected>Rajya Sabha</option>
                                                                        </select>
                                                                    <?php else: ?>
                                                                        <select name="hpcType<?=$j?>" id="" class="form-control">
                                                                            <option value="HPC">HPC</option>
                                            ...
                                            <div class="form-check mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <?php if($isInserted == true): ?>
                                                            <?php foreach($inserted_data as $dtt): ?>
                                                                <?php if((trim($dtt->user_code) == trim($mla->user_code)) && ($dtt->user_level == '2')) : ?>
                                                                    <?php $slNoCount = 1; ?>
                                                                    <select class="form-control" name="mlaSlNo<?=$i?>" id="">
                                                                        <?php if(trim($dtt->sl_no) != 0 ): ?>
                                                                            <option selected value="<?php echo $dtt->sl_no ?>"> <?php echo $dtt->sl_no?></option>
                                                                        <?php else:  ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($slNoCount == 0) : ?>
                                                            <select name="mlaSlNo<?=$i?>" id="" class="form-control">
                            ...
                            <!-- municipal board -->
                            <div class="container shadow-sm mt-3 rezaS">
                                <h5 class="reza-title">Municipal Board / Corporation</h5>
                                <div class="reza-body">
                                    <div class="row">`
                                        <?php $mm=0; foreach($usersdlc_list as $sdlc) { ?>
                                            ...
                                            <div class="col-3" style="margin-bottom: 15px">
                                                ...
                                                }?>" id="boardName" name="boardNameMunicipal<?= $sdlc->user_code?>" placeholder="Enter Board/Corporation Name">
                                            </div>
                                            <?php  $mm++; } ?>
