                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDcIns/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->id; ?>"
                                        ...
                                        <?php if($meeting->file_minute_path != '' && $meeting->file_minute_path != NULL): ?>
                                            <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDcIns/viewSdlacUploadedMinute/?meetingId=<?php echo $meeting->id; ?>"
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDcIns/viewSdlacAttendance/?meetingId=<?php echo $meeting->id; ?>"
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo base_url(); ?>index.php/SettlementMeetingControllerDcIns/getResigningProposalsAgainstMeetingId/?meetingId=<?php echo $meeting->id; ?>"
...
<script type="text/javascript">
    ...
    $('.showMinutesGenerateModal').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/generateResignDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/verifyAreaForResignMinutes",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCases(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/deleteProposalWithZeroCasesByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/digitalResignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "SettlementMeetingControllerDcIns/resignedFinalUpdatedMeetingByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
