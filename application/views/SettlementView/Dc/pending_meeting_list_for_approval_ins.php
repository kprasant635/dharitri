            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 25px">
                        ...
                        <?php if(MB3_DIGITAL_SIGN_LIVE == 1): ?>
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : BASE_URL + '/SettlementMeetingControllerDcIns/listOfPendingMeetingIds',
                type : 'POST',
                data : {
                    // circle       : circle,
                    // subdiv       : subdiv,
    ...
    $('#datatable').on('click', '.showMinutesGenerateModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/generateDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    function displayRecommendCases(data)
    {
        ...
        var fixed_header = '<tr>' +
            ...
            '<td style="background-color: white!important;  border: 1px solid black;  color: black!important; font-size: 12px; text-align: center; font-weight: bold">Dept/Ministry of</td>' +
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/verifyArea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCasesPendingMeeting(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/deleteProposalWithZeroCasesForPendingMeetingByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function revertBulkToCOForHoldCases(revertCasesBulk)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementCommonIns/bulkRevertCasesForHoldDeptCases",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        // });
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/digitalSignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $('#datatable').on('click', '.revertBackMeetingModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementMeetingControllerDcIns/getRevertBackMeetingDetails",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
                ...
                {
                    window.location.href = baseurl+"SettlementMeetingControllerDcIns/getVgrPgrCasesForRevertDc/"+data.meetingId;
                }
                else
                {
                    showErrorMessage("SOMETHING WENT WRONG");
    ...
    $('#revertBackMeetingModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementMeetingControllerDcIns/revertBackMeetingToAdcSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "SettlementMeetingControllerDcIns/signedAndFinalApproveByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
