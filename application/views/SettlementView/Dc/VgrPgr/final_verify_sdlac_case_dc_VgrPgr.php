...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB / <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/SettlementVgrPgrLandDc">PGR VGR</a>
            / <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/getAllProposalForFinalVerification">Cases For Final Verification By DC</a>


            <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/getAllProposalForFinalVerification">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr id="caseNoData">
                                ...
                                <?php if($case->status == PRO_CASE_STATUS_PENDING) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/getSettlementVgrPgrApplicationDetails/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/viewApprovedAppDetailsVgrPgr/?case=<?php echo $case->case_no; ?>&proposal=<?=$proposal_no?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/viewRejectedAppDetailsVgrPgr/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementVgrPgrDc/viewRejectedAppDetailsVgrPgr/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
...
<script>
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/updateProposalHearingDateKhas",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (proposalNo != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/updateHearingDateGenerateNoticeKhas",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#finalVerifyModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/finalApproveTheProposalByDcVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    else if (data.responseType == 3)
                    {
                        ...
                        Swal.fire({
                            icon: 'warning',
                            text: 'Proposal successfully Forwarded to DC for Final Verification !',
