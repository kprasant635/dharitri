...
<div class="container">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        / <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/getAllApplicationInSdlacReportForVerifyPgrVgr/?case=<?=$_GET['proposal']?>">Verify</a> / View

        <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/getAllApplicationInSdlacReportForVerifyPgrVgr/?case=<?=$_GET['proposal']?>">
        ...
        <section>
            <div class="wizard">
                ...
                <div class="tab-content">
                    ...
                    <?php
                    include(APPPATH."views/SettlementView/include/applicationVgrView.php");
                    ?>
