        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                    Marked Application Send To SDLAC
                </h5>
            </div>
...
<script>
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/generateNoticeSendAllMarkAppToSDLACByDcVgrPgr",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
