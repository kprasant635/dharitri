...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/SettlementVgrPgrDc/SettlementVgrPgrLandDc">
                        ...
                        <?php if(FIRST_PAGE_ONLY_DC == 1) { ?>
                            <tr>
                                ...
                                <td style="width: 200px" >
                                    <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrDc/viewAllVgrPgrFirstProceedingDCCaseList'; ?>" style="float:right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrDc/viewAllMarkAsSDLACListForDCVgrPgr'; ?>" style="float:right">
                                        <i class="fa fa-eye"></i>&nbsp;view
                                    </a>
                                </td>
                            </tr>
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllUnderConSdlacVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrDc/getAllProposalListSdlacVgrPgr'; ?>" style="float:right">
                                        <i class="fa fa-eye"></i>&nbsp;view
                                    </a>
                                </td>
                            </tr>
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllReReportAppByCOForDcAppVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllRevertedAppByDeptForDcAppVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllApprovedBySDLACListVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllRejectByDcListVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
...
<!--                                </td>-->
<!--                                <td>-->
<!--                                    <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementVgrPgrDc/getAllOrderChithaUpdateForDcAppVgrPgr'; ?><!--" style="float:right">-->
<!--                                        <i class="fa fa-eye"></i>&nbsp;view-->
<!--                                    </a>-->
<!--                                </td>-->
<!--                            </tr>-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrDc/getAllSdlacMemberApprovalProposalListVGR'; ?>" style="float:right">
                                        <i class="fa fa-eye"></i>&nbsp;view
                                    </a>
                                </td>
                            </tr>
                        ...
                        <?php if(FIRST_PAGE_ONLY_DC == 0 OR FIRST_PAGE_ONLY_DC == 1) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementVgrPgrDc/getAllProposalForFinalVerification'; ?>" style="float:right">
                                        <i class="fa fa-eye"></i>&nbsp;view
                                    </a>
                                </td>
                            </tr>
