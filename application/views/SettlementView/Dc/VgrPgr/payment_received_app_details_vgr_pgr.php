                ...
                <?php 
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        ...
                        <h5 class="bg-info p-2 text-white shadow">
                            Registration of <?php echo $this->lang->line('pgrVgrTitle')?> (
                    ...
                    <div class="tab-pane" role="tabpanel" id="proceedings">
                        ...
                        <br>
                        <h5 class="bg-info p-2 text-white shadow">
                            Proceeding of <?php echo $this->lang->line('pgrVgrTitle')?> (
...
<script>
    ...
    $(document).on('click','#orderForChithaUpdateModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementVgrPgrDc/orderToCoByDcForChithaUpdating",
                type: "post",
                dataType: "json",
