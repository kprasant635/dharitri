  ...
  <div class="card-content shadow-sm">
    <div class="card-body">
      ...
      <div class="text-right">
        <a href="<?php echo base_url()?>index.php/SettlementVgrCo/printNotice?case_no=<?=$_GET['case']?>" target="GenerateNotice"><button type="button" name="print_notice" type="button" class="m-1 col-1 text-white btn btn-warning btn-sm">Print Notice</button>
        </a>
      </div>
    ...
    <?php } ?>
      ...
      <div class="card-text mt-2 co-report">
        <form
          method="post"
          action="<?php echo base_url()?>index.php/SettlementVgrCo/generatePaymentNoticeCoSave"
          id="formNotice"
        >
