...
<style>
    ...
    .close-enc-modal-lm:hover,
    .close-enc-modal-lm:focus {
        color: #000;
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <div class="reza-card">
                            <div class="reza-body">
                                                ...
                                                <li >
                                                    ...
                                                    <ul style="padding-bottom: 20px!important;">
                                                        ...
                                                        <span class="badge " style="padding: 5px; font-size: 14px; background-color: #6f42c1">
                                                            ...
                                                            &nbsp; LM Processed Area In In this Dag
                                                        </span>

                                                            <?php foreach ($lmProcessArea as $singleReservedArea): ?>
                                                                <?php if ($singleChithaArea->dag_no == $singleReservedArea->dag_no): ?>
                                                                    <ul>
                                                                        <li>
                                                                        <span class="rezaCaseSpan">
                                ...
                                <?php
                                //include(APPPATH."views/SettlementView/include/vgrReservation.php");
                                ?>
                                ...
                                if($user_desig_code == 'SK')
                                {
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <form method="post" action="<?php echo base_url()?>index.php/SettlementTeaCo/generateNoticeCo" name="sk_form_sub">
                                ...
                                else
                                {
                                    ...
                                    <?php
                                    if(isset($checkReserv))
                                    {
                                        if($checkReserv['responseType'] != 2)
                                        {
                                            echo $checkReserv['msg'];
                                        }
                                    }
                                    ?>
                                    <?php
                                    if($basic['status'] != 'AA' && $basic['status'] != 'AB'){
                                        if(isset($lmnotes)):
                                            if($lmnotes):
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-check form-check-inline">
                                                                        <input
                                                                                ...
                                                                                id="reservation_vgr"
                                                                                onclick="getLotsInCircle('<?=$basic['dist_code']?>','<?=$basic['subdiv_code']?>','<?=$basic['cir_code']?>','<?=$basic['vill_townprt_code']?>');"
                                                                                value="RESERVATION"
                                        ...
                                        if($validation_bypass == 1)
                                        {
                                            ...
                                            <div class="row justify-content-center mb-5">
                                                <div class="col-md-8">
                                                    ...
                                                    {
                                                        ?>
                                                        <button onclick="return rejectSubAlert()" type="button" class="btn btn-danger btn-sm" name="">Agree with Rejection</button>
                                        ...
                                        <div class="tableCard">
                                            <div class="mt-4 row px-5 justify-content-center">
                                                <div class="col-md-9">
                                                    ...
                                                    <select id="remark_co_v" onchange="autoRemark();" class="form-control">
                                                        <?php
                                                        foreach(json_decode(CO_NOTE) as $co_note){
                                                            ...
                                                            ?>
                                                            <option value="<?=$co_note->CODE?>"><?=$co_note->NAME?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select> <br>
                                                    <textarea placeholder="Remarks  ..." id="remark_co_text_v" class="form-control p-2" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center" style="margin-top: 20px; margin-bottom:50px">
                                                ...
                                                ?>
                                                <button type="submit" name="revert_to_lm" onclick="lm_Revert()" class="m-1 col-2 btn btn-danger btn-sm" id="lm_revert_btn" disabled>Revert Back to LM</button>

                                                <?php if(SEND_TO_OTHER_LM_VGR != 0){?>
                                                    <button type="button" onclick="sendToOtherLm('<?=$_GET['case']?>')" class="btn m-1 col-3 btn-warning btn-sm">Send to other LM for Reservation</button>
                                                <?php }?>

                                                <?php
                                                // if($case_from == 'upper_office')
                                                // {
                                                ?>

                                                <!-- <input type="button" name="forward_to_dc" onclick="dc_forward('<?php // echo $_GET['case'];?>')" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" disabled value="Forward"> -->
                                                ...
                                                if($meetingRevertedCase == true)
                                                {
                                                    ?>

                                                    <button onclick="forwardRevertedCase('<?=$_GET['case']?>')" type="button" class="btn m-1 col-2 btn-primary btn-sm" id="forwardToVillage" disabled>Forward</button>
                                                ...
                                                {
                                                    ?>
                                                    <button onclick="putIntoVillageClust('<?=$_GET['case']?>')" type="button" class="btn m-1 col-2 btn-primary btn-sm" id="forwardToVillage" disabled>Forward to Village Cluster</button>
                                                    <?php
                                                }
                                                ?>
                                                <?php
                                                ...
                                                {
                                                    ?>
                                                    <button onclick="return rejectSubAlert()" type="button" class="col-2 btn btn-danger m-1 btn-info-full btn-sm">Reject</button>
                                                    <?php
                                                } ?>
                                    ...
                                    else
                                    {
                                        if($basic['status'] == 'AA'):
                                            ?>
                                            <div class="tableCard alert-success text-center" style="padding-bottom: 15px">
                                                <b>Case forwarded to Village Cluster.</b>
                                            </div>
                                        <?php
                                        endif;
                                        if($basic['status'] == 'AB'):
                                            ?>
                                            <div class="tableCard alert-success text-center" style="padding-bottom: 15px">
                                                <b>Case forwarded LM for VGR/PGR Reservation.</b>
                                            </div>
                                        <?php
                                        endif;
                                    }
                                    ...
                                    <div class="tableCard " style="padding: 25px!important;">
                                        <?php foreach ($premium_data as $dagsprem) {?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" id="prem_area" class="form-control" name='area<?=$dagsprem->dag_no?>' value="<?=$dagsprem->area?>" readonly>
...
<script>
    ...
    function autoRemark(){
        ...
        var remark_val = $.trim($('#remark_co_v').val());
...
<script>
    ...
    $(document).on('click','#reverttolm',function ()
    {
        $("#lm_revert_btn").removeAttr("disabled");
        $("#frwrd_dc_btn").attr("disabled", true);
    });
    $(document).on('click','#frwrdtodc',function ()
    {
    ...
    $(document).on('click','#frwrdtodc',function ()
    {
        $("#forwardToVillage").removeAttr("disabled");
        $("#lm_revert_btn").attr("disabled", true);
    });
...
<script>
    function putIntoVillageClust(case_no)
    {
        var reservation =  $("input[name='re_dereservation']:checked").val();

        let remark_co = $('#remark_co_v').val();
        let remark_co_text = $('#remark_co_text_v').val();

        if (remark_co == -1) {
            alert("Select remark category.");
            $("#remark_co_v").focus();
            return false;
        }
        if (remark_co_text == "") {
            alert("Enter remark.");
            $("#remark_co_text_v").focus();
            return false;
        }
        ...
        $.ajax({
            url: baseurl+'SettlementVgrCo/putInVillageCluster',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
...
<script>
    function lm_Revert(){
        ...
        $.ajax({
            url: baseurl+'SettlementVgrCo/coRevertedLm',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
...
<div id="otherLmModal" class="modal-lm">

    <!-- Modal content -->
    <div class="modal-content-lm">
        <div class="row text-right">
            <span class="close-enc-modal-lm px-4">&times;</span>
        </div>
        <h5 id="head_label_lm"></h5>

        <div class="container px-5" id="other_lms" style="border: 1px solid #CED4DA;">
        </div>
    </div>
...
<script>
    ...
    var modal_lm = document.getElementById("otherLmModal");
    // Get the button that opens the modal_vgr
    var btn = document.getElementById("myBtn");
    // Get the <span> element that closes the modal_vgr
    var span_lm = document.getElementsByClassName("close-enc-modal-lm")[0];

    span_lm.onclick = function() {
        // checkIfRserveDataInserted();
        modal_lm.style.display = "none";
        // table.destroy();
    }

    // When the user clicks anywhere outside of the modal_vgr, close it
    window.onclick = function(event) {
        if (event.target == modal_lm) {
            // checkIfRserveDataInserted();
            modal_lm.style.display = "none";
            // table.destroy();
        }
    ...
    function sendToOtherLm(case_no)
    {
        var postData = {
            'case_no': case_no
        }
        ...
        $.ajax({
            url: baseurl+'SettlementVgrCo/otherLmList',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
                ...
                {
                    //show modal with others LM in circle here
                    modal_lm.style.display = "block";

                    $('#head_label_lm').html('<h5 class="pl-5"><u>LM list of this Cicle</u></h5>');

                    var options = '<option value="">Select LM...</option>';

                    for(i=0; i<arr.content.length; i++)
                    {
                        options += "<option value='"+arr.content[i].user_code+"_"+arr.content[i].dist_code+"_"+arr.content[i].subdiv_code+"_"+arr.content[i].cir_code+"_"+arr.content[i].mouza_pargona_code+"_"+arr.content[i].lot_no+"'>"+arr.content[i].lm_name+" ("+arr.content[i].loc_name+")</option>";
                    }

                    $('#other_lms').html("<div class='row justify-content-center mt-3'>"+
                        "<div class='col-md-11'><select class='form-control' id='lmSelected'>"+options+"</select></div>"+
                        "</div>"+
                        "<div class='row justify-content-center mt-3'>"+
                        "<div class='col-md-11'><textarea class='form-control p-2' rows='5' id='remark_other_lm' placeholder='Please enter remark...'></textarea></div>"+
                        "</div>"+

                        "<div class='row justify-content-center mt-4 mb-5'>"+
                        "<button type='button' onclick=\"sendToLmSub(\'"+case_no+"\')\" class='btn btn-primary btn-sm col-5'>send</button>"+
                        "</div>");
    ...
    function sendToLmSub(case_no)
    {
        var lm_data = $('#lmSelected').val();
        var splited_data = lm_data.split('_');

        var lm_code = splited_data[0];
        var dist_code = splited_data[1];
        var subdiv_code = splited_data[2];
        var cir_code = splited_data[3];
        var mouza_pargona_code = splited_data[4];
        var lot_no = splited_data[5];

        var remark_other_lm = $('#remark_other_lm').val();

        if(lm_data == '')
        {
            alert('Please select LM!');
            return false;
        }
        ...
        $.ajax({
            url: baseurl+'SettlementVgrCo/sendToOtherLm',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
...
<script>
    function dc_forward(case_no)
    {

        var remark_co_v = $('#remark_co_v').val();
        var remark_co_text_v = $('#remark_co_text_v').val();

        var postData = {
            'case_no': case_no,
            'remark_co': remark_co_v,
            'remark_co_text' : remark_co_text_v,
        }
        ...
        $.ajax({
            url: baseurl+'SettlementVgrCo/directForwardToDc',
            type: "POST",
            data: postData,
            success: function(data) {
                $.unblockUI();
...
<script>
    function forwardRevertedCase(case_no)
    {
        var remark_co_v = $('#remark_co_v').val();
        var remark_co_text_v = $('#remark_co_text_v').val();
