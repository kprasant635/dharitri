            ...
            <div class="wizard">
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs shadow" id="myTab" role="tablist">
                        <li role="presentation" <?php if($state!='active'){ echo 'class="active"' ;} ?>>
                            <a
                                    class="test"
                                    href="#step1"
                                    data-toggle="tab"
                ...
                <div class="tab-content">
                    <div class="tab-pane <?php if($state!='active'){ echo 'active' ;} ?>" role="tabpanel" id="step1">
                    ...
                    <div class="tab-pane <?php if($state=='active'){ echo 'active' ;} ?>" role="tabpanel" id="step3">
                        ...
                        <div class="reza-card">
                            <div class="reza-body">
                                ...
                                <?php  if($proceedings){ ?>
                                    ...
                                    <div class="tableCard ">
                                        <table class="table table-bordered">
                                            ...
                                            <?php foreach($proceedings as $remarks) :if ($i==1){?>
                                                <tr>
                                                    <td><?=$remarks->date_entry?></td>
                                                    <td><?=$remarks->office_from?></td>
                                                    <td><?=$remarks->office_to?></td>
                                                    <td><span class="text-success"><?=$remarks->note_on_order?></span></td>
                                                </tr>
                                            <?php } $i++; endforeach;?>
                                        </table>
                                    </div>
                                ...
                                <?php
                                include(APPPATH."views/SettlementView/include/areaModifiedAp.php");
                                ?>
                                ...
                                {
                                    ?>
                                    <h5  class="reza-title" style="margin-top: 1px">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <form method="post" action="<?php echo base_url()?>index.php/settlementApCo/generateNoticeCo" name="sk_form_sub">
                                ...
                                else
                                {
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        <?php //include(APPPATH."views/SettlementView/include/areaEditView.php");?>

                                        <?php
                                        $pending_officer = $basic["pending_officer"];
                                        $from_office = $basic["from_office"];
                                        ?>
                                        <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url()?>index.php/SettlementApCo/generateNoticeCo">
                                            <input type="hidden" id="case_no" name="case_no" value="<?=$_GET['case']?>">

                                            <input type="hidden" id="notice_generated_date" name="notice_generated_date" value="<?=$basic['notice_generated_date']?>">
                                            ...
                                            <div class="mt-4 row px-5">
                                                <div class="col-md-3">
                                                    <?php
                                                    if(($basic['notice_generated_yn'] != 'Y') && ($pending_officer != 'LM' && $from_office != 'CO') && ($pending_officer != 'DC' && $from_office != 'CO') && $validation_bypass == 0){
                                                        ?>

                                                        <label for="">Select hearing date</label>
                                                        <input type="hidden" name="case_no" value="<?=$_GET['case']?>">
                                                        <input type="text" autocomplete="off" placeholder="Please select date" class="hearing_date form-control date" id="popup1Datepicker" name="hearing_date" />

                                                    <?php }

                                                    if(($basic['status'] == 'R' || $basic['notice_generated_yn'] == 'Y') && $validation_bypass == 0):
                                                        ?>
                                                        <label for="">Re-select hearing date</label>
                                                        <input type="hidden" name="case_no" value="<?=$_GET['case']?>">
                                                        <input type="text" autocomplete="off" placeholder="Please select date" class="hearing_date form-control date" id="popup1Datepicker" name="hearing_date" />
                                                    <?php
                                                    endif;
                                                ...
                                                <div class="col-md-9">
                                                    <?php if($pending_officer == 'CO' || $pending_officer == 'SK'){
                                                        if ($lm_report!='no') {
                                                            ?>
                                                    ...
                                                    <?php if(($basic['notice_generated_yn'] == 'Y' && $lm_report=='yes') || $validation_bypass == 1){ ?>

                                                        <?php if(ENABLE_BUTTON_CO_TO_DC_AP != 0 && ($basic['notice_generated_yn'] == 'Y' || $validation_bypass == 1) && ($pending_officer == 'CO' || $pending_officer == 'SK')){ ?>
                                                            <label class="control-label">
                                                        ...
                                                        <select name="remark_co_type" id="remark_co" onchange="autoRemark();" class="form-control">
                                                            ...
                                                            <!-- <option value="Case forwarded to DC for NR">Case forwarded to DC for NR</option>
                                                            <option value="Case forwarded to DC for Settlement">Case forwarded to DC for Settlement</option> -->
                                                    ...
                                                    if(($basic['notice_generated_yn'] != 'Y') && ($pending_officer != 'LM' && $from_office != 'CO') && ($pending_officer != 'DC' && $from_office != 'CO') && $validation_bypass == 0){
                                                        if ($lm_report!='no') {
                                                            ...
                                                            <select name="remark_co_type" id="remark_co" class="form-control">


                                                                <?php
                                                                foreach(json_decode(CO_NOTE) as $co_remark_cat){
                                                                    if($co_remark_cat->CODE==-1 || $co_remark_cat->CODE==3){
                                                                        ?>
                                                                        <option value="<?=$co_remark_cat->CODE?>" <?php if(set_value('lm_note') == $co_remark_cat->CODE){ echo "selected"; }?>><?=$co_remark_cat->NAME?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                                ?>
                                                                ...
                                                                <!-- <option value="">Select remarks...</option>
                                                                <option value="Revert to LM">Revert to LM</option> -->
                                            ...
                                            <div class="row mt-4 justify-content-center">
                                                ...
                                                <?php
                                                if(ENABLE_BUTTON_CO_TO_DC_AP != 0){
                                                    if($basic['notice_generated_yn'] == 'Y'){ ?>

                                                        <button type="submit" name="print_notice" formtarget="GenerateNotice" type="button" class="m-1 col-2 text-white btn btn-info btn-sm"><i class="fa fa-print"></i> Print/View Notice</button>

                                                    <?php }elseif(($basic['notice_generated_yn'] != 'Y' && ($pending_officer != 'LM' && $from_office != 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) && $validation_bypass == 0){ ?>

                                                        <button type="submit" name="generate_notice" formtarget="GenerateNotice" type="button" class="m-1 col-2 text-white btn btn-warning btn-sm" onclick="return coForm()">Generate Notice</button>
                                                        <button onclick="return rejectSubAlert()" id="reject_button_direct" type="button" class="col-2 btn btn-danger m-1 btn-info-full btn-sm">Reject</button>
                                                    <?php }
                                                    if(((($basic['status'] == 'R' || $basic['status'] == 'X') && $basic['notice_generated_yn'] == 'Y' && ($pending_officer == 'CO' || $pending_officer == 'SK') && $from_office == 'LM') || ($basic['status'] == 'W' && ($pending_officer == 'CO' || $pending_officer == 'SK') && $basic['notice_generated_yn'] == 'Y')) && $validation_bypass == 0):
                                                        ?>
                                                        <!--                                                        <button type="submit" name="re_generate_notice" formtarget="GenerateNotice" type="button" class="m-1 col-2 text-white btn btn-warning btn-sm" onclick="return coForm()">-->
                                                        <!--                                                            <i class="fa fa-refresh" aria-hidden="true"></i> <b> Re-generate Notice </b>-->
                                                        <!--                                                        </button>-->


                                                        <button type="button" class="m-1 col-2 text-white btn btn-warning btn-sm" id="unMarkAsSDLAC">
                                                            <i class="fa fa-refresh" aria-hidden="true"></i> <b> Re-generate Notice </b>
                                                        </button>
                                                            ...
                                                            <div class="modal-dialog " role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" align="center">
                                                                        <i class="fa fa-info-circle" aria-hidden="true" style="font-weight: bold; font-size: 85px; color: #FF8A65"></i>
                                                                        <br>
                                                                        <h3>You already have generated notice before !</h3>
                                                                        <br>
                                                                        <h5>Do you want to Re-generate Notice for this same application </h5>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"  id="unMarkAsSDLACModalNo">Close</button>
                                                                        <button type="submit" id="unMarkAsSDLACModalYes" name="re_generate_notice" formtarget="GenerateNotice" type="button" class=" btn btn-primary " onclick="return coForm()">
                                                                            <i class="fa fa-refresh" aria-hidden="true"></i> <b> Re-generate </b>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <?php if(($pending_officer == 'CO' || $pending_officer == 'SK')){
                                                    if ($lm_report!='no') {
                                                        ...
                                                        <button type="submit" name="revert_to_lm" onclick="return lm_Revert()" class="m-1 col-2 btn btn-danger btn-sm" id="lm_revert_btn" disabled>Revert Back to LM</button>
                                                    <?php } } ?>
                                                ...
                                                if(ENABLE_BUTTON_CO_TO_DC_AP != 0){
                                                    ...
                                                    //first process from co to DC for NR settlement
                                                    if(($pending_officer == 'CO' && $from_office == 'LM' && $basic['notice_generated_yn'] == 'Y' && $basic['status'] == MB_PENDING)){ ?>
                                                        <!-- <button type="submit" name="forward_to_dc" onclick="return dc_forward()" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" id="frwrd_dc_btn" disabled>Forward</button> -->
                                                    <?php }

                                                    //second process from co to SDO/ADC
                                                    if(($pending_officer == 'CO' && $from_office == 'DC'
                                                        && $basic['status'] == 'Y')){ ?>
                                                        <!-- <button type="submit" name="forward_to_dc" onclick="return dc_forward()" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" id="frwrd_dc_btn" disabled>Forward</button> -->

                                                    <?php }

                                                    if(isset($sdo_user_check) && $sdo_user_check == 'y'){

                                                        if($basic['notice_generated_yn'] == 'Y' || $validation_bypass == 1){
                                                            if($pending_officer == 'CO' || $pending_officer == 'SK'){ ?>
                                                                <button type="submit" name="forward_to_dc" onclick="return dc_forward()" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" id="frwrd_dc_btn" disabled>Forward</button>
                                                                ...
                                                                <!-- <button type="submit" name="forward_to_dc" onclick="return dc_forward()" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" id="frwrd_dc_btn" disabled>Forward3</button> -->
                                                            <?php } }else{?>
                        ...
                        <div class="tab-pane" role="tabpanel" id="premium">
                            ...
                            <div class="reza-card ">
                                <div class="reza-body">
                                    ...
                                    <h5 class="reza-title" style="margin-top: 15px">
                                        <i class="fa fa-history" aria-hidden="true"></i> Premium Calculation
                                    </h5>
...
<script>
    ...
    function lm_Revert(){
        ...
        //let remark_co_text = document.forms["co_form_sub"]["remark_co"].value;
    ...
    function dc_forward(){
        ...
        //let remark_co_text = document.forms["co_form_sub"]["remark_co"].value;
        let remark_co_text =  $("#remark_co_text").val();
        let notice_generated_date = '<?php echo date('Y-m-d', strtotime($basic['notice_generated_date']))?>';
        curr_date = '<?php echo date('Y-m-d')?>';

        const x = new Date(notice_generated_date);
        const y = new Date(curr_date);
        ...
        if(diffDays>30){
            ...
            showErrorMessage('Unable to forward the case due to notice generated date is less than 30!!!');
            $("#frwrd_dc_btn").hide();
            return false;
                ...
                success: function(data) {
                    ...
                    if(arr.responseType == 0){
                        ...
                        for(i=0; i<arr.area.length; i++){
                            var areaData = " "+arr.area[i].s_dag_area_b +"B "+ arr.area[i].s_dag_area_k +"k "+ arr.area[i].s_dag_area_lc +"L covered by Dag no " +arr.area[i].dag_no+ " Annual patta/Short lease patta No "+arr.area[i].patta_no;
                        ...
                        if(arr.isUrban == 'Y'){
                            $('#remark_co_text').val("Perused LM report.  Checked all the documents submitted by the applicant and are found in order. \n\nLand measuring "+finalArea+" of Revenue village "+villageName+" of mouza "+ mouzaName +" under "+ circleName +" Revenue Circle falls "+$('#prem_area').val()+" has been transferred to the applicant by registered agreement /kutcha affidavit in violation of section 11 of ALRR 1886.  Hence, proceeding for non-renewal has been initiated for cancellation of Annual patta/Short lease, thereby making the transferred land Government land as per Notification No RDM-12011(17)/5/2022-LR-REV-R&D/96 , Dated  11-Nov-2022; issued by  Revenue and Disaster  Management Department , Assam. \n\nForwarded for perusal and consideration.");
                        }
                        else if(arr.isUrban == 'N')
                        {
                            $('#remark_co_text').val("Perused LM report. Checked all the documents submitted by the applicant. Land is in rural area. Land measuring "+finalArea+" of revenue village "+villageName+" of mouza "+ mouzaName +" under "+ circleName +" revenue circle has been transferred to the applicant by registered agreement /kutcha affidavit in violation of rules as provided in section 11 of ALRR 1886.  Hence proceeding for non-renewal has been initiated for making the transferred land Government as per provision read with Government instruction vide Notification No RDM-12011(17)/5/2022-LR-REV-R&D/96, Dated 11-No-2022; issued by Revenue and Disaster Management Department, Assam. \n\nForwarded for kind consideration.");
                        }
                    }
                }
            });
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb2(''+case_no+'','<?php echo SETTLEMENT_AP_TRANSFER_ID ?>');
