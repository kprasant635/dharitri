  ...
  <div class="card-content shadow-sm">
    <div class="card-body">
      ...
      <div class="text-right">
        <a href="<?php echo base_url()?>index.php/SettlementTenantCo/printNotice?case_no=<?=$_GET['case']?>" target="GenerateNotice"><button type="button" name="print_notice" type="button" class="m-1 col-1 text-white btn btn-warning btn-sm">View Notice</button>
        </a>
      </div>
    ...
    <?php } ?>
      ...
      <div class="card-text mt-2 co-report">
        <form
          method="post"
          action="<?php echo base_url()?>index.php/SettlementTribalCo/generatePaymentNoticeCoSave"
          id="formNotice"
        >
        <div class="row">
          ...
          <div class="row mt-4 justify-content-center">
            ...
            { 
                if($basic->pay_notice_gen_yn != 'Y') 
                {
                    ...
                    if($old_dag_flag_message != false) 
                    {
                        echo $old_dag_flag_message;
                        echo $old_dag_flag_button;
                    }
                    else
                    {
                        if($concessionCheck != false)
                        {
                            echo $concessionCheck;
                            echo $concessionRecalculate;
                        }
                        else
                        {
                            ?>
