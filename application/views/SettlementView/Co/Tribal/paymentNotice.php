...
<html class="no-js">
   ...
   <body style="background:none!important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementTribalCo/savePaymentNotice" method="post" enctype='multipart/form-data'>
            ...
            <div class="container bg-white shadow" id="print_direct">
               <div class="row mt-5 text-center">
                  <div class="col-12 text-center" style="font-size: 18px; font-weight:bold;">
                     <u>প্ৰিমিয়াম আদায়ৰ বাবে জাননী</u>                
                  </div>
               </div>
               <div class="row mt-4">
                  <div class="col-12 text-justify p-5">
                     ...
                     <b><?=$this->utilityclass->getVillageName($get_settlement_basic->dist_code,$get_settlement_basic->subdiv_code,$get_settlement_basic->cir_code,$get_settlement_basic->mouza_pargona_code,$get_settlement_basic->lot_no,$get_settlement_basic->vill_townprt_code)?> </b> গাঁৱৰ, 
                     <?php
                        $dag_position = 0;
                        ...
                        ?>
                           চিলিং চৰকাৰী/সাধাৰণ চৰকাৰী মাটিৰ বিশেষ খেতিৰ  পট্টনৰ বাবে আপোনাৰ আবেদন প্ৰস্তাৱ নং <b><?=$case_no?></b> ত, অনুমোদন জনোৱা হৈছে৷  সেই অনুসৰি উক্ত জমি প্ৰিমিয়াম আদায় ক্ৰমে আপোনাৰ নামত পট্টনৰ বাবে কৰ্তৃপক্ষই বিবেচনা কৰিছে।<br><br>
                           সেইসূত্ৰে আপোনাক <b><?=$premium_data[0]->final_amount;?></b> টকাৰ প্ৰিমিয়াম অহা ১৫ দিনৰ ভিতৰত  আদায় দিবলৈ অনুৰোধ জনোৱা হ'ল।
