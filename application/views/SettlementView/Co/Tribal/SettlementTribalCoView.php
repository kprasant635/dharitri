        ...
        <section>
            <div class="wizard">
                ...
                <div class="tab-content">
                    <?php
                    include(APPPATH."views/SettlementView/include/applicationTribalLmView.php");
                    ?>
                        ...
                        <div class="reza-body">
                            ...
                            if($user_desig_code == 'SK')
                            {
                                ...
                                <div class="tableCard" style="padding-bottom: 15px">
                                    ...
                                    <form method="post" action="<?php echo base_url()?>index.php/SettlementTribalCo/generateNoticeCo" name="sk_form_sub">
                            ...
                            else
                            {
                                ...
                                <div class="tableCard ">
                                    ...
                                    $from_office = $basic["from_office"];
                                    ?>
                                    <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url()?>index.php/SettlementTribalCo/generateNoticeCo">
                                        ...
                                        <div class="mt-4 row px-5">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <textarea placeholder="Remarks  ..." name="remark_co_text" id="remark_co_text" class="form-control" id="remark_co" cols="30" rows="3" required></textarea>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            ...
                                            <?php if(ENABLE_BUTTON_CO_TO_DC_TRIBAL != 0){ ?>

                                                <?php if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                                                    <button type="submit" onclick="return lm_Revert();" id="lm_revert_btn" name="revert_to_lm" class="m-1 col-2 btn btn-danger btn-sm" disabled>Revert Back to LM</button>
                                                <?php }else{ ?>
                                                    <button type="submit" onclick="return lm_Revert();" id="lm_revert_btn" name="revert_to_lm" class="m-1 col-2 btn btn-danger btn-sm">Revert Back to LM</button>
                                                <?php }

                                                if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                                                    <button type="submit" name="forward_to_dc" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" disabled>Forward</button>
                                                    ...
                                                    ?>
                                                    <button type="submit" name="forward_to_dc" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm">Forward</button>
                                                <?php } ?>
                                            <?php } ?>
                                            <!-- <button type="submit" name="re_geo_tag" class="m-1 col-2 btn btn-warning btn-info-full btn-sm">Re-report Geo Tag</button> -->
                ...
                <?php if(!empty($premium_data)) { ?>
                    <div class="tab-pane" role="tabpanel" id="premium">
                        ...
                        <h5 class="bg-info p-2 text-white shadow" style="margin-top: 10px">
                            <?php echo $this->lang->line('settlementTribalCommunityTitle')?> (
                                ...
                                <div class="tableCard " style="padding: 25px!important;">
                                    <?php foreach ($premium_data as $dagsprem) {?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" name='area<?=$dagsprem->dag_no?>' value="<?=$dagsprem->area?>" readonly>
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb2(''+case_no+'','<?php echo SETTLEMENT_TRIBAL_COMMUNITY_ID ?>');
