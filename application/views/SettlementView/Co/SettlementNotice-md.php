...
<?phpinfo?>
    ...
    <form action="<?php echo base_url()?>index.php/SettlementApCo/saveNotice" method="post">
        ...
        <div class="container bg-white shadow" id="printableArea">
        ...
        <div class="container">
                <div class="row mt-4 mb-5 text-center">
                    <div class="col-6">
                        <button type="submit" class="btn btn-danger text-white">Save and print notice</button>
                    </div>
                    <!-- <div class="col-6 text-left">
                        <button onclick="printDiv('printableArea')" class="btn btn-danger text-white">Print Notice</button>
                    </div> -->
                </div>
            </div>
    </form>
