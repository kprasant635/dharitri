          ...
          <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="step1">
              <h5 class="bgheading p-2 text-white shadow">
                Registration of SETTLEMENT TRIBAL COMMUNITIES (
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h5 class="card-title text-white bgheading p-2 text-center shadow-sm">Area Details</h5>
                  <p class="card-text">
                    <table class="table table-bordered">
        ...
        <form method="post" action="<?php echo base_url()?>index.php/SettlementApCo/generateNoticeCo">
          <div class="mt-4 row px-5">
              <div class="col-md-3">
                ...
                <input type="text" autocomplete="off" class="form-control date" id="enable_next_date" name="hearing_date" required />
