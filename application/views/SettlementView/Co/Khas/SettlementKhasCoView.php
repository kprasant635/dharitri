...
<?php if ($this->session->flashdata('error')) {?>
        ...
        <?php
            ...
            <div class="row text-right">
                <a href="<?php echo base_url('index.php/SettlementCommonDc/viewApplicationDetailsOnly?case=' . $basic['old_case_no']) ?>" target="Old Application" class="text-danger">
        ...
        <section>
            <div class="wizard">
                ...
                <div class="tab-content">
                    ...
                    <?php
                        include APPPATH . "views/SettlementView/include/applicationKhasView.php";
                                            ...
                                            <?php
                                                $i = 1;
                                                    foreach ($proceedings as $pro):
                                                        ...
                                                        ?>
					                                                    <tr>
					                                                        <td><?php echo date('Y-m-d h:i:s', strtotime($pro->date_entry)); ?></td>
					                                                        <td><?php echo $pro->office_from; ?></td>
					                                                        <td><span class="text-success"><?php echo $pro->note_on_order; ?></span></td>
					                                                    </tr>
					                                                <?php }
                                                                            $i++;endforeach; ?>
                                        </table>
                                    ...
                                    <div class="tableCard">
                                        <table class="table table-bordered">
                                            <?php
                                                ...
                                                ?>
                                                <tr>
                                                    <th><?php echo $enc_count++ ?></th>
                                                    <th>Encroacher Name</th>
                                                    <td><?php echo $enc_data->enc_name ?></td>
                                                    <th>Father's Name</th>
                                                    <td><?php echo $enc_data->enc_fathers_name ?></td>
                                                    <th>Encroachment from</th>
                                                    <td><?php echo $enc_data->enc_from_date ?></td>
                                                </tr>
...
<?php endforeach; ?>
                                ...
                                <input type="hidden" id="caseNo" name="case_no" value="<?php echo $_GET['case'] ?>">
                                <?php
                                        ...
                                        <form method="post" action="<?php echo base_url() ?>index.php/SettlementKhasCo/generateNoticeCo" name="sk_form_sub">
                                            ...
                                            <div class="mt-4 row px-5 justify-content-center">
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="hidden" id="case_no" name="case_no" value="<?php echo $_GET['case'] ?>">
                                                    <br>
            ...
            echo 'lm_invalid';
                                                            ...
                                                            <?php
                                                                foreach ($co_name as $coname) {
                                                                        ...
                                                                        ?>
                                                                <option value="<?php echo $user_code ?>"<?php if (isset($err_return)) {
                                        ...
                                        <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url() ?>index.php/SettlementKhasCo/generateNoticeCo">
                                            ...
                                            <div class="mt-4 row px-5">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <select name="remark_co_type" id="remark_co" onchange="autoRemark();" class="form-control">
                                                        ...
                                                        <?php
                                                            foreach (json_decode(CO_NOTE) as $co_remark_cat) {
                                                                ...
                                                                ?>
                                                            <option value="<?php echo $co_remark_cat->CODE ?>"><?php echo $co_remark_cat->NAME ?></option>
                                                            <?php
                                                                }
                                                                ?>
                                                    ...
                                                    <input type="hidden" name="case_no" value="<?php echo $_GET['case'] ?>">
                    ...
                    <div class="tab-pane" role="tabpanel" id="history">
                        ...
                        <h5 class="bg-info p-2 text-white shadow" style="margin-top: 10px">
                            <?php echo $this->lang->line('khasLand') ?> (
                            <span class="bg-warning" style="padding-left: 5px; padding-right: 5px"><?php echo $_GET['case'] ?></span> )
                        </h5>
                        <div class="reza-card ">
                            <div class="reza-body">
                                        ...
                                        <?php foreach ($premium_data as $dagsprem) {?>
                                            <div class="row">
                                                <div class="form-group col-md-6 ">
                                                    <label>Zonal Value for dag no <strong><span id="dag_prem"><?php echo $dagsprem->dag_no ?></span></strong></label>

                                                </div>
                                                <div class="form-group col-md-6">

                                                    <input type="number" name="zonal_valuation_prem<?php echo $dagsprem->dag_no ?>" id="zonal_valuation_prem<?php echo $dagsprem->dag_no ?>"
                                                           class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control" id="prem_area" name='area<?php echo $dagsprem->dag_no ?>' value="<?php echo $dagsprem->area ?>" readonly>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 ">
                                                    <input type="text" class="form-control" name='land_type<?php echo $dagsprem->dag_no ?>' value="<?php echo $dagsprem->land_type ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 ">
                                                ...
                                                <div class="form-group col-md-6 ">
                                                    <input type="text" class="form-control" id="prem_landtype" name='rate_type<?php echo $dagsprem->dag_no ?>' value="<?php echo $dagsprem->house_type ?>" readonly>

                                                </div>
                                            </div>
                                            <div class="row" id="percentage<?php echo $dagsprem->dag_no ?>">
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 ">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 ">
                                                    <label for="title">Total amount for dag no <strong><span id="dag_prem"><?php echo $dagsprem->dag_no ?></span></strong></label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input id="finalper<?php echo $dagsprem->dag_no ?>" type="hidden" class="finalper<?php echo $dagsprem->dag_no ?>" value="" name="finalper<?php echo $dagsprem->dag_no ?>" />
                                                    <input id="total_lessa<?php echo $dagsprem->dag_no ?>" type="hidden" class="total_lessa<?php echo $dagsprem->dag_no ?>" value="" name="total_lessa<?php echo $dagsprem->dag_no ?>" />
                                                    <input type="text" class="totalamount form-control" value="<?php echo $dagsprem->amount_dag ?>" name="amount<?php echo $dagsprem->dag_no ?>" readonly />
    ...
    ?>
                                        ...
                                        <div class="tableCard" style="padding: 25px!important;">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control" name="finalamount" id="finalamount" value="<?php echo $dagsprem->final_amount ?>" readonly>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control " name="totaldue" id="totaldue"  value="<?php echo $dagsprem->due_amount ?>" readonly>
                                                </div>
...
<script>
    ...
    function autoRemark(){
        ...
        if(remark_val == 1){
            ...
            $.ajax({
                url: baseurl+'SettlementCommon/checkRuralUrbanv2',
                type: "POST",
                data: postData,
                success: function(data) {
                        console.log("Raw response:", data); // See what you're really getting
