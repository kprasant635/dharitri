...
<html class="no-js">
   ...
   <body style="background:none!important;">
      ...
      <form action="<?php echo base_url()?>index.php/SettlementTenantCo/saveNotice" method="post" enctype='multipart/form-data'>
            ...
            <div class="container bg-white shadow pb-3" id="print_direct">
               ...
               <div class="row mt-4">
                  <div class="col-12 text-justify p-5">
                     'অসম অস্থায়ী বন্দৱস্তি এলেকাৰ ৰায়তী নিয়মাৱলী, ১৯৭২ৰ ১০ নং নিয়ম অনুসৰি জাৰি কৰা এই জাননীৰ জৰিয়তে আপোনালোকক জনোৱা  হ'ল যে, ৰায়ত শ্ৰী
                     <b>
                     <?php 
                        $position = 0;
                     ...
                     <?php 
                        $position1 = 0;
                        $length1 = count($get_owners);
                        foreach($get_owners as $own){
                                if($position1 == $length1 - 1){
                                    echo $own->pdar_name;
                                }elseif($position1 == $length1 - 2){
                                    echo $own->pdar_name.' আৰু ';
                                }else{
                                    echo $own->pdar_name.', ';
                                }
                                $position1++;
                     ...
                     <b>
                     <?php
                        foreach($get_settlement_applicant as $applicant_details){
                           if($applicant_details->is_applicant == 1){
                              echo $applicant_details->khatian_no;
                           }
                        }
                     ?></b>
                     ...
                     <?php
                        ...
                        ?>
                     জমিত 'অসম অস্থায়ী বন্দৱস্তি এলেকাৰ ৰায়তী আইন'ৰ অধীনত ২৩ নং ধাৰামতে মালিকীস্বত্ব লাভৰ বাবে আৱেদন কৰিছে। এই ক্ষেত্ৰত শুনানিৰ বাবে <b><?=$notice_hearing_date?></b> তাৰিখটো ধাৰ্য কৰা হৈছে। গতিকে আপোনালোকক যাৱতীয় নথিপত্ৰসহ উক্ত দিনত কাৰ্যালয়ত উপস্থিত থাকিবলৈ জনোৱা হ'ল।
                  </div>
               </div>
