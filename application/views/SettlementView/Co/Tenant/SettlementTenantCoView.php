                        ...
                        <div class="reza-body">
                            ...
                            if($user_desig_code == 'SK')
                            {
                                ...
                                <div class="tableCard" style="padding-bottom: 15px">
                                    ...
                                    <form method="post" action="<?php echo base_url()?>index.php/SettlementTenantCo/generateNoticeCo" name="sk_form_sub">
                            ...
                            { ?>
                                ...
                                <div class="tableCard ">
                                    ...
                                    <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url()?>index.php/SettlementTenantCo/generateNoticeCo">

                                        <input type="hidden" id="case_no" name="case_no" value="<?=$_GET['case']?>">

                                        <?php
                                        if($validation_bypass == 1 && 1==2)
                                        {
                                            ?>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            ...
                                            if(ENABLE_BUTTON_CO_SUBMIT_TENANT != 0)
                                            {
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb2(''+case_no+'','<?php echo SETTLEMENT_TENANT_ID ?>');
