                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <strong><input type="text" style="text-align: center;" name="i_area_g<?=$i?>" value="<?php if((in_array($this->session->userdata('dist_code'), BARAK_VALLEY))){ echo $settlement->i_area_g;} else {echo '0';} ?>" class="form-control input-sm" >
                          </strong> 
                        </td>
                        <td>
                          <span class="input-group-addon">Kranti</span>
                          <strong><input type="text" style="text-align: center;" value="<?php if((in_array($this->session->userdata('dist_code'), BARAK_VALLEY))){ echo $settlement->i_area_kr;} else {echo '0';} ?>" name="i_area_kr<?=$i?>" class="form-control input-sm" >
                          </strong>
                        </td>
                      </tr>
                    </table>
                  ...
                  <p class="card-text">
                    <table class="table">
                      ...
                      <tr>
                        <td>
                          <input type="text" name="kin_name" value="Jayanta Sonowal" class="form-control input-sm" disabled>
                        </td>
                        <td>
                          <input type="text" name="kin_relation" value="Father" class="form-control input-sm" disabled>
                        </td>
                        <td>
                          <input type="text" class="form-control input-sm" value="Dibrugarh" name="kin_address" disabled>
                        </td>
                        <td>
                          <input type="text" name="kin_contact_no" value="8403903066" class="form-control input-sm" disabled>
                        </td>
                      </tr>
                    </table>
                  </p>
...
<div class="row p-2 px-5">
  ...
  <div class="col-md-6">
    <input
      ...
      id="ceiling_limit"
      class="form-control"
      placeholder="Enter ceilling limit" value="<?=$lmnote->ceiling_limit?>"
    />
  </div>
</div>
<div class="row p-2 px-5" >
...
<div class="tab-pane" role="tabpanel" id="step3">
  <h5 class="bg-info p-2 text-white shadow">
    CO report for Registration of SETTLEMENT AP TRANSFER (
    <span class="bg-warning"><?=$_GET['case']?></span> )
  </h5>
  <div class="card">
    <div class="card-body">
    <?php
      ...
      ?>
        <div class="row p-2 px-5" >
          ...
          <table class="table table-bordered">
            ...
            <?php
              foreach($proceedings as $remarks){
            ?>
            <tr>
              <td><?=$remarks->date_entry?></td>
              <td><?=$remarks->office_from?></td>
              <td><?=$remarks->office_to?></td>
              <td><span class="bg-warning text-white"><?=$remarks->note_on_order?></span></td>
            </tr>
            <?php }?>
          </table>
        </div>
      ...
      ?>
        <form method="post" action="<?php echo base_url()?>index.php/SettlementApCo/generateNoticeCo">
          <div class="mt-4 row px-5">
              <div class="col-md-3">
                <label for="">Select hearing date</label>
                <input type="hidden" name="case_no" value="<?=$_GET['case']?>">
                <input type="date" class="form-control" name="hearing_date" required />
              ...
              <div class="col-md-9">
                  ...
                  <textarea placeholder="Remarks  ..." name="remark_co" class="form-control" id="remark_co" cols="30" rows="3"></textarea>
                  <input type="hidden" name="case_no" value="<?=$_GET['case']?>">
          ...
          <div class="row mt-4 justify-content-center">
              ...
              <button type="submit" name="generate_notice" formtarget="_blank" type="button" class="m-1 col-2 text-white btn btn-warning btn-sm">Generate Notice</button>
            ...
            <?php }else{ ?>
              ...
              <?php } ?>
                ...
                <?php if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                <button type="submit" name="forward_to_dc" class="m-1 col-2 btn btn-primary btn-info-full next-step btn-sm" disabled>Forward to DC</button>
                <?php }else{ ?>
                  <button type="submit" name="forward_to_dc" class="m-1 col-2 btn btn-primary btn-info-full next-step btn-sm">Forward to DC</button>
                  <?php } ?>
