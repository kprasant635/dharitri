            ...
            <div class="wizard">
              ...
              <input type="hidden" name="application_no" value="<?=$_GET['app']?>"> -->
                ...
                <div class="tab-content">
                    <?php
                    include(APPPATH."views/SettlementView/include/applicationTeaLmView.php");
                    ?>
                            ...
                            <div class="reza-body">
                                            ...
                                            foreach($proceedings as $pro):
                                                if ($i==1){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span><?=$pro->note_on_order;?></span>
                                                        </td>
                                                    </tr>
                                                <?php } $i++; endforeach;?>
                                        </table>
                                ...
                                if($user_desig_code == 'SK')
                                {
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        $from_office = $basic["from_office"];
                                        ?>
                                        <form method="post" id="co_form_sub" action="<?php echo base_url()?>index.php/SettlementTeaCo/generateNoticeCo" name="co_form_sub">
                                                    ...
                                                    <div class="col-md-8">
                                                        <label for="" class="text-danger">
                                                            ...
                                                            <h5><i class="fa fa-exclamation-circle" aria-hidden="true"></i>
                                                                ...
                                                                {
                                                                    ?>
                                                                    &nbsp;LM has rejected this case by selected rejection reasons which can be seen in the LM Report section. Do you agree with LM and allow rejection for this case?
                                            ...
                                            <div class="mt-4 row px-5">
                                                ...
                                                <div class="col-md-9">
                                                    <?php if(ENABLE_BUTTON_CO_TO_DC_CULTIVATORS != 0){ ?>
                                                        <?php if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                                                            <label class="control-label">
                                                                <input type="radio" name="order_type" value="re_lm_note" id="reverttolm" disabled> <b>Send Back to LM for Re Submitting Report</b>
                                                            </label>
                                                            <label class="control-label">
                                                                <input type="radio" name="order_type" value="frwrddc" id="frwrdtodc" disabled> <b>Forwarded</b>
                                                            </label><br><br>
                                                        <?php }else{ ?>
                                                            <label class="control-label">
                                                            ...
                                                            <label class="control-label">
                                                                <input type="radio" name="order_type" value="frwrddc" id="frwrdtodc"> <b>Forwarded</b>
                                                            </label><br><br>
                                                    ...
                                                    <textarea placeholder="Remarks  ..." name="remark_co_note" id="remark_co_text" class="form-control" cols="30" rows="3"></textarea>
                                                ...
                                                <?php if(ENABLE_BUTTON_CO_TO_DC_CULTIVATORS != 0){ ?>
                                                    <?php if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                                                        <button
                                                                type="submit"
                                                                name="revert_to_lm"
                                                                class="m-1 col-2 btn btn-danger btn-sm"
                                                                disabled
                                                                onclick="return lm_Revert()" id="lm_revert_btn"
                                                        >
                                                            Revert Back to LM
                                                        </button>
                                                    <?php }else{ ?>
                                                        <button
                                                                type="submit"
                                                                name="revert_to_lm"
                                                                class="m-1 col-2 btn btn-danger btn-sm" disabled
                                                                onclick="return lm_Revert()" id="lm_revert_btn"
                                                        >
                                                            Revert Back to LM
                                                        </button>
                                                    ...
                                                    <?php if(($pending_officer == 'LM' && $from_office == 'CO') || ($pending_officer == 'DC' && $from_office == 'CO')){ ?>
                                                        <button
                                                                type="submit"
                                                                name="forward_to_dc"
                                                                class="m-1 col-2 btn btn-primary btn-info-full btn-sm"
                                                                disabled
                                                                onclick="return dc_forward()" id="frwrd_dc_btn"
                                                        >
                                                            Forward
                                                        </button>
                                                        <?php
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 ">
                                                <label class="text-danger">(TEA: @Rs 1000/ per Bigha up to 30 bighas of land, If above 30 bighas then 30% of the Zonal valuation up till 75 bigha.
                                                    <br>COFFEE/RUBBER: @Rs 5000/ per Bigha for special cultivation of Coffee and Rubber up to 30 bighas of land. If above 30 bighas then 100% of the Zonal valuation.)
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb2(''+case_no+'','<?php echo SETTLEMENT_SPECIAL_CULTIVATORS_ID ?>');
