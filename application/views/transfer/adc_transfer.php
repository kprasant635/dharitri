        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1 panel panel-default panel-body ">
                <div class="well well-sm mis_report">
                    <h2 class='uni_text' style="text-align: center; color: #2e4d8e">Case Transfer (Assign ADC)</h2>
                </div>
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
						...
						<?php
						$attributes = array('CaseTransferAdc/Update','class' => 'form-horizontal', 'id' => 'myform');
						echo form_open_multipart('CaseTransferAdc/Update',$attributes); ?>
