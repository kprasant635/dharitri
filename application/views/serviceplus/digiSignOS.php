        ...
        <div class='col-lg-10' style="margin: 0 auto;float: none;">
            <div class="panel panel-primary panel-form">
                <div class="panel-body">
                    ...
                    <div class="col-lg-6 update col-lg-offset-3 ">
                        <div class="alert alert-info">
                            ...
                            <form id="pdfForm" class="form-horizontal unicode">
                                ...
                                <center><i class='fa fa-pencil-square fa-5x'></i></center>
								<center><input id="signPdf" type="button" value="Click Here for Digital Signature in Order Sheet Copy " class="btn btn-success"></center>
                            ...
                            <div id="panel"></div>
                            <form class="form-horizontal unicode" id='VerfiedConfirm' action="<?php echo base_url(); ?>index.php/serviceplus/UpdateOSDeliver" method="POST" enctype="multipart/form-data">
                                <!--<label for="signedPdfData">Signed Pdf (Base64):</label> <br />-->
                                <input type='text' class="form-control" name='signedPdfData' readonly id='sdfsdPdfData' >
                                ...
                                <input type="text" value="<?php echo $this->session->userdata('case_no'); ?>"  name="cert_no" >
                            </form> 
                        </div>
                    </div>
                </div>
