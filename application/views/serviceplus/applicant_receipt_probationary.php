                ...
                <form action="<?php echo base_url(); ?>index.php/serviceplus/save_citizen_centric" method="POST">
                    <div class="panel-body">
                        ...
                        <p class="uni_text"><?php echo $location['vill_townprt_code'] ?> </span> গাঁওৰ  <span class='red'><?php echo $pdar_name; ?></span>
                            <?php echo $this->utilityclass->get_relation($relation); ?> <?php echo $guard_rel ?>'ৰ নামত জমাবন্দীৰ নকল ৰ বাবে পঞ্জীকৰণ প্রক্রিয়া সম্পূর্ণ হ'ল ।</p>
						<hr>
                        <p class="uni_text">The Registration Process for Issuance of Certified Copy of Jamabandi or Records of Right By Assistant (to LM) Completed.</p>
						</div>
                    </div>
