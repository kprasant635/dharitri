        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">Pending RoR Application From Service Plus</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                foreach ($result as $s) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href='<?php echo base_url() ?>index.php/serviceplus/register_ror_applicant?application_ref_no=<?php echo $s['application_ref_no'] ?>&applid=<?php echo $s['applid'] ?>' class='btn btn-primary btn-sm btn-block'><i class="fa fa-file-image-o" aria-hidden="true"></i> Register Application </a>
                                        </td>
                                    </tr>
                                <?php
                                    $i++;
