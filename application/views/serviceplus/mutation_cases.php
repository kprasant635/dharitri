        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">Pending Mutation Cases From Service Plus</h2>
                </div>
            </div>
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                foreach ($result as $s) {
                                    ...
                                    $patta_no = $s['patta_no'];
									$patta_type_code = $s['patta_type_code'];
                                    $dag_no = $s['dag_no'];
                                    ?>
                                    <tr>
                                        ...
                                        <td class='center'>
										<?php echo $this->utilityclass->get_dag_no_from_dag_no_int($dist_code, $subdiv_code, $cir_code, $mouza_pargona_code, $lot_no, $vill_townprt_code,$patta_no,$patta_type_code,$dag_no); ?>
										</td>
                                        <td class='center'>
                                        ...
                                        <td class="center">
                                            <a href='<?php echo base_url() ?>index.php/Serviceplus/mutation_register?application_ref_no=<?php echo $s['application_ref_no'] ?>&applid=<?php echo $s['applid'] ?>' class='btn btn-primary btn-sm btn-block'><i class="fa fa-file-image-o" aria-hidden="true"></i> Register Application </a>
                                        </td>
                                    </tr>
                                <?php
                                    $i++;
