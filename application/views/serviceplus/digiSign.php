...
<div class="container-fluid form-top login">
    <div class='row'>
        <div class='col-lg-10' style="margin: 0 auto;float: none;">
            <div class="panel panel panel-form">
                <div class="panel-body">
                    <?php //var_dump($this->session->all_userdata()); ?>
                    <hr>
                    <p class='uni_text red center'>Please Connect your Digital Signature</p>
                    <div class="col-lg-6 update col-lg-offset-3 ">
                        ...
                        <div class="alert alert-info">
                            <form id="pdfForm" class="form-horizontal unicode">
								...
								<center><input id="signPdf" type="button" value="Click Here for Digital Signature in ROR Copy" class="btn btn-success"> </center>
