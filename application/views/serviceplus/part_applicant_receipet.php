            ...
            <div class="panel panel-primary">
                ...
                <form action="" method="POST">
                    <div class="panel-body">
                        <input type='hidden' name='cert_no' value='<?php echo $data['case_no']; ?>'>
                        <table width="100%">
                            <tr>
                                <td width="45%">গোচৰ নং : <?php echo $data['case_no']; ?></td>
                                <td width="10%"></td>
                                <td width="45%">প্রস্তাবিত তাৰিখ :<?php echo $this->utilityclass->cassnum(date('d/m/Y', strtotime($data['next_due_date']))) ?></td>
                            </tr>
                            <tr>
                                ...
                                <td width="10%"></td>
                                <td width="45%">Service name : <span class='red'> <?php echo $data['mutation_type_name']; ?> </span></td>
                            </tr>
                            <tr>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data['circle']; ?> ৰাজহ  চক্র ,<?php echo $data['district']; ?></span></td>
                            </tr>
                        </table>
						<hr>
                        <div class="form-group">
							<p class="uni_text"><?php
                            echo $this->utilityclass->cassnum(date('d/m/Y', strtotime($data['current_date'])));
                            ?>  তাৰিখে <?php echo $data['case_no']; ?> নং গোচৰ <span class='red'> <?php echo $data['mutation_type_name']; ?></span> বাবে পঞ্জীকৰণ প্রক্রিয়া সম্পূর্ণ হ'ল ।</p>
						<hr>
