...
<div class='dontshow' >
    <div class="form-group" style="text-align: center">
        <div class="col-sm-10" style="margin: 0 auto;float: none;margin-top: 20px;margin-bottom: 20px;">                     
            <br><button class='btn btn-success' id="print"><i class='fa fa-file'></i> Click to Generate Jamabandi for Digital Signature</button>
			<a href="<?php echo base_url(); ?>index.php/serviceplus/PrintForAsts?cert_no=<?php echo $certDtls->cert_no; ?>&certtype=07" class="btn btn-info dontshow" onclick="myFunction5644()"><i class='fa fa-print'></i> Send to Ast. for Print & Manual Signature</a>   
        </div>
    </div>
</div>

 <form action="<?php echo base_url(); ?>index.php/serviceplus/mpdfOS" id="pdf_certificate" style='display:none' enctype='multipart/form-data'   method="post">                    
