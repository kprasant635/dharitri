                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                            <h6 class="red uni_text"><b>NOTE : || ALL ACTIVE USERS || 
                                ...
                                else
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            if ($c['status'] == 'E') {
                                                ?>
                                                <a onClick="return ConfDel()" href="<?php echo base_url() . 'index.php/initialization/disable_users?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Disable User"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true" style='color: red;'></span></a>
                                                <?php
                                            } else {
                                                ?>		
                                                <a onClick="return Confadd()" href="<?php echo base_url() . 'index.php/initialization/enable_users?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Enable User"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style='color: green;'></span></a>
                                                    <?php
                                                }
                                            ?>
                                        </td>
										<td>
											<?php
											//var_dump($c);
                                            if ($c['status'] == 'E' and $c['lot_no']!='00') {
											?>
												<a href="<?php echo base_url() . 'index.php/initialization/lm_transfer?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" class='btn btn-info btn-xs' title="Transfer LM to Another Lot" >Transfer</a>
											<?php
											}
											?>
										</td>
