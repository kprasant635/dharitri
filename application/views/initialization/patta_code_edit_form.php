        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                        ...
                        <center>
                            ...
                            <table class="table">
                                <tr style='text-align: center;'>
                                    <td><b><?php echo $this->lang->line('code');?></b></td>
                                    <td><b><?php echo $this->lang->line('patta_name');?></b></td>
                                    <td><b><?php echo $this->lang->line('mutation');?></b></td>
                                    <td><b><?php echo $this->lang->line('conversion');?></b></td>
                                    <td><b><?php echo $this->lang->line('jamabandi');?></b></td>
                                    <td><b><?php echo $this->lang->line('ap_cancellation');?></b></td>
                                </tr>
                    ...
                    <div class="col-lg-6">
                        <center>
                            <form  name="frmLClass" method ="post" action="<?php echo base_url();?>index.php/initialization/afterEdit_pattacode" >
                                    ...
                                    <table border="1" cellpadding="1" cellspacing="2"  style="VISIBILITY: visible" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <font face="ASBW-TTDurgaEN" color="#009900" style="font-size: 17pt">যি কোনো সুত্রে</font>
                                                <font face="ASBW-TTDurgaEN" color="#000080" style="font-size: 17pt">&nbsp;&nbsp;&nbsp;&nbsp; </font>
                                                
                                                <font face="ASBW-TTDurgaEN" color="#000080" style="font-size: 14pt; font-weight: 700"><input type="radio" value="i" name="mutation" ></font>
                                                <font face="ASBW-TTDurgaEN" color="#0000FF" style="font-size: 14pt; font-weight: 700"></font>
                                                <span style="border-left-color: #CCCCFF; border-left-width: 1; border-right-color: #CCCCFF; border-right-width: 1; border-top-style: none; border-top-width: medium; border-bottom-color: #CCCCFF; border-bottom-width: 1">
                                                <font face="ASBW-TTDurgaEN" color="#0000FF" style="font-size: 17pt">কেবল উত্তৰাধিকাৰ / উঃ দঃ সুত্রে</font>
                                                <font face="ASBW-TTDurgaEN" color="#000080" style="font-size: 17pt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></span>
                                                <font face="ASBW-TTDurgaEN" color="#000080" style="font-size: 14pt; font-weight: 700">
                                                <input type="radio" value="n" name="mutation"></font>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <font style="font-size: 17pt" face="ASBW-TTDurgaEN" color="#008000">হ'ব</font>
                                                <font style="font-size: 17pt" face="ASBW-TTDurgaEN" color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font>
