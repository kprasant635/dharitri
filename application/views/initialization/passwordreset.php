        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <!-- <h2 style="text-align: center;">All Other Users Accounts (CO, SK,AST,LM)</h2> -->
                    ...
                    {
                        echo '<h2 style="text-align: center;">All SK,AST,LM,DEO Enabled Accounts</h2>';
                    }
                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                            <h6 class="red uni_text"><b>NOTE :  
                                    Button to Reset Password (The Default password will be test@123)  
                        ...
                        <table id="" class="table table-bordered"  width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <td class="bold hide"><?php echo $this->lang->line('action'); ?></td>
                                </tr>
                            </thead>
