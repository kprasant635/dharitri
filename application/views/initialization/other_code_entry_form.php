        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        <center>
                            <form  name="frmLClass" method ="post" action="<?php echo base_url();?>index.php/initialization/afterEntry" >
                                ...
                                <center>
                                    <table border="1" cellpadding="1" cellspacing="2"  style="VISIBILITY: visible" class="table table-bordered">
                                        <tr>
                                            ...
                                            <td colspan=2><b><input size='default' style="width:40%;" name="Code"  maxLength=7 size=6></b>
                                                <font color=red>
                                                <?php
                                                $valid_length = 0;
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><b><input size='default' style="width:70%;" name="Type" maxLength=45 size=45></b></td>
                                        </tr>
                                    </table>
                                </center>
                                ...
                                <P>&nbsp;</P>
                                <P align = center>
                                    <a href="<?php echo base_url();?>index.php/initialization/master_code_entry" class="btn btn-danger" id=""><< <?php echo $this->lang->line('back');?></a>  || 
                        ...
                        <center>
                            ...
                            <table class="table">
                                <tr style='text-align: center; color:#0000cc;'>
                                    <td><b><?php echo $datas['table_name']; ?> <?php echo $this->lang->line('code');?></b></td>
                                    <td><b><?php echo $datas['table_name']; ?> <?php echo $this->lang->line('name');?></b></td>
                                </tr>
                                <?php foreach($master_result as $m_result): ?>
                                <tr style='text-align: center;'>
                                    <td><?php echo $m_result->code; ?></td>
                                    <td><?php echo $m_result->type; ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </table>
                        </center>
