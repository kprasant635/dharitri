<script type="text/javascript">
	...
	function ConfRemove() {
        if (!confirm('Really want to Remove this User Permanenatly? '))
            return (false);
        return (true);
    }
</script>
        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;">All Disabled Users</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                            <h6 class="red uni_text"><b>NOTE : Please Select Locations from the drop down and select your circle. || ALL IN-ACTIVE USERS ||
                                If you want to Enable any particular user than click on the <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style='color: green;'></span> button and
                        ...
                        <form class='form center no-trigger' method="POST" action="<?php echo base_url() . 'index.php/initialization/all_inactive_disabled_users_dio' ?>">
                        ...
                        <table id="" class="table table-bordered"  width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <td class="bold"><?php echo $this->lang->line('edit'); ?></td>
                            ...
                            <tbody>
                                ...
                                else
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url() . 'index.php/initialization/co_edit_account?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Edit User">
                                        ...
                                        <td class="center">
                                            ...
                                            if ($c['status'] == 'E') {
                                                ?>
                                                <a onClick="return ConfDel()" href="<?php echo base_url() . 'index.php/initialization/disable_users_nic?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Disable User"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true" style='color: red;'></span></a>
                                                <?php
                                            } else {
                                                ?>		
                                                <a onClick="return Confadd()" href="<?php echo base_url() . 'index.php/initialization/enable_users_nic?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Enable User"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style='color: green;'></span></a>
                                                    <?php
                                                }
                                            ?>
                                        </td>
										<td class="center">
                                            <a onClick="return ConfRemove()" href="<?php echo base_url() . 'index.php/initialization/remove_users_nic?use_name=' . $c['primary_login'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Remove User Permanenatly"><span class="glyphicon glyphicon-trash" aria-hidden="true" style='color: red;'></span></a>      
                                        </td>
