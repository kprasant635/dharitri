        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <p class='center bold'><span class="rasid" style="color: #315b75;"><u>The contents of Master <b><u> Cert Revenue Location </u></b></u></span></p>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <table class="table table-striped table-bordered tablesorter pageshowpage">
                            <thead>
                                ...
                                <th><b><?php echo $this->lang->line('location');?></b></th>
                                <th><b><?php echo $this->lang->line('revenue_name');?></b></th>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td><?php echo $m_result->loc_name; ?></td>
                                <td><?php echo $m_result->rev_name; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
                        <hr>
