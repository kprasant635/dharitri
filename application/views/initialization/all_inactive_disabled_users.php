            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    ...
                    if($user_desig_code=='ADC'){
                        echo '<h2 style="text-align: center;">All Circle officers and Branch officers Disabled Accounts</h2>';
                    } 

                    elseif ($user_desig_code=='DC') {
                         echo '<h2 style="text-align: center;">All ADCs Disabled Accounts</h2>';
                    }
                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                            <h6 class="red uni_text"><b>NOTE : Click on 
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            if ($c['status'] == 'E') {
                                                ...
                                                ?>      
                                                <a onClick="return Confadd()" href="<?php echo base_url() . 'index.php/initialization/enable_other_users_adc?user_code=' . $c['user_code'] . '&dist_code=' . $c['dist_code'] . '&subdiv_code=' . $c['subdiv_code'] . '&cir_code=' . $c['cir_code'] . '&mouza_pargona_code=' . $c['mouza_pargona_code'] . '&lot_no=' . $c['lot_no'] ?>" title="Enable User"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style='color: green;'></span></a>
                                                    <?php
                                                }
                                            ?>
                                        </td>
