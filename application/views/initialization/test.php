                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="rasid table">
                                <tr>
                                    <td style="text-align: center;"><?php echo $datas['table_name']; ?> <?php echo $this->lang->line('data_inserted_properly_in');?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 rasid" style="margin: 0 auto;float: none;margin-top: 20px;margin-bottom: 20px;">
                            <a href="<?php echo base_url();?>index.php/initialization/LClassTypePlug?LRCTables=<?php echo $datas['table_name']; ?>" class="btn btn-danger">
