...
<div class="container">
  <h2>Total No. of Basundhara 2.0 Review Case(s) in District</h2>
</div><hr>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 my-2">
        <div class="card-body">
          ...
          <?php if($total_array[0]["received"] != 0) { ?>
            <!-- <a href="<?=base_url().'index.php/BasundharaApi/loadViewPageReview?check=received'?>" >
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 my-2">
        <div class="card-body">
          ...
          <?php if($total_array[0]["pending"] != 0) { ?>
            <!-- <a href="<?=base_url().'index.php/BasundharaApi/loadViewPageReview?check=pending'?>" >
              <span class="more_details">More details >></span></a> -->
          <?php } ?>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 my-2">
        <div class="card-body">
          ...
          <?php if($total_array[0]["delivered"] != 0) { ?>
            <!-- <a href="<?=base_url().'index.php/BasundharaApi/loadViewPageReview?check=delivered'?>" >
              <span class="more_details">More details >></span></a> -->
          <?php } ?>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 my-2">
        <div class="card-body">
          ...
          <?php if($total_array[0]["rejected"] != 0) { ?>
            <!-- <a href="<?=base_url().'index.php/BasundharaApi/loadViewPageReview?check=rejected'?>" >
              <span class="more_details">More details >></span></a> -->
          <?php } ?>          
        </div>
      </div>
...
<script>
  ...
  filterOverAllService = function(){
    ...
    var url = apiurl+"getRtpsAjaxReview";
    if (service == "") {
  ...
  loadDistrictDataByCode = function (district_code, service_code, district_name, service_name) {
    var url = apiurl+"getRtpsCircleAjaxReview";
    $('.loader').addClass('trans');
    $('.loader').removeClass('hide');
    $('.loader').show();
  ...
  loadLotDataByCode = function (district_code,subdiv_code, service_code, circle_code, district_name, service_name, circle_name) {
    ...
    var url = apiurl+"getRtpsLotDataReview";
    $('.loader').addClass('trans');
    $('.loader').removeClass('hide');
    $('.loader').show();
  ...
  function villageWiseDetail(dist, sub, cir, mouza, lot, vill, scode) 
  {
    loader();
    $.ajax({
      url: apiurl+"getApplicationDetailsByVillageMbTwoReview",
      dataType: "JSON",
  ...
  function view_application_detail(appl_no){
    ...
    loader();
    $.ajax({
      url: apiurl+"getRtpsApplicationDetailsReview",
      dataType: "JSON",
