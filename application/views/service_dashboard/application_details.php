...
<div class="container table_div_responsive">
  ...
  <h2>Total no of application(s) <b><?php echo ucwords($_GET['check']); ?></b>
    <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'BasundharaApi/getRtpsData'?>"><< Go Back</a>
  </h2>   
...
<script>
  ...
  $(document).ready(function(){
    ...
    function load_data() {
      ...
      var table = $('#application_detail').DataTable({
        ...
        'ajax':{
          url: baseurl+'getApplicationDetailsAppliedByApplicants',
          type:'POST',
          deferLoading: 57,
          data: {
  ...
  function viewAppl(appl_no){
    ...
    $.ajax({
      url: baseurl+"getRtpsApplicationDetails",
      dataType: "JSON",
