        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">DC Conversion Order</h2>
                </div>
            </div>
            <div class="col-lg-12">
                                    ...
                                    <td colspan="2">
                                        ...
                                        foreach ($lm_details_final as $lm):
                                            ...
                                            if(($approval_authority == 'gov') || ($approval_authority == 'dc')){
                                                ...
                                                if ($lm->conversion_premium_rates_id == 3 || $lm->conversion_premium_rates_id == 11) {
                                                    $prem_percent="বিঘাই প্রতি 1% ";
                                                }else {
                                        ...
                                        if ($presence == '') {
                                            ?>
                                            <!-- ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ অতিৰিক্ত জিলা আয়ুক্তৰ টুকা চোৱা হল ৷ <?php echo $abedon_kari." ".$jati_janajati." ".$freedom_fighter." ".$widow;?> প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী,
                                        ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি উপযুক্ত বিবেচিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ 
                                        <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php //echo $patta_type; ?>একচনা পট্টাৰ  <?php echo $location['dag']; ?> 
                                        ...
                                        <span style='float:right;margin-right:50px; text-align: center'><?php echo $location['add_to']; ?><br><?php echo $location['add_off_designation']; ?>, <?php echo $location['dist']; ?></span> -->
                                            ...
                                            <textarea rows="10" cols="120" name="dc_adc_notice">ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ অতিৰিক্ত জিলা আয়ুক্তৰ টুকা চোৱা হল ৷ প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী, ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি উপযুক্ত বিবেচিত হোৱাত প্ৰস্তাৱ অনুমোদন জনোৱা হল / চৰকাৰৰ অনুমোদনৰ বাবে প্ৰেৰণ কৰা হওঁক ৷

আবেদিত মাটি <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণ প্ৰিমিয়াম মাটিৰ মান্ডলিক মুল্যৰ বিঘাই প্রতি <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা  ৷

                                                <?php echo $location['add_to']; ?>

                                                <?php //echo $location['add_off_designation']; ?>জিলা আয়ুক্ত, <?php echo $location['dist']; ?></textarea>

                                            <!-- <input type="text" style="font-size: 18pt; height: 40px;" name="dc_adc_notice" class="form-control" value="ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ অতিৰিক্ত জিলা আয়ুক্তৰ টুকা চোৱা হল ৷ প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী, ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি উপযুক্ত বিবেচিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ</span> <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণ প্ৰিমিয়াম মাটিৰ মান্ডলিক মুল্যৰ <span style='color:red;'> <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা</span> ৷ প্ৰস্তাৱ অনুমোদন জনোৱা হল / চৰকাৰৰ অনুমোদনৰ বাবে প্ৰেৰণ কৰা হওঁক ৷<br>
                                        <span style='float:right;margin-right:50px; text-align: center'><?php echo $location['add_to']; ?><br><?php echo $location['add_off_designation']; ?>, <?php echo $location['dist']; ?></span>"/> -->
                                            <?php
                                        } else {
                                            ...
                                            <textarea rows="10" cols="120" name="dc_adc_notice">চক্ৰ বিষয়া পলাশবাৰী ৰাজহ চক্ৰই দাখিল কৰা <?php echo $location['case_no']; ?> নং ম্যাদীকৰণৰ প্ৰস্তাৱ আৰু ভূমিলেখ্য সহায়ক/ভূমিলেখ্য পৰ্যবেক্ষক /চক্ৰ বিষয়াই এই প্ৰস্তাৱ সন্দৰ্ভত দাখিল কৰা প্ৰতিবেদন চোৱা হ’ল ৷ আবেদন কৰা মাটি আবেদনকাৰীৰ একচনা পট্টাৰ মাটি বা দখলত থকা মাটি হয় | এই মাটি আল শ্ৰেণীৰ মাটি হ'য়| উক্ত মাটিৰ ৰাস্তাৰ কাষৰ সংৰক্ষণ নাই | এই মাটি নদীৰ কাষৰ মাটি নহয় | অসম ভুমিলেখ্য নিয়মাৱলী ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি ম্যাদীকৰণৰ বাবে উপযুক্ত বিবেচিত হোৱাত আৰু অসম চৰকাৰৰ ৰাজহ বিভাগৰ অনুমোদন পোৱাত তথা অসম চৰকাৰৰ দ্বাৰা নিৰ্দ্ধাৰিত হাৰত <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা প্ৰিমিয়াম আদায় নিশ্চিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ</span> <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণৰ হুকুম দিয়া হ’ল ৷ চক্ৰ বিষয়াই নথি সংশোধন কৰিব ৷</textarea>
                                            <!-- <input type="text" name="dc_adc_notice" class="form-control" value="চক্ৰ বিষয়া <?php echo $location['cir']; ?> ৰাজহ চক্ৰই দাখিল কৰা <span style='color:red;'><?php echo $location['case_no']; ?></span> নং ম্যাদীকৰণৰ প্ৰস্তাৱ আৰু লাঃমঃ/চুঃকাঃ/চক্ৰ বিষয়া/শাখা বিষয়াই এই প্ৰস্তাৱ সন্দৰ্ভত দাখিল কৰা প্ৰতিবেদন চোৱা হ’ল ৷<?php echo $abedon_kari." ".$jati_janajati." ".$freedom_fighter." ".$widow;?> <?php echo $applicants_patta_occupied." ".$val_tree_yn." ".$roadside." ".$riverside; ?> অসম ভুমিলেখ্য নিয়মাৱলী ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি ম্যাদীকৰণৰ বাবে উপযুক্ত বিবেচিত হোৱাত তথা অসম চৰকাৰৰ দ্বাৰা নিৰ্দ্ধাৰিত হাৰত প্ৰিমিয়াম আদায় নিশ্চিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ</span> <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণৰ হুকুম দিয়া হ’ল ৷<br>
                                        <span style='float:right;margin-right:50px; text-align: center'><?php echo $location['add_to']; ?><br><?php echo $location['add_off_designation']; ?>, <?php echo $location['dist']; ?></span>"/> -->
                                        ...
                                        If($approval_authority=='gov'){
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <label class="control-label">
                                                    ...
                                                    ?>
                                                    Generate Notice for Premium by ADC &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                            ...
                            <div class="row" style="display:<?=$display_type?>">
                                ...
                                <center>
                                    ...
                                    if ($presence == '') {
                                        ?>
                                        <span class="red"><b>Note : Please Select the Assigning ADC from the drop down below.</b></span>
                                        <?php
                                    }
                                    ?>
                                    <div class="col-lg-12">
                                        ...
                                        if ($presence == '') {
                                            ...
                                            <label class="btn btn-success">
                                                <select class="form-control" name='adc_code' required>
                                                    <?php
                                                    foreach ($adc_active as $adcdata) {
                                                        $user_desig_code = $adcdata->user_desig_code;
                                                        $username = $adcdata->username." ( ".$user_desig_code." )";
                                                        $user_code = $adcdata->user_code;
                        ...
                        <div class="col-lg-12 alert alert-warning">
                            <div class="col-lg-12 center">
                                ...
                                <button type="" class="btn btn-warning uni_text" value="7" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp; ADC Report</button>
                ...
                <div class="row panel-form">
                    <div class="col-lg-12 center-col">
                        <div class="panel">
                            ...
                            <div id="notice7" style="display:none;">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <p class='center bold uni_text'>ADC Remark for case no: <?php echo $location['case_no']; ?></p>
                                        </div>

                                    </div>
                                    <div class="panel-body">
                                        <center>
                                            <p><?php echo ($adc_order && $adc_order->co_order) ? $adc_order->co_order : 'Not Available!'; ?></p>
                                        </center>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function modaldiva(objButton) {
        ...
        if (objButton == 1)
        {
            ...
            document.getElementById('notice7').style.display = 'none';
        }
        else if (objButton == 2)
        {
        ...
        else if (objButton == 7)
        {
            ...
            document.getElementById('notice4').style.display = 'none';
            document.getElementById('notice5').style.display = 'none';
            document.getElementById('notice7').style.display = 'block';
        }
    }
