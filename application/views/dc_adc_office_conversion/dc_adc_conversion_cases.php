                            ...
                            <table class='table table-striped table-bordered tablesorter pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    ...
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                                ...
                                                ?>
                                                <a href="<?php echo base_url(); ?>index.php/dc_adc_conversion/SecondProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $case->case_no; ?>
                                                     <br>
                                        ...
                                        <td>
                                            ...
                                            if ($case->lm_note_yn == 'Y' and $case->notice_generated_yn == 'Y' and $case->proceeding_yn == '1') {
                                                ?>
                                                <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/SecondProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                                <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/PassToAdc?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">Forward To ADC</a>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <td>
                                            ...
                                            if ($case->status == 'W' and $case->add_off_desig == 'DPT' and $case->dept_note_yn == null){
                                                ...
                                                if ($case->lm_note_yn == 'Y' and $case->notice_generated_yn == 'Y' and $case->proceeding_yn == '1') {
                                                    ?>
                                                    <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/SecondProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                                    <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/PassToDc?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">Forward To DC</a>
                                                    <?php
                                                }
                            ...
                            <table class='table table-striped table-bordered tablesorter pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    ...
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                                ...
                                                ?>
                                                <a href="<?php echo base_url(); ?>index.php/dc_adc_conversion/FirstProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $case->case_no; ?>
                                                     <br>
                                                <span class='small font-italic red'>
                                                   <?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?>
                                                 </span>
                                        ...
                                        <td class="center"><i class='fa fa-calendar'></i> Submited On <?php echo date('d-m-Y', strtotime($case->date_entry)); ?></td>
                                        <td class="center">
                                            <form class="" method='post' action="<?php echo base_url() . "index.php/dc_adc_conversion/FirstProceeding_save_direct"; ?>">
                                            ...
                                            <hr>
                                            <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/FirstProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                            <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/PassToAdc?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">Forward To ADC</a>
                                            <a class='btn btn-sm btn-danger' href="<?php echo base_url(); ?>index.php/COconversionPartha/RejectOrder?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">Reject Order</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php if($case->is_mb3==1) {?>
                                                <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion_mb/FirstProceedingMb?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                            <?php } else {?>
                                                <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/FirstProceeding?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                            <?php }?>
                                    ...
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                        ...
                                        <td>
                                            ...
                                            if ($case->status == 'R' and $case->add_off_desig == 'DC' and $case->dept_note_yn == null){?>
                                                <a class="btn btn-sm btn-success" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/DepartmentReverted?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View & Give Order</a>
                                                <button type="button" class="btn btn-sm btn-danger" onclick="showRejectModal('<?=$case->case_no?>','<?=SERVICE_CONVERSION?>')"><i class="fa fa-close"></i> &nbsp;Reject Application</button>
                                            <?php }
...
<script>
     $(document).on('click', '#forwardCaseToDc', function(response) {
        ...
        $.ajax({
            url: baseurl + 'index.php/dc_adc_conversion/forwardToDc',
            type: 'POST',
            ...
            success: function(response) {
                ...
                if(response.status == 'success') {
                    ...
                    // window.location.href = baseurl + 'dc_adc_conversion/GoToDC_ADC?pro=2';
                }
