                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <label class="col-sm-6 rasid"><?php echo $this->lang->line('case_no'); ?> : <?php echo $petition_basic->case_no; ?></label>

                            <!-- <label class="col-sm-4 rasid"><?php echo $this->lang->line('sl_no'); ?> : <?php echo "2"; ?></label> -->
                            <label class="col-sm-6 rasid"><?php echo $this->lang->line('date'); ?> : <?php echo date('d-m-Y', strtotime(date('Y-m-d'))); ?> </label>
                            <br>
                        </h3>
                    </div>
                    <?php //echo form_open(base_url('index.php/dc_conversion_mb/DepartmentRevertToCo')) ?>
                      <form class="" id="revertCaseForm"  method='post' action="<?php echo base_url('index.php/dc_conversion_mb/DepartmentRevertToCo'); ?>">
                        <div class="panel-body">
                            <input type="hidden" name="case_no" id="case_no" value="<?php echo $petition_basic->case_no; ?>"/>
                            <input type="hidden" id="baseurl" value="<?php echo base_url(); ?>">
                            <div style="width: 100%">
                                <div style="width: 100%; margin-bottom: 10px;">
                                    <p><?php echo $proceeding_dc_adc->co_order; ?></p>
                                </div>
                                <div style="width: 100%">
                                    <p><b>Department Order: </b><br> <?php echo $proceeding_dc_adc->note_on_order; ?></p>
                                    <?php
                                        $last_row = end($cases);
                                        echo $last_row->note_on_order;
                                    ?>
                                </div>
                            </div>
                        ...
                        <div>
                            <label for="reason">Why are you reverting the case?</label>
                            <textarea name="reason" id="reason" rows="4" cols="50"></textarea>
                            <span id="reason-error" style="color: red; display: none;">This field is required.</span>
                        </div>
                        <div class="panel-footer">
                            <button type="submit" name="submit" class="btn btn-danger uni_text" value="false"> Revert to CO</button>
                        </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
            <div class="col-lg-12 center">
                <button type="" class="btn btn-primary uni_text btn-modal" value="1" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class='fa fa-list-alt'></i>&nbsp; <?php echo $this->lang->line('view_application'); ?></button>
                <button type="" class="btn btn-info uni_text btn-modal" value="2" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp;<?php echo $this->lang->line('lm_report'); ?></button>
                <button type="" class="btn btn-active uni_text btn-modal" value="3" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp;  AST & CO Report</button>
                <button type="" class="btn btn-default uni_text btn-modal" value="4" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp; <?php echo $this->lang->line('sk_report'); ?></button>
                <!--<button type="" class="btn btn-primary uni_text btn-modal" value="6" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp; BO Report</button>-->
                <!-- <button type="" class="btn btn-warning uni_text btn-modal" value="5" onclick="modaldiva(this.value)" data-toggle="modal" data-target="#myModal"><i class="fa fa-list-alt"></i> &nbsp; <?php echo $this->lang->line('view_premiun_report'); ?></button> -->
                                        ...
                                        <table class='table table-bordered  unicode'>
                                            ...
                                            foreach ($pattadar as $p):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label class="control-label"><?php echo $pdar_name; ?></label></td>
                                                    ...
                                                    <table class='table table-striped unicode'>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                <ul>
                                                                <?php
                                                                if (($lm_details_final->jati_janajati_yn != 'Y') && ($lm_details_final->freedom_fighter_yn != 'Y') && ($lm_details_final->widow_yn != 'Y'))
                                                                {
                                                                    $msg="";
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12" style="margin: 0 auto;float: none;margin-top: 20px;margin-bottom: 20px;">
                                            <table class='table table-striped unicode'>
                                                <?php
                                                if (!empty($bo_details_final)) {
                                                    // foreach ($bo_details_final as $bo):
                                                        $bo = $bo_details_final;
                                                        ?>
                                                <?php
                                                if ((($bo_details['dist_frm_town'] == 3) && ($bo_details['inside_outside_town'] == 'i')) || (($lm_details_final->dist_frm_town == 5) && ($lm_details_final->inside_outside_town == 'i')) || (($lm_details_final->dist_frm_town == 5) && ($lm_details_final->inside_outside_town == 'm'))) {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#revertCaseForm').submit(function(e) {
                // Front-end validation for textarea
                if ($('#reason').val().trim() === '') {
                    $('#reason-error').show();
