            ...
            <div class="col-lg-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        <?php
                        if ($process == '2') {
                            echo $this->lang->line('conversion_note_of_action_taken_on_proceeding_order')." (Conversion Cases)";
                        } elseif ($process == '4') {
                            echo $this->lang->line('confirmation_of_payment_of_premium_conv')." (Conversion Cases)";
                        } elseif ($process == '3') {
                            echo $this->lang->line('notice_generation_for_clearing_premium')." (Conversion Cases)";
                        } elseif ($process == '5') {
                            echo "Branch Officer Report On Conversion Cases";
                        }
                        ?>
                    </h2>
                </div>
                        ...
                        if ($process == '2') {
                            ...
                            <table class='table table-striped table-bordered tablesorter pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    <tr>
                                        <td>
                                            <?php
                                            if (($case->notice_generated_yn == '') || (strtolower($case->lm_note_yn) != 'y') || (strtolower($case->sk_comment) == null) || (strtolower($case->bo_note_yn)==null)) {
                                                ?>
                                        ...
                                        <td>
                                            ...
                                            if(strtolower($case->bo_note_yn)==null){
                                                echo "<p class='text-danger'> <i class='fa fa-exclamation-triangle red'></i> সাখা কর্মকর্তাৰ প্ৰতিবেদন দিয়া নাই</p>";
                                            }
                                            ?>
                                            <?php
                                            if (($case->notice_generated_yn == '') || (strtolower($case->lm_note_yn) != 'y') || (strtolower($case->sk_comment) == null)) {
                                                ...
                                                <?php
                                            } elseif (($case->notice_generated_yn == '') || (strtolower($case->co_order_conv_premium) == 'y') || (strtolower($case->bo_note_yn)==null)) {
                                                ?>

                                                <?php
                                            } else {
                                                ?>
                                                <a class='text-danger btn btn-info' href="<?php echo base_url(); ?>index.php/AdcConversionMb/notice_action_taken?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $this->lang->line('write_report'); ?></a>
                                                <?php
                                            }
                                            ?>
                                        </td>
                            ...
                            <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url(); ?>index.php/AdcConversionMb/notice_premium?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $case->case_no; ?></a>
                                    ...
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                        ...
                                        <td class="center"><p class='text-success'> <i class='fa fa-calendar'></i> Hearing Date : <?php echo date('d-m-Y', strtotime($case->next_date_of_hearing)); ?></p></td>
                                        <td class="center">
                                            <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/AdcConversionMb/notice_premium?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">Give Notice</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            if (($case->co_order_conv_notice != null) && (strtolower($case->co_order_conv_premium) == 'y')) {
                                                ...
                                                ?>
                                                <a href="<?php echo base_url(); ?>index.php/AdcConversionMb/confirmation_premium?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $case->case_no; ?></a>
                                            <br>
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                            </td>
                                            <?php
                                        ...
                                        <td>
                                            ...
                                            if (($case->co_order_conv_notice != null) && (strtolower($case->co_order_conv_premium) == 'y')) {
                                                ...
                                                ?>
                                                <a class='text-danger btn btn-info' href="<?php echo base_url(); ?>index.php/AdcConversionMb/confirmation_premium?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $this->lang->line('write_report'); ?></a>
                                                <!--<a class='text-danger btn btn-info' href="<?php echo base_url(); ?>index.php/AdcConversionMb/viewPremiumNoticeAPtoPP?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View Premium Notice</a>-->
                                                <a class='text-danger btn btn-info' href="<?php echo base_url(); ?>index.php/AdcConversionMb/viewPremiumNoticeAPtoPP?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>">View Premium Notice</a>
                                            </td>                                    
                                            <?php
                                        }
                                ...
                                <?php foreach ($cases as $case): ?>
                                    ...
                                    <span class='small font-italic red'><?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?> </span>
                                        ...
                                        <td>
                                            ...
                                            echo "<p class='text-success'> <i class='fa fa-calendar'></i> Hearing Date : " . date('d/m/Y', strtotime($case->next_date_of_hearing)) . "</p>";
                                            ?>
                                            <a class='text-danger btn btn-info' href="<?php echo base_url(); ?>index.php/AdcConversionMb/Bo_Report?case_no=<?php echo $case->case_no."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><?php echo $this->lang->line('write_report'); ?></a></td> 
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
