        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <?php echo form_open(base_url('index.php/dc_adc_conversion/DepartmentRevertToCo')) ?>
                        <div class="panel-body">
                            <input type="hidden" name="case_no" value="<?php echo $petition_basic->case_no; ?>"/>
                            <div style="width: 100%">
                                <div style="width: 100%; margin-bottom: 10px;">
                                    <p><b>CO Order: </b><?php echo $proceeding_dc_adc->co_order; ?></p>
                                </div>
                                <div style="width: 100%">
                                    <p><b>Dept. Note on CO Order: </b><br> <?php echo $proceeding_dc_adc->note_on_order; ?></p>
                                </div>
                            </div>
