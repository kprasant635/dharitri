                        ...
                        <input type="hidden" id="baseurl" value="<?php echo base_url(); ?>">
                            <table class='table table-striped table-bordered rasid-t' style="font-size: 20px;">
                                <tr>
                                    ...
                                    if ($presence == '') {
                                        ?>
                                        <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ 
                                        <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> 
                                            নং দাগৰ</span> <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণৰ ক্ষেত্ৰত চৰকাৰৰ অনুমোদন পোৱা হৈছে ৷ উক্ত  মাটিৰ মান্ডলিক মুল্যৰ বিঘাই প্রতি <span style='color:red;'> <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা</span> প্ৰিমিয়াম আদায়ৰ হুকুম দিয়া হ’ল ৷ আবেদনকাৰীক প্ৰিমিয়াম আদায়ৰ বাবে অবগত কৰোৱা হওঁক ৷<br>
