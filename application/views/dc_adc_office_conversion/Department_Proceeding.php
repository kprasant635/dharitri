        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Department Conversion Order by DC/ADC</h2>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class="" method='post' action="<?php echo base_url() . "index.php/dc_adc_conversion/DepartmentReportSubmit"; ?>" enctype="multipart/form-data">
                        <input type="hidden" name="case_no" value="<?php echo $location['case_no']; ?>"/>
                            <table class='table table-striped table-bordered rasid-t' style="font-size: 20px;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <label class="control-label" > Department Order Number &nbsp;</label>
                                        <input type="text" name="dept_order_no" style="width: 200px;" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <label class="control-label" style="padding-right: 155px;">তাৰিখ &nbsp;</label>
                            ...
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-3 required  control-label">Upload Document</label>
                                <div class="col-lg-3">
                                    <input type='file' name="up_dept_doc" id="up_dept_doc" required>
                                </div>
