                    ...
                    <div class="panel-body">
                        <form class="" method='post' action="<?php echo base_url($post_url); ?>">
                            <table class='rasid-t'>
                                <tr>
                                    <td>
                                        চক্ৰ বিযয়া <?php echo $location['cir']; ?> ৰাজহ চক্ৰৰ পৰা <span style='color:red;'><?php echo $location['case_no']; ?></span> নং ম্যাদীকৰন প্ৰস্তাৱ পোৱা গৈছে |
                                    </td>
                                </tr>
                                <tr>
                                    <td>শাখা বিষয়াই এই প্ৰস্তাৱ পৰীক্ষা কৰি প্ৰতিবেদন দাখিল কৰিব |</td>
                                </tr>
                                <tr>
                                    <td style="text-align: right; padding-right: 40px;">
                                        <input type="hidden" name="dc_adc_order" value="<p>চক্ৰ বিযয়া <?php echo $location['cir']; ?> ৰাজহ চক্ৰৰ পৰা <span style='color:red;'><?php echo $location['case_no']; ?></span> নং ম্যাদীকৰন প্ৰস্তাৱ পোৱা গৈছে |</p><br>
                                               <label class='control-label rasid' style='float:right; margin-right:30px; font-size: 22px; text-align: center'><?php echo $location['add_to']; ?><br><?php echo $location['designation_name']; ?>, <?php echo $location['dist']; ?></label>">
                                    </td>
                                </tr>
                            </table>
                            <hr>
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-2" style="margin-left:20px;">
                                        <input type="text" class="form-control" id="popupDatepicker" placeholder="" name="hearing_date" required style="margin-left: 20px;">
                                    </div>
                                    <label style="color: blue; " class="col-sm-8 uni_text">তাৰিখ শুনানি আৰু আপত্তি দাখিলৰ বাবে ধাৰ্য্য হ'ল ।</label>
                                </div>
                                <br>
                                <label class="control-label rasid pull-right" style="float:right; font-size: 22px; "><?php echo $location['add_to']; ?><br>&nbsp;&nbsp;<?php echo $location['designation_name']; ?>, <?php echo $location['dist']; ?></label>
                            </div>
                        ...
                        <div class="col-lg-12 alert alert-warning">
                            <div class="col-lg-12 center">
                                ...
                                <a class="btn btn-danger uni_text" href="<?php echo base_url(); ?>index.php/dc_adc_conversion/GoToDC_ADC?pro=3"><i class='fa fa-arrow-left'></i> <?php echo $this->lang->line('back') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
