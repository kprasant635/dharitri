        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">ADC's Conversion Order</h2>
                </div>
            </div>
            <div class="col-lg-12">
                        ...
                        <input type="hidden" id="baseurl" value="<?php echo base_url(); ?>">
                            <table class='table table-striped table-bordered rasid-t' style="font-size: 20px;">
                                <tr>
                                    ...
                                    if ($presence == '') {
                                        ?>
                                        <!-- ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ <?php echo $abedon_kari." ".$jati_janajati." ".$freedom_fighter." ".$widow;?> প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী, 
...
<textarea rows="10" cols="120" name="dc_adc_notice">ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী, ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি উপযুক্ত বিবেচিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণ প্ৰিমিয়াম মাটিৰ মান্ডলিক মুল্যৰ <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা ৷ প্ৰস্তাৱ অনুমোদন জনাব পাৰে / চৰকাৰৰ অনুমোদনৰ বাবে প্ৰেৰণ কৰিব পাৰি ৷

<?php echo $location['add_to']; ?>

<?php //echo $location['add_off_designation']; ?>অতিৰিক্ত জিলা আয়ুক্ত, <?php echo $location['dist']; ?></textarea>

                                        <!-- <input type="hidden" name="dc_adc_notice" class="form-control" value="ভূমিলেখ্য সহায়কৰ /ভূমিলেখ্য পৰ্যবেক্ষকৰ /চক্ৰ বিষয়াৰ প্ৰতিবেদন চোৱা হ’ল ৷ প্ৰতিবেদন পৰীক্ষণ মৰ্মে ম্যাদীকৰণৰ বাবে আবেদিত জমী অসম ভূমিলেখ্য নিয়মাৱলী, ১৯০৬ৰ ১০৫ নং নিয়ম অনুসৰি উপযুক্ত বিবেচিত হোৱাত <?php echo $location['mouza']; ?> মৌজাৰ <?php echo $location['vill']; ?> গাওঁৰ <span style='color:red;'><?php echo $location['patta_no']; ?> নং <?php echo $patta_type; ?> পট্টাৰ  <?php echo $location['dag']; ?> নং দাগৰ</span> <?php echo $location['m_dag_area_b']; ?> বিঘা <?php echo $location['m_dag_area_k']; ?> কঠা <?php echo $location['m_dag_area_lc']; ?> লেছা জমীৰ ম্যাদীকৰণ প্ৰিমিয়াম মাটিৰ মান্ডলিক মুল্যৰ <span style='color:red;'> <?php echo $prem_percent; ?> হিচাপে <?php echo $msg; ?> মুঠ <?php echo $pt; ?> টকা</span> ৷ প্ৰস্তাৱ অনুমোদন জনাব পাৰে / চৰকাৰৰ অনুমোদনৰ বাবে প্ৰেৰণ কৰিব পাৰি ৷<br>
                                        <span style='float:right;margin-right:50px; text-align: center'><?php echo $location['add_to']; ?><br><?php echo $location['add_off_designation']; ?>, <?php echo $location['dist']; ?></span>"/> -->
                                        <?php
                                    } ?>
                            ...
                            <div class="row" style="display:<?=$display_type?>">
                                <div class="col-sm-12">
                                    ...
                                    <label class="rasid col-sm-4">
                                        ...
                                        if ($presence == '') {
                                            ?>
                                            <input type="radio" name="order_type" id="inlineRadio3" value="continuehearing" checked> Forward to DC
                                            <?php
                                        } else {
                                            ?>
