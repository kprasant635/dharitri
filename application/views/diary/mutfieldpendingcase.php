        ...
        <div class="col-sm-12" >  
            ...
            <table id="example"  width="100%" class="table table-bordered" border="1">
                ...
                <tr class="active text-danger">
                    ...
                    <td > <p align="center"><?php echo $this->lang->line('submission_date');?></p></td>
                ...
                <tr >
                    ...
                    <td class="alert-teal"><div align="center">11</div></td>
                    <td class="alert-teal"><div align="center">12</div></td>
                    <td class="alert-teal"><div align="center">13</div></td>
                </tr>
                ...
                <tr>
                        ...
                        <td><?php
                            ...
                            if(sizeof($landarea[$i])== '0' or sizeof($landarea[$i])== '5')
                            {
                                echo "No Data Found";
                            }else{
                            $k=1;
                            //var_dump ([$landarea[$i]->patta_no] );
                            ...
                            ?></td>
                        <td><?php echo $this->utilityclass->getCircleName($f->dist_code,$f->subdiv_code,$f->cir_code) ?></td>
                        ...
                        echo "no data ";
                             ...
                             echo $landarea[$i]->m_dag_area_b."-".$landarea[$i]->m_dag_area_k."-".  round($landarea[$i]->m_dag_area_lc, 2);
                        }
                        
                       ?></td>
                        <td><?php echo date('d/m/Y',  strtotime($f->date_entry)) ?></td>
                        <td><?php echo date('d/m/Y',  strtotime($f->report_date)) ?></td>
