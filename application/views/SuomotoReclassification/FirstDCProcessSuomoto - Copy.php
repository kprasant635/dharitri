  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <?php }?>
            ...
            <button type="submit" class="btn btn-sm btn-primary"><i class='fa fa-check-square-o'></i> Send to BO for Payment notice</button>&nbsp;
            <?php }else{?>
            <span id='loading'></span><span id='msg'></span>
            <button type="submit" class="btn btn-sm btn-primary"><i class='fa fa-check-square-o'></i> Send to DPT for Approval</button>&nbsp;
            <?php }?>
            </center>
            <br>
            <br>
