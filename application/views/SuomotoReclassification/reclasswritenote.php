        ...
        <div class="col-lg-12">
            <div class="well well-sm mis_report">
                <h2 style="text-align: center;">
                    Note of Action Taken on Proceeding Order for Suomoto Reclass Cases
                </h2>
            </div>
        </div>
        <div class="col-lg-12">
            ...
            <div class="panel-body form_1">
                <form class="unicode" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (strlen($case->note_on_order) != NULL) {
                                            ...
                                            <input type="hidden" name="note[<?php echo $case->proceeding_id;?>]" class="form-control" value="<?php echo $case->note_on_order; ?>"/>
                                            <?php
                                        } else {
                                            ?>
                                            <textarea name="note[<?php echo $case->proceeding_id;?>]" class="form-control" rows="8">&nbsp;</textarea>
                                            <?php
                                        }
                                        ?>
                                    </td>
                    ...
                    <center>
                        ...
                        <a href="<?php echo base_url(); ?>index.php/SuomotoReclassification/getPendingreclassactionTakenReport" class="btn btn-danger">
