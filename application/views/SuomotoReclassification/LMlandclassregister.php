...
<script type="text/javascript">
    ...
    function delconfirm() {
        ...
        {
            alert("Please Select a New Land Class.");
            return false;
        }
    }
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/LandReclassification/saveReclasificationDetails' ?>">
                            <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                                <h6 class="red uni_text">NOTE : Please Insert the Dag Number and click the "Generate Dag Details" button. It will Auto Generate All The Details. If it doesn't than click the "Generate Dag Details" button again.</h6>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-8 col-lg-offset-4">
                                    <button type="submit" class="btn btn-success subm" onclick="return delconfirm()"><i class='fa fa-check'></i>&nbsp;<?php echo $this->lang->line('submit_button'); ?></button>
...
<script type="text/javascript">
   ...
   function generate_dag() {
       ...
       $('#loc_tax').val("");
       $('#tot_rev').val("");
       $("[name='land_class']").prop('selectedIndex',0);
       $("[name='patta_type']").prop('selectedIndex',0);  
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(dag.length==0)
                {
                    alert("Agricultural Dags are not allowed!!!");
                    return;
                }
