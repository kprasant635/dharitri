...
<section class="procedding">
<div class="left">
  <div class="circle">
    <h2>Proceeding details</h2>
  </div>
</div>
    <div class="right">
    ...
    <?php
                ...
                <table class="table table-stripped table-hover">
                  <th style="background:#45ddb7">Proceeding</th>
                   
                   <th style="background:#45ddb7">Date Entry</th>  
