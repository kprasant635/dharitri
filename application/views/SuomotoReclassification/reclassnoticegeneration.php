            ...
            <div class="col-lg-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        Suomoto Reclass Case For Notice Generation
                    </h2>
                </div>
            </div>
            <div class="col-lg-12">
