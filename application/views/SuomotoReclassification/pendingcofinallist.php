               ...
               //var_dump($cases);
                foreach ($cases as $case): ?>
                    <tr>
                        ...
                        <td>Suomoto Reclass</td>
                        <td><i class="fa fa-calendar"></i> <?php  echo   date('d/m/Y',  strtotime($case->lm_date)) ; ?></td>
                        <td>
                            <a  href='<?php echo base_url() . "index.php/SuomotoReclassification/Finalcoorder?case_no=" . $case->case_no . "&dist_code=" . $case->dist_code . "&subdiv_code=" . $case->subdiv_code . "&cir_code=" . $case->cir_code . "&mouza_pargona_code=" . $case->mouza_pargona_code . "&lot_no=" . $case->lot_no . "&vill_townprt_code=" . $case->vill_townprt_code; ?>' class="btn btn-danger">Update Chitha</a>
                        </td>
