...
<style>
    ...
    background-color: #fff;     /* black fill */
    border: 2px solid #000;     /* white border outline */
                    ...
                    <div class="tab-pane fade show active" id="addPattadar-pane-<?= $index ?>" role="tabpanel"
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form id="addPattadarForm-<?= $index ?>" class="needs-validation" novalidate>
                                    <div class="row g-3">
                                        <div class="col-md-6 mb-3">
                                            <label for="name-<?= $index ?>" class="form-label fw-bold">Name <span
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="guardianName-<?= $index ?>" class="form-label fw-bold">Guardian Name
                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="guardianName-<?= $index ?>"
                                                name="guardianName" required>
                                            <div class="invalid-feedback">Please enter the guardian name.</div>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <label for="gender-<?= $index ?>" class="form-label fw-bold">Gender <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select" id="gender-<?= $index ?>" name="gender" required>
                                                <option value="">Select Gender</option>
                                                <?php foreach ($gender as $g): ?>
                                                    <option value="<?= $g->short_name ?>">
                                                        <?= $g->gen_name_ass ?>-(<?= $g->gen_name_eng ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="relation-<?= $index ?>" class="form-label fw-bold">Relation <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select" id="relation-<?= $index ?>" name="relation"
                                                required>
                                                <option value="">Select Relation</option>
                                                <?php foreach ($relation as $r): ?>
                                                    <option value="<?= $r->id ?>">
                                                        <?= $r->guard_rel_desc_as ?>-(<?= $r->guard_rel_desc ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="address-<?= $index ?>" class="form-label fw-bold">Address <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" id="address-<?= $index ?>" name="address"
                                        ...
                                        <button type="submit" class="btn btn-success">
                                            <i class="fa fa-save me-2"></i>Save Pattadar Details
                                        </button>
                                    </div> -->
                                    </div>
                                </form>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" name="bigha" id="bigha-<?= $index ?>" min="0" placeholder="Bigha" required>
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text areaheight">Bigha</span>
                                                </div>
                                                <!-- Katha -->
                                                
                                                <input type="number" class="form-control" name="katha" id="katha-<?= $index ?>" min="0" max="19" placeholder="Katha" required>
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text areaheight">Katha</span>
                                                </div>
                                                <!-- Lessa -->
                                                
                                                <input type="number" class="form-control" name="lessa" id="lessa-<?= $index ?>" min="0" max="19" placeholder="Lessa" required>
                                                <div class="input-group-prepend">
                            ...
                            <div class="card-body">
                                <form id="pattaTypeChangeForm-<?= $index ?>" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="presentPattaType" class="form-control presentPattaType-select" id="presentPattaType-<?= $index ?>" required>

                                            <option value="">Select Type</option>
                                            <?php foreach ($pattatype as $p): ?>
                                                <option value="<?= $p->type_code ?>">
                                                    <?= $p->patta_type ?>-(<?= $p->pattatype_eng ?>)</option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="requestedPattaType" class="form-control requestedPattaType-select" required>
                                            <option value="">Select Type</option>
                                            <?php foreach ($pattatype as $p): ?>
                                                <option value="<?= $p->type_code ?>">
                                                    <?= $p->patta_type ?>-(<?= $p->pattatype_eng ?>)</option>
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mb-3">
                            ...
                            <div class="card-body">
                                <form id="otherRemarksForm-<?= $index ?>">
                                    ...
                                    <i class="fa fa-paper-plane me-2"></i>Submit Remarks
                                </button> -->
                                </form>
                            </div>
                        </div>
