        ...
        <div class="container bg-white shadow" id="print_direct">
            ...
            <div class="row mt-4">
                <div class="col-12 text-justify p-5">
                    ...
                    <br>
                    <br>
                    ইয়াৰ দ্বাৰা আপোনাক জনোৱা হয় যে মিছন বসুন্ধৰা ৩.০ ৰ অধীনৰ <b><?=$service_name?></b> সেৱাৰ বাবে আপুনি নিম্নোক্ত তপচিলভূক্ত ভূমিৰ বাবে <b><?=$date_of_application?></b> তাৰিখে আৱেদন নং  <b><?=$application_no?></b>. দাখিল কৰিছে।
                    ...
                    আৱেদন পৰীক্ষাৰ অন্তত  <b><?=$date_of_sldc?></b> তাৰিখৰ ভূমি উপদেষ্টা সমিতিৰ বৈঠকৰ সিদ্ধান্ত অনুসৰি চৰকাৰী
                    মাটিৰ পট্টনৰ বাবে আবেদন প্ৰস্তাৱত অনুমোদন জনোৱা হৈছে। সেয়েহে অসম ভূমি ও ৰাজহ অধিনিয়ম ১৮৮৬ অন্তর্গত ৩২(১)
                    ধাৰা অনুসৰি ওপৰত উল্লেখ কৰা দাগত আপোনাৰ দখলত থকা ভূমিৰ পট্টনৰ বাবে এই জাননীযোগে জনোৱা হ'ল
                    ...
                    <table class="mt-4 mb-4">
                        ...
                        <tr>
                            <td>১</td>
                            <td><b>প্ৰকৃত  প্ৰিমিয়াম মূল্য</b></td>
                        ...
                        <tr>
                            ...
                            <td>ST/SC/Widows/Person with disabilities</td>
                            <td><?=$concession_dag_no?></td>
                            <td><?=$concession_area?></td>
                            <td><?=$concession_amount?></td>
                        </tr>
                        <tr>
                            <td colspan="5" class="text-center"><b>প্ৰকৃত / চূড়ান্ত দিবলগীয়া প্ৰিমিয়াম</b></td>
                            <td><b><?=$net_premium_payable?></b></td>
                        </tr>
                        </tbody>
                    </table>
                    সেইমৰ্মে আপোনাক সৰ্বমুঠ <b><?=$net_premium_payable?></b> টকাৰ  প্ৰিমিয়াম অহা ইং <?=$due_date?>
