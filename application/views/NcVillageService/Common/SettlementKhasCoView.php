        ...
        <section>
            <div class="wizard">
                ...
                <div class="tab-content">
                    ...
                    <?php
                    include(APPPATH."views/NcVillageService/NcKhas/applicationKhasView.php");
                    // include(APPPATH."views/NcVillageService/NcKhas/applicationKhasViewAjax.php");
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <div class="reza-card">
                            <div class="reza-body">
                                                        ...
                                                        <li style="padding-top: 10px; padding-bottom: 15px">
                                                            ...
                                                            <?php foreach ($appliedDags as $singleAppliedArea): ?>
                                                                <?php if ($singleChithaArea->dag_no == $singleAppliedArea->dag_no): ?>
                                                                    ...
                                                                    <?php if(NC_ENABLE_AREA_BUTTON_CO == 1){?>
                                                                        <button type="button" id="editarea<?=$singleAppliedArea->id?>" onclick="editArea(<?=$singleAppliedArea->id?>,<?=$singleAppliedArea->dag_no?>);" class="btn btn-sm btn-warning">Edit Area</button>
                                ...
                                <?php if($dagRequest == 1): ?>
                                    <h5 style="color: red; font-weight: bold; padding-top: 30px; padding-bottom: 15px; text-align: center" >
                                        Application can not be forwarded at the moment as dag change request is in process !
                                    </h5>
                                    <br>
                                <?php endif; ?>
                                ...
                                if($user_desig_code == 'SK')
                                {
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <form method="post" action="<?php echo base_url()?>index.php/NcKhaslandCoController/generateNoticeCo" name="sk_form_sub">
                                ...
                                { ?>
                                    ...
                                    <div class="tableCard ">
                                        <?php
                                        //include(APPPATH."views/NcVillageService/NcKhas/areaEditView.php");
                                        ?>
                                        ...
                                        $from_office = $basic["from_office"];
                                        ?>
                                        <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url() ?>index.php/NcKhaslandCoController/generateNoticeCo">
                                            ...
                                            <div class="mt-4 row px-5">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    &nbsp; &nbsp;
                                                    <?php if(ENABLE_BUTTON_CO_ACTION_NC != 0){ ?>
                                                        <?php if($dagRequest != 1): ?>
                                                            <label class="control-label" style="font-size: 16px">
                                            ...
                                            <div class="row mt-4 justify-content-center">
                                                ...
                                                if(ENABLE_ADDITIONAL_PROPERTY_BUTTON == 1 && isset($checkAdditionalProperty)){
                                                    ...
                                                    include(APPPATH."views/NcVillageService/NcKhas/additionalProperty.php");
                                                }
                                                ?>
                                                ...
                                                if(ENABLE_BUTTON_CO_ACTION_NC != 0)
                                                {
                                                    ...
                                                    if($sdo_user_check == 'y')
                                                    {
                                                        if (($pending_officer != 'LM' && $from_office != 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) {?>
                                                            <?php if($dagRequest != 1 ) : ?>
                                                                ...
                                                                <?php if($appAreaMoreThanDagArea == 0 && $appAreaMoreThanDagSingle == 0) : ?>
                                                            ...
                                                            <?php if($validation_bypass != 1) { ?>
                                                                <?php if(NC_HOLD_CO_REJECTED_DAG_REQUEST == 1):  ?>
                                                                    <?php if($dagRequest != 1):  ?>
...
<?php include(APPPATH."views/NcVillageService/Common/Includes/editAreaCommon.php"); ?>
<script src="<?php echo base_url();?>js/NcVillage/editAreaCommon.js"></script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(arr.responseType == 0){
                        ...
                        var khasmaxrural = "<?=NC_KHAS_RURAL_MAX?>";
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb3(''+case_no+'','<?php echo NC_KHAS_LAND_ID ?>');
