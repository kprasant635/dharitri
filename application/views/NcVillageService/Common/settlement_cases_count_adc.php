...
<div class="container-fluid">
    <div class="col-lg-12">
        ...
        <div class="row">
            <p class="uni_text">Total No. of Basundhara 2.0 Case(s) in the Sub-Division </p>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body text-white">
                        ...
                        <kbd id='circle'><?=$output->data->recieved;?></kbd>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body text-white">
                        ...
                        <kbd id='circle'><?=$output->data->pending;?></kbd>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body text-white">
                        <h4></h4>
                        Application Delivered: <br>
                        <kbd id='circle'><?=$output->data->delivered;?></kbd>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body text-white">
                        ...
                        <kbd id='circle'><?=$output->data->rejected;?></kbd>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 p-4">
        ...
        <table class="table table-bordered" id="pendingCasesTable">
            ...
            <tr>
                ...
                <th class="text-center">SDLAC/CDLAC</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td class="rezaText">Marked for SDLAC/CDLAC</td>
                        <td align="center">
                            <span id="markedForSDLACCaseCount" style="font-weight: bold; color: #FF5252"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="rezaText">Placed as SDLAC/CDLAC Proposals</td>
                        <td align="center">
