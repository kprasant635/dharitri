...
<script>
    $(document).on('change', '#mouza_cat, #lot_cat', function(){
        ...
        $.ajax({
            url: baseurl+'NcCommonController/getLotsFromMouza',
            type: "POST",
            data: postData,
...
<script>
    $(document).ready(function ()
    {
        $(document).on('change', '#category, #remark_cat, #mouza_cat, #lot_cat', function(){
            ...
            load_data(category, remark_cat, dist_code, subdiv_code, cir_code, mouza_pargona_code, lot_cat);

        });

        load_data();

        function load_data(is_category = null, remark_cat = null, dist_code=null, subdiv_code=null, cir_code=null, mouza_pargona_code=null, lot_cat=null)
        {
...
<?php 
    include(APPPATH."views/NcVillageService/Common/revival_scripts.php");
?>
