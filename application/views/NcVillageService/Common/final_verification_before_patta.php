    ...
    $(document).ready(function ()
    {
        ...
        function load_data(category,v_status)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/NcVillageHomeController/finalVerificationPagination',
                    type:'POST',
                    data: {
...
<script>
    ...
    function finalVerificationModal(case_no)
    {
        ...
        $.ajax({
            url: baseurl+'NcVillageHomeController/getFinalVerificationData',
            type: "POST",
            data: postData,
                ...
                tr +=  '<tr>'+
                        ...
                        '</tr>'+
                            ...
                            '<tr>'+
                                ...
                                '<td>'+
                                    '<input type="date" name="possession_from" class="form-control" placeholder="Enter possession from..." min="1970-01-01">'+
                                '</td>'+
                           '</tr>';
...
<script>
    ...
    function landmark_dist(side, dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getSubdiv/" + district,
            success: function(data) {
    ...
    function landmark_subdiv(side,dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getCircle/" + district+ "/"+ subdiv,
            success: function(data) {
    ...
    function landmark_cir(side, dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getMouza/" + district+ "/"+ subdiv+"/"+ cir,
            success: function(data) {
    ...
    function landmark_mouza(side,dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getLot/" + district+ "/"+ subdiv+"/"+ cir +"/"+ mouza,
            success: function(data) {
    ...
    function landmark_lot(side,dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getVillage/" + district+ "/"+ subdiv+"/"+ cir +"/"+ mouza+"/"+ lot,
            success: function(data) {
    ...
    function landmark_village(side,dag_no) 
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getAllDags/" + district+ "/"+ subdiv+"/"+ cir +"/"+ mouza+"/"+ lot+"/"+ village,
            success: function(data) {
...
<script>
    ...
    {   
        ...
        $.ajax({
            url: baseurl+'NcVillageHomeController/getGuardianRelation',
            type: "POST",
            success: function(data) 
            {
                $.unblockUI();
    ...
    function addFamilyDetails(){
        ...
        $.ajax({
            url: baseurl+'NcVillageHomeController/addFamilyDetails',
            type: "POST",
            data: postData,
            success: function(data) {
                arr = JSON.parse(data);
    ...
    function confirmDeleteFamily(id)
    {
        ...
        if(confirm("Are you sure you want to delete this Record?"))
        {
            $.ajax({
                type: "POST",
                url: baseurl+'NcVillageHomeController/delFamilyDetailsExisted',
                async: false,
                // dataType: 'json',
    ...
    function confirmDeleteFamilyLmInserted(id)
    {
        ...
        if(confirm("Are you sure you want to delete this Record?"))
        {
            $.ajax({
                type: "POST",
                url: baseurl+'NcVillageHomeController/delFamilyDetails',
                async: false,
                // dataType: 'json',
                data: { id: id, case_no:case_no },
                success: function (response) 
...
<script>
    ...
    $('#approvalForm').submit(function (e) {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/chithaProcessingDetails",
            type: 'POST',
...
<script>
    function getRevenueHome(dag_no, case_no)
    {
        ...
        $.ajax({
            url: baseurl + "NcVillageHomeController/getRevenueDetails",
            type: 'POST',
            data: postData,
            dataType: 'json',
            success: function (data) {
