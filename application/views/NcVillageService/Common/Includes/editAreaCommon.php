  ...
  <div class="modal-content">
    ...
    <p>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" id="enc_bigha_home" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="number" id="enc_katha_home" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="number" id="enc_lessa_home" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>

                    <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                    <td>
                        <input type="number" id="enc_ganda_home" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="hidden" id="enc_kranti_home" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <?php endif; ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" id="enc_bigha_agriculture" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="number" id="enc_katha_agriculture" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="number" id="enc_lessa_agriculture" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>

                    <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                    <td>
                        <input type="number" id="enc_ganda_agriculture" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <td>
                        <input type="hidden" id="enc_kranti_agriculture" style="font-weight:bold;" class="text-center form-control input-sm" readonly>
                    </td>
                    <?php endif; ?>
        ...
        <div class="row justify-content-center">
            <center style="color:red; font-size:16px">Note: Please verify the Premium after Edit the Area.</center>
            <button type="button" onclick="updateAreaDetailsCommon();" class="btn btn-sm btn-danger col-3">UPDATE</button>
        </div>
    </p>
  </div>
