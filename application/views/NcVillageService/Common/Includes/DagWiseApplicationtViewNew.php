                            ...
                            <div class="reza-body">
                                ...
                                <table class="table table-bordered border-primary">
                                    ...
                                    <?php $count=0; foreach ($applications as $applied_dag) { ?>
                                        ...
                                        <?php
                                        $bigha += $this->UtilsModel->defaultValue($applied_dag->mbigha, 0);
                                        $katha += $this->UtilsModel->defaultValue($applied_dag->mkatha, 0);
                                        $lessa += $this->UtilsModel->defaultValue($applied_dag->mlessa, 0);
                                        $ganda += $this->UtilsModel->defaultValue($applied_dag->mganda, 0);
                                        $bighaAgr += $this->UtilsModel->defaultValue($applied_dag->agri_bigha, 0);
                                        $kathaAgr += $this->UtilsModel->defaultValue($applied_dag->agri_katha, 0);
                                        $lessaAgr += $this->UtilsModel->defaultValue($applied_dag->agri_lessa, 0);
                                        $gandaAgr += $this->UtilsModel->defaultValue($applied_dag->agri_ganda, 0);
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            $tribal_link = '<a type="button" target="_blank" href="' . base_url() . 'index.php/SettlementTribal/TribalApplicationRegistration?app=' . $this->utilityclass->encryptJwtcase($applied_dag->application_no) . '" class="lmreportmut btn-sm btn btn-primary">write report</a>';
                                            ...
                                            $khas_link = '<a type="button" target="_blank" href="' . base_url() . 'index.php/SettlementKhasLand/applicationKhaslandRegistration?app=' . $this->utilityclass->encryptJwtcase($applied_dag->application_no) . '" class="lmreportmut btn-sm btn btn-primary">write report</a>';
                                            ...
                                            $tea_link = '<a type="button" target="_blank" href="' . base_url() . 'index.php/SettlementCultivator/settlementApplication?app=' . $this->utilityclass->encryptJwtcase($applied_dag->application_no) . '" class="lmreportmut btn-sm btn btn-primary">write report</a>';
