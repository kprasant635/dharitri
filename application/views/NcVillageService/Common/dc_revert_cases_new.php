...
<form id="bulk_dc_revert_form" method="post">
<div class="row px-5">
        ...
        <div class="card pt-2">
            <div class="col-lg-12">
                <div class="mt-4 row px-5">
                    ...
                    <div class="col-md-9">
                        <b style="color:red">Are you want to forward multiple cases at one go ? please select remark category with remarks and proceed...</b>
                        <hr>
                            ...
                            <div class="text-center">
                                <button type="submit" name="bulk_nr_revert" formtarget="bulk_dc_revert_form" class=" text-white btn btn-warning btn-sm" onclick="return coForm()">Submit</button>
                            </div>
...
<script>
    $(document).ready(function ()
    {
        $(document).on('change', '#category, #mouza_cat, #lot_cat', function(){
            ...
            load_data(category, mouza_cat, lot_cat);
        ...
        function load_data(is_category = null,  mouza_cat=null, lot_cat=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementApCo/getListofcasesDcRevert',
                    type:'POST',
                    data: {
...
function coForm(){
        let x = document.forms["bulk_dc_revert_form"]["remark_co_text"].value;
        let y = document.forms["bulk_dc_revert_form"]['remark_co_type'].value;
...
$('#bulk_dc_revert_form').submit(function (e) {
    e.preventDefault();
    if(!confirm("Are you sure you want to forward this selected cases?"))
     {
        ...
        $.ajax({
            url: baseurl + "SettlementApCo/coBulkForwardDCRevert",
            type: 'POST',
            data: $("#bulk_dc_revert_form").serialize(),
            dataType: 'json',
            success: function (data) {
                $.unblockUI();
                // $("#overlay").fadeOut(300);
