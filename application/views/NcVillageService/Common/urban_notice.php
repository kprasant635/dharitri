...
<form action="<?php echo base_url()?>index.php/NcCommonController/savePaymentNotice" method="post" enctype='multipart/form-data'>
        ...
        <div class="container bg-white shadow" id="print_direct">
            ...
            <div class="row mt-4">
                <div class="col-12 text-justify p-5">
                    ...
                    <br>
                    <br>
                    ইয়াৰ দ্বাৰা আপোনাক জনোৱা হয় যে মিছন বসুন্ধৰা ৩.০ ৰ অধীনত <b><?=$service_name?></b> সেৱাৰ বাবে আপুনি নিম্নোক্ত তপচিলভুক্ত ভূমিৰ বাবে <b><?=$date_of_application?></b> তাৰিখে আবেদন নং  <b><?=$application_no?></b> যোগে দাখিল কৰিছে।
                    ...
                    আবেদন পৰীক্ষাৰ অন্তত  <b><?=$date_of_sldc?></b> তাৰিখৰ ভূমি উপদেষ্টা সমিতিৰ বৈঠকৰ সিদ্ধান্ত অনুসৰি

                    <?php if($get_settlement_basic->dept_order_no != null && $get_settlement_basic->dept_order_date != null) : ?>

                        আৰু ৰাজহ আৰু দুৰ্যোগ ব্যৱস্থাপনা বিভাগ,
                        অসম চৰকাৰৰ অধিসূচনা No. <?=$dept_order_no?> dtd <?=$dept_order_date?> অনুযায়ী

                    <?php endif; ?>

                    চৰকাৰী মাটিৰ পট্টনৰ বাবে আবেদন প্ৰস্তাৱত অনুমোদন জনোৱা হৈছে।
                    সেয়েহে অসম ভূমি ৰাজহ আইনৰ ১৮৮৬ চনৰ ৩২(১) ধাৰা অনুসৰি ওপৰত উল্লেখ কৰা দাগত
                    আপোনাৰ দখলত থকা ভূমিৰ পট্টনৰ বাবে এই জাননীযোগে জনোৱা হ'ল আৰু আপুনি উক্ত পট্টন
                    গ্ৰহণ কৰিবলৈ সন্মত হলে তলত উল্লেখিত ধৰণে প্ৰিমিয়াম আদায় দিবলৈ জনোৱা হ'ল।
                    <br><br>
                    ...
                    সেইমৰ্মে আপোনাক সৰ্বমুঠ <b>₹ <?=$net_premium_payable?></b> টকাৰ প্ৰিমিয়াম অহা  ইং <?=$due_date?>
                    তাৰিখৰ ভিতৰত পৰিশোধ কৰিবলৈ জনোৱা হ'ল।
                    <br>
                    <br>
