...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            <?php echo $this->lang->line('ncSidebar') ?>   / Application Details
        ...
        <section>
            ...
            <div class="wizard">
                    ...
                    <ul class="nav nav-tabs shadow" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#step5" data-toggle="tab" aria-controls="step5" role="tab" title="step 5">
                                <span class="round-tab"><strong>Area Details </strong></span>
                            </a>
                        </li>
                        <li role="presentation">
                ...
                <div class="tab-content">
                    ...
                    <?php include(APPPATH."views/NcVillageService/NcKhas/applicationKhasViewOnly.php"); ?>
