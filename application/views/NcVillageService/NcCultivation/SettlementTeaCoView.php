            ...
            <div class="wizard">
              ...
              <input type="hidden" name="application_no" value="<?=$_GET['app']?>"> -->
                ...
                <div class="tab-content">
                    <?php
                    include(APPPATH."views/NcVillageService/NcCultivation/applicationTeaLmView.php");
                    ?>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <div class="reza-card">
                            <div class="reza-body">
                                ...
                                <?php
                                include(APPPATH."views/NcVillageService/Common/Includes/areaModified.php");
                                ?>
                                ...
                                <?php
                                include(APPPATH."views/NcVillageService/Common/Includes/village_wise_area_show_co.php");
                                ?>
                                ...
                                if($user_desig_code == 'SK')
                                {
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <form method="post" action="<?php echo base_url()?>index.php/NcCultivationCoController/generateNoticeCo" name="sk_form_sub">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        <?php //include(APPPATH."views/NcVillageService/Common/Includes/areaEditView.php");?>

                                        <?php
                                        $pending_officer = $basic["pending_officer"];
                                        $from_office = $basic["from_office"];
                                        ?>
                                        <form method="post" id="co_form_sub" action="<?php echo base_url()?>index.php/NcCultivationCoController/generateNoticeCo" name="co_form_sub">
                                            ...
                                            <div class="row mt-4 justify-content-center">
                                                ...
                                                if(ENABLE_ADDITIONAL_PROPERTY_BUTTON == 1 && isset($checkAdditionalProperty)){
                                                    ...
                                                    include(APPPATH."views/NcVillageService/Common/Includes/additionalProperty.php");
                                                }
                                                ?>
