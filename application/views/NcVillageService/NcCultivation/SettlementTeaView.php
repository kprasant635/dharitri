...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".next-step").click(function (e) {
            ...
            let appbigha_btn=parseFloat($("#total_applied_agri_bigha").val());
            let appkatha_btn=parseFloat($("#total_applied_agri_katha").val());
            let applessa_btn=parseFloat($("#total_applied_agri_lessa").val());

            let total_app_lessa_btn = parseFloat((appbigha_btn * 100) + (appkatha_btn * 20) + applessa_btn);
            if(total_app_lessa_btn>3000){
                $("#above30").show();
                $("#below30").hide();
            } else {
                $("#above30").hide();
    ...
    <div class="row">
        ...
        <section>
            ...
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url()?>index.php/NcCultivationLmController/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    if ($basic == true) { ?>
                                                        ...
                                                        <tr>
                                                            <th>Caste</th>
                                                            <td>
                                                                <select disabled name="caste" id="" class="form-control">
                                                                    <?php
                                                                ...
                                                                <input type="hidden" id="caste_name" name="cast_category" value="<?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select disabled name="tribal_belt" id="" class="form-control">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="cultboard_reg_no" value="<?php  echo $basic['cultboard_reg_no']; ?>" class="form-control <?php if(form_error('cultboard_reg_no')){echo 'is-invalid';} ?>">
                                            ...
                                            foreach ($dags as $all_dags) {
                                                ...
                                                <tr style="border-bottom:1px solid #227576">
                                                    <td colspan="4">
                                                        ...
                                                        <?php if(ENABLE_DAG_ELIGIBLE_BUTTON_LM_REVERT != 0){
                                                            if($dag_count>1){?>
                                ...
                                <div class="reza-body">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <select name="protected_class_lm" id="protected_class_lm" class="form-control" required>
                                                    <?php foreach(json_decode(PROTECTED_CLASS) as $class): ?>
                                                        <option value="<?php echo $class->CODE ?>" <?php if(trim($lmnote->protected_class_lm) == $class->CODE){echo "selected";} ?>><?php echo $class->NAME ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            type="radio"
                                                            name="litigation"
                                                            value="YES" <?php if ($lmnote->litigation == "YES"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            type="radio"
                                                            name="litigation"
                                                            value="NO" <?php if ($lmnote->litigation == "NO"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
                                    ...
                                    foreach($dags as $nature_dag):
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="livelihood"
                                                            id="livelihood"
                                                            value="YES"  <?php if ($lmnote->livelihood == "YES"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="livelihood"
                                                            id="livelihood"
                                                            value="NO"  <?php if ($lmnote->livelihood == "NO"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="suitability"
                                                            id="suitability"
                                                            value="YES"  <?php if ($lmnote->suitability == "YES"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="suitability"
                                                            id="suitability"
                                                            value="NO"  <?php if ($lmnote->suitability == "NO"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            id="admissible_area"
                                                            value="YES"  <?php if ($lmnote->admissible_area == "YES"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="admissible_area"
                                                            id="admissible_area"
                                                            value="NO"  <?php if ($lmnote->admissible_area == "NO"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="govt_allotted"
                                                            id="govt_allotted"
                                                            value="YES"  <?php if ($lmnote->govt_allotted == "YES"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            name="govt_allotted"
                                                            id="govt_allotted"
                                                            value="NO"  <?php if ($lmnote->govt_allotted == "NO"){ echo "checked"; } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-md-6">
                                                <select name="land_falls" id="land_falls" class="form-control">
                                                    <option value="">Select...</option>
                                    ...
                                    wherever necessary)</span>
                                        ...
                                        <div class="row p-2 justify-content-end">
                                            <div class="col-md-12">
                                                <textarea name="lm_remark_text" class="form-control p-2" id="lm_remark_text" cols="30" rows="12"></textarea>
                                            </div>
                                        </div>
                                        <!-- lm report ends here -->
                                        <?php endforeach;?>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                                ...
                                                <?=form_error('co_code')?>
                                                <?=form_error('premiumReCalculationReq')?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="validationcheck" type="hidden" class="validationcheck" value="" name="validationcheck"/>
                                                <label for="title">Do you want to chnage the premium?</label>
                                                <input type="radio" id="prem_update1" name="prem_update" class="prem_update" value="YES">
                                                <label for="html">YES</label>
                                                <input type="radio" id="prem_update2" name="prem_update" class="prem_update" value="NO">
                                        ...
                                        <div class="row p-2" id="chngPremButton" style="display:none">
                                            <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function(){
        ...
        if(isset($err_return)){
        ?>
        appbigha_btn = <?=set_value('total_applied_area_agricultural_bigha')?>;
        appkatha_btn= <?=set_value('total_applied_area_agricultural_katha')?>;
        applessa_btn= <?=set_value('total_applied_area_agricultural_lessa')?>;
        <?php
        }else{
        ?>
        appbigha_btn=parseFloat($("#total_applied_agri_bigha").val());
        appkatha_btn=parseFloat($("#total_applied_agri_katha").val());
        applessa_btn=parseFloat($("#total_applied_agri_lessa").val());
        <?php }?>
    ...
    $("#finalsave").click(function(){
        ...
        if ($('#totaldue').val().length === 0) {
            theme = "blue";
            $.jAlert({
                'title': 'Error: Field Required',
                'content': 'Total Due Amount can not be blank!!!',
                'theme': theme,
                'backgroundColor': 'white',
                'btns': [
                    {'text':'OK', 'theme':theme}
