    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url() ?>index.php/NcKhasLand/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">

                    <?php
                    $case_no = $this->ncutility->decryptJwtCase($_GET['case']);
                    ?>
                    ...
                    <div class="tab-content">
                        ...
                        Check errors
                                ...
                                <div class="reza-body">
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <td class="text-warning">
                                                    <strong class="alert-warning">
                                                        <input type="text" name="dist_name" class="form-control input-sm" value='<?=$this->ncutility->getDistrictName($basic["dist_code"])?>' readonly>
                                                ...
                                                <td class="text-warning">
                                                    <strong class="alert-warning">
                                                        <input type="text" name="subdiv_name" class="form-control input-sm" value='<?=$this->ncutility->getSubDivName($basic["dist_code"], $basic["subdiv_code"])?>' readonly>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-warning">
                                                    <strong class="alert-warning">
                                                        <input type="text" name="circle_name" value='<?=$this->ncutility->getCircleName($basic["dist_code"], $basic["subdiv_code"], $basic["cir_code"])?>' class="form-control input-sm" readonly>
                                                ...
                                                <td class="text-warning">
                                                    <strong class="alert-warning">
                                                        <input type="text" name="mouza_name" class="form-control input-sm" value='<?=$this->ncutility->getMouzaName($basic["dist_code"], $basic["subdiv_code"], $basic["cir_code"], $basic["mouza_pargona_code"])?>' readonly>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-warning">
                                                    <strong class="alert-warning">
                                                        <input type="text" name="village_name" value='<?=$this->ncutility->getVillageName($basic["dist_code"], $basic["subdiv_code"], $basic["cir_code"], $basic["mouza_pargona_code"], $basic["lot_no"], $basic["vill_townprt_code"])?>' class="form-control input-sm" readonly>
                                    ...
                                    <?php if(ENABLE_MODIFY_MAIN_APPLICANT==1 && !(isset($ekyc_data)) && isset($deceased) && $deceased != 0) { ?>
                                        ...
                                        <script src="<?php echo base_url().'js/NcVillage/changeApplicant.js'?>"></script>
                                        ...
                                        <div class="tableCard" id='applicantData'>
                                            <table class="table table-bordered" id="appRow<?=$settlement->id?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if(NC_ENABLE_APPLICANT_BUTTON == 1): ?>
                                                        <td colspan="2" style="vertical-align : middle;text-align:center;">
                                                            <button type="button" onclick="editApplicantNc(<?=$settlement->id?>, <?=$settlement->is_applicant?>);" class="btn btn-sm btn-warning"><strong>Edit Data</strong></button>
                                    ...
                                    <?php //include(APPPATH."views/NcVillageService/Common/Includes/ekyc_response_page.php");?>
                                            ...
                                            foreach ($dags as $all_dags) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                                                        ...
                                                        <td class="enc-area-color">
                                                            <input readonly type="text" style="text-align: center;" value="<?=$encroachment_area->agriculture->kranti;?>" class="form-control input-sm agri_kr" name="enc_agri_kr<?=$all_dags->dag_no?>" id="enc_agri_kr<?=$all_dags->dag_no?>">
                                                        </td>
                                                    <?php endif;?>
                                                </tr>
                                                <tr class='<?=$hide?>'>
                                                    ...
                                                    <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                                                        ...
                                                        <td class="settlement-area-color">
                                                            <input readonly type="text" style="text-align: center;" value="<?=$all_dags->home_kr;?>" class="form-control input-sm s_dag_area_kr" name="home_kr<?=$all_dags->dag_no?>" onkeyup="totalAreaCal()" id="home_kr<?=$all_dags->dag_no?>">
                                                        </td>
                                                    <?php endif;?>
                                                </tr>
                                                <?php $hide = 'area_show';
                                                ...
                                                <tr class='<?=$hide?>'>
                                                    ...
                                                    <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                                                        ...
                                                        <td class="settlement-area-color">
                                                            <input readonly type="text" style="text-align: center;" value="<?=$all_dags->agri_kr;?>" class="form-control input-sm agri_kr" name="agri_kr<?=$all_dags->dag_no?>" onkeyup="agriArea()" id="agri_kr<?=$all_dags->dag_no?>">
                                                        </td>
                                                    <?php endif;?>
                                                </tr>
                                                ...
                                                <tr style="border-bottom:1px solid #227576">
                                                    <td colspan="2">
                                                        <?php if(NC_ENABLE_AREA_BUTTON == 1){?>
                                                            <button type="button" onclick="editArea(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-warning">Edit Area</button>
                                                        <?php } if(NC_ENABLE_DAG_ELIGIBLE_BUTTON_LM_REVERT == 1){ ?>
                                                            <button type="button" id="deldag<?=$all_dags->id?>" onclick="deleteDagRevert(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-danger"><i class="fa fa-remove" style="color:white"></i> Dag Not Eligible</button>
                                                            <?php ?>
                                                            <button type="button" id="insdag<?=$all_dags->id?>" onclick="insertDagRevert(<?=$all_dags->id?>,<?=$all_dags->dag_no?>);" class="btn btn-sm btn-success" style="display:none" >Eligible</button>
                                                        <?php  }?>
                                                    </td>
                                    ...
                                    <?php if(NC_ENABLE_DAG_CHANGE_BUTTON_REVERT == 1) { ?>
                                        <button type="button" class="btn btn-sm btn-success pull-right"
                                                id="add_new_dag"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW DAG</button>
                                        <br><br>
                                    <?php include(APPPATH."views/NcVillageService/Common/Includes/newDagEntry.php"); ?>
                                        <script src="<?php echo base_url();?>js/NcVillage/newDagEntry.js"></script>
                                    <?php } ?>
                                            ...
                                            <table class="table table-bordered">
                                                <?php $i=1; foreach($property as $adp): ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-warning">
                                                            <strong class="alert-warning">
                                                                <input type="text" name="a_dist_name" class="form-control input-sm" value='<?=$this->ncutility->getDistrictName($adp->dist_code)?>' readonly>
                                                            </strong>
                                                        </td>
                                                        <th>Subdivision Name:</th>
                                                        <td class="text-warning">
                                                            <strong class="alert-warning">
                                                                <input type="text" name="a_subdiv_name" class="form-control input-sm" value='<?=$this->ncutility->getSubDivName($adp->dist_code,$adp->subdiv_code)?>' readonly>
                                                            </strong>
                                                        </td>
                                                        <th>Circle Name: </th>
                                                        <td class="text-warning">
                                                            <strong class="alert-warning">
                                                                <input type="text" name="a_circle_name" value='<?=$this->ncutility->getCircleName($adp->dist_code,$adp->subdiv_code,$adp->cir_code)?>' class="form-control input-sm" readonly>
                                                            </strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-warning">
                                                            <strong class="alert-warning">
                                                                <input type="text" name="a_mouza_name" class="form-control input-sm" value='<?=$this->ncutility->getMouzaName($adp->dist_code,$adp->subdiv_code,$adp->cir_code,$adp->mouza_pargona_code)?>' readonly>
                                                            </strong>
                                                        </td>
                                                        <th>Village Name: </th>
                                                        <td class="text-warning">
                                                            <strong class="alert-warning">
                                                                <input type="text" name="a_village_name" value='<?=$this->ncutility->getVillageName($adp->dist_code,$adp->subdiv_code,$adp->cir_code,$adp->mouza_pargona_code,$adp->lot_no,$adp->vill_townprt_code)?>' class="form-control input-sm" readonly>
                                                            </strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table class="table table-bordered" id="listNextOfKin">
                                                ...
                                                <?php $i = 1;foreach ($nominee as $kin): ?>
                                                    <tr id="sp<?=$kin->id?>">
                                                        ...
                                                        <td>
                                                            <input type="text" readonly name="kin_relation" value="<?=$this->ncutility->appRelationbyIDMB2($kin->relation)?>" class="form-control">
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="tableCard">
                                        <table class="table table-bordered">
                                            <?php foreach ($document as $d): ?>
                                                <tr>
                                                    <th>
                                                        <a target='download' href="<?php echo base_url(); ?>index.php/NcCommonController/document/<?=$d->name;?>"><i class="fa fa-paperclip"></i> <?=$d->file_details;?></a>
                                    ...
                                    <?php
                                    include(APPPATH."views/NcVillageService/Common/Includes/nrcFileUpload.php");
                                    ?>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                                ...
                                <div class="reza-body ">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        <?php $i = 1;foreach ($lmnotes as $lmnote): ?>
                                            ...
                                            <div class="row p-2 " >
                                                <div class="col-md-6">
                                                    <span><strong><?=$sl_count++?>.</strong> VLB verified : whether applicant name is there in VLB</span>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    foreach ($dags as $ddg) {
                                                        ?>
                                                        <i class="fa fa-link" aria-hidden="true"></i>
                                                        <a target='VlbReport' href="<?php echo base_url() . 'index.php/NcCommonController/vlbEncroacherDetails?dag=' . $ddg->dag_no . '&m=' . $basic["mouza_pargona_code"] . '&l=' . $basic['lot_no'] . '&v=' . $basic["vill_townprt_code"] . '&dist=' . $basic["dist_code"] . '&cir=' . $basic["cir_code"] . '&sub_div=' . $basic["subdiv_code"] ?>" target="VlbReport">
                                            ...
                                            <div class="row p-2" >
                                                <div class="col-md-6">
                                                    <span><strong><?=$sl_count++?>.</strong> Caste Verified: whether applicant belongs to the caste as mentioned in application as per the verification of the caste cerficate uploaded?</span>

                                                    <?=form_error('caste_verified')?>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                                class="form-check-input <?php if(form_error('caste_verified')){echo 'lm_invalid';}?>"
                                                                type="radio"
                                                                name="caste_verified"
                                                                id="caste_verified1"
                                                                value="YES"
                                                            <?php if(set_value('caste_verified') == 'YES'){ echo "checked";} 
                                                                if(isset($err_return)){
                                                                    if(set_value('caste_verified') == "YES"){
                                                                        echo "checked";
                                                                    }
                                                                }else{
                                                                    if (trim($lmnote->caste_verified) == "YES"){
                                                                        echo "checked";
                                                                    }
                                                                }?>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            <?php 
                                                            if(isset($err_return)){
                                                                if(set_value('caste_verified') == "NO"){
                                                                    echo "checked";
                                                                }
                                                            }else{
                                                                if (trim($lmnote->caste_verified) == "NO"){
                                                                    echo "checked";
                                                                }
                                                            }?>
                                                        />
                                             ...
                                             <span>
                                                   ...
                                                   Is Encroacher Exists in VLB for <strong><span class="alert-warning">Dag no <?=$encroacher_ext->dag_no?></span></strong>?
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <select name="encroacher_exist_vlb<?=$encroacher_ext->id?>" id="encroacher_exist_vlb<?=$encroacher_ext->id?>" class="form-control <?php if(form_error('encroacher_exist_vlb'.$encroacher_ext->id)){echo 'lm_invalid';}?>">
                                            ...
                                            <div class="row p-2 " >
                                                <div class="col-md-6">
                                 <span><strong><?=$sl_count++?>.</strong> Whether the applicant falls under tribal belt/block category?</span>
                                                ...
                                                <div class="col-md-4" id="tribal_belt_input_id" style="display: none;">
                                                    <input type="text" class="form-control <?php if(form_error('tribal_belt_name')){echo 'lm_invalid';}?>" name="tribal_belt_name" id="tribal_belt_name" placeholder="Enter name of the Tribal belt block">
                                                </div>
                                                    ...
                                                    <div class="row p-2 " >
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <select
                                                                    ...
                                                                    onchange="naturePossessionOther(this, <?=$nature_dag->dag_no?>)"
                                                            >
                                                        ...
                                                        <div class="form-group col-md-3" style="display: none;" id="nature_possession_div_other<?=$nature_dag->dag_no?>">
                                                            <input type="text" placeholder="Enter Nature of possession" name="nature_possession_other<?=$nature_dag->dag_no?>" class="form-control" id="nature_possession_other<?=$nature_dag->dag_no?>">
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- <div class="row p-2 ">
                              <div class="col-md-6">
                                 <span><strong><?=$sl_count++?>.</strong> Whether application is landless</span>
                                 <?=form_error('is_landless')?>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-check form-check-inline">
                                    <input
                                       class="form-check-input <?php if(form_error('is_landless')){ echo 'lm_invalid';}?>"
                                       type="radio"
                                       name="is_landless"
                                       id="is_landless"
                                       value="YES"
                                       <?php if(isset($err_return)){
                                                if(set_value('is_landless') == YES){
                                                    echo "checked";
                                                }
                                            }else{
                                                if(trim($lmnote->is_landless) == YES) {
                                                    echo "checked";
                                                }
                                            }
                                            ?>/>
                                 ...
                                 <div class="form-check form-check-inline">
                                    <input
                                       ...
                                       value="NO" <?php
                                            if(isset($err_return)){
                                                if(set_value('is_landless') == NO){
                                                    echo "checked";
                                                }
                                            }else{
                                                if(trim($lmnote->is_landless) == NO) { echo "checked";}
                                            }
                                            ?>/>
                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                 </div>
                                            ...
                                            <?php
                                            include(APPPATH."views/NcVillageService/Common/Includes/settlementPropertyModalRevert.php");
                                            ?>
                                            ...
                                            <div class="row p-2 " >
                                                <div class="col-md-6">
                                    <span><strong><?=$sl_count++?>.</strong> Whether the proposed land falls within ghy metropolitian authority area or within master plan area of dist head quarter municipality town, rangia, palashbari town, within 5 km from the boundary of dist HQ municipality town not having notified master plan area.</span>
                                 ...
                                 wherever necessary)</span>
                                            ...
                                            <div class="row p-2justify-content-end mt-2">
                                                <div class="col-md-12">
                                 <textarea name="lm_remark_text" class="form-control p-2" id="lm_remark_text" cols="30" rows="13"><?php if(isset($err_return)){ echo set_value('lm_remark_text');
                                     }else{  }?></textarea>
                                                </div>
                                            </div>
                                            <br>
                            ...
                            <?php
                            include(APPPATH."views/NcVillageService/Common/Includes/premium_calculation_modal.php");
                            ?>
                                ...
                                ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <input type="number" readonly onkeyup="zonalValueChange<?=$dagsprem->dag_no?>()" name="zonal_valuation_prem<?=$dagsprem->dag_no?>" id="zonal_valuation_prem<?=$dagsprem->dag_no?>"
                                                                   ...
                                                                   value="<?php if(isset($err_return)){ echo set_value('zonal_valuation_prem'.$dagsprem->dag_no);} else {echo $this->ncutility->getZonalValue($dagsprem->dist_code,$basic['uuid'],$dagsprem->dag_no);} ?>" placeholder="Enter Amount"/>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group col-md-6 ">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <select class="form-control"  name='area<?=$dagsprem->dag_no?>' >
                                                ...
                                                <script>
                                                    ...
                                                    $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                                                        ...
                                                        var total_ganda = parseFloat((appbigha * 6400) + (appkatha * 320) + (applessa * 20) + mganda);
                                                    ...
                                                    $("input[name=concession<?=$dagsprem->dag_no?>]").on("click", function () {
                                                        ...
                                                        var appbigha=agribigha+mbigha;
                                                        var appkatha=agrikatha+mkatha;
                                                        var applessa=agrilessa+mlessa;

                                                        var total_lessa = (appbigha * 100) + (appkatha * 20) + applessa;
                                            ...
                                            <div class="tableCard premhide" style="padding: 25px!important; display:none">
                                                ...
                                                <div class="row premhide hide" style="display:none">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="css">30% Down Payment</label><br>
                                                    </div>
                                                </div>
                                                <div class="row premhide" style="display:none">
...
<script>
    ...
    $("#lm_remark").change(function (event) {
        ...
        if(selectedRemark==1){
            ...
            $('#lm_remark_text').text('');
            <?php if((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
            $('#lm_remark_text').text("আবেদনকাৰী শ্ৰী <?php echo $app_name?> য়ে <?php echo $this->ncutility->getCircleName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"])?> ৰাজহ চক্ৰৰ  <?php echo $this->ncutility->getMouzaName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"])?> মৌজাৰ <?php echo $this->ncutility->getLotName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"],$basic["lot_no"])?>ৰ <?php echo $this->ncutility->getVillageName($basic["dist_code"],$basic["subdiv_code"],$basic["cir_code"],$basic["mouza_pargona_code"],$basic["lot_no"],$basic["vill_townprt_code"])?> <?php echo $lmtown?> ৰাজহ গাওঁৰ চৰকাৰী দাগ নং <?php echo $all_dags?> ত "+$('#sbigha').val()+" বি "+$('#skatha').val()+" ক "+$('#slessa').val()+" চ "+$('#sganda').val()+" গ  ত ভূমি পট্টনৰ বাবে আবেদন কৰিছে।");
...
<?php include(APPPATH."views/NcVillageService/Common/Includes/ekyc_new_appl_modal.php"); ?>
<?php include(APPPATH."views/NcVillageService/Common/Includes/multiple_appl_ekyc.php"); ?>
...
<?php include(APPPATH."views/NcVillageService/Common/Includes/editAreaDetailsNew.php"); ?>
<script src="<?php echo base_url();?>js/NcVillage/editAreaDetailsNew.js"></script>
...
<script>
    $(document).ready(function(){
       ...
       $.ajax({
            url: baseurl+'NcKhasLand/fetchTribalBelt',
            type: "POST",
            data: {case_no: $('#case_no').val()},
            success: function(data) {
                arr = JSON.parse(data);
                $.unblockUI();
                if(arr.responseType != 2){
                    ...
                    if(arr.data.is_tribal_belt == 'YES'){
                        $('#tribal_belt_input_id').show();
                        $('#protected_class_id').show();

                        $('#tribal_belt_name').val(arr.data.tribal_belt_name);
                    }

                    for(i=0; i<arr.data1.length; i++){
                        if(arr.data1[i].nature_possession == 'Others'){
                            $('#nature_possession_div_other'+arr.data1[i].dag_no).show();
                            $('#nature_possession_other'+arr.data1[i].dag_no).val(arr.data1[i].nature_of_possession_other);
                        }
    ...
    function naturePossessionOther(elm, dag_no){
        if(elm.value == 'Others'){
            $('#nature_possession_div_other'+dag_no).show();
        }else{
            $('#nature_possession_div_other'+dag_no).hide();
        }
    }
</script>