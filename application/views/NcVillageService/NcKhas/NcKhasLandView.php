    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url() ?>index.php/NcKhasLand/applicationKhaslandRegistration?app=<?=$_GET['app']?>" enctype="multipart/form-data">
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            foreach ($dags as $all_dags) {
                                                ...
                                                <tr style="border-bottom:1px solid #227576">
                                                    <td colspan="2">
                                                        <?php if(NC_ENABLE_AREA_BUTTON_LM == 1):?>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if(NC_ENABLE_DAG_ELIGIBLE_BUTTON == 1) :?>
                                                            <?php if($dag_count>1): ?>
                                                    ...
                                                    <td colspan="2" class="text-right">
                                                        <a type="button" target="_blank" class="btn-sm  buttInfo" href="<?php echo base_url(); ?>index.php/NcCommonController/apiDagWiseApplication?app=<?=$basic["applid"];?>&dag=<?=$all_dags->dag_no;?>" style="text-decoration: none">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            id="caste_verified2"
                                                            value="NO"
                                                        <?php if(set_value('caste_verified') == 'NO'){ echo "checked";} ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                            </div>
