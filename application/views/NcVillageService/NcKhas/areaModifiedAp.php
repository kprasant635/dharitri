    ...
    foreach ($area_modified as $areaMod) {
        ?>
                ...
                <ul>
                    ...
                    <ul>
                        <li>
                            <a href=""><span><i class="icon-time"></i> Homestead</span> &ndash; B: <?=$areaMod->nr_bigha?> K: <?=$areaMod->nr_katha?> L: <?=$areaMod->nr_lessa?>
                        
                        <?php if (in_array($this->session->userdata('dist_code'), json_decode(BARAK_VALLEY))) {
                            ?>
                            G: <?=$areaMod->nr_ganda?> K: <?=$areaMod->nr_kranti?>
                            <?php
                        }
        ?>
                            </a>
                    ...
                    <ul>
                        <li>
                        <a href=""><span><i class="icon-time"></i> Homestead</span> &ndash; 
                            B: <?=$areaMod->s_dag_area_b?> K: <?=$areaMod->s_dag_area_k?> L: <?=$areaMod->s_dag_area_lc?>
                            <?php if (in_array($this->session->userdata('dist_code'), json_decode(BARAK_VALLEY))) {
                                ?>
                                G: <?=$areaMod->s_dag_area_g?> K: <?=$areaMod->s_dag_area_kr?>
                                <?php
                            }
        ?>
