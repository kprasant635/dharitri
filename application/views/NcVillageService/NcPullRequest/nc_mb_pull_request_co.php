...
<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        <h4 style="text-align: center;">
            All Nc Cases for Modification Request
        </h4>
    </div>
            ...
            <th>Mouza
                <select class="form-control" name="mouza_cat" id="mouza_cat">
                    ...
                    <?php if(isset($select_data)){ foreach($select_data as $select){?>
                        <option value="<?=$select->mouza_pargona_code?>"><?=$this->ncutility->getMouzaName($select->dist_code, $select->subdiv_code, $select->cir_code, $select->mouza_pargona_code)?></option>
                    <?php }}?>
                </select>
            </th>
            <th>Lot
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/NcModification/paginationForPullRequest',
                    type:'POST',
                    data: {
...
<script type="text/javascript">
    ...
    $('#ajaxMappingForm').submit(function (e) {
        ...
        $.ajax({
            url: baseurl + "NcModification/checkWhetherPullRequestByCO",
            type: 'POST',
