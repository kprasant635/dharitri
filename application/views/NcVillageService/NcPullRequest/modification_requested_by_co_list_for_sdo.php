    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                ...
                <hr>
                <span>Modification Requested Nc Application By CO</span>
            </div>
                            ...
                            <th>Location
                                <select class="form-control" name="category" id="category">
                                    ...
                                    <?php if(isset($select_data)){ foreach($select_data as $select){?>
                                        <option value="<?=$select->vill_townprt_code?>"><?=$this->ncutility->getVillageName($select->dist_code, $select->subdiv_code, $select->cir_code, $select->mouza_pargona_code, $select->lot_no, $select->vill_townprt_code)?></option>
                                    <?php }}?>
                                </select>
                            </th>
                            <th>Action</th>
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/NcModification/paginationForModificationRequestApplicationByCoForSdo',
                    type:'POST',
                    data: {
