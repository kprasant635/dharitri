...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
        ...
        <a href="<?= base_url()?>index.php/NcKhasLandSdo/getAllProposalListSdlacKhasSdo">
...
<script>
    ...
    $(document).on('click','#finalSubmit',function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandSdo/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandSdo/sdlacReportOnlineApprove",
            type: "post",
            ...
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/NcKhasLandSdo/getAllProposalListSdlacKhasSdo";
                }
                })
                }
                else
