...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            ...
            <a href="<?= base_url()?>index.php/NcKhasLandSdo/viewNcKhasFirstProceedingCaseListSdo">
                <?php echo $this->lang->line('ncFirstProceeding') ?>
            </a>
            / Application Details
        ...
        <section>
            ...
            <div class="wizard">
                ...
                <div class="tab-content">
                    ...
                    <?php include(APPPATH."views/NcVillageService/NcKhas/applicationKhasView.php"); ?>


                    <div class="tab-pane" role="tabpanel" id="step5">
                        <h5 class="bg-info p-2 text-white shadow" style="margin-top: 10px">
                            <?php echo $this->lang->line('ncKhasLandTitle')?> (
                            ...
                            <div class="reza-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12"  style="margin-bottom: 40px">
                                        <?php
                                        include(APPPATH."views/NcVillageService/NcKhas/areaModified.php");
                                        include(APPPATH."views/NcVillageService/NcKhas/encroacherEligibility.php");
                                        ?>
                                        <h5 class="reza-title" style="margin-top: 15px">
                                                                            ...
                                                                            <?php if ($singleChithaArea->dag_no == $singleReservedArea->dag_no): ?>
                                                                                <ul>
                                                                                    ...
                                                                                    <span class="rezaCaseSpan">
                                                                                        <a target="_blank" href="<?php echo base_url(); ?>index.php/NcCommonController/viewApplicationDetailsOnly/?case=<?php echo $singleReservedArea->case_no; ?>" style="text-decoration: none">
                                                                                ...
                                                                                $totalApproveLessa = $this->ncutility->Total_Lessa($totalApproveB,$totalApproveK,$totalApproveL);
                                                                                $totalApproveLessaInBKL  = $this->ncutility->Total_Bigha_Katha_Lessa($totalApproveLessa);
                                                                                if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY))))
                                                                                {
                                                                                    $totalApproveGanda = $this->ncutility->Total_ganda($totalApproveB,$totalApproveK,$totalApproveL,$totalApproveG);
                                                                                    $totalApproveLessaInBKCG = $this->ncutility->Total_Bigha_Katha_Lessa2($totalApproveGanda);
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <?php foreach ($single as $singleReservedArea): ?>
                                                                            <?php if ($singleChithaArea->dag_no == $singleReservedArea->dag_no): ?>
                                                                                <?php if ($singleChithaArea->status != 'Z'): ?>
                                                                                    ...
                                                                                    $totalLessa = $this->ncutility->Total_Lessa($totalLmProB,$totalLmProK,$totalLmProL);
                                                                                    $totalLessaInBKL  = $this->ncutility->Total_Bigha_Katha_Lessa($totalLessa);
                                                                                    if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY))))
                                                                                    {
                                                                                        $totalGanda = $this->ncutility->Total_ganda($totalLmProB,$totalLmProK,$totalLmProL,$totalLmProG);
                                                                                        $totalLessaInBKCG = $this->ncutility->Total_Bigha_Katha_Lessa2($totalGanda);
                                                                                    }
                                                                                    ?>
                                                                                <?php endif; ?>
                                                                            <?php endif; ?>
                                                                        ...
                                                                        <span class="rezaCaseSpan">
                                                                            ...
                                                                            <b><?php echo $singleReservedArea->s_dag_area_k ?></b>
                                                                                ...
                                                                                <b><?php echo $singleReservedArea->s_dag_area_lc ?></b>
                                                                                    ...
                                                                                    $totalLessaNotSub = $this->ncutility->Total_Lessa($totalLmProBNotSub,$totalLmProKNotSub,$totalLmProLNotSub);
                                                                                    $totalLessaInBKLNotSub  = $this->utilityclass->Total_Bigha_Katha_Lessa($totalLessaNotSub);
                                                                                    if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY))))
                                                                                    {
                                                                                        $totalGandaNotSub = $this->ncutility->Total_ganda($totalLmProBNotSub,$totalLmProKNotSub,$totalLmProLNotSub,$totalLmProGNotSub);
                                        ...
                                        <?php
                                        include(APPPATH."views/NcVillageService/NcKhas/village_wise_area_show_co.php");
                                        ?>
                                        ...
                                        <?php if($appAreaMoreThanDagArea == 1): ?>
                                            <h5 style="color: red; font-weight: bold; padding-top: 30px; padding-bottom: 15px; text-align: center" >
                                                Total applied area should not be more than total Dag Area !
                                            </h5>
                                            <br>
                                        <?php elseif($appAreaMoreThanDagSingle == 1): ?>
                                            <h5 style="color: red; font-weight: bold; padding-top: 30px; padding-bottom: 15px; text-align: center" >
                                                Applied area should not be more than Dag Area !
                                            </h5>
                                            <br>
                                        <?php endif; ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if(NC_CASE_PROCESS_STATUS_FOR_DC_ADC_SDO == 1 ):  ?>

                                            <?php foreach($applicants_encroacher as $enc_lst): ?>
                                                <?php if($enc_lst->encroacher_exist_vlb == 4): ?>
                                                    <?php $enc_not_eligible = true; break; ?>
                                                <?php endif; ?>
                                            <?php endforeach; ?>

                                            <?php if(isset($enc_not_eligible)): ?>

                                                <button class="rezaButt buttPrimary" id="revertFromDcToCo">
                                                    <i class="fa fa-level-down" aria-hidden="true"></i>
                                                    <?php echo $this->lang->line('revertToCO') ?>
                                                </button>
                                                <button class="rezaButt buttDanger" onclick="showNewDirectRejectModalMb2('<?php echo $_GET['case']?>','<?= NC_KHAS_LAND_ID ?>')">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if($caseDetails->status == MB_PENDING OR $caseDetails->status == MB_RE_REPORT OR $caseDetails->status == MB_REVERT OR $caseDetails->status == MB_UNDER_CONSIDERATION) :?>
                                                    <?php if($areaCheck == 0 && $checkAppliedArea == 0 && $appAreaMoreThanDagArea == 0 && $appAreaMoreThanDagSingle == 0):?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                <h3>Are You Sure !</h3>
                <br>
                <h5>You want to remove this application from SDLAC/CDLAC marking</h5>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandSdo/markApplicationForSDLACSdo",
            type: "post",
            dataType: "json",
            ...
            success: function (data) {
                ...
                {
                    showErrorMessage("Application Already Send to SDLAC/CDLAC Committee!");
                }
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandSdo/removeMarkApplicationForSDLACSdo",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
                ...
                {
                    $('.rezaButt').hide();
                    showSuccessMessage("Application successfully removed from SDLAC/CDLAC Recommended List");
                }
                else if (data.responseType == 3)
                {
                    showErrorMessage("Data not found !");
    ...
    $(document).on('click','#putUnderConsiderModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonSdoAdcDc/applicationPutUnderConsideration",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    {
                        $('.rezaButt').hide();
                        showSuccessMessage("Application successfully put under SDLAC/CDLAC Consideration");
                    }
                    else if (data.responseType == 101)
                    {
                        showErrorMessage(data.message);
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcKhasLandSdo/applicationRevertFromSdoToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
