...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            ...
            / <?php echo $this->lang->line('SDLACNcMarkApp') ?> / List
        ...
        <div class="reza-card">
            <div class="reza-title">
                ...
                <hr>
                <span><?php echo $this->lang->line('SDLACMarkNcCases') ?></span>
            </div>
            ...
            <div class="reza-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="left">
                        <?php if(ENABLE_BUTTON_SEND_TO_SDLAC_NC == 1): ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select class="form-control" id="added_sdlac_member">
                                    ...
                                    <?php $i=1; foreach($committeeList as $mem) { ?>
                                        <?php if($mem->user_type == 'MLA' && in_array($this->session->userdata("dist_code").'_'.$mem->user_code, SDLAC_MEM_MLA_NOMINEE_ALLOW_NC)) :?>
                                            <option value="<?= $mem->user_code ?>"><?= $mem->name ?></option>

                                        <?php elseif(in_array($mem->user_type,SDLAC_MEM_NOMINEE_ALLOW_NC)) : ?>
                                            <option value="<?= $mem->user_code ?>"><?= $mem->name ?></option>
...
<div class="modal" role="dialog" id="sendToSDLACModal">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                    Recommended Nc Cases For Make Proposal
                </h5>
            </div>
            <div class="modal-body" >
                <form action="">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Hearing Date <span style="color: red; font-weight: bold">*</span>
                                <?php if(MEETING_PROPOSAL_SDLAC_NOTICE_HOLD_NC == 1): ?>
                                    <span style="color: #EF5350; font-weight: bold">
                                        ( Maximum Date of processing <?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_SHOW_NC ?> )
                                    </span>
                                <?php endif; ?>
                            </label>
                            <?php if(MEETING_PROPOSAL_SDLAC_NOTICE_HOLD_NC == 1): ?>
                                <input type="datetime-local" class="form-control" name="w3date" id="date" required  max="<?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_INPUT_NC ?>"> </input>
                            <?php else: ?>
...
<script type="text/javascript">
    ...
    $('#cir_id').change(function()
    {
        ...
        $.ajax({
            url: base_url+'index.php/NcCommonSdoAdcDc/NcVillageListCommon',
            dataType: 'json',
            data: {
                subdiv_code: subdiv,
                cir_code: circle,
    ...
    function load_data(){
        var base_url     = "<?php echo base_url();?>";
        var service_code = <?= NC_KHAS_LAND_ID ?>;
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/NcKhasLandSdo/secondProceedingSdlacRecommendedMarkedSdo',
                type:'POST',
                data: {
...
<script>
    ...
    $('#insertNominee').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcCommonSdoAdcDc/insertNomineeDetailOfSdlacMember",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcKhasLandSdo/sendAllMarkAppToSDLACBySdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcKhasLandSdo/generateNoticeSendAllMarkAppToSDLACByDcKhasSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
