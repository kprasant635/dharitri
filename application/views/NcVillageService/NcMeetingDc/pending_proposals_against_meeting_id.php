...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/NcMeetingDc/pendingMeetingList'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?php foreach ($additionalDoc as $docs): ?>
                                ...
                                <a target='download' href="<?php echo base_url(); ?><?=$docs->file_path;?>" style="padding-right: 20px">
                ...
                <table class="datatable table table-stripped" id='datatable'>
                    ...
                    <?php $j=1; foreach($proposal_detail as $prop){ ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" target= "SDLACProposalNotice" href="<?=base_url()?>index.php/NcCommonSdoAdcDc/getProposalNotice/?case=<?=$prop->proposal_id?>">
...
<script type="text/javascript">
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcMeetingDc/postAdditionalFileUnderMeetingDc",
                type: "post",
