                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo base_url(); ?>index.php/NcMeetingDc/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->id; ?>"
                                        ...
                                        <?php if($meeting->file_minute_path != '' && $meeting->file_minute_path != NULL): ?>
                                            <a href="<?php echo base_url(); ?>index.php/NcMeetingDc/viewSdlacUploadedMinute/?meetingId=<?php echo $meeting->id; ?>"
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo base_url(); ?>index.php/NcMeetingDc/viewSdlacAttendance/?meetingId=<?php echo $meeting->id; ?>"
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo base_url(); ?>index.php/NcMeetingDc/getResigningProposalsAgainstMeetingId/?meetingId=<?php echo $meeting->id; ?>"
...
<script type="text/javascript">
    ...
    $('.showMinutesGenerateModal').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcMeetingDc/generateResignDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcMeetingDc/verifyAreaForResignMinutes",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCases(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcMeetingDc/deleteProposalWithZeroCasesByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcMeetingDc/digitalResignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "NcMeetingDc/resignedFinalUpdatedMeetingByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
