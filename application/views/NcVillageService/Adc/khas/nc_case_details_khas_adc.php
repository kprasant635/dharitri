...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            ...
            <a href="<?= base_url()?>index.php/NcKhasLandAdc/NcKhasLandLandingPageAdc">
                <?php echo $this->lang->line('ncKhasLink') ?>
            </a> /
            <a href="<?= base_url()?>index.php/NcKhasLandAdc/viewNcKhasFirstProceedingCaseListAdc">
                            ...
                            <div class="reza-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <div class="row">
                                            <?php if($caseDetails->approve_by != '' || $caseDetails->approve_by != NULL): ?>

                                                <span style="font-weight: bold; color: Red; padding-bottom: 20px">
                                                        Final approval of this application will be given by the
                                                    <?php if($caseDetails->approve_by == 'DC'): ?>
                                                        DC
                                                    <?php elseif($caseDetails->approve_by == 'GOVT'): ?>
                                                        Department
                                                    <?php else: ?>
                                                        NA
                                                    <?php endif;?>
                                        ...
                                        <?php if(NC_CASE_PROCESS_STATUS_FOR_DC_ADC_SDO == 1 ):  ?>
                                            ...
                                            <?php if(isset($enc_not_eligible)): ?>
                                                ...
                                                <button class="rezaButt buttDanger" onclick="showNewDirectRejectModalMb3('<?php echo $_GET['case']?>','<?= NC_KHAS_LAND_ID ?>')">
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandAdc/markApplicationForSDLACAdc",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandAdc/removeMarkApplicationForSDLACAdc",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcKhasLandAdc/applicationRevertFromAdcToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
