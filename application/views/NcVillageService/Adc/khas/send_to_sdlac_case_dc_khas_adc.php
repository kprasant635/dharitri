...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
        ...
        <a href="<?= base_url()?>index.php/NcKhasLandAdc/getAllProposalListSdlacKhasAdc">
        ...
        <div class="reza-title">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="hidden" id="service_code" value="<?= NC_KHAS_LAND_ID ?>">

                    <?php echo $this->lang->line('sendingToSDLACByDc') ?> ( <?=$proposalDetails->proposal_name?> )
                </div>
                ...
                <table class='table table-striped table-bordered tablesorter  pageshowpage unicode'  width="100%">
                    ...
                    <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                        <tr>
                            <td><?php echo $i ?> </td>
                            <td>
                                <a href="<?php echo base_url('index.php/NcKhasLandAdc/getNcKhasApplicationDetailsAdc/?case=').$case->case_no ?>" class="">
                                    <?php echo $case->case_no; ?>
                                </a>

                                <br>
                                <span class='small font-italic red'><?php if ($case->case_no) {
                                        echo "Basundhara:" . $this->ncutility->getApplidFromCaseNo($case->case_no);
                                    } ?> </span>
                            </td>
                            <td class="center">
                                <?php echo $this->ncutility->getCircleName($case->dist_code, $case->subdiv_code, $case->cir_code) ?>
                                <br>
...
<script>
    ...
    function report_no(id, case_no)
    {
        ...
        showNewRejectModalMb2(case_no, '<?php echo NC_KHAS_LAND_ID ?>')
    }
    ...
    $(document).on('click','#finalSubmit',function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandAdc/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/NcKhasLandAdc/sdlacReportOnlineApprove",
            type: "post",
            ...
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/NcKhasLandAdc/getAllProposalListSdlacKhasAdc";
                }
                })
                }
                else
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonSdoAdcDc/applicationRemoveFromProposal",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
