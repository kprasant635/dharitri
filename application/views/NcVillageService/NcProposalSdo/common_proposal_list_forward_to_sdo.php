    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right" >
                <a class="rezaButt rezaPrint pull-right" href="<?=base_url().'index.php/NcCommonProposalSdo/addEditCopyToNc'?>">
        ...
        <div class="reza-card">
            <div class="reza-body">
                ...
                <?php if($countPendingCase != 0){ ?>
                    <div class="row">
                        <?php if(SEND_PROPOSAL_TO_SDLAC_MEM_BUTTON_NC == 1) { ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="datetime-local" class="form-control"
                                       name="meeting_date" id="meeting_date" required max="<?php echo MEETING_PROPOSAL_SDLAC_NOTICE_DATE_INPUT_NC ?>">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="rezaText" style="padding-left: 10px; padding-right: 10px">
                                ...
                                extant guidelines laid down in Mission Basundhara 3.0 Under Svamitva, Land Policy, 2019 and verification of
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/NcCommonProposalSdo/listOfProposalsAllServicesSdo',
                type : 'POST',
                data : {
                    circle       : circle,
                    subdiv       : subdiv,
    ...
    function openTab(id)
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcCommonProposalSdo/getCasesAgainstProposalNoSdlac",
            dataType: "JSON",
            data: {id : id},
            type: "POST",
            success: function(data) {
...
<script type="text/javascript">
    ...
    $("#openModalForFinalSubmit").click(function()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalSdo/checkAllSdlacPresentMember",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        {
            $.ajax({
                url: BASE_URL + "/NcCommonProposalSdo/sendProposalsToDcMinute",
                type: "post",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            {
                $.ajax({
                    url: BASE_URL + "/NcCommonProposalSdo/sendProposalsToDc",
                    type: "post",
                    enctype: 'multipart/form-data',
                    contentType: false,
                    cache: false,
