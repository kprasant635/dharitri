...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/NcCommonProposalSdo/forwardedMeetingListForSdo'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
            ...
            <div class="reza-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr style="background-color:white;">
                        <th style="width: 175px">Meeting ID</th>
                        <td><?=$meeting->meeting_name?></td>
                        <th style="width: 175px">Meeting Venue</th>
                        <td><?=$meeting->meeting_venue?></td>
                    </tr>
                    <tr>
                        <th style="width: 175px">Meeting Held On</th>
                        <td><?=date('d M Y', strtotime($meeting->meeting_date))?></td>
                        <th style="width: 175px">Forwarded By</th>
                        <td><?=$meeting->created_by?></td>
                    </tr>
                    <tr>
                        <th colspan="1" style="width: 175px">Meeting Remarks</th>
                        <td colspan="3"><?=$meeting->meeting_remarks?></td>
                    </tr>

                    <tr>
                        <th colspan="1" style="width: 175px">Digital Minutes</th>
                        <td colspan="3">
                            <?php if($meeting->digital_sign_status == 1): ?>
                                <a href="<?php echo base_url(); ?>index.php/NcCommonSdoAdcDc/getDigitalMinutesWithMeetingId/?meetingId=<?php echo $meeting->id; ?>"
                                   class="rezaButt btn btn-sm " style="color: #FFF; background-color: #9C27B0;" target="DigitalMinutes">
                                    <i class="fa fa-download" aria-hidden="true"></i> &nbsp;Download
                                </a>
                            <?php else: ?>
                                Pending for Digital Signing
                            <?php endif; ?>
                        </td>
                    </tr>
                    ...
                    <?php if($meeting->file_minute_path != '' && $meeting->file_minute_path != NULL): ?>
                        ...
                        <th colspan="1" style="width: 175px">Uploaded Minutes</th>
                        <td colspan="3">
                            <a href="<?php echo base_url(); ?>index.php/NcCommonSdoAdcDc/viewSdlacUploadedMinute/?meetingId=<?php echo $meeting->id; ?>"
                    ...
                    <tr>
                        <th colspan="1" style="width: 175px">Attendance</th>
                        <td colspan="3">
                            <a href="<?php echo base_url(); ?>index.php/NcCommonSdoAdcDc/viewSdlacAttendance/?meetingId=<?php echo $meeting->id; ?>"
                ...
                <table class="datatable table table-stripped" id='datatable'>
                    ...
                    <?php $j=1; foreach($proposal_detail as $prop){ ?>
                        <tr>
                            ...
                            <td><?=$this->ncutility->getServiceName($prop->service_code)?></td>
                            <td>
                                <a class="btn btn-sm btn-primary" target= "SDLACProposalNotice" href="<?=base_url()?>index.php/NcCommonSdoAdcDc/getProposalNotice/?case=
                                <?php  echo $prop->proposal_id ?>">
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=1;  foreach($sdlac_member as $mem) { ?>
                        <tr>
                            ...
                            <td>
                                <?=$this->ncutility->getNameOfUserByUserCode($mem->sdlac_member_code)?>

                                (<?=$this->ncutility->getDesignationNameByUserCode($mem->sdlac_member_code)->user_desig?>)
                            </td>
                            <td align="center">
                                <?php if($mem->nominee_id==0) : ?>
                                    --
                                <?php else: ?>
                                    <?php echo $this->ncutility->getNomineeNameOfNomineeId($mem->nominee_id) ?>
                                <?php endif; ?>
                            </td>
                            <td><?=$mem->emailid?></td>
                            <td align="center">
...
<script type="text/javascript">
    ...
    function btnCaseView(propId)
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcMeetingDc/viewCasesAgainstProposalNo",
            type: "post",
            dataType: "json",
