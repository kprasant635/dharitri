...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-left: 25px">
        Process /
        Settlement MB /
        <a href="<?= base_url()?>index.php/NcCommonProposalSdo/revertMeetingListForSdo">Reverted Meeting </a> /
        Proposals

        <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/NcCommonProposalSdo/revertMeetingListForSdo'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
                        ...
                        <?php $i=1; foreach ($proposals as $proposal): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="rezaButt buttSuccess"  target= "SDLACProposalNotice" href="<?php echo base_url(); ?>index.php/NcCommonProposalSdo/caseListUnderRevertedMeetingForSdo/?proposal=<?php echo $proposal->id ?>">
...
<script>
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalSdo/postAdditionalFileUnderMeetingSdo",
                type: "post",
    ...
    $("#verifyCases").click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcCommonProposalSdo/verifyCasesUnderRevertedMeetingByDc",
            type: "post",
            dataType: "json",
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcCommonProposalSdo/sendRevertedProposalsToDcMinute",
            type: "post",
            enctype: 'multipart/form-data',
            contentType: false,
            cache: false,
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalSdo/sendRevertedProposalsToDc",
                type: "post",
                enctype: 'multipart/form-data',
                contentType: false,
                cache: false,
    ...
    function deleteProposalWithZeroCases(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalSdo/deleteProposalWithZeroCasesBySdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
