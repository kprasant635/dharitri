    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url()?>index.php/NcTribal/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    if ($basic == true) { ?>
                                                        ...
                                                        <tr>
                                                            <th>Caste</th>
                                                            <td>
                                                                <select name="caste" id="" class="form-control" disabled>
                                                                    <?php
                                    ...
                                    <?php $i=1; foreach($lmnotes as $lmnote):?>
                                        <div class="tableCard">
                                                    ...
                                                    <?php if(form_error('protected_class_lm')){echo 'lm_invalid';}?>" required>
                                                        <?php foreach(json_decode(PROTECTED_CLASS) as $class): ?>
                                                            <option value="<?php echo $class->CODE ?>"
                                                                ...
                                                                elseif($lmnote->protected_class_lm == $class->CODE){
                                                                    echo "selected";
                                                                }
                                                                ?>>
                                                                <?php echo $class->NAME ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                                ...
                                                                id="landed_property1"
                                                                value="YES"
                                                            <?php if(set_value('litigation') == 'YES'){ echo "checked";}elseif($lmnote->litigation == 'YES'){echo "checked";} ?>
                                                        />
                                                        <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                                ...
                                                                id="landed_property2"
                                                                value="NO"
                                                            <?php if(set_value('litigation') == 'NO'){ echo "checked";}elseif($lmnote->litigation == 'NO'){echo "checked";} ?>
                                                        />
                                                        <label class="form-check-label" for="inlineRadio2">No</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <select name="land_falls" id="land_falls" class="form-control <?php if(form_error('land_falls')){echo 'lm_invalid';}?>" required>
                                                        <?php foreach(json_decode(LB_NATURE_OF_RESERVATION) as $landCode): ?>
                                                            <option value="<?php echo $landCode->CODE ?>"
                                                                <?php if(set_value('land_falls') == $landCode->CODE){ echo "selected";}elseif($lmnote->land_falls == $landCode->CODE){echo "selected";} ?>>
                                                                <?php echo $landCode->NAME ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="lm_note" id="lm_remark" class="form-control">
                                                        <?php
                                            ...
                                            <div class="row p-2 justify-content-end" style="padding-bottom: 15px!important;">
                                                <div class="col-md-12">
                                                    <textarea name="lm_remark_text" placeholder="Enter remark..." class="form-control" id="lm_remark_text" cols="30" rows="11"></textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            ...
                                                            <td width="50%" style="font-weight: bold"> Premium Due (Rs) </span></td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="tableCard " style="padding: 25px!important;">
                                            <?php foreach ($premium_data as $dagsprem) {?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input type="text" class="form-control" value="<?=$dagsprem->area?>" readonly>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <input type="text" class="form-control" value="<?=$dagsprem->land_type?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6 ">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <input type="text" class="form-control"  value="<?=$dagsprem->house_type?>" readonly>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input  type="hidden" class="finalper<?=$dagsprem->dag_no?>" value=""  />
                                                        <input  type="hidden" class="total_lessa<?=$dagsprem->dag_no?>" value=""  />
                                                        <input type="text" class="form-control" value="<?=$dagsprem->amount_dag?>" readonly />
                                                    </div>
                                                </div>
                                            <?php }?>
                                            ...
                                            <div class="tableCard" style="padding: 25px!important;">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input type="text" class="form-control" value="<?=$dagsprem->final_amount?>" readonly>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input type="text" class="form-control" value="<?=$dagsprem->due_amount?>" readonly>
                                                    </div>
