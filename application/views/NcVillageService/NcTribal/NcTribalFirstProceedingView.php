    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form class="lmForm" role="form" method="post" action="<?php echo base_url()?>index.php/NcTribal/TribalApplicationRegistration?app=<?=$_GET['app']?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="reza-card">
                                ...
                                <div class="reza-body">
                                                    ...
                                                    if ($basic == true) { ?>
                                                        ...
                                                        if($basic['protected_class']):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select disabled name="protected_class" id="" class="form-control">
                                                                        <?php
                                    ...
                                    <?php if($applicants_riotee_nok == true) { ?>
                                        ...
                                        <div class="tableCard">
                                            <table class="table table-bordered">
                                                <?php   foreach($applicants_riotee_nok as $riotee_nok) {  ?>
                                                    <tr>
                                    ...
                                    <?php foreach($dags as $dagspremlm){ ?>
                                        ...
                                        <strong><?=form_error('total_applied_area_error');?></strong>
                                        <table class="table mb-0">
                                            ...
                                            <tr style="border-bottom:1px solid #227576">
                                                <td>
                                                    ...
                                                    <?php }
                                                    if(ENABLE_DAG_ELIGIBLE_BUTTON != 0){
                                                        if($dag_count>1){?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input readonly type="text" style="text-align: center;" name="total_applied_area_agricultural_bigha" class="form-control input-sm ag_dag_area_b"  id="total_applied_agri_bigha"
                                                           value="<?php if(isset($err_return)) {
                                                               echo set_value('total_applied_area_agricultural_bigha');
                                                           } else {
                                                               echo $total_agri_bigha;
                                                           }?>">
                                                </td>
                                                <td>
                                                    <input readonly type="text" style="text-align: center;" name="total_applied_area_agricultural_katha" value="<?php if(isset($err_return)) {
                                                        echo set_value('total_applied_area_agricultural_katha');
                                                    } else {
                                                        echo $total_agri_katha;
                                                    }?>" id="total_applied_agri_katha"  class="form-control input-sm ag_dag_area_k" >
                                                </td>
                                                <td>
                                                    <input readonly type="text" style="text-align: center;" name="total_applied_area_agricultural_lessa" class="form-control input-sm ag_dag_area_lc" id="total_applied_agri_lessa"  value="<?php if(isset($err_return)) {
                                                        echo set_value('total_applied_area_agricultural_lessa');
                                                    } else {
                                                        echo $total_agri_lessa;
                                                    }?>" >
                                                </td>
                                                <?php if ((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))): ?>
                                                    <td>
                                                        <input readonly type="text" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                            echo set_value('total_applied_area_agricultural_ganda');
                                                        } else {
                                                            echo $total_agri_ganda;
                                                        }?>" class="form-control input-sm ag_dag_area_g" id="total_applied_agri_ganda"  name="total_applied_area_agricultural_ganda" >
                                                    </td>
                                                    <td class="hide">
                                                        <input readonly type="text" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                            echo set_value('total_applied_area_agricultural_kranti');
                                                        } else {
                                                            echo $total_agri_kranti;
                                                        }?>" class="form-control input-sm ag_dag_area_kr" id="total_applied_agri_kranti"  name="total_applied_area_agricultural_kranti" >
                                                    </td>
                                                <?php endif;?>
                                            </tr>
                                        ...
                                        <!-- this only to display the error message in area validation -->
                                        <span class="<?php if(form_error('totalAppliedAreaZeroCheck')) {
                                            echo 'is-invalid';
                                        }?>"></span>
                                        <strong><?=form_error('totalAppliedAreaZeroCheck');?></strong>
                                        <span class="<?php if(form_error('appAreaMoreThanDagA')) {
                                            echo 'is-invalid';
                                        }?>"></span>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                            ...
                            <div class=reza-card>
                                <div class="reza-body">
                                    ...
                                    <div class="tableCard ">
                                        ...
                                        <div class="row p-2" >
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                foreach ($encroachers as $ddg) {
                                                    ?>
                                                    <i class="fa fa-link" aria-hidden="true"></i>
                                                    <a target='VlbReport' href="<?php echo base_url() . 'index.php/SettlementTribal/vlbEncroacherDetails?dag=' . $ddg->dag_no . '&m=' . $app['mouza_pargona_code'] . '&l=' . $app['lot_no'] . '&v=' . $app['vill_townprt_code'] . '&dist=' . $app['dist_code'] . '&cir=' . $app['cir_code'] . '&sub_div=' . $app['subdiv_code'] ?>" target="VlbReport">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                    <span><strong><?=$sl_count++?>.</strong> Schedule of the land and area under
                                        occupation</span>
                                                <?=form_error('possession_verification')?>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input <?php if(form_error('possession_verification')) {
                                                        echo 'lm_invalid';
                                                    }?>"
                                                           type="radio" name="possession_verification"
                                            ...
                                            foreach($applicants_encroacher as $encroacher_ext){
                                                ...
                                                <div class="row p-2" >
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <select name="encroacher_exist_vlb<?=$encroacher_ext->id?>" id="encroacher_exist_vlb<?=$encroacher_ext->id?>" data-id="<?=$encroacher_ext->dag_no?>" class="form-control clsencdata <?php if(form_error('encroacher_exist_vlb'.$encroacher_ext->id)){echo 'lm_invalid';}?>">
                                      ...
                                      <span><strong><?=$sl_count++?>.</strong>
                                        ...
                                        <div class="row p-2" >
                                            <div class="col-md-6">
                                      <span><strong><?=$sl_count++?>.</strong> Landed property of the petitioner and
                                          his family (if any) within the State</span>
                                      ...
                                      <span><strong><?=$sl_count++?>.</strong> Whether the proposed land falls under
                                        ...
                                        <div class="row p-2" >
                                            <div class="col-md-6">
                                      <span><strong><?=$sl_count++?>.</strong>
                                        Whether proposed land is free from Encroachment</span>
                                                <?=form_error('is_free_encroachment')?>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">

                                                    <input
                                                            class="form-check-input <?php if(form_error('is_free_encroachment')) {
                                                                echo 'lm_invalid';
                                                            }?>"
                                                            type="radio"
                                                            ...
                                                            value="YES"
                                                        <?php if(set_value('is_free_encroachment') == 'YES') {
                                                            echo "checked";
                                                        }
                                                        ?>
                                                    />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            value="NO"
                                                        <?php if(set_value('is_free_encroachment') == 'NO') {
                                                            echo "checked";
                                                        }
                                                        ?>
                                                    />
                                      ...
                                      <span><strong><?=$sl_count++?>.</strong> Specific comment on roadside
                                          ...
                                          wherever necessary)</span>
                                                ...
                                                <?php
                                                foreach($encroachers as $dags_road_reserv) {
                                                    echo form_error('reserved_bigha'.$dags_road_reserv->dag_no);
                                                    echo form_error('reserved_katha'.$dags_road_reserv->dag_no);
                                                    echo form_error('reserved_lessa'.$dags_road_reserv->dag_no);
                                                    echo form_error('reserved_ganda'.$dags_road_reserv->dag_no);
                                                    echo form_error('reserved_kranti'.$dags_road_reserv->dag_no);
                                                }
                                                ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div id="road_side_reservation_hide" class="road_side_reservation_hide">
                                                    <?php foreach($encroachers as $dags_road_reserv) { ?>
                                                        <div class="form-group row mt-2">
                                                            <input type="hidden" value="<?=$dags_road_reserv->dag_no?>" class="form-control input-sm" name="reserved_dag_road<?=$dags_road_reserv->dag_no?>" id="reserved_dag_road">
                                                            <input type="hidden" value="<?=$dags_road_reserv->patta_no?>" class="form-control input-sm" name="reserved_patta_road<?=$dags_road_reserv->dag_no?>" id="reserved_patta_road">
                                                            <label for="area-reserved" class="mb-2"><b>Enter road side reserve area in Dag No: <?=$dags_road_reserv->dag_no?></b></label>
                                                            <div class="col-4">
                                                                <span class="input-group-addon">Bigha</span>
                                                                <input type="text" onkeyup="roadAreaCheck()" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                                    echo set_value('reserved_bigha'.$dags_road_reserv->dag_no);
                                                                } else {
                                                                    echo "0";
                                                                }?>" class="form-control input-sm reserved_road_value <?php if(form_error('reserved_bigha'.$dags_road_reserv->dag_no)) {
                                                                    echo 'lm_invalid';
                                                                }?>" name="reserved_bigha<?=$dags_road_reserv->dag_no?>" id="reserved_bigha<?=$dags_road_reserv->dag_no?>">
                                                            </div>
                                                            <div class="col-4">
                                                                <span class="input-group-addon">Katha</span>
                                                                <input type="text" onkeyup="roadAreaCheck()" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                                    echo set_value('reserved_katha'.$dags_road_reserv->dag_no);
                                                                } else {
                                                                    echo "0";
                                                                }?>" class="form-control input-sm reserved_road_value <?php if(form_error('reserved_katha'.$dags_road_reserv->dag_no)) {
                                                                    echo 'lm_invalid';
                                                                }?>" name="reserved_katha<?=$dags_road_reserv->dag_no?>" id="reserved_katha<?=$dags_road_reserv->dag_no?>" >
                                                            </div>
                                                            <div class="col-4">
                                                                <span class="input-group-addon">Lessa</span>
                                                                <input type="text" onkeyup="roadAreaCheck()" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                                    echo set_value('reserved_lessa'.$dags_road_reserv->dag_no);
                                                                } else {
                                                                    echo "0";
                                                                }?>" class="form-control input-sm reserved_road_value <?php if(form_error('reserved_lessa'.$dags_road_reserv->dag_no)) {
                                                                    echo 'lm_invalid';
                                                                }?>" name="reserved_lessa<?=$dags_road_reserv->dag_no?>" id="reserved_lessa<?=$dags_road_reserv->dag_no?>" >
                                                            </div>
                                                        </div>
                                                        <?php if((in_array($this->session->userdata("dist_code"), json_decode(BARAK_VALLEY)))): ?>
                                                            <div class="form-group row mt-2">
                                                                <div class="col-4">
                                                                    <span class="input-group-addon">Ganda</span>
                                                                    <input type="text" onkeyup="roadAreaCheck()" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                                        echo set_value('reserved_ganda'.$dags_road_reserv->dag_no);
                                                                    } else {
                                                                        echo "0";
                                                                    }?>" class="form-control input-sm reserved_road_value <?php if(form_error('reserved_ganda'.$dags_road_reserv->dag_no)) {
                                                                        echo 'lm_invalid';
                                                                    }?>" name="reserved_ganda<?=$dags_road_reserv->dag_no?>" id="reserved_ganda<?=$dags_road_reserv->dag_no?>" >
                                                                </div>
                                                                <div class="col-4">
                                                                    <span class="input-group-addon">Kranti</span>
                                                                    <input type="text" onkeyup="roadAreaCheck()" style="text-align: center;" value="<?php if(isset($err_return)) {
                                                                        echo set_value('reserved_kranti'.$dags_road_reserv->dag_no);
                                                                    } else {
                                                                        echo "0";
                                                                    }?>" class="form-control input-sm reserved_road_value <?php if(form_error('reserved_kranti'.$dags_road_reserv->dag_no)) {
                                                                        echo 'lm_invalid';
                                                                    }?>" name="reserved_kranti<?=$dags_road_reserv->dag_no?>" id="reserved_kranti<?=$dags_road_reserv->dag_no?>" >
                                                                </div>
                                                            </div>
                                                        <?php endif ;?>
                                                    <?php } ?>
                                        ...
                                        <?php include(APPPATH."views/NcVillageService/Common/Includes/settlementPropertyModal.php"); ?>
                                        <!---// Add additional land detail modal --->
                                      ...
                                      <span><strong><?=$sl_count++?>.</strong> Field visit report & geo tagged
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        if(isset($geo_tag_doc_empty)) {
                                                            ?>
                                                            <span class="<?php if(isset($err_return)) {
                                                                echo "lm_invalid";
                                                            }?>">
                                                      <?=$geo_tag_doc_empty?>
                                                  </span>
                                        ...
                                        <?php
                                        foreach($encroachers as $landmark_dag):
                                            ?>
                                            <div class="row p-2">
                                                <div class="col-md-6">
                                                    <label for="">
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="rezaButt buttPrimary <?php if(form_error('validationcheck')) {
                                                    echo 'lm_invalid';
                                                }?> <?php if(form_error('totaldue')) {
                                                    echo 'lm_invalid';
                                                }?>"
                            ...
                            <ul class="list-inline pull-right"  style="margin-top: 20px">
                                ...
                                <li>
                                    <?php if(ENABLE_BUTTON_LM_SUBMIT_TRIBAL != 0) {?>

                                        <input type="submit" class="btn btn-primary" onClick="this.disabled=true; this.value='Saving...';" id="btnLmSubmit" value="Save and submit">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="number" readonly onkeyup="zonalValueChange<?=$dagsprem->dag_no?>()" name="zonal_valuation_prem<?=$dagsprem->dag_no?>" id="zonal_valuation_prem<?=$dagsprem->dag_no?>"
                                                               class="zonal_valuation_prem form-control <?php if(form_error('zonal_valuation_prem')) {
                                                                   echo 'lm_invalid';
                                                               }?>"
