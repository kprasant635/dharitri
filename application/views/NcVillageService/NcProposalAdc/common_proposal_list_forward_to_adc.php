...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/NcCommonProposalAdc/listOfProposalsAllServicesAdc',
                type : 'POST',
                data : {
                    circle       : circle,
                    subdiv       : subdiv,
    ...
    function openTab(id)
    {
        ...
        $.ajax({
            url: BASE_URL + "/NcCommonProposalAdc/getCasesAgainstProposalNoSdlac",
            dataType: "JSON",
            data: {id : id},
            type: "POST",
            success: function(data) {
...
<script type="text/javascript">
    ...
    $("#openModalForFinalSubmit").click(function()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalAdc/checkAllSdlacPresentMember",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        {
            $.ajax({
                url: BASE_URL + "/NcCommonProposalAdc/sendProposalsToDcMinute",
                type: "post",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            {
                $.ajax({
                    url: BASE_URL + "/NcCommonProposalAdc/sendProposalsToDc",
                    type: "post",
                    enctype: 'multipart/form-data',
                    contentType: false,
                    cache: false,
