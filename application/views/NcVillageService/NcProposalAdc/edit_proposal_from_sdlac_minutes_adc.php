...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a href="<?= base_url()?>index.php/NcCommonProposalAdc/commonProposalListViewAdc">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Cases Under Proposal (<?=$proposalDetails->proposal_name?>) </span>
                <hr>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="hidden" id="proposalIdForward" value="<?php echo $proposal_no ?>">
                        <input type="hidden" id="service_code" value="<?= NC_KHAS_LAND ?>">
                        Case List
                    </div>
...
<script>
    ...
    function report_no(id, case_no) {
        ...
        showNewRejectModalMb2(case_no, '<?php echo NC_KHAS_LAND ?>')
    }
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/NcCommonProposalAdc/applicationRevertToCoFromProposalUnderMinutes",
                type: "post",
                dataType: "json",
