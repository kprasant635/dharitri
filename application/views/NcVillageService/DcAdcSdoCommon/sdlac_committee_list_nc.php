            ...
            <div class="reza-title">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-sx-12" >
                        <span><?php echo $this->lang->line('sdlacCommitteeNcList') ?></span>
                    </div>
                ...
                <?php else : ?>
                    ...
                    <div class="text-center">
                        <button class="btn btn-success" id="update">
                            <i class="fa fa-check"></i>&nbsp;&nbsp;SET PRIORITY ORDER FOR SDLAC/CDLAC Member
                        </button>
...
<script>
    ...
    $(document).on('click','#update',function (event){
        ...
        $.ajax({
            // url: BASE_URL + "/NcCommonSdoAdcDc/updateMemberPriority",
            url: BASE_URL + "/SettlementCommonDc/updateMemberPriority",
            type: "POST",
