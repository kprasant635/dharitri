        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">List of Legacy (Mobile Updation) Pending Cases</h2>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
											<?php if($type=='M'){ ?>
                                                ...
                                                <a href="<?php echo base_url() . "index.php/LegacyCorrection/coReportMobileUpdation"; ?>?case_no=<?php echo $cases->case_no."&petition_no=".$cases->petition_no; ?>" class="btn btn-primary"><?php echo $this->lang->line('write_report'); ?> </a>
        ...
        $(document).ready( function () {
            ...
            function load_data(zone_status)
            {
                ...
                var table = $('#cases').DataTable({
                    ...
                    'ajax':{
                        url: base_url+'index.php/EscalationController/searchByEscalationZoneMobileUpdationForCo',
                        type:'POST',
