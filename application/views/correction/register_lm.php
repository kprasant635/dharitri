...
<form class="form-horizontal" action="<?php echo base_url() . "index.php/LegacyCorrection/LMStepSave"; ?>"  enctype="multipart/form-data" method="POST">    
                      ...
                      <?php
                       ...
                       //  }
                        ?>
                          ...
                          <tr>
                            <td><?=$base64_decoded_adhar_file?></td>
                            <td><?=$engName?><br><b><?=$status?></b></td>
                          </tr>
...
<div class="custom-accordion" id="accordion_1">
  ...
  <?php if ($app->service_type=='N'){ ?>
    <div class="accordion-item">
        <h2 class="mb-0">
          <button class="btn btn-link collapsed bg-second" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Applied for Legacy Name Correction</button>
            </h2>
        ...
        <div class="accordion-item">
          ...
          <?php }?>
    <textarea class="form-control" rows="3" name="lm_report" placeholder=" Enter Your Remark(s) here" required></textarea>
     ...
     <ul class="list-group" style='margin-bottom: 10px'>
      ...
      <div class="form-group" style="margin-bottom: 30px;">
          <div class="col-lg-8 col-lg-offset-4">
              ...
              <a href="<?php echo base_url(); ?>index.php/LegacyCorrection/CaseListLMend" class="btn btn-danger">
