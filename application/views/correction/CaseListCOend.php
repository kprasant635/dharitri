        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">List of Legacy (Area/Name Correction) Cases Pending For Circle Officer Report</h2>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                foreach ($legacyCases AS $cases) {
                                    ...
                                    <span class='small font-italic red'><?php if($cases->basundhara){ echo "Basundhara:". $cases->basundhara ;} ?> </span></td>
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo base_url() . "index.php/LegacyCorrection/COReportAreaCorrection"; ?>?case_no=<?php echo $cases->case_no."&petition_no=".$cases->petition_no; ?>" class="btn btn-primary"><?php echo $this->lang->line('write_report'); ?> </a>
											<?php }elseif ($type == 'N'){?>
											<a href="<?php echo base_url() . "index.php/LegacyCorrection/COReportNameCorrection"; ?>?case_no=<?php echo $cases->case_no."&petition_no=".$cases->petition_no; ?>" class="btn btn-primary"><?php echo $this->lang->line('write_report'); ?> </a>
											<?php } ?>
                                        </td>
                                    </tr>
                                    <?php
        ...
        $(document).ready( function () {
            ...
            function load_data(zone_status)
            {
                ...
                var table = $('#cases').DataTable({
                    ...
                    'ajax':{
                        url: base_url+'index.php/EscalationController/searchByEscalationZoneAreaDataCorrectionForCo',
                        type:'POST',
