...
<form class="form-horizontal" action="<?php echo base_url() . "index.php/LegacyCorrection/COMobileUpdationFinalOrder"; ?>"  enctype="multipart/form-data" method="POST">    
        ...
        <div class="accordion-body">
            <h4>Applicant Information</h4>
              <table class="table table-stripped">
                ...
                <tr>
                  <td>Name in English:<?= $app->appl_name_eng?> </td>
                  <td>Gurdian Name in English:<?= $app->appl_guard_eng?> </td>
...
<div class="accordion-item">
          ...
          <div class="accordion-body">
            ...
            <table class="table table-stripped">
              <tr>
                <td>Name:<?= $app->appl_name?> </td>
                <td>Gurdian Name:<?= $app->appl_gurdian_name?> </td>
                <?php if($app->relation != null || $app->relation != '') { ?>
                  <td>Relation:<?= $this->utilityclass->getrelationByID($app->relation)?> </td>
                <?php } ?>
              </tr>
              <tr>
  ...
  <?php }?>
    <textarea class="form-control" rows="3" name="co_final_report" placeholder=" Enter Your Remark(s) here"></textarea>
      ...
      <div class="panel panel-info">
          <div class="">
            ...
            <div class="col-lg-8 col-lg-offset-4">
                ...
                <button class="btn reject btn-danger"><i class='fa fa-arrows-alt'></i> Reject Application</button>

                <a href="<?php echo base_url(); ?>index.php/LegacyCorrection/mobileUpdationCo" class="btn btn-danger">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Rejection Reason [Case No : <?=$app->case_no?>]</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form id='rejectForm' action="<?php echo base_url() ?>index.php/LegacyCorrection/RejectMobileUpdationOrder" method="post">
            <div class="modal-body">
              <input type="hidden" class="form-control" name='application_no' value="<?=$application->basundhara?>">
              <input type="hidden" class="form-control" name='petition_no' value="<?=$app->petition_no?>">
              <input type="hidden" class="form-control" name='case_no' value="<?=$app->case_no?>">
