    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 ">
			...
			<div class="panel-body ">
				...
				<?php 
					if($insert){	
					echo "<p class='uni_text red'>Already Requested Name List for Pattadar Strikeout: </p>";
					foreach($insert as $r):
					//var_dump($elist);
					?>
				...
				<h2>Request For Pattadar Name Strike Out</h2>
				</nav>
				<form class="form-horizontal" enctype="multipart/form-data" role="form" action='<?= base_url();?>index.php/jamaeditentry/deopdarstrike' method="post">
				<div class="form-group">
					...
					<div class=" col-sm-6">
					  ...
					  <span class='green'>Please Select the Dag number if You want to strike from that Dag also <mark>Use keyboard "Ctrl" button for multiple dag select</mark></span>
					</div>
					<div class="col-sm-12">
...
$(".pdar_dag").change(function(){
	var selectedVal = $(".pdar_dag option:selected").val();
		$.ajax({
            ...
            //url: "http://10.177.15.74/dharitree/index.php/jamaeditentry/getPdarDag/" + selectedVal,
