...
<script type="text/javascript">
    ...
    $("#new_patta_type").change(function (e) {
       ...
       // var patta_no = $(this).val();
		...
		alert(baseurl + "settlement/getDagsGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + patta_type_code);
        $.ajax({
            url: baseurl + "settlement/getDagsGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + patta_type_code,
            success: function (d) {
