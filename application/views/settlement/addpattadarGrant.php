        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12 panel panel-default panel-body ">
                <div class="well well-sm mis_report">
                    <h2 class='uni_text' style="text-align: center; color: #2e4d8e"> Conversion to PP land</h2>
                </div>
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
						...
						echo form_open_multipart('Settlement/addpattadarGrant',$attributes); ?>
							...
							<label for="select" class="col-lg-2 required control-label">Age</label>
                                <div class="col-lg-2">
                                    <input class="form-control numberonly" maxlength=3 value="<?php echo set_value('age'); ?>" type="text" placeholder="Type Here"  required name="age" />
                            </div>
                            ...
                            <div class="form-group">
                                 <label for="select" class="col-lg-2 required control-label">Mobile No.</label>
                                <div class="col-lg-2">
