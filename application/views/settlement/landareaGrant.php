        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12 panel panel-default panel-body ">
                <div class="well well-sm mis_report">
                    <h2 class='uni_text' style="text-align: center; color: #2e4d8e">Registration for PP Conversion</h2>
                </div>
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
						...
						echo form_open_multipart('Settlement/detailslandareaGrant',$attributes); ?>
                            <h4 class="center red"><u> Details </u></h4>
                        ...
                        <input type="hidden" readonly value="<?php echo $location['vill_code']; ?>" class="form-control villageselect" name="vill_townprt_code">
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-3 control-label uni_text ">  Order No  by DC</label>
                                <div class="col-lg-3">
						...
						<!--	  <div class="form-group">
                                <label for="inputEmail" class="col-lg-3 control-label uni_text ">Govt. of Assam Order No </label>
                                <div class="col-lg-3">
                            ...
                            <hr>
                            <h4 class="center red "><u>Schedule Of Land Converted</u></h4>
                          <!--  <div class="form-group ">    
						...
						<!--	<div class="form-group">
                                ...
                                <div class="col-lg-4">
							     ...
							     <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label">Existing Patta Type</label>
                            <div class="col-sm-3">
                                <select class="form-control pattatype_nmaegrant" id="new_patta_type" name="patta_type" required >
                            ...
                            <label for="inputEmail3" class="col-sm-3 control-label required" ><?php echo $this->lang->line('patta_no'); ?></label>
                            <div class="col-sm-3">
						...
						<div class="form-group">
						 <div class="col-lg-6">
							...
							<div class="form-group ">
                                ...
                                <label for="inputEmail" class="col-lg-5 required  control-label uni_text">Select Dag Number </label>
							 ...
							 <select class="form-control " id="dag_noGrant" name="dag_noGrant[]"  multiple="multiple" size="8" class="form-control" style="width:300px">
							   <option selected disabled>Select Dag Number </option>
                                ...
                                <div class="col-lg-1">
                                    <input type="text"  class="form-control hide" readonly id='pno' name="patta_ftyfno" placeholder='Patta' value="" >
                                </div>
...
<script type="text/javascript">
    ...
    $(".pattanoselect").change(function (e) {
        ...
        var patta_type_code = $('.pattatype_nmaegrant').val();
        var patta_no = $(this).val();
        //alert(distcode+" "+subdivcode+" "+circode+" "+mouzacode+" "+lotcode+" "+villcode+" "+patta_type_code);
		
		//alert(baseurl + "settlement/getDagsGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + patta_type_code + "/" + patta_no);
        $.ajax({
            url: baseurl + "settlement/getDagsGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + patta_type_code + "/" + patta_no,
            success: function (d) {
                ...
                $("select[name='dag_noGrant[]']").html(template);
...
//        $('#rk').val(krantik - mk);
	  ...
	  $('.pattatype_nmaegrant').change(function (e) {
		 // alert('i am hee');
        var subdivcode = $('.subdivselect').val();
        var distcode = $('.districtselect').val();
        var circode = $('.circleselect').val();
		...
		//alert(baseurl + "JamabandiControllerBondita/getpattaTypebynameGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode+ "/" + patta_type);
        $.ajax({
            url: baseurl + "JamabandiControllerBondita/getpattaTypebynameGrant/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode+ "/" + patta_type,
...
<script>
 ...
 $(document).ready(function(){
   $("#checkallusers").change(function(){
     ...
     // Select all
     if(checked){
       $('#dag_noGrant option').each(function() {
  ...
  $("#dag_noGrant").change(function(){
 
    // When total options equals to total selected option
    if($("#dag_noGrant option").length == $("#dag_noGrant option:selected").length) {
