               ...
               // var_dump($cases);
                foreach ($cases as $case): ?>
                    <tr>
						...
						<td><i class=""></i> <?php  //echo   date('d/m/Y',  strtotime($case->next_date_hearing)) ; ?></td>
                        <td><a class='btn btn-danger' href='<?php echo base_url() . 'index.php/Settlement/lmstep_oneAp' ?>?case_no=<?php echo $case->case_no ?>'>PROCESS</a>
                        </td>
