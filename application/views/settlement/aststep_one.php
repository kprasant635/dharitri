                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
						...
						echo form_open_multipart('Settlement/index',$attributes); ?>
                            ...
                            <hr>
                            <h4 class="center red"><u>Settlement Certificate Details </u></h4>
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-3 control-label uni_text">Settlement Certificate/Order No </label>
                                <div class="col-lg-3">
...
$('#villageselect_allot').change(function (e) {
        ...
        console.log("Changer");
        $.ajax({
            url: baseurl + "Settlement/governmentland/" + dist_code + "/" + subdiv_code + "/" + cir_code + "/" + mouza_pargona_code + "/" + lot_no + "/" + vill_code,
...
$('#dag_land_area').change(function (e) {
        ...
        console.log("Changer");
        $.ajax({
            url: baseurl + "Settlement/landarea/" + dist_code + "/" + subdiv_code + "/" + cir_code + "/" + mouza_pargona_code + "/" + lot_no + "/" + vill_code+ "/" + dag_no,
            success: function (data) {
                console.log(data);
