                    ...
                    <div class="panel-body">
                        ...
                        <center>
                            <table class="table table-condensed">
                                <tr>
                                    <td>&gt;&gt;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/Maintenance/JamabandiStatus">Change Jamabandi Status For Re Updation</a></td>
                                </tr>
                                <tr class='hide'>
                                    <td>&gt;&gt;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/Maintenance/PattadarMatching">Match Pattadar's ( Chitha Vs Jamabandi )</a></td>
                                </tr>
                                <tr class='hide'>
