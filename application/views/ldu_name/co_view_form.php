    ...
    <div class="form-container">
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label required-field">Relation</label>
                        <div class="col-lg-8">
                            <input class="form-control" type="text" value="<?php echo htmlspecialchars($this->CorrectionModel->getRelationbyId($data->relation)); ?>" readonly>

                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label required-field">Gender</label>
                        <div class="col-lg-8">
                           <input class="form-control" type="text" value="<?php echo htmlspecialchars($this->CorrectionModel->getGenderbyId($data->gender)); ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label required-field">Caste</label>
                        <div class="col-lg-8">
                            <input class="form-control" type="text" value="<?php echo htmlspecialchars($this->CorrectionModel->getCastebyId($data->caste)); ?>" readonly>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label required-field">DOB</label>
                        <div class="col-lg-8">
                            <input class="form-control" type="text" value="<?=$data->dob?>" readonly>
                        </div>
                    </div>
                </div>
            <?php }?>
            ...
            <?php
                $file_name = $data->attachment; // Assuming you have the file name
                $file_path = base_url('uploads/NEWNAMEMIDIFY/' . $file_name);
            ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-9">
                    <textarea class="form-control" rows="3" id="co_report" name="co_remark"></textarea>
                </div>
            </div>
        ...
        <?php if($data->status=='Pending' && $data->pending_with_officer=='CO' && $data->pending_status='C'){?>
            <div class="row mt-4">
    ...
    <script type="text/javascript">
         ...
         var selectAdc = $("#adc_code");
         var coremark = $("#co_report");
         if (selectAdc.val() == "") {
                  alert("Please select Assign ADC!");
                  return false;
              }
         if (coremark.val() == "") {
        ...
        $('#consentModal').modal('show');
         ...
         $('#confirmSubmit').click(function() {
            if ($('#consentCheckbox').is(':checked')) {
                ...
                $.ajax({
                    url: baseurl + "CorrectionController/updateCoCorrection",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
