...
<div class="modal" id="land_share_update_details_modal" role="dialog">
    <form method="post" id="land_share_update_details_form">
        ...
        <input type="hidden" value="" id="land_share_update_form_dag_area_b" name="land_share_update_form_dag_area_b">
        <input type="hidden" value="" id="land_share_update_form_dag_area_k" name="land_share_update_form_dag_area_k">
        <input type="hidden" value="" id="land_share_update_form_dag_area_lc" name="land_share_update_form_dag_area_lc">
        <input type="hidden" value="" id="land_share_update_form_dag_no" name="land_share_update_form_dag_no">
        <input type="hidden" value="" id="no_of_indivisuals_update_form" name="no_of_indivisuals_update_form">
            ...
            <div class="modal-content">
                <div class="modal-header text-white text-bold text-center bg-warning">
                    <h5 class="modal-title w-100">
                        ...
                        <?php echo $this->lang->line('land_share_update_details_modal_header'); ?><br>
                        ...
                        <span class="text-white" id="lb_update_dag_no_header"></span>
                        <p>[
                            <span>Total Dag Area:</span>
                            <span class="text-white" id="lb_update_dag_area_b_header"></span> Bigha,
                            <span class="text-white" id="lb_update_dag_area_k_header"></span> Katha,
                            <span class="text-white" id="lb_update_dag_area_lc_header"></span> Lessa
                            ]
                        </p>
                    </h5>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group mb-5 col-lg-12 col-sm-12 col-md-12">
                        <div class="text-center bg-secondary text-white p-1">
                            <h5 class="mb-0">Land Share details</h5>
                        </div>
                                ...
                                <tfoot>
                                    <tr hidden>
                                        <th colspan="11" class="text-center">
                                            <button id="updateBtnAdd" type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Add more controls"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add More&nbsp;</button>
                                        </th>
                                    </tr>
                                </tfoot>
                                </tbody>
                    ...
                    <div class="col-lg-12" id="lb_validation_error_div_update_form" style="display:none;">
                        <div class="alert alert-warning alert-dismissible" role="alert">
                            <strong class="text-center" style="color:red !important" id="lb_validation_error_msg_update_form">
                            </strong>
                        </div>
                    </div>
                ...
                <div class="row" align="center" style="padding:10px;">
                    <div class="col-lg-12" align="center">
                        <button type="button" class="btn btn-sm btn-success" onclick="land_share_update_form_submit()">
                            <i class="fa fa-check" aria-hidden="true"></i>
                            Update
                        </button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="land_share_update_details_modal_close()">
