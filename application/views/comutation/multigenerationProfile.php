    ...
    <div class="row">
        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <br>
                <div class="col-lg-12">
                    <?php foreach ($fmd as $key => $fmddag) {?>
                <a style="float:right" target="_blank" href="<?php echo base_url() . 'index.php/chithareport/generateChitha?case_no=4&dag=' . $fmddag['dag_no'] . '&m=' . $fmb['mouza_pargona_code'] . '&l=' . $fmb['lot_no'] . '&v=' . $fmb['vill_townprt_code'] . '&p=' . $fmd[0]['patta_type_code'] . '&dist=' . $fmb['dist_code'] . '&cir=' . $fmb['cir_code'] . '&sub_div=' . $fmb['subdiv_code'] ?>">
                             <i class="fa fa-link" aria-hidden="true"></i><u><span class="text-primary" style="font-size:16px;">Dag No. <?=$fmddag['dag_no']?> (Chitha View)</span></u>
                          </a>
                          <?php } ?>
                </div>
                <div class="col-lg-12">
            ...
            <form id='submitFieldPost' action="<?php echo base_url() ?>index.php/cofieldmutation/passOrderofMultiGeneration" enctype="multipart/form-data" method="POST">
