        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Revive Case with Remarks</h2>
                </div>
            </div>
            <div class="col-lg-12">
            <div class="error_container">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?php echo base_url() . 'index.php/coofficemutation/reviveCaseUpdate' ?>" method="post" >

                            <div class="form-group">
                                <label for="textArea" class="col-lg-3 control-label">Revive Remarks</label>
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" name='co_order' id="textArea" placeholder="Please Type Your Reason For Revive"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
