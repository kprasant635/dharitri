        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Revert Back to LM or SK</h2>
                </div>
            </div>
            <div class="col-lg-12">
            <div class="error_container">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?php echo base_url() . 'index.php/COFieldMutation/revertBackLS' ?>" method="post" >
