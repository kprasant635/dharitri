    ...
    <div class="row">
        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-lg-12">
                    <?php
                        foreach($fmd as $f_dag):
                    ?>
                            <a style="float:right" target="_blank" href="<?php echo base_url() . 'index.php/chithareport/generateChitha?case_no=4&dag=' . $f_dag['dag_no'] . '&m=' . $fmb['mouza_pargona_code'] . '&l=' . $fmb['lot_no'] . '&v=' . $fmb['vill_townprt_code'] . '&p=' . $f_dag['patta_type_code'] . '&dist=' . $fmb['dist_code'] . '&cir=' . $fmb['cir_code'] . '&sub_div=' . $fmb['subdiv_code'] ?>">
                                <i class="fa fa-link" aria-hidden="true"></i><u><span class="text-primary" style="font-size:16px;">Dag No. <?=$f_dag['dag_no']?> (Chitha View)</span></u>
                            </a>
                    <?php
                        endforeach;
                    ?>
            ...
            <form id='submitFieldPost' action="<?php echo base_url() ?>index.php/cofieldmutation/passOrderofMultiDag" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="col-lg-12">
                                ...
                                <center><h4><u>Location Details</u></h4></center>
                                        ...
                                        <tbody>
                                            <?php foreach ($applicant as $app) :
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $this->utilityclass->gender($app['pet_gender']); ?></td>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($seller as $key => $app) :?>
                                            <tr>
                                                <td><?=$app['pdar_name']?></td>
                                                <td><?=$app['dag_no']?></td>
                                                <td><?=$app['pdar_guardian']?></td>
                                                <input type="hidden" name="seller_dag[]" value="<?=$app['dag_no']?>">
                                                ...
                                                <?php if($key == 0): ?>
                                                    <td rowspan="<?= count($seller) ?>" style="line-height: 1.5; vertical-align: middle; text-align: center;">
                                                        <?=$this->utilityclass->getTransferType($fmb['trans_code'])?>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                            <?php endforeach; ?>
                                    ...
                                    <span class="text-danger"><center><b>Please Update the Details if it's incorrect</b></center></span>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <!--//#START PLB--->
                                            <input type="hidden" name="dag_no_update[]" value=<?=$dag['dag_no'];?> >
                                            <?php
