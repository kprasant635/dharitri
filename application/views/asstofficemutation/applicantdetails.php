        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;"><?php echo $this->lang->line('applicant_details_for_office_mutation') ?></h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">Office Mutation (Applicant Details)</h3>
                    </div>
                    <div class="panel-body">
                        <form class='form-horizontal' action="<?php echo base_url() . "index.php/officemutation/saveApplicantDetails"; ?>" method="post">
                            ...
                            <div class="form-group">
                                <center>
                                    <div class="col-lg-12">
                                        ...
                                        <!--<a href='<?php echo base_url() . "index.php/officemutation/pattadarDetails"; ?> ' class="btn btn-info"><i class='fa fa-check'></i>&nbsp;Proceed To Next Stage</a>-->
