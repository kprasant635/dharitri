                        ...
                        <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-sm btn-block btn-primary" href="<?php echo base_url(); ?>index.php/officemutation/writenote?case_no=<?php echo enc_param('case_no', $case->case_no, 600)."&dist_code=".$case->dist_code."&subdiv_code=".$case->subdiv_code."&cir_code=".$case->cir_code."&mouza_pargona_code=".$case->mouza_pargona_code."&lot_no=".$case->lot_no."&vill_townprt_code=".$case->vill_townprt_code; ?>"><i class="fa fa-pencil"></i>&nbsp;Write Report</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
