                ...
                <div class="panel panel-info">
                    <div class="panel-body">
                        ...
                        <div class="center col-lg-12">
                            <a href="<?php echo base_url() . "index.php/officemutation/mutationapplicantDetails?next=true" ?>" class="btn btn-danger">
                                <i class="fa fa-arrow-left"></i>&nbsp;Click Here to Add More Applicant 
                            </a>
                            <a href="<?php echo base_url() . "index.php/officemutation/mutationlandarea" ?>" class="btn btn-success">
