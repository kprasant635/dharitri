...
<style>
    ...
    .card-body{
      background: linear-gradient(to right, #ad0000, #ffffff) !important;
    }
...
<script type="text/javascript">  
  ...
  <div class="col-lg-12">
    ...
    <div class="row">
      <p class="uni_text">Total No. of Basundhara 3.0 Case(s) in the District </p>
    ...
    <thead>
      <tr>
        ...
        <th  colspan="28" scope="col" class="text-center">SERVICE</th>
      </tr>
      <tr class="text-center">

        <th colspan="4" class="text-center tenant">SVAMITVA</th>
        <th colspan="4" class="text-center AP">BHOODAN</th>
        <th colspan="4" class="text-center tribal">RECLASS</th>
        <th colspan="4" class="text-center khasland">TENANTS</th>
        <th colspan="4" class="text-center bgrpgr">TEA</th>
        <th colspan="4" class="text-center cultivator">AP</th>
        <th colspan="4" class="text-center institute">INSTITUTE</th>
       ...
       <tr class="text-center">
        ...
        <th class="institute">Delivered</th>
        <th class="institute">Rejected</th>
      </tr>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td class="text-sm text-right">
         ...
         <td class="text-sm text-right">
            <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.NC_KHAS_LAND_ID?>">
        ...
        <td class="text-sm text-right">
         ...
         <td class="text-sm text-right">
                          <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.BHODDAN_SERVICE_CODE?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
           ...
           <td class="text-sm text-right">
             ...
             <td class="text-sm text-right">
             <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.RECLASS_ID?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
             ...
             <td class="text-sm text-right">
             <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.SETTLEMENT_TENANT_URBAN_ID?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
             ...
             <td class="text-sm text-right">
             <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.TEA_SERVICE_CODE?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
             ...
             <td class="text-sm text-right">
             <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.SERVICE_CONVERSION_MB3?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
            ...
            <td class="text-sm text-right">
              <span class=""><?=$output->data1->slij_recieved ;?></span>
            </td>
            <td class="text-sm text-right">
             <a href="<?=base_url().'index.php/SettlementCommon/viewPendingCases/'.SLIJE_ID?>">
                          <i class="fa fa-eye" aria-hidden="true"></i>
                          <span class=""><?=$output->data1->slij_pending ;?></span>
             </a>
                        </td>
          
             <td class="text-sm text-right">
                          <span class=""><?=$output->data1->slij_delivered ;?></span>
                        </td>
          
             <td class="text-sm text-right">
                          <span class=""><?=$output->data1->slij_rejected ;?></span>
                        </td>
    ...
    <thead>
      ...
      <tr class="text-center">
       ...
       <tr class="text-center">
        ...
        <th class="institute"> Received</th>
        <th class="institute">Pending<br> (% wise)</th>
        <th class="institute">Delivered<br> (% wise)</th>
        <th class="institute">Rejected<br> (% wise)</th>
      </tr>
         ...
         <td class="text-sm text-right">
           ...
           <td class="text-sm text-right">
             ...
             <td class="text-sm text-right">
                        ...
                        <td class="text-sm text-right">
                          <span class=""><?=($cirData->slij_recieved)==null?"0":($cirData->slij_recieved) ;?></span><br>                       </td>
          
             <td class="text-sm text-right">
                          <span class=""><?=($cirData->slij_pending)==null?"0":($cirData->slij_pending) ;?></span><br>                       <span class="">
                              <?php if($cirData->slij_recieved!=0){
                               echo '('. number_format(((($cirData->slij_pending)/($cirData->slij_recieved))*100),1).'%)';
             ...
             <td class="text-sm text-right">
                          <span class=""><?=($cirData->slij_delivered)==null?"0":($cirData->slij_delivered) ;?></span><br>
                           <span class="">
                              <?php if($cirData->slij_recieved!=0){
                               echo '('. number_format(((($cirData->slij_delivered)/($cirData->slij_recieved))*100),1).'%)';
             ...
             <td class="text-sm text-right">
                          <span class=""><?=($cirData->slij_rejected)==null?"0":($cirData->slij_rejected) ;?></span><br>                         <span class="">
                              <?php if($cirData->slij_recieved!=0){
                               echo '('. number_format(((($cirData->slij_rejected)/($cirData->slij_recieved))*100),1).'%)';
