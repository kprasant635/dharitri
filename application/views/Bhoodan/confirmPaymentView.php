...
<form action="<?php echo base_url() ?>index.php/BhoodanControllerCo/chithaUpdate" method="post">

    <input type="hidden" name="total_premium" value="<?php if ($total_premium) {
                                                            echo $total_premium;
                                                        } ?>">
    <input type="hidden" name="paid_amount" value="<?php if ($paid_amount) {
                                                        echo $paid_amount;
                                                    } ?>">
    <input type="hidden" name="remaining_amount" value="<?php if ($remaining_amount) {
                                                            echo $remaining_amount;
                                                        } ?>">
    <input type="hidden" name="tenure" value="<?php if ($tenure) {
                                                    echo $tenure;
                                                } ?>">
    <input type="hidden" name="installment_amount" value="<?php if ($installment_amount) {
                                                                echo $installment_amount;
                                                            } ?>">
    <input type="hidden" name="payment_date" value="<?php if ($payment_date) {
                                                        echo $payment_date;
                                                    } ?>">
                ...
                <div class="row p-3">
                    <div class="row">
                        ...
                        ?>
                            ...
                            <span><strong>Total Premium Amount : <?php if ($total_premium) {
                                                                        echo $total_premium;
                                                                    } ?></strong></span><br>
                            <span><strong>Amount Paid : <?php if ($paid_amount) {
                                                            echo $paid_amount . " (" . $percentage . "%)";
                                                        } ?></strong></span><br>

                            <?php
                            if ((int)$percentage != 100) {
                            ?>
                                <span><strong>Remaining Amount : <?php if ($remaining_amount) {
                                                                        echo $remaining_amount;
                                                                    } ?></strong></span><br>
                                <span><strong>Tenure : <?php if ($tenure) {
                                                            echo $tenure;
                                                        } ?></strong></span><br>
                                <span><strong>Installment Amount : <?php if ($installment_amount) {
                                                                        echo $installment_amount;
                                                                    } ?></strong></span><br>
                            <?php
                            }
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $nom->address ?></td>
                                    <td><?= $nom->mobile_no ?></td>
                                    <td><?php if ($nom->delete_id != 0) {
                                            echo '<span class="alert-danger"><b>DELETE</b></span>';
                                        } else {
                                            echo '<span class="alert-warning"><b>ADD</b></span>';
                                        } ?></td>
                                </tr>
                            <?php
                            }
                    ...
                    <table class="table table-bordered mt-1">
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($dagRow->new_landclass_home) {
                                            echo $this->utilityclass->getLandClassCode($dagRow->new_landclass_home);
                                        } ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($dagRow->new_landclass_agri) {
                                            echo $this->utilityclass->getLandClassCode($dagRow->new_landclass_agri);
                                        } ?></td>
                                </tr>
                ...
                ?>
                    ...
                    <table class="table table-bordered mt-1">
                        ...
                        ?>
                                ...
                                <tr>
                                    <th>Proposed Landclass for Homestead </th>
                                    <td><?php if ($dagRow->new_land_class_home) {
                                            echo $this->utilityclass->getLandClassCode($dagRow->new_land_class_home);
                                        } ?></td>
                                </tr>
                                ...
                                <tr>
                                    <th>Proposed Landclass for Agriculture </th>
                                    <td><?php if ($dagRow->new_land_class_agri) {
                                            echo $this->utilityclass->getLandClassCode($dagRow->new_land_class_agri);
                                        } ?></td>
                                </tr>
