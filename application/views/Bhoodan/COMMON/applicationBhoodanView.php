                           ...
                           ?>
                            ...
                            if($applicants_encroacher == true){
                                foreach($applicants_encroacher as $enc_data1){
                                    if(date('Y-m-d', strtotime($enc_data1->period_possession)) != '1970-01-01' && ($enc_data1->period_possession != null || $enc_data1->period_possession != '')){
                                    ?>
                                    <tr>
            ...
            <div class="tableCard">
                <?php $sl_count =1; $i = 1;foreach ($lmnotes as $lmnote): 
                    if($validation_bypass == 0):
                        ...
                        <div class="row p-2" >
                            <div class="col-md-6">
                                <span ><strong><?=$sl_count++?>.</strong> VLB verified and found the applicant / applicants predecessor as a pattadar ?</span>
                            </div>
                            <div class="col-md-2">
                                <div class="form-check form-check-inline">
                                    <input
