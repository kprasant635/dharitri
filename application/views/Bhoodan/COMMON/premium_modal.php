        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" align="">
                    <?php  
                        $areacount=1;  foreach($dags as $dagsprem){ ?>
                        ...
                        <script>
                            ...
                            if (area_id == 19)
                            {
                              area_id =23; // assigned 24 bcz as per new notification Revenue Towns showing urbanization and industrial growth (Town Area) rate changed
                            }
