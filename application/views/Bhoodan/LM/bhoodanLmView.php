    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url() ?>index.php/BhoodanController/applicationBhoodanRegistration/<?=$review_flag?>?app=<?=$_GET['app']?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        Check errors
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    if ($basic == true) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a type="button" target="_blank" class="btn buttInfo" href="<?php echo base_url(); ?>index.php/SettlementMB3Common/apiAadharWiseApplication?app=<?=$basic["applid"];?>">
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            foreach ($dags as $all_dags) {
                                                ...
                                                <tr style="border-bottom:1px solid #227576">
                                                    <td colspan="2">
                                                        <?php if(BHOODAN_ENABLE_AREA_BUTTON_LM == 1){?>
                              ...
                              <script src="<?php echo base_url();?>js/mb2/newDagEntry.js"></script>
                                    ...
                                    <!-- <a href="#lm_report" onclick="lm()" class="btn btn-primary text-white">Go to LRA report</a> -->
                                </div>
                            </div>
                            ...
                            <div class="reza-card">
                                <div class="reza-body">
                                    ...
                                    <div class="tableCard lm-report" style="padding-bottom: 15px">
                                        ...
                                        <div class="row p-2" >
                                            <div class="col-md-6">
                                                <span><strong><?=$sl_count++?>.</strong> Whether VLB Verified?
                                                </span>
                        ...
                        <!-- new premium addition -->
                        <?php include(APPPATH."views/Bhoodan/COMMON/premium_modal.php"); ?>
