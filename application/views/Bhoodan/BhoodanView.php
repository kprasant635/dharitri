    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url() ?>index.php/BhoodanController/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                            ...
                            <ul class="list-inline pull-right" style="margin-top: 20px">
                                ...
                                <li>
                                    <button type="submit" id="submit_seconproc" onclick="submitSecond(event)" class="btn btn-primary">
...
function submitSecond(event) {
    $('#submit_seconproc').hide(); // Hide the button
    console.log($('form').attr('action')); // Log form action
}
