...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/BhoodanControllerAdc/viewAllMarkAsSdlacListForDcBhoodan">SDLAC/CDLAC Recommended (Marked)</a>
            ...
            <div class="reza-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="left">
                        <?php if(ENABLE_BUTTON_SEND_TO_SDLAC_BHOODAN !=0): ?>
                            ...
                            <label for="w3review" style="font-weight: bold">Hearing Date <span style="color: red; font-weight: bold">*</span>
                                <?php if(MEETING_PROPOSAL_SDLAC_NOTICE_HOLD == 1): ?>
                                    <span style="color: #EF5350; font-weight: bold">
                                        ( Maximum Date of processing <?php echo MEETING_PROPOSAL_SDLAC_NOTICE_BHOODAN_DATE_SHOW ?> )
                                    </span>
                                <?php endif; ?>
                            </label>
                            <input type="datetime-local" class="form-control" name="w3date" id="date" required  max="<?php echo MEETING_PROPOSAL_SDLAC_NOTICE_BHOODAN_DATE_INPUT ?>"> </input>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control" id="select_nominee_<?=$row->user_code?>">
                                        ...
                                        <?php if($row->user_type == 'MLA' && in_array($this->session->userdata("dist_code").'_'.$row->user_code, SDLAC_MEM_MLA_NOMINEE_ALLOW)) :?>
                                            ...
                                            foreach($nominee as $nom)
                                            {
                                                ...
                                                $checkedStatus = $this->utilityclass->getSelectedNomineeOfSdlac($proposal_no, $nom->id, BHODDAN_SERVICE_CODE); ?>
...
<script>
    ...
    $(document).on('click','#sendToSDLACModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/BhoodanControllerAdc/sendAllMarkAppToSDLACByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
        ...
        {
            showErrorMessage("Please Select Case(s) to make proposal !");
        }
    ...
    $(document).on('click','#noticeSaveModalYes',function ()
    {
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/BhoodanControllerAdc/generateNoticeSendAllMarkAppToSdlacByDcBhoodan",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    else if (data.responseType == 2)
                    {
                        Swal.fire({
                            backdrop:true,
                            allowOutsideClick: false,
                            text: "Application successfully send to SDLAC",
                            confirmButtonText: 'OK',
                            customClass: {
                                actions: 'my-actions',
                                confirmButton: 'order-2',
...
<script type="text/javascript">
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/BhoodanControllerAdc/secondProceedingSdlacRecommendedMarked',
                type:'POST',
                data: {
