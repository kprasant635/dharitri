...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-bottom: 5px; padding-top: 10px">
            ...
            <a href="<?= base_url()?>index.php/BhoodanControllerAdc/viewAllBhoodanFirstProceedingAdcCaseList">First Proceeding</a> / <b>Process</b>
        ...
        <section>
            ...
            <div class="wizard">
                ...
                <div class="tab-content">
                    ...
                    <?php
                    include(APPPATH."views/Bhoodan/COMMON/applicationBhoodanView.php");
                    ?>
                            ...
                            <div class="reza-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12"  style="margin-bottom: 40px">
                                        ...
                                        <?php
                                        include(APPPATH."views/Bhoodan/COMMON/village_wise_area_show_adc_sdo.php");
                                        ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                        ...
                                        <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) {  ?>
                                            ...
                                            if(isset($enc_not_eligible))
                                            {
                                                ...
                                                <button class="rezaButt buttDanger" onclick="showNewDirectRejectModalMb3('<?php echo $_GET['case']?>','<?= BHODDAN_SERVICE_CODE ?>')">
                                            ...
                                            else
                                            {
                                                ...
                                                // if($areaCheck == 0 && $checkAppliedArea == 0):
                                                    if($areaCheck == 0 && $checkAppliedArea == 0 && $lmnotes[0]->lm_note !=2):
                                                    ?>
                                                ...
                                                <?php if($caseDetails->status == MB_PENDING && $lmnotes[0]->lm_note !=2): ?>
...
<script>
    ...
    $(document).on('click','#markAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/BhoodanControllerAdc/markApplicationForSDLAC",
            type: "post",
            dataType: "json",
    ...
    $(document).on('click','#unMarkAsSDLACModalYes',function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/BhoodanControllerAdc/removeMarkApplicationForSDLAC",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/BhoodanControllerAdc/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
