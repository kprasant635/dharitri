                        ...
                        <div class="reza-card">
                            <div class="reza-body">
                                                        ...
                                                        <li style="padding-top: 10px; padding-bottom: 15px">
                                                            ...
                                                            <?php foreach ($appliedDags as $singleAppliedArea): ?>
                                                                <?php if ($singleChithaArea->dag_no == $singleAppliedArea->dag_no): ?>
                                                                    ...
                                                                    <?php if(BHOODAN_ENABLE_AREA_BUTTON == 1){?>
                                ...
                                <div class="tableCard ">
                                    ...
                                    ?>
                                    <form method="post" id="co_form_sub" name="co_form_sub" action="<?php echo base_url() ?>index.php/BhoodanControllerCo/reportSubmitFirsProceedingCo">

                                        <input type="hidden" id="case_no" name="case_no" value="<?=$_GET['case']?>">
                                        <input type="hidden" autocomplete="off" class="form-control date" id="enable_next_date" name="hearing_date" value="" />
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            ...
                                            if($pending_officer == 'DC' && $from_office == 'CO'){
                                                echo "<span class='alert-success text-center'><strong>Case forwarded to ADC/DC.</strong></span>";
                                            }
                                            ?>
...
<script>
    ...
    function rejectSubAlert()
    {
        ...
        showNewDirectRejectModalMb3(''+case_no+'','<?php echo BHODDAN_SERVICE_CODE ?>');
