            ...
            <table id="datatable" class="datatable table table-stripped">
                <thead>
                    <tr>
                        ...
                        <th>All <input type="hidden" class="checkBoxD "  id="checkedAll1"> </th>
                        <th></th>
                        <th></th>
...
<script>
    $(document).ready(function() {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat = null, lot_cat = null, urban_rural = null) {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax': {
                    url: base_url + 'index.php/BhoodanControllerCo/getListofPaymentNoticeCases',
                    type: 'POST',
                    data: {
            ...
            $("#checkedAll1").click(function() {
                if (this.checked) {
                    $('.selectMark').each(function() {
                        this.checked = true;
                        var id = $(this).val();
                        if ($.inArray(id, selectedCheckBoxArray) !== -1) {} else {
    ...
    $('#bulk_payment_notice_generate_form').submit(function(e) {
        ...
        $.ajax({
            url: baseurl + "BhoodanControllerCo/coBulkPaymentNoticeGenerateAndSave",
            type: 'POST',
