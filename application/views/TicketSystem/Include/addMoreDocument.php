<h5 class="reza-title" style="margin-top: 50px">
    <div class="card-subtitle"><code> Minimum one document is required  </code></div>
    <i class="fa fa-upload" aria-hidden="true"></i> &nbsp;
    Upload Screenshots <span style="color:red;">*</span> ? &nbsp;
    ...
    $(document).ready(function () {
        ...
        $("#addMoreFileDocFun").click(function (e)
        {
            ...
            $("#fieldList").append(
                ...
                "<div class=\"col-md-6\">\n" +
                "<div class=\"form-group\">\n" +
                "<label id=\"formControlFile\">Document Title <span style=\"color:red\" id=\"document"+counter+"Err\"></span></label>\n" +
                ...
                "<div class=\"col-md-4\">\n" +
                "<div class=\"form-group\">\n" +
                "<label id=\"formControlFile\">Select File <span style=\"color:red\" id=\"uploadFile"+counter+"Err\"></span></label>\n" +
