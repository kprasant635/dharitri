...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" >
    <div class="modal-dialog modal-lg" role="document" style=" width: 750px!important; margin: auto;">
        <div class="modal-content">
            ...
            <form id="form_validation" action="<?php echo base_url() ?>index.php/TicketTechnicalController/addCommentOnTechnicalTicketOnlyView" enctype="multipart/form-data" method="POST">
