<div class="tableCard">
    ...
    <form id="myForm" method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/RelinquishmentLmController/relinquishmentApplicationForwardToCo">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 labDiv" style="margin-bottom: 20px">
                <label for="sel1" class="lab" style="margin-bottom: 10px">
                    Application Forward To CO <span style="color: red;font-weight: bold;"> *</span>
                </label>
