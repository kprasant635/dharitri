<div class="tableCard">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td style="width: 30%">
                <?php echo $this->utilityclass->getMouzaName($basic->dist_code,$basic->subdiv_code,$basic->cir_code,$basic->mouza_code);?>
            </td>
        </tr>
        <tr>
            <th style="width: 20%">Lot</th>
            <td style="width: 30%">
                <?php echo $this->utilityclass->getLotLocationName($basic->dist_code,$basic->subdiv_code,$basic->cir_code,$basic->mouza_code,$basic->lot_no);?>
            </td>
            <th style="width: 20%">Village</th>
            <td style="width: 30%">
                <?php echo $this->utilityclass->getVillageName($basic->dist_code,$basic->subdiv_code,$basic->cir_code,$basic->mouza_code,$basic->lot_no,$basic->village_code);?>
            </td>
        </tr>
    </table>
</div>