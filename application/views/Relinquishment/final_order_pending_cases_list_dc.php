...
<div class="row" style='padding-top: 15px; margin-bottom: 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        /
        <a href="<?= base_url()?>index.php/RelinquishmentDcController/getAllPendingForFinalOrderRelinquishmentCasesDc">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span><?php echo $this->lang->line('relinquishmentTitle') ?> Cases Pending For Final Order</span>
                <hr>
            </div>
            <div class="reza-body">
...
<script>
    ...
    $('#cir_id').change(function()
    {
        ...
        $.ajax({
            url: base_url+'index.php/RelinquishmentCommonController/villageListCommon',
            dataType: 'json',
            data: {
                subdiv_code: subdiv,
                cir_code: circle
    ...
    function load_data(){
        var base_url     = "<?php echo base_url();?>";
        var service_code = <?= RELINQUISHMENT_ID ?>;
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/RelinquishmentDcController/getAllPendingForFinalOrderRelinquishmentPaginationAPI',
                type:'POST',
                data: {
