...
<div class="row" style='padding-top: 15px; margin-bottom: 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        /
        <a href="<?= base_url()?>index.php/RelinquishmentDcController/getAllPendingRelinquishmentCasesDc">
            <?php echo $this->lang->line('relinquishment1stPro') ?>
        </a>
        /  View
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/RelinquishmentDcController/firstProceedingPaginationAPIDc',
                type:'POST',
                data: {
