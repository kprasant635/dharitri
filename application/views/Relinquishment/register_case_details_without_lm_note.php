...
<script>
    ...
    // Allow multiple modals open at same time
                ...
                <div class="tab-pane" role="tabpanel" id="step2">
                    ...
                    <div class="reza-card ">
                        <div class="reza-body">
                            ...
                            <?php include(APPPATH."views/Relinquishment/include/application/lra_report.php"); ?>
                        </div>
                    </div>
                    <ul class="list-inline pull-right" style="margin-top: 20px">
                        <li>
                    ...
                    <div class="reza-card ">
                        <div class="reza-body">
                            ...
                            <?php if($proceedings){ ?>
                                ...
                                <br>
                            <?php } ?>
                            <?php if($basic->status == 'Z' && $basic->pending_officer == MB_CIRCLE_OFFICER): ?>
                                <?php include(APPPATH."views/Relinquishment/include/application/process.php"); ?>
<!--                            --><?php //elseif($basic->status == 'W' && $basic->pending_officer == MB_CIRCLE_OFFICER): ?>
<!--                                --><?php //include(APPPATH."views/Relinquishment/include/application/process_co.php"); ?>
                            <?php elseif($basic->status == 'G' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                                <?php include(APPPATH."views/Relinquishment/include/application/process_final_order.php"); ?>
                            <?php elseif($basic->status == 'W' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                                <?php include(APPPATH."views/Relinquishment/include/application/process_dc_notice.php"); ?>
                            <?php elseif($basic->status == 'S' && $basic->pending_officer == MB_DEPUTY_COMM && $basic->notice_generated_yn == 'Y'): ?>
                                <?php include(APPPATH."views/Relinquishment/include/application/process_dc_notice_serve.php"); ?>
                            <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <h5>
                    <?php if($basic->status == 'Z' && $basic->pending_officer == MB_CIRCLE_OFFICER): ?>
                        You want to Forward this application to DC ?
                    <?php elseif($basic->status == 'W' && $basic->pending_officer == MB_CIRCLE_OFFICER): ?>
                        You want to Forward this application to DC ?
                    <?php elseif($basic->status == 'G' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                        You want to submit this application for Final Order ?
                    <?php elseif($basic->status == 'S' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                        You want to forward this application to Final Order ?
                    <?php elseif($basic->status == 'W' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                        You want to Generate Notice ?
                    <?php endif; ?>
                </h5>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"   id="submitApplicationModalYes">
                    Yes,
                    <?php if($basic->status == 'C' && $basic->pending_officer == MB_CIRCLE_OFFICER): ?>
                        Update
                    <?php elseif($basic->status == 'W' && $basic->pending_officer == MB_DEPUTY_COMM): ?>
                        Generate
                    <?php else: ?>
...
<!-- Modal Re Generate Notice  -->
<div class="modal" role="dialog" id="reGenerateNoticeModal" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Confirmation</h5>
            </div>
            <form  method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/RelinquishmentDcController/relinquishmentApplicationReGenerateNotice">
                <input type="hidden" id="appNoReGenerate" name="appNoReGenerate" value="<?php echo $enAppNo ?>">
                <div class="modal-body" align="center">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 labDiv" style="margin-bottom: 20px">
                            <label for="sel1" class="lab" style="margin-bottom: 10px">New Hearing Date <span style="color: red;font-weight: bold;"> *</span></label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 labDiv" style="margin-bottom: 20px">
                            <input type="date" name="hearingDateRe" id="hearingDateRe" class="form-control" required >
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="rezaButt buttDanger"  id="reGenerateNoticeModalNo"> Close</button>
                    <button type="submit" id="reGenerateNoticeModalYes" class="rezaButt buttPrimary" >
                        <i class="fa fa-refresh" aria-hidden="true"></i> Re-generate
                    </button>
                </div>
...
<!-- Modal forward to final order  -->
<div class="modal" role="dialog" id="forwardToFinalOrderModal" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Application Forward to Final Order Process</h5>
            </div>
            <form  method="POST" id="forwardToFinalOrderForm" enctype="multipart/form-data" action="<?php echo base_url()?>index.php/RelinquishmentDcController/relinquishmentApplicationForwardToFinalOrder">
                <input type="hidden" id="appNoForward" name="appNoForward" value="<?php echo $enAppNo ?>">
                <div class="modal-body">
                    <div class="row" style="padding-left: 20px; padding-right: 20px">

                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 labDiv" style="margin-bottom: 20px">
                            <label for="sel1" class="lab" style="margin-bottom: 10px">Upload Hearing Document <span style="color: red;font-weight: bold;"> *</span></label>
                            <input type="file" name="signedNotice" id="signedNotice" class="form-control" required >
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 labDiv" style="margin-bottom: 20px">
                            <label for="sel1" class="lab" style="margin-bottom: 10px">Hearing Remarks <span style="color: red;font-weight: bold;"> *</span></label>
                            <textarea type="date" name="finalRemarks" id="finalRemarks" rows="4" class="form-control" required ></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="rezaButt buttDanger"  id="forwardToFinalOrderModalNo"> Close</button>
                    <button type="button" id="forwardToFinalOrderModalYes" class="rezaButt buttPrimary">
                        <i class="fa fa-paper-plane-o" aria-hidden="true"></i> Forward
                    </button>
                </div>
