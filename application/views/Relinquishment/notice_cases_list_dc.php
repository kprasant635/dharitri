...
<div class="row" style='padding-top: 15px; margin-bottom: 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        /
        <a href="<?= base_url()?>index.php/RelinquishmentDcController/getAllNoticeRelinquishmentCasesDc">
            Pending For Hearing
        </a>
        /  View
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span><?php echo $this->lang->line('relinquishmentTitle') ?> Cases Pending For Hearing</span>
                <hr>
            </div>
            <div class="reza-body">
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/RelinquishmentDcController/getAllNoticeRelinquishmentPaginationAPI',
                type:'POST',
                data: {
