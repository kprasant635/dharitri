            ...
            <div class="reza-body">
                <div class="row" style="margin-bottom: 15px">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h5>
                            <i class="fa fa-user" aria-hidden="true"></i> Land Records Supervisor (LRS)
                        </h5>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" align="right">
                        <?php if($vacPositionLRSCount != 0): ?>
                            <a href="<?php echo base_url()?>index.php/VacancyStaffController/getVacancyOfLrsStaffReport" class="rezaButt buttInfo">
                                <i class="fa fa-download" aria-hidden="true"></i> Download
                            </a>
                        <?php endif; ?>
                        <button class="rezaButt buttPrimary"  type="button" id="vacancyAddLRS">
                ...
                <table class="table table-striped table-bordered text-bold">
                    ...
                    <tr>
                        ...
                        <th style="width: 20%">Name of LRS</th>
                    ...
                    <?php else: ?>
                        <?php $i=1; foreach ($vacPositionLRSS as $vacPositionLRS): ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo $vacPositionLRS->open_category ?></td>
                                <td><?php echo $vacPositionLRS->roster_point ?></td>
                                <td><?php echo $vacPositionLRS->lr_name ?></td>
                                <td><?php echo date("d-m-Y", strtotime($vacPositionLRS->date_of_joining)) ?></td>
                                <td><?php echo date("d-m-Y", strtotime($vacPositionLRS->date_of_superannuation)) ?></td>
                                <td><?php echo $vacPositionLRS->remarks ?></td>
                            </tr>
...
<!-- Modal for LRS -->
<div class="modal" role="dialog" id="vacancyAddLRSModal">
    <div class="modal-dialog modal-lg" role="document" style="width: 60%!important;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Add Land Records Supervisor (LRS)</h5>
            </div>
            <form action="<?php echo base_url(); ?>index.php/VacancyStaffController/saveVacancySupervisor" method="post">
                ...
                <div class="modal-body row" align="center">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="left" style="margin-bottom: 20px">
                        <label for="sel1" class="lab">Name of LRS <span style="color: red;font-weight: bold;"> *</span></label>
...
<script>
    ...
    $(document).on('click','#vacancyAddLRS',function ()
    {
        $('#vacancyAddLRSModal').modal('show');
    });

    $(document).on('click','#vacancyAddLRSNo',function ()
    {
        $('#vacancyAddLRSModal').modal('hide');
    });
