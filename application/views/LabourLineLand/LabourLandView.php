    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url() ?>index.php/LabourLineController/applicationLabourLineLandRegistration?app=<?= $_GET['app'] ?>" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <div class="reza-card">
                                ...
                                <div class="reza-body">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="aadhar_verified" value="<?php if ($aadhar->is_aadhaar_verify == '1') {
                                                                                                                            echo 'Yes';
                                    ...
                                    <!-- <?php if ($setEncroacherStatus == 1): ?>
                                        <div align="center" style="margin-top: 50px; background-color: #8BC34A; margin-bottom: -20px;font-size: 20px; font-weight: bolder; color: #FF1744; align-items: center; padding: 8px">
                                            Select Occupier's to Process (VLB List)
                                        </div>
                                    <?php endif; ?> -->
                                    ...
                                    <?php
                                    //*********occupiers details  */
                                    include(APPPATH . "views/NcVillageService/NcKhas/include/encroacherDetails.php");
                                    ...
                                    <div class="tableCard">
                                        <span><strong style="color:red"> Dag No fetched from geo tag api (Longitude: <?= $long ?>, Latitude: <?= $lat?>): <?= $geo_tag_dag ?></strong></span>
                                        <table class="table mb-0">
                                            <thead class="thead-warning">
                                                ...
                                                <tr>
                                                    <th colspan="2">#</th>
                                                    <th>Area</th>
                                                    <th class="text-center"><input class="form-control input-sm" type="text" id="geo_tag_dag_<?= $geo_tag_dag ?>_bigha" name="geo_tag_dag_<?= $geo_tag_dag ?>_bigha" /></th>
                                                    <th class="text-center"><input class="form-control input-sm" type="text" id="geo_tag_dag_<?= $geo_tag_dag ?>_katha" name="geo_tag_dag_<?= $geo_tag_dag ?>_katha" /></th>
                                                    <th class="text-center"><input class="form-control input-sm" type="text" id="geo_tag_dag_<?= $geo_tag_dag ?>_lessa" name="geo_tag_dag_<?= $geo_tag_dag ?>_lessa" /></th>
                                                </tr>
                                                <tr>
                                                    <td  colspan="6"><button class="btn btn-info">Edit Dag Area</button></td>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tableCard">
                                        ...
                                        <?php if (NC_ENABLE_DAG_CHANGE_BUTTON == 1) { ?>
                                            <a href="<?php echo base_url(); ?>index.php/LabourLineController/firstProceeding?an=<?php echo $_GET['app']; ?>"
                                    ...
                                    <h5 class="reza-title" style="margin-top: 50px">
                                        ...
                                        <?php if (NC_ENABLE_FAMILY_BUTTON == 1) { ?>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                                    ...
                                    <div class="tableCard lm-report" style="padding-bottom: 15px">
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        class="form-check-input <?php if (form_error('caste_verified')) {
                                                                                    echo 'lm_invalid';
                                                                                } ?>"
                                                        type="radio"
                                                        name="caste_verified"
                                                        id="caste_verified1"
                                                        value="YES"
                                                        <?php if (set_value('caste_verified') == 'YES') {
                                                            echo "checked";
                                                        } ?> />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        id="caste_verified2"
                                                        value="NO"
                                                        <?php if (set_value('caste_verified') == 'NO') {
                                                            echo "checked";
                                                        } ?> />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-md-4" id="tribal_belt_input_id" style="display: none;">
                                                <input type="text" class="form-control <?php if (form_error('tribal_belt_name')) {
                                                                                            echo 'lm_invalid';
                                                                                        } ?>" name="tribal_belt_name" placeholder="Enter name of the Tribal belt block">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                                <span>
                                                    <strong><?= $sl_count++ ?>.</strong> Whether the area is vulnerable to landslide prone area ?
                                                </span>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                                <span>
                                                    <strong><?= $sl_count++ ?>.</strong> Whether the land falls under erosion prone area ?
                                                </span>
                                                <?= form_error('erosion') ?>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        ?>
                                                ...
                                                <div class="row p-2">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <select name="encroacher_exist_vlb<?= $encroacher_ext->id ?>" id="encroacher_exist_vlb<?= $encroacher_ext->id ?>" class="form-control clsencdata <?php if (form_error('encroacher_exist_vlb' . $encroacher_ext->id)) {
                                                                                                                                                                                                                echo 'lm_invalid';
                                                                                                                                                                                                            } ?>">
                                                            ...
                                                            ?>
                                                                <option value="<?= $enc_exist->CODE ?>" <?php if (isset($err_return)) {
                                                                                                            if (set_value('encroacher_exist_vlb' . $encroacher_ext->id) == $enc_exist->CODE) {
                                                                                                                echo "selected";
                                                                                                            }
                                                                                                        } ?>>
                                                                    <?= $enc_exist->NAME ?>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-12 <?php if (form_error('encroacher_exist_vlb')) {
                                                                        echo 'lm_invalid';
                                                                    } ?>">
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <select
                                                        ...
                                                        class="form-control <?php if (form_error('nature_possession' . $nature_dag->dag_no)) {
                                                                                echo 'lm_invalid';
                                                                            } ?>"
                                                ...
                                                <div class="form-group col-md-3" style="display: none;" id="nature_possession_div_other<?= $nature_dag->dag_no ?>">
                                                    <input type="text" placeholder="Enter Nature of possession" name="nature_possession_other<?= $nature_dag->dag_no ?>" class="form-control">
                                                </div>
                                            </div>
                                        <?php
                                        endforeach;
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-12">
                                                            ...
                                                            <textarea
                                                                ...
                                                                class="form-control"
                                                                rows="2"><?php if (isset($err_return)) {
                                        ...
                                        <div class="row p-2" style="display: none">
                                            <div class="col-md-6">
                                                ...
                                                <!-- this only to display the error message in area validation -->
                                                <span class="<?php if (form_error('familyMoreThanAppArea')) {
                                                                    echo 'lm_invalid';
                                                                } ?>"></span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" onclick="familyReservYes();" class="form-check-input family_comment_check1 <?php if (form_error('family_comment_check')) {
                                                                                                                                                        echo 'lm_invalid';
                                                                                                                                                    } ?>" name="family_comment_check" id="family_comment_check1" value="<?= YES ?>" <?php if (set_value('family_comment_check') == YES) {
                                                                                                                                                                                                                                        echo "checked";
                                                                                                                                                                                                                                    } ?>>
                                                    <label for="familyarea">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" checked onclick="familyReservNo();" class="form-check-input family_comment_check2 <?php if (form_error('family_comment_check')) {
                                                                                                                                                                echo 'lm_invalid';
                                                                                                                                                            } ?>" name="family_comment_check" id="family_comment_check2" value="<?= NO ?>" <?php if (set_value('family_comment_check') == NO) {
                                                                                                                                                                                                                                                echo "checked";
                                                                                                                                                                                                                                            } ?>>
                                                ...
                                                <div id="family_reservation_hide" class="family_reservation_hide">
                                                    <?php foreach ($dags as $family_dag) { ?>
                                                        <div class="form-group row mt-2">
                                                            ...
                                                            <div class="col-4">
                                                                <span class="input-group-addon">Bigha</span>
                                                                <input type="text" onkeyup="familyAreaCheck()" style="text-align: center;" value="<?php if (isset($err_return)) {
                                                                                                                                                        echo set_value('reserved_bigha_family' . $family_dag->id);
                                                                                                                                                    } else {
                                                                                                                                                        echo "0";
                                                                                                                                                    } ?>" class="form-control input-sm <?php if (form_error('reserved_bigha_family' . $family_dag->id)) {
                                                                                                                                                                                            echo 'lm_invalid';
                                                                                                                                                                                        } ?>" name="reserved_bigha_family<?= $family_dag->id ?>" id="reserved_bigha_family<?= $family_dag->dag_no ?>">
                                                            </div>
                                                            <div class="col-4">
                                                                <span class="input-group-addon">Katha</span>
                                                                <input type="text" onkeyup="familyAreaCheck()" style="text-align: center;" value="<?php if (isset($err_return)) {
                                                                                                                                                        echo set_value('reserved_katha_family' . $family_dag->id);
                                                                                                                                                    } else {
                                                                                                                                                        echo "0";
                                                                                                                                                    } ?>" class="form-control input-sm <?php if (form_error('reserved_katha_family' . $family_dag->id)) {
                                                                                                                                                                                            echo 'lm_invalid';
                                                                                                                                                                                        } ?>" name="reserved_katha_family<?= $family_dag->id ?>" id="reserved_katha_family<?= $family_dag->dag_no ?>">
                                                            </div>
                                                            <div class="col-4">
                                                                <span class="input-group-addon"><?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?> Chatak <?php else : ?> Lessa <?php endif; ?></span>
                                                                <input type="text" onkeyup="familyAreaCheck()" style="text-align: center;" value="<?php if (isset($err_return)) {
                                                                                                                                                        echo set_value('reserved_lessa_family' . $family_dag->id);
                                                                                                                                                    } else {
                                                                                                                                                        echo "0";
                                                                                                                                                    } ?>" class="form-control input-sm <?php if (form_error('reserved_lessa_family' . $family_dag->id)) {
                                                                                                                                                                                            echo 'lm_invalid';
                                                                                                                                                                                        } ?>" name="reserved_lessa_family<?= $family_dag->id ?>" id="reserved_lessa_family<?= $family_dag->dag_no ?>">
                                                            </div>
                                                        </div>
                                                        <?php if ((in_array($basic["dist_code"], json_decode(BARAK_VALLEY)))): ?>
                                                            <div class="form-group row mt-2">
                                                                <div class="col-4">
                                                                    <span class="input-group-addon">Ganda</span>
                                                                    <input type="text" onkeyup="familyAreaCheck()" style="text-align: center;" value="<?php if (isset($err_return)) {
                                                                                                                                                            echo set_value('reserved_ganda_family' . $family_dag->id);
                                                                                                                                                        } else {
                                                                                                                                                            echo "0";
                                                                                                                                                        } ?>" class="form-control input-sm <?php if (form_error('reserved_ganda_family' . $family_dag->id)) {
                                                                                                                                                                                                echo 'lm_invalid';
                                                                                                                                                                                            } ?>" name="reserved_ganda_family<?= $family_dag->id ?>" id="reserved_ganda_family<?= $family_dag->dag_no ?>">
                                                                </div>
                                                                <div class="col-4 hide">
                                                                    <span class="input-group-addon">Kranti</span>
                                                                    <input type="text" onkeyup="familyAreaCheck()" style="text-align: center;" value="<?php if (isset($err_return)) {
                                                                                                                                                            echo set_value('reserved_kranti_family' . $family_dag->id);
                                                                                                                                                        } else {
                                                                                                                                                            echo "0";
                                                                                                                                                        } ?>" class="form-control input-sm <?php if (form_error('reserved_kranti_family' . $family_dag->id)) {
                                                                                                                                                                                                echo 'lm_invalid';
                                                                                                                                                                                            } ?>" name="reserved_kranti_family<?= $family_dag->id ?>" id="reserved_kranti_family<?= $family_dag->dag_no ?>">
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php } ?>
                                        ...
                                        <!-- <div class="row p-2" >
                                            ...
                                            <div class="col-md-6">
                                                <input
                                                        ...
                                                        class="form-control <?php if (form_error('zonal_valuation')) {
                                                                                echo 'lm_invalid';
                                                                            } ?>"
                                                        value="<?php if (isset($err_return)) {
                                                                    echo set_value('zonal_valuation');
                                                                } ?>"
                                                />
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="row p-2">
                                            <div class="col-md-6">
                                                <span><strong><?= $sl_count++ ?>.</strong> Copy of map of the proposed land
                                                    clearly highlighting the propose land road/riverside reservation etc(if
                                                    any)</span>
                                                <strong style="color:red">[**This draft map must be generated from Bhunaksha and then upload]</strong>
                                                <?php
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                    ...
                                                    <input type="file" accept=".png, .jpg, .jpeg, .pdf" name="trace_map_copy<?= $dags_trace->dag_no ?>" id="trace_map_copy" class="form-control <?php if (form_error('trace_map_copy' . $dags_trace->id)) {
                                                                                                                                                                                                    echo 'lm_invalid';
                                                                                                                                                                                                } ?>" /><br>
                                        ...
                                        <div class="row p-2 <?php if (form_error('land_exceed')) {
                                                                echo 'lm_invalid';
                                                            } ?>">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="lm_note" id="lm_remark" class="form-control <?php if (form_error('lm_note')) {
                                                    ...
                                                    ?>
                                                        <option value="<?= $lm_remark_cat->CODE ?>" <?php if (set_value('lm_note') == $lm_remark_cat->CODE) {
                                                                                                        echo "selected";
                                        ...
                                        <div class="row p-2" id="co_for_reject" style="display: none;">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control <?php if (form_error('co_code_reject')) {
                                                                                echo 'lm_invalid';
                                                                            } ?>" name='co_code_reject'>
                                                    <option value="">Select Circle Officer...</option>
                                                    <?php
                            ...
                            <ul class="list-inline pull-right" style="margin-top: 20px">
                                ...
                                <?php if (ENABLE_BUTTON_LM_SUBMIT_NC != 0) { ?>
                                    <?php if ($setEncroacherStatus == 0): ?>
                                        <li>
                                            <input type="submit" onClick="this.disabled=true; this.value='Saving...';" value="Save and submit" class="btn btn-primary next-step" id="btnLmSubmit" style="color: white!important;">
...
<script>
    ...
    $('#btnLmSubmit').on('click', function(e) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            html: 'Map: Uploaded from Bhunakasha ; <br><br> Land Occupied : ' + $("#is_landless option:selected").text() + "; <br /><br /> Encroacher Exists in VLB - " + encDataAll,
            icon: 'warning',
            showCancelButton: true,
