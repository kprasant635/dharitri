            ...
            <div class='row'>
                <div class="panel panel-info panel-form">
                    ...
                    <div class='panel-body'>
                        <form class='form-horizontal'  action="<?php echo base_url(); ?>index.php/MisReport/back_step_three" method="post">
                          
                            <div class="form-group">
                                <label for="inputEmail3"  class="col-sm-3 uni_text control-label required">New Dag Number</label>
                                <div class="col-sm-2">
                                    <input type="text" readonly class="form-control" name="new_dag" value="<?php echo $dagpatta['newdag']; ?>" >
                                </div>
                                <label for="inputEmail3"  class="col-sm-3 uni_text control-label required">New Patta Number</label>
                                <div class="col-sm-2">
                                    <input type="text" readonly class="form-control" name="new_patta" value="<?php echo $dagpatta['newpatta']; ?>" >
                                </div>
                            </div>
                            <div class=" hide form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" readonly class="form-control" name="pdar_cron_no" value="<?php echo $dagpatta['newpatta']; ?>" >
                                </div>
                            </div>
