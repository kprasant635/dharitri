        ...
        <div class="col-lg-10 col-lg-offset-1 ">
            <div class="panel panel-info panel-form">
                ...
                <?php } ?>
					...
					<a class="btn btn-info uni_text" id='cbsic'  href='<?php echo base_url() . 'index.php/Allotment/viewlmnote?case_no='.$allotment_cb->case_no?>'>
				...
				<br><br><br>
                <form class="form-horizontal  unicode" action="<?php echo base_url()."index.php/Allotment/sk_submit" ?>" method="POST"  >              
				...
				<div class="form-group">    
                    ...
                    ?>
                        <div class="col-lg-10">
                            <textarea class="form-control" rows=5 placeholder='Type here' name="sk_comment" required="" value="" >আবেদনকারীর আবেদন /  লা:ম র প্রতিবেদন এবং সিন্থেটিক নাম পরীক্ষিত । প্যাটনের প্রস্তাবটি অনুমোদনের পথে জেলা প্রশাসকের কাছে পাঠানো যেতে পারে । </textarea>
