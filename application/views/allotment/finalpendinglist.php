            ...
            <table id="example" class="table table-hover  panel-body" width="100%">
               ...
               // var_dump($cases);
                foreach ($cases as $case): ?>
                    <tr>
			<?php if($case->es_flag == '1' && ESCALATION_ENABLE ==1){ ?>
			...
			<?php } ?>
                        ...
                        <td>
                            <?php 
                                ...
                                {
                                    ?>
                                    <a class='btn btn-danger' href='<?php echo base_url() . 'index.php/Allotment/dcfinalorder' ?>?case_no=<?php echo enc_param('case_no', $case->case_no, 600) ?>'>PROCESS</a>
                            <?php } ?>
