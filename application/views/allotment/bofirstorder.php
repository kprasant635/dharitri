        ...
        <div class="col-lg-10 col-lg-offset-1 ">
            <div class="panel panel-info panel-form">
                ...
                <?php
                    ...
                    if($barak){
                ?>
                    <h2 class="text-center" style="top:50px; margin-top:20px;z-index:1000"> শাখা কর্মকর্তার আদেশ </h2>
                <?php } else { ?>
                ...
                <?php
                  ...
                  ?>
                <form class="form-horizontal unicode" action="<?php echo base_url() . "index.php/Allotment/saveboorder" ?>" method="POST"  >              
                    ...
                    <?php }?>
                        ...
                        <div class="form-group">    
                            ...
                            ?>
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows=5 placeholder='Type here' name="bo_comment" required="" value="" >  সার্কেল অফিসার ,<?php echo $circlename; ?>বরাদ্দ থেকে ইজারা পাওয়ার মাধ্যমে জমা দেওয়া রাজস্ব চক্র <?php echo $allotment_cb->case_no; ?> নং ভূমিলেখ্য সহায়ক / ভূমিলেখ্য পৰ্যবেক্ষক / সার্কেল অফিসারের প্রস্তাব এবং প্রতিবেদন চেক করা হয়েছে এবং দেখা হয়েছে। প্যাটনের প্রস্তাব অনুমোদন করতে পারেন ।</textarea>
                                </div>
                            <?php } else { ?>
                            <div class="col-lg-10">
                        ...
                        ?>
                            <label class="radio-inline hide col-lg-offset-2 uni-text">
                                <input type="radio" name="next_hearing" title="Reject This Case"  value="D"> মামলা খারিজ করুন
                            </label>                    
                            <label class="radio-inline hide uni-text ">
                                <input type="radio" name="next_hearing" title="Forward to Circle Officer" value="P">  সাইকেল অফিসার আবার রিপোর্ট করুন 
                            </label>
                            <label class="radio-inline hide uni-text">
                                <input type="radio" name="next_hearing" title='Send to BO'  value="R" checked=""> BO তে প্রেরণ করুন
                            </label>
                        <?php } else { ?>
                        <label class="radio-inline hide col-lg-offset-2 uni-text">
