                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(ESCALATION_ENABLE == 1 && $case->is_escalated == 1){
                                ...
                                {
                                    ?>
                                    <a  href='<?php echo base_url() . "index.php/Allotment/Finalcoorder?case_no=" . enc_param('case_no', $case->case_no, 600) . "&dist_code=" . $case->dist_code . "&subdiv_code=" . $case->subdiv_code . "&cir_code=" . $case->circle_code . "&mouza_pargona_code=" . $case->mouza_pargona_code . "&lot_no=" . $case->lot_no . "&vill_townprt_code=" . $case->vill_townprt_code; ?>' class="btn btn-danger">Update Dag & Patta</a>
                          <?php } ?>
                        </td>
