                ...
                <div class="panel-body">
                    <form class="form-inline" method="post" >
                        ...
                        <div class="form-group" style="width: 100%;"> 
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="finalorder[lm_note_date]"
                                       value="" class="form-control calendar dating"      id="applicantNam" 
                                       placeholder="">
                            </div>
                        ...
                        <div class="form-group" style="width: 100%;"> 
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="finalorder[co_ord_date]" value="" class="form-control calendar dating"     name="co_ord_date" id="applicantNam" 
                                       placeholder="">
                        ...
                        <fieldset>
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th class="partitionhide">Inplace/Alongwith</th>
                                    <th>Include in Current Order?</th>
                                </tr>
                                <?php
                                $j = 0;
