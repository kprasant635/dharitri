        ...
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" value="<?php echo $pattadar->pdar_id; ?>" class="form-control"     name="pdar_id" id="applicantNam" 
                                       placeholder="">
                        <div class="form-group" style="width: 100%;"> 
                            <label for="inputEmail3" class="col-sm-2  control-label required" id='applicant_name_label'>PDAR ID</label>
                            <div class="col-sm-4">
                                <input type="text" value="<?php echo $pattadar->pdar_id; ?>" class="form-control"     name="new_pdar_id" id="applicantNam" 
                                       placeholder="">
                            </div>
                        </div>
                        <hr>
