        ...
        <div class="col-lg-10 ">
            <div class="panel panel-info panel-form">
                <div class="panel-heading">
                    <h3 class="panel-title">INPLACE ADD</h3>
                </div>
                <div class="panel-body">
                    <form class="form-inline" method="post">
                        ...
                        <div class="form-group" style="width: 100%;">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  required   value="<?php echo $this->session->userdata('ord_cron_no');?>" name="ord_cron_no" id="applicantNam" required
                                       placeholder="">
                            </div>
                        ...
                        <div class="form-group" style="width: 100%;">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  required   name="inplace_of_name" id="applicantNam" required
                                       placeholder="">
                            </div>
                            <label for="inputEmail3" class="col-sm-2 uni_text control-label required" id='applicant_name_label'>INPLACE OF GUARDIAN</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  required   name="inplace_of_guardian" id="applicantNam" required
                                       placeholder="">
                            </div>
                        </div>
                        <hr>
                        ...
                        <hr>
                         <div style="text-align: center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/chithaeditentry/step5" class="btn btn-danger">NEXT</a>
                        </div>
                    </form>
                </div>
            </div>
