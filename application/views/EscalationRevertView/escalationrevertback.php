            ...
            <div class="error_container">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <h5 style="color:brown;"> Since the case has been escalated to CO, LRA no longer has a timeline to take action, and the allocation days are now coming from CO's own timeline. kindly ensure before time allocate to LRA/SK </h5>
                        <form class="form-horizontal" action="<?php echo base_url() . 'index.php/AutoEscalationRevertController/revertBackEscalationCases' ?>" method="post" >
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            $user = $this->utilityclass->decryptJwtCase(($this->input->get('revert_to_user'))); 

                                            echo $user == 'LM' ? 'LRA' : $user;
                                        ?>
                                    </td>
                                </tr>
