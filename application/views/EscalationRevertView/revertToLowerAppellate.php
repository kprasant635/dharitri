                        ...
                        <form class="form-horizontal" action="<?php echo base_url() . 'index.php/AutoEscalationRevertController/revertBackEscalationCases' ?>" method="post" >
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" name='revert_to_user'>
                                            <option value='' disabled selected>Select Appellate Authority</option>
                                            <?php
                                                foreach(json_decode(REVERT_TO_APPELLATE_USER) as $user)
                                                {
                                                    if($this->session->userdata('user_desig_code') == $user->IF_LOGIN)
                                                    {
                                                        echo '<option value="'.$user->REVERT_TO.'">'.$user->REVERT_TO.'</option>';
                                                    }
                                                }
                                            ?>
                                        </select>
                            ...
                            <input type='hidden' name='esc_env' value='<?=$esc_env?>'>
