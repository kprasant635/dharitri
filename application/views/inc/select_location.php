        ...
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Select Village/Town Name</h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="citha_report1.php">
                        <div class="form-group">
                            <label for="select" class="col-lg-2 control-label">District</label>
                            <div class="col-lg-10">
                                <select class="form-control" id="select" required>
                                    <option disabled selected>Select District</option>
                                    <?php foreach ($data['names'] as $district):?>
                                        <?php 
                        ...
                        <div class="form-group">
                            <label for="select" class="col-lg-2 control-label">Sub-Division</label>
                            <div class="col-lg-10">
                                <select class="form-control" id="select" required>
                        ...
                        <div class="form-group">
                            <label for="select" class="col-lg-2 control-label">Mouza</label>
                            <div class="col-lg-10">
                                <select class="form-control" id="select" required>
                        ...
                        <div class="form-group">
                            <label for="select" class="col-lg-2 control-label">Lot No</label>
                            <div class="col-lg-10">
                                <select class="form-control" id="select" required>
                        ...
                        <div class="form-group">
                            <label for="select" class="col-lg-2 control-label">Village/Town</label>
                            <div class="col-lg-10">
                                <select class="form-control" id="select" required>
