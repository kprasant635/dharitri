            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        ...
                        <form name='frmDelete' method='post' action='<?php echo base_url() . "index.php/APCancellation/regenerate_showcause_notice"; ?>'>
                            <div class="row hide">
                            ...
                            <p style="color:red; font-weight: bold !important; font-size: 18px;" class='center'>Please enter valid AP cancellation case no.</p>
                            <div class="row">
