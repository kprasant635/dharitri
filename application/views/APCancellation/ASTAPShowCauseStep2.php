            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body uni_text" style='min-height:460px'>
                        ...
                        ?>
                        <p>
                            এই পাট্টাদ্বাৰৰ পাট্টা  <span class='red'>( দাগ নং :  <?php echo $this->utilityclass->cassnum($dag_no); ?>   / পাট্টা নং : <?php echo $this->utilityclass->cassnum($patta_no); ?>)  </span> বাতিল কৰা উচিত হয় নে নহয় সাপেক্ষে  <strong class='red'><b><?php echo $_GET['case_no']; ?></b></strong> নং গোচৰৰ  মতে কাৰণ দৰ্শোৱাৰ জাননী জাৰী কৰা হ`ল | পৰবৰ্তী শুনানিৰ তাৰিখ <?php echo $this->utilityclass->cassnum(date('d-m-Y', strtotime($_GET['date_hearing']))); ?> নিৰ্ধাৰিত কৰা হল |
                        </p>
                        <p>
