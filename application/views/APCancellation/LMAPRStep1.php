    ...
    <div class="col-lg-12 ">
        <div class="col-lg-10 col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 style="text-align: center; "><?php echo $this->lang->line('lm_report_on_ap_cancellation');?></h2>
            </div>
        </div>
        <div class="col-lg-10 col-lg-offset-1">
