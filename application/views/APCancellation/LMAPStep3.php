            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . "index.php/APCancellation/LMAPStep3"; ?>">
                            ...
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-2">
                                    ...
                                    {
                                    ?>
                                    <a href="<?php echo base_url() . "index.php/APCancellation/LMAPStep4"; ?>" class="btn btn-danger pull-right disabled">
                                    ...
                                    {
                                    ?>
                                    <a href="<?php echo base_url() . "index.php/APCancellation/LMAPStep4"; ?>" class="btn btn-danger pull-right">
                                        <?php echo $this->lang->line('next');?>&nbsp;<i class="fa fa-arrow-right"></i>
                                    </a>
                                    <?php
                                    }
