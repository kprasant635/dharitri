                        ...
                        <form name="f1"  class="form-horizontal" method='post' action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control"  name="mut_type" required>
                                            <option value="0504">পট্টা ৰদ (একচনা পট্টা)<?php //echo $this->lang->line('patta_rod');?></option>
                                        </select>
                                    </div>
                                    <label for="select" class="col-lg-2 control-label"><?php echo $this->lang->line('submission_date');?></label>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" id="popupDatepicker" readonly name="submission_date" value="<?php echo date("d-m-Y", strtotime(date("Y-m-d"))); ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="select" class="col-lg-2 control-label"><?php echo $this->lang->line('patta_no');?></label>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" autocomplete="off" name="patta_no" id="patta_no" value="" onkeyup="return onlyint(this.value);"  required />
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 center">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/APCancellation/ASTStep1">
