                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method='post' action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="hidden" name="mouza_code" class="mouzaselect" value="<?php echo $this->session->userdata('mouza_pargona_code')?>"/>
                                    <input type="text" name="cir" class="form-control " readonly="readonly" value="<?php echo $mouza[0]->mouza; ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="hidden" name="lot_no" class="lotselect" value="<?php echo $this->session->userdata('lot_no')?>"/>
                                    <input type="text" name="cir" class="form-control " readonly="readonly" value="<?php echo $lot[0]->lot_no; ?>"/>
