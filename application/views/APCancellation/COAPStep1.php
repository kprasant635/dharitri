        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center; "><?php echo $this->lang->line('co_report_on_ap_cancellation');?></h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    <div class="panel-body">
						...
						<tbody>
                            <?php
                            $row = count($countAPCaseforCO);
                            if ($row > 0) {
                                $c = 1;
                                foreach ($countAPCaseforCO AS $cases) {
                                    ?>
                                ...
                                ?>
                                <tr class="text-center">
                                    <td colspan="4" style="color: red;">No fresh NRCase found. (নতুন গোচৰ বিচাৰি পোৱা নগল)  
                                        <br/>
                                    </td>
                                </tr>
                            <?php } ?>
