...
<div class="modal align-middle" id="lb_revert_modal" role="dialog">
            ...
            <div class="modal-header text-white text-bold text-center bg-danger">                
                ...
                <div class="row" align="center" style="padding:10px;">
                    <div class="col-lg-12" align="center">
                        <button type="button" class="btn btn-sm btn-success" onclick="lbRevertFormSubmit()">
                            <i class="fa fa-check" aria-hidden="true"></i>
                                Submit
                        </button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="lbRevertModalClose()">
