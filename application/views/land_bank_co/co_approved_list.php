...
<div class="panel panel-info panel-form mt-5">
    <div class="panel-heading bg-info text-center">
        <h3 class="panel-title">
            <u>
                Village Land Bank - (Approved-List) : Circle - <?php echo $this->utilityclass->getCircleName($dist_code,$subdiv_code,$circle_code); ?>, 
            </u>                        
        </h3>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <form action="<?php echo base_url() . 'index.php/LandBankCO/getApprovedList' ?>" method="post" id="lb_pagination_form">
                ...
                <div class="form-group">
                    <form action="<?php echo base_url() . 'index.php/LandBankCO/searchApprovedListByDag' ?>" method="post" id="lb_pagination_form">
                        ...
                        <tbody>
                            <?php foreach ($pending_list as $pending):?>                                    
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm text-white" onclick="lbViewModal('<?=$pending->id?>', '' )">
                                            <i class="fa fa-eye"></i>
                                            View
                                        </button>
                                    </td>                                                                
...
<?php include 'lb_view_form_show_co.php'; ?>
