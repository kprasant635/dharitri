                ...
                <div class="modal-body">
                    ...
                    <!-- <form id="lb_approve_rmk_form">
                        <div class="form-group mb-5">
                            ...
                            <div id="approved" class="col-sm-10 mb-3">
                                <td>
                                    <input type="hidden" name="encroacher_id" id="encroacher_id">
                                    <textarea class="form-control" placeholder="--Approval-Remark--" rows="2" name="lb_approve_rmk" id="lb_approve_rmk"></textarea>
                                </td>
                            </div>
                        </div> 
                        <div class="form-group mb-5 deletion_remark" style="display:none">
                            <label class="col-sm-2 uni_text control-label text-right">
                                Deletion Remark :
                                <span style="color:red;font-weight:bold; font-size: 25px;">*</span>
                            </label>                            
                            <div id="deleted" class="col-sm-4 mb-3">
                                <td>
                                    <textarea class="form-control" placeholder="--Deletion-Remark--" rows="2" name="lb_delete_rmk" id="lb_delete_rmk"></textarea>
                                </td>
                            </div>
                        </div> 
                    ...
                    <div class="row" align="center" style="padding:10px;">
                        <div class="col-lg-12" align="center">
                            <!-- <button type="button" class="btn btn-success" onclick="lbApproveFormSubmit()">
                                <i class="fa fa-check" aria-hidden="true"></i>
                                    Forward to DC
                            </button> -->
                            <button type="button" class="btn btn-danger" onclick="lbViewModalClose()">
...
<script type="text/javascript">
    ...
    function checkboxes(){
        var inputs = document.getElementsByName('delete_enc[]');
        var encIdArray = [];
        var inputObj;
        // alert(inputs.length);
        var selectedCount = 0;
        for(var count1 = 0;count1<inputs.length;count1++){
            ...
            if (type == 'checkbox' && inputObj.checked) {
                ...
                if(inputs.length == selectedCount){
                    ...
                    document.getElementById("delete_enc"+[count1]).checked = false;
                    selectedCount--;
                }else{
        ...
        if(selectedCount>=1){
            ...
            $(".deletion_remark").show();
            $("#encroacher_id").val(encIdArray);
