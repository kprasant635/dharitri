                ...
                <tbody>
                    ...
                    foreach ($cases as $case):
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <?php if($case->comp_serv_yn=='Y'):?>
                            <td><kbd><?php echo $case->c_no; ?></kbd></td>
                            <?php else: ?>
                            <td><?php echo $case->c_no ."<br><span class='small red'>". $case->application_ref_no ."</span>"."<br><span class='small red'>". $case->rtps ."</span>";; ?></td>
                            <?php endif; ?>
                            <td><?php echo $this->lang->line('office_partition'); ?></td>
                            <td><?php echo date('d/m/Y', strtotime($case->submission_date)); ?></td>
                            <?php if ($case->pay_notice_gen_yn == 'Y') { ?>
                                <td>
                                    <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/partition/ByayNoticeGenerate?pid=<?php echo $case->petition_no; ?>&case=<?php echo $case->c_no ?>"><?php echo $this->lang->line('write_report'); ?></a>
                                </td>
                                <?php
                            } else {
                                ?>
