                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($case->ord_type_code == '04'): ?>
                                    <a class="btn btn-danger msg" href="<?php echo base_url(); ?>index.php/partition/updateChithaPartition_dd?case_no=<?php echo $case->ord_no ?>">Update</a>
                                    <a class="btn btn-success btn-xs msg" href="<?php echo base_url(); ?>index.php/partition/updatePartition_order?case_no=<?php echo $case->ord_no ?>">Delete and Pass Order Again</a>
                                <?php endif; ?>
                            </td>
                        </tr>
<?php endforeach; ?>
