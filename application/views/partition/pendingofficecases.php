...
<div class="container-fluid form-top login">
    <div class='row '>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <a href="<?=base_url().'index.php/home/PartitionLmOP'?>">
        ...
        <div class='col-lg-12 panel panel-default' style="margin: 0 auto;float: none;">
            ...
            <?php endif; ?>
            <table id="example" class="table table-hover table-bordered table-striped  panel-body" width="100%">
                <thead >
                    <tr >
                ...
                <tbody>
                    ...
                    foreach ($cases as $case):
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td><?php echo $case->c_no; ?>
                                <br>
                                <span class='small font-italic red'>
                                <?php if($case->basundhara){ echo "Basundhara:". $case->basundhara ;} ?></span>
                                <span class='small font-italic red'>
                            ...
                            <td>
                                ...
                                <?php if ($case->mut_type == '04'):
                                    ...
                                    {
                                        ?>
                                        <a class="btn btn-danger msg" href="<?php echo base_url(); ?>index.php/partition/LmPartitionRpt?petition_no=<?php echo $case->petition_no ?>&case_no=<?php echo $case->c_no ?>"><?php echo $this->lang->line('write_report'); ?></a>
                                    <?php } ?>
    ...
    $(document).ready( function () {
        ...
        function load_data(zone_status)
        {
            ...
            var table = $('#example').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/EscalationController/searchByEscalationZoneForLmOfficePartition',
                    type:'POST',
