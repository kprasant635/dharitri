            ...
            <div class="col-lg-12">
                <div class="well well-sm">
                    <h2 style="text-align: center;">চক্র বিষয়াৰ হুকুম 
                        <?php
      //                   if (($pb->pay_notice_gen_yn == null)) {
                             ?>
                             <!-- <p class='red uni_text'>Byay-Prak Report Not Generated yet   <br> Please Click on <em>Continue Order</em> </p> -->
                             <?php
      //                   } elseif($byayprak->if_paid != 'Y') {
      //                       echo "<p class='red uni_text'>Premium not received by Assistant !! Check Byay-Prak Prak Report.</p>";
      //                   }else{
						// 	echo "<p class='green uni_text'>Click on Final Order !!</p>";
						// }
                        ?>
                    </h2>
                </div>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            <label class="col-sm-4 rasid">হুকুম  ক্রমিক নং : 2 </label>
                            <label class="col-sm-4 rasid">তাং : <?php echo date('d/m/Y') ?></label>
                            <br>
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal unicode" action="<?php echo base_url(); ?>index.php/partition/SaveAgainReport" method="POST">
                            <div class="panel panel-info panel-form">
                                ...
                                <div class='panel-body'><!----form start---->
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label required">Please Select an option</label>
                                        <div class="col-lg-offset-4">
                                            <?php
                                                $msg = "ভূমিলেখ্য সহায়ক / ভূমিলেখ্য পৰ্যবেক্ষক ৰ প্রতিবেদন মতে খৰিদা জমিত আবেদনকাৰীৰ দখল-আবাদ আছে | জাননী ৰীতিমতে জাৰি হয় আৰু জাননী জাৰিৰ ম্যাদৰ ভিতৰত কোনো আপত্তি আদি পোৱা নাই |  "
                                                        . "সকলো তথ্য সঠিক আছে | বাটোবাৰাৰ অন্তিম হুকুম দিয়া হল |  চক্র বিষয়া";
                                             ?>
                                                <label class="radio-inline">
                                                    <input  type="radio" name="next_hearing"  checked="" required=""  value="F"><?php echo $this->lang->line('final_order'); ?>  
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="next_hearing"   value="P"><?php echo $this->lang->line('continue_order'); ?> 
                                                </label>
                                        </div>
                                    </div>
                                    <div class="textt" >
                                        <div class="form-group">
                                            <label for="select" class="col-sm-4 control-label required"> <?php echo $this->lang->line('next_hearing_date'); ?> : </label>
                                            <div class="col-sm-3">
                                                <input type="text" id="enable_next_date" autocomplete="off" required="" class="form-control" name="next_hear_date" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="select" class="col-sm-4 control-label"><?php echo $this->lang->line('order'); ?>  :</label>
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="comment" rows="4"><?php echo $msg ?> </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-offset-2">
                                                <label class="checkbox-inline checkbox-primary">
                                                    <input type="checkbox" class="large squaredTwo" disabled  name="asst_notice" value="Y"> <?php echo $this->lang->line('notice_regenrate'); ?>
                                                </label>
                                                <!-- <label class="checkbox-inline">
                                                    <?php if ($pb->pay_notice_gen_yn == null and $byayprak->if_paid == null) {
                                                        ?>
                                                        <input type="checkbox" class="squaredTwo" required="" checked=""  name="byay_notice"  value="Y"><span class="blink_me red"><?php echo $this->lang->line('bayaprak_report'); ?></span>
                                                    <?php } else { ?>
                                                        <input type="checkbox" class="squaredTwo" disabled  name="byay_notice"  value="Y"><?php echo $this->lang->line('bayaprak_report'); ?>
                                                    <?php } ?>
                                                </label> -->
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" class="squaredTwo" disabled name="lm_notice"  value="Y"><?php echo $this->lang->line('mondal_report_resubmission'); ?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            echo '<hr><h2 class="red">Document(s) Attachments</h2> <ul>';
                            ...
                            ?>
                                <div class="panel-footer center">
                                    ...
                                    <div class="row col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <label><span class="pull-left">View Document Uploaded by LRA</span></label>
                                    ...
                                    <?php endif;?>
                                    <input type="hidden" value="<?php echo $this->session->userdata('case_no'); ?>" name="caseno" >
                                    <div class="btn btn-info uni_text" id="BackMain" ><i class="fa fa-reply "></i> &nbsp;<?php echo $this->lang->line('back_to_home'); ?></div>

                                    <?php if($buttonEnabledFlag == 1){ ?>
                                        <button class="btn btn-primary uni_text" type="submit" name="submit" ><i class="fa fa-share "></i> &nbsp;<?php echo $this->lang->line('submit_button'); ?></button>
                                    <?php } ?>
                                    
                                    <button type="button" class="btn btn-danger" onclick="showRejectModal('<?=$this->session->userdata('case_no');?>',<?=SERVICE_OFFICE_PARTITION?>)"><i class="fa fa-close"></i> &nbsp;Reject Application</button>
                                    <?php if (isset($basuCase)) { ?>
                                <br>
                                <a href="<?php echo base_url() . "index.php/Partition/revertback?case_no=" . $pb->case_no. "&dist_code=" . $pb->dist_code . "&subdiv_code=" . $pb->subdiv_code . "&cir_code=" . $pb->cir_code . "&mouza_pargona_code=" . $pb->mouza_pargona_code . "&lot_no=" . $pb->lot_no . "&vill_townprt_code=" . $pb->vill_townprt_code; ?>" class='text-small font-italic text-danger'>Click Here to Revert Back for Report</a>
                                <?php } ?>
                        ...
                        <div class="col-lg-12 alert alert-warning">
                            ...
                            <div class="col-lg-12 center" style="margin-top: 10px;">
                                ...
                                <div class="btn btn-info uni_text" data-toggle="modal" data-target="#myModalAST"  ><i class="fa fa-unlock-alt "></i> &nbsp; Assistant report</div>
							...
							<div class='col-lg-12 center'>
								...
								$m=$dags[0]->mouza_pargona_code;	
								$l=$dags[0]->lot_no;	
								$v=$dags[0]->vill_townprt_code;	
								$dag=$dags[0]->dag_no;	
								$giscode=$d."_".$s."_".$c."_".$m."_".$l."_".$v."&plotno=".$dag;
								if($d=='16' or $d=='06'){
								?><div style='margin-top:10px' class="btn btn-info uni_text" >
            ...
            <div class="modal-body">
                <div class="col-lg-12" >
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 col-sm-12 alert alert-info">
                        ...
                        <p class="uni_text text-red"><u>LRA Revert Report</u></p>
...
//           var_dump($lmNote);
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 col-sm-12 alert alert-info">
                    <div class="col-lg-12 text-bold"></div>
                    <p class="uni_text text-red"><u>LRS Revert Report</u></p>
                    <?php $i=1; foreach($sk_revert_note as $note): ?>
                        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                            <p class="uni_text"><?php echo $note->order_date; ?> </p>
                        </div>
                        <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                            <p class="uni_text"><?php echo $note->co_order; ?> </p>
                        </div>
