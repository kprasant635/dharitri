                                ...
                                <div class="panel-heading">
                                    ...
                                    <p align="right" style="margin-top: 0; margin-bottom: 0">
                                        ...
                                        foreach ($p_in_order as $pop):
                                             $relation=$this->utilityclass->get_relation($pop->pdar_rel_guar);
                                            echo $pop->pdar_name . ", " .$relation."-". $pop->pdar_guardian . "<br>";
                                        endforeach;
                                        ?>
                                        </font>
                                    </p>
...
//$i = $i+1;
                                            ...
                                            <div class="col-lg-12 center">
                                                <a class="btn btn-danger uni_text" href="<?php echo base_url(); ?>index.php/partition/ActionTakenRpt"><i class='fa fa-arrow-left'></i> <?php echo $this->lang->line('back') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
