<div class="container-fluid form-top login">
        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">Field Partition Cases For First Proceeding
                    </h2>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                            ...
                            <table class='table table-striped table-bordered' id='PendingFieldPartCases' width="100%">
                                <thead>
 ...
 <script type="text/javascript">
    ...
    $('#mouza_lot, #village_om, #zone_status').change(function(){
            ...
            $('#PendingFieldPartCases').DataTable().destroy();
        ...
        function load_data(mouza_code,lot_no,vill_mouza_code,vill_lot_no,village_code,zone_status)
        {
            ...
            var table = $('#PendingFieldPartCases').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/COFieldMutation/getPendingPartitionCasesLMendList',
                    type:'POST',
                    data: {
