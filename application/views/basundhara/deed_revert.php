                      ...
                      <table class="table">
                       ...
                       <ul class="list-group" style='margin-bottom: 10px'>
                        ...
                        <?php
                          ...
                          <button type="button" class="btn btn-danger btn-sm" onclick="showRejectModalNoCase('<?=$_GET['app']?>','2')"><i class="fa fa-close"></i> &nbsp;Reject Application</button>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    if(rural_urban=='Y'){
      sendurl=baseurl+'basundhara/adcApproveRejectOffice';
    }else{
      sendurl=baseurl+'basundhara/adcApproveReject';
    }
