             ...
             <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                      ...
                      <hr>
                      <!--  <div class="col-lg-3">
                        <label for="inputEmail3" class="col-sm-4 uni_text control-label required" aria-required="true">Assign Circle Officer</label>
                                    <select class="form-control" name="official" >
                                       ...
                                       <!-- <?php foreach($user as $u){
                                 ?>
                                <option value="<?=$u->user_code?>"><?=$u->co_name?> </option>
                                <?php } ?>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/namecancelPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
