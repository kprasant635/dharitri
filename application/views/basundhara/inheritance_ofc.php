                ...
                <div class="panel panel-info panel-form">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Registration of Office Mutation <kbd>Inheritance Mutation (<?=$_GET['app']?>)</kbd>
                        </h3>
                    </div>
                    <div class="panel-body">
                      ...
                      <table class="table">
                         ...
                         <tr>
                           ...
                           <td><input type="number" required="" name="mut_area_k"  value="<?=$secParty[0]->area_k;?>" /> Katha </td>
                           <td><input type="number" required="" name="mut_area_l" value="<?=$secParty[0]->area_l;?>" /> Lessa </td>
                         </tr>
                      </table>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/inheritanceOfcPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
