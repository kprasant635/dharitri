             ...
             <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                          ...
                          <input type="hidden" class="form-control" name='case_no' value="<?=$app->application_no?>">
                      ...
                      <input type="hidden" class="form-control" name='app_id' value="<?=$app->id?>">
                        ...
                        <?php
                          ...
                          <button type="button" class="btn btn-danger btn-sm" onclick="showRejectModalNoCase('<?=$_GET['app']?>','7')"><i class="fa fa-close"></i> &nbsp;Reject Application</button>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/adcApproveRejectAreaCorrection', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
