                      ...
                      <hr>
                       <!-- <div class="col-lg-3">
                        ...
                        <center>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" onclick="showRejectModalNoCase('<?=$_GET['app']?>','6')"><i class="fa fa-close"></i> &nbsp;Reject Application</button>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        ...
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/adcApproveRejectNameCorrect', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
