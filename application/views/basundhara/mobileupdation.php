                    ...
                    <div class="panel-body">
                      ...
                      <table class="table">
                       ...
                       <span id='loading'></span><span id='msg'></span>
                        <center>
                          <button type="submit" class="btn disable_forward btn-sm btn-primary"><i class='fa fa-check-square-o'></i> Update Record</button>&nbsp;
                          <button type="button" class="btn btn-sm btn-danger" onclick="showRejectModal('<?=$app->application_no?>','<?=SERVICE_MOBILE_UPDATE?>')"><i class="fa fa-close"></i> &nbsp;Reject Application</button>&nbsp;
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/mbileUpdatePost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
