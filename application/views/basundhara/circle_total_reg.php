  ...
  <div class="col-lg-12">
    ...
    <div class="row">
      <p class="uni_text">Total No. of Basundhara Case(s) in your circle </p>
      ...
      <!--Second Row Start-->
      <hr>
      <p class="uni_text">Registraion of Total Case(s) Basundhara in your circle </p>
          ...
          <div class="card bg-info text-white">
                <div class="card-body text-white">
                  ...
                  Application Received: <kbd id='circle'><?=$row->count?></kbd>
                   <a href="<?php echo base_url() ?>index.php/basundhara/requestCircle/<?=$row->service_code?>"><i class="fa fa-hand-o-right fa-3x pull-right" title="Please Click Here to Check Details" ></i></a> 
