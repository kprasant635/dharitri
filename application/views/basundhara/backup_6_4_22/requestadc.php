	...
	<tr>
		...
		<td>
			...
			<?php }else if($pen->service_code=='5'){ ?>
				...
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/basundhara/allotmentBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> Action</a>
				<?php } ?>
			...
			<?php }else if($pen->service_code=='3'){ ?>
				...
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/basundhara/partitionBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> Action</a>
				<?php } ?>
