...
<script type="text/javascript">  
  ...
  <div class="col-lg-12">
    ...
    <div class="row">
      <p class="uni_text">Total No. of Basundhara 2.0 Review Geotag Details in the জিলা : <?=$output->data->district?></p>
...
<script>
          function get_geotag_count_by_lot(subdiv_code,cir_code,cir_name){
               ...
               $("#lotwise_details").show();
                ...
                'ajax': {
                    url: base_url + 'index.php/GeotagDashboard/geotagDashboardCountByLotSDOReview',
                    type: 'POST',
                    data: {
