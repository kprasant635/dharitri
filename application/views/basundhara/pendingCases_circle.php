  ...
  <div class="col-lg-12">
    ...
    <div class="row">
      <p class="uni_text">Registration Pending of Total Case(s) in Basundhara in your circle </p>
          ...
          <div class="card bg-info text-white">
                <div class="card-body text-white">
                  ...
                  Application Received: <kbd id='circle'><?=$row->count?></kbd>
                   <a href="<?php echo base_url() ?>index.php/basundhara/pendingRequestCircleWise/<?=$row->service_code?>"><i class="fa fa-hand-o-right fa-3x pull-right" title="Please Click Here to Check Details" ></i></a>
                </div>
              </div>
            </div>
            <?php endforeach; ?>
