                    ...
                    <div class="panel-body">
                      ...
                      <table class="table">
                         ...
                         <tr>
                           ...
                           <td><input type="number" required="" name="mut_area_b"  value="<?=$secParty[0]->area_b;?>" /> Bigha</td>
                           <td><input type="number" required="" min="0" max="4" name="mut_area_k"  value="<?=$secParty[0]->area_k;?>" /> Katha </td>
                           <td><input type="number" required="" min="0" max="19.99" step="0.01" name="mut_area_l" value="<?=$secParty[0]->area_l;?>" /> Lessa </td>
                         </tr>
                         <tr>
                           <td class="text-danger" colspan="2">Deed Details </td>
                           <td>Deed No:  <input type="text" required="" name="deed_no"  value="<?=$secParty[0]->deed_no;?>" /></td>
                           <td>Deed Date : <input type="text" required="" name="deed_date"  value="<?=$secParty[0]->deed_date;?>" id="DatepickerCO" /> </td>
                           <td>Deed Value : <input type="text" required="" name="deed_value" value="<?=$secParty[0]->deed_value;?>" /> </td>
                         </tr>
                      </table>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'basundhara/deedofcPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
