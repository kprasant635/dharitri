...
<script type="text/javascript">  
  ...
  <div class="col-lg-12">
    ...
    <div class="row">
      <p class="uni_text">Total No. of Basundhara 2.0 Geotag Details in the জিলা : <?=$output->data->district?></p>
    ...
    <tbody>
      ...
      <?php 
        if(trim($cirData->subdivision) != trim($subdiv)){
          continue;
        }
      ...
      <tr>
        ...
        <td><a  class="" href="#lotwise_details" onclick="get_geotag_count_by_lot('<?php echo $cirData->cir_code ?>','<?php echo $cirData->circle ?>')"    href="" title=""><i class="fa fa-eye" aria-hidden="true"></i> <?=$cirData->circle?></a></td>
...
<!-- Script for Lotwise Basundhara 2.0 Geotag Details for Specificv Circle SDO -->
<script>
          function get_geotag_count_by_lot(cir_code,cir_name){
               ...
               $("#lotwise_details").show();
                ...
                'ajax': {
                    url: base_url + 'index.php/GeotagDashboard/geotagDashboardCountByLotSDO',
                    type: 'POST',
                    data: {
                        cir_code: cir_code,
                    },
