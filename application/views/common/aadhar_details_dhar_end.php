...
<?php if(isset($selfDecData) && ($selfDecData[0]!= null || !empty($selfDecData[0]))){
  ?>   
    ...
    <?php  } if(isset($aadhaarData) && $aadhaarData->auth_type != null && $aadhaarData->is_applicant == 1): ?>
              <input type="hidden" name="auth_type" value="<?=$aadhaarData->auth_type?>">
              <table class="table_border table">
                <thead>
                  <tr>
              ...
              $state = '';
               if($aadhaarData->auth_type == "PAN"){ 
                  ...
                  <input type="hidden" name="aadhaar_no" value="<?=$aadhaarData->id_ref_no?>">
                  ...
                  <input type="hidden" name="dob" value="<?=$aadhaarData->dob;?>">
