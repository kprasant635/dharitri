            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?php echo base_url() . "index.php/COconversionPartha/updateProDate"; ?>" method="post" >
                            ...
                            <center>
                                ...
                                <a href="<?php echo base_url('index.php/COconversionPartha/GoToCO?pro=2'); ?>" class="btn btn-danger">
