        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Chitha Update</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if(ENABLED_BLOCKCHAIN == 1 && in_array($this->session->userdata('dist_code'),json_decode(ENABLED_BLOCKCHAIN_FOR_DIST)))
                            ...
                            <table class='table table-striped table-bordered rasid-t' style="font-size: 20px;">
                                <tr>
                                    ...
                                    endforeach;
                                    ?>
                                        <input type="hidden" name="case_no" class="form-control" value="<?php echo $location['case_no']; ?>">
                                        <input type="hidden" name="final_notice" class="form-control" value='ম্যাদীকৰণ প্রক্ৰিয়াৰ চিঠাবহী সংশোধন কৰা হল ৷<br>
                                        <span style="float:right;margin-right:50px; text-align: center"><?php echo $location['co_name']; ?><br>চক্র বিষয়া, <?php echo $location['cir']; ?></span>'/>
                                    </td>
                                </tr>
                            </table>
                            <hr style="border-bottom: 2px solid #000;">
                            <center>
                                <button type="submit" name="submit" id="onsubmit" class="btn btn-danger uni_text"><i class='fa fa-check'></i>  Proceed / Complete Order  </button>
                            </center>
                            <hr style="border-bottom: 2px solid #000;">
                            ...
                            <table class='table table-striped'>
                                      ...
                                      <tr>
                                          ...
                                          <td><input type="text" name="order_passed_by" value="<?php echo ($display['bo_note_yn'] == 'Y' ?  "DC" :  "CO" ); ?>" class="form-control" readonly/></td>
                                      ...
                                      <tr>
                                          ...
                                          <td><label class="control-label" ><?=$user_desig?> Name</label></td>
                                          <td><input type="text" name="co_name" value="<?php echo $display['co_name']; ?>" class="form-control"/></td>
                                      </tr>
                                      <tr>
                                          <td><label class="control-label" ><?=$user_desig?> Sign Date</label></td>
                                          ...
                                          <td><label class="control-label" ><?=$user_desig?> Sign</label></td>
                                          <td>
                                              <label class="control-label" >
                        ...
                        <div class="col-lg-12 alert alert-warning">
                            <div class="col-lg-12 center">
                                ...
                                <a class="btn btn-danger uni_text" href="<?php echo base_url(); ?>index.php/COconversionPartha/GoToCO?pro=6"><i class='fa fa-arrow-left'></i> <?php echo $this->lang->line('back') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
