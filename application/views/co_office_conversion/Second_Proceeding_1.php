        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <p class='center bold uni_text'><u><?php echo $this->lang->line('co_order'); ?></u></p>
                </div>
            </div>
            <div class="panel-body">
                <form class="unicode" method='post' action="<?php echo base_url() . "index.php/COconversionPartha/ThirdProceeding"; ?>">
