        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <p class='center bold'><span class="rasid"><u><?php echo $this->lang->line('co_order');?></u></span></p>
                </div>
            </div>
            <div class="panel-body">
                <form class="unicode" method='post' action="<?php echo base_url() . "index.php/COconversionPartha/FifthProceeding"; ?>">
                <div class="row">
                    <div class="col-lg-12">
