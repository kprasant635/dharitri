    ...
    <div class="col-lg-10 col-lg-offset-1">
        <div class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal unicode' id='myForm' action="<?php echo base_url() . "index.php/COconversionPartha/FinalSaveTest"; ?>" method="post">
                    ...
                    <table class='table table-striped'>
                        ...
                        <tr>
                            <td colspan="2" class="alert-danger center danger">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='bigha' value="<?php echo $datas['bigha']; ?>">
                                </div>
                                <label for="inputEmail3" class="col-sm-1 control-label">&nbsp;Bigha</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='kotha' value="<?php echo $datas['kotha']; ?>">
                                </div>
                                <label for="inputEmail3" class="col-sm-1 control-label">&nbsp;Kotha</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='lessa' value="<?php echo $datas['lessa']; ?>">
                                </div>
                                <label for="inputEmail3" class="col-sm-1 control-label">&nbsp;Lessa</label>
                            </td>
                        </tr>
                        <tr class="hide">
                            <td colspan="2">
