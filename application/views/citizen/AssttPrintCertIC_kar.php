        ...
        <div class='col-lg-10' style="margin: 0 auto;float: none;">
            <div class="panel panel-primary">
                <div class="panel-body">
                    <h2 class="center uni_text">অসম সরকার</h2>
                    ...
                    <div class="col-lg-12" style="margin-top: 25px">
                        <p class="uni_text">
                            এটি দ্বারা প্রত্যয়িত হয় যে ,<?php echo $certDtls->appln_name; ?> -- <?php echo $certDtls->appln_guard; ?>

                            <?php echo $location['cirname']; ?>  ৰাজহ চক্ৰ ,<?php echo $location['mouza_pargona_code'] ?> মৌজা ৰ,
                            <?php echo $location['vill_townprt_code'] ?> গাঁওৰ বাসিন্দা হয় | আবেদনকারীর পরিবারের বার্ষিক আয় <?php echo $this->utilityclass->cassnum(number_format($certDtls->inc_total, 2)); ?> টকা হয় | </p>
