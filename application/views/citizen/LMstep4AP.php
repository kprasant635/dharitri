<div class="container-fluid form-top">
    <div class="col-lg-12">
        ...
        <h1 class="text-center">ANNUAL KHIRAJ PATTA</h1>
        <p class="uni_text text-center">
            <?php
                echo $this->utilityclass->getCertName($this->session->userdata('cert_codeNo')) ;
                echo " নং ".$certD->patta_no;
            ?> 
        </p>
        ...
        <div style="margin-top: 70px; border: 1px solid #000"></div>
        <p class="uni_text">
            প্রতি , <?php echo $certD->appln_name; ?> <br>
            
            যিহেতু অসমৰ ভূমি আৰু ৰাজহ  বিধি ব্যবস্থা সময়ে সময়ে কৰা তাৰ নিয়মৰ বশবৰ্তী হৈ ইয়াৰ লগত দিয়া তপচিলত লিখা মাটি আপুনি দখল কৰিছে , 
            তলত লিখা স্বৰ্ওমতে আপোনাক ইং <?php echo $certD->year_no; ?> ৰাজহ বছৰৰ এই পাট্টা দিয়া হ’ল –
        </p>
        <p class="uni_text">
            1) ইয়াৰ লগত দিয়া তপচিলত দেখুৱা পুৰা খজনা আৰু স্থানীয় কৰ আপুনি নিৰ্ধাৰিত তাৰিখত কিস্তিমতে আদায় কৰিব | 
        </p>
        <p class="uni_text">
           2) এই বছৰৰ কাৰণে তপচিলত লিখিত মাটিত আপোনাৰ ব্যৱহাৰ ও দখলীস্বত্ত থাকিব কিণ্তু হস্তান্তৰ কৰিবৰ কোনো ক্ষমতা নাথাকিব |
        </p>
        <p class="uni_text">
           ...
           বাহিৰে আপুনি কোনো লোকচানি দাবী কৰিব নোবাৰিব | কিণ্তু আপুনি নাইবা গভৰ্ণমেন্টে <?php echo $send['to_date'];?> তাৰিখে বা তাৰ পূৰ্বে ,
           অৰ্থৰ / চৰকাৰী পক্ষক লিখিত নটিচৰ দ্বাৰা  তপচিলত লিখিত নাইবা কোনো মাটিৰ পুনৰ পাট্টা দিব নালাগে বুলি নজনালে , 
        ...
        <p class="uni_text">
          ...
          কাৰণে প্রয়োজন হয় তেনেহলে সেই মাটি আপোনাৰ পৰা এৰোবাই লোবা হৱ | এইদৰে মাটি এৰোবাই ললে এৰোবাই 
        ...
        <p class="uni_text">
           ...
           বেৰে এফুটতকৈ ডাঙৰ শিমলু গছ কিম্বা তাৰ ডাল কাটিব নোবাৰিব আৰু পুৰা কাঠৰ মাচুল আগেয়ে আদায় নকৰাকৈ 
        ...
        <table class="table-bordered table " width="100%" border="1">
            ...
            <tr>
                <td><?php echo $valu['dag_no']; ?></td>
                <td><?php echo $this->utilityclass->getLandClassCode($valu['land_class_code']); ?></td>
                <?php if(in_array($this->session->userdata('dist_code'),json_decode(BARAK_VALLEY))){?>
                <td><?php echo $valu['a_dag_area_b']."B-".$valu['a_dag_area_k']."K-".$valu['a_dag_area_lc']."C-".$valu['a_dag_area_g']."G"; ?></td>
                <?php }else{?>
        ...
        <hr>
        <div class="col-lg-offset-4 col-lg-5" style="margin-top: 20px">
            <form action="<?php echo base_url();?>index.php/CitizenController/LMFinalSubmitAP" method="post">
                <button type="submit" class="btn btn-primary" name="submit">Forwarded to CO for Necessary Action</button>
            </form>
        </div>
    </div>
</div>
