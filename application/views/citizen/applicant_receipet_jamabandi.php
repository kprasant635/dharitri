            ...
            <div class="panel panel-primary">
                ...
                <form action="" method="POST">
                    <div class="panel-body">
                        ...
                        <p class="center uni_text"><?php echo $circle; ?> ৰাজহ  চক্ৰ</p>
                        ...
                        <div class="form-group">
                            ...
                            ?>  তাৰিখে আপুনি বিচৰামতে   <span class='red'> <?php echo $cert_type; ?></span>  আপোনাক দিয়া হ’ল |
                            </label>
                        </div>
                        <hr>
                        <div class="form-group">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Service Charge (For 1st Page)</td>
                                <td class="center">1</td>
                                <td class="center">1 X <?php echo $this->utilityclass->cassnum(number_format($this->session->userdata('cert_fees'), 2)); ?> টকা</td>
                                <td class="center"><?php echo $this->utilityclass->cassnum(number_format($this->session->userdata('cert_fees'), 2)); ?> টকা</td>
                            </tr>
                            <tr>
                                <td>Printing Charge (For Every Extra Page)</td>
                                <td class="center">
                                    <?php
                                    echo $no_of_pages = $number_of_pages-1;
                                    ?>
                                </td>
                                <td class="center">
                                    <?php
                                    echo $no_of_pages = $number_of_pages-1;
                                    ?>
                                    <?php echo " X ১০.০০ টকা";?>
                                </td>
                                <td class="center">
                                    <?php 
                                    $amount = $no_of_pages*10;
                                    echo $this->utilityclass->cassnum(number_format($amount, 2)); ?> টকা
                                </td>
                            </tr>
                            <tr>
