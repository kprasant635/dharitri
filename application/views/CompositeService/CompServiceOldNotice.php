            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        ...
                        <form name='frmDelete' method='post' action='<?php echo base_url() . "index.php/CompositeService/compServiceRegenerateNotice"; ?>'>
                            <p style="color:red; font-weight: bold !important; font-size: 18px;" class='center'>Please enter valid Composite Service case no.</p>
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-3">
                                    <div class="form-group">
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Enter Case Number Here" name="case_no" required='' class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
