...
<div class="container-fluid form-top">
    <div class="row">
        <div class="col-lg-12 panel-body ">
            ...
            <div style="line-height: 30px;margin-top: 30px;margin-bottom: 30px;">
                <p class='uni_text' style="font-size:1em;">যিহেতু <?php
                    ...
                    <?php foreach ($dags as $key=>$dag): ?>
                        ...
                        <?php echo $this->utilityclass->cassnum(number_format($dag->m_dag_area_lc, 2)); ?> ছটাক
                        <?php echo   $this->utilityclass->cassnum(number_format($dag->m_dag_area_g, 2));?> গণ্ডা
            ...
            <table class="table table-bordered table_black" style="font-size:1em;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo "পাট্টার  নং:" . $this->utilityclass->cassnum($dag->patta_no) . "," . "<br>";
                        echo "দাগের নং :" . $this->utilityclass->cassnum($dag->dag_no) . "," . "<br>";
                        echo "মাটির কালি: " . $this->utilityclass->cassnum($dag->m_dag_area_b) . " বি: " . $this->utilityclass->cassnum($dag->m_dag_area_k) . " ক: " .
                        $this->utilityclass->cassnum($dag->m_dag_area_lc, 2) . " ছ ". $this->utilityclass->cassnum(number_format($dag->m_dag_area_g,2))."গ";
                        ?>
                        <?php endforeach; ?>
                    </td>
                    <td></td>
            ...
            <p class='uni_text' style="font-size:1em;">বিজ্ঞপ্তি গ্রহণ করা ব্যক্তি/সর্বসাধারণ :
