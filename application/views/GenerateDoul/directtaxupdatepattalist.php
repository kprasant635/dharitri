            ...
            <div class="">
                ...
                <div class="" >
                    ...
                    <div class="text-center">
                        <div class="col-lg-12">
                            <b id="errorPattaTitle" style="color:red;font-size:18px"></b>
                            <span id="errorPattaList" style="color:red;font-size:18px"></span>
                        </div>
                        <button type="button" id="btn-update-patta" class="btn btn-warning"><i class='fa fa-refresh'></i> Update Details</button>
                    </div>
...
<script type="text/javascript">
            $('#btn-update-patta').on('click', function(e) {
                var formData = $('#myForm').serialize();
                $.ajax({
                    url: '<?= base_url()?>'+ "index.php/GenerateDoul/updatePattaNo",
                    type: "POST",
                    data : formData,
                    dataType: 'json',
                    error: function() {
