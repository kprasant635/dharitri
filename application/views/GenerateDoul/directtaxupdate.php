        ...
        <div class="col-lg-12 panel panel-deafult panel-body">
            ...
            <div class="panel panel-info panel-form">
                <div class="panel-heading">
                    <h3 class="panel-title">Direct tax update in all Patta no.<h3>
                </div>
...
<!-- 
                       ...
                       <div style="margin-top:20px"></div>
                        <center>
                            <button type="button" id="btn-find-patta" class="btn btn-primary"><i class='fa fa-check'></i> Get All Patta</button>
                            <button type="button" id="btn-find-updated-patta" class="btn btn-success"><i class='fa fa-check'></i> Get Direct Paying Updated Patta List</button>
                        </center>
...
<script type="text/javascript">
            $('#btn-find-patta').on('click', function(e) {
                ...
                $.ajax({
                    url: '<?= base_url()?>'+ "index.php/GenerateDoul/findPattaVillageWise",
                    type: "POST",
