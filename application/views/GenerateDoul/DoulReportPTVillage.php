    ...
    <div class="row">
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Auto Generated Doul of each Villages of a mouza's
                        </h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tr class="hope">
                                <td colspan="2">&nbsp;</td>
                                <td colspan="2">Patta Type : <?php echo $patta_name; ?></td>
                ...
                <tr class="center info text-center hope">
               ...
               //var_dump($query);
                foreach ($result as $row):
                    ...
                    ?>
                <tr class="hope">
                        <td class="text-success"><?php echo $row['village_name']; ?></td>
