                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <div class="bs-callout bs-callout-info" id="callout-type-b-i-elems"> 
                            <h6 class="red uni_text"><b>NOTE : Please Select the Name Of the Pattadar whose Name needs to be Corrected from the Dropdown List below.</b></h6>
                        </div>
                        <form class="form-horizontal" method='post' action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <label for="inputEmail" class="col-lg-6 control-label"><?php echo $this->lang->line('pattadar_name');?> </label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" required class="form-control" name="petition_pdar_name_new" value="" placeholder="অপৰিচিত" />
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <h2><mark><?php echo $this->lang->line('pattadar_details'); ?></mark></h2>
                            <hr>
                            <div class="form-group">
