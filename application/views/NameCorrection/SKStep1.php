        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;"><?php echo $this->lang->line('sk_report_on_pending_miscellaneous_cases'); ?></h2>
                </div>
            </div>
                                ...
                                foreach ($MisCases AS $cases) {
                                    ...
                                    <span class='small font-italic red'><?php if($cases->basundhara){ echo "Basundhara:". $cases->basundhara ;} ?> </span></td>
										...
										<?php $misc_case_type= $cases->misc_case_type;  ?>
                                            <a href="<?php echo base_url() . "index.php/NameCorrection/SKStep2"; ?>?misc_case_no=<?php echo $cases->misc_case_no."&petition_no=".$cases->misc_case_petition_no; ?>" class="btn btn-primary"> <?php echo $this->lang->line('write_report');?></a>
										<?php }else{?>
											<a href="<?php echo base_url() . "index.php/NameCancellation/SKStep2"; ?>?misc_case_no=<?php echo $cases->misc_case_no."&petition_no=".$cases->misc_case_petition_no; ?>" class="btn btn-primary"> <?php echo $this->lang->line('write_report');?></a>
										<?php } ?>
                                        </td>
                                    </tr>
                                    <?php
