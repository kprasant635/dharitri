        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;"><?php echo $this->lang->line('sk_report_on_miscellaneous_cases');?></h2>
                </div>
            </div>
                       ...
                       <?php if(!empty($app->basundhara)){ ?>
                                ...
                                <div class="col-lg-12">
                                    <table class="table table-striped table-bordered" width="100%">
                                        <tr class="success">
                                            ...
                                            <td class="text-center"><h6><?php echo $this->lang->line('submission_date');?> : <strong><?php echo $namedata[1]->subdiv; ?></strong></h6></td>
                        ...
                        <?php }?>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">                           
                                <table class="table table-striped table-bordered">
                                    <thead><tr><th colspan="2">Supportive Documents</th></tr></thead>
                                        <tbody>
                                            <?php foreach($sup_doc as $doc) { ?>
                                            <tr>
                                                <td><span class="text-red bold"><?=$doc->file_name?></span></td>
                                                <td>
                        ...
                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <textarea disabled class="form-control" rows="5"><?php echo $lm_report; ?></textarea>
                                </div>
                            </div>
                            <hr style="border-bottom: 2px solid #000;">
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-4 control-label"><?php echo $this->lang->line('sk_report');?> </label>
                                <div class="col-lg-8">
                                    <textarea name="sk_report" class="form-control" rows="5" required></textarea>
                                </div>
                            </div>
                            <hr style="border-bottom: 2px solid #000;">
                            <?php if(!empty($app->basundhara)){ ?>
