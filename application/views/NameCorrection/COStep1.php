                            ...
                            foreach ($MisCases AS $cases) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="center"><?php 
                                        if($type==06){
                                            echo "নাম সংশোধন";
                                            $url=base_url() . "index.php/NameCorrection/COStep2";
                                        }
                                        elseif ($type==07) {
                                            echo "নাম কৰ্ত্তন";
                                    ...
                                    <td class="center">
                                        ...
                                        <?php if(ESCALATION_ENABLE == 1 && $cases->is_escalated == 1){
                                            ...
                                            {
                                                ?>
                                                <a href="<?php echo $url; ?>?misc_case_no=<?php echo enc_param('misc_case_no', $cases->misc_case_no, 600)."&petition_no=".$cases->misc_case_petition_no; ?>" class="btn btn-sm btn-primary"> <?php echo $this->lang->line('pass_order');?></a>
