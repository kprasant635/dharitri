        ...
        ?>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <h3>CO order on Misc Cases (Name Correction)</h3><br>
                    <form class="form-horizontal" action="<?=base_url().'index.php/NameCorrectionV2/coorderNameCorrection_save'?>"  enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                ...
                                <?php if($adc_revert){?>
                                   ...
                                   <div class="form-group">
                                    <label for="inputEmail" class="col-lg-2 control-label">ADC's remark</label>
                                    <div class="col-lg-10">

                                        <textarea name="" class="form-control" rows="5" readonly><?php echo $adc_revert->process_note;?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <center>
                                    ...
                                    <a class="btn btn-warning" href="<?=base_url()."index.php/NameCorrectionV2/revertToLm?misc_case_no=" . $_GET['misc_case_no']. "&application_no=" .$app->basundhara ; ?>"><i class='fa fa-backward'></i>&nbsp; Revert to LM</a>
