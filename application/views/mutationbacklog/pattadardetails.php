...
<div class="modal fade" id="myModal" role="dialog" style="padding-top:15%;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header  custom-modal" style="background: #ccc">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title custom-modal-title">You Have Selected Mutation module </h4>
            </div>
            <hr>
            <div class="modal-body">
                <p>Enter Pattadar Details for Dag No  <?php echo $dag; ?>;</p>
            </div>
                ...
                <div class="panel panel-info panel-form">
                    ...
                    <div class='panel-body'>
                        <?php
                            $action="";
                            if($mut_type=='01'){
                                $action =base_url() . "index.php/mutationbacklog/savePattadarDetails";
                            }
                            else if($mut_type == '02'){
                                $action =base_url() . "index.php/mutationbacklog/savePattadarForPartition";
                            }
                        ?>
                        <form class='form-horizontal no-trigger prevent_ajax' id='pattadardetails' 
                            ...
                            <div class="form-group">
                                <div class="col-sm-3" style="margin: 0 auto;float: none;margin-top: 20px;margin-bottom: 20px;">
                                    ...
                                    <?php if($dag==-1):?>
                                    <a href='<?php echo base_url();?>index.php/mutationbacklog/recordOrder' onclick="return confirm('Are you sure you want to submit this case')"
                                       class="btn btn-danger"><i class='fa fa-save'></i><?php echo $this->lang->line('save_all')?></a>
                                       <?php else:?>
                                        <?php if($pattadar_cron_no > 1):?>
                                        <a class="btn btn-danger"  href="<?php echo base_url() . 'index.php/mutationbacklog/pattadardetails?inc=1'?>">
                                            <?php if(!$this->session->userdata('isMutiple')):?>
                                                <?php echo "Next";?>
                                            <?php else:?>
                                            <?php echo $this->lang->line('next_dag')?>
                                            <?php endif;?>
                                        </a>
                                        <?php endif;?>
                                    <?php endif;?>
