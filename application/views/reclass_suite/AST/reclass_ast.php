        ...
        <div class="panel casedisplay">
            <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    <?php if($_GET['service'] == '40')
                    {
                        if($user_desig_code == 'AST') {?>
                            <tr class="">
                                <td>Reclassification cases pending for notice print</td>

                                <td><?php
                                    if ($reclassnotice != '0') {

                                        echo "<span class=\"badge badge-danger\">$reclassnotice</span>";
                                    }
                                    ?>
                                </td>
                                <td>

                                    <a href="<?php echo base_url() ?>index.php/ReclassSuiteControllerAst/reclassNoticeGenertaedCases?service=40&s=V" style="float:right">view</a>
                                </td>
                            </tr>
                            <!-- <tr class="">
                                <td>Reclassification notice printed cases</td>
                            ...
                            <tr>
                                    ...
                                    <td><a class="pull-right green "  href="<?php echo base_url() . 'index.php/ReclassSuiteControllerAST/getPendingProceeReportReclass'; ?>"><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                        <?php  }?>
                    <?php  }?>
