                ...
                <tbody>
                    ...
                    foreach ($cases as $case):
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger" href="<?php echo base_url() ?>index.php/ReclassSuiteControllerAst/AsstActionTakenReclass?case=<?php echo $case->c_no ?>"><?php echo $this->lang->line('write_report'); ?></a>
                            </td>
