...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-sm btn-danger" href="<?=base_url().'index.php/RelassSuiteMeetingControllerDc/revertedMeetingByDepartmentForDC'?>"><i class="fa fa-backward"></i>&nbsp;Go Back</a>
...
<script type="text/javascript">
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/postAdditionalFileUnderMeetingDc",
                type: "post",
    ...
    {
        var redirect_url = BASE_URL + "/RelassSuiteMeetingControllerDc/meetingLandPage";
        Swal.fire({
            backdrop:true,
            allowOutsideClick: false,
            icon: 'warning',
        ...
        $.ajax({
            url: BASE_URL + "/RelassSuiteMeetingControllerDc/finalApproveOfMeetingDetail",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
