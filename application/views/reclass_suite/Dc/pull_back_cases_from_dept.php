...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process /
            Settlement MB3 /
            <a href="<?= base_url()?>index.php/RelassSuiteMeetingControllerDc/pullBackCasesFromDepartmentForDC">
                Cases For Pull Back (Reclassification)
            </a>
...
<script>
    ...
    $('#datatable').on('click', '.pullBackCasesModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/RelassSuiteMeetingControllerDc/getPullBackCaseDetails",
            type: "post",
            dataType: "json",
    ...
    $('#pullBackCasesModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/finalPullBackRevertToCoSubmit",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/RelassSuiteMeetingControllerDc/pullBackCasesWithDeptPaginationAPI',
                type:'POST',
                data: {
