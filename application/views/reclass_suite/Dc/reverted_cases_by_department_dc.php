...
<script type="text/javascript">
    ...
    function openModalForRevertCases()
    {
        ...
        $.ajax({
            url: baseurl + "RelassSuiteMeetingControllerDc/getAllDeptRevertedCases",
            type: 'post',
            dataType: 'json',
            data: {
    ...
    $('#ajaxRevertedForm').submit(function (e) {
        ...
        $.ajax({
            url: baseurl + "RelassSuiteMeetingControllerDc/finalDeptRevertedCaseRevertToCO",
            type: 'POST',
            ...
            success: function (data)
            {
                ...
                else if(data.responseType == 2)
                {
                    ...
                    window.location.href = baseurl+"RelassSuiteMeetingControllerDc/revertedMeetingByDepartmentForDC";
                }})
                }
                else
                {
