                        ...
                        <div class="reza-card ">
                            <div class="reza-body">
                               ...
                               <input type="hidden" id="getBaseURL" value="<?php echo base_url(); ?>index.php">
                                ...
                                <?php if(($caseDetails->status == MB_PENDING) && ($caseDetails->is_dlc =='N') && ($caseDetails->pending_officer == MB_DEPUTY_COMM)) :?>

                                            <button class="rezaButt buttInfo" id="forwardtoCOfromDC">
                                                <i class="fa fa-level-down" aria-hidden="true"></i>
                                                Forward to CO for Chitha Updation
                                            </button>
...
<script type="text/javascript">
    ...
    $(document).on('click','#forwardtoCOfromDC',function ()
    {
        const applicant = {
            caseNo: $("#caseNo").val(),
        };
        ...
        $.ajax({
            url: BASE_URL + "/ReclassSuiteControllerADC/applicationForwardFromDCToCO",
            type: "post",
            dataType: "json",
            ...
            success: function (data) {
                ...
                {
                    $('.rezaButt').hide();
                    showSuccessMessage("Application Successfully Forwarded to CO");
                }
...
<script type="text/javascript">
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/ReclassSuiteControllerADC/applicationRevertFromDCToCONoDLC",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
