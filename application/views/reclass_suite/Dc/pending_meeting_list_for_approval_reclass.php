            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 25px">
                        ...
                        <?php if(MB3_RE_CLA_DIGITAL_SIGN_LIVE == 1): ?>
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : BASE_URL + '/RelassSuiteMeetingControllerDc/listOfPendingMeetingIds',
                type : 'POST',
                data : {
                    // circle       : circle,
                    // subdiv       : subdiv,
    ...
    $('#datatable').on('click', '.showMinutesGenerateModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/RelassSuiteMeetingControllerDc/generateDigitalMinutesDc",
            type: "post",
            dataType: "json",
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/verifyArea",
                type: "post",
                dataType: "json",
                contentType: "application/json",
    ...
    function deleteProposalWithZeroCasesPendingMeeting(proIds,message)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/deleteProposalWithZeroCasesForPendingMeetingByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function revertBulkToCOForHoldCases(revertCasesBulk)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/bulkRevertCasesForHoldDeptCases",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    function convertViewToPdf(meetingIdDigital)
    {
        ...
        // });
        $.ajax({
            url: BASE_URL + "/RelassSuiteMeetingControllerDc/digitalSignAndSavePdf",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
    ...
    $('#datatable').on('click', '.revertBackMeetingModal', function ()
    {
        ...
        $.ajax({
            url: BASE_URL + "/RelassSuiteMeetingControllerDc/getRevertBackMeetingDetails",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
                ...
                {
                    window.location.href = baseurl+"RelassSuiteMeetingControllerDc/getVgrPgrCasesForRevertDc/"+data.meetingId;
                }
                else
                {
                    showErrorMessage("SOMETHING WENT WRONG");
    ...
    // revert final submit & send proposal to dc
    $('#revertBackMeetingModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/RelassSuiteMeetingControllerDc/revertBackMeetingToAdcSdo",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
        ...
        .ready(function(){
            ...
            function saveDataPDF(signedPdfData)
            {
                Swal.fire({
                    ...
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Approve & Update cases',
                }).then((result) => {
                    if (result.isConfirmed)
                {
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : baseurl+ "RelassSuiteMeetingControllerDc/signedAndFinalApproveByDC",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
