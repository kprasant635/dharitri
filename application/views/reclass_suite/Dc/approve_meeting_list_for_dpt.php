                        ...
                        <?php $i = 0;  foreach ($meetings as $meeting):  $i++  ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/RelassSuiteMeetingControllerDc/getMeetingIdForwardtoCO/?meetingId=<?php echo $meeting->id; ?>"
                                       class="rezaButt btn btn-sm " style="background-color :#50331e" >
                                        <i class="fa fa-eye" aria-hidden="true"></i> &nbsp;Send to CO for Payment Notice
                                    </a>
                                </td>
                            </tr>
