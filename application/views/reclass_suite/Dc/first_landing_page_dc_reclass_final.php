                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        <tr>
                            ...
                            <td class="rezaText">Final Order for Reclass cases(Agri to Residential less than 1 bigha)</td>
                            <td>
                                <?php
                                if ($finalOrderDcCount != '0')
                                {
                                    echo  "<span class=\"badge badge-danger\">$finalOrderDcCount</span>";
                                }
                                else
                                {
                                    echo  "<span class=\"badge badge-success\">$finalOrderDcCount</span>";
                                }
                                ?>
                            </td>
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllReclassFinalOrderDCCaseList'; ?>" style="float:right">
