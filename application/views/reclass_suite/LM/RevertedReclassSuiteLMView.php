    ...
    <div class="row">
        ...
        <section>
            <div class="wizard">
                ...
                <form role="form" method="post" action="<?php echo base_url() ?>index.php/ReclassSuiteControllerLm/secondProceeding?case=<?=$_GET['case']?>" enctype="multipart/form-data">
                                ...
                                <div class="reza-body ">
                                    ...
                                    <div class="tableCard" style="padding-bottom: 15px">
                                        <?php $i = 1;foreach ($lmnotes as $lmnote): ?>
                                            ...
                                            <div class="row p-2 " >
                                                <div class="col-md-6">
                                                    <span><strong><?=$sl_count++?>.</strong> Verify Schedule of the land and area under occupation?</span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                       ...
                                                       <?php
                                                        if(isset($err_return)){
                                                            if(set_value('applicant_type') == NO){
                                                                echo "checked";
                                                            }
                                                        }else{
                                                            if (trim($basic['applicant_type']) == "I") {echo "checked";}
                                                        }?>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        <?php if(isset($err_return)){
                                                            ...
                                                            if (trim($basic['applicant_type']) == "N") {echo "checked";}
                                                        }?>
                                    ...
                                    <div class="row p-2" >
                                            ...
                                            <?php if(in_array($nature_dag->dist_code,['15','14'])){?>
                                            <div class="col-md-2">
                                                <div class="form-check form-check-inline">
                                                    <input
                                        ...
                                        <div class="row p-2" >
                                            <div class="col-md-6">
                                                <span><strong><?=$sl_count++?>.</strong> Nature of current possession for Dag no: <?=$nature_dag->dag_no?></span>
                                                <?=form_error('nature_possession'.$nature_dag->dag_no)?>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <!-- <input type="text" name="" id="selectedNP<?=$nature_dag->dag_no?>" value="<?=$nature_dag->nature_possession?>"> -->
                                                <select
                                                ...
                                                >
                                                        <option value="1" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "Agricultural"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                            if (trim($nature_dag->nature_possession) == "1") {echo "selected";}
                                                        }?>>
                                                            Agricultural
                                                        </option>
                                                        <option value="2" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "Residential"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                            if (trim($nature_dag->nature_possession) == "2") {echo "selected";}
                                                        }?>>
                                                            Residential
                                                        </option>

                                                        <option value="3" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "Commercial"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                            if (trim($nature_dag->nature_possession) == "3") {echo "selected";}
                                                        }?>>
                                                            Industrial
                                                        </option>

                                                        <option value="4" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "4"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                         ...
                                                         <option value="6" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "4"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                            if (trim($nature_dag->nature_possession) == "6") {echo "selected";}
                                                        }?>>
                                                            Plantation
                                                        </option>

                                                        <option value="10" <?php if(isset($err_return)){
                                                            if(set_value('nature_possession'.$nature_dag->dag_no) == "4"){
                                                                echo "selected";
                                                            }
                                                        }else{
                                                            if (trim($nature_dag->nature_possession) == "10") {echo "selected";}
                                                        }?>>
                                                            Institution
                                                        </option>
                                        ...
                                        <?php
                                        foreach($dags as $agrinonagri):?>
                                            
                                    <div class="row p-2" >
                                            <div class="col-md-6">
                                                <strong><?=$sl_count++?>. Is Reclassification from agri to Non-agri(For Dags <?=$agrinonagri->dag_no?>) ?
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            class="form-check-input <?php if(form_error('wetland_verified')){echo 'lm_invalid';}?>"
                                                            type="radio"
                                                            name="agritononagri_verified<?=$agrinonagri->dag_no?>"
                                                            id="agritononagri_verified1_<?=$agrinonagri->dag_no?>"
                                                            value="YES"  onclick="editDagReclassDetails(<?=$agrinonagri->dag_no?>);"
                                                        <?php if(set_value('agritononagri_verified') == 'YES'){ echo "checked";} 

                                                        else{
                                                            if (trim($agrinonagri->is_agri_to_nonagri) == "Y") {echo "checked";}
                                                        }?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                            ...
                                                            type="radio"
                                                            name="agritononagri_verified<?=$agrinonagri->dag_no?>"
                                                            id="agritononagri_verified2_<?=$agrinonagri->dag_no?>"
                                                            value="NO" onclick="updateDagReclassDetails(<?=$agrinonagri->dag_no?>);"
                                                        <?php if(set_value('agritononagri_verified') == 'NO'){ echo "checked";} 
                                                        else{
                                                            if (trim($agrinonagri->is_agri_to_nonagri) == "N") {echo "checked";}
                                                        }?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
                                    ...
                                    <div class="addPropertyDetail-<?=$agrinonagri->dag_no?>" style="display:none" >
                                        ...
                                        <tr>
                                            ...
                                            <th>Land is not under cultivation for last minimum ten years</th>
                                        </tr>
                                    </table>
                                            </div>
                                    </div>

                                <?php } if($agrinonagri->is_agri_to_nonagri == 'N') { ?>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        <?php if(set_value('masterplan_notified') == 'YES'){ echo "checked";}
                                                            ...
                                                            if (trim($nature_dag->is_master_plan) == "Y") {echo "checked";}
                                                        } ?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        ...
                                                        <?php if(set_value('masterplan_notified') == 'NO'){ echo "checked";} 
                                                            ...
                                                            if (trim($nature_dag->is_master_plan) == "N") {echo "checked";}
                                                        }?>
                                                    />
                                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                                </div>
...
<script>
    ...
    function premiumModal(){
        ...
        $('[id^=nature_possession]').each(function() {
        const dag_no = this.id.replace('nature_possession', '');
        const nature_possession_selected = this.value;

        // Set the value of the corresponding nature_possession_selected field
        $('#nature_possession_selected' + dag_no).val(nature_possession_selected);
        console.log(`Selected Value for DAG No ${dag_no}: ${nature_possession_selected}`);
        });
...
<script type="text/javascript">
    ...
    // var selectedNP = $.trim($('#selectedNP'+dag_no).val());

    // if(nature_possession_selected!=selectedNP)
    // {
    //     document.getElementById("prem_update1").checked = true;
    // }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(arr.responseType == 0){
                        ...
                        row += '<td>' + (arr.is_not_culti_ten === 'Y' ? 'Yes' : 'No') + '</td>';
                        row += '</tr>';
