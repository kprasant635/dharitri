...
<script>
    $(document).on('change', '#mouza_cat, #lot_cat', function(){
        ...
        $.ajax({
            url: baseurl+'ReclassSuiteController/getLotsFromMouzaCoRS',
            type: "POST",
            data: postData,
...
<script>
    $(document).ready(function ()
    {
        $(document).on('change', '#category, #remark_cat, #mouza_cat, #lot_cat, #nr_cat, #payment_status, #final_verification_report, #co_approved', function(){
            ...
            load_data(category, remark_cat, mouza_cat, lot_cat, nr_cat, payment_status, final_verification_report, co_approved);

        });

        load_data();

        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null, nr_cat=null, payment_status=null, final_verification_report=null, co_approved = null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/ReclassSuiteControllerCO/pagination',
                    type:'POST',
                    data: {
...
<script type="text/javascript">
    function gen_payment_notice_btn(case_no)
  {
    ...
    $.ajax({
       url: baseurl+'ReclassSuiteControllerCO/loadViewForPaymentGenerationReclass',
       type: "POST",
