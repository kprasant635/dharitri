                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if($user_desig_code == 'CO') { ?>
                        ...
                        <!-- <tr> -->
                            ...
                            <!-- <td>Pending Wetland List forwarded from JDS</td>
                            <td>
                                <?php if($service_code == RECLASS_ID) { ?>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'index.php/ReclassSuiteControllerCO/dcRevertedCasesReclass?service='.$service_code.'&s='.MB_REVERT; ?>" style="float:right">view</a></td>
                        </tr>

                        <tr>
                            <td>Payment Notice After approval from DC</td>    
                            <td>
                                <?php if($service_code == RECLASS_ID) { ?>
                                    <span class="badge badge-danger"><?=$payment_notice?></span>
                                <?php } ?>
                            </td>                  
                            <td><a href="<?php echo base_url() . 'index.php/ReclassSuiteControllerCO/paymentNoticeCoReclass?service='.$service_code.'&s='.MB_PAYMENT_REQUEST; ?>" style="float:right">view</a></td>
                        </tr>

                        <tr>
                            <td>Payment Confirm List</td>    
                            <td>
                                <?php if($service_code == RECLASS_ID) { ?>
                                    <span class="badge badge-danger"><?=$payment_confirm?></span>
                                <?php } ?>
                            </td>                  
                            <td><a href="<?php echo base_url() . 'index.php/ReclassSuiteControllerCO/paymentNoticeCofirmationCases?service='.$service_code.'&s='.MB_PAYMENT_NOTICE; ?>" style="float:right">view</a></td>
                        </tr>
                         <tr>
                            <td>Case list for Re-Geotag</td>
                            <td></td>

                            <td><a href="<?php echo base_url() . 'index.php/ReclassSuiteControllerCO/reGeoTagCaseList?service='.$service_code; ?>" style="float:right">view</a></td>
                        </tr> 
                    <?php } ?>
