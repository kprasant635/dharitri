                                        ...
                                        <?php }?> -->
                                            <div class="row mt-4 justify-content-center">
                                                ...
                                                if(ENABLE_BUTTON_CO_TO_DC_KHAS != 0){
                                                    ...
                                                    if($sdo_user_check == 'y'){
                                                        if ((($pending_officer != 'LM' && $from_office != 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) && ($basic['partition_enable'] == 'N') && ($basic['wet_land'] == 'N') && ($basic['notice_generated_yn'] == null || strtolower($basic['notice_generated_yn']) == null)) {?>
                                                        ...
                                                        <!-- </button> -->
                                                            ...
                                                            else if ((($pending_officer != 'LM' && $from_office != 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) && ($basic['partition_enable'] == 'Y') && ($basic['notice_generated_yn'] == null || strtolower($basic['notice_generated_yn']) == null)) {?>
                                                            <input type="submit" name="notice_generate_ast" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" disabled value="Send For Notice Generation">
                                                        <!-- </button> -->
                                                            ...
                                                            ///new//
                                                            else if ((($pending_officer != 'LM' && $from_office == 'CO') || ($pending_officer != 'DC' && $from_office != 'CO')) && ($basic['partition_enable'] == 'Y') && ($basic['status'] == 'S') && ($basic['notice_generated_yn'] != null || strtolower($basic['notice_generated_yn']) == 'y')) {?>
                                                            <input type="submit" name="partition_done" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" disabled value="Partition Chitha Updation">
                                                        <!-- </button> -->
                                                            ...
                                                            //after part done //
                                                            else if (($pending_officer == 'CO' && $from_office == 'CO') && ($basic['partition_enable'] == 'Y') &&  ($basic['status'] == 'W') &&  ($basic['wet_land'] == 'N') && ($basic['notice_generated_yn'] != null || strtolower($basic['notice_generated_yn']) == 'y')) {?>
                                                            <input type="submit" name="forward_to_dc" onclick="return dc_forward()" id="frwrd_dc_btn" class="m-1 col-2 btn btn-primary btn-info-full btn-sm" disabled value="Forward">
                                                        <!-- </button> -->
                                                            ...
                                                            ///for wet land//
                                                            else if (($pending_officer == 'CO' && ($from_office == 'CO' || $from_office == 'LM')) && ($basic['wet_land'] == 'Y') &&  ($basic['status'] == 'W') && ($basic['partition_enable']=='N' || ($basic['notice_generated_yn'] != null || strtolower($basic['notice_generated_yn']) == 'y'))) {?>
