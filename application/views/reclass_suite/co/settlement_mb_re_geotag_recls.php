    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/ReclassSuiteControllerCO/paginationForReGeoTagRecls',
                    type:'POST',
                    data: {
...
<script type="text/javascript">
  ...
  function showErrorMessage(text) {
    ...
    function reGeotagIns(case_no,applid) {
    var base_url = "<?php echo base_url();?>";
    if(!confirm("Are you sure you want enable for re-geotag?"))
    {
        return false;
    }
    $.ajax({
          url: base_url +'index.php/ReclassSuiteControllerCO/checkWhetherGeoTagorNot',
          type: "post",
          dataType: "json",
          data : {
            case_no : case_no,
