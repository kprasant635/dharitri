...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalControllerReclass/commonProposalListView/'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
        </div>
                                ...
                                <?php if($case->status == PRO_CASE_STATUS_PENDING) : ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if($proposalDetails->meeting_create_status == 1): ?>
                                            ...
                                            <?php if($case->service_code != SETTLEMENT_PGR_VGR_LAND_ID): ?>
                                                <br>
...
<script>
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerReclass/applicationRevertToCoFromProposalUnderMinutes",
                type: "post",
                dataType: "json",
