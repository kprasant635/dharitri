...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            Process / Settlement MB3 / <a href="<?= base_url()?>index.php/ReclassSuiteControllerADC/ReclassSuiteLandDc">Reclass Suite</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 0 OR DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        <tr>
                            ...
                            <td class="rezaText">Notice Generation for Partial Cases</td>
                            <td>
                                <?php
                                if ($noticegenerateCount != '0')
                                {
                                    echo  "<span class=\"badge badge-danger\">$noticegenerateCount</span>";
                                }
                                else
                                {
                                    echo  "<span class=\"badge badge-success\">$noticegenerateCount</span>";
                                }
                                ?>
                            </td>
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllReclassNoticeGenerateDCCaseList'; ?>" style="float:right">
                        ...
                        <tr>
                            ...
                            <td class="rezaText">Note of action for Notice serving</td>
                            <td>
                                <?php
                                if ($noteofactionCount != '0')
                                {
                                    echo  "<span class=\"badge badge-danger\">$noteofactionCount</span>";
                                }
                                else
                                {
                                    echo  "<span class=\"badge badge-success\">$noteofactionCount</span>";
                                }
                                ?>
                            </td>
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllReclassNoteofActionDCCaseList'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 200px" >
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllReclassFirstProceedingDCCaseList'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="rezaText">DLC Committee</td>
                            <td>
                                <?php
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteCommonDc/getSdlacCommitteeCommon'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="rezaText"><?php echo $this->lang->line('DLCNotice') ?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllMarkAsSDLACListForDCReclass'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <?php if(DC_ADC_SDO_PRO_BUTTON == 1) { ?>
                        ...
                        <tr>
                            ...
                            <td class="rezaText"><?php echo $this->lang->line('DLCMemberReport') ?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/getAllProposalListSdlacReclass'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                        ...
                        <!--                            </td>-->
                        <!--                            <td>-->
                        <!--                                <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbADC/getAllSdlacMemberApprovalProposalListKhas'; ?><!--" style="float:right">-->
                        <!--                                    <i class="fa fa-eye"></i>&nbsp;view-->
                        <!--                                </a>-->
                        <!--                            </td>-->
                        <!--                        </tr>-->
                    ...
                    <?php } ?>
                        ...
                        <tr>
                            <td class="rezaText"><?php echo $slNo += 1; ?>.</td>
                            <td class="rezaText">Step 7</td>
                            <td class="rezaText">Re-generate Notice</td>
                            <td>
                                
                            </td>
                            <td>
                                <a class="rezaButt" href="<?php echo base_url() . 'index.php/ReclassSuiteControllerADC/viewAllReclassReNoticeGenerateDCCaseList'; ?>" style="float:right">
                                    <i class="fa fa-eye"></i>&nbsp;view
                                </a>
                            </td>
                        </tr>
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbADC/getAllUnderConSdlacKhas'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    ...
                    <!--                            </td>-->
                    <!--                            <td>-->
                    <!--                                <a class="rezaButt" href="--><?php //echo base_url() . 'index.php/SettlementMbADC/getAllReReportAppByCOForDcAppKhas'; ?><!--" style="float:right">-->
                    <!--                                    <i class="fa fa-eye"></i>&nbsp;view-->
                    <!--                                </a>-->
                    <!--                            </td>-->
                    <!--                        </tr>-->
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDc/getAllRejectedApplicationByCoForAdc?service='.SETTLEMENT_KHAS_LAND_ID .'&s='.MB_DISMISS; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                   ...
                   <!--  <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementModification/getAllModificationRequestApplicationByCoForAdc?service='.SETTLEMENT_KHAS_LAND_ID; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr>
 -->
                    <!-- <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementCommonDC/rejectedList?service='.SETTLEMENT_KHAS_LAND_ID.'&s=D&office='.MB_ADD_DEPUTY_COMM; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
                    <!-- <tr>
                        ...
                        <td>
                            <a class="rezaButt" href="<?php echo base_url() . 'index.php/SettlementMbCo/coRevivalCases?service='.SETTLEMENT_KHAS_LAND_ID.'&s=D'; ?>" style="float:right">
                                <i class="fa fa-eye"></i>&nbsp;view
                            </a>
                        </td>
                    </tr> -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <input type="hidden" id="serviceType" value="><?php echo SETTLEMENT_KHAS_LAND_ID ?>">
