...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/ReclassSuiteControllerADC/getAllProposalListSdlacReclass">DLC Report</a>
            / Process

            <a href="<?= base_url()?>index.php/ReclassSuiteControllerADC/getAllProposalListSdlacReclass">
            ...
            <div class="reza-title">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="hidden" id="service_code" value="<?=RECLASS_ID?>">
            ...
            <div class="reza-body">
                        ...
                        <?php $i = 0; foreach ($cases as $case):  $i++ ?>
                            <tr>
                                ...
                                <td>
                                     ...
                                     <a href="<?php echo base_url('index.php/ReclassSuiteControllerADC/getReclassSuiteApplicationDetails/?case=').$case->case_no ?>" class="">
                                        <?php echo $case->case_no; ?>
                                    </a>
                                    <br>
                                    <span class='small font-italic red'><?php if ($case->case_no) {
                                            echo "Basundhara:" . $this->utilityclass->getApplidFromCaseNoReclass($case->case_no);
                                        } ?> </span>
                                </td>
                                <td class="center">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_APPROVE) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewApplicationDetailsOnly/?case=<?php echo $case->case_no; ?>">
                                ...
                                <?php elseif ($case->status == PRO_CASE_STATUS_REJECT) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewApplicationDetailsOnly/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php elseif ($case->status == PRO_CASE_STATUS_REVERTED) : ?>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-danger"  style="background-color: #263238" href="<?php echo base_url(); ?>index.php/SettlementCommonDc/viewApplicationDetailsOnly/?case=<?php echo $case->case_no; ?>">
                                            <?php echo $this->lang->line('viewApp'); ?>
                                        </a>
                                    </td>
                                <?php endif ;?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                        <?php if(SEND_PROPOSAL_TO_SDLAC_MEM_BUTTON_RECLS == 1) { ?>
                            <?php if($proposalDetails->final_verify_status == 0 && $proposalDetails->meeting_create_status == 0): ?>
                                <button  class="btn btn-md btn-primary" id="finalSubmit" >
                                    <i class="fa fa-forward" aria-hidden="true"></i>&nbsp;&nbsp;Forward For DLC Minutes
                                </button>
                            <?php endif; ?>
                            <?php if($proposalDetails->meeting_create_status == 1): ?>
                                <h5>This Proposal would be available under process DLC Minutes</h5>
                            <?php endif; ?>
    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                <br>
                <h5>This Proposal will be made final & will be listed under process DLC Minutes</h5>
                <br>
                <h3>Are You Sure !</h3>
            </div>
            <br><br>
            ...
            <div class="modal-body" >
                <div class="row">
                    <div class="col-12 text-center" style="color: red; font-weight: bold">
                        ...
                        DLC Meeting Minutes Template Not Available
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function report_no(id, case_no) {
        ...
        showNewRejectModalMb2(case_no, '<?= RECLASS_ID ?>')
    }
    ...
    $(document).on('click','#finalSubmit',function() {
        ...
        $.ajax({
            url: BASE_URL + "/ReclassSuiteControllerADC/checkForSdlacStatus",
            dataType: "JSON",
    ...
    $('#onlineForwardToSdlac').click(function(){
        ...
        $.ajax({
            url: BASE_URL + "/ReclassSuiteControllerADC/sdlacReportOnlineApprove",
            type: "post",
            contentType: "application/json",
            dataType: "json",
            success: function (data)
            {
                ...
                else if (data.response == 2)
                {
                    ...
                    window.location = BASE_URL + "/ReclassSuiteControllerADC/getAllProposalListSdlacReclass";
                }
                })
                }
                else
    ...
    $('#removeFromProposalModalYes').click(function()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/ReclassSuiteCommonDc/applicationRemoveFromProposal",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
