...
<div class="row" style='padding: 40px 50px 40px 20px'>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-left: 25px">
        Process /
        Settlement MB 3.0/
        <a href="<?= base_url()?>index.php/SettlementProposalControllerReclass/revertMeetingListForAdc">Reverted Meeting </a> /
        Proposals

        <a class="btn btn-sm btn-danger pull-right" href="<?=base_url().'index.php/SettlementProposalControllerReclass/revertMeetingListForAdc'?>"><i class="fa fa-backward"></i>&nbsp; Go Back</a>
                        ...
                        <?php $i=1; foreach ($proposals as $proposal): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="rezaButt buttCust"    target= "Download" href="<?php echo base_url(); ?>index.php/ReclassSuiteCommonDc/downloadCasesWithProposalId/?case=<?php echo $proposal->id ?>">
                                        <i class="fa fa-download"></i> Download
                                    </a>
                                    <a class="rezaButt buttSuccess"  target= "SDLACProposalNotice" href="<?php echo base_url(); ?>index.php/SettlementProposalControllerReclass/caseListUnderRevertedMeetingForAdc/?proposal=<?php echo $proposal->id ?>">
...
<script>
    ...
    // new for vewrify the reverted case
    $("#verifyCases").click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalControllerReclass/verifyCasesUnderRevertedMeetingByDc",
            type: "post",
            dataType: "json",
    ...
    function revertBulkToCO(revertBulkPull,revertBulkChitha)
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementCommonDc/bulkRevertCasesInRevertedMeeting",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $(document).on('click','#uploadAdditionalFileModalYes',function ()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerReclass/postAdditionalFileUnderMeetingAdc",
                type: "post",
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalControllerReclass/sendRevertedProposalsToDcMinuteAdc",
            type: "post",
            enctype: 'multipart/form-data',
            contentType: false,
            cache: false,
    ...
    $('#printMinutes').click(function()
    {
        ...
        $.ajax({
            url: BASE_URL + "/SettlementProposalController/sendRevertedProposalsToDcMinuteAdc",
            type: "post",
            enctype: 'multipart/form-data',
            contentType: false,
            cache: false,
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerReclass/sendRevertedProposalsToDcAdc",
                type: "post",
                enctype: 'multipart/form-data',
                contentType: false,
                cache: false,
