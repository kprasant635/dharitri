    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right" >
                <a class="rezaButt rezaPrint pull-right" href="<?=base_url().'index.php/SettlementCommonDc/addEditCopyToForDLC'?>">
                    <i class="fa fa-edit"></i> &nbsp; Add Members For Minutes Copy to For DLC
                </a>
            </div>
        </div>
        <div class="reza-card">
                ...
                <?php if($countPendingCase != 0): ?>
                    <div class="row">
                        <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
                            <?php if(SEND_PROPOSAL_TO_SDLAC_MEM_BUTTON_RECLS_DLC == 1) : ?>
...
<div class="modal" role="dialog" id="finalSubmissionModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document" style="max-width: 80%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                    DLC Member who attended meeting
                </h5>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="datetime-local" class="form-control"
                                       name="meeting_date" id="meeting_date" required max="<?php echo MEETING_PROPOSAL_DLC_NOTICE_DATE_INPUT ?>">
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Upload Minutes <span style="font-weight: bold; font-size: 18px; color: red">*</span></label>
                                <input type="file" class="form-control" id="upload_minute_online" name="upload_minute_online" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="file" class="form-control" id="upload_attendance" name="upload_attendance" required>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <table class="datatable table table-stripped" id='datatable1' width="100%">
                            ...
                            <tr>
                                ...
                                <th width="20%">DLC Member</th>
                                <th width="20%">Select Nominee (if any)</th>
                                <th width="20%" style="text-align:center; display: none">Meeting Attended</th>
                            </tr>
                            </thead>
                ...
                <div class="container bg-white divCard pb-3 " style="page-break-before:always;">
                    ...
                    <div class="row mt-5 text-center">
                        ...
                        <div class="reza-title" style="text-align: center;">
                            Minutes of the meeting of District Level Committee  held on
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="rezaText" style="padding-left: 10px; padding-right: 10px">
                                ...
                                She/He welcomed all the members present in the meeting and
                                apprised the house about the objectives of the meeting. Initiating the discussion, the
                                Chairman placed the reclassification proposals of the individuals for each Revenue
                                Circle in front of the Committee for discussion and consideration.
                                <br>
                                &nbsp; &nbsp; &nbsp; &nbsp;

                                After threadbare discussion, following reclassification proposals submitted by the
                                Revenue Circle Officers are recommended by the DLC subject to fulfillment of extant
                                guidelines laid down in Mission Basundhara 3.0, applicable rules and regulations and
                                verification of all related records/documents.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="reza-title" style="margin-top: 25px">
                                <b><u>Following Proposals where considered by DLC & Recommended</u></b>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="reza-title" style="margin-top: 25px">
                                <b><u>Following Proposals where considered by DLC & Not Recommended</u></b>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-3 text-center">
                                District Level Committee, <span style="font-weight:bold;" class="districtName"></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 25px">
                        ...
                        <button type="button" onclick="printDiv('print_direct');" id="print" class="rezaButt rezaPrint" style="background-color: #673AB7; color: white">
            ...
            <div class="modal-body" id="print_direct_new">
                ...
                <div class="container bg-white divCard pb-3 " style="page-break-before:always;">
                    ...
                    <div class="row mt-5 text-center">
                        ...
                        <div class="reza-title" style="text-align: center;">
                            Minutes of the meeting of DLC held on
                            <span style="font-weight:bold;" class="meetingDate"></span>
                            at
                            <span style="font-weight:bold;" class="timing"></span>
                            in the
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="rezaText" style="padding-left: 10px; padding-right: 10px">
                                ...
                                the DLC for discussion and consideration.
                                ...
                                unanimously by the DLC subject to fulfillment of
                                extant guidelines laid down in Mission Basundhara 3.0, Land Policy, 2019 and verification of
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-3 text-center">
                                Chairman, DLC, <span style="font-weight:bold;" class="districtName"></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body" >
                <div class="row">
                    <div class="col-12 text-center" style="color: red; font-weight: bold">
                        ...
                        #MREZA000: There is some network issue
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript">
    ...
    function load_data()
    {
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax'   : {
                url  : base_url+'index.php/SettlementProposalControllerReclass/listOfProposalsAllServices',
                type : 'POST',
                data : {
                    circle       : circle,
                    subdiv       : subdiv,
    ...
    $("#openModalForFinalSubmit").click(function(){
        ...
        if (selectedList.length > 0)
        {
            ...
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerReclass/checkAllSdlacPresentMember",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    $('#forwardToDcForFinalApproval').click(function()
    {
        ...
        if($('#upload_minute_online').val() == '') {
            showErrorMessage('Upload Minutes is mandatory');
        ...
        {
            $.ajax({
                url: BASE_URL + "/SettlementProposalControllerReclass/sendProposalsToDcMinute",
                type: "post",
    ...
    $('#printMinutes').click(function()
    {
        ...
        {
            $.ajax({
                url: BASE_URL + "/SettlementProposalController/sendProposalsToDcMinute",
                type: "post",
                enctype: 'multipart/form-data',
                contentType: false,
                cache: false,
    ...
    $('#minutesGenerateModalYes').click(function(){
        ...
        else
        {
            ...
            {
                $.ajax({
                    url: BASE_URL + "/SettlementProposalControllerReclass/sendProposalsToDc",
                    type: "post",
                    enctype: 'multipart/form-data',
                    contentType: false,
                    cache: false,
                    ...
                    success: function (data)
                    {
                        ...
                        if (data.responseType == 1) { //for error message
                            showErrorMessage(data.message);
                        }
