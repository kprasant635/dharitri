...
<div class="panel panel-info panel-form mt-5">
    <div class="panel-heading bg-info text-center font-weight-bold">
        <h3 class="panel-title">
            Village Land Bank Report-(Lot-Wise)                       
        </h3>
    </div>    
    <div class="panel-heading bg-warning text-center">
        <h6 class="panel-title font-weight-bold" style="font-size:14px;">
            TOTAL-GOVT-DAG : <?=$total_govt_dag_in_circle?>,
            TOTAL-DAG-UPDATED : <?=$total_updated_by_lm_dag?>,
            TOTAL-DAG-APPROVED : <?=$total_approved_by_co_dag?>,
                        ...
                        <tbody>
                            <?php foreach ($lot_wise_report_data as $rptData):?>                                    
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'index.php/LandBankReport/VillageWiseReport/'.$rptData['mouza_pargona_code'].'/'.$rptData['lot_no'] ?>" class="text-danger">
