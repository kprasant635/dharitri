...
<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        ...
        Payment Notice list for Juridical Entity
        </h4>
    </div>
</div>
<div class="col-lg-12">
    <p style="font-weight:bold;color: red;">Note : In some cases premium is not applicable so directly it will go for chitha correction once forwarded by CO</p>
                ...
                <tr>  
                    ...
                    <th>
                        <select class="form-select" data-column-index="2" id="remark_cat"
                                name="remark_cat">
                            <option value="">LRA Remark Category...</option>
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null,  mouza_cat=null, lot_cat=null,urban_rural=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementInstitutionCo/getListofPaymentNoticeCases',
                    type:'POST',
                    data: {
