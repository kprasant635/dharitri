        ...
        <div class="row">
            <div class="form-group">
                ...
                <label class="col-lg-12 col-md-12 col-sm-12 text-left" style=" font-size: 18px; color:#FF5252">
                    ...
                    Click on checkboxes to Approve multiple cases...
                </label>
                <br>
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null, nr_cat=null, payment_status=null, final_verification_report=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementMbCo/paginationCoFirstBulkApprove',
                    type:'POST',
                    data: {
...
<script>
    $('#co_bulk_notice').submit(function (e) {
        e.preventDefault();
        if(!confirm("Are you sure you want to approve this cases?"))
        {
            return false;
        }
        // $("#overlay").fadeIn(300);
        ...
        $.ajax({
            url: baseurl + "SettlementMbCo/coBulkApproveLmReVerificationReport",
            type: 'POST',
