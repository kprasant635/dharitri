...
<?php if(NIJE_OFFER_OF_ALLOTMENT_SETTLEMENT_GUIDE == 1){?>
<div class="row p-4" style='margin-top:40px'>
    <div class="col-md-12" style="background:#c8a8ff">
        <h4>GUIDELINES FOR GENERATING OFFER OF ALLOTMENT/SETTLEMENT (MODULE WILL BE LAUNCH SOON)</h4>
        <ul>
            <li>1) For cases where a payment notice was generated before, the option to generate the Offer of Allotment/Settlement will be available under the <b>Payment Notice Confirmation List</b>.</li>
            <li>2) For cases where a payment notice has not yet been generated, it can be created directly from the list <b>Payment Notice (After Approval from Department/DC)</b>. In such cases, the Offer of Allotment/Settlement will be generated simultaneously. no need to generate again from the link <b>Payment Notice Confirmation List</b>.</li>
            <li>3) After successful generation, all Offers of Allotment/Settlement will be available under the list <b>Offer of Allotment & Settlement (Issued Cases) [For Bulk Printing Only]</b>.</li>
        </ul>
    </div>
</div>
<?php } ?>
            ...
            <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr class="">
                        ...
                        <td>
                            <a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/initLanding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                        </td>
                    </tr>

                    <tr class="">
                        <td>Second Proceeding</td>
                        <td><?php
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/SecondProcess?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                        </td>
                    </tr>
                    <?php
                    if($user_desig_code == 'CO'){ ?>
                        ...
                        <tr>
                            <td>Payment Notice After approval from Department/DC</td>
                            <td><?php
                                if ($payment_notice != '0') {
                                    echo "<span class=\"badge badge-danger\">$payment_notice</span>";
                                }
                                ?></td>
                            <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/paymentNoticeCo?service='.$service_code.'&s='.MB_PAYMENT_REQUEST; ?>" style="float:right">view</a></td>
                        </tr> 
                        <tr>
                            <td>Payment Notice Confirmation</td>
                            <td><?php
                                if ($payment_confirm != '0') {
                                    echo "<span class=\"badge badge-danger\">$payment_confirm</span>";
                                }
                                ?></td>
                            <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/paymentNoticeCofirmationCases?service='.$service_code.'&s='.MB_PAYMENT_NOTICE; ?>" style="float:right">view</a></td>
                        </tr>
                        <?php if (NIJE_OFFER_OF_ALLOTMENT_SETTLEMENT == 1 && NIJE_OFFER_OF_ALLOTMENT_SETTLEMENT_DATE <= date('Y-m-d')){?>
                            <tr>
                                <td><b style="color: red;">Offer of Allotment & Settlement (Issued Cases) [For bulk printing only]</b></td>
                                <td><?php
                                    if ($ooa_oos_issue != '0') {
                                        echo "<span class=\"badge badge-danger\">$ooa_oos_issue</span>";
                                    }
                                    ?></td>
                                <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/offerLetterIssued?service='.$service_code.'&s='.MB_PAYMENT_NOTICE; ?>" style="float:right">view</a></td>
                            </tr>
                        <?php }?>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/coReSubmitLmCases?service='.$service_code.'&s='.MB_RE_REPORT; ?>" style="float:right">view</a></td>
                    </tr>
                    <?php
                    if($user_desig_code != 'SK')
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/dcRevertedCases?service='.$service_code.'&s='.MB_REVERT; ?>" style="float:right">view</a></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/coRejectCases?service='.$service_code.'&s='.MB_DISMISS ?>" style="float:right">view</a></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/reGeoTagCaseList?service='.$service_code; ?>" style="float:right">view</a></td>
                        </tr> 
                    ...
                    if($user_desig_code == 'CO')
                    {
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url() . 'index.php/SettlementInstitutionCo/chithaBulkList?service='.$service_code.'&s='.MB_PAYMENT_NOTICE?>" style="float:right">view</a></td>
                            </tr>
