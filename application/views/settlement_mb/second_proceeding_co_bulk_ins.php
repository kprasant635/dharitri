<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        ...
        Second Proceeding (Non individual juridical entities)
        </h4>
    </div>
    <!-- New Select Field -->
    <!-- //Select Field End -->
        ...
        <div class="row" style="display:none;">
            <div class="form-group">
                ...
                <label class="col-lg-12 col-md-12 col-sm-12 text-left" style=" font-size: 18px; color:#FF5252">
                    ...
                    Click on checkboxes to revert multiple cases. All reverted cases will be available at LRA...
                </label>
                <br>
    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null, nr_cat=null, payment_status=null, final_verification_report=null, review_cat)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementInstitutionCo/paginationCoSecondBulk',
                    type:'POST',
                    data: {
