<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        <h4 style="text-align: center;">
            Chitha Update List(paid through installment)
...
<script>
    ...
    {
        $(document).on('change', '#category, #p_type, #l_mis', function(){
            ...
            // if(category != ''){
            load_data(category, remark_cat, mouza_cat, lot_cat, p_type, l_mis);
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null, p_type = null, l_mis=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/SettlementMbCo/paginationBulkChitaUpdatePartial',
                    type:'POST',
                    data: {
...
<script>
    $('#co_bulk_notice').submit(function (e) {
        ...
        $.ajax({
            url: baseurl + "SettlementMbCo/bulkChithaUpdatePartial",
            type: 'POST',
