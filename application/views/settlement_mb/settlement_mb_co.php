            ...
            <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr class="">
                        ...
                        <td><!-- <a href="<?php echo base_url() . 'index.php/SettlementMbCo/FirstProceeding'; ?>" style="float:right">view</a> -->
                            <!-- <a href="<?php echo base_url() . 'index.php/SettlementApCo/FirstProceeding'; ?>" style="float:right">view</a> -->
                            <?php if ($service_code == 16) { ?>
                                <a href="<?php echo base_url() . 'index.php/SettlementKhasCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                            <?php }
                            else if ($service_code == 17) { ?>
                                <a href="<?php echo base_url() . 'index.php/SettlementVgrCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                            <?php }

                            else if ($service_code == 18) { ?>
                                <a href="<?php echo base_url() . 'index.php/SettlementTeaCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                            <?php }

                            else if ($service_code == 13) { ?>
                                <a href="<?php echo base_url() . 'index.php/SettlementTenantCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                            <?php }
                            ...
                            <?php }
                                ...
                                <a href="<?php echo base_url() . 'index.php/SettlementApCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">view</a>
                    ...
                    if($user_desig_code != 'SK')
                    {
                        ...
                        <?php
                        if(LM_VERIFICATION_REPORT_BULK_APPROVE_CO != 0)
                        {
                            ?>
                            <tr>
                                <td>LM Verification Report Bulk Approve List</td>
                                <td>
                                    <?php
                                    if ($payment_confirm != '0') {
                                        echo "<span class=\"badge badge-danger\">$bulk_approve_lm_report</span>";
                                    }
                                    ?>
                                </td>
                                <td>
                                    <a href="<?php echo base_url() . 'index.php/SettlementMbCo/bulkLmVerificationReportApprove?service='.$service_code.'&s='.MB_PAYMENT_NOTICE; ?>" style="float:right">view</a>
                                </td>
                            </tr>
                        ...
                        ?></td>
                        <td><a href="<?php echo base_url() . 'index.php/SettlementMbCo/coFinalPendingCases'; ?>" style="float:right">view</a></td>
                    </tr> -->
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() . 'index.php/SettlementMbCo/coReSubmitLmCases?service='.$service_code.'&s='.MB_RE_REPORT; ?>" style="float:right">view</a></td>
                    </tr>
                    <?php
                    if($user_desig_code != 'SK')
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'index.php/SettlementMbCo/coForwardedCases?service='.$service_code.'&s=V&reverted=LM' ?>" style="float:right">view</a></td>
                        </tr>
                    <?php } ?>
                        ...
                        <?php echo ($this->session->userdata('cir_code')) ?>

                        <!-- Modification Request Masud reza -------- 21_09_23-->
                        <?php if(MODIFICATION_REQUEST_ENABLE == 1): ?>
                        <?php if($service_code == SETTLEMENT_KHAS_LAND_ID): ?>
                            <?php if(in_array($this->session->userdata('dist_code'), MODIFICATION_REQUEST_ENABLE_FOR_DIST_CODE)
                                AND in_array($this->session->userdata('cir_code'), MODIFICATION_REQUEST_ENABLE_FOR_CIR_CODE)): ?>
                                <tr>
                                    <td>All Cases for Modification Request</td>
                                    <td></td>
                                    <td><a href="<?php echo base_url() . 'index.php/SettlementModification/caseListForPullRequest?service='.$service_code; ?>" style="float:right">view</a></td>
                                </tr>
                                <tr>
                                    <td>Modification Requested Cases</td>
                                    <td></td>
                                    <td><a href="<?php echo base_url() . 'index.php/SettlementModification/caseListForModificationRequestedByCo?service='.$service_code; ?>" style="float:right">view</a></td>
                                </tr>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><a href="<?=base_url().'index.php/SettlementMbCo/apNoticeGenertaedCases?service=14&s=V&notice=1'?>">Notice Period to be completed in 1 day</a> (<?= $to_be_completed_1day->count ?>)</p>
