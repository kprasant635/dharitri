    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 ">
            <div class="panel panel-info panel-form">
                <form class="form-horizontal unicode" action="<?php echo base_url() . "index.php/SettlementMbCo/updateChithaAP" ?>" method="POST"  >   
                    ...
                    <div class='panel-body'>
                        ...
                        <div class="form-group">    
                            ...
                            <div class="col-lg-2">
                                <input type="text" class="form-control numberonly" value='' placeholder='Patta Number' name="new_patta" id='new_patta' required="" value="" >
                            </div>
                        ...
                        <div class="form-group">    
                            ...
                            <label for="inputEmail" class="col-lg-3 control-label ">Check Existing Patta</label>
                            <div class="col-lg-3">
                                <select class="col-lg-3">
                                    <?php foreach ($dag_patta as $d) { ?>
                        ...
                        <div class="panel-footer">
                            ...
                            <input type="text"  class="numberonly form-control" name="land_class" value="<?= $class_code; ?>" >
