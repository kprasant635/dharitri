                ...
                <div class="row">
                    ...
                    <?php if(ENABLE_DIGITAL_PATTA_BATCH_SIGN == 1){?>
                        ...
                        <button class="btn btn-primary" type="button" id="bulkSentForApproveWithoutSignModalOpen">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            Approve Digital Patta For Selected Application
                        </button>
                        <?php }  else { ?>
                            <button class="btn btn-danger" type="button" id="bulkSentForApproveWithoutSignModalOpen">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            Issue Digital Patta For Selected Application
                        </button>
                            <?php } ?>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php if(ENABLE_DIGITAL_PATTA_BATCH_SIGN == 1){ ?>
                            <button type="button" class="btn btn-success btn-sm" id="bulkSentForDigitalSign">Sent for Digital Sign</button>
                        <?php } else if(ENABLE_DIGITAL_PATTA_BATCH_SIGN == 2){ ?>
                            <button type="button" class="btn btn-primary btn-sm" id="bulkCasesApproveSubmit">Approve Digital Patta</button>
                        <?php } else{ ?>
                            <button type="button" class="btn btn-danger btn-sm" id="bulkCasesApproveSubmitWithoutPdf">Issue Digital Patta</button>
                        <?php } ?>
    ...
    <div class="col-sm-4">
        <div class="well-sm" style="display:none">
            ...
            <form id="pdfForm">
                ...
                <input type="hidden" id="timeServerURL" name="timeServerURL" value="<?=DIGITAL_SIGN_SERVER_TIME_URL?>" maxlength="100" style="width: 400px;" /><br /> 
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_data_digital_patta_list() {
            ...
            var table = $('#dataTableDigitalPatta').DataTable({
                ...
                'ajax': {
                    url: base_url+'index.php/DigitalPatta/getAllDigitalPattaDetails',
                    type: 'POST',
                    data: {
                    },
                    deferLoading: 57,
    ...
    function viewDigitalPatta(case_no,dist_code){
        ...
        $.ajax({
            url: base_url +'index.php/DigitalPatta/getDigitalPattaDetails',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
...
<script type="text/javascript">
    ...
    $(document).on('click', '#bulkCasesApproveSubmitWithoutPdf', function() {
        ...
        //console.log(applicant);
        $.ajax({
            url: base_url +'index.php/DigitalPatta/bulkApproveCasesOfDigitalPattaWithoutDigitalSignWithoutPdf',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
