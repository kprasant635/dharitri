                    ...
                    <table style="width: 100%!important; margin-bottom: -10px!important;">
                        ...
                        <tr>
                            ...
                            <td class="logo logoBorder" style="text-align:right!important;" width="33%">
                                <img src="<?php echo $base_64_qr ?>" height="70px" width="70px" style="margin-top: 10px!important;">
                                <br>
                                <span style="align-items: right; padding-left: 10px; font-weight: bold; font-size: 10px!important;">DATE OF ISSUE: <?= date("d/m/Y") ?></span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="row" style="padding:0px 10px 1px 10px;!important;">
                        ...
                        <table class="table table-bordered reza-table-width-100">
                            ...
                            <tr class="reza_table_text" style="border: 1px solid black!important;" >
                                <td style="border: 1px solid black!important"><?=$patta_info['chitha_pattadar_applicant_data']->pdar_name_eng?></td>
                                <td style="border: 1px solid black!important"><?=$patta_info['chitha_pattadar_applicant_data']->pdar_add1?></td>
                                ...
                                <td style="border: 1px solid black!important"><?=$patta_info['applicant_data']->settlement_guardian_eng?></td>
                                <td style="border: 1px solid black!important">
                                    <?php
                                ...
                                <td style="border: 1px solid black!important"><?=date('d-m-Y',strtotime($patta_info['applicant_data']->settlement_dob))?></td>
                                <td style="border: 1px solid black!important"><?=$patta_info['settlement_basic_details']->occupation_applicant?></td>
                                ...
                                <?php else : ?>
                                    <td style="border: 1px solid black!important"><?=$patta_info['chitha_pattadar_applicant_data']->pdar_mobile?></td>
                                <?php endif ?>
                        ...
                        <table class="table table-bordered himanxu_body_color_purple himanxu-table-width-100" style="margin-top: -17px!important;">
                            ...
                            <tr class="reza_table_text">
                                ...
                                <td style="border: 1px solid black!important"><?=$this->digitalPattaLocationModel->getDistrictNameEng($patta_info['chitha_pattadar_applicant_data']->dist_code)?></td>
                        ...
                        <table class="table table-bordered himanxu_body_color_blue himanxu-table-width-100" style="margin-top: -17px!important;">
                            ...
                            <tr align="center">
                                <td colspan="3" style="text-align:center;vertical-align: middle; border: 1px solid black!important ">
                                    <img src=" <?php echo $base_64_qr_geo_cordinates ?>" alt="qr_code" height="70px" width="70px">
                                </td>
                                <td colspan="3" style="border: 1px solid black!important; vertical-align: middle;">
                                    <img src=" <?php echo $dag_sketch_qr_photos ?>" alt="qr_code" height="70px" width="70px">
                                </td>
                                <td colspan="3" style="text-align:center;vertical-align: middle; border: 1px solid black!important ">
                                    <img src=" <?php echo $base_64_qr_google ?>" alt="qr_code" height="70px" width="70px">
                                </td>
                                <td colspan="3" style="text-align:center; border: 1px solid black!important; vertical-align: middle; ">
                                    <img src=" <?php echo $base_64_qr_sketch ?>" alt="qr_code" height="70px" width="70px">
