<div class="container-fluid login form-top">
    <div class="row">
        <div class="col-lg-10 panel panel-default panel-body  col-lg-offset-1">
              <div class="alert alert-success" role="alert">
                <h4>Land Area of New Lease Rule Grant for Mouza  : <code><?php echo $namedata[3]->mouza;?></code></h4>
            </div>
            ...
            <table class="table table-striped table-bordered" width="100%" border="1">
                ...
                <tr class="danger">
                    ...
                    <th class="text-center"><?php echo $this->lang->line('lesa');?></th>
    ...
    <script type="text/javascript">
        document.getElementById("backButton").onclick = function () {
            location.href = "<?php echo base_url() . 'index.php/MisReport/LandAreaNLR' ?>";
        };
    </script>
