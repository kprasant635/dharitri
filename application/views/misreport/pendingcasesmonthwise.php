<div class="container-fluid login">
    <div class="row" >
        <div class="col-sm-12" >  
            ...
            ?>
            <div class="alert alert-dismissible alert-warning text-center"><h2 class="uni_text">List of pending case's more than 2 month's  - <?php echo $cnmae; ?> </h2>
                <p class="text-info hide"> <?php echo $this->lang->line('during_this_period');?>  <?php echo $this->lang->line('from');?> <?php echo date('d-m-Y',  strtotime($this->session->userdata('sdate')))  ?>  <?php echo $this->lang->line('to');?> <?php echo date('d-m-Y',  strtotime($this->session->userdata('edate')))  ?></p>
            </div>
