<div class="container-fluid login">
    <div class="row">
        <div class="col-lg-12" >
            <div class="alert alert-warning"><h2 class="uni_text center"><?php echo $this->lang->line('registered_disposed_pending_cases_of'); ?></h2></div>
        </div>
    </div>
              ...
              //  var_dump($circle) ;
                ...
                foreach ($circle as $key=>$val) {
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><?php
                            echo $val['omut']->c;
                            $omut_tot = $omut_tot + $val['omut']->c;
                            ?></td>
                        <td><?php
                            echo $val['omutfinal']->c;
                            $omutfinal_tot = $omutfinal_tot + $val['omutfinal']->c;
                            ?></td>
                        <td><?php
                        echo $val['omutdev']->c;
                        $omutdev_tot = $omutdev_tot + $val['omutdev']->c;
                            ?></td>
                        <td><?php
                        echo $val['omutpen']->c;
                        $omutpen_tot = $omutpen_tot + $val['omutpen']->c;
                            ?></td>
                        <td ><?php
                        echo $val['opart']->c;
                        $opart_tot = $opart_tot + $val['opart']->c;
                            ?></td>
                        <td ><?php
                            echo $val['opartfinal']->c;
                            $opartfinal_tot = $opartfinal_tot + $val['opartfinal']->c;
                            ?></td>
                        <td ><?php
                            echo $val['opartdev']->c;
                            $opartdev_tot = $opartdev_tot + $val['opartdev']->c;
                            ?></td>
                        <td ><?php
                            echo $val['opartpen']->c;
                            $opartpen_tot = $opartpen_tot + $val['opartpen']->c;
                            ?></td>

                        <td><?php
                            echo $val['ocon']->c;
                            $ocon_tot = $ocon_tot + $val['ocon']->c;
                            ?></td>
                        <td><?php
                            echo $val['oconfinal']->c;
                            $oconfinal_tot = $oconfinal_tot + $val['oconfinal']->c;
                            ?></td>
                        <td><?php
                            echo $val['ocondev']->c;
                            $ocondev_tot = $ocondev_tot + $val['ocondev']->c;
                            ?></td>
                        <td><?php
                            echo $val['oconpen']->c;
                            $oconpen_tot = $oconpen_tot + $val['oconpen']->c;
                            ?></td>


                        <td><?php
                            echo $val['ofcmut']->c;
                            $ofcmut_tot = $ofcmut_tot + $val['ofcmut']->c;
                            ?></td>
                        <td><?php
                            echo $val['ofcmutfinal']->c;
                            $ofcmutfinal_tot = $ofcmutfinal_tot + $val['ofcmutfinal']->c;
                            ?></td>
                        <td><?php
                        echo $val['ofcmutdev']->c;
                        $ofcmutdev_tot = $ofcmutdev_tot + $val['ofcmutdev']->c;
                            ?></td>
                        <td><?php
                            echo $val['ofcmutpen']->c;
                            $ofcmutpen_tot = $ofcmutpen_tot + $val['ofcmutpen']->c;
                            ?></td>


                        <td><?php
                            echo $val['fpart']->c;
                            $fpart_tot = $fpart_tot + $val['fpart']->c;
                            ?></td>
                        <td><?php
                            echo $val['fpartfinal']->c;
                            $fpartfinal_tot = $fpartfinal_tot + $val['fpartfinal']->c;
                            ?></td>
                        <td><?php
                            echo $val['fpartdev']->c;
                            $fpartdev_tot = $fpartdev_tot + $val['fpartdev']->c;
                            ?></td>
                        <td><?php
                            echo $val['fpartpen']->c;
                            $fpartpen_tot = $fpartpen_tot + $val['fpartpen']->c;
                            ?></td>

                        <td><?php
                echo $val['nr_tot']->c;
                $nr_tot_tot = $nr_tot_tot + $val['nr_tot']->c;
                ?></td>
                        <td><?php
                echo $val['nr_dev']->c;
                $nr_dev_tot = $nr_dev_tot + $val['nr_dev']->c;
                ?></td>
                        <td><?php
                echo $val['nr_dispose']->c;
                $nr_dispose_tot = $nr_dispose_tot + $val['nr_dispose']->c;
                ?></td>
                        <td><?php
                echo $val['nr_pen']->c;
                $nr_pen_tot = $nr_pen_tot + $val['nr_pen']->c;
                ?></td>

                        <td><?php
                echo $val['misccase_tot']->c;
                $misccase_tot_tot = $misccase_tot_tot + $val['misccase_tot']->c;
                ?></td>
                        <td><?php
                echo $val['misccase_dev']->c;
                $misccase_dev_tot = $misccase_dev_tot + $val['misccase_dev']->c;
                ?></td>
                        <td><?php
                echo $val['misccase_dispose']->c;
                $misccase_dispose_tot = $misccase_dispose_tot + $val['misccase_dispose']->c;
                ?></td>
                        <td><?php
                echo $val['misccase_pen']->c;
                $misccase_pen_tot = $misccase_pen_tot + $val['misccase_pen']->c;
                ?></td>

                        <td><?php
                echo $val['t_reclass_tot']->c;
                $t_reclass_tot_tot = $t_reclass_tot_tot + $val['t_reclass_tot']->c;
                ?></td>
                        <td><?php
                echo $val['t_reclass_dev']->c;
                $t_reclass_dev_tot = $t_reclass_dev_tot + $val['t_reclass_dev']->c;
                ?></td>
                        <td><?php
                echo $val['t_reclass_dispose']->c;
                $t_reclass_dispose_tot = $t_reclass_dispose_tot + $val['t_reclass_dispose']->c;
                ?></td>
                        <td><?php
                echo $val['t_reclass_pen']->c;
                $t_reclass_pen_tot = $t_reclass_pen_tot + $val['t_reclass_pen']->c;
                ?></td>
                    </tr>
    <?php
}
