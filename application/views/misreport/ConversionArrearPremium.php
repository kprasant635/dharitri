    ...
    <div class="row">
        <div class="col-lg-10 panel panel-default panel-body col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 class='uni_text' style="text-align: center; color: #2e4d8e"> Arrear Premium For Conversion</h2>
            </div>
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportControllerPartha/saveConversionArrearPremium' ?>">
