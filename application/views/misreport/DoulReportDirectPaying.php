    ...
    <div class="row">
        <div class="col-lg-10 panel panel-body panel-default col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 class='uni_text' style="text-align: center; color: #2d4e8e">Doul Report Generation</h2>
            </div>
            <?php //print_r($pattas);?>
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportController/saveDoulReportDPE' ?>">
