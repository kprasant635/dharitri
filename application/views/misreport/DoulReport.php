<div class="container-fluid login form-top">
    <div class="row">
        <div class="col-lg-10 panel panel-body panel-default col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 class='uni_text' style="text-align: center; color: #2d4e8e"><?php echo $this->lang->line('doul_report');?></h2>
            </div>
            <?php //print_r($pattas);?>
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportController/saveDoulReport' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control Patta_type " id="select" required name="patta_type">
                                    <option disabled selected><?php echo $this->lang->line('select_patta_type');?></option>
                                     <?php
                                     foreach ($pattas as $patta_type): ?>
                                        <?php
                                        $typeCode = $patta_type->type_code;
                                        $patta_name = $patta_type->patta_type;
                                        ?>
                                        <option value="<?php echo $typeCode; ?>"><?php echo $patta_name; ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control " required name="year" placeholder="YYYY-YY" onkeyup="
                                            var v = this.value;
                                            if (v.match(/^\d{4}$/) !== null) {
                                                this.value = v + '-';
                                            } "
