    ...
    <div class="col-lg-12 ">
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="well well-sm mis_report">
                <h2 style="text-align: center; color: #2e4d8e"><?php echo $this->lang->line('irrigated_and_non_irrigated_land_area');?></h2>
            </div>
        ...
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method='post' action="<?php echo base_url() . "index.php/MisReportController1/irregated_nonirregated1"; ?>">
                        ...
                        <div class="form-group">
                            <div class="col-lg-5 col-lg-offset-3">
                                ...
                                <button id="backButton" class="btn btn-danger uni_text"><i class="fa fa-home"> </i>&nbsp;<?php echo $this->lang->line('back_to_main_menu');?></button>
                            </div>
                        </div>
                    </form>
                </div>
