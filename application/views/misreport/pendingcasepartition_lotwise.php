    ...
    <div class="row" >
        <div class="col-sm-12" > 
            <?php
                  ...
                  //var_dump($newdata);
            ?>
            <div class="alert alert-dismissible alert-warning text-center"><h2 class="uni_text"><?php echo $this->lang->line('lot_wise_pendency_list');?> - <?php echo $cnmae; ?>  </h2></div>
            ...
            <span class="label label-success uni_text"><?php echo $this->lang->line('subdivision');?> : <?php echo $this->utilityclass->getSubDivName($this->session->userdata('dist_code'),$newdata['subdiv_code'] ); ?></span>
             ...
             <span class="label label-active uni_text"><?php echo $this->lang->line('mouza');?> : <?php echo $this->utilityclass->getMouzaName($this->session->userdata('dist_code'),$newdata['subdiv_code'] ,$newdata['cir_code'],$newdata['mouza']); ?></span>
