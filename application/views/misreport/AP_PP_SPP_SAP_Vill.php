        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 class='uni_text' style="text-align: center; color: #2e4d8e">Village-Wise Land Area of Annual Patta(A.P), Periodic Patta(P.P), Special Periodic Patta(S.P.P), Special Annual Patta(S.A.P) Land Area</h2>
                </div>
            </div>
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method='post' action="<?php echo base_url() . "index.php/MisReportController1/AP_PP_SPP_SAP_Vill1"; ?>">
