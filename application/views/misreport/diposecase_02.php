...
<div class="container-fluid login">
    <div class="row" >
        <div class="col-sm-12" >  
            ...
            <div class="alert alert-warning"><h2 class="uni_text"><?php echo $this->lang->line('registered_disposed_pending_cases_of');?> <font color="#0066FF"></font> 
	    District- At a Glance (<font color="#0066FF"><?php echo $this->lang->line('mouza_wise');?></font>)</h2></div>
            ...
            <span class="label label-success uni_text"><?php echo $this->lang->line('subdivision');?> : <?php echo $this->utilityclass->getSubDivName($this->session->userdata('dist_code'),$locdata['subdiv_code']) ; ?></span>
             <span class="label label-warning uni_text"><?php echo $this->lang->line('circle');?> :  <?php echo $this->utilityclass->getCircleName($this->session->userdata('dist_code'),$locdata['subdiv_code'],$locdata['cir_code']) ; ?></span>
            <p><br></p>   
            
        <div class="table-responsive">
            <table width="100%" class="table table-bordered" style="background: #fff"  border="1">
             <tr>
                 <th style="background:#196f82;color:#fff" width="40" rowspan="3"><?php echo $this->lang->line('mouza'); ?></th>
                 ...
                 <td  rowspan="2" style="background:#FF6347; color: #fff; text-align: center"><?php echo $this->lang->line('get_information'); ?></td>
             </tr>
             <tr>
             ...
             <tr class="alert-warning active">
                ...
                <td style="background:#9E4638; color: #fff; text-align: center"><?php echo $this->lang->line('pending'); ?></td>
                 ...
                 <td width="59" style="background:#FF6347; color: #fff; text-align: center"><?php echo $this->lang->line('lot_wise'); ?></td>
             </tr>
             ...
             $tot_nr=0;$tot_nrdis=0;$tot_nrpen=0;
             $tot_re=0;$tot_redis=0;$tot_repen=0;
             $tot_mi=0;$tot_midis=0;$tot_mipen=0;
             $tot_omutfinal=0; $tot_opartfinal=0; $tot_oconvfinal=0;$tot_fmut_final=0;$tot_fpart_final=0;
             $tot_nrfinal=0;$tot_refinal=0;$tot_mifinal=0;$tot_acppfinal=$totcomp=$totsettle=0;
             $tot_acpp=0;$tot_acppdis=0;$tot_acpppen=0;
             ...
             <tr style="text-align: center">
               ...
               <td><a href="<?php echo base_url(); ?>index.php/MisReport/DisposeLotwise?mouza_code=<?php echo $l->mouza_pargona_code; ?>&sub=<?php echo $l->subdiv_code;?>&cir=<?php echo $l->cir_code ?>" class="btn btn-warning"><?php echo $this->lang->line('view_details');?></a></td>
             </tr>
             <?php
             ...
             $tot_omutfinal=$tot_omutfinal+$omutfinal[$i]->c;
             ...
             $tot_fmut_final=$tot_fmut_final+$fieldmutfinal[$i]->c;
