            ...
            <table class="table table-striped table-bordered" width="100%">
                ...
                <tr class="active">
                    <td colspan="3" class="text-center">
                        <h2>MIS-Report On No Of Tenants for Mouza : 
                ...
                <tr class="danger">
                    ...
                    <td  class="text-center" colspan="2"><?php echo $this->lang->line('no_of_tenants');?></td>
                </tr>
                <?php
                $c = 1;
...
<script type="text/javascript">
    document.getElementById("backButton").onclick = function () {
        window.location="<?php echo base_url(); ?>index.php/MisReportController1/No_Of_Tenants";
    };
</script>