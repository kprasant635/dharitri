    ...
    <div class="row">
        <div class="col-lg-10 panel panel-body panel-default col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 class='uni_text' style="text-align: center; color: #2e4d8e"> Village-wise Land Scenario</h2>
            </div>
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportControllerPartha/savevillageland' ?>">
...
<div class="modal fade modal-transparent" style="margin-top: 250px" id='myModal' >
    <div class="" role="document"> 
        ...
        <center>
            ...
            <h5 style="color: #fff">Generating Village-wise Land Scenario. </h5>
        </center>
