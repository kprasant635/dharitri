...
<div class="container-fluid login">
    <div class="row" >
        <div class="col-sm-12" >  
            ...
            <?php  
            //var_dump($loc); 
            $dist_name=$this->utilityclass->getDistrictName($loc[0]->dist_code);
            $i=0;
            foreach($loc as $l){
            ?>
            ...
            <table width="100%"  class="example table table-bordered table-hover" border="1">
                ...
                <tr>
                    ...
                    District : <?=$dist_name?> Circle : <?php echo $l->loc_name; ?> <br>
                    <?php echo $this->lang->line('mutation_type');?></div></td>
                ...
                <tr class="active">
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $fieldmut1[$i]['penomut1']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/FieldPendingCase?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td> <!-- removed -<?php //echo $this->lang->line('view');?>  -->
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $fieldmut[$i]['penomut']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/FieldPendingCasePPEdate?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                </tr>
                <tr>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $fieldpart1[$i]['penopart1'] ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/FieldPendingCase?type=02&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $fieldpart[$i]['penopart']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/FieldPendingCasePPEdate?type=02&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"></a></div></td>
                </tr>
                <tr class="active">
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officemut1[$i]['penomut1']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=03&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officemut[$i]['penomut']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=03&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                </tr>
                <tr>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officepart1[$i]['penopart1'] ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=04&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officepart[$i]['penopart']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=04&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                </tr>
                <tr class="active">
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officecon1[$i]['penocon1']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officecon[$i]['penocon']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec"> </a></div></td>
                </tr>
                <tr>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeAP[$i]['penap'] ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=04&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeAP1[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=04&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                </tr>
                <tr class="active">
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeReclass[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide "></a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeReclass1[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                </tr>
                <tr>
                    <td><div align="center">8</div></td>
                    <td><a href='<?php echo base_url() ?>index.php/MisReport/citizenBreakup/<?php echo $l->subdiv_code ?>/<?php echo $l->cir_code ?>'>Citizen Centric Services</a><sup class="red">New</sup> </td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeCert[$i]['penap'] ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=04&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><a href="<?php echo base_url() ?>index.php/MisReport/pendingCert/<?php echo $l->subdiv_code ?>/<?php echo $l->cir_code ?>" ><?php echo $officeCert1[$i]['penap']  ; ?></a></span></div></td>
                </tr>
                ...
                <tr class="active">
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeMiscN[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide "> </a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeMiscN1[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                </tr>
                <tr >
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeMiscD[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePPEdate?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide "></a></div></td>
                    ...
                    <td><div align="center"><span class="badge badge-danger"><?php echo $officeMiscD1[$i]['penap']  ; ?></span><br><a href="<?php echo base_url() ?>index.php/MisReport/PendingCasePP?type=01&sub=<?php echo $l->subdiv_code ?>&cir=<?php echo $l->cir_code ?>" class="text-dec hide"> </a></div></td>
                </tr>
                </tbody>
            </table>
            <?php
...
<script type="text/javascript">
    ...
    $('.example').DataTable( {
        ...
        buttons: [
            {
                extend: 'excel',
                text: 'Click here to Export in excel',
