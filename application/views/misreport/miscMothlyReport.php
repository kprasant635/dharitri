    ...
    <div class="row">
        <div class="col-lg-10 panel panel-default panel-body col-lg-offset-1">
            <div class="well well-sm mis_report">
                <h2 class='uni_text' style="text-align: center; color: #2e4d8e"> <?php echo $this->lang->line('yearly_monthly_report_on_application_received_on_MISC_cases');?></h2>
            </div>
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportController/MiscMonthlyReport' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control " id="select" required name="select_yr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="select" required name="month_name">
                                    ...
                                    <option value="00">Full Year</option>
