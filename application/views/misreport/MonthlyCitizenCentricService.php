        ...
        <div class="col-lg-10 panel panel-default panel-body col-lg-offset-1">
            ...
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/MisReportController/MonthlyCitizen' ?>">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('district');?> </label>
                            <div class="col-sm-4">
                                <select class="form-control subdivselect" readonly id="select" name="dist_code" required>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-lg-offset-4" style="float: none;margin-top: 20px;margin-bottom: 20px;">
                                ...
                                <button id="backButton" class="btn btn-danger"><i class='fa fa-home'></i>&nbsp;<?php echo $this->lang->line('back_to_main_menu');?></button><hr>
                                
                            </div>
                        </div>
                    </form> 
                    <button id="YearlyReport" class="btn btn-info"><i class='fa fa-area-chart'></i>&nbsp;<?php echo $this->lang->line('click_here_for_yearly_total');?></button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <script type="text/javascript">
                        ...
                        document.getElementById("YearlyReport").onclick = function () {
