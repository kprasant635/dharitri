    ...
    <div class="row">
        <div class="col-lg-10 panel panel-default panel-body col-lg-offset-1">
			<div class="well well-sm mis_report">
				<h2 class='uni_text' style="text-align: center; color: #2e4d8e"  class="bold"><?php echo $this->lang->line('tea_estate_wise_land_area');?></h2>
			</div>
			...
			<div class="panel panel-info panel-form">
			  ...
			  <div class="panel-body">
			   <form class='form-horizontal' method="post" action="<?php echo base_url().'index.php/MisReportControllerPartha/saveTeaEstateReport'?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                <select class="form-control circleselect" id="select" required name="cir_code">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                <select class="form-control mouzaselect" id="select" required name="mouza_pargona_code">
