<div class="container-fluid login form-top">
    <div class="row">
        ...
        <div class="well well-sm mis_report">
            <h2 class='uni_text' style="text-align: center; color: #2e4d8e"> <?php echo $this->lang->line('land_revenue_of_direct_paying_tea_estate');?></h2>
        </div>
        <div class="panel panel-info panel-form">
          ...
          <div class="panel-body">
           <form class='form-horizontal' method="post" action="<?php echo base_url().'index.php/MisReportController/RevenueTeaEstate'?>">
