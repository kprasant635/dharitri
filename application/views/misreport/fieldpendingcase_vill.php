<div class="container-fluid login">
    <div class="row" >
        <div class="col-sm-12" > 
            ...
            ?>
            <div class="alert alert-dismissible alert-warning text-center"><h2 class="uni_text"><?php echo $this->lang->line('lot_wise_pendency_list');?> - <?php echo $cnmae; ?>  </h2>
           ...
           <span class="label label-primary uni_text"> <?php echo $this->lang->line('district');?> : <?php echo $this->utilityclass->getDistrictName($this->session->userdata('dist_code')) ?></span>
            ...
            <span class="label label-info uni_text"><?php echo $this->lang->line('lot_no');?> : <?php echo $varadata['lot_no']; ?></span>
            <p><br></p>
