            ...
            <div class="card-body shadow-lg p-1 mb-5 bg-white rounded">                              
                <div class = "card-body">            
                    <table id="ek_co_pending_list" class="table table-hover text-center" style="width:100%">            
                        ...
                        <tbody>
                            <?php foreach ($pendingListForCoMouzadari as $row):?> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" 
                                            href="<?php echo base_url() . 'index.php/EkhajanaCoController/pendingCaseDetailsMouzadari/'.$row->id?>" role="button" style="font-size: 14px;">
                                            View Details
