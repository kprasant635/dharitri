<nav aria-label="breadcrumb">
  <ol class="breadcrumb p-3 text-white">
      ...
      <li class="breadcrumb-item font-weight-bold active" aria-current="page">E-Khajana-(Reverted-list)</li>
  </ol>
</nav>
<div class="panel panel-info panel-form mt-5">
    <div class="panel-heading bg-danger text-center">
        <h3 class="panel-title">
            <u>
                <b>E-Khajana-(Reverted-List)</b><br>
            </u>                        
        </h3>
    </div> 
            ...
            <div class="card-body shadow-lg p-1 mb-5 bg-white rounded">                              
                <div class = "card-body">            
                    <table id="ek_co_pending_list" class="table table-hover text-center" style="width:100%">            
                        ...
                        <tbody>
                            <?php foreach ($revertedList as $row):?> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" 
                                            href="<?php echo base_url() . 'index.php/EkhajanaCoController/pendingCaseDetails/'.$row->id?>" role="button" style="font-size: 14px;">
                                            View Details
