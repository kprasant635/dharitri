            ...
            <div class="col-lg-12">
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="panel panel-danger panel-form">
                        ...
                        <!-- view if any additional document uploaded by lm starts -->
                        <?php if($additional_doc != "NO-DATA-FOUND"):?>
                        <h5 class="text-center text-white" style="background-color:grey;padding:5px">ADDITIONAL DOCUMENT</h5>
                        <div class="row m-3">
                            <div class="col-lg-10">
                                <textarea class="form-control" name="lm_report" required readonly=""><?=$additional_doc->file_name?>
                                </textarea>
                            </div>
                            <div class="col-lg-2">
                                <button class="btn btn-primary btn-sm">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                    <a href="<?=base_url().'index.php/EkhajanaCoController/viewAdditionalDocument?ld_application_no='.$caseDetails->ld_application_no?>"
                                    target="_blank" style="text-decoration:none;color:white;">
                                        View Document
                                    </a>
                                </button>
                        ...
                        <?php endif ?>
                        <!-- view if any additional document uploaded by lm ends -->      
                        <table class="table table-striped table-bordered text-bold">
                            <thead>
                            <tr>
    ...
    <div id="rejectModal" class="modal" role="dialog">
        <div class="modal-dialog modal-sm modal-dialog-centered" style="max-width:50%">
            <div class="modal-content">
                ...
                <form id="rejectformEkhajana" method="post">
