            ...
            <div class="card-body shadow-lg p-1 mb-5 bg-white rounded">                              
                <div class = "card-body">            
                    <table id="ek_lm_pending_list" class="table table-hover text-center" style="width:100%">            
                        ...
                        <tbody>
                            <?php foreach ($pending_list_tn_branch as $row):?>                                    
                                <tr>                                    
                                    <td>
                                    ...
                                    <td>
                                         <a class="btn btn-info btn-sm text-white" 
                                            href="<?php echo base_url() . 'index.php/EkhajanaTn/pendingCaseDetailsTnBranch/'.$row->ld_id?>" role="button" style="font-size: 14px;">
                                            Update Arrear
