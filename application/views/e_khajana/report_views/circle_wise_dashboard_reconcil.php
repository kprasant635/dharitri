...
<div class="container mb-5 mt-5 section-box" style="width: 95%; margin: 0 auto;">
    <div class="section-title shadow-lg mb-3">
        ...
        ?>
        <h5 style="text-align:center">Mouza Wise Reconciliation Dashboard For Circle <?=$cir_name?></h5>
    </div>
    ...
    <table class="table table-bordered" style="border-color:black; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);" id="circle_wise_details">
        <thead>
