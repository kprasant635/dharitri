<nav aria-label="breadcrumb">
  <ol class="breadcrumb p-3 text-white">
      ...
      <li class="breadcrumb-item font-weight-bold active" aria-current="page">E-Khajana-(Land Class Change Request)</li>
  </ol>
</nav>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" 
                                            href="<?php echo base_url() . 'index.php/EkhajanaChangeRequestController/pendingCaseDetails/'.$row->petition_no?>" role="button" style="font-size: 14px;">
                                            View Details
