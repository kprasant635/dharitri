...
<?php $archive_doul_rates = EKHAJANA_RATES_FROM_ARCHIVE_DOULS ?>
                            ...
                            <?php foreach ($arrear_year as $year):?>    
                                ...
                                <div class="col-9 text-center p-1">
                                    ...
                                    <div class="arrear cal_row" >
                                        ...
                                        <!-- <input  type ="number" required class="form-control sec_c" placeholder="Miran" rows="3" name="miran[]" id="miran_<?=$year?>">
                                        </input> -->
...
<script>
    ...
    function get_total(){
        ...
        $('#testse').text(totalSecD);
        $('#testssi').val(totalSecA);
        $('#testsbi').val(totalSecB);
        $('#testsei').val(totalSecD);
