...
<div class="panel panel-info panel-form mt-5">
    <div class="panel-heading bg-success text-center">
        <h3 class="panel-title">
            <u>
                <b>E-Khajana-(Pre Updated Arrear List)</b><br>
            </u>                        
        </h3>
    </div> 
    <div class="tab-content">
        <div class="card-body">
            <div class="card-body shadow-lg p-1 mb-5 bg-white rounded">                              
                <div class = "card-body">            
                    <table id="ek_ast_arrear_updated_list" class="table table-hover text-center" style="width:100%">            
                        ...
                        <tbody>
                            <?php foreach ($all_pre_arrear_list as $row):?> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <a class="btn btn-secondary btn-sm text-white" 
                                            href="<?php echo base_url() . 'index.php/EkhajanaAstController/viewYearWiseArrear/'.$row->id?>" role="button" style="font-size: 14px;">
                                            View Year Wise Arrear
...
<script>
    $('#ek_ast_arrear_updated_list').dataTable({
        "scrollX": true,
