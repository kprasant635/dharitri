        ...
        <div class="panel casedisplay_new shadow-lg p-3 mb-5">                        
                    ...
                    <div class="" style="background-color:#907E17">
                        <div class="text-center text-white">
                            <h5><i class="fa fa-money" aria-hidden="true"></i>
                                Revenue Collected on Month: <span style="color:yellow">'<?=$date?>'</span> in the Circle: <span style="color:yellow"><?=$this->utilityclass->getCircleName($dist_code, $subdiv_code,$cir_code)?></span>
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-striped table-hover" >
                <tr>
                    ...
                    <td><strong>₹ <?=json_decode($monthly_amount)?></strong></td>
                </tr>
                <tr>
                    <td>Circle:</td>
