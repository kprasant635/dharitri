            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    <tr class="bg-info" style="background: #17a2b8 !important;">
                        <td colspan="3">E-Khajana-(ADC-Khajana-Approve)</td>
                    </tr>
                    <tr>
                        <td>Pending-List</td>
                        <td>
                        ...
                        <td>
                            <a href="<?php echo base_url() . 'index.php/EkhajanaAdc/pendingList' ?>" class="green" style="float:right"><?php echo $this->lang->line('go') ?>
                        </td>
                    </tr>   
                </table>
            </div>
