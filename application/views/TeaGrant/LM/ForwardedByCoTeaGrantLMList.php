...
<div class="col-lg-12 ">
    <div class="well well-sm mis_report">
        <h4 style="text-align: center;">
            Forward Case(s) to Circle Officer
        </h4>
    </div>
</div>
<div class="col-lg-12 ">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(DISABLE_ALL_BUTTON == 0) { ?>
                                ...
                                <a type="button" href="<?=base_url()."index.php/TeaGrantControllerLm/lmFirstProceeding?app=" . $this->utilityclass->encryptJwtCase($case->applid); ?>" class='lmreportpart btn-sm btn btn-primary' id='myModal'><i class="fa fa-envelope-open" aria-hidden="true"></i> <?php echo $this->lang->line('submit_report'); ?></a>
