                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(DISABLE_ALL_BUTTON == 0) { ?>
                                <a type="button" href="<?php echo base_url() . "index.php/TeaGrantControllerLm/secondProceeding?app=" . $this->utilityclass->encryptJwtCase($case->case_no); ?>" class='lmreportpart btn-sm btn btn-primary' id='myModal'><i class="fa fa-envelope-open" aria-hidden="true"></i> <?php echo $this->lang->line('submit_report'); ?></a>
                            <?php } ?>
