...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllGeneratedNoticeTeaGrantAdcCaseList">List of Generated Notice</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - All Notice Generated Cases</span>
                <hr>
                <button class="btn btn-sm btn-danger"></button> - <span style="font-size: 13px;">Enter Hearing Remarks</span> |
                ...
                <button class="btn btn-sm btn-default"></button> - <span style="font-size: 13px;">Forward to DC</span> |
                <button class="btn btn-sm btn-info"></button> - <span style="font-size: 13px;">Re Generate General Notice</span>
            </div>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerAdc/noticeGeneratePaginationAPI',
            type:'POST',
            data: {
  ...
  function forward_to_dc(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerAdc/loadViewForForwardedToDc',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
  ...
  function revert_to_co_btn(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerAdc/loadViewForRevertToCoRemarks',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
  ...
  function regenerate_pn_btn_tea_grant(case_no)
  {
    // alert("sdfghj");
    $.blockUI({
       message: $('#displayBox'),
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerAdc/loadViewForReGenerationOfGN',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) { 
         $.unblockUI();
