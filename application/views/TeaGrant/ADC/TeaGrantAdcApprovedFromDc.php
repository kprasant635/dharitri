...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllApprovedCaseFromDcList">Approved case(s) from DC / Generate Payment Notice</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - All Approved Cases from DC</span>
                <hr>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerAdc/allApprovedCaseListFromDc',
            type:'POST',
            data: {
  ...
  function gen_payment_notice_btn_tea_grant(case_no)
  {
    // alert("sdfghj");
    $.blockUI({
       message: $('#displayBox'),
