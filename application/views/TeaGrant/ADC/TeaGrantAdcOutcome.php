...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllTeaGrantPendingListAtAdc">Verify Outcome of the Case(s)</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                ...
                <hr>
                <span>Verify Outcome of the Case(s)</span>
            </div>
            ...
            <div class="reza-body">
                ...
                <?php else : ?>
                    <table class='table table-striped tablesorter  pageshowpage unicode datatable' id='datatable' width="100%">
                    <!-- <table class="datatable table table-stripped table-responsive" id='datatable'> -->
                        <thead>
...
<script>
    ...
    function load_data(){
        ...
        var table = $('#datatable').DataTable({
            ...
            'ajax':{
                url: base_url+'index.php/TeaGrantControllerAdc/displayListOfCasesPendingAtAdc',
                type:'POST',
                data: {
