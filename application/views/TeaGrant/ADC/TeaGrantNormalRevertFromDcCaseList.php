...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllDcRevertedTeaGrantAdcCaseList">Reverted case(s) from DC</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - Reverted case(s) from DC</span>
                <hr>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerAdc/adcNormalRevertedPendingList',
            type:'POST',
            data: {
