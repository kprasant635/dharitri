...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllTeaGrantFirstProceedingDcCaseList">Verify Outcome of the Case(s)</a> >
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        ...
                        <div class="reza-card ">
                            <div class="reza-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12"  style="margin: 40px">
                                            <?php 
                                              if(CASE_DESCRIPTION_BUTTON == 1) { 
                                                include(APPPATH."views/TeaGrant/common/TeaGrantIsMutated.php");
                                              }
                                            ?>
                                        </div>
                                    </div>
                ...
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Hearing Date&nbsp;<span class="text-red">*</span></label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Remarks&nbsp;<span class="text-red">*</span></label>
                            <textarea class="form-control" name="adc_hearing_remarks" id="adc_hearing_remarks" rows="4" required minlength="2" required placeholder="Please enter remarks"></textarea>
                        </div>
...
<script>
    ...
    $(document).on('click','#revertFromDcToCoModalYes',function ()
    {
        ...
        if(remarks != '')
        {
            ...
            $.ajax({
                url: BASE_URL + "/TeaGrantControllerAdc/applicationRevertFromDCToCO",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
                    ...
                    else if (data.responseType == 2)
                    {
                        Swal.fire({
                            ...
                            text              : "Application has successfully reverted to CO",
    ...
    {
        if(!$("input[name='is_mutated']").is(':checked')) {
           showWarningMessage('Please check the radio button of : Is/Are the applicant(s) of this application already mutated ?');
           return;
        }
    ...
    $(document).on('click','#updateModalYes',function ()
    {
        ...
        var adc_hearing_remarks = $("#adc_hearing_remarks").val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                else if (data.responseType == 2)
                {
                    ...
                    window.location.href = BASE_URL + "/TeaGrantControllerAdc/viewAllTeaGrantFirstProceedingDcCaseList";
