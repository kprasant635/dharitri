...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllPaymentPendingCases">Payment Pending By Applicants</a>
        ...
        <div class="reza-card col-lg-12">
            ...
            <div class="reza-title" style="font-style: italic;">
                ...
                <button class="btn btn-sm btn-primary"></button> - <span style="font-size: 13px;">View Payment Notice</span> |
                <button class="btn btn-sm btn-danger"></button> - <span style="font-size: 13px;">Write Report</span>
            </div>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerAdc/paymentPendingByAdcCaseList',
            type:'POST',
            data: {
