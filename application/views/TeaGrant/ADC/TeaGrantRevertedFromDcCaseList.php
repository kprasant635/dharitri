...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerAdc/viewAllDcRevertedTeaGrantAdcCaseList">Reverted case(s) from DC through Department</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - Reverted case(s) from DC through Department</span>
                <hr>
                ...
                <button class="btn btn-sm btn-warning"></button> - <span style="font-size: 13px;">Revert to CO</span>
            </div>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerAdc/adcRevertedPendingList',
            type:'POST',
            data: {
  ...
  function adc_revert_to_co(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerAdc/loadViewForCoRevert',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
