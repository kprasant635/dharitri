    ...
    <div class="modal-dialog" role="document" style="max-width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveAdcRevertRemark">Save & Revert to CO</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $('#saveAdcRevertRemark').on('click', function()
    {
      ...
      Swal.fire({
        ...
        text              : 'Are you sure, you want to revert the case to CO ?',
        showCancelButton  : true,
        ...
        if (result.isConfirmed) 
        {
          ...
          $.ajax({
            url         : baseurl+'TeaGrantControllerAdc/revertToCoFromAdc',
            type        : "POST",
            dataType    : "json",
