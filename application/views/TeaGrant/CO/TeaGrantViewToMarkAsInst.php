    ...
    <div class="row">
        ...
        <section>
            ...
            <div class="col-md-12 text-right text-cyan">
                ...
                <a href="<?=base_url().'index.php/TeaGrantControllerCo/markedAsInstitute'?>">Mark the case(s) submitted under Institute</a> >
                <b>Write Report</b>
            </div><br>
            ...
            <div class="wizard">
                ...
                <form role="form" class="lmForm" method="post" action="<?php echo base_url() ?>index.php/TeaGrantControllerCo/markApplicationRegistrationAsInst?app=<?=$_GET['app']?>>" enctype="multipart/form-data">  
                ...
                <div class="tab-content">
                    ...
                    Check errors
                        ...
                        <ul class="list-inline pull-right" style="margin-top: 20px">
                            <li>
                                <input type="submit" 
                                    value="Mark as Institute" class="btn btn-primary btnMarkAsInst" id="btnMarkAsInst">
                            </li>
                        </ul>
                    </div>
                </form>
...
<script>
    ...
    $('#btnMarkAsInst').on('click',function(e){
        ...
        swalWithBootstrapButtons.fire({
            title             : 'Are you sure, you want to mark this case as Institute ?',
            icon              : 'warning',
            showCancelButton  : true,
