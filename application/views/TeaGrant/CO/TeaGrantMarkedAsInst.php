<div class="col-md-12 text-right text-cyan">
    ...
    <b>Mark the case(s) submitted under Institute</b>
</div><br>
<div class="col-lg-12 ">
  <div class="well well-sm mis_report">
    <h4 style="text-align: center;">List of case(s) to be marked as Institute </h4>
  </div>
  ...
  <div class="row">
    <table id="datatable" class="datatable table table-stripped">  
      <thead>  
        <tr>  
          <th>All <br>
            <input  type="checkbox" class="checkBoxD " value="all" id="checkedAll"></th>
...
<script>
  ...
  $(document).ready(function ()
  {
    ...
    load_data();
    function load_data(is_category = null, mouza_cat=null, lot_cat=null, nr_cat=null, payment_status=null, final_verification_report=null)
    {
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/TeaGrantControllerCo/listOfToBeMarkedAsInstitute',
          type:'POST',
          data: {
