    ...
    $(document).ready(function ()
    {
        ...
        function load_data(is_category = null, remark_cat = null, mouza_cat=null, lot_cat=null)
        {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax':{
                    url: base_url+'index.php/TeaGrantControllerCo/paginationForReGeoTagTeaGrant',
                    type:'POST',
                    data: {
...
<script type="text/javascript">
  ...
  function showErrorMessage(text) {
    ...
    function reGeotagTeaGrant(case_no,applid) {
    var base_url = "<?php echo base_url();?>";
    ...
    $.ajax({
          url: base_url +'index.php/TeaGrantControllerCo/checkWhetherGeoTagorNot',
          type: "post",
          dataType: "json",
          data : {
            case_no : case_no,
