        ...
        <div class="panel casedisplay">
            ...
            <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                    <tr>
                      <td>First Proceeding | Forward Simultaneously to LRA/SRO</td>    
                      <td>
                        <?php if($service_code == TEA_SERVICE_CODE) { ?>
                          <span class="badge badge-danger"></span>
                        <?php } ?>
                      </td>                            
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/initialLanding?service='.TEA_SERVICE_CODE.'&s=i'; ?>" style="float:right">VIEW</a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/FirstProceeding?service='.$service_code.'&s='.MB_PENDING; ?>" style="float:right">VIEW</a>
                      </td>
                    </tr>

                    <tr>
                      <td>Reverted By ADC</td>    
                      <td>
                        <?php if($service_code == TEA_SERVICE_CODE) { ?>
                          <span class="badge badge-danger"><?=$reverted_to_co_from_dc?></span>
                        <?php } ?>
                      </td>                      
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/revertedCasesFromDc?service='.$service_code.'&s='.MB_REVERT; ?>" style="float:right">view</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/coReSubmitLmCases?service='.$service_code.'&s='.MB_RE_REPORT; ?>" style="float:right">view</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if($service_code == TEA_SERVICE_CODE) { ?>
                          <span class="badge badge-danger"><?=$pending_for_chitha_update?></span>
                        <?php } ?>
                      </td>                      
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/chithaUpdatePending'; ?>" style="float:right">view</a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td></td>                      
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/reGeoTagCaseList'; ?>" style="float:right">view</a>
                      </td>
                    </tr>

                    <tr>
                      <td>Mark the case(s) submitted under Institute</td>    
                      <td><span class="badge badge-danger"><?=$transfer_tgtpp_to_inst?></span></td>                      
                      <td>
                        <a href="<?php echo base_url() . 'index.php/TeaGrantControllerCo/markedAsInstitute'; ?>" style="float:right">view</a>
                      </td>
                    </tr>
