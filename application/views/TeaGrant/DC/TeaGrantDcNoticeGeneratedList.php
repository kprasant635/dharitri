...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerDc/viewAllGeneratedNoticeTeaGrantDcCaseList">Report From ADC (Notice Generated)</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - Report From ADC (Notice Generated)</span>
                <hr>

                <button class="btn btn-sm btn-success"></button> - <span style="font-size: 13px;">View Application</span> |
                <button class="btn btn-sm btn-primary"></button> - <span style="font-size: 13px;">View General Notice</span> |
                <button class="btn btn-sm btn-default"></button> - <span style="font-size: 13px;">Forward to Dept</span> |
                <button class="btn btn-sm btn-warning"></button> - <span style="font-size: 13px;">Revert to ADC</span>
            </div>
            ...
            <div class="reza-body">
                ...
                <!-- <button class="btn btn-sm btn-danger" id="bulkDeptForward">Bulk Forward to Department</button> -->
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerDc/noticeGeneratePaginationAPI',
            type:'POST',
            data: {
  ...
  function dcHearing_btn(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForHearingRemarks',
       type: "POST",
  ...
  function forward_to_dept(case_no)
  {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForDeptForward',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) 
      {
        ...
        if (selectedList.length > 0) {
          ...
          $.ajax({
            url         : BASE_URL + "/TeaGrantControllerDc/forwardToDepartmentBulk",
            type        : "post",
            dataType    : "json",
            contentType : "application/json",
            success: function (data) {
  ...
  function gen_payment_notice_btn(case_no)
  {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForPaymentGeneration',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
  ...
  function dc_revert_to_adc(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForAdcRevert',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
  ...
  function forward_to_adc(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForAdcAprroveForward',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
