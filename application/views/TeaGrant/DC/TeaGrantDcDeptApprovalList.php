...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerDc/viewAllDeptApprovalTeaGrantDcCaseList">Department Approval List</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - Department Approval List</span>
                <hr>
                ...
                <button class="btn btn-sm btn-danger"></button> - <span style="font-size: 13px;">View Payment Notice</span> |
                <button class="btn btn-sm btn-warning"></button> - <span style="font-size: 13px;">Approve & Forward to ADC</span>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerDc/listOfDeptApprovedCases',
            type:'POST',
            data: {
