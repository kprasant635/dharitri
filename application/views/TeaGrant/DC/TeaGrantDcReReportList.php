...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerDc/viewAllReReportTeaGrantDcCaseList">Re-Report From ADC</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - Re-Report From ADC</span>
                <hr>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerDc/reReportPaginationAPI',
            type:'POST',
            data: {
