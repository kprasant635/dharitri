...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
            ...
            <a href="<?= base_url()?>index.php/TeaGrantControllerDc/viewAllDeptApprovalTeaGrantDcCaseList">Reverted cases from Department</a>
        ...
        <div class="reza-card col-lg-12">
            <div class="reza-title" style="font-style: italic;">
                <span>Limited Conversion of Tea Grant Land to Periodic Patta - All Department Approved Case(s)</span>
                <hr>
...
<script>
  ...
  function load_data(){
      ...
      var table = $('#datatable').DataTable({
        ...
        'ajax':{
            url: base_url+'index.php/TeaGrantControllerDc/deptRevertedPendingList',
            type:'POST',
            data: {
  ...
  function dc_forward_to_dept(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
  ...
  function dc_revert_to_co(case_no)
  {
    $.blockUI({
       message: $('#displayBox'),
       css: {
    ...
    $.ajax({
       url: baseurl+'TeaGrantControllerDc/loadViewForCoRevert',
       type: "POST",
       data: { case_no: case_no },
       success: function(data) {           
         $.unblockUI();
