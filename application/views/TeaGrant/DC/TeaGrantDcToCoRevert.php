    ...
    <div class="modal-dialog" role="document" style="max-width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveDcRevertRemark">Save & Revert to CO</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $('#saveDcRevertRemark').on('click', function()
    {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) 
        {
          ...
          $.ajax({
            url         : baseurl+'TeaGrantControllerDc/revertToCoByDC',
            type        : "POST",
            dataType    : "json",
