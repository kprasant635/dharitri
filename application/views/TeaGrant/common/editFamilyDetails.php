  ...
  <div class="modal-content">
    ...
    <p>
        ...
        <div class="row justify-content-center">
            <button type="button" onclick="addFamilyDetailsTeaGrant();" class="btn btn-sm btn-danger col-3">Add</button>
        </div>
    </p>
  </div>
...
<script src="<?php echo base_url();?>js/mb3/editFamilyDetailsTeaGrant.js"></script>
