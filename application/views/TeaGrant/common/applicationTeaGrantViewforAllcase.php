                ...
                <?php $sl_count =1; $i = 1;foreach ($lmnotes as $lmnote): 
                    if($validation_bypass == 0):
                      ...
                      $lm_tea_report = json_decode($lmnotes[0]->lm_tea_report);
                        ...
                        <div class="row p-2">
                            <div class="col-md-6 text-justify">
                                <span><strong><?=$sl_count++?>.</strong> Present Land use type?</span>
                            </div>
                            <div class="col-md-6">
                                <select name="land_falls" id="land_falls" class="form-control" required disabled>
                                    <option value="">উদ্যোগ - I</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            name="landslide"
                                            id="landslide"
                                            value="YES" disabled checked <?php if ($lmnote->landslide == YES) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            value="YES" disabled checked <?php //if ($lmnote->land_falls_periphery == YES) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            name="land_falls_periphery"
                                            id="land_falls_periphery"
                                            value="NO" disabled <?php //if ($lmnote->land_falls_periphery == NO) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            value="YES" disabled <?php //if ($lmnote->roadside_comment_check == YES) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            name="roadside_comment_check"
                                            id="roadside_comment_check"
                                            value="NO" disabled checked <?php //if ($lmnote->roadside_comment_check == NO) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                </div>
                            </div>
                        ...
                        <div class="row p-2" >
                            ...
                            <div class="col-md-2">
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            value="YES" disabled checked<?php //if ($lmnote->dispute_possession == YES) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input
                                            ...
                                            name="dispute_possession"
                                            id="dispute_possession"
                                            value="NO" disabled  <?php //if ($lmnote->dispute_possession == NO) {echo "checked";}?>
                                    />
                                    <label class="form-check-label" for="inlineRadio2">No</label>
                                </div>
                            </div>
                            <div class="col-md-4 div_category_type">
                                ...
                                value="<?=$lm_tea_report->dis_cat_type?>"
                                />                            
                            </div>
                        </div>
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-6">
                        <input name="lm_possession_entry" readonly class="form-control" id="lm_possession_entry" value="27-12-2024<?php //foreach(json_decode(LM_NOTE) as $lm_remark_cat){ if($lm_remark_cat->CODE == $lmnote->lm_note){ echo $lm_remark_cat->NAME;}}?>" cols="30" rows="2">
                        </div>
                    </div>
