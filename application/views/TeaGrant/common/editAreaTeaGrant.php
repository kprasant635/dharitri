  ...
  <div class="modal-content">
    ...
    <p>
        ...
        <div class="row justify-content-center">
            <button type="button" onclick="updateTeaGrantArea();" class="btn btn-sm btn-danger col-3">UPDATE</button>
        </div>
    </p>
  </div>
</div>

<script src="<?php echo base_url();?>js/mb3/teaGrant/editAreaTeaGrant.js"></script>
