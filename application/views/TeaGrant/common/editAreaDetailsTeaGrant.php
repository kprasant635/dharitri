...
<div id="editAreaDetailsTea" class="modal">
  <!-- Modal content -->
    ...
    <p>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <input type="hidden" id="area_service_code">
                <tr>
        ...
        <div class="row justify-content-center">
            <button onclick="updateAreaDetailsTeaGrant();" class="btn btn-sm btn-danger col-3">UPDATE</button>
        </div>
    </p>
  </div>
