                    ...
                    <div class="panel casedisplay">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    <td>Reverted by CO</td>
                                    <td><?php
                                        if ($reverted_case != '0') {
                                            echo "<span class=\"badge badge-primary\">$reverted_case</span>";
                                        }
                                        ?>
                                    </td>
                                    <td><a href="<?php echo base_url(); ?>index.php/partition/getRevertedOfcPartitionCases" class="green" style="float:right"><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
