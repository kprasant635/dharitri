...
?>
<?php if(ESCALATION_MODAL_OPEN == 1){ include 'escalation_adc.php'; }?>
<?=GLOBAL_CASE_SEARCH?>
                ...
                <div class="col-lg-4">
                    <div class="card bg-info text-white">
                        <div class="card-body text-white">
                            <h5 class="card-title"><img src="<?php echo base_url('assets/recieved.png');?>" style="height:22px;width:22px;" alt="New Applications"> New Applications received today</h5>
                        </div>
