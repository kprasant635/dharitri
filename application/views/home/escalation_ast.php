<div class="modal escalation_ast" id="escalation_ast" data-keyboard="false" data-backdrop="static" role="dialog">
...
<script type="text/javascript">
  ...
  {
      $('#escalation_ast').modal({
        backdrop: 'static',
        keyboard: false
      });
      $("#escalation_ast").modal("show"); 
  });
  $('#modal-close').click(function(){
    $('#escalation_ast').modal('hide');
  });
</script>
