                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>index.php/dc_adc_conversion/GoToDC_ADC?pro=4" class='green' style='float:right'><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>index.php/dc_adc_conversion/GoToDC_ADC?pro=2" class='green' style='float:right'><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                                <tr>
                                    <td>Conversion ( Cases Pending at Department )</td>
                                    <td>
                                        <?php
                                        if ($dpt_proceeding_for_adc != '0') {
                                            echo "<span class=\"badge badge-primary\">$dpt_proceeding_for_adc</span>";
                                        }
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($dpt_app_proceeding_for_adc != '0') {
                                            echo "<span class=\"badge badge-primary\">$dpt_app_proceeding_for_adc</span>";
                                        }
                                        ?>
                                    </td>
