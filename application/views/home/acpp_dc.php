                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
                                ...
                                <?php if(ESCALATION_ENABLE == 0) { ?>
                                    <tr>
                                        <td>Pending Case(s) for escalation 
                                        </td>
                                        <td>
                                            <span class="badge badge-primary">
                                                <?=($allote_dc_esc == '0')? 0 : $allote_dc_esc ?>
                                            </span>
                                        </td>
                                        <td><a href="<?php echo base_url(); ?>index.php/Allotment/withoutBOdcFinalOrder" class='green' style='float:right'><?php echo $this->lang->line('view') ?></a></td>
                                    </tr>
                                <?php } ?>
