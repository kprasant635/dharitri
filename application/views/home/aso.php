    ...
    <div class="row">
        ...
        <div class="col-lg-12 ">
            <table class='table' style="color:blue;">
                <tr>
                    <td><label class="regular"><i class="fa fa-tachometer"></i> সহকাৰী বন্দবস্তী প্ৰাধিকৰী DASHBOARD</label></td>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a class="pull-right green " href="<?php echo base_url() . 'index.php/coofficemutation/ActionTakenRpt'; ?>"><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                                <tr class="">
                                    <td colspan="3">&nbsp;</td>
                                </tr>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
                                ...
                                <tr class="hide">
                                    <td><?php echo $this->lang->line('co_generate_proceeding') ?></td>
                                    <td></td>
                                    <td><a href="#"><?php echo $this->lang->line('view') ?></a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
