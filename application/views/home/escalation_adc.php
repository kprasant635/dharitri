<div class="modal escalation_adc" id="escalation_adc" data-keyboard="false" data-backdrop="static" role="dialog">
...
<script type="text/javascript">
  ...
  {
      $('#escalation_adc').modal({
        backdrop: 'static',
        keyboard: false
      });
      $("#escalation_adc").modal("show"); 
  });
  $('#modal-close').click(function(){
    $('#escalation_adc').modal('hide');
  });
</script>
