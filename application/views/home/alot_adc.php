                    ...
                    <div class="panel casedisplay">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover">
								...
								<tr>
								<td>Reverted By CO for Correction <sup class="red">New</sup></td>
								<td><?php
									if ($reverted_by_co != '0') {
										echo "<span class=\"badge badge-primary\">$reverted_by_co</span>";
									}
									?></td>
								<td><a href="<?php echo base_url(); ?>index.php/Allotment/getPendingCORevertCases" class="green" style="float:right"><?php echo $this->lang->line('view') ?></a></td>
							</tr>
