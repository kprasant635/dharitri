        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-12 panel panel-default panel-body ">
                <div class="well well-sm mis_report">
                    <h2 class='uni_text' style="text-align: center; color: #2e4d8e">Backlog Entry for Office Partition</h2>
                </div>
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method='post' action="<?php echo base_url() . "index.php/Backlogpartition/index"; ?>">
