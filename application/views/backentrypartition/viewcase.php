                    ...
                    <div class='row'>
                        ...
                        <div class='col-lg-10 col-lg-offset-1'>
                            ...
                            <table class='table uni_text table_black'>
                                ...
                                <tr>
                                    <td rowspan='2'>Old Dag No. :  <?php echo  $col8occ[0]->old_dag_no; ?>
                                        <br>
                                        Old Patta No : <?php echo  $col8occ[0]->old_patta_no; ?>
                                        <br>
                                    ...
                                    <td>
                                        New Dag Land Area : <?php echo  $col8->mut_land_area_b ?> B-<?= $col8->mut_land_area_k ?> K-<?= $col8->mut_land_area_lc ?> L <br>
                                        Old Dag Land Area : <kbd><?= $col8->land_area_left_b ?> B-<?= $col8->land_area_left_k ?> K-<?= $col8->land_area_left_lc ?> L </kbd>
                                    </td>
                                </tr>	
                            </table>
                            ...
                            <table class='table uni_text table_black'>
                                ...
                                foreach ($col8occ as $fp):
                                    ...
                                    <td>Gurdian Name <i class='fa fa-user-plus'>: <?php echo  $fp->occupant_fmh_name ?></td>
                                    <td colspan=2>Relation <i class='fa fa-retweet'>: <?php echo  $this->utilityclass->get_relation($fp->occupant_fmh_flag) ?></td>
                                    </thead>
