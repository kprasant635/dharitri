...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/views/css/dataTables.bootstrap.min.css">
...
<script src="<?php echo base_url(); ?>application/views/js/dataTables.bootstrap.min.js"></script>
<script>
