    ...
    <div class="row">
        ...
        <div class="panel panel-info panel-form">
            ...
            <div class="panel-body">
                <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/LmEntryChitha/addnonAgriinfo' ?>">
                            ...
                            <div class="form-group">
                                ...
                                <td width="50%">
                                    <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('non_agricultural_use_id')?>:</label>  
                                      <input type="text" name="noncrop_slno" value="<?php echo $noncropslno['noncrop_id'] ?>">
                                </td>
                                ...
                                <td width="50%">
                                    ...
                                    <input type="text" name="yearno" id="yy" maxlength="4" value="" onfocus="this.value='';"  required><font color=red>*</font>
                                </td>
                                ...
                                <tr>
                                 <td width="50%">
                                       <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('type_of_usages')?></label><font color=red>*</font>
                                <div class="col-sm-4">
                                 
                                    <select class="form-control cropnameselect" id="select" name="typofusagesname" required>
                                         <option disabled selected><?php echo $this->lang->line('select')?></option>
<?php foreach ($typofusages as $usetyp): ?>
    <?php
    $noncroptypUsagescd = $usetyp->used_noncrop_type_code;
   $typusages = $usetyp->noncrop_type;
  
    ?>
                                            <option value="<?php echo $noncroptypUsagescd; ?>"><?php echo $typusages; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
