    ...
    <div class="row">
        ...
        <div class="panel panel-info panel-form">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo $this->lang->line('enter_a_new_line')?>(column 30)</h2>
            ...
            <div class="panel-body">
                <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/LmEntryChitha/addlmnote' ?>">
                        ...
                        <div> 
                            ...
                            <div class="form-group">
                                ...
                                <td width="50%">
                                    ...
                                    <input type="text" name="lmNOtecron" readonly="true" value="<?php echo   $newnote['lmNotecronnum'] ?>">
                                </td>
                                ...
                                <td width="50%">
                                    <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('lm_note_line_no')?>:</label>  
                                      <input type="text" name="lmNotelinenum" readonly="true" value="<?php echo $newnote['lmNotelinenum'] ?>">
                                </td>
                                ...
                                <td width="50%">
                                    <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('remark_type_hist_no')?>:</label>  
                                      <input type="text" name="lmNotehistnum" readonly="true" value="<?php echo $newnote['lmNotehistnum'] ?>">
                                </td>
                                ...
                                <td width="50%">
                                    ...
                                    <textarea type="text" cols="40" rows="4"   name="lmNOte" value="" required></textarea>
                                </td>
                                ...
                                <td width="20%">
                                               ...
                                               <label for="inputEmail3" class="col-sm-4 control-label">Wet Land:</label>  
 <div>
  
     <input type="radio" name="w" value="y" > yes
<input type="radio" name="w" value="n" checked> no
 </div>
                                ...
                                <td width="50%">
                                    <label for="inputEmail3" class="col-sm-4 control-label"><?php echo $this->lang->line('note_date_(dd/mm/yyyy)')?>:</label>  
                                      <input type="text" id="popupDatepicker" name="lmNOteDate" value="" required>
                                </td>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control placeselect" id="select" name="lmname" required>
                                    <option disabled selected><?php echo $this->lang->line('select')?></option>
<?php foreach ($lm_nme as $lname): ?>
    <?php
    $lcd = $lname->lm_code;
   $lnme = $lname->lm_name;
  
    ?>
                                            <option value="<?php echo $lcd; ?>"><?php echo $lnme; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
...
<input type="radio" name="f" value="n" checked="checked"> no
        ...
        <div class="col-sm-4" style="float: none;margin-top: 20px;margin-bottom: 20px;">
         ...
         <div class="form-group" align="center">
          <div class="col-sm-8" style="float: none;margin-top: 20px;margin-bottom: 20px;">
