    ...
    <div class="row">
        ...
        <div class="panel panel-info panel-form">
            ...
            <div class="panel-body">
                <form class='form-horizontal' method="post" action="<?php echo base_url() . 'index.php/LmEntryChitha/wantToenterEncrodetails' ?>">
                        ...
                        <div> 
                              <table class="table table-bordered" align="center" width="50%" >
                                ...
                                <td width="50%">
                                    ...
                                    <input type="text" name="histnumbr" readonly="true" value="<?php echo $Histslno['histno_id']  ?>" required>
                                </td>
...
<?php //foreach ($rmktype as $rmktyp): ?>
   ...
   // $type_code = $rmktyp->type_code;
    ...
    ?>
                                            <option value="04">বেদখলকাৰীৰ টোকা</option>
                                        <?php //endforeach; ?>
                                    </select>
        ...
        <div class="col-sm-4" style="float: none;margin-top: 20px;margin-bottom: 20px;">
            <button type="submit" id="submit" name="show" class="btn btn-primary">&nbsp;<?php echo $this->lang->line('submit_button')?></button>
                    ...
                    <div class="form-group" align="center">
        <div class="col-sm-4" style="float: none;margin-top: 20px;margin-bottom: 20px;">
                  <button id="end" type="submit" name="end" id="end" class="btn btn-primary">&nbsp;<?php echo $this->lang->line('end')?></button>
