...
<div class="row"> <!--Second Row Start-->
  ...
  <div class="col-lg-3">
    ...
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingDistrict" class="test text-decoration-none  text-decoration-none "> 
    <div class="card">
            <div class="card-body">
  ...
  <div class="col-lg-3">
    ...
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingPartDistrict" class="test text-decoration-none  text-decoration-none "> 
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Partition</p>
              </div>
        <div class="card-footer">
  ...
  <div class="col-lg-3">
    ...
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingConvDistrict" class="test text-decoration-none  text-decoration-none "> 
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Conversion</p>
              </div>
        <div class="card-footer">
  ...
  <div class="col-lg-3">
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingReclassDistrict" class="test text-decoration-none  text-decoration-none "> 
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Reclassification</p>
              </div>
        <div class="card-footer">
    ...
    <div class="col-lg-3">
      <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingCitizenDistrict" class="test text-decoration-none  text-decoration-none ">
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Citizen Certificate</p>
              </div>
        <div class="card-footer">
   ...
   <div class="col-lg-3">
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingApcancelDistrict" class="test text-decoration-none  text-decoration-none ">
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">AP Cancellation</p>
              </div>
        <div class="card-footer">
...
<div class="col-lg-3">
  <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingAcPpDistrict" class="test text-decoration-none  text-decoration-none ">
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">AC to PP</p>
              </div>
        <div class="card-footer">
   ...
   <div class="col-lg-3">
     <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingSettleDistrict" class="test text-decoration-none  text-decoration-none ">
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Settlement</p>
              </div>
        <div class="card-footer">
   ...
   <div class="col-lg-3">
    <a href="<?php echo base_url(); ?>index.php/DashboardController/pendingMiscDistrict" class="test text-decoration-none  text-decoration-none ">
    <div class="card">
            <div class="card-body">
        <p title="Click here for a detailed view" class="card-title font-weight-bold font-weight-bold">Misc Case</p>
              </div>
        <div class="card-footer">
