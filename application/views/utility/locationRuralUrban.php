<div class="col-lg-8 col-lg-offset-2">
            <div class="well well-sm mis_report">
                <h3 style="text-align: center; font-size: 28px">Updation of Village Status (Rural/Urban)</h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url() . 'index.php/utilityController/urbanRuralUpdate' ?>">
                        ...
                        <div class="form-group">
                            <div class="col-lg-8 col-lg-offset-3">
                                <button type="submit" name="submit" class="btn btn-success" ><i class='fa fa-check'></i>&nbsp;<?php echo $this->lang->line('submit_button'); ?></button>
