        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Quick Delete a Case No for Field Mutation(Order not Passed by CO)</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <table id="example" class="table table-bordered"  width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($fmute as $f):
                                    ...
                                    ?>
                                    <tr>
                                        <td align='center'><a onClick="return ConfDel()" href="<?php echo base_url(); ?>index.php/Utility/DeleteCaseFM?CaseNo=<?php echo $f->case_no."&mouza_pargona_code=".$f->mouza_pargona_code."&lot_no=".$f->lot_no."&village=".$f->vill_townprt_code; ?>" title="Delete record"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true" style='color: red;'></span></a></td>
                                        <td><a onClick="return ConfDel()" href="<?php echo base_url(); ?>index.php/Utility/DeleteCaseFM?CaseNo=<?php echo $f->case_no."&mouza_pargona_code=".$f->mouza_pargona_code."&lot_no=".$f->lot_no."&village=".$f->vill_townprt_code; ?>"><font style="color:red;"><?php echo $f->case_no; ?></font></a></td>
