    ...
    <div class="col-lg-10 col-lg-offset-1">
        <div class="col-lg-10 col-lg-offset-1">
            <div class="well well-sm ">
                <h3 style="text-align: center; font-size: 28px">Generate list of DAGS of Govt. Land</h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url()."index.php/Utility/selectGovtLand";?>">
