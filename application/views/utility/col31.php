            ...
            if (($r['remark_type_code'] == '01') && ($r['ord_type_code'] == '04')):
                ...
                if ($howmany != null) {
                    ...
                    ?>
                        ...
                        <?php endif; ?>
                    <p><u class="text-danger">ভূমিলেখ্য সহায়ক :-</u>(<?php echo $r['lm_name']; ?>)</p>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>index.php/utility/DeleteCol31Order?orderno=<?php //echo $col31order_cron_no; ?>" onClick="return confirmDelete();" class="btn btn-sm btn-danger btn-block"><font size=2><b>Click to Delete Order</b></font></a>
            </div>
        <?php endif; ?>
...
<?php
if ($chithainf['lmnotes'] != null) {
    echo "<u class='text-danger'>মণ্ডলৰ টোকা</u>";
    foreach ($chithainf['lmnotes'] as $note):
        echo"<p>" . $note->lm_note . "<hr></p>";
    endforeach;
}
?>
