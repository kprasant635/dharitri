                            ...
                            <?php $i = 0; foreach ($applications as $case):  $i++ ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/OfflineSettlementCommonController/getMyKhasApplicationDetails/?app=<?php echo $application_no; ?>">
