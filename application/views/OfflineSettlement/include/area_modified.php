                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href=""><span><i class="icon-time"></i> Homestead</span> &ndash; B: <?=$areaMod->applied_area_home_bigha?> K: <?=$areaMod->applied_area_home_katha?> L: <?=$areaMod->applied_area_home_lessa?>
