<div class="row p-2" >
    ...
    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
        <select name="is_landless" id="is_landless" class="form-control <?php if(form_error('is_landless')){echo 'lm_invalid';}?>" onchange="openSelectAddPropertyModal()">
            ...
            <option value="YES" <?= ($lmnote->is_landless == 'YES')?'selected':'' ?> class="completely_landless">Completely Landless</option>
            <option value="NO" <?= ($lmnote->is_landless == 'NO')?'selected':'' ?>>Landless as per land policy</option>
            <option value="OTHERS" <?= ($lmnote->is_landless == 'OTHERS')?'selected':'' ?>>Having Land</option>
        </select>
    </div>
    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
