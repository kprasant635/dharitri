...
<form id="lmReportForm" method="POST" action="<?php echo base_url() ?>index.php/OfflineSettlementLMController/saveOfflineSettlementLmReport" enctype="multipart/form-data">
    ...
    <div class="tableCard lm-report" style="padding-bottom: 15px">
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('chitha_verified')){echo 'lm_invalid';}?>"
                        ...
                        <?php if(set_value('chitha_verified') == 'YES'){ echo "checked";} ?>  required/>
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('vlb_verified')){echo 'lm_invalid';}?>"
                        ...
                        <?php if(set_value('vlb_verified') == 'YES'){ echo "checked";} ?>  required/>
                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('vlb_verified')){echo 'lm_invalid';}?>"
            ...
            <div class="col-md-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('bhumiputra_confirmation_lm')){echo 'lm_invalid';}?>"
                        ...
                        <?php if(set_value('bhumiputra_confirmation_lm') == 'YES'){ echo "checked";} ?> required/>
                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('bhumiputra_confirmation_lm')){echo 'lm_invalid';}?>"
                ...
                <div class="row p-2" >
                    ...
                    <div class="form-group col-md-6">
                        <select name="encroacher_exist_vlb<?=$encroacher_ext->id?>" id="encroacher_exist_vlb<?=$encroacher_ext->id?>"
                            ...
                            <?php foreach(json_decode(ENC_VARIFICATION_LIST) as $enc_exist)
                            {
                                ?>
            ...
            <div class="col-md-6">
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('possession_verification')){echo 'lm_invalid';}?>"
                        ...
                        <?php if(set_value('possession_verification') == 'YES'){ echo "checked";} ?> required/>
                    <label class="form-check-label" for="inlineRadio1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input <?php if(form_error('possession_verification')){echo 'lm_invalid';}?>"
            ...
            <div class="row p-2" >
                ...
                <div class="form-group col-md-6">
                    <select name="nature_possession<?=$nature_dag->dag_no?>"  id="nature_possession<?=$nature_dag->dag_no?>"
                            class="form-control <?php if(form_error('nature_possession'.$nature_dag->dag_no)){echo 'lm_invalid';}?>" required>
        ...
        <?php
        include(APPPATH."views/OfflineSettlement/include/add_property_modal.php");
        ?>
        ...
        <div class="row p-2" >
            ...
            <div class="col-md-6">
                <div class="form-check form-check-inline">
                    <input required type="radio" onclick="roadSideReservYes();" class="form-check-input roadside_comment_check1 <?php if(form_error('roadside_comment_check')){echo 'lm_invalid';}?>" name="roadside_comment_check" id="roadside_comment_check1" value="YES" <?php if(set_value('roadside_comment_check') == 'YES'){ echo "checked";} ?>>
                ...
                <div id="road_side_reservation_hide" class="road_side_reservation_hide">
                    <?php foreach($dags as $roadside_dags){ ?>
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-4">
                                <span class="input-group-addon"><?php if((in_array($dist_code, json_decode(BARAK_VALLEY)))): ?>  Chatak <?php else :?> Lessa <?php endif ;?></span>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <textarea name="roadside_reservation" id="roadside_reservation" class="form-control" rows="2">
                                <?php if(isset($err_return)){ echo set_value('roadside_reservation');}?>
                            </textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="row p-2" style="display: none" >
            <div class="col-md-6" >
                <span><strong></strong>
                    Whether applicant family has occupied any land in the lot?
                </span>
        ...
        <div class="row p-2" >
            ...
            <div class="col-md-6">
                ...
                foreach($dags as $dags_trace){
                    ...
                    <input type="file" accept=".png, .jpg, .jpeg, .pdf" name="trace_map_copy<?=$dags_trace->dag_no?>" id="trace_map_copy"
                           class="form-control <?php if(form_error('trace_map_copy'.$dags_trace->id)){echo 'lm_invalid';}?>" required/>
                    <br>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <input class="form-control <?php if(form_error('field_report')){echo 'lm_invalid';}?>"
                               type="file" name="field_report" id="field_report" accept=".png, .jpg, .jpeg, .pdf" required/>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-4">
        ...
        <div class="row p-2 <?php if(form_error('land_exceed')){echo 'lm_invalid';}?>">
            <div class="col-md-6">
                ...
                <strong><?=$sl_count++?>.</strong><label> LM remarks </label>
                <?=form_error('lm_note')?>
                <?=form_error('lm_remark_text')?>

            </div>
            <div class="col-md-6">
                <select required name="lm_note" id="lm_remark" class="form-control <?php if(form_error('lm_note')){echo 'lm_invalid';}?>">
                    <?php
        ...
        <div class="row p-2">
            <div class="col-md-6">
                <strong><?=$sl_count++?>.</strong><label> Premium </label>
                <?=form_error('totaldue')?>
        ...
        <div class="row p-2" id="premrow" style="display:none">
            <div class="col-md-6">
                <strong><?=$sl_count++?>.</strong><label> Premium Amount</label>
        ...
        <?php
        include(APPPATH."views/OfflineSettlement/include/add_more_document.php");
        ?>
