...
<div class="row" style='padding-top: 15px; margin-bottom: 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        View Reverted Offline Application
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px">
            <div class="reza-card">
                <div class="reza-title">
                    <span><?php echo $this->lang->line('offlineSettlementRevList') ?></span>
                    <hr>
                            ...
                            <?php $i = 0; foreach ($applications as $case):  $i++ ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/OfflineSettlementLMController/getKhasRevertedApplicationDetailsLM/?app=<?php echo $application_no; ?>">
