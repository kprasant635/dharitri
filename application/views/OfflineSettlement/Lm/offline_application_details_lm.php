...
<div class="row" style='padding-top: 15px; margin-bottom: 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left">
        ...
        <a href="<?= base_url()?>index.php/OfflineSettlementLMController/getPendingApplicationListLM" style="text-decoration: none">
            All Pending Offline Application /
        </a>
        View
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <div class="reza-card">
                            <div class="reza-body">
                                ...
                                <?php include(APPPATH."views/OfflineSettlement/include/lm_report.php"); ?>
