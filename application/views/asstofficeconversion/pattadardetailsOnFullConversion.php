        ...
        <div class="col-lg-12 ">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    ...
                    <form class='form-horizontal unicode' action="<?php echo base_url() . "index.php/AsistantMutationPartha/FinalSaveTest"; ?>"  method="post">
                        <?php
                        $i = 1;
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control col-sm-2" id="select" required name="availibility">
                                    ...
                                    <option value="নাথাকে" selected>নাথাকে</option>
                                </select>
                            </div>
