        ...
        <div class="panel " id="printdiv">
            <div class="panel-heading">
                <div class="panel-title">
                    <p class='center bold uni_text'><u>NOTICE UNDER SECTION 105 OF THE ALRM ACT 1886</u></p>
                    <p class='center bold uni_text'><u>ভূমিলেখ্য নিয়মাৱলীৰ ১০৫ ধাৰা মতে দিয়া জাননী</u></p>
                    <p class='center bold uni_text'><u>(<?php echo $location['case_no']; ?>)</u></p>
                </div>
            </div>
            <div class="panel-body form_1">
                <table class='rasid-t'>
                    <tr>
                        <td>যিহেতু <span style="color:#37BC9B"><?php echo $location['cir']; ?></span> ৰাজহ চক্রৰ, <span style="color:#37BC9B"><?php echo $location['mouza']; ?></span> মৌজাৰ, <span style="color:#37BC9B"><?php echo $location['vill']; ?></span> গাঁওৰ  নিবাসী শ্রী/শ্রীমতী <span style="color:#37BC9B"><?php 
                            ...
                            ?>
                            <?php echo $p->pdar_name."(".$p->pdar_father.")".", "; ?>
                            <?php endforeach; ?></span> ৰ দৰ্খাস্তৰপৰা জানিৱ পৰা গৈছে যে তলত উল্লেখ কৰা তফচিলৰ একচনা পট্টা মাটিত ম্যাদীকৰণ বিছাৰিছে ।
                ...
                <table class="table table-bordered rasid unicode">
                    ...
                    <tr>
                        ...
                        <td><label class="control-label" >
                            <?php
                            foreach ($pattadar as $p1):
                                // $pattadar = $p1->pdar_name;
                                ?>
                                <?php echo $p1->pdar_name."(".$p1->pdar_father.")" . ", <br>"; ?>
                ...
                <?php if ($mode==1) { ?>
                <center>
                    <a onclick="return myFunction()" href="" class="btn btn-success uni_text" ><i class='fa fa-print'></i> Print</a>
                </center>
                <?php } else {?>
                    <center>
                    <a onclick="return myFunction()" href="<?php echo base_url();?>index.php/AsistantConversionMb/notice_generation_save?case_no=<?php echo $location['case_no']; ?>" class="btn btn-success uni_text" ><i class='fa fa-print'></i> ৰচিদ ছপোৱা আৰু ৰচিদ জাৰি কৰক |</a>
                </center>
                <?php }?>
