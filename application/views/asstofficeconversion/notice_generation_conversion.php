    ...
    <div class="col-lg-12 center-col">
        <div class="panel " id="printdiv">
            ...
            <div class="panel-body form_1">
                ...
                <center>
                    <a onclick="return myFunction()" href="<?php echo base_url();?>index.php/AsistantMutationPartha/notice_generation_save?case_no=<?php echo $location['case_no']; ?>" class="btn btn-success uni_text" ><i class='fa fa-print'></i> ৰচিদ ছপোৱা আৰু ৰচিদ জাৰি কৰক |</a>
                </center>
                </div>
            </div>
        </div>
