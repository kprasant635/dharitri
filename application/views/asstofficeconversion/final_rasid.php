<style type="text/css" media="print">
    @page 
    {
        size:  10px;   /* auto is the initial value */
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <center>
                                ...
                                <a href="<?php echo base_url() . "index.php/AsistantMutationPartha/save_all_data"; ?>" class="btn btn-success uni_text dontshow" onclick="myFunction()"><i class='fa fa-print'></i> ৰচিদ ছপোৱা আৰু ৰচিদ জাৰি কৰক |</a>
                            </center>
                        </div>
                    </div>
                </div>
