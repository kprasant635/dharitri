    ...
    <div class="col-md-12 col-lg-12">
        <div class="card card-success">
            <div class="card-header text-center">
                <h5>
                <?php if ($process == '1') { ?>
                    Supervisor Kanango's Office Pending Land Conversion Cases
                <?php } ?>
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped convtable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success text-light" href="<?php echo base_url("index.php/sk_first_proceeding?case_no=". $case->case_no); ?>">Write Report</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
