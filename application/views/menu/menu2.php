        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <!--<li><a href="#">Link</a></li>-->
                    <li>
                        <a>Welcome <?php echo $this->session->userdata('user_code')."(".$this->session->userdata('user_desig_code').")";?></a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Settings <i class="fa fa-cog"></i></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo base_url();?>index.php/initialization/useraccount ">User Accounts</a></li>
                            <li><a href="<?php echo base_url();?>index.php/initialization/myaccount">My Accounts</a></li>
