    ...
    <nav class="navbar navbar-default menu">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand brand" href="<?php echo base_url();?>index.php/welcome/menuhome"><i class='fa fa-home red'></i> Dharitee</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="#" class="not-active">Dag No. Eneumeration</a></li>
