...
<strong>DATE OF ISSUE:</strong>                                                                                                                                                                                                                                                                                                                                     
     ...
     <!-- Land Advisory Info -->
        <table class="highlight-box">
            ...
            style="border:none !important; background-color:rgb(214, 227, 188);">
                ...
                <td><?php echo  $certificate_data->dept_order_no . ' ' . $certificate_data->dept_order_date . '<br> ' .  $certificate_data->land_advisiory_proposal_no . ', ' . $certificate_data->lapn_date ?>
                </td>
            </tr>
            <tr>
    ...
    <!-- Terms & Conditions -->
      <!-- <h3 style="text-align:center;">TERMS AND CONDITIONS</h3> -->
        <div class="page-break tnc-table" style="margin-top:15px;" >
    ...
    <tbody>
        ...
        <tr>
            <td>3</td>
            <td>In case of non-utilization of the allotted land within 3 years for the purpose for which it was allotted, or in the event of dissolution of the entity, institution, or organization, the allotment will be cancelled and the land shall automatically revert back to the Revenue and DM Department, Government of Assam.</td>
        </tr>
        <tr>
            <td>4</td>
            <td>The land so allotted will not be subjected to transfer by way of lease, mortgage, sublet, or any other way to any other entity, including but not limited to individuals, firms, or companies, without the permission of the Government.</td>
        </tr>
        <tr>
            <td>5</td>
            <td>In case of any public path or Government institutions found on any land held by the allottee, the authority will have the right to treat that portion as surrendered by the allottee and it will be excluded from the allotment.</td>
        </tr>
        <tr>
            <td>6</td>
        ...
        <tr>
            <td>7</td>
            <td>This allotment of land shall be cancelled if it is established at any later stage that the beneficiaries resorted to submission of fraudulent supporting documents and information, including affidavits. In case of realization of premium, the amount of premium shall be forfeited in addition to any other legal action for submission of fraudulent documents, information, or false affidavits.</td>
        </tr>
        <tr>
            <td>8</td>
        ...
        <tr>
            <td>9</td>
            <td>The Government or the District Commissioner shall have the right to cancel the allotment at any stage if there is a reasonable ground in the interest of public service.</td>
        </tr>
    </tbody>
</table>
