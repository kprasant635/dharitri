...
<style>
    ...
    .highlight-pink {
        background-color: rgb(241, 208, 218);
    }

    .highlight-purple {
        background-color: rgb(222, 212, 223);
    }

    .highlight-blue {
        background-color: rgb(208, 230, 241);
    }
...
<strong>DATE OF ISSUE:</strong>                                                                                                                                                                                                                                                                                                                                     
     ...
     <!-- Land Advisory Info -->
        <table class="highlight-box">
            ...
            style="border:none !important; background-color:rgb(214, 227, 188);">
                      <tr>
                <th style="text-align:left;">1.Government Notification No & Date: or 2.District Commissioner Approval No & Date :</th>
<td>
    <?php 
        echo ($certificate_data->dept_order_no ?? '') . ' ' . 
             ($certificate_data->dept_order_date ?? '') . '<br>' . 
             ($certificate_data->land_advisiory_proposal_no ?? '') . ', ' . 
             ($certificate_data->lapn_date ?? '');
    ?>
</td>
                </td>
            </tr>
       ...
       <!-- Institution Details -->
        ...
        <table class="highlight-purple" style="margin-top:15px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="2"><?php echo strtoupper($certificate_data->subdivision_name) ?></td>
                ...
                <tr>
                    ...
                    <td><b>Lot</b></td>
                    <td colspan="2"><?php echo strtoupper($certificate_data->lot_name) ?></td>
                    <td colspan="2"><b>Village</b></td>
         ...
         <!-- <table class="certificate-table"
            style="border:none !important; background-color:rgb(222, 212, 223);">
            <thead>
        ...
        <table class="certificate-table highlight-blue"
            style="border:none !important; width: 100%;word-break: break-all;">
            <thead>
  ...
  <tbody>
    <tr>
      ...
      <td>This allotment certificate is issued on realization of 50% of the liberalized premium rate and the 50% of the balance premium as applicable for the settlement of the allotted land shall be realized at the time of settlement, which can be given within 3 years subject to the actual use for the purpose the land was allotted.</td>
    </tr>
    <tr>
      <td style="text-align:center;">2</td>
      <td>The allotted land should be utilized and used solely for the purpose allotted for within the period of 3 years from the date of allotment and in accordance with the terms and conditions of the allotment.</td>
    </tr>
    <tr>
      <td style="text-align:center;">3</td>
      <td>In case of non-utilization of the allotted land within 3 years for the purpose for which allotted or in the event of dissolution of the entity/institution/organization will result in the cancellation of the allotment, and the land so allotted shall be automatically reverted back to the Revenue and DM Department, Government of Assam.</td>
    </tr>
    <tr>
      <td style="text-align:center;">4</td>
      <td>The land so allotted will not be subjected to transfer by way of lease or mortgage or sublet or any other way to any other entity, including but not limited to, individuals, firms, or companies, without the permission of the Government.</td>
    </tr>
    <tr>
      <td style="text-align:center;">5</td>
      <td>In case of any public path or Government institutions found on any land held by the allottee, the authority will have the right, treating the land as have been surrendered by the allottee and will be excluded from the allotment.</td>
    </tr>
    <tr>
      <td style="text-align:center;">6</td>
      <td>The terms and conditions of this allotment shall be binding on the said allottee in the interest of the State Government and the allottee in all cases.</td>
    </tr>
    <tr>
      <td style="text-align:center;">7</td>
      <td>This allotment of land shall be cancelled if it is established at any later stage that such beneficiaries resorted to submission of fraudulent supporting documents &amp; information including affidavits and in case of realization of premium, amount of premium shall be forfeited in addition to any other legal action for submission of fraudulent documents &amp; information, false affidavits etc.</td>
    </tr>
    <tr>
      <td style="text-align:center;">8</td>
      <td>Violation of any of the above conditions may result in cancellation of the above allotment.</td>
    </tr>
    <tr>
      <td style="text-align:center;">9</td>
      <td>The Government/District Commissioner shall have the right to cancel the allotment at any stage if there is a reasonable ground in the interest of public service.</td>
    </tr>
  </tbody>
</table>
