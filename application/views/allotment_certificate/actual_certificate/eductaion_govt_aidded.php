...
<strong>DATE OF ISSUE:</strong>                                                                                                                                                                                                                                                                                                                                     
     ...
     <!-- Land Advisory Info -->
        <table class="highlight-box">
            ...
            style="border:none !important;         background-color: #fde9d9;">
                      <tr>
      ...
      <!-- <h3 style="text-align:center;">TERMS AND CONDITIONS</h3> -->
        ...
        <table>
          ...
          <tbody>
                ...
                <tr>
                    <td>4</td>
                    <td>The land so allotted will not be subjected to transfer by way of lease, mortgage, sublet, or any other form of assignment to any other entity, including but not limited to individuals, firms, or companies, without the permission of the Government.</td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>In case of any public path or Government institution found on any land held by the allottee, the authority will have the right to treat that portion as surrendered by the allottee and it will be excluded from the allotment.</td>
                </tr>
                <tr>
                    <td>6</td>
                ...
                <tr>
                    <td>7</td>
                    <td>If it is established at any later stage that the beneficiaries submitted fraudulent supporting documents, false affidavits, or misleading information, the allotment shall be cancelled, the premium amount forfeited, and legal action may be taken.</td>
                </tr>
                <tr>
                    <td>8</td>
