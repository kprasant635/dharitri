...
<div class="row p-4" style='margin-top:40px'>
    <div class="col-md-12" style="background:#d6f5d6">
        <h4>GUIDELINES FOR GENERATING & ISSUING ALLOTMENT CERTIFICATE</h4>
        <ul>
            <li>1) Go to <b>Allotment Certificate (NIJE)</b> in the main menu and then click on <b>Issue Certificate</b>.</li>
            <li>2) Click on <b>View</b> to check the draft copy of the Allotment Certificate.</li>
            <li>3) Select the certificates you would like to issue and then click on <b>Generate Allotment Certificate For Selected Application</b>.</li>
            <li>4) After generation, click on <b>Issue Allotment Certificate</b>.</li>
            <li>5) Once issued, go to <b>Allotment Certificate (NIJE)</b> in the main menu and then click on <b>Issued Certificate</b>.</li>
                ...
                <div class="row">
                    ...
                    <?php if (ENABLE_DIGITAL_PATTA_BATCH_SIGN == 1) {?>
                        ...
                        <?php } else {?>
                            ...
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            Generate Allotment Certifcate For Selected Application
                        </button>
                            <?php }?>
                    </div>
                </form>
    ...
    $(document).ready(function() {
        ...
        function load_data_digital_patta_list() {
            ...
            var table = $('#dataTableDigitalPatta').DataTable({
                ...
                'ajax': {
                    url: base_url+'index.php/AllotmentCertificate/getAllDigitalPattaDetails',
                    type: 'POST',
                    data: {
