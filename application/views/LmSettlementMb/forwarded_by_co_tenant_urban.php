                        ...
                        <?php foreach ($cases as $case) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a type="button" href="<?php echo base_url() . "index.php/".$service_controller."/settlementTenantRegistration?app=" . $this->utilityclass->encryptJwtCase($case->applid); ?>" class='lmreportpart btn-sm btn btn-primary' id='myModal'><i class="fa fa-envelope-open" aria-hidden="true"></i> <?php echo $this->lang->line('submit_report'); ?></a>
