                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        ...
                                        if($service_controller == 'BhoodanController')
                                        {
                                            ?>

                                                <a type="button" href="<?php echo base_url() . "index.php/".$service_controller."/secondProceeding?case=" . $this->utilityclass->encryptJwtCase($case->case_no); ?>" class='lmreportpart btn-sm btn btn-primary' id='myModal'><i class="fa fa-envelope-open" aria-hidden="true"></i> <?php echo $this->lang->line('submit_report'); ?></a>
            ...
            <div class="modal-content">
              ...
              <form id='queryRequest' action="<?php echo base_url() ?>index.php/QueryToApplController/queryToApplicantForMb2" method="post">
                <div class="modal-body">
                  ...
                  <input type="hidden" name='appl_no' value="<?=$case->basundhara?>">
                </div>
