<div class="col-lg-12 ">
            <div class="well well-sm mis_report">
                <h4 style="text-align: center;">
                    LRA First proceeding (Forwarded from CO)
                </h4>
            </div>
        </div>
        <div class="col-lg-12 ">
                        ...
                        <?php foreach ($cases as $case) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a type="button" href="<?php echo base_url() . "index.php/".$service_controller."/applicationInsRegistration?app=" . $this->utilityclass->encryptJwtCase($case->applid); ?>" class='lmreportpart btn-sm btn btn-primary' id='myModal'><i class="fa fa-envelope-open" aria-hidden="true"></i> <?php echo $this->lang->line('submit_report'); ?></a>
