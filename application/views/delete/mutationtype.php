                ...
                <div class="panel panel-info panel-form">
                    ...
                    <?php endif; ?>
                        <form class='form-horizontal form_1 unicode ' method="post" action="<?php echo base_url() . 'index.php/partition/savePartionCO' ?>">
							...
							<div style='margin-bottom:10px'><span class='red center' >টোকা : যদিহে আবেদনকাৰীৰ উত্ত দাগ /পট্টা ত মাটিৰ অংশ বাকী নাথাকে তেতিয়া বাটোৱাৰাৰ প্রকাৰ সম্পূৰ্ণ দিয়ক অন্যথা অসম্পূৰ্ণ দিয়ক |</span></div>
                            <div class="form-group">
                                ...
                                <label for="inputEmail3" class="col-sm-2 control-label"><?php echo $this->lang->line('partition_type'); ?><i class="fa fa-star red"></i></label>
                                <div class="col-sm-2">
                                    <select class="form-control " required name="patition_type">
                                        <option value="0">Select Partition Type</option>
                                        <option value="Y">সম্পূৰ্ণ<?php //echo $this->lang->line('full'); ?> </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="topseal" rows="4" cols="5"> বাটোৱাৰা বিচাৰি আবেদন দাখিল |</textarea>
                                </div>
                            </div>
                            <div class="checkbox  col-lg-offset-2">
                                <label>
                                    <input type="checkbox" class="squaredTwo" name="attachment" value="Y">   <?php echo $this->lang->line('required_doc'); ?>
                                </label>
                            </div>
                            </fieldset>
                            <hr>
