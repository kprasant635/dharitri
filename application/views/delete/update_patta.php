        ...
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">                   
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url()."index.php/Deletefromchitha/update_patta_action";?>">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control pattatype_name" id="select" name="patta_type">
...
$('.pattatype_name').change(function (e) {
        ...
        $.ajax({
            url: baseurl + "Deletefromchitha/getpattaTypebyname/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode+ "/" + patta_type,
...
$('.pattanoselect').change(function (e) {
        ...
        var patta_type = $('.pattatype_name').val();

        $.ajax({
            url: baseurl + "deletefromchitha/getdag/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + patta_type + "/" +patta_no,
            success: function (data) {
                if (debug) {
                    console.log(data);
                }
