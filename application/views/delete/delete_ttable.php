    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="well well-sm mis_report">
                <h3 style="text-align: center; font-size: 28px">Delete case from transaction table</h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">                   
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url()."index.php/Deletefromchitha/delete_ttable";?>">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control case_type" id="select" name="case_type">
                                    <option value='00' >Select Type</option>
                                    <option value='01' >Office</option>
                                    <option value='02' >Field</option>	
                                </select>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control dagnoselect" size="3" multiple="multiple" tabindex="1" name="case_number">	
                                </select>
                            </div>
                        </div>
...
$('.case_type').change(function (e) {
        ...
        $.ajax({
            url: baseurl + "deletefromchitha/getcase/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode + "/" + case_type,
            success: function (data) {
               ...
               var lot = JSON.parse(data);
                var template = "<option>Select Case Number</option>";
                for (var i = 0; i < lot.length; i++) {
                    template += "<option value='" + lot[i].case_no + "'>" + lot[i].case_no + "</option>";
                }
