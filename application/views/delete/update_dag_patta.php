    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="well well-sm mis_report">
                <h3 style="text-align: center; font-size: 28px">Update Junk-Dag </h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">                   
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url()."index.php/Deletefromchitha/update_dag_patta_action";?>">
...
$('.villageselect').change(function (e) {
        ...
        $.ajax({
            url: baseurl + "deletefromchitha/getAlldag/" + distcode + '/' + subdivcode + '/' + circode + "/" + mouzacode + "/" + lotcode + "/" + villcode ,
