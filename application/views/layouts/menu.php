        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview" style="padding-left:15px">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/MutationLm" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mutation</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/PartitionLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Partition</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ConversionLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Conversion</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/CitizenLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Citizen Certificate</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/LandReLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Reclassification</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ApcLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AP Cancellation</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/AcPPLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AC to PP</p>
                </a>
              </li>
			  ...
			  <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/MiscLm" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Misc Case</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview" style="padding-left:15px">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/Tenants/indexAdd" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Khatian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/Tenants/deleteTenant" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add/Remove Tenant</p>
                </a>
              </li>
                <li class="nav-item">
		  ...
		  <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview" style="padding-left:15px">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/chithareport/jamadistrictDetails_dc_lao" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
			   ...
			   <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/MisReportController/DeedViewList" class="nav-link">
			     ...
			     <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/coofficemutation/ActionTakenReport" class="nav-link">
                  <i class="far fa fa-newspaper-o nav-icon"></i>
