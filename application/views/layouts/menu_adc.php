        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview" style="padding-left:15px">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ConversionAdc" class="nav-link">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ApcAdc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AP cancellation</p>
                </a>
              </li>
               ...
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/AlotAdc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/MisAdc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>MIS Reports</p>
                </a>
              </li>
