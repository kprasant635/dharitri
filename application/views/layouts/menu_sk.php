        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview" style="padding-left:15px">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/MutationSk" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mutation</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/PartitionSk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Partition</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ConversionSk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Conversion</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/CitizenSk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
               ...
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/ApcSk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AP cancellation</p>
                </a>
              </li>
               ...
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/Miscsk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Miscellaneous Case</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/home/AcPPSk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>AC to PP</p>
                </a>
              </li>
