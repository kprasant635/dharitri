                        ...
                        <table class="datatable table table-stripped" id='datatable'>
                            ...
                            <?php foreach ($cases as $case): ?>
                                <tr>
                                    ...
                                    <td><?php echo $case->from_office ?></td>
                                    <td><?php echo $case->pending_office ?></td>
                                    <td>
                                        <?php
                                        if($case->status == 'W')
                                        {
                                            echo "<b style='color: #263238'>Pending </b>";
                                        }
                                        if($case->status == 'R')
                                        {
                                            echo "<b style='color: #C62828'>Rejected</b>";
                                        }
                                        if($case->status == 'F')
                                        {
                                            echo "<b style='color: #1B5E20'>Approved</b>";
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url() ?>index.php/DagDeletionController/viewDagDeletionAppDetailsCommon?case=<?php echo $case->case_no?>"
                                                class="rezaButt buttPrimary"  target="Application Details" >
                                            view
