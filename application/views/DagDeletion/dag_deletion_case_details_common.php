                                ...
                                <div class="reza-body">
                                    ...
                                    <div class="row" style="margin-top: 25px">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12" align="right">
                                            <?php if($caseDetails->pending_office == MB_CIRCLE_OFFICER && $caseDetails->status == 'W' && $userDesig == MB_CIRCLE_OFFICER): ?>
                                                <button class="rezaButt buttInfo" id="forwardToSdoAdc">
                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                    Forward To ADC/SDO
                                                </button>
                                            <?php endif; ?>
                                            <?php if($caseDetails->pending_office == "SDO" && $caseDetails->status == 'W' &&  $userDesig == 'SDO'): ?>
                                                <button class="rezaButt buttInfo" id="forwardToDc">
                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                    Forward To DC
                                                </button>
                                            <?php endif; ?>
                                            <?php if($caseDetails->pending_office == "ADC" && $caseDetails->status == 'W' &&  $userDesig == 'ADC'): ?>
                                                <button class="rezaButt buttInfo" id="forwardToDc">
                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                    Forward To DC
                                                </button>
                                            <?php endif; ?>
                                            <?php if($caseDetails->pending_office == "DC" && $caseDetails->status == 'W' &&  $userDesig == 'DC'): ?>
                                                <button class="rezaButt buttInfo" id="acceptByDc">
                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                    Accept Request & Delete Dag
                                                </button>
                                                <button class="rezaButt buttDanger" id="rejectByDc">
                                                    <i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                    Reject Request
                                                </button>
                                            <?php endif; ?>
...
<!-- Modal for co -->
<div class="modal" role="dialog" id="forwardToSdoAdcModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" align="">
                <div class="row" align="center">
                    <h3>Are You Sure !</h3>
                    <br>
                    <h5 style="color: #2E7D32; margin-bottom: 25px">You want to Forward Dag Delete request  <br>
                        ( <span style="font-weight: bold"> <?php echo $caseDetails->case_no ?> </span> ) to ADC/SDO
                    </h5>
                    <hr>
                </div>
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            ...
                            <textarea class="form-control" name="w3review" id="remarksCo" rows="4" required minlength="1"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"  id="forwardToSdoAdcModalNo">NO</button>
                <button type="button" class="btn btn-primary"   id="forwardToSdoAdcModalYes">YES, FORWARD</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal for SDO/ADC -->
<div class="modal" role="dialog" id="forwardToDcModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Confirmation</h5>
            ...
            <div class="modal-body" align="">
                <div class="row" align="center">
                    ...
                    <br>
                    <h5 style="color: #2E7D32; margin-bottom: 25px">You want to Forward Dag Delete request  <br>
                        ( <span style="font-weight: bold"> <?php echo $caseDetails->case_no ?> </span> ) to DC
                    </h5>
                    <hr>
                </div>
                ...
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Enter Your Remarks</label>
                            <textarea class="form-control" name="w3review" id="remarksSdoAdc" rows="4" required minlength="1"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="forwardToDcModalNo">NO</button>
                <button type="button" class="btn btn-primary"  id="forwardToDcModalYes">YES, FORWARD</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal for DC Reject the request -->
<div class="modal" role="dialog" id="rejectByDcModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Confirmation</h5>
            ...
            <div class="modal-body" align="">
                <div class="row" align="center">
                    <h3>Are You Sure !</h3>
                    <br>
                    <h5 style="color: #673AB7; margin-bottom: 25px">You want to Reject Dag Delete request  <br>
                        ( <span style="font-weight: bold"> <?php echo $caseDetails->case_no ?> </span> )
                    </h5>
                    <hr>
                </div>
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Enter Your Remarks</label>
                            <textarea class="form-control" name="w3review" id="remarksDcReject" rows="4" required minlength="1"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"  id="rejectByDcModalNo">NO</button>
                <button type="button" class="btn btn-primary"   id="rejectByDcModalYes">YES, REJECT</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal for DC Accept the request -->
<div class="modal" role="dialog" id="acceptByDcModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Confirmation</h5>
            ...
            <div class="modal-body" align="">
                <div class="row" align="center">
                    <h3>Are You Sure !</h3>
                    <br>
                    <h5 style="color: #2E7D32; margin-bottom: 25px">You want to Accept dag delete request   <br>
                        ( <span style="font-weight: bold"> <?php echo $caseDetails->case_no ?> </span> )
                    </h5>
                    <hr>
                </div>
                ...
                <form action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            <label for="w3review" style="font-weight: bold">Enter Your Remarks</label>
                            <textarea class="form-control" name="w3review" id="remarksDcAccept" rows="4" required minlength="1"> </textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 15px">
                <div style="font-size: 14px; font-weight: bold; margin-top: 10px; margin-bottom: 10px; color: #E53935">
                    Note: Once you accept the dag deletion request, then this dag would permanently delete from chitha &
                    with all related information of this dag.
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"  id="acceptByDcModalNo">NO</button>
                <button type="button" class="btn btn-primary"   id="acceptByDcModalYes">YES, DELETE</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    // for CO end
    $(document).on('click','#forwardToSdoAdc',function ()
    {
        $('#forwardToSdoAdcModal').modal('show');
    });

    $(document).on('click','#forwardToSdoAdcModalNo',function ()
    {
        $('#forwardToSdoAdcModal').modal('hide');
    });

    $(document).on('click','#forwardToSdoAdcModalYes',function ()
    {
        var remarks = $("#remarksCo").val();
        if(remarks != '')
        {
            $.blockUI({
                message: $('#displayBox'),
            ...
            $.ajax({
                url: BASE_URL + "/DagDeletionController/forwardRequestToAdcSdo",
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    else if (data.responseType == 2)
                    {
                        ...
                        window.location = BASE_URL + "/DagDeletionController/viewPendingRequestDetailsCommon";
                    }
                    })
                    }
                    else {
        ...
        {
            showErrorMessage("There is no remarks, Kindly Enter some remarks");
        }
    });


    // for ADC/SDO end
    $(document).on('click','#forwardToDc',function ()
    {
        $('#forwardToDcModal').modal('show');
    });

    $(document).on('click','#rejectByDcModalNo',function ()
    {
        $('#forwardToDcModal').modal('hide');
    });

    $(document).on('click','#forwardToDcModalYes',function ()
    {
        var remarks = $("#remarksSdoAdc").val();
        if(remarks != '')
        {
            $.blockUI({
                message: $('#displayBox'),
            ...
            $.ajax({
                url: BASE_URL + "/DagDeletionController/forwardRequestToDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    // Reject the request by DC
    $(document).on('click','#rejectByDc',function ()
    {
        $('#rejectByDcModal').modal('show');
    });

    $(document).on('click','#rejectByDcModalNo',function ()
    {
        $('#rejectByDcModal').modal('hide');
    });

    $(document).on('click','#rejectByDcModalYes',function ()
    {
        var remarks = $("#remarksDcReject").val();
        if(remarks != '')
        {
            $.blockUI({
                message: $('#displayBox'),
            ...
            $.ajax({
                url: BASE_URL + "/DagDeletionController/rejectDeleteRequestByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    // Accept the request by DC
    $(document).on('click','#acceptByDc',function ()
    {
        $('#acceptByDcModal').modal('show');
    });

    $(document).on('click','#acceptByDcModalNo',function ()
    {
        $('#acceptByDcModal').modal('hide');
    });

    $(document).on('click','#acceptByDcModalYes',function ()
    {
        var remarks = $("#remarksDcAccept").val();
        if(remarks != '')
        {
            $.blockUI({
                message: $('#displayBox'),
            ...
            $.ajax({
                url: BASE_URL + "/DagDeletionController/acceptDeleteRequestByDc",
                type: "post",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
