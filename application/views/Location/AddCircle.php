            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#6" data-toggle="tab" style="text-decoration:none;">Add Circle</a>
                        </li>
                            ...
                            <div class="col-lg-12 ">
                                <div class="panel panel-primary shadow-lg">
                                    <div class="panel-heading bg-secondary text-white">
                                        <h3 class="panel-title text-center font-weight-bold">ADD CIRCLE</h3>
                                    </div>
                                    <div class="panel-heading">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="col-lg-12 py-3 text-center">
                                                <button type="button" onclick="validate_circle_data()"
                            ...
                            <div class="col-lg-12 ">
                                <div class="panel panel-primary shadow-lg">
                                    <div class="panel-heading bg-success text-white">
                                        <h3 class="panel-title text-center">CIRCLE DETAILS</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="col-md-4 mb-3">
                                            <label>
                                                Circle Assamese Name
                                                <span style="color:red;font-weight:bold; font-size: 25px;">*</span>
                                            </label>
                                            <input class="form-control form-control-lg"
                                                   id="circle_as_name"
                                                   placeholder="Circle Assamese Name">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label>
                                                Circle English Name
                                            ...
                                            <input class="form-control form-control-lg"
                                                   id="circle_eng_name"
                                                   placeholder="Circle English Name">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label>
                                                Circle Abbreviation
                                        ...
                                        <div class="col-lg-12 text-center pt-3"
                                            ...
                                            <button onclick="add_circle_form_submit()"
                                                    class="btn uni_text btn-success"><i
                                                    class="fa fa-check" aria-hidden="true"></i> SAVE NEW CIRCLE
                                            </button>
                                        </div>
                            ...
                            <div class="col-lg-12 bg-white rounded">
                                <div class="panel panel-primary shadow-lg p-2">
                                    <table id="data_table" class="dataTable border table table-hover">
                                        ...
                                        <tr>
                                            <th>SL NO.</th>
                                            <th>CIRCLE ASSAMESE NAME</th>
                                            <th>CIRCLE ENGLISH NAME</th>
                                            <th>ABBREVIATION</th>
                                            <th>ACTION</th>
                                        </tr>
                                        </thead>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title red bold">CIRCLE NAME ALREADY EXISTED..!</h5>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="comfirm_add_circle_form_submit()" class="btn btn-primary">
...
<div class="modal" id="EditModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title bold">EDIT CIRCLE DETAILS</h5>
            </div>
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control form-control-lg" id="e_circle_as_name"
                               placeholder="Circle Assamese Name">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>
                        ...
                        <input class="form-control form-control-lg" id="e_circle_eng_name"
                               placeholder="Circle English Name">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>
                        ...
                        <input class="form-control form-control-lg" id="e_cir_abbr"
                               placeholder="Circle Abbreviation">
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="edit_circle_form_submit()" class="btn btn-primary">
