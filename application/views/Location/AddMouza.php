            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#6" data-toggle="tab" style="text-decoration:none;">Add Mouza</a>
                        </li>
                            ...
                            <div class="col-lg-12 ">
                                <div class="panel panel-primary shadow-lg">
                                    <div class="panel-heading bg-secondary text-white">
                                        <h3 class="panel-title text-center font-weight-bold">ADD MOUZA</h3>
                                    </div>
                                    <div class="panel-heading">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="col-lg-12 py-3 text-center">
                                                <button type="button" onclick="validate_mouza_data()"
                            ...
                            <div class="col-lg-12 ">
                                <div class="panel panel-primary shadow-lg">
                                    <div class="panel-heading bg-success text-white">
                                        <h3 class="panel-title text-center">MOUZA DETAILS</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="col-md-4 mb-3">
                                            <label>
                                            ...
                                            <input class="form-control form-control-lg"
                                                   id="mouza_as_name"
                                                   placeholder="Mouza Assamese Name">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label>
                                                Mouza English Name
                                            ...
                                            <input class="form-control form-control-lg"
                                                   id="mouza_eng_name"
                                                   placeholder="Mouza English Name">
                                        </div>
                                        ...
                                        <div class="col-lg-12 text-center pt-3"
                                            ...
                                            <button onclick="add_mouza_form_submit()"
                                                    class="btn uni_text btn-success"><i
                                                    class="fa fa-check" aria-hidden="true"></i> SAVE NEW MOUZA
                                            </button>
                                        </div>
                            ...
                            <div class="col-lg-12 bg-white rounded">
                                <div class="panel panel-primary shadow-lg p-2">
                                    <table id="data_table" class="dataTable border table table-hover">
                                        ...
                                        <tr>
                                            <th>SL NO.</th>
                                            <th>MOUZA ASSAMESE NAME</th>
                                            <th>MOUZA ENGLISH NAME</th>
                                            <th>UNIQUE CODE</th>
                                            <th>ACTION</th>
                                        </tr>
                                        </thead>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title red bold">MOUZA NAME ALREADY EXISTED..!</h5>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="comfirm_add_mouza_form_submit()" class="btn btn-primary">
...
<div class="modal" id="EditModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title bold">EDIT MOUZA DETAILS</h5>
            </div>
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control form-control-lg" id="e_mouza_as_name"
                               placeholder="Mouza Assamese Name">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>
                        ...
                        <input class="form-control form-control-lg" id="e_mouza_eng_name"
                               placeholder="Mouza English Name">
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="edit_mouza_form_submit()" class="btn btn-primary">
