                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body final_mapped_classes final_map_group_<?= $land_class_group['id']; ?>" data-group_id="<?= $land_class_group['id']; ?>">
                                                            <?php 
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <?php
                                                                if(count((array) $land_class_group['co_land_class'])):
                                                            ?>
                                                                    <div class="row">
                                                            <?php
                                                                        foreach($land_class_group['co_land_class'] as $co_ins):
                                                            ?>
                                                                            <div class="col-md-4">
                                                                                <div class="card cos_block">
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        <?php
                                                                                            ...
                                                                                            ?>
                                                                                                    <div class="connectedSortable sortable" data-group_id="<?= $land_class_group['id']; ?>">
                                                                                            <?php
                                                                                                    foreach($co_ins['mapped_cases'] as $mapped_case):
                                                                                            ?>
                                                                                                        <li class="ui-state-default landClassList bg-gradient-info land_class_<?= $mapped_case['class_code']; ?>" data-land_class_code="<?= $mapped_case['class_code']; ?>">
                                                                                                            <a herf="javascript:void(0);" 
                                                                                                                title="View and move to final mapped"
                                                                                                                data-class_code="<?= $mapped_case['class_code']; ?>" 
                                                                                                                data-class_name="<?= $mapped_case['land_type']; ?> (<?= $mapped_case['landtype_eng']; ?>)" 
                                                                                                                data-group_id="<?= $land_class_group['id']; ?>" 
                                                                                                                data-group_name="<?= $land_class_group['name']; ?>" 
                                                                                                                data-circle_name="<?= $co_ins['loc_name']; ?>" 
                                                                                                                class="land_class_move_confirmation"
                                                                                                                data-toggle="modal" data-target="#previewModal"
                                                                                                            >
                                                                                                                <i class="fa fa-arrow-circle-left mr-1"></i>
                                                                                                            </a>
                                                                                                            <?= $mapped_case['land_type']; ?> (<?= $mapped_case['landtype_eng']; ?>)
                                                                                                        </li>
                                                                                            <?php
                                                                                                    endforeach;
                                                                                            ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <strong class="text-danger p preview_class_name"></strong>
...
<div class="modal fade" id="finalPreviewModal" tabindex="-1" role="dialog" aria-labelledby="finalPreviewModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="landClassMapForm" action="<?= base_url('index.php/land-class-group/class-map/approve') ?>" method="POST">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.land_class_move_confirmation', function(){
            ...
            const circleName = $this.data('circle_name');
            ...
            $(`.land_class_${classCode}`).each(function(){
                ...
                let circle_name = $('.land_class_move_confirmation', closestLi).data('circle_name');
            ...
            $.each(tempGroupWiseLandClasses, function(grpid, details){
                if(details.length > 0){
                    ...
                    $.each(details, function(ind, val){
                        ...
                        clsHtml += `<button class="btn btn-warning m-1" type="button">${val.circleName}</button>`;
                    });
