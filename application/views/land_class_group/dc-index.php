    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-form">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php if(count($land_class_groups) > 0): ?>
                                        ...
                                        <div class="accordion-body" style="min-height: 62px;" data-group_id="<?= $land_class_group['id']; ?>">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    ?>  
                                                                <button class="btn btn-warning m-2"><?= $land_class['land_class_name']; ?> (<?= $land_class['land_class_eng_name']; ?>)</button>
                                                    <?php
                                                            endforeach;
                                                        endif; 
                                                    ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="landClassMapForm" action="<?= base_url('index.php/land-class-group/class-map/final-approve') ?>" method="POST">
