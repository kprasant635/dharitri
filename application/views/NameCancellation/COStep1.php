        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;"><?php echo $this->lang->line('pending_miscellaneous_cases');?></h2>
                </div>
            </div>
                            ...
                            {	
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="<?=$url?>?misc_case_no=<?php echo enc_param('misc_case_no', $cases->misc_case_no, 600)?>" class="btn btn-sm btn-primary"> <?php echo $this->lang->line('pass_order');?></a>
        ...
        $(document).ready( function () {
            ...
            function load_data(zone_status)
            {
                ...
                var table = $('#cases').DataTable({
                    ...
                    'ajax':{
                        url: base_url+'index.php/EscalationController/searchByEscalationZoneNameCancellationForCo',
                        type:'POST',
...
<script type="text/javascript">
    ...
    $('.panel').on('click', '.chainReportMiscNC', function(e) {
        e.preventDefault();
