                        ...
                        <form name="f1" class="form-horizontal" method='post' action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
									...
									<?php echo form_error('ord_date', '<p class="red">', '</p>'); ?>
                                </div>
                                <label for="inputEmail" class="col-lg-3 required control-label"><?php echo $this->lang->line('address_to_the_officer'); ?> </label>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <label for="inputEmail" class="col-lg-3 required control-label"><?php echo $this->lang->line('mouza'); ?></label>
                                <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-3 required control-label"><?php echo $this->lang->line('lot_no'); ?> </label>
                                <div class="col-lg-3">
                                ...
                                <label for="inputEmail" class="col-lg-3 required control-label"><?php echo $this->lang->line('vill_town'); ?> </label>
                                <div class="col-lg-3">
                                    <select class="form-control required villageselect" id="select" required name="vill_code">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
									...
									<?php echo form_error('patta_type_code', '<p class="red">', '</p>'); ?>
                                </div>
                                <label for="select" class="col-lg-2 required control-label"><?php echo $this->lang->line('patta_no'); ?></label>
                                <div class="col-lg-2">
                                ...
                                <label for="select" class="col-lg-2 required control-label"><?php echo $this->lang->line('dag_no'); ?></label>
                                <div class="col-lg-2">
                            ...
                            <hr style="border-bottom: 2px solid #000;">
							<h2><mark>Select <?php echo $this->lang->line('supporting_document'); ?> </mark></h2>
                            <div class="form-group">
								<div class='col-lg-12'>
