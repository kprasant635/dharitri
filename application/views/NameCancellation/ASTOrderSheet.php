            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        <?php echo $this->lang->line('ast_order_sheet_on_misc_cases');?>
                    </h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered" width="100%">
                            ...
                            <?php
                            $row = count($ConfirmNoticeGenerate);
                            if ($row > 0) {
                                $c = 1;
                                foreach ($ConfirmNoticeGenerate AS $cases) {
									var_dump($cases);
                                    ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . "index.php/NameCancellation/ASTOrderSheet1"; ?>?misc_case_no=<?php echo $cases->misc_case_no; ?>&p=<?=$cases->misc_case_petition_no;?>" class="btn btn-primary"><?php echo $this->lang->line('notice_generate');?> </a>
                                        </td>
                                    </tr>
                                    <?php
                                    $c++;
