                            ...
                            <tr>
                                <td>To,<br>
                                    ...
                                    <p style="text-indent: 100px;">
                                        ...
                                        has filed the petition in my court for delete/Strikeout of  your name from the record.
                                    </p><br/>
                                    <p>
                                        You are hereby given the notice to present in my court at 10.30 A.M. on <?php echo date("d-m-Y", strtotime($miscCaseInfo->next_date_of_hearing)); ?>
                                    </p>
                                    <p>
                                        Given under my hand and real of this court on <?php echo date("d-m-Y"); ?> at <?php echo $namedata[2]->circle; ?>.
                                    </p>
                                </td>
                            </tr>
                            <tr>
