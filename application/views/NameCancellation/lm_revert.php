        ...
        <div class="col-lg-12 ">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">Reverted Name Cancellation Cases</h2>
                </div>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <a href="<?=base_url().'index.php/home/MiscLm'?>">
                                    ...
                                    <span class='small font-italic red'><?php if($cases->basundhara){ echo "Basundhara:". $cases->basundhara ;} ?> </span></td>
                                        ...
                                        <td class="center">
                                            ...
                                            else
                                            {
                                                ...
                                                <a href="<?php echo base_url() . "index.php/NameCorrection/LMStep2"; ?>?misc_case_no=<?php echo enc_param('misc_case_no', $cases->misc_case_no, 600)."&petition_no=".$cases->misc_case_petition_no; ?>" class="btn btn-primary"><?php echo $this->lang->line('write_report'); ?> </a>
    											<?php }else{?>
    											<a href="<?php echo base_url() . "index.php/NameCancellation/LMStep2_revert"; ?>?misc_case_no=<?php echo enc_param('misc_case_no', $cases->misc_case_no, 600)."&petition_no=".$cases->misc_case_petition_no; ?>" class="btn btn-primary"><?php echo $this->lang->line('write_report'); ?> </a>
    											<?php } ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
        ...
        $(document).ready( function () {
            ...
            function load_data(zone_status)
            {
                ...
                var table = $('#cases').DataTable({
                    ...
                    'ajax':{
                        url: base_url+'index.php/EscalationController/searchByEscalationZoneNameCancellationRevertForLm',
                        type:'POST',
