    ...
    <strong>DATE OF ISSUE:</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <?php echo $certificate_data->certificate_date ?>
     ...
     <!-- Land Advisory Info -->
        <table class="highlight-box">
         ...
         <!-- Institution Details -->
        <table class="highlight-pink" style="margin-top:15px; background-color: #b8cce4;">
           <thead>
                <td colspan="2" class="section-heading">INSTITUTION/ORGANIZATION DETAILS</td>
            </thead>
             <tbody>
            <tr>
...
?>
<table class="certificate-table" style="border:none !important; background-color:#b8cce4;">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <table class="certificate-table"
            style="border:none !important; width: 100%; background-color:#b8cce4;">
            <thead>
        ...
        <!-- Geo Section -->
        <table class="highlight-blue" style="text-align:center; background-color:#b8cce4;">
            <thead style="background-color: #b8cce4;">
                <td>ULPIN*/Geo-coordinates</td>
                <td>Land Schedule Sketch (Link)</td>
                <td>Google Location</td>
                <td>Geo Tag Photos</td>
            </thead>
            <tr>
