    ...
    $(document).ready(function() {
        ...
        function load_data_digital_patta_list() {
            ...
            var table = $('#dataTableDigitalPatta').DataTable({
                ...
                'ajax': {
                    url: base_url+'index.php/SettlementCertificate/getAllDigitalPattaDetailsIssuedv2',
                    type: 'POST',
                    data: {
...
<script>
 ...
 $(document).on('click', '#bulkPrint', function() {
        ...
        //console.log(applicant);
        $.ajax({
            url: base_url +'index.php/SettlementCertificate/print_certificates_without_sign',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
    ...
    form.setAttribute("action", base_url + 'index.php/SettlementCertificate/print_certificates_as_pdf');
