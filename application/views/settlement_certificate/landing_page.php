...
<h2 class="text-center">Settlement Certificate</h2>


<?php if(NIJE_ALLOTMENT_CERTIFICATE_GUIDE == 1){?>
<div class="row p-4" style='margin-top:40px'>
    <div class="col-md-12" style="background:#d6f5d6">
        <h4>GUIDELINES FOR GENERATING & ISSUING Settlement CERTIFICATE</h4>
        <ul>
            <li>1) Go to <b>Settlement Certificate (NIJE)</b> in the main menu and then click on <b>Issue Certificate</b>.</li>
            <li>2) Click on <b>View</b> to check the draft copy of the Settlement Certificate.</li>
            <li>3) Select the certificates you would like to issue and then click on <b>Generate Settlement Certificate For Selected Application</b>.</li>
            <li>4) After generation, click on <b>Issue Settlement Certificate</b>.</li>
            <li>5) Once issued, go to <b>Settlement Certificate (NIJE)</b> in the main menu and then click on <b>Issued Certificate</b>.</li>
            <li>6) Select the certificate you would like to print and click on <b>Print</b>.</li>
            <li>7) For multiprint, select all the certificates you would like to print. 
                <br><i>Note: All selected certificates should be of the same category.</i></li>
            <li>8) Once the printable list is ready, press <b>Ctrl + P</b> to print all the certificates.</li>
        </ul>
    </div>
</div>
<?php } ?>
        ...
        width: '100%'
                ...
                <div class="row">
                    ...
                    <?php if (ENABLE_DIGITAL_PATTA_BATCH_SIGN == 1) {?>
                        ...
                        <?php } else {?>
                            <button class="btn btn-danger" type="button" id="bulkSentForApproveWithoutSignModalOpen">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            Generate Seetlement Certifcate For Selected Application
                        </button>
                            <?php }?>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-sm" id="bulkCasesApproveSubmitWithoutPdf" disabled>
                            Issue Allotment Certificate
                        </button>
...
$(document).ready(function () {
    ...
    $(document).ready(function() {
        ...
        $('#selectCircle').on('change', function() {
            ...
            if (circleCode) {
                $.ajax({
                    url: base_url+'index.php/SettlementCertificate/getVillagesByCircle',
                    type: "POST",
        ...
        function load_data_digital_patta_list() {
            ...
            var table = $('#dataTableDigitalPatta').DataTable({
                ...
                'ajax': {
                    url: base_url+'index.php/SettlementCertificate/getAllDigitalPattaDetails',
                    type: 'POST',
                    data: {
    ...
    function viewDigitalPatta(case_no,dist_code){
        ...
        $.ajax({
            url: base_url +'index.php/SettlementCertificate/getAllotmentCertificate',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
...
<script type="text/javascript">
    ...
    $(document).on('click', '#bulkCasesApproveSubmitWithoutPdf', function() {
        ...
        //console.log(applicant);
        $.ajax({
            url: base_url +'index.php/SettlementCertificate/bulkApproveCasesOfDigitalPattaWithoutDigitalSignWithoutPdf',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
    ...
    $(document).on('click', '#signAndBulkCasesApproveSubmit', function() {
        ...
        //console.log(applicant);
        $.ajax({
            url: base_url +'index.php/SettlementCertificate/signAndBulkCasesApproveSubmit',
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
