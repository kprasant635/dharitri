...
?>
    <table class="certificate-table" style="border:none !important; background-color:rgb(222, 212, 223);">
        <thead>
            <tr>
        ...
        <table class="certificate-table"
            style="border:none !important; width: 100%; background-color:rgb(208, 230, 241);">
            <thead>
    ...
    <tbody>
        ...
        <tr>
            <td>5</td>
            <td>The Lease-holder shall have a permanent right of use and occupancy in the land subject to the reservation in favour of the State Government of all quarries and of all mines, minerals and mineral oils, and of all buried treasure, with full liberty to search for and work the same, paying to the leaseholder only compensation for the surface damage as estimated by the District Commissioner. However, in case of land under Tribal Belt &amp; Blocks, restrictions under Section 164 and Section 164(A) of Assam Land Revenue Regulation 1886 will be also applicable. Further, violation of provisions of Section 164 will invite action as per Section 165 of Assam Land Revenue Regulation 1886.</td>
        </tr>
        <tr>
            <td>6</td>
