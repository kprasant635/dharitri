                    ...
                    <div class="panel-body">
                        ...
                        <h2><mark>Circle Officer(s) Note On Action or Reason For Rejection</mark></h2>
                            ...
                            <?php if(!empty($app->basundhara)){ ?>
                                 ...
                                 <center>
                          <button type="submit" name="FormSubmit" class="btn btn-sm btn-primary" id="change_text1"><i class='fa fa-check-square-o'></i> Forward</button>&nbsp;
                         <button class="btn btn-sm btn-danger" id="reject_text1"><i class='fa fa-arrows-alt'></i> Reject Application</button>&nbsp;
