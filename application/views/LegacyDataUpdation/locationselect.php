    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="well well-sm mis_report">
                <h3 style="text-align: center; font-size: 28px">Report On Legacy Update</h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url() . 'index.php/LegacyDataUpdation/GenerateReport' ?>">
