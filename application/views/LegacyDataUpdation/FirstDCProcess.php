<div class="container-fluid form-top login">
    <div class="row">
        <div class="col-lg-12 ">
            ...
            <form class='form-horizontal' id="f1" method="post" action="<?php echo base_url() . 'index.php/LegacyDataUpdation/SaveDcProcess' ?>" enctype="multipart/form-data">
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    <a href="javascript:void(0);" data-bs-target="#historyModal" data-bs-toggle="modal" class="get_history btn btn-warning" data-case_no="<?= $details->case_no; ?>"><i class="fa fa-eye"></i>&nbsp;View History</a>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        if($Pcases->suggested_dag_no != '')
                        {
                                echo'<div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="suggested_dag_no" value="'.$Pcases->suggested_dag_no.'" disabled>
                                    </div>
                                    </div>';
                        ...
                        if($Pcases->suggested_patta_no != '')
                        {
                            echo'<div class="form-group">
                                ...
                                //     <label for="inputEmail3" class="col-sm-5 control-label">Suggested Patta No</label>
                                //     <div class="col-sm-5">
                                //     <input type="text" class="form-control" name="suggested_patta_no" value="'.$Pcases->suggested_patta_no.'" disabled>
                                //     </div>';
                                //     if($patta_remarks){
                        ...
                        if($Pcases->suggested_patta_type != '0' && $new_patta_type)
                        {
                                echo'<div class="form-group">
                                    <label for="inputEmail3" class="col-sm-5 control-label">Suggested Patta Type</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="sugested_patta_type" value="'.$new_patta_type.'" disabled>
                                    </div>
                                    </div>';
                                $remark = $remark.""."পট্টা প্ৰকাৰ ".$det['patta_type']." পৰা ".$new_patta_type.", ";
                        }
                        
                        if($Pcases->suggested_land_class != '0' && $new_land_class)
                        {
                                echo'<div class="form-group">
                                    <label for="inputEmail3" class="col-sm-5 control-label">Suggested Land Class</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="sugested_land_class" value="'.$new_land_class.'" disabled>
                                    </div>
                                    </div>';
                        ...
                        if($Pcases->suggested_land_rev != '')
                        {
                                echo'<div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="sugested_land_rev" value="'.$Pcases->suggested_land_rev.'" disabled>
                                    </div>
                                    </div>';
                        ...
                        if($Pcases->suggested_loc_tax != '')
                        {
                                echo'<div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="sugested_local_tax" value="'.$Pcases->suggested_loc_tax.'" disabled>
                                    </div>
                                    </div>';
                        ...
                        <div class="col-sm-12">
                           ...
                           <!--  <label class="control-label">    
                                <center><input type="radio" name="order_type" value="reject" onclick="return confirm('Are you sure you want to Reject Case ?')" required> Reject This Case.</center>
                            </label> -->
                            <hr>
                        </div>
                        <h2><mark>DC/ADC(s) Note On Action or Reason For Rejection</mark></h2>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <?php
                                    // echo '<textarea name="" readonly="" class="form-control final" rows="5">লাঃ মঃৰ প্ৰতিবেদন চোৱা হল ৷  '.$remark.' সংশোধনীৰ বাবে অনুমোদন দিয়া হল ৷  - '.$location['dc_name'] . ", " .$location['designation'].", " . $location['dist'].'</textarea>';
                                    // echo '<textarea name="final_report" class="form-control hide" rows="5">লাঃ মঃৰ প্ৰতিবেদন চোৱা হল ৷  '.$remark.' সংশোধনীৰ বাবে অনুমোদন দিয়া হল ৷  - '.$location['dc_name'] . ", " .$location['designation'].", " . $location['dist'].'</textarea>';
                                    echo '<textarea name="final_report" class="form-control" rows="5">চক্র বিষয়াৰ প্ৰতিবেদন চোৱা হল ৷  '.$remark.' সংশোধনীৰ বাবে অনুমোদন দিয়া হল ৷</textarea>';
                                    ?>
                                    <textarea name="" readonly="" class="form-control reject" rows="5">তথ্য নাই | - <?php echo $location['dc_name'] . ", "; ?><?php //echo $location['designation'].", " . $location['dist']; ?></textarea>
                                    <textarea name="designation_suffix" class="form-control hide" rows="5"><?php //echo $location['dc_name'] . ", "; ?><?php echo $location['designation'].", " . $location['dist']; ?></textarea>
