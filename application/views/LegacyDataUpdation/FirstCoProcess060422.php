                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <h2><mark>Circle Officer(s) Note On Action or Reason For Rejection</mark></h2>
                            ...
                            <center>
                          <button type="submit" name="FormSubmit" class="btn btn-sm btn-primary" id="change_text1"><i class='fa fa-check-square-o'></i> Submit</button>&nbsp;
                          ...
                          <button class="btn query btn-sm btn-success"><i class='fa fa-hand-paper-o'></i>Query to Applicant(s)</button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <button type="submit" class="btn btn-danger" id="reject_text1"><i class='fa fa-check'></i>&nbsp; Reject For Inadequate  Documents
