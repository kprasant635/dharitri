                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="rasid table">
                            <tr>
                                <td style="text-align: center;">The Registration Process For Legacy Data Updation / modification Completed.</td>
                            </tr>
                            <tr>
                                <td style="text-align: center; font-size: 30px;">লিগ্যাসি সংশোধনীৰ বাবে নিবন্ধীকৰণ প্রক্রিয়া সম্পন্ন ।</td>
                            </tr>
                        </table>
                    </div>
                </div>
