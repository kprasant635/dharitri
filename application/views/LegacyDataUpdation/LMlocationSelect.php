    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            <div class="well well-sm mis_report">
                <h2 style="text-align: center; font-size: 28px"> Legacy Data Modification / Updation </h2>
            </div>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" name="form" method='post' action="<?php echo base_url()."index.php/LegacyDataUpdation/LMConvertionType";?>">
