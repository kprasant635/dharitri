        ...
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel panel-info panel-form">
                ...
                <div class="panel-body">
                    <form method="post" action="<?php echo base_url() . "index.php/LegacyDataUpdation/FinalupdateLandDag" ?>">
                        <div class="form-group" style="width: 100%;">
                            ...
                            <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>New Dag no</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control"  name='new_dag_no' >
                            </div>
                        </div>
                        <hr>
