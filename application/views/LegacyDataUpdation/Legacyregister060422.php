                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group sugested_dag_no">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="suggested_dag_no" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group sugested_patta_no">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control suggested_patta_no" name="suggested_patta_no">
                                </div>
                            ...
                            <div class="form-group sugested_land_class">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="suggested_land_class">
                            ...
                            <div class="form-group sugested_land_rev">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="suggested_land_rev"  value="">
                                </div>
                            </div>
                            <div class="form-group sugested_local_tax">
                                <label for="inputEmail3" class="col-sm-5 control-label">Suggested Local Tax</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control loc_tax" name="suggested_loc_tax"  value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group alert alert-success sugested_area">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='suggested_dag_area_b' placeholder="বিঘা"  value="">
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='suggested_dag_area_k' placeholder="কঠা"  value="">
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" name='suggested_dag_area_lc' placeholder="লেছা"  value="">
                                </div>
                            </div>
