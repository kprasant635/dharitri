    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            <div class="well well-sm mis_report bg-success">
                <h2 style="text-align: center;font-size: 28px">Update Village Wise Zonal Information </h2>
            </div>
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    <?php echo form_open(base_url('index.php/ZoneInformationController/getVillageZoneDetails'), array('method' => 'post')); ?>
