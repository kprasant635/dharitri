            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        <?php
                        if ($process == '1' || $process == '2' || $process == '4' || $process == '6' || $process == '7') {
                            echo $this->lang->line('co_land_reclassification_cases');
                            ...
                            <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="<?php echo base_url(); ?>index.php/LandReclassification/FirstCoProcess?case_no=<?php echo $case->case_no."&proposal_no=".$case->proposal_no; ?>" class="btn btn-success">Proceed</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                                <?php
                            ...
                            <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='cases' width="100%">
                                ...
                                <?php foreach ($cases as $case): ?>
                                    <tr>
                                        ...
                                        <td class="center"><?php echo $case->dag_no; ?></td>
                                        <td class="center"><i class='fa fa-calendar'></i> Submited On <?php echo date('d-m-Y', strtotime($case->lm_date)); ?></td>
                                        <td class="center"><a href="<?php echo base_url(); ?>index.php/LandReclassification/FirstDCProcess?case_no=<?php echo $case->case_no."&proposal_no=".$case->proposal_no; ?>" class="btn btn-success">Proceed</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                                <?php
