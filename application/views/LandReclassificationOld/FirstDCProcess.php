                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <form class='form-horizontal' method="post" action="<?php echo base_url(); ?>index.php/LandReclassification/FinalProcess">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea name="dc_report" class="form-control" rows="5">  চক্র্ বিষয়াৰ প্রতিবেদন মৰ্মে মাটিৰ  শ্ৰেণী পৰিবৰ্ত্তনৰ  বাবে  হুকুম দিয়া হল । নথি সংশোধন  কৰা হওঁক  ।</textarea>
                                    <textarea name="dc_report_suffix" class="form-control hidden" rows="5"><?php echo $location['adc_name'] . ", "; ?><?php echo "অতিৰিক্ত উপায়ুক্ত, " . $location['cir']; ?></textarea>
