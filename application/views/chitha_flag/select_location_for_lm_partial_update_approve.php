        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Approved Dag update Flagging</h3>
                </div>
                        ...
                        <table class="datatable table table-stripped" id='datatable'>
                            <thead style="font-size:7px">
                                <tr>
                                    ...
                                    <th>Is Char Area</th>    
                                    <th>Is Wetland</th>    
                                    <th>Is Industrial Corridor</th>    
                                    <th>Under NH Acquisition</th>    
                                    <th>Under AsomMala Acquisition</th> 
                                    <th>Is Gramdan</th>
                                    <th>Is Bhoodan</th>                         
                        ...
                        <table id="mapping_datatable" class="table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Is Gramdan</th>
                                    <th>Is Bhoodan</th>
                                    <th>Is Forest Land</th>
                                    <th>Is Prime Agricultural</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                    foreach ($insertedMappingDetails as $key => $value) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$value->industrial_corridor == 8 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->nh_acquisition == 9 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->asom_mala_acquisition == 10 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->gramdan == 11 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->bhoodan == 12 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->bhoodan == 13 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td><?=$value->bhoodan == 14 ? "<span class='text-red'>Yes</span>" : "No";?></td>
                                            <td>-- </td>
                                        </tr>
                               <?php } ?>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="13" style="text-align:center;"><button class="btn btn-primary" type="submit">Forward to CO <i class="fa fa-hand-o-right"></i> </button></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
    ...
    <div class="modal-dialog modal-md ">
        <div class="modal-content login">
            ...
            <div class="modal-body">
                ...
                <h4 style="border-bottom: 5px solid #ff681d;">Chitha Dag Mapping with Area/Zonal Details</h4>
                <div class="row">
                    <div class="col-lg-4">
               ...
               <div class="row mt-2">
                   ...
                   <div class="col-md-6">
                      <select class="form-select" id="MappingSubCat" name="MappingSubCat">
