        ...
        <div class="col-lg-12">
            <div class="panel panel-info panel-form">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Location Details for Chitha Dag Mapping / Flagging</h3>
                </div>
                <div class="panel-body">
                   ...
                   <div class="panel-heading col-lg-12">
                            <h3 class="panel-title text-center font-weight-bold" style="text-transform: uppercase;">Dag Mapping with Chitha</h3>
                        </div>
                    ...
                    <div class="table-responsive" id="areaMappingDiv" >
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $count=1;foreach ($villages as $d) :
                                $color = "#000";
