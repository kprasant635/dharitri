...
<div class="modal  bs-example-modal-lg" id='myLargeModalLabelDagList' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabelDagList">
        ...
        <div class="modal-content login">
            ...
            <div class="modal-body">
                    ...
                    <form id="approveMappingbyCO">
                     ...
                     <div class="row px-5">
                        <b class="text-danger">1) Select Checkbox only for revert the dags, </b>
...
<div class="modal  bs-example-modal-md" id='myLargeModalLabelRevert' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabelRevert">
    <div class="modal-dialog modal-lg ">
        <div class="modal-content login">
            <div class="row text-right">
