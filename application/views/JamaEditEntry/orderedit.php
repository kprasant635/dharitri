                ...
                <div class="panel-body">
                    <form class="form-inline" method="post" >
                                ...
                                <select class="form-control" name="finalorder[lm_code]">
                                    ...
                                    <?php foreach ($mandals as $type): ?>
                                        <?php if ($order->lm_code == $type->user_code): ?>
                                            <option selected value="<?php echo $type->user_code; ?>"><?php echo $type->use_name; ?></option>
                                        <?php else: ?>
                        ...
                        <div class="form-group" style="width: 100%;"> 
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="finalorder[lm_note_date]"
                                       value="<?php echo date('d-m-Y', strtotime($order->lm_note_date)); ?>" class="form-control"      id="applicantNam" 
                                       placeholder="">
                            </div>
                                ...
                                <select class="form-control" name="finalorder[co_code]">
                                    ...
                                    <?php foreach ($cos as $type): ?>
                                        <?php if ($order->co_code == $type->user_code): ?>
                                            <option selected value="<?php echo $type->use_name; ?>"><?php echo $type->use_name; ?></option>
                                        <?php else: ?>
                                            <option value="<?php echo $type->use_name; ?>"><?php echo $type->use_name; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                            </div> 
                        ...
                        <div class="form-group" style="width: 100%;"> 
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="finalorder[co_ord_date]" value="<?php echo date('d-m-Y', strtotime($order->co_ord_date)); ?>" class="form-control"     name="co_ord_date" id="applicantNam" 
                                       placeholder="">
                            </div>
                        </div>
                        <hr>
