        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Add Remarks</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
						...
						foreach($remark as $r):
						?>
						<p class='uni_text'>Remarks Pending for Approval : <span class='small green'><?=$r->r;?></span></p>	
						<?php 
						endforeach;
						} ?>
                        ...
                        <form method='post' enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 alert alert-warning">
                                <center>
                                    <button type="submit" name="submit" class="btn btn-success uni_text"><i class="fa fa-check"></i>&nbsp;Add New Remarks</button>
                                </center>
                            </div>
                        </form>
