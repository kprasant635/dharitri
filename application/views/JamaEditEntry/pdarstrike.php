        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;"> Strike Out Pattadar Name In Chitha / Jamabandi</h2>
                    <h2 class="red" style="text-align: center;">Please select the name to be stricked out from both chitha and jamabandi for better correction.</h2>
                </div>
            </div>   
            ...
            <?php 
                if($insert){
                    echo'<div class="col-lg-10 col-lg-offset-1">
                            <div class="well well-sm">
                            <p class="uni_text red">Some Of Already Requested Strike Out Name(s) pending  for COs approval </p>';
                            foreach($insert as $r):
                            ?>
            ...
            ?>
            <form class="form-horizontal" enctype="multipart/form-data" role="form" action='<?= base_url();?>index.php/jamaeditentry/deopdarstrikebothways' method="post">
            <div class="col-lg-5 col-lg-offset-1">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Request For Pattadar Name Strike Out (Jamabandi)
                        </h3>
                    </div>
            ...
            <div class="col-lg-5">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Pattadar Name Strike Out (Dag)
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-sm-12" style='height:320px; overflow-y: scroll;'>
