                    ...
                    <form class="form-inline"  method="post" action="">
                        ...
                        <div class="form-group" style="width: 100%;">
                            ...
                            <div class="form-group" style="width: 100%;">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"   name="dag_no_int" id="applicantNam" 
                                           placeholder="">
                                </div>
                            ...
                            <hr>
                            <div class="form-group" style="width: 100%;">
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA B</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_b" id="applicantNam" 
                                           placeholder="">
                                </div>
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA K</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_k" id="applicantNam" 
                                           placeholder="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group" style="width: 100%;">
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA LC</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_lc" id="applicantNam" 
                                           placeholder="">
                                </div>
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA G</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_g" id="applicantNam" 
                                           placeholder="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group" style="width: 100%;">
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA KR</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_kr" id="applicantNam" 
                                           placeholder="">
                                </div>
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG AREA ARE</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_area_are" id="applicantNam" 
                                           placeholder="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group" style="width: 100%;">
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG REVENUE</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_revenue" id="applicantNam" 
                                           placeholder="">
                                </div>
                                <label for="inputEmail3" class="col-sm-2 uni_text control-label " id='applicant_name_label'>DAG LOCAL TAX</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_local_tax" id="applicantNam" 
                                           placeholder="">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group" style="width: 100%;">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control"     name="dag_no_map" id="applicantNam" 
                                           placeholder="">
                                </div>
