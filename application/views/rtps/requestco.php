	...
	<tr>
		...
		<td>
			<?php if($pen->service_code=='1'){ ?>
				<?php if(($pen->allow_reapply=='A')){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/inheritanceBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'></i> Action</a>
			...
			<?php } else if($pen->service_code=='5'){ ?>
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/allotmentBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i> Action</a>
			...
			<?php }else if($pen->service_code=='3'){ ?>
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/partitionBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i> Action</a>
				<?php }else{ ?>
			...
			<?php }else if($pen->service_code=='9'){ ?>
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/conversionBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i>Action</a>
				<?php }else{ ?>
			...
			<?php }else if($pen->service_code=='4'){  ?>
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/reclassBasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i> Action</a>
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/inheritanceBasuCO?app=<?=$pen->application_no?>' class="btn btn-sm  btn-info"><i class='fa fa-check-square-o'></i> View</a>
				<?php } ?>
			...
			<?php }else if($pen->service_code=='7'){  ?>
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/areaCorrectionbasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i> Action</a>
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/inheritanceBasuCO?app=<?=$pen->application_no?>' class="btn btn-sm  btn-info"><i class='fa fa-check-square-o'></i> View</a>
				<?php } ?>
			...
			<?php }
				...
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/nameCorrectionbasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'></i> Action</a>
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/inheritanceBasuCO?app=<?=$pen->application_no?>' class="btn btn-sm  btn-info"><i class='fa fa-check-square-o'></i> View</a>
				<?php } ?>
			...
			<?php }
				...
				<?php if(($pen->allow_reapply=='A') ){ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/nameCancelbasu?app=<?=$pen->application_no?>' class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i>Action</a>
				<?php }else{ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/inheritanceBasuCO?app=<?=$pen->application_no?>' class="btn btn-sm  btn-info"><i class='fa fa-check-square-o'></i> View</a>
				<?php } ?>
			...
			<?php }else if($pen->service_code=='10'){ ?>
				<?php if(($pen->allow_reapply=='A') ){ 
					   ...
					   <?php }
						...
						<a href='<?php echo base_url() ?>index.php/rtps/mobileUpdationBasu?app=<?=$pen->application_no?>'class="btn btn-sm  btn-primary"><i class='fa fa-check-square-o'> </i>Action</a>
					<?php } 
					}
					else{ ?>
					<a href='<?php echo base_url() ?>index.php/rtps/mobileUpdationBasuCO?app=<?=$pen->application_no?>' class="btn btn-sm  btn-info"><i class='fa fa-check-square-o'></i> View</a>
