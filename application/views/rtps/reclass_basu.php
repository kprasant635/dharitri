                    ...
                    <div class="panel-body">
                      ...
                      <table class="table">
                         ...
                         <tr class="bg-success">
                          ...
                          if(in_array($dist_code, json_decode(BARAK_VALLEY))){?>
                               <td colspan="4"><?=$app->area_b;?>B-<?=$app->area_k;?>K-<?=$app->area_l;?>C-<?=$app->area_g;?>G </td>
                            <?php }

                          else{?>
                            <td colspan="2"><?=$app->area_b;?>B-<?=$app->area_k;?>K-<?=$app->area_l;?>L </td>
                          <?php }?>
                      ...
                      <?php if($query){
                        ...
                        if(in_array($dist_code, json_decode(BARAK_VALLEY))){?>
                          ...
                          <div class="form-group">
                                <div class="col-sm-12">
                                    <textarea name="co_report" class="form-control" rows="5"> জমি পুনর্বিন্যাসের জন্য ভূমিলেখ্য সহায়কর রিপোর্ট জমা দেওয়া হয়েছে ।</textarea>
...
<script type="text/javascript">
  $(document).ready(function(){
	// console.log($('input[name="dob"]').clone()[0]);
