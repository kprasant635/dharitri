                ...
                <div class="panel panel-info panel-form">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Registration of <kbd>Area Correction (<?=$_GET['app']?>)</kbd>
                        </h3>
                    </div>
                      ...
                      <div class="row">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="p_loc_tax" placeholder="" name="" readonly>
                                </div>
                            </div>
                          </div>
...
<form class="hiddenSections"></form>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    const aadhaarTypeEl = $('input[name="auth_type"]')[0];
    ...
    $('.hiddenSections').append(aadhaarTypeEl);
  ...
  $('#formAjaxPost').on('submit', function(event){
    ...
    if($("#reapply_remark").val().trim().length < 1)
    {
      ...
      setTimeout(() => {
        $('.form__submit_btn').attr('disabled', false);
      }, 200)
      return; 
    }
    var p_land = $("#P_land");
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'rtps/areacorrectPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
            ...
            error: function(errorData){
                ...
                if(errorData.status == 403){
                    ...
                    $('#msg').html(`<div class="alert alert-danger text-center"> ${errorInJson} </div>`);
                }else{
