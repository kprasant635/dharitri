        ...
        <div class="col-lg-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Partial Flagging of Dags</h3>
                </div>
                <div class="panel-body">
                    <form method="POST" action="" id="dagFlaggingPartialForm">
                        ...
                        <div class="container">
                            <div class="form-group" style="margin-bottom: 80px;">
                                <div class="col-md-4">
                                    <label>Select Dag Flagging Category</label>
                                </div>
                                <div class="col-md-4">
                                    <select class="form-select" id="FlaggingDag" name="FlaggingDag[]">
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td width="40%"><label class="selectLabel2">Selected Dags with Category</label>
...
<script type="text/javascript">
    ...
    $('#dagFlaggingPartialForm').submit(function(e) {
        ...
        $.ajax({
            url: baseurl + "Dagflag/dagFlaggingPartialSubmit",
            type: 'POST',
            data: $("#dagFlaggingPartialForm").serialize(),
            dataType: 'json',
    ...
    function moveToRight() {
        ...
        var cat = $("#FlaggingDag option:selected").text();
        var catVal = $("#FlaggingDag").val();
        var selectedValCat;
