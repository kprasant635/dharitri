        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-warning text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Location Details for Update Rural/Urban Flag (Reverted from CO)</h3>
                </div>
                <div class="panel-body">
                    <form method="POST" action="" id="PartialDagFlaggingFormRevertRuralUrban">
                        ...
                        <div class="container">
                            ...
                            <div>
                                <div class="row" style="margin-bottom: 24px;">
                                    <strong class="text-danger">NOTE: Move left for selection of dags with correct flagging category.</strong>
                                </div>
                                <table>
                                    <tr>
                                        <td width="20%">
                                        ...
                                        <td width="60%"><label class="selectLabel2">Dags With Already Selected Category</label>
                                            <select class="form-control" id='list2' name="list2" size="200" multiple>
                                                <?php foreach ($daginfo as $dags) : ?>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $dag_no . "@" . $dags->ru_flag; ?>"><?php echo $dag_no; ?> - <?= $dags->rural_urban ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    ...
    $('#PartialDagFlaggingFormRevertRuralUrban').submit(function(e) {

        // alert("PartialDagFlaggingFormRevertRuralUrban");
        // return;
        ...
        $.ajax({
            url: baseurl + "Dagflag/partialFlaggingSubmitRevertLMRuralUrban",
            type: 'POST',
            data: $("#PartialDagFlaggingFormRevertRuralUrban").serialize(),
            dataType: 'json',
