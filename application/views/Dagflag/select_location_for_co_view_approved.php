        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Mapping Details Village Wise Approved List (Partial Mapping)</h3>
                </div>
                    ...
                    <div class="container">
                        ...
                        <div style="max-height: 440px;overflow-y: scroll;">
                            ...
                            <?php foreach ($daginfo as $dags): ?>
                                ...
                                $area = $dags->area;
                                ?>
                                <li style="border: 1px solid #ebebeb;padding: 10px;"><b><i class="fas fa-venus text-warning mx-2"></i> <span class="labelDag"> <?php echo $dag_no; ?></span> <i class="fas fa-male text-info mx-2"></i> <?=$area?> </b></li>
                            <?php endforeach; ?>
                        </ul>
