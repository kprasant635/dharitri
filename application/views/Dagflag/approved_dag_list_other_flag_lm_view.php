        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Dag Flagging Details Village Wise Approved List (Partial Mapping)</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="container">
                        <ul class="list-group">
                            <li style="background-color: #01ff709c; border: 1px solid #ebebeb;padding: 14px;"><b>Dag No. with Approved Flagging Category </b></li>
                        </ul>
                        <div style="max-height: 440px;overflow-y: scroll;">
                            <ul class="list-group">
                                <?php foreach ($daginfo as $dags) : ?>
                                    ...
                                    $flag = $dags->flag_name;
                                    ?>
                                    <li style="border: 1px solid #ebebeb;padding: 10px;"><b><i class="fa fa-check-circle mx-2" style="font-size:20px"></i> <span class="labelDag"> <?php echo $dag_no; ?></span> <i class="fas fa-flag text-success mx-2"></i>( <?= $flag ?> ) </b></li>
                                <?php endforeach; ?>
                            </ul>
            ...
            <?php
            $backLink = 'Dagflag/approvedListMapping';
