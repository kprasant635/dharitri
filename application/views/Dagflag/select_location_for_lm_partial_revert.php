        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Location Details for Update Flag (Revert Partial Mapping)</h3>
                </div>
                <div class="panel-body">
                    <form method="POST" action="" id="PartialMappingFormRevert">
                    ...
                    <div class="container">
                        ...
                        <div>
                            <div class="row" style="margin-bottom: 24px;">
                                <b class="text-danger">NOTE: Move left for selection of dags with correct mapping category. Once selection done completely update button will appear.</b>
                            </div>
                            <table>
                                <tr>
                                    <td width="20%">
                                    ...
                                    <td width="60%"><label class="selectLabel2">Selected Dags with Category</label>
                                        <select class="form-control" id='list2' name="list2"  size="200" multiple>
                                            <?php foreach ($daginfo as $dags): ?>
                                                ...
                                                ?>
                                                <option value="<?php echo $dag_no."@".$dags->cat; ?>"><?php echo $dag_no; ?> - <?=$dags->area?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    ...
    $('#PartialMappingFormRevert').submit(function (e) {
        ...
        $.ajax({
            url: baseurl + "Dagflag/partialMappingSubmitRevert",
            type: 'POST',
            data: $("#PartialMappingFormRevert").serialize(),
            dataType: 'json',
