        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                <div class="panel-heading bg-success text-white  my-2">
                    <h3 class="panel-title text-center font-weight-bold">Location Details for Update Chitha Flag (Rural/Urban Flags)</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group text-center">
                        <button type="button" class="btn btn-success approveRuralUrbanFlag" id="<?php echo $datas['uuid']; ?>"><i class='fa fa-check'></i> Approve Rural/Urban</button>
                        <button type="button" class="btn btn-danger revertRuralUrbanFlag" id="<?php echo $datas['uuid']; ?>"><i class='fa fa-times-circle'></i> Revert Rural/Urban</button>
                    </div>
                </div>
                <div class="container">
                    <ul class="list-group">
                        <li style="background-color: #faffb1; border: 1px solid #ebebeb;padding: 14px;"><b>Dag No. and Rural/Urban FLagging Category </b></li>
                    </ul>
                    <div style="max-height: 440px;overflow-y: scroll;">
                        ...
                        <ul class="list-group">
                            ...
                            <?php foreach ($daginfo as $dags) : ?>
                                <?php
                                $dag_no = $dags->dag_no;
                                $flag = $dags->rural_urban;
                                ?>
                                <li style="border: 1px solid #ebebeb;padding: 10px;"><b><i class="fas fa-venus text-warning mx-2"></i> <span class="labelDag"> <?php echo $dag_no; ?></span>&nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-map-marker "></i> <?= $flag ?> </b></li>
                            <?php endforeach; ?>
                        </ul>
...
<script type="text/javascript">
    ...
    $('.approveRuralUrbanFlag').click(function(e) {
        var id = $(this).attr("id");
        var uuid = id;
        ...
        $.ajax({
            url: baseurl + "Dagflag/approveRuralUrbanFlaggingCO",
            type: 'post',
            dataType: 'json',
            data: {
                uuid: uuid,
    ...
    $('.revertRuralUrbanFlag').click(function(e) {
        ...
        $.ajax({
            url: baseurl + "Dagflag/revertRuralUrbanFlaggingCO",
            type: 'post',
            dataType: 'json',
            data: {
                uuid: uuidRevert,
