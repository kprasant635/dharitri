        ...
        <div class="panel casedisplay">
            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    <tr>
                        <td>Dag Mapping/Flagging </td>

                        <?php
                        $link = base_url() . "index.php/Dagflag/locationDetails";
                        ?>
                    ...
                    <tr>
                        <td>Revert Mapping Details</td>


                        <?php
                        $link = base_url() . "index.php/Dagflag/RevertMappingVillages";
                        ?>
                        <td><a class="pull-right green" href="<?php echo $link; ?>"><?php echo $this->lang->line('view') ?></a></td>
                    </tr>
