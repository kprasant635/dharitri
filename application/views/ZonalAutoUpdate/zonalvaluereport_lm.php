        ...
        <div class="panel casedisplay">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4 class="text-center">Zonal Value Report</h4>
                </div>
            </div>
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td><b class="bg-yellow">Zonal Value Mising Report Download<i class="fa fa-download"></i></b> <sup class="red">New</sup></td>
                        <td>

                        </td>
                        <?php
                        $link = base_url() . "index.php/ZonalByforcationController/zonalDetailsMissingReportLM";
                        ?>
                    ...
                    <tr>
                        ...
                        <?php
                        $link = base_url() . "index.php/ZonalByforcationController/zonalValueCertificateReportLM";
                        ?>
                        <td><a class="pull-right green" href="<?php echo $link; ?>">Download</a></td>
                    </tr>
                        ...
                        <?php else : ?>
                            <td>
                                <?php if (($document->is_active == 'R')) : ?>
                                    <small class="text-danger">Zonal Details Report Reverted by CO</small>
                                    <h6>Reupload Verified Report <i class="fa fa-upload"></i> <sup class="red">New</sup></h6>
                                <?php elseif (($document->is_active == 'E')) : ?>
                                    <h6>Zonal Details Report Sent for CO verification </h6>
                                <?php elseif (($document->is_active == 'A')) : ?>
                                    <h6>Zonal Details Report Verified by CO </h6>
                                <?php endif; ?>
                            </td>
                        <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        $('#upload').on('click', function() {
            ...
            $.ajax({
                url: base_url + 'index.php/ZonalByforcationController/uploadZonalReportLM',
                dataType: 'text',
                cache: false,
                contentType: false,
                processData: false,
