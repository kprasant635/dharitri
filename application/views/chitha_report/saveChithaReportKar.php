...
<div class='chitha_report container-fluid'>
    ...
    <center>       
        <table class="table" id='table1'>
         ...
         <?php if($application_no) echo "<p>Application No.:&nbsp; ". $application_no . "&nbsp;   Dated:".date('d/m/Y')."</p>"; ?>
    </center>
    <br/>
                    ...
                    <table class="table table_black" id='table2'  >
                        <tr >
                            ...
                            <td align=center rowspan="2" style="width:150px;"> <!--AREA COL. 3-->
                                কালি <br>( বি-কা-ছ-গ )</td>
                            <td align=center rowspan="2" style="width:150px; "> &nbsp;পাট্টা  
                                নং এবং প্ৰকার</td>
                        ...
                        <tr >
                            ...
                            <td align='center' > 
								...
								echo $this->utilityclass->cassnum($chithainf['dag_area_b']) . '-' . $this->utilityclass->cassnum($chithainf['dag_area_k']) . '-' . $this->utilityclass->cassnum($chithainf['dag_area_lc']).'-'.$this->utilityclass->cassnum($chithainf['dag_area_g']);
                                ?>
                            </td>
                            <td align='center' > 
                                <?php
