                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url() . 'index.php/chithareport/generateDagChitha' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control lotselectflag" id="select" required name="lot_no">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control villageselectflagged" id="select" required name="vill_code">
