    ...
    if (isset($chithainf['col8'])) {
        ...
        foreach ($chithainf['col8'] as $clmn8):
            ...
            <p>চক্ৰ বিষয়াৰ  <br> <?php echo $this->utilityclass->cassnum($formatDate); ?> তাৰিখৰ 
                ...
                echo ($order_type=='13'?" ৰায়তী স্বত্ব ": $order_type ). ' নং ' . $case_no . '-ৰ ' . ' হুকুমমৰ্মে এই দাগৰ ' . $bigha . $katha . $lesa . ' জমিত ';
                //var_dump($clmn8['inplace']);
                if($order_type_code==SETTLEMENT_TENANT_ID){
                    echo "অসম অস্থায়ী বন্দৱস্তি এলেকাৰ ৰায়তী স্বত্ব আইনৰ অধীনত ৰায়তীৰ দ্বাৰা মালিকিস্বত্ব লাভৰ সূত্ৰে "; 
                    if($clmn8['inplaceofriotee'])
                        echo $clmn8['inplaceofriotee'] . " পট্টাদাৰৰ স্থলত ";
                    if($clmn8['alongwithriotee'])
                        echo $clmn8['alongwithriotee'] . " পট্টাদাৰৰ লগত ";
                    if($clmn8['riotee'])
                    echo $clmn8['riotee'];
                    echo "ৰ নামত নামজাৰি কৰি নথি সংশোধন কৰা হ’ল৷";
                }
                ...
                foreach ($clmn8['occup'] as $in) {
                    ...
                    if(MULTIGENERATION_ACTIVE ==1 && $in['multigenFlagVal'] =='M')
                    {
                        ...
                        echo $in['occupant_fmh_name'] . "'ৰ"; echo " স্হলত ";
                        }
                ...
                if (($clmn8['deed_reg_no'] != "")) {
                    ...
                    if ($interval->days > 0) {
						//Bondita 13/9/19
						$deed_d = date('d-m-y', strtotime($clmn8['deed_date']));
                        if($deed_d=="1900-01-01 00:00:00"){
                            $deed_d="";
                        }else{
                           $deed_date=  $this->utilityclass->cassnum($deed_d);
                        }
                        
                        echo $lebel_two . $deed_date . " ";
        ...
        if (($operation == 'B') and ($order_type_code == "01")){
            echo "ভূমিলেখ্য সহায়কৰ প্ৰতিবেদনৰ ভিত্তিত উপৰোক্ত বকেয়া নামজাৰী ও নথি সংশোধন অনুমোদন / নাকচ কৰা হ’ল ।  ";
            echo "<br><u class='text-danger'> চঃ বিঃ –  ".$co_name."</u>";
        }elseif (($operation == 'B') and ($order_type_code == "02")){
            echo "ভূমিলেখ্য সহায়কৰ প্ৰতিবেদনৰ ভিত্তিত উপৰোক্ত আপোচ বাটোৱাৰা ও নথি সংশোধন  কৰা হ’ল ।  ";
            echo "<br><u class='text-danger'> চঃ বিঃ –  ".$co_name."</u>";
        }
        ?>
        <?php
