...
foreach ($data as $chithainf):
    ...
    if (isset($chithainf['col8'])) {
        foreach ($chithainf['col8'] as $clmn8):
            ...
            $mpdf->WriteHTML('<p><u class="text-danger">ভূমিলেখ্য সহায়ক :</u><br>(' . $clmn8['lm_name'] . ')</p>');
        ...
        foreach ($remark as $r) {
            ...
            if (sizeof($r) > 0) {
                ...
                if ($r['ord_type_code'] == '06') {
                    ...
                    $mpdf->WriteHTML('<p>ভূমিলেখ্য সহায়ক :</p>');
                ...
                if (($r['remark_type_code'] == '01') && ($r['ord_type_code'] == '03')) {
                    ...
                    $mpdf->WriteHTML('<p><u class="text-danger">ভূমিলেখ্য সহায়ক :</u><br>(' . $r['lm_name'] . ')</p>');
                    ...
                    if (($r['remark_type_code'] == '01') && ($r['ord_type_code'] == '04')) {
                        ...
                        if ($howmany != null) {
                            ...
                            //endif;
                            $mpdf->WriteHTML('<p><u class="text-danger">ভূমিলেখ্য সহায়ক :-</u>(' . $r['lm_name'] . ')</p>');
