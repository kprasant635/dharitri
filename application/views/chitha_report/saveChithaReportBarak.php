...
<div class='chitha_report container-fluid'>
    ...
    <center>
        <div id="table_head">
            <p style="margin-top: 1; margin-bottom: 0;text-align: center;"><font face="Verdana" size="5">Chitha for Surveyed Villages / জৰীপ হোৱা গাঁৱৰ চিঠা</font></p>
            <br>
        </div>
        <?php 
         if($single_dag=='1')
         ...
         <div class="text-right"> 
                <a target="blank" href='<?php echo base_url() ?>index.php/chithareport/viewDownloads?uuid=<?php echo $uuid['uuid'] ?>&dag_no=<?php echo $dag_no_original[0]; ?>' class="btn btn-success">
                ...
                <div align="center" class="col-lg-12 table-responsive">
                    <table class="table" id='table3' STYLE="width:100%; border-collapse:collapse" cellPadding=0 cellSpacing=0 height="580">
                        <tr>
                            ...
                            <td align="center" rowspan="2" valign="top" height="127" width="15%">
                            নামজাৰী হবলগী<span lang="as">য়া</span> দখলদাৰৰ নাম, পিতাৰ নাম, ঠিকনা
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" height="100">কালি 
                            <?php if(in_array($this->session->userdata('dist_code'),json_decode(BARAK_VALLEY))){ ?>
                                (বি-ক-ছ-গো)
                            <?php } else { ?>
                                (বি-ক-)
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" height="100" id=chitha_col_17>
                                ...
                                foreach ($chithainf['mcrp_akeadhig'] as $key => $mcrop_ekadhig):
                                    ...
                                    echo $chithainf['mcrp_akeadhig'][$key]['bigha'] . '-' . $chithainf['mcrp_akeadhig'][$key]['katha'] . '-' . $chithainf['mcrp_akeadhig'][$key]['lesa'];
                                    if(in_array($this->session->userdata('dist_code'),json_decode(BARAK_VALLEY))){
                                        echo '-' . $chithainf['mcrp_akeadhig'][$key]['ganda'] . '<br>';
                                    }
                                    else {
                                        echo '<br>';
                                    }
                            ...
                            <td align="left" valign="top"  height="409" rowspan=3 id=chitha_col_30> <!--FRUIT-->
                                ...
                                foreach ($chithainf['fruit'] as $key => $fruit):
                                    ...
                                    echo $chithainf['fruit'][$key]['fruitname'] . '<br>' . $chithainf['fruit'][$key]['no_of_plants'] . '<br>' . '(' . $chithainf['fruit'][$key]['fbigha'] . '-' . $chithainf['fruit'][$key]['fkatha'] . '-' . $chithainf['fruit'][$key]['flesa'];
                                    if(in_array($this->session->userdata('dist_code'),json_decode(BARAK_VALLEY))){
                                        echo '-' . $chithainf['fruit'][$key]['fganda'] . ')' . '<br>';
                                    }
                                    else {
                                        echo '<br>';
                                    }
