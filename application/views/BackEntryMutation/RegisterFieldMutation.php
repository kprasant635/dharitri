        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <h2 style="text-align: center;">Field Mutation ( Back Log Entry )</h2>
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                    ...
                    <div class="panel-body">
                        <form class='form-horizontal' id='myForm' action="<?php echo base_url() . "index.php/BackLogMutation/RegisterFMutation"; ?>" method="post">
                        <div id="itemRows">
                        ...
                        <label class="rasid">Address : </label><label><input type="text" name="add_1[]" class="form-control" /></label> <br><br>
                        
                        <label class="rasid">Individual Share  &nbsp;:</label>&nbsp;<label><input type="text" name="inv_b[]" class="" placeholder="0 Bigha" /></label>
                        <label><input type="text" name="inv_k[]" class="" placeholder="0 Katha" /></label>
                        <label><input type="text" name="inv_lc[]" class=""  placeholder="0 Lesa" /></label>
                         <?php
                        $dist_code = $this->session->userdata('dist_code');
                        if(in_array($dist_code, json_decode(BARAK_VALLEY))){?>
                        <label><input type="text" name="inv_g[]" class=""  placeholder="0 Ganda" /></label>
                    <?php }?>
                        <label class="rasid">(if Known)</label>
                        </div>
