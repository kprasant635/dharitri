            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm mis_report">
                    <h2 style="text-align: center;">
                        <?php
                            echo 'Pending Cases For Back Log Field / Office Mutation';
                        ?>
                    </h2>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            if($type=='FMUT-BL'){
                                                $mut_type = 'F';
                                                ?>
                                                <a  id='co-order' href='<?php echo base_url() . "index.php/BackLogMutation/FinalFOrder?case_no=" . $case->case_no . "&dist_code=" . $case->dist_code . "&subdiv_code=" . $case->subdiv_code . "&cir_code=" . $case->cir_code . "&mouza_pargona_code=" . $case->mouza_pargona_code . "&lot_no=" . $case->lot_no . "&vill_townprt_code=" . $case->vill_townprt_code. "&mut_type=" . $mut_type; ?>' class="btn btn-sm btn-success"><?php echo $this->lang->line('pass_order');?></a>
                                                <?php
                                            } else {
                                                $mut_type = 'O';
                                                ?>
