                            ...
                            foreach ($MisCases AS $cases) 
                            {
                                ...
                                <tr>
                                   ...
                                   <td>Trace Map</td>
                                    ...
                                    <td class="center"><a href="<?php echo base_url() . "index.php/Tracemap/COStep2"; ?>?case_no=<?php echo $cases->case_no; ?>" class="btn btn-sm btn-primary"> <?php echo $this->lang->line('pass_order');?></a></td>
                                </tr>
                                <?php
                                $c++;
                            }
