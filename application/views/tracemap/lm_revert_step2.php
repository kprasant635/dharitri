                       ...
                       <form class="form-horizontal" method='post' id="lm_save" enctype="multipart/form-data">
                        ...
                        <?php
                         ...
                         <div class="row">
                                 ...
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                                    <textarea name="lmremark" class="form-control" rows="5" readonly=""> <?php echo $cormk->co_order; ?></textarea>
                                 </div>
                              </div>
                              <br/>
                              <div class="row">
                            ...
                            <div class="row">
                                 <div class='col-lg-3 col-md-6 col-sm-6 col-xs-12 mmm'>
                                    <label for="inputEmail" class=" control-label">Previous Remark(LM)</label>
                                 </div>
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                        ...
                        <?php if(isset($sup_doc) && sizeof($sup_doc)>0) { ?>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><span class="text-red bold">VIEW Previously Uploaded <?=$doc->file_name?></span></td>
                                            <td>
                            ...
                            <div class="row">
                                 ...
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                                    <textarea name="lmremark" class="form-control" rows="5"> </textarea>
                                 </div>
                              </div>
