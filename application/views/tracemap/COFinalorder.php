                        ...
                        <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='example' width="100%">
                            ...
                            foreach ($MisCases AS $cases) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="center"><a href="<?php echo base_url() . "index.php/Tracemap/COFinalOrderPass"; ?>?case_no=<?php echo $cases->case_no; ?>" class="btn btn-sm btn-primary"> <?php echo $this->lang->line('pass_order');?></a></td>
