                   ...
                   foreach($firstParty as $fp): ?>
                              ...
                              <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 mmm'>
                                <div class="row">
                                 ...
                                 <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>
                                     <input type="text" name="applname" class="form-control" value="<?=$fp->pat_name_ass;?>"/>
                                 </div>
                              </div>
                            </div>
                              ...
                              <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 mmm'>
                                <div class="row">
                                 ...
                                 <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>
                                    <input type="text" name="fathername" class="form-control" value="<?=$fp->pat_gurdian_name_ass;?>"/>
                                 </div>
                              </div>
                            </div>
                          <?php endforeach; ?>
                          <?php foreach($firstParty as $fp): ?>
                            ...
                            <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 mmm'>
                                <div class="row">
                                 ...
                                 <div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>
                                    <input type="number" name="mobile" class="form-control" value="<?=$fp->pat_mobile_no;?>"/>
                                 </div>
