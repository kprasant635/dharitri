    ...
    <div class="row">
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
               <div class="p-2 my-2 rounded center" style="background-color: #20c997;font-size: 25px;font-weight: 700">
                    Trace Map Cases
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <table class='table table-striped table-bordered tablesorter  pageshowpage unicode' id='example' width="100%">
                            ...
                            foreach ($MisCases AS $cases) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $cases->case_no; ?><br><span class='small font-italic red'><?php if($cases->basundhara){ echo "Basundhara:". $cases->basundhara ;} ?> </span>
                                    </td>
                                   <td>Trace Map</td>
                                    <td class="center"><i class='fa fa-calendar'></i> Submited On <?php echo date("d-m-Y", strtotime($cases->submission_date)); ?></td>
                                    <td class="center"><a href="<?php echo base_url() . "index.php/Tracemap/LmRevertstep2"; ?>?case_no=<?php echo $cases->case_no; ?>" class="btn btn-sm btn-primary"> <?php echo $this->lang->line('pass_order');?></a></td>
                                </tr>
                                <?php
                                $c++;
                            }
