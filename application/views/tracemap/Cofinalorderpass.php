        ...
        <div class="col-lg-12 ">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="p-2 my-2 rounded center" style="background-color: #607d8b;font-size: 25px;font-weight: 700">
                    Circle Officer's Final Order on Trace Map 
                </div>
            </div>
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-info panel-form">
                   <div class="panel-heading" style="background-color: #00838F">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method='post' action="<?php echo base_url() . "index.php/Tracemap/COFinalOrderPass_save"; ?>">   
                        ...
                        <?php
                            ...
                            <div class="row">
                                 ...
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                                    <textarea name="lmremark" class="form-control" rows="5" readonly=""> <?php echo $lmrmk->co_order; ?></textarea>
                                 </div>
                              </div>
                              <br/>
                            <div class="row">
                                 <div class='col-lg-3 col-md-6 col-sm-6 col-xs-12 mmm'>
                                    <label for="inputEmail" class=" control-label">SK Remark</label>
                                 </div>
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                                    <textarea name="lmremark" class="form-control" rows="5" readonly=""> <?php echo $skrmk->co_order; ?></textarea>
                                 </div>
                              </div>
                              <br/><br/>
                              <?php
                ...
                <?php
                            ...
                            <div class="row">
                                 <div class='col-lg-3 col-md-6 col-sm-6 col-xs-12 mmm'>
                                    <label for="inputEmail" class=" control-label">Final Remark</label>
                                 </div>
                                 <div class='col-lg-9 col-md-6 col-sm-6 col-xs-6'>
                                    <textarea name="fcoremark" class="form-control" rows="5"> </textarea>
                                 </div>
                              </div>
                        ...
                        <?php if(!empty($app->basundhara)){ ?>
                          ...
                          <button class="btn rejectTMR btn-sm btn-danger"><i class='fa fa-close'></i>&nbsp;Reject</button>
                          <button class="btn revertToLmForReportR btn-sm btn-success"><i class='fa fa-arrows-alt'></i> Revert to LM</button>&nbsp;
                            <br><br>
                           <a href="<?php echo base_url(); ?>index.php/home/index" class="btn btn-sm btn-warning" style="background-color: #f0ad4e;color: white;">
                            ...
                            <div class="form-group">
                                <div class="text-center">
                                 <button type="submit" name="FormSubmit" class="btn btn-sm btn-primary"><i class='fa fa-check'></i>&nbsp;Approve</button>
                                <button class="btn rejectTM btn-sm btn-danger"><i class='fa fa-close'></i>&nbsp;Reject</button>
...
<div id="rejectTMR" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="rejectTM" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Rejection reason</h5>
...
<div id="revertToLmForReport" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id='' action="<?php echo base_url() ?>index.php/Tracemap/revertToLm" method="post">
            <div class="modal-body">
              <input type="hidden" class="form-control" name='case_no' value="<?php echo $case_no; ?>"> 
                <textarea name='coremark' class="form-control">Reason for revert</textarea> 
                <textarea name="co_report_suffix" class="form-control hide" rows="5"></textarea> 
...
<div id="revertToLmForReportR" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Revert to LM reason</h5>
