                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" name="form" method='post' action="<?php echo base_url()."index.php/LandReclassification/LMConvertionType";?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control districtselect" id="LmMutationSelectDistrict" name="" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control subdivselect" id="select" name="" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control circleselect" id="select"  name="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control mouzaselect" id="select"  name="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control lotselect" id="select"  name="">
                                    <?php 
