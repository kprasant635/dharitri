            ...
            <div class="card-body">
                ...
                2. Uploaded file size should not be more than 4MB"></i>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <table class="table table-striped table-bordered">
                                <tbody id='certi_tab'>
                                        ...
                                        <td>
                                            <?php if (!empty($doc1_id)) {
                                                if ($doc1_id->doc_flag != '' || $doc1_id->doc_flag != null) { ?>
                                                    <div id="div_death">
                                                        <a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/chithareport/downloadDocuments?doc_flag=<?php echo $doc1_id->doc_flag ?>&uuid=<?php echo $doc1_id->uuid ?>&dag_no=<?php echo $doc1_id->dag_no ?>' target="_blank"><button class="btn btn-sm btn-primary" type="button">View <?= ucfirst($doc1_id->file_name) ?></button></a>
                                                    </div>
                                                <?php }
                                            } else { ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($doc2_id)) {
                                                if ($doc2_id->doc_flag != '' || $doc2_id->doc_flag != null) { ?>
                                                    <div id="div_noc">
                                                        <a style="text-decoration: none;" href='<?php echo base_url() ?>index.php/chithareport/downloadJamabandiDocuments?doc_flag=<?php echo $doc2_id->doc_flag ?>&uuid=<?php echo $doc2_id->uuid ?>&patta_no=<?php echo $doc2_id->patta_no ?>&patta_type_code=<?php echo $doc2_id->patta_type_code; ?>' target="_blank"><button class="btn btn-sm btn-primary" type="button">View <?= ucfirst($doc2_id->file_name) ?></button></a>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($doc3_id)) {
                                                if ($doc3_id->doc_flag != '' || $doc3_id->doc_flag != null) { ?>
                                                    <div id="div_kha">
                                                        <a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/chithareport/downloadKhatianDocuments?doc_flag=<?php echo $doc3_id->doc_flag ?>&uuid=<?php echo $doc3_id->uuid ?>&khatian_no=<?php echo $doc3_id->khatian_no ?>' target="_blank"><button class="btn btn-sm btn-primary" type="button">View <?= ucfirst($doc3_id->file_name) ?></button></a>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($doc4_id)) {
                                                if ($doc4_id->doc_flag != '' || $doc4_id->doc_flag != null) { ?>
                                                    <div id="div_touzi">
                                                        <a style="text-decoration: none;" href='<?php echo base_url() ?>index.php/chithareport/downloadDocuments?doc_flag=<?php echo $doc4_id->doc_flag ?>&uuid=<?php echo $doc4_id->uuid ?>&dag_no=<?php echo $doc4_id->dag_no ?>' target="_blank"><button class="btn btn-sm btn-primary" type="button">View <?= ucfirst($doc4_id->file_name) ?></button></a>
                                    ...
                                    <tr>
                                        <td><span class="text-bold"> <input type="hidden" required="" id="doc4" name="doc4" value="touzi" />Additional Document (if Any)</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($doc5_id)) {
                                                if ($doc5_id->doc_flag != '' || $doc5_id->doc_flag != null) { ?>
                                                    <div id="div_addi">
                                                        <a style="text-decoration: none;" href='<?php echo base_url() ?>index.php/chithareport/downloadDocuments?doc_flag=<?php echo $doc5_id->doc_flag ?>&uuid=<?php echo $doc5_id->uuid ?>&dag_no=<?php echo $doc5_id->dag_no ?>' target="_blank">
                                                            <button class="btn btn-sm btn-primary" type="button">
                                                                View <?= ucfirst($doc5_id->file_name) ?></button></a>
                                                    </div>
                                                <?php }
                                            } else { ?>
                                                No Documents uploaded yet<?php } ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                            <br>
                            <a href="<?php echo base_url(); ?>index.php/home" class="btn btn-danger text-light">
    ...
    $('.uploadOMutDocumentCO').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.flag_set == '1') {
                    $('#div_death').html('');
                    $('#file_1').html('<a class="btn btn-sm btn-info" type="button" style=" text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments/' + data.doc_id + '" target="_blank">View ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="1">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }
                if (data.flag_set == '2') {
                    $('#div_noc').html('');
                    $('#file_2').html('<a class="btn btn-sm btn-info" type="button" style=" text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments/' + data.doc_id + '" target="_blank">View ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="2">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }

                if (data.flag_set == '3') {
                    $('#div_kha').html('');
                    $('#file_3').html('<a class="btn btn-sm btn-info" type="button" style=" text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments/' + data.doc_id + '" target="_blank">View ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="3">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }

                if (data.flag_set == '4') {
                    $('#div_touzi').html('');
                    $('#file_4').html('<a class="btn btn-sm btn-info" type="button" style=" text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments/' + data.doc_id + '" target="_blank">View ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="4">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }

                if (data.flag_set == '5') {
                    $('#div_addi').html('');
                    $('#file_5').html('<a class="btn btn-sm btn-info" type="button" style=" text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments/' + data.doc_id + '" target="_blank">View ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="5">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }
