...
<!--                        </td>-->
                        <td>
                            ...
                            <a type="button"  href="<?php echo base_url() . "index.php/khatian/khatianCoFinalView?khatian=" . $case->khatian_no."&uuid=". $case->uuid."&app_id=".$case->app_id ?>" class='btn-sm btn btn-primary'><i class="fa fa-envelope-open" aria-hidden="true"></i> Pass Order</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php endif; ?>
