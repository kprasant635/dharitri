                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                            <table class="table table-striped table-bordered text-bold">
                                                ...
                                                <tr>
                                                    <td width="15%"><label class="required uni_text control-label" style="text-align: left">Length
...
<?php if($khatian_status == 'Y'): ?>
    <script>
        window.onload = function() {
            if (!confirm("Khatian already exists. Are you sure want to edit Khatian No. "+<?= $khatian_no ?>)) {
                $.blockUI({
                    message: $('#displayBox'),
                    css: {
                        border: 'none',
            ...
            insert_data_from_main_table_to_temp_table();
        };
    </script>
<?php endif; ?>