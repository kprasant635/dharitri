                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                            <table class="table table-striped table-bordered text-bold">
                                                ...
                                                <tr>
                                                    <td width="15%"><label
                                                                class=" uni_text control-label">Paid Cash
                                                            Kind:</label>
                                                    </td>
                                                    <td colspan="5">
                                                ...
                                                <tr>
                                                    <td width="15%"><label
                                                                class=" uni_text control-label">Payable
                                                            Cash/Kind:</label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="15%"><label class=" uni_text control-label" style="text-align: left">Special
