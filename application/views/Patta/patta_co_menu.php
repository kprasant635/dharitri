            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    <tr class="bg-info" style="background: #17a2b8 !important;">
                        <td colspan="2">PENDING / VIEW PATTA</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="2">Pending Applied Patta</td>
                        <td>
                            <a href="<?php echo base_url() . 'index.php/Patta/pattaListForCo' ?>" class="red" style="float:right"><?php echo $this->lang->line('view') ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">View Patta <sup class="red">New</sup></td>
                        <td><a href="<?php echo base_url() . 'index.php/Patta/selectPattaView'; ?>" style="float:right"><?php echo $this->lang->line('view') ?></a></td>
                    </tr>
                </table>
            </div>
        </div>
