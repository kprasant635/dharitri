                                ...
                                if($patta_basic->patta_type == $patta_application_type[0]->CODE): ?>
                                    <table class="table table-striped table-bordered text-bold">
                                        ...
                                        <tr>
                                            ...
                                            <th width="25%" class="red"><?= $patta_basic->upto_date ?></th>
                                        </tr>
                                        <tr>
                                            <th width="25%">First Installment Date : </th>
                                            <th width="25%" class="red"><?= $patta_basic->installment1 ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <th width="25%" class="red"><?= $patta_basic->installment2 ?></th>
                                            <th width="25%">Revenue to be Paid : </th>
                                ...
                                <table class="table table-striped table-bordered text-bold">
                                    <thead>
                                        ...
                                        <tr style="background-color: #919191; color: #fff">
                                            ...
                                            <th width="25%">Relation with Guardian</th>
                                            <th class="hide" width="25%">Mobile</th>                                      </tr>
                                        <?php 
                                        foreach ($pattadar as $pattadar_details):?>     
                                            <tr>
                                                <th width="25%"><?=$pattadar_details->pdar_name?></th>
                                                <th width="25%"><?=$pattadar_details->pdar_father?></th>                                    
                                                <th width="25%"><?=$this->utilityclass->get_relation($pattadar_details->pdar_guard_reln)?></th>
