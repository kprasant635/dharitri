    ...
    <div class="col-lg-12 ">
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="well well-sm mis_report">
                <h3 style="text-align: center; font-size: 28px"><?php echo $this->lang->line('display_jamabandi_by_selecting_a_pattatype')?></h3>
            ...
            <div class="panel panel-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal unicode" name="form" method='post' action="<?php echo base_url() . 'index.php/JamabandiControllerBondita/displayjamabandiByPattatype' ?>">
