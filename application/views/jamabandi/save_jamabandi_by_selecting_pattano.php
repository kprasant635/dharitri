    ...
    <div class="row">
        <div align="center" class="col-lg-12">
            <table align="center table_black" width="100%" >
                <tr>
                    <td align="center">জৰীপ হোৱা গাঁওৰ জমাবন্দী (Jamabandi for Surveyed Village)</td> 
                </tr>
                <tr>
            ...
            <table class="table table-striped table-bordered" width="100%" >
                <tr>
                    ...
                    <td align="center" rowspan="3" height="73">  স্হানীয় কৰ<br>  </td>
                ...
                <tr>
                    ...
                    <td align="middle">  
                        ...
                        if (!empty($pno['daginfo'])) {
                            ...
                            <p><?php
                                ...
                                $converted_to_lessa = ($p->dag_area_b) * 100 + ($p->dag_area_k) * 20 + ($p->dag_area_lc);
                    ...
                    <td align="middle">
                        ...
                        if (!empty($pno['daginfo'])) {
                            foreach ($pno['daginfo'] as $p): ?>
                            <p><?php
                                $each_land_area_hectr = $this->utilityclass->get_Hec_Are_CAre($p->dag_area_b, $p->dag_area_k, $p->dag_area_lc);
                    ...
                    <td align="middle">
                        ...
                        if (!empty($pno['daginfo'])) {
                            foreach ($pno['daginfo'] as $p): ?>
                            <?php 
                            $revenueTotal = (float)$revenueTotal + ((float)$p->dag_revenue==null?0:(float)$p->dag_revenue); ?>
                            <p><?php
                    ...
                    <td align="middle">
                        ...
                        if (!empty($pno['daginfo'])) {
                            foreach ($pno['daginfo'] as $p):
                                //var_dump($p);
                             ?>
                            <?php $localtaxTotal = (float)$localtaxTotal + ((float)$p->dag_revenue==null?0:(float)$p->dag_revenue); ?>
                            <p><?php
                ...
                <tr>
                    ...
                    <td align="middle">
                        <?php
                        $single_land_area = $this->utilityclass->Total_Bigha_Katha_Lessa($total_lesa);
                        if (!empty($pno['daginfo'])) {
                            echo $this->utilityclass->cassnum($single_land_area[0]) . '-' . $this->utilityclass->cassnum($single_land_area[1]) . '-' . $this->utilityclass->cassnum($single_land_area[2]);
                            $single_land_area_hectr = $this->utilityclass->get_Hec_Are_CAre($single_land_area[0], $single_land_area[1], $single_land_area[2]);
                            
                        } else {
                            echo "0-0-0";
                            $single_land_area_hectr = "0-0-0";
                        }
                ...
                <tr>
                    ...
                    <td align="middle">
                    <?php
                    $all_land_area = $this->utilityclass->Total_Bigha_Katha_Lessa($grand_total_land_area_lessa);
                    echo $this->utilityclass->cassnum($all_land_area[0]) . '-' . $this->utilityclass->cassnum($all_land_area[1]) . '-' . $this->utilityclass->cassnum($all_land_area[2]);
                    $All_land_area_hectr = $this->utilityclass->get_Hec_Are_CAre($all_land_area[0], $all_land_area[1], $all_land_area[2]);
                    ?> 
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
