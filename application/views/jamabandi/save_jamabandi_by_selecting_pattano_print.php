<style>
    ...
    @media only screen and (min-width: 992px) {
          .col-md-2 {width: 15.66%;} 
          .col-lg-12{width: 100%;}
        }
</style>

<div style="font-size:1em;" class="container-fluid form-top">
    <div class="row">
        <div align="center" style="display:inline-block; width: 100%;" class="col-lg-12">
            ...
            <table class="table table_black" align="center" width="100%;" style="margin-bottom: 10px; padding: 1px" >
                <tr>
            ...
            <table class="table table_black" width="100%" >

                <tr>
                    <td align="center" colspan="2" height="24">  পট্টা নং </td>
                    <td align= "center" rowspan="2" height="78"> পট্টাদাৰৰ  নাম,পিতাৰ নাম/স্ৱামীৰ নাম আৰু ঠিকনা  </td>
                    ...
                    <td align="center" rowspan="2" height="100" width="100">  মন্তব্য </td>
                ...
                <tr>
                    ...
                    <td>  
                        <?php foreach ($daginfo as $p): ?>
                            <p><?php echo $this->utilityclass->cassnum($p->dag_area_b) . "-" . $this->utilityclass->cassnum($p->dag_area_k) . "-" . $this->utilityclass->cassnum($p->dag_area_lc, 2); ?> </p>
                        <?php endforeach; ?>
                    </td>
                    <td>
                        <?php foreach ($daginfo as $p): ?>
                    ...
                    <td>
                        <?php foreach ($daginfo as $p): ?>
                            ...
                            <p><?php echo $this->utilityclass->cassnum(number_format($p->dag_revenue, 2)); ?> </p>
                        <?php endforeach; ?>
                    ...
                    <td>
                        <?php foreach ($daginfo as $p): ?>
                            ...
                            <p><?php echo $this->utilityclass->cassnum(number_format($p->dag_localtax, 2)); ?> </p>
                        <?php endforeach; ?>
                    </td>
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
			...
			$data = explode(",", $qrcode);
			$data = $data[1];
            echo '<img class="img-fluid col-md-2" src="data:image/png;base64,' . $data . '" />';
            ?>
            <?php
...
<div class='dontshow' >
    <div class="form-group" style="text-align: center">
        <div class="col-sm-3" style="margin: 0 auto;float: none;margin-top: 20px;margin-bottom: 20px;">
            <a href="<?php echo base_url(); ?>index.php/CitizenController/AssttPrintCertPageCount?cert_no=<?php echo $this->session->userdata('case_no'); ?>&certtype=01" class="btn btn-success uni_text dontshow" onclick="myFunction()"><i class='fa fa-print'></i> Print this page</a>
